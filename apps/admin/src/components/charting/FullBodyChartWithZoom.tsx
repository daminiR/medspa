...
/**
 * FullBodyChartWithZoom - Full body chart with zoom and pan capabilities
 *
 * Wraps FullBodyChart with zoom/pan functionality:
...
import { FullBodyChart } from './FullBodyChart'
import { useChartZoomPan } from '@/hooks/useChartZoomPan'
import { ZoomPanControls } from './ZoomPanControls'
import type { ZoomState, ZoomControls } from './FaceChartWithZoom'

// Re-export the InjectionPoint type from FullBodyChart
export type { InjectionPoint } from './FullBodyChart'

interface FullBodyChartWithZoomProps {
  productType: 'neurotoxin' | 'filler'
  injectionPoints: Map<string, import('./FullBodyChart').InjectionPoint>
  onInjectionPointsChange: (points: Map<string, import('./FullBodyChart').InjectionPoint>) => void
  onSave?: () => void
  selectedProductId?: string
  selectedProductColor?: string // The color of the selected product (for new points)
  patientLastTreatment?: Map<string, import('./FullBodyChart').InjectionPoint>
  readOnly?: boolean
      ...
      >
        ...
        >
          <FullBodyChart
            ...
            onInjectionPointsChange={onInjectionPointsChange}
            onSave={onSave}
...
export default FullBodyChartWithZoom
