...
// Target points on the face (normalized screen coordinates for raycasting)
...
// Face model component with raycasted injection points
function FaceModel() {
  ...
  // Find injection points on the mesh surface using raycasting
  useEffect(() => {
...
// Empty loading fallback for instant display
  ...
  return (
    ...
    >
      <Suspense fallback={<LoadingFallback />}>
        {/* Lighting - matches the actual app */}
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" }}>
      ...
      {/* Hero Section */}
      <section className="min-h-screen flex items-center px-8 pt-24 pb-16 bg-gradient-to-b from-purple-50/50 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          <div className="z-10">
            ...
            <div className="flex flex-wrap gap-2 mb-8 max-w-xl">
              {[
                ...
                <span key={i} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-purple-50 border border-purple-100 rounded-full text-xs font-semibold text-purple-700">
            ...
            <div className="flex gap-12 mb-10">
              <div>
                <div className="text-4xl font-extrabold bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">Q1</div>
                <div className="text-sm text-gray-500 font-medium">2026 Launch</div>
              </div>
              <div>
                <div className="text-4xl font-extrabold bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">12+</div>
                <div className="text-sm text-gray-500 font-medium">Core Modules</div>
              </div>
              <div>
                <div className="text-4xl font-extrabold bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">3D</div>
                <div className="text-sm text-gray-500 font-medium">Charting System</div>
              </div>
            </div>
            <div className="flex gap-4 flex-wrap">
              <a href="#contact" className="group inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-purple-700 text-white px-8 py-4 rounded-xl font-semibold text-base shadow-xl shadow-purple-500/30 hover:shadow-2xl hover:shadow-purple-500/40 hover:-translate-y-1 hover:brightness-110 active:scale-95 transition-all no-underline">
                Get Early Access
              ...
              <a href="#features" className="inline-flex items-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold text-base border-2 border-gray-100 hover:border-purple-200 hover:text-purple-600 hover:bg-purple-50/30 active:scale-95 transition-all no-underline">
                Explore Features
              </a>
            </div>
          </div>
          ...
          <div className="relative h-[500px] lg:h-[600px] group">
            ...
            <div className="absolute top-[10%] left-[-20px] lg:left-[-60px] bg-white rounded-2xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-10 hover:scale-105 transition-transform cursor-default" style={{ animation: 'float 6s ease-in-out infinite' }}>
            ...
            <div className="absolute top-[45%] right-[-20px] lg:right-[-50px] bg-white rounded-2xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-10 hover:scale-105 transition-transform cursor-default" style={{ animation: 'float 6s ease-in-out infinite', animationDelay: '1s' }}>
              <div className="flex items-center gap-3">
            ...
            <div className="absolute bottom-[15%] left-[-10px] lg:left-[-30px] bg-white rounded-2xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-10 hover:scale-105 transition-transform cursor-default" style={{ animation: 'float 6s ease-in-out infinite', animationDelay: '2s' }}>
              <div className="flex items-center gap-3">
            ...
            <div className="w-full h-full rounded-3xl overflow-hidden bg-gradient-to-br from-gray-900 via-slate-800 to-gray-950 shadow-[0_40px_100px_rgba(0,0,0,0.4)] relative ring-1 ring-white/10 group-hover:ring-purple-500/30 transition-all duration-500">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end pointer-events-none">
                <div className="bg-black/40 backdrop-blur-xl px-4 py-3 rounded-xl text-white text-sm border border-white/10 shadow-2xl">
                  <strong className="block text-base mb-1">3D Injection Mapping</strong>
                  Interactive charting for precision treatments
                </div>
                <div className="flex gap-3">
                  <div className="flex items-center gap-2 bg-black/40 backdrop-blur-xl px-3 py-2 rounded-lg text-white text-xs border border-white/10 shadow-2xl">
                    <span className="w-2.5 h-2.5 rounded-full bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.8)]" />
                    Neurotoxin
                  </div>
                  <div className="flex items-center gap-2 bg-black/40 backdrop-blur-xl px-3 py-2 rounded-lg text-white text-xs border border-white/10 shadow-2xl">
                    <span className="w-2.5 h-2.5 rounded-full bg-pink-500 shadow-[0_0_10px_rgba(236,72,153,0.8)]" />
                    Filler
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="group bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/[0.08] hover:border-purple-500/40 hover:-translate-y-2 transition-all duration-300">
                <div className={`w-14 h-14 rounded-xl flex items-center justify-center text-3xl mb-6 shadow-lg ${problem.color === 'red' ? 'bg-red-500/15 text-red-400' : problem.color === 'orange' ? 'bg-orange-500/15 text-orange-400' : 'bg-yellow-500/15 text-yellow-400'}`}>
                  {problem.icon}
                </div>
                <h3 className="text-xl font-bold mb-3 group-hover:text-purple-300 transition-colors">{problem.title}</h3>
                <p className="text-sm text-white/60 leading-relaxed mb-6">{problem.desc}</p>
                <span className="inline-block px-4 py-2 bg-red-500/10 border border-red-500/20 rounded-lg text-xs font-bold text-red-300 group-hover:bg-red-500/20 transition-all">{problem.stat}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-[2.5rem] p-1 shadow-2xl shadow-purple-500/5 group">
              <div className="bg-white rounded-[2.25rem] p-8 shadow-inner border border-white relative overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-6">
                  <div className="col-span-1 bg-purple-50/50 rounded-2xl p-5 border border-purple-100/50">
                    <div className="text-[10px] text-purple-400 mb-4 font-bold uppercase tracking-wider">TODAY&apos;S SCHEDULE</div>
                    <div className="flex flex-col gap-3">
                      <div className="bg-purple-600 shadow-md shadow-purple-500/20 text-white px-3 py-2.5 rounded-lg text-[10px] font-bold">9:00 - Botox (J. Smith)</div>
                      <div className="bg-pink-600 shadow-md shadow-pink-500/20 text-white px-3 py-2.5 rounded-lg text-[10px] font-bold">10:30 - Filler (M. Johnson)</div>
                      <div className="bg-purple-600 shadow-md shadow-purple-500/20 text-white px-3 py-2.5 rounded-lg text-[10px] font-bold">1:00 - Consultation</div>
                    </div>
                  </div>
                  <div className="col-span-2">
                    <div className="text-[10px] text-gray-500 mb-4 font-bold uppercase tracking-wider">QUICK STATS</div>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-green-50/50 p-5 rounded-2xl text-center border border-green-100/50 hover:bg-green-50 transition-colors">
                        <div className="text-2xl font-black text-green-600">$4,280</div>
                        <div className="text-[10px] text-green-500/70 font-bold uppercase mt-1">Today&apos;s Revenue</div>
                      </div>
                      <div className="bg-purple-50/50 p-5 rounded-2xl text-center border border-purple-100/50 hover:bg-purple-50 transition-colors">
                        <div className="text-2xl font-black text-purple-600">8</div>
                        <div className="text-[10px] text-purple-500/70 font-bold uppercase mt-1">Appointments</div>
                      </div>
                      <div className="bg-yellow-50/50 p-5 rounded-2xl text-center border border-yellow-100/50 hover:bg-yellow-50 transition-colors">
                        <div className="text-2xl font-black text-yellow-600">3</div>
                        <div className="text-[10px] text-yellow-500/70 font-bold uppercase mt-1">On Waitlist</div>
                      </div>
                      <div className="bg-pink-50/50 p-5 rounded-2xl text-center border border-pink-100/50 hover:bg-pink-50 transition-colors">
                        <div className="text-2xl font-black text-pink-600">2</div>
                        <div className="text-[10px] text-pink-500/70 font-bold uppercase mt-1">Follow-ups Due</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-24 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-gradient-to-br from-purple-600 to-indigo-700 text-white rounded-[2rem] p-10 shadow-2xl shadow-purple-500/20 relative overflow-hidden group">
              ...
              <div className="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-4xl mb-8 shadow-xl ring-1 ring-white/30 group-hover:scale-110 transition-transform">🎙️</div>
              <h3 className="text-3xl font-bold mb-4">Voice-Activated Everything</h3>
              ...
              <span className="inline-block mt-8 px-5 py-2.5 bg-white/15 backdrop-blur-sm border border-white/20 rounded-xl text-xs font-bold uppercase tracking-widest group-hover:bg-white/25 transition-all">Hands-Free Workflow</span>
            </div>
            {[
              ...
              <div key={i} className="group bg-gray-50/50 rounded-[2rem] p-8 border border-gray-100 hover:bg-white hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] hover:border-purple-200 hover:-translate-y-2 transition-all duration-300">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-100 to-purple-50 flex items-center justify-center text-3xl mb-8 shadow-sm group-hover:shadow-md transition-shadow group-hover:scale-110 transition-transform">{feature.icon}</div>
                ...
                <span className="inline-block px-4 py-2 bg-purple-100/50 text-purple-600 border border-purple-200/50 rounded-xl text-[10px] font-bold uppercase tracking-wider group-hover:bg-purple-600 group-hover:text-white transition-all">{feature.tag}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-8 bg-gradient-to-b from-white to-purple-50/30">
      ...
      {/* AI Section */}
      <section id="ai" className="py-24 px-8 bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="inline-block text-xs font-semibold uppercase tracking-widest text-pink-400 mb-4">The Dalphene Difference</span>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white/5 border border-white/10 rounded-xl p-4">
                    ...
                    <p className="text-xs text-white/60">{cap.desc}</p>
                  </div>
                ))}
              </div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-1 shadow-2xl backdrop-blur-sm group">
              <div className="bg-gray-950/50 rounded-[2.25rem] p-8 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-48 h-48 bg-purple-500/10 blur-[100px] rounded-full" />
                <div className="flex items-center gap-2 pb-6 mb-8 border-b border-white/5">
                  <div className="w-3 h-3 rounded-full bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]" />
                  <div className="w-3 h-3 rounded-full bg-yellow-500 shadow-[0_0_10px_rgba(245,158,11,0.5)]" />
                  <div className="w-3 h-3 rounded-full bg-green-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]" />
                  <span className="ml-auto text-[10px] font-bold uppercase tracking-widest text-white/30">AI Message Analysis</span>
                </div>
                <div className="space-y-6">
                  <div className="bg-white/10 border border-white/5 rounded-2xl p-5 mr-12 shadow-xl hover:bg-white/20 transition-colors">
                    <div className="text-[10px] font-black uppercase tracking-widest text-white/30 mb-3">Incoming SMS</div>
                  ...
                  <div className="bg-gradient-to-br from-purple-500/20 to-purple-700/20 border border-purple-500/40 rounded-2xl p-5 shadow-2xl relative group">
                    <div className="absolute inset-0 bg-purple-500/5 animate-pulse rounded-2xl" />
                    <div className="text-[10px] font-black uppercase tracking-widest text-purple-300 mb-3 relative z-10">AI Analysis</div>
                    ...
                    <div className="flex gap-2 mt-4 flex-wrap relative z-10">
                      <span className="px-2.5 py-1 bg-white/10 border border-white/10 rounded-lg text-[10px] font-bold uppercase tracking-tighter">Post-Treatment</span>
                      <span className="px-2.5 py-1 bg-white/10 border border-white/10 rounded-lg text-[10px] font-bold uppercase tracking-tighter">Reschedule</span>
                      <span className="px-2.5 py-1 bg-purple-500/40 border border-purple-400/30 rounded-lg text-[10px] font-bold uppercase tracking-tighter">Requires Action</span>
                    </div>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-5 shadow-xl hover:bg-green-500/20 transition-all">
                    <div className="text-[10px] font-black uppercase tracking-widest text-green-400/70 mb-3">Suggested Response</div>
                    <p className="text-sm leading-relaxed text-green-50 italic">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="group text-center p-10 rounded-3xl bg-gradient-to-b from-gray-50 to-white border border-gray-100 hover:border-purple-200 hover:shadow-2xl hover:shadow-purple-500/5 transition-all duration-500">
                <div className="text-6xl font-black bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent mb-4 group-hover:scale-110 transition-transform duration-500">{metric.value}</div>
                <div className="text-gray-900 font-bold mb-4 tracking-tight leading-tight">{metric.label}</div>
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-600 rounded-xl text-xs font-black uppercase tracking-wider group-hover:bg-green-600 group-hover:text-white transition-all">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17" /></svg>
                  {metric.trend}
                </div>
              </div>
            ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group bg-white rounded-[2rem] p-10 border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-2 transition-all duration-300">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-100 to-purple-50 flex items-center justify-center text-4xl mb-8 shadow-sm group-hover:scale-110 transition-transform">{card.icon}</div>
                <h3 className="text-2xl font-black mb-4 text-gray-900 group-hover:text-purple-700 transition-colors">{card.title}</h3>
                <p className="text-gray-600 leading-relaxed text-sm mb-8">{card.desc}</p>
                <div className="flex items-baseline gap-3 mt-auto pt-8 border-t border-gray-50">
                  <span className="text-4xl font-black text-purple-600 group-hover:scale-110 transition-transform origin-left">{card.stat}</span>
      ...
      <section id="integrations" className="py-24 px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-3 md:grid-cols-5 gap-4 mb-12">
            {[
              { name: 'Stripe', desc: 'Payments', color: '#635BFF', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.591-7.305z"/></svg> },
              { name: 'Square', desc: 'POS', color: '#000000', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M4.01 0A4.01 4.01 0 000 4.01v15.98A4.01 4.01 0 004.01 24h15.98A4.01 4.01 0 0024 19.99V4.01A4.01 4.01 0 0019.99 0H4.01zm2.04 6.05h11.9c1.12 0 2.05.93 2.05 2.05v7.8c0 1.12-.93 2.05-2.05 2.05H6.05A2.07 2.07 0 014 15.9v-7.8c0-1.12.93-2.05 2.05-2.05zm1.93 2.96v6.01h8.04V9.01H7.98z"/></svg> },
              { name: 'Twilio', desc: 'SMS & Voice', color: '#F22F46', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.381 0 0 5.381 0 12s5.381 12 12 12 12-5.381 12-12S18.619 0 12 0zm0 20.4c-4.639 0-8.4-3.761-8.4-8.4S7.361 3.6 12 3.6s8.4 3.761 8.4 8.4-3.761 8.4-8.4 8.4zm3.6-11.4c0 1.325-1.075 2.4-2.4 2.4S10.8 10.325 10.8 9s1.075-2.4 2.4-2.4 2.4 1.075 2.4 2.4zm-6 6c0 1.325-1.075 2.4-2.4 2.4S4.8 16.325 4.8 15s1.075-2.4 2.4-2.4 2.4 1.075 2.4 2.4zm6 0c0 1.325-1.075 2.4-2.4 2.4s-2.4-1.075-2.4-2.4 1.075-2.4 2.4-2.4 2.4 1.075 2.4 2.4z"/></svg> },
              { name: 'Google', desc: 'Calendar', color: '#4285F4', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z"/></svg> },
              { name: 'DocuSign', desc: 'E-Signatures', color: '#FFCC22', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M4.07 0A4.07 4.07 0 000 4.07v15.86A4.07 4.07 0 004.07 24h15.86A4.07 4.07 0 0024 19.93V4.07A4.07 4.07 0 0019.93 0zm7.793 5.067h6.07v1.54h-6.07zm-5.796 4.4l8.263 4.773-8.263 4.773z"/></svg> },
              { name: 'Zapier', desc: 'Automation', color: '#FF4A00', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M15.633 1.636l-3.507 7.89h7.016l-10.769 12.838 3.506-7.89H4.864L15.633 1.636z"/></svg> },
              { name: 'Podium', desc: 'Reviews', color: '#5046E5', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg> },
              { name: 'RxPhoto', desc: 'Before/After', color: '#10B981', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h16a2 2 0 012 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zm0 2v8l4-4 3 3 5-5 4 4V6H4zm0 12h16v-2.5l-4-4-5 5-3-3-4 4V18zM8 10a2 2 0 110-4 2 2 0 010 4z"/></svg> },
              { name: 'PatientFi', desc: 'Financing', color: '#0EA5E9', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.41 16.09V20h-2.67v-1.93c-1.71-.36-3.16-1.46-3.27-3.4h1.96c.1 1.05.82 1.87 2.65 1.87 1.96 0 2.4-.98 2.4-1.59 0-.83-.44-1.61-2.67-2.14-2.48-.6-4.18-1.62-4.18-3.67 0-1.72 1.39-2.84 3.11-3.21V4h2.67v1.95c1.86.45 2.79 1.86 2.85 3.39H14.3c-.05-1.11-.64-1.87-2.22-1.87-1.5 0-2.4.68-2.4 1.64 0 .84.65 1.39 2.67 1.91s4.18 1.39 4.18 3.91c-.01 1.83-1.38 2.83-3.12 3.16z"/></svg> },
              { name: 'QuickBooks', desc: 'Accounting', color: '#2CA01C', icon: <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zM9.2 16.4H7.6c-1.325 0-2.4-1.075-2.4-2.4V10c0-1.325 1.075-2.4 2.4-2.4h1.6v1.6H7.6c-.44 0-.8.36-.8.8v4c0 .44.36.8.8.8h1.6v1.6zm8 0h-1.6v-1.6h1.6c.44 0 .8-.36.8-.8v-4c0-.44-.36-.8-.8-.8h-1.6V7.6h1.6c1.325 0 2.4 1.075 2.4 2.4v4c0 1.325-1.075 2.4-2.4 2.4zm-4-8.8c-1.325 0-2.4 1.075-2.4 2.4v4c0 1.325 1.075 2.4 2.4 2.4s2.4-1.075 2.4-2.4v-4c0-1.325-1.075-2.4-2.4-2.4zm.8 6.4c0 .44-.36.8-.8.8s-.8-.36-.8-.8v-4c0-.44.36-.8.8-.8s.8.36.8.8v4z"/></svg> },
            ].map((integration, i) => (
              <div key={i} className="group bg-white rounded-xl p-5 border border-gray-100 shadow-sm hover:shadow-lg hover:border-purple-200 transition-all duration-300 text-center">
                <div
                  className="w-12 h-12 mx-auto mb-3 flex items-center justify-center text-gray-400 grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                  style={{ color: integration.color }}
                >
                  {integration.icon}
                </div>
                <h4 className="font-bold text-sm text-gray-900 group-hover:text-purple-700 transition-colors">{integration.name}</h4>
                <p className="text-[10px] font-semibold uppercase tracking-wider text-gray-400 mt-1">{integration.desc}</p>
              </div>
            ))}
          </div>
          <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-[2rem] p-10 text-center border border-purple-100 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-purple-500/5 blur-3xl rounded-full" />
            <h3 className="text-2xl font-black mb-3 text-gray-900">Coming Soon: Manufacturer Loyalty Programs</h3>
            ...
            <div className="flex flex-wrap justify-center gap-8 text-xs font-black uppercase tracking-widest text-purple-600/70">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
            <div className="relative flex-shrink-0">
              <div className="w-32 h-32 rounded-2xl overflow-hidden shadow-xl ring-4 ring-purple-100">
                <img
            ...
            <div>
              <span className="inline-block text-xs font-semibold uppercase tracking-[0.2em] text-purple-600 mb-2">Meet the Founder</span>
          ...
          <div className="flex flex-wrap gap-3">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 border border-purple-100 rounded-xl text-xs font-bold text-purple-700">
            ...
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-100 rounded-xl text-xs font-bold text-green-700">
      ...
      {/* CTA Section */}
      <section id="contact" className="py-32 px-8 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 text-center relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.1)_0%,transparent_70%)]" />
        <div className="relative z-10 max-w-4xl mx-auto">
          <h2 className="text-5xl lg:text-6xl font-black text-white mb-6 tracking-tight">Be First in Line</h2>
          <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed text-pretty font-medium">
            Get notified when we launch and be among the first to experience the future of medical spa management.
          </p>
          <div className="bg-white/10 backdrop-blur-xl rounded-[2.5rem] p-10 mb-16 max-w-xl mx-auto border border-white/20 shadow-2xl group hover:bg-white/15 transition-all">
