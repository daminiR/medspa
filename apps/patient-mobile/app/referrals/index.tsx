...
import QRCodeDisplay from '../../components/referrals/QRCodeDisplay';
  ...
  const handleShare = async (method: string) => {
    ...
    try {
      await referralService.shareReferral({
        ...
        message: `Use my code ${program?.referralCode} for $50 off!`,
      });
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(600).delay(100)}>
          ...
          >
            ...
            <View style={styles.heroHeader}>
              ...
              <Text style={styles.heroTitle}>Earn $50 Per Friend</Text>
            </View>

            <Text style={styles.heroSubtitle}>
              Share your code with friends. When they book their first service (min. $100), you both get $50!
            </Text>

            <View style={styles.rewardBadges}>
              <View style={styles.rewardBadge}>
                <Ionicons name="heart" size={20} color="#EC4899" />
                <Text style={styles.rewardBadgeText}>You: $50</Text>
              </View>
              <Text style={styles.rewardPlus}>+</Text>
              <View style={styles.rewardBadge}>
                <Ionicons name="people" size={20} color="#10B981" />
                <Text style={styles.rewardBadgeText}>Friend: $50</Text>
              </View>
            </View>
          </LinearGradient>
        </Animated.View>
        ...
        {/* QR Code */}
        {showQRCode && (
          <Animated.View entering={FadeInDown.duration(400)} style={styles.qrSection}>
            <QRCodeDisplay
        ...
        >
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/referrals/leaderboard')}>
              <Text style={styles.sectionLink}>Leaderboard</Text>
            </TouchableOpacity>
          </View>
        ...
        >
          ...
          {referrals.length > 5 && (
            <TouchableOpacity
              ...
              onPress={() => router.push('/referrals/history')}
            >
