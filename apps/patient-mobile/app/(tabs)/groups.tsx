 ...
 * Groups Tab Screen
 *
 * This tab wraps the main Groups List screen to integrate it into the tab navigation.
 * Detail screens (group details, join, create) remain as stack screens outside tabs.
 */
