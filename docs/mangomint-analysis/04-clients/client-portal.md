...
**URL:** https://www.mangomint.com/learn/help-articles/clients/client-portal/
...
The client portal allows clients to manage their appointments, memberships, and packages online.

Manage appointments: Clients can book new appointments and view, reschedule, or cancel upcoming appointments.

Manage memberships & packages: Clients can view their membership & package details, update their membership payment method, and cancel their membership.

You can also customize the client portal with your brand color, company logo, and a custom cover image.

Clients can access the client portal from their automated messages, and you can also add a link to the client portal to your flow messages using the Client Profile Link merge tag. Clients do not need a username or password to access the client portal.

The Call, Email, and Website buttons will display in the client portal once the following business information has been entered:

Go to Apps > Settings > Business Setup > Locations and enter a Contact phone and Contact email.

Go to Apps > Settings > Business Setup > Business Details and enter a Website address.

The articles in this section cover how to use the client portal, including managing appointments and memberships.

In this section:
Managing Appointments from the Client Portal
Managing Memberships from the Client Portal
...
3. **Untitled image**
   - Source: https://bat.bing.com/action/0?ti=97065788&Ver=2&mid=61840942-ca30-4696-8529-87075ed2abbc&bo=1&sid=6470ad60aad411f0a08c3337922d37be&vid=6470f430aad411f0ad3dbbd763893d96&vids=0&msclkid=N&pi=0&lg=en-US&sw=1920&sh=1080&sc=24&tl=Mangomint%20Client%20Portal%20-%20Overview%20%7C%20Mangomint%20Salon%20and%20Spa%20Software&p=https%3A%2F%2Fwww.mangomint.com%2Flearn%2Fhelp-articles%2Fclients%2Fclient-portal%2F&r=&lt=413&evt=pageLoad&sv=2&cdb=AQAQ&rn=491701
