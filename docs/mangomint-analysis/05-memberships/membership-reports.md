...
**URL:** https://www.mangomint.com/learn/membership-reports/
...
Membership Service Usage Report
Memberships Started Report
Memberships Cancellations Report

If the Memberships app is enabled for your account, the following Membership reports are available in the Reports app.

Membership reports can help you track membership payments, used membership services, and more.

Link copied
Membership Payments Report

The Membership Payments report includes payments for new memberships and membership renewals.

The table below provides more information on the different columns in the Membership Payments report.
...
The number of payments for new memberships and membership renewals.
...
The number of payments for new memberships.
...
The amount of tax that was collected.
...
The membership sales total.

Link copied
Membership Service Usage Report

The Membership Service Usage report includes details for used membership services.

The table below provides more information on the different columns in the Membership Service Usage report.
...
The sale where the membership was used.
...
The client who used the membership.
...
The service for which the membership was used.
...
The value of the applied membership.

Link copied
Memberships Started Report

The Memberships Started report includes new memberships that were started within the selected time period. This does not include membership renewals.

The table below provides more information on the different columns in the Memberships Started report.
...
The date the membership was started.
...
The Memberships Cancellations report includes canceled memberships within the selected time period.

The table below provides more information on the different columns in the Memberships Cancellations report.
...
The date the membership was canceled.
...
3. **Untitled image**
   - Source: https://bat.bing.com/action/0?ti=97065788&Ver=2&mid=8aa46a3d-5e17-41da-be1c-1895a5ba9c8c&bo=1&sid=6470ad60aad411f0a08c3337922d37be&vid=6470f430aad411f0ad3dbbd763893d96&vids=0&msclkid=N&pi=0&lg=en-US&sw=1920&sh=1080&sc=24&tl=Membership%20Reports%20in%20Mangomint%20%7C%20Mangomint%20Salon%20and%20Spa%20Software&p=https%3A%2F%2Fwww.mangomint.com%2Flearn%2Fmembership-reports%2F&r=&lt=344&evt=pageLoad&sv=2&cdb=AQAQ&rn=747126
