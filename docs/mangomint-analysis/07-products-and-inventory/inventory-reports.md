...
**URL:** https://www.mangomint.com/learn/inventory-reports/
...
Product Inventory Changes Report
Product Usage Report

This article covers the Inventory reports available in the Reports app.

Inventory reports can help you track product inventory changes, product usage, and more.

Link copied
Cost of Goods Report

The Cost of Goods report includes costs and profits of products. This report only includes products that have a purchase cost.

The table below provides more information on the different columns in the Cost of Goods report.
...
The name of the product category and product.
...
The name of the product brand and product.
...
The adjustments that were made to the default price during checkout.
...
The Product Inventory report includes the stock of products at the end of the selected day. Download the Excel report to see the product brand.

The table below provides more information on the different columns in the Product Inventory report.
...
The stock level at the end of the selected day.
...
The cost value of the stock level.
...
The retail value of the stock level.

Link copied
Product Inventory Changes Report

The Product Inventory Changes report includes product inventory changes. Download the Excel report to see the Description for Other inventory changes.

The table below provides more information on the different columns in the Product Inventory Changes report.
...
The amount of stock added or removed.
...
The staff member who made the change (the staff member who was logged into Mangomint).

Link copied
Product Usage Report

The Product Usage report includes product usage details. Download the Excel report to see additional details including SKU and Purchase Cost/Unit.

The table below provides more information on the different columns in the Product Usage report.
...
The number of products used for Professional use.
...
3. **Untitled image**
   - Source: https://bat.bing.com/action/0?ti=97065788&Ver=2&mid=f2ffb56d-9773-4553-8a33-31f1ace65481&bo=1&sid=6470ad60aad411f0a08c3337922d37be&vid=6470f430aad411f0ad3dbbd763893d96&vids=0&msclkid=N&pi=0&lg=en-US&sw=1920&sh=1080&sc=24&tl=Inventory%20Reports%20in%20Mangomint%20%7C%20Mangomint%20Salon%20and%20Spa%20Software&p=https%3A%2F%2Fwww.mangomint.com%2Flearn%2Finventory-reports%2F&r=&lt=403&evt=pageLoad&sv=2&cdb=AQAQ&rn=436396
