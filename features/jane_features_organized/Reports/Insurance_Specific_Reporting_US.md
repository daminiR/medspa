...
*Source: [https://jane.app/guide/insurance-specific-reporting-us](https://jane.app/guide/insurance-specific-reporting-us)*

*Category: Reports*

*Scraped: 2025-08-07 02:37:24*
...
Feature OverviewInsurance Specific Reporting (US)
Reports
Insurance Specific Reporting (US)
4 min read
Practice Plan
Thrive Plan
Legacy Plans
They say knowledge is power and reports help keep you informed about how your practice is doing.
For those clinics that bill insurance Jane has a few key reports and workflows that help you stay on top of your insurance billing.
As a complement to Jane’s reporting, those clinics using the
Claim.MD integration
can also take advantage of Claim.MDs reports such as Billed Charges by Payer, Provider, and Procedure code.
Ready to learn more? Let’s dive in.
Accounts Receivable Report
Jane’s AR report can be found in
Reports > Accounts Receivable
. This report can be filtered by location, staff member, Insurance or Patient accounts, and date. Jane displays the age of the receivables and provides a link to the Patient billing area or Insurer profile.
To learn more about this report check out our guide:
Accounts Receivable Report
Insurer Profile & Statements
Just like patients, Insurers have profiles in Jane. You can access these profiles in
Billing
>
Insurer Invoices
or you can click on the Insurer directly from the
Accounts Receivable report
.
You can filter claims by location, staff member, status, date range, and age of claim (invoice). A statement can then be generated based on your filters.
You can learn more in our guide:
Insurer Statements
Claims Submission Search
Want to be able to view all claims for all insurers? Or be able to see all claims for a specific patient? Head to
Billing > Search
under the
Claim Submissions
folder.
Here you will see all claims, in all states, for all insurers. You can then filter the search by Location, Chart Status, Claim Status, Staff member, Insurer, Claim Type and Date Range. Clicking on the
Search button
at the top left of the page will allow you to filter further by invoice number or patient name.
Once filtered, claims can be viewed in more detail by clicking on the
View
button to right of any Claim. Claims can also be submitted from this screen.
This view can be very helpful when investigating claims and the search can be exported as an Excel or CSV file by clicking on the three dots in the top right corner.
Claim.MD Reports
Claims processed by Claim.MD either through Jane’s integration or submitted to insurers directly from Claim.MD will be reflected in Claim.MD’s reports.
By checking out these reports, you’ll be able to see how your billing is doing, spot any problems with certain payers or procedures, and keep an eye on your claims. The reports are set up in a simple, easy-to-understand format, so you can easily track your billing and reimbursement.
Claim.MD’s reporting features give you a handy tool to manage your claims and boost your billing performance.
To learn more, check out Claim.MD’s help documents:
Claim.MD Reporting
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Insurance Specific Reporting (US)
Reports
Insurance Specific Reporting (US)
4 min read
Practice Plan
Thrive Plan
Legacy PlansThey say knowledge is power and reports help keep you informed about how your practice is doing.
For those clinics that bill insurance Jane has a few key reports and workflows that help you stay on top of your insurance billing.
As a complement to Jane’s reporting, those clinics using the
Claim.MD integration
can also take advantage of Claim.MDs reports such as Billed Charges by Payer, Provider, and Procedure code.
...
To learn more, check out Claim.MD’s help documents:
Claim.MD Reporting
Mastering Claim.MD Reports: A Guide to Informed Billing ManagementSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/12c3b84d-a553-413b-9943-696958e75f7b)
- ![](https://jane.app/thumbs/23a43924-03db-442e-89fd-4dcfe605a580)
- ![](https://jane.app/thumbs/9c86e837-3b60-4107-b137-4ffc7810618d)
