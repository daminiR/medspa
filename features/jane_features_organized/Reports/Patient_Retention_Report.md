...
*Source: [https://jane.app/guide/patient-retention-report](https://jane.app/guide/patient-retention-report)*

*Category: Reports*

*Scraped: 2025-08-07 02:26:54*
...
Feature OverviewPatient Retention Report
Reports
Patient Retention Report
5 min read
Balance Plan
...
💡 Note:
An appointment will not count towards the totals shown in this report unless it has been marked as
Arrived
. Appointments that have been marked as a
No Show
will not be included within this report.
New Patients
The first line is
New Patients
.  This is exactly how it sounds :) New patients to the practice.  These are those that are coming in for the very first time and have never been seen by anyone else in your practice.  They will have the “first visit” badge on their appointments on the schedule.
...
Returning Patients
The second line is also fairly self explanatory:
Returning Patients
.  This is the number of clients who are returning to the practice (but note that they are not necessarily returning to see the same person in your practice).  They may have been in first for Massage and are now returning for Physiotherapy for example, and they will display as “returning”.
📍Note:
Keep in mind for New and Returning Patients figures, these numbers will represent unique patients. If the same patient visits the clinic multiple times during the specified date range, they will be counted only once in either category. In the special case where a patient is brand new to the clinic AND also books their follow-up visit during the specified date range, they will be considered a
New Patient
.
Total Patients
...
The fourth line is
Total Visits
- this is the number of actual treatments that were arrived during the reporting period. This includes all visit types attended by all clients. If the same patient visits multiple times during the specified date range, each visit will count towards the final total.
% Returning
Jane calculates the percentage of visits that are repeat business for the entire practice during the specified time frame by excluding initial visits from the total visit count. This calculation accounts for instances where patients may have seen different staff members in previous appointments. This can be calculated as:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Patient Retention Report
Reports
Patient Retention Report
5 min read
Balance Plan
Practice Plan
Thrive PlanThe Patient Retention Report is designed to give you an overview of the booking habits of your staff members.
You can find this report under
Reports > Patient Retention
.
It will show you the number of new patients for the practice, and per staff member, and help give you an idea of whether clients are booking back in.
...
This will give you a rough idea of whether the practitioner is booking clients more than a single time.  Again, it’s always important to keep treatment style, report date ranges, vacation or sick time and the many other factors that could be affecting reporting data in mind.
(Total Visits - Total Patients) / Total Visits = Returning Visits * 100%
If there’s data that you’re trying to extract from Jane, let us know what it is and most importantly WHY you want it and what you want to do with it, and we’d love to discuss how Jane can help.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/29152805-cc68-4cb0-b60e-d1ed159ed344)
