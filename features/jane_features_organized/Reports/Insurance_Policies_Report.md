...
*Source: [https://jane.app/guide/insurance-policy-report](https://jane.app/guide/insurance-policy-report)*

*Category: Reports*

*Scraped: 2025-08-07 02:34:52*
...
Feature OverviewInsurance Policies Report
Reports
Insurance Policies Report
5 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Keeping track of your patients’ insurance policies can be a bit overwhelming, but with the Insurance Policies report, you’ll have all your ducks in a row in no time! Whether you’re looking for a list of Medicare patients or just need to see how many policies are under a specific policy, we’ve designed this report to make viewing and managing patients’ policies efficient and hassle-free.
What’s the Insurance Policies Report?
The Insurance Policies report provides a comprehensive view of all insurance policies used in your practice. Looking for a list of patients under a specific insurer (i.e. Medicare, Sunlife, Blue Cross etc)? This report can be filtered by insurer, staff member, and policy status. Plus, with the “Patients With Upcoming Appointments” toggle, you can quickly review policies before those appointments roll in, ensuring you’re always prepared and organized.
✨ Do you
Collect Insurance Information on Intake Forms
? If so, the Insurance Policies report simplifies the administrative process by allowing you to review and approve patient policies directly within the report. Say goodbye to tedious back-and-forth, and hello to streamlined efficiency!
To find the Insurance Policies report, simply navigate to
...
An internal Name for the policy
Their Claim #
Their Policy #
The Status of the policy (Open, Awaiting Review, or Closed)
The End Date for the policy
Adjuster info
The Number of Treatments in the policy
The Policy Maximum for the policy
The patient’s Next Appointment date
Any additional Notes attached to the policy
Reviewing Patient Insurance Policies
If you
Collect Insurance Information on Intake Forms
, you’ll likely have insurance policies that require review and approval. No worries! Our Insurance Policies report makes the process of setting up insurance for your patients quick and easy.
To manage all insurance policy reviews at once, visit the
Reports
section and access the
Insurance Policies
report. With the handy
Filter
options, you can focus on policies that require your immediate attention. For instance, filtering for policies that are both
Awaiting Review
and
Patients With Upcoming Appointments
helps prioritize the most urgent cases. This way, you can ensure your patients are all set and ready for their next visit!
This report is also super helpful when you want to see how many visits each patient has had under a specific insurance provider. For example, if you’d like to view all patients with
Manulife
coverage, you can use the
Insurer
filter to show only Manulife policies. From there, Jane will display each patient’s visit count in the
Number of Treatments
column.
When you’re ready to review a policy, all you need to do is click on the
blue Claim #
and you’ll be brought directly into that policy.
Upon selecting a policy, you’ll receive a friendly reminder to review the details and ensure they match any provided insurance card images. Take a moment to
Edit
the policy and make any necessary corrections or add additional policy information to keep everything accurate and up-to-date.
When everything looks good, click
Save and Approve
. This will save any changes you made and update the status of the policy to Open so that it can be added to appointments and you can begin billing claims. For those in the 🇺🇸 US billing with ClaimMD, this is a great spot to
check eligibility
and learn about your patient’s coverage, too!
Exporting the Insurance Policies Report
While there are a lot of details that populate the Insurance Policies report, you’re also able to export this report to Excel or CSV to get more fields. In this case, you’ll also get the Adjuster Email & Phone Number if entered in the insurance policy when exported to Excel or CSV.
If you’d like to investigate any outstanding amounts seen on a per-insurer basis, check out the
Accounts Receivable Report
to be able to do a deep dive into those outstanding amounts.
Next time you’re managing your insurance policies, give this report a try and discover a more efficient way to review and approve policies, ensuring a seamless experience for both you and your patients. Remember we’re also here to lend a hand if needed so don’t hesitate to
chat with our team
. Happy managing!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Insurance Policies Report
Reports
Insurance Policies Report
5 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansKeeping track of your patients’ insurance policies can be a bit overwhelming, but with the Insurance Policies report, you’ll have all your ducks in a row in no time! Whether you’re looking for a list of Medicare patients or just need to see how many policies are under a specific policy, we’ve designed this report to make viewing and managing patients’ policies efficient and hassle-free.
What’s the Insurance Policies Report?
The Insurance Policies report provides a comprehensive view of all insurance policies used in your practice. Looking for a list of patients under a specific insurer (i.e. Medicare, Sunlife, Blue Cross etc)? This report can be filtered by insurer, staff member, and policy status. Plus, with the “Patients With Upcoming Appointments” toggle, you can quickly review policies before those appointments roll in, ensuring you’re always prepared and organized.
✨ Do you
Collect Insurance Information on Intake Forms
...
Next time you’re managing your insurance policies, give this report a try and discover a more efficient way to review and approve policies, ensuring a seamless experience for both you and your patients. Remember we’re also here to lend a hand if needed so don’t hesitate to
chat with our team
. Happy managing!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/74d09670-5d80-4d28-bb43-2c7cd21d305e)
- ![](https://jane.app/thumbs/3756f9b7-7cf0-40d4-a024-8960a00e6bda)
- ![](https://jane.app/thumbs/3340ffac-4e88-45c3-9a91-5d6e247f2491)
- ![](https://jane.app/thumbs/30b843b1-8ad2-4d95-8021-e1400295e903)
- ![](https://jane.app/thumbs/19fc3b80-5983-48fe-963a-ac8b07021503)
- ![](https://jane.app/thumbs/e1eafcff-086d-45ef-bafe-35b9f6bb0d6a)
