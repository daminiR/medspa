...
*Source: [https://jane.app/guide/compensating-product-sales-by-profit-margin](https://jane.app/guide/compensating-product-sales-by-profit-margin)*

*Category: Reports*

*Scraped: 2025-08-07 02:34:13*
...
Feature OverviewCompensating Product Sales by Profit Margin
Reports
Compensating Product Sales by Profit Margin
3 min read
Balance Plan
...
Compensating a Product Sale by Profit
If you haven’t already, you’ll want to make sure that you’ve set up the cost of a product to the clinic from your
Settings > Products
area. Here is our guide on
Creating a Product
)
in case you’d like a quick refresher on this process.
...
and
income category
are additional fields that will show up on the exported version of the report.
You will be able to reference this information to help calculate the profit made for a sale as well as the after-commission amount for that particular staff member.
The export will display the
product cost of a single unit
in the “Product Cost” column of the export. If the line item you are working with is a single product sale, you’ll be able to calculate profit by subtracting the
Product Cost
from the
Adjusted Total
value.
Don’t forget to multiply the product cost by the number of products sold if the quantity of the transaction is greater than one.
Once the profit has been calculated, you will be able to multiple this number by the commission rate set for this practitioner and income category. In the example below, our practitioner will receive 75% of the commission based on the profit brought in under the product income category.
Once you have your formula set, you can click and drag the cell down to cover all of the other line items for that same staff member— your spreadsheet program will apply the same calculation for all of the selected lines. You can then sum all of these values together to calculate a final total.
And that’s it! If you have any questions about working with compensation in Jane, don’t hesitate to reach out to us at
support@janeapp.com
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Compensating Product Sales by Profit Margin
Reports
Compensating Product Sales by Profit Margin
3 min read
Balance Plan
Practice Plan
Thrive PlanCurrently, Jane will calculate staff compensation based on the revenue received for a particular product sale. If you would like to compensate your staff member based on the profit made on a particular product sale, you will be able to arrive at this amount with a little bit of spreadsheet magic ✨
Compensating a Product Sale by Profit
If you haven’t already, you’ll want to make sure that you’ve set up the cost of a product to the clinic from your
Settings > Products
area. Here is our guide on
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/246759d9-aded-4bb6-8fd8-1e2712587fd3)
- ![](https://jane.app/thumbs/47c04041-d81f-479d-b385-127f4b883721)
- ![](https://jane.app/thumbs/f662395c-8eff-406e-bd53-b7cb572e0f5a)
- ![](https://jane.app/thumbs/52ec86a7-c620-490f-8a03-a112caec885e)
- ![](https://jane.app/thumbs/daedea28-5313-43b6-898a-1d9388fe2af5)
