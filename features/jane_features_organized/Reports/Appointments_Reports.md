...
*Source: [https://jane.app/guide/appointments-reports](https://jane.app/guide/appointments-reports)*

*Category: Reports*

*Scraped: 2025-08-07 02:19:43*
...
Feature OverviewAppointments Reports
Reports
Appointments Reports
12 min read
Balance Plan
...
You can find the Appointments Report by heading to
...
Using the Appointments report, you’ll be able to bring up all of the appointments for a particular date range, for a specific staff member or Location, and in the
State
column, Jane will indicate the status of the appointment.
...
Rescheduled
- this means the appointment was rescheduled within Jane.
No Show
- this means that the appointment was set to No Show.
Never Booked
- the appointment was at one point reserved but the Book button was never pressed.
Archived
- the appointment was booked and then deleted.
Arrived
- the appointment was booked and arrived.
Booked Online
- the appointment was booked online by the patient.
...
Reports can be exported to an Excel file or CSV using the “Export” button. Excel is a great tool for manipulating data! You can learn a few tips and tricks in this handy guide:
Working with Excel
...
Here in the
State
filter of the Appointments Report, if we select
First Visit
you are able to pull a list of all of the appointments that were the first for your patients. This can be really helpful for you to keep track of any new patients that come into the clinic.
💡Pro Tip: Use this in tandem with the
Referral Report
to get a sense of where your new patients are learning about your practice.
Filtering by Chart Status
The Appointments report also includes a column that displays chart status. This is a quick way to view a list of all the appointments that have no charts attached to them or have not been completed yet. As long as you are charting from the
Day
view or are ensuring that the appointment is selected when you create a chart note, then Jane will link the chart entry with the appointments. You can learn more about this here:
...
💡
Pro Tip:
Any blue text is clickable in Jane. Clicking on the appointment date will bring up the appointment panel, where you can view billing details or jump to the schedule view. You can also jump directly into a patient profile by clicking on the patient name inside this report.
...
How can I track a list of unpaid appointments?
How can I print out a list of all the patients that have been to the clinic within the last month?
⭐️What does Jane consider a “First Visit” when I filter the report using this status?
...
If a patient has visited the clinic in the past but is seeing a different practitioner for the first time, this appointment
would not
be considered a “First Visit”.
If you are interested in the number of new patients for a specific practitioner, check out our guide on the
Practitioner Dashboard
, under the Patient Metrics section.
⭐️What is the “Checked In” status?
These are appointments where the patient has used Jane’s
Self Check-In
feature to indicate that they have arrived for their session.
⭐️I filtered my appointments by “No Chart”, but when I go to look at the patient’s charts for that day it looks like I had completed a chart entry!
Jane will associate a chart with a particular appointment if the entry had been started from the practitioner’s
Day Sheet
. An appointment falls under the “No Chart” category if there is no
connected
chart entry associated with that particular session.
...
⭐️Can I see my Late Cancellations on this report?
All cancellations, late or otherwise, will show up when we filter the appointment state to display
cancelled
visits.
...
You can learn more about Late Cancellations in our guide:
Late Cancellations
⭐️How do I get a list of one client’s appointments?
To access a list of one client’s appointments, you can head to the
Appointments
section of their patient profile:
...
⭐️Is there a filter to bring up specific appointments or sessions?
...
⭐️Does the Appointments Report show a history of changes to breaks?
...
To generate a list of breaks, filter the report by date range, and select
Breaks
from the
All States
list. This will display all breaks, including deleted ones. The
Booking Info
column shows the date and time a break was created and deleted. To see a detailed history of changes, including which staff member modified a break, click the
blue appointment link
in the
Date
column. This opens the Appointment Panel on the right side of the page where you can scroll to the
History & Status
section.
For more info about breaks, feel free to check out this guide page:
Booking a Break, Vacation and Holidays on Your Schedule
⭐️How can I track a list of unpaid appointments?
If you’re looking to generate a list of unpaid appointments, the recommendation here would be to head over to the
Sales report
, filtered to
Treatment Income
.  From there, you can filter the report to a specific invoice state (in this case,
Unpaid
).
If you’re looking to generate a list of unpaid appointments for a specific patient, you can head over to the
Patient’s Profile
>
Billing
> filter to
Unpaid/Unsubmitted
.
From there, you can either click on the
Patient Invoices
button to generate a list of invoices in a single PDF, with multiple invoices or click on
Statement
to generate a summarized list of outstanding invoices.
For more details, you can check out our
Patient Statements
guide.
⭐️How can I print out a list of all the patients that have been to the clinic within the last month?
While there currently isn’t a way to print the entire schedule for more than a day, you can use the
Appointments Report
. To see which patients attended appointments for the month, you can head over to the
Reports
tab and click on
Appointments
within the left sidebar menu.
Next, you can use the date range filter to narrow down the date range
Last Month
and the appointment state to
Arrived
.
Once the data is narrowed down, you can print the report by clicking on the
three horizontal black dots
and selecting
Print
from the dropdown menu options.
If you have any questions please don’t hesitate to
get in touch
with our lovely team. 💙
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Appointments Reports
Reports
Appointments Reports
12 min read
Balance Plan
Practice Plan
Thrive PlanWhat’s the Appointments Report?
Jane keeps track of everything related to appointments, from online bookings to arrivals.
The Appointments Report shows a list of your client’s past and future appointments, including the client’s name, clinic location, treatment, appointment date, and booking date.
You can use it to track how many bookings you have coming up next week, to see who’s booked the most appointments at the clinic, or to check how many clients you saw last week.
You can find the Appointments Report by heading to
...
If you have any questions please don’t hesitate to
get in touch
with our lovely team. 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e705b73a-0fe9-4f96-9eca-11824bd0cc3f)
- ![](https://jane.app/thumbs/00ac2555-899f-4038-92eb-e32d167cbab7)
- ![](https://jane.app/thumbs/190aeddd-632b-478d-892e-f757809a847b)
- ![](https://jane.app/thumbs/54a18428-6749-48cb-b461-d0b8dc7e7e1a)
- ![](https://jane.app/system/dragonfly/production/2016/11/09/65zf9aqm2a_blob)
- ![](https://jane.app/system/dragonfly/production/2016/11/09/nyol3eu6x_blob)
- ![](https://jane.app/thumbs/1d5616fb-f3ef-4eef-9763-42225116b43d)
- ![](https://jane.app/thumbs/d6e5ffbf-d7e6-4b22-b685-ddb2992bd857)
- ![](https://jane.app/thumbs/80f5d7fe-3f3f-40cd-91b9-569f72a2f462)
- ![](https://jane.app/thumbs/524a5142-6eaf-4c1a-81e1-345bacf1967a)
- ![](https://jane.app/thumbs/341ca8b6-657a-41e2-bb56-0713695be76e)
- ![Appointments Report filtered to Breaks](https://jane.app/thumbs/027f34d0-c31a-418c-b786-427adc90013d)
- ![screenshot of what the report looks like and where to set the filters](https://jane.app/thumbs/4d22fffa-b202-4a70-a628-fb93e611eb6a)
- ![](https://jane.app/thumbs/c7f50773-9493-417d-81fc-94bee93dcec0)
- ![An image of the appointments report filtered to the Last Month and Arrived](https://jane.app/thumbs/cefbaa67-8080-47de-b545-81b28fdfc6b2)
