...
*Source: [https://jane.app/guide/reports-overview](https://jane.app/guide/reports-overview)*

*Category: Reports*

*Scraped: 2025-08-07 02:36:08*
...
Feature OverviewReports Overview
Reports
Reports Overview
1 min read
...
To learn more about the different reports, check out the Guide articles for
Patients Reports
,
...
.
Displaying Reports
The most direct way to access reports is to click the “Reports” button in the top menu bar. In the left sidebar, you’ll find a number of links to various Reports.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Reports Overview
Reports
Reports Overview
1 min readJane has an impeccable memory. Every time your clinic admits a patient, books an appointment or bills an insurer, Jane remembers. Summaries of your clinic’s day-to-day operations can be generated quickly and easily through Jane’s Reports feature.
Reports can be used to gain insight about your clinic’s patients, appointments and billing. The Billing reports are particularly useful for tracking cash flow, showing taxes invoiced or collected, reconciling your daily POS cash-out, and calculating your clinic’s payroll.
Billing Reports are available to all clinic staff. Clinic owners have access to two additional types of reports: Patients Reports and Appointment Reports.
To learn more about the different reports, check out the Guide articles for
Patients Reports
...
.
Displaying Reports
The most direct way to access reports is to click the “Reports” button in the top menu bar. In the left sidebar, you’ll find a number of links to various Reports.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e02ca26b-4cc2-431c-bdac-35bbdf480377)
