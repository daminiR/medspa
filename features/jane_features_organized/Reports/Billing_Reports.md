...
*Source: [https://jane.app/guide/billing-reports](https://jane.app/guide/billing-reports)*

*Category: Reports*

*Scraped: 2025-08-07 02:21:04*
...
Feature OverviewBilling Reports
Reports
Billing Reports
7 min read
Balance Plan
...
All of your clinic’s billing and sales data are detailed in Jane’s Billing reports. The various Billing reports are particularly useful for tracking cash flow, showing taxes invoiced or collected, reconciling your daily POS cash-out and calculating your clinic’s payroll.
Billing Summary Report
Sales
Accounts Receivable Report
Compensation Report
Transactions or “Cash Out” Report
Adjustments
Product Performance
Billing Summary Report
...
There are five main sections in the
Billing Summary
report: Sales by Location, Sales Breakdown, Income, Tax, and Transactions.
Sales by Location
shows the amounts invoiced and collected by each location of your clinic.
Sales Breakdown
compares the amounts invoiced and collected for treatments and products.
Income
lists all your income sources (patients and various insurers) and provides the total amounts invoiced and collected for each one.
Tax
shows the total amounts invoiced and collected for all kinds of tax.
Transactions
gives you the total collected for every different payment method.
Sales Report
The
Sales Report
is a comprehensive list of sales during a specific date range. The report identifies the payer (patient or insurer) for each appointment, as well as the type of sale (treatment or product), the status of the payment, the subtotal, taxes and other details.
...
The results of the Sales report can be filtered by clinic location, practitioner, date range, purchase type and payment status.
...
Jane’s
Transaction Report
is commonly used as a “cash out” report, for reconciling a clinic’s POS machine, cash and cheques at the end of the day. The report shows what was collected during any given period of time, listing details of each transaction, organized by payment method.
...
You can run the report for a longer period (say a month) if you want to provide numbers for a bookkeeper of deposits to your account.
Adjustments Report
...
The
Product Performance Report
lists all products and treatments sold within the selected date range, including the number sold and the sales total for each item. The report includes a clinic-wide summary, as well as breakdowns for each clinic location.
Further Reading
Working with the Purchase, Invoice, Received At, and Applied Dates
for more details on the different billing dates and how they impact your financial reports in Jane.
Strategies for Investigating Reports
for some tips and tricks when investigating discrepancies with your financial reports.
Reporting FAQs
for a compilation of some of the most frequently asked questions we receive about working with reports in Jane.
The
Jane Payments Transactions Report
comes in handy if you’re looking for an in-depth look at all the credit card transactions processed via Jane Payments within the specified date range.
The
Jane Payments Payouts Report
provides a list of all the payouts, including their status.
Check out the
Jane Payments Monthly Processing Report
for a breakdown of the number of transactions and total processing fees each month in the previous year.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Billing Reports
Reports
Billing Reports
7 min read
Balance Plan
Practice Plan
Thrive PlanNumber-loving people, it’s time to celebrate.
All of your clinic’s billing and sales data are detailed in Jane’s Billing reports. The various Billing reports are particularly useful for tracking cash flow, showing taxes invoiced or collected, reconciling your daily POS cash-out and calculating your clinic’s payroll.
Billing Summary Report
Sales
Accounts Receivable Report
...
Check out the
Jane Payments Monthly Processing Report
for a breakdown of the number of transactions and total processing fees each month in the previous year.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2014/12/11/8fhxwsou16_Screen_Shot_2014_12_11_at_2.30.07_PM.png)
- ![](https://jane.app/system/dragonfly/production/2014/12/11/4jj224xabw_Screen_Shot_2014_12_11_at_2.30.07_PM_2.png)
- ![](https://jane.app/system/dragonfly/production/2014/12/11/6ne01ii8uo_Screen_Shot_2014_12_11_at_2.18.06_PM.png)
- ![](https://jane.app/system/dragonfly/production/2014/12/11/30bc23neeu_Screen_Shot_2014_12_11_at_2.20.51_PM.png)
