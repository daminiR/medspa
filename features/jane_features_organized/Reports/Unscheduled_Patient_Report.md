...
*Source: [https://jane.app/guide/unscheduled-patient-report](https://jane.app/guide/unscheduled-patient-report)*

*Category: Reports*

*Scraped: 2025-08-07 02:32:04*
...
Feature OverviewUnscheduled Patient Report
Reports
Unscheduled Patient Report
5 min read
Balance Plan
...
This report ensures that you are aware of which clients are not booking appointments into the future, or to recall which patients haven’t yet booked in for a future visit. The
Unscheduled Patients
report is also handy for viewing when a patient’s last visit to the clinic was.
❗️
Heads up:
All staff members can view their own Unscheduled Patients report, but only those with
Full Access or Administrator / All Billing
access can view all staff members’ unscheduled patients.
To view the report, follow me over to your
Reports
tab on the top blue bar, and click
Unscheduled Patient Report (Last Visit)
💡 Speed up or slow down the video speed using the ⚙️ button inside the video player!
How It Works
By default, Jane will display a list of all patients that have had their last visit within the specified period of time for
each staff member
. This means, that if a patient had seen Staff Members A and B, but not C, they will show up on the reports for both Staff A and B.
Filters
You’ll find a number of handy filters that’ll help you narrow down the data in this report. Let’s dive into how each of these filtering wonders will sort the data for you:
Days Since Last Visit:
This filter will narrow down the list of patients who haven’t been in for a certain time period.
Any Status:
If your clinic is using return visit reminders, you can filter if a reminder is due, sent or not set up.
Any State:
You can filter the appointment state to only display the last visits that were marked as Arrived, Cancelled, or No Show.
Last Visit to Clinic Only:
This filter will help narrow down the list of patients to just their last visit to the clinic overall. If a patient has appointments with multiple staff members, only the latest appointment will be considered. For example, if a patient saw Staff A on December 1st and Staff B on December 15th, the appointment with Staff B will be considered the most recent, and the patient will only appear once in the report under Staff B for December 15th.
Note 📍:
The
Date Range
and
Days Since Last Visit
filters cannot be used at the same time. For example, let’s say you’re looking to see which clients have not visited in the past 3 weeks, but limit the view to just this year.  You’ll want to adjust the
Date Range
to January 1st of the current year to 3 weeks from the date you’re loading the report.
From here you can add a Return Visit Reminder to the patient profile or see if one has been sent. The reminder is a gentle suggestion to follow up. To read more about these, check out our guide:
Return Visit Reminders
If you filter the report by
Staff Member
, Jane will bring up the last visit a patient had with that particular staff member, even if they had seen a different provider more recently during the same period of time (provided the “last Visit to Clinic” toggle is disabled).
Notes:
If you mark a patient as discharged or deceased they will not appear on the Unscheduled Patient Report.
If you are having trouble finding a particular patient on this report, don’t forget to check whether they had any recently cancelled appointments. This report will also consider
cancelled
appointments when determining a client’s last visit and in turn have not rebooked, so a good way to confirm their last visit is to pop in to the
Patient’s Profile > Appointments
area and
View All
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Unscheduled Patient Report
Reports
Unscheduled Patient Report
5 min read
Balance Plan
Practice Plan
Thrive PlanPatient compliance. One of the hardest things for a clinic to manage. No worries, Jane’s here to lend a helping hand at getting those clients back in for their continued care.
This report ensures that you are aware of which clients are not booking appointments into the future, or to recall which patients haven’t yet booked in for a future visit. The
Unscheduled Patients
report is also handy for viewing when a patient’s last visit to the clinic was.
❗️
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/603b3a76-7f8b-486e-8e32-72a8a45756bf)
- ![](https://jane.app/thumbs/9dc73964-1d20-47dc-a8c6-6ef654d842cb)
- ![](https://jane.app/thumbs/5f256523-7433-41aa-99f0-6caf4d5a8cee)
- ![](https://jane.app/thumbs/649e415c-e851-4ff8-8d69-a9e1485e6932)
- ![](https://jane.app/thumbs/1919ba92-f516-45b7-9cb7-ed059f16e18d)
