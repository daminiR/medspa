...
*Source: [https://jane.app/guide/sales-report](https://jane.app/guide/sales-report)*

*Category: Reports*

*Scraped: 2025-08-07 02:30:05*
...
You can find the Sales report by navigating to
Reports > Sales
...
Note
📍:
There is an additional filter that lets you sort this report by either the
Purchase
date or the
Invoice
date. For more detailed information on the difference between these dates, check out our
Working with the Purchase, Invoice, Received At, and Applied Dates
Income Categories
We love this filter 🙌
The Sales Report can be filtered down by income category, so you can run detailed reporting by each income group in your account! Jane creates two default income categories when you get started in your account,
Treatment Income
and
Product Income.
If you’re interested in running detailed reporting, you can create as many additional income categories as you’d like. This could be for Orthotics, Documentation, Labs, etc. If you want to get fancy, you can split up your disciplines and separate this out even more!
You can learn all about this in our handy guide:
...
The
All Outstanding
option will also include patient and insurer invoices that are partially paid.
If you’re looking for a report that will exclusively list all owings for both patients and insurers, you can check out our
Accounts Receivable Report
guide.
Summary
The Summary section of the Sales report displays:
Total Invoiced -
The sum of all the invoice amounts generated within this period
Amount collected for invoices in report period -
As of the end of the report period, how much money had we collected that went towards these invoices?
Amount collected for listed invoices as of today -
As of today’s date, how much money have we collected for these invoices?
...
Only
$842.50
worth of payments were collected during this same reporting period (January 15th)
$967.50
has been collected as of today’s date
...
You’ll notice if you look through the line items that some of them have a bit of extra text under the
Collected
column and
Balance column
:
...
💡
Pro Tip:
If you click on the blue invoice text, you can find additional information on the payment, and the date it was collected:
Invoice Reversals
...
user with “Access Billing” enabled in the Permissions & Commissions section of their Staff Profile will be able to see this report in its entirety.
...
You can learn more about access levels in our guide:
Staff Access Levels
...
We hope that this is helpful! Don’t hesitate to reach out to us at support@janeapp.com if you have any further questions about the Sales Report.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Sales Report
Reports
Sales Report
9 min read
Balance Plan
Practice Plan
Thrive PlanWhat’s the Sales Report?
Jane’s Sales report shows you a comprehensive list of sales during a specific date range. It’s helpful in identifying what you have been paid for during a specific date range and whether there are any invoices that have not yet been paid.
We recommend reviewing this report daily to ensure that you’ve charged (or invoiced) everyone appropriately for the day, and to make sure that all new charges you’ve created are entered properly.
You can find the Sales report by navigating to
Reports > Sales
...
Sales by Staff Member
This is a comprehensive list of sales during a specific date range, grouped by staff member. The information shown is the same as the regular Sales report, but divided into separate sections for each staff member.
We hope that this is helpful! Don’t hesitate to reach out to us at support@janeapp.com if you have any further questions about the Sales Report.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/54cca72a-2bdf-47d5-a793-72302e4e3009)
- ![](https://jane.app/thumbs/5d4147ad-af59-4c75-b13e-dd3b777338ae)
- ![An image of the Sales report filtered to all oustanding](https://jane.app/thumbs/9ca2dfc6-57de-458e-a112-fc51b3db51a6)
- ![](https://jane.app/thumbs/6275b93a-05ed-4863-ad93-40159bacd6bb)
- ![](https://jane.app/thumbs/b6f46914-04e8-4b31-8ae6-595fff60e4ce)
- ![](https://jane.app/thumbs/b786eded-9082-4da4-9f50-961e330fbad8)
- ![](https://jane.app/thumbs/0883ee87-1627-41c4-9de4-4b074a18f6d9)
- ![](https://jane.app/thumbs/1c71cc6d-43fd-45bb-9cc8-ab37f05cb708)
- ![](https://jane.app/thumbs/ec96f9ea-0286-4ef2-94a0-4c58ba752478)
