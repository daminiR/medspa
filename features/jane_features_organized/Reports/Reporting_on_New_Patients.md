...
*Source: [https://jane.app/guide/reporting-on-new-patients](https://jane.app/guide/reporting-on-new-patients)*

*Category: Reports*

*Scraped: 2025-08-07 02:36:43*
...
Feature OverviewReporting on New Patients
Reports
Reporting on New Patients
3 min read
You have a couple of options in Jane for reporting on new patients. The first two options require the staff member to be a
Full Access user
.
List Report​
​
​Found in your
Reports
tab, you can run your
List
report for the date you’re interested in reporting on. 
​
Along the top of the report, you will find filter options you can use to pull up a specific subset of patients. Using the
Created Date
filter allows you to filter for Patient Profiles created within a certain date range.
...
Dashboard
Another option if your looking for just a count of first visits is the dashboard which is the landing page on your Settings tab. 
​
​When run by date range this will show you the number of arrived first visits.
...
See more about the
Product Performance Report by clicking here
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Reporting on New Patients
Reports
Reporting on New Patients
3 min readYou have a couple of options in Jane for reporting on new patients. The first two options require the staff member to be a
Full Access user
.
List Report​
​
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/00687783-7f15-4d0d-b6e9-f50cc09b7f2d)
- ![](https://jane.app/system/dragonfly/production/2017/03/17/6vin7of8gp_blob)
- ![](https://jane.app/system/dragonfly/production/2017/03/17/4joglx6c6s_blob)
