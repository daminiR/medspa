...
*Source: [https://jane.app/guide/hours-scheduled-booked-report](https://jane.app/guide/hours-scheduled-booked-report)*

*Category: Reports*

*Scraped: 2025-08-07 02:25:18*
...
Feature OverviewHours Scheduled / Booked Report
Reports
Hours Scheduled / Booked Report
5 min read
Balance Plan
...
The Hours Scheduled/Booked report will provide an aggregate perspective on how productively your clinic’s schedule, or a staff member’s schedule, has been booked within a certain period of time.
...
What’s included in the Hours Scheduled / Booked Report?
1.
Scheduled (hrs)
This column reflects the total length of the shifts booked for the time period.
2.
Booked (hrs)
This column reflects the total length of appointments or classes booked into the practitioner’s day and is based on the Scheduled Length of those appointments (not the Treatment Length). This does not factor in breaks booked during your shift time.
3.
% Booked
...
Seeing
inf%
in one of the columns? This is a shortened way of saying
infinite percentage
, which typically appears when there is a division by zero. This can happen when there are bookings on a staff member’s schedule (
Booked Hours
) without corresponding shifts (
Scheduled Hours
).
...
Note:
when two appointments are doubled-booked at the same time on the schedule, let’s say each appointment was an hour long, the Hours Scheduled report would consider this to be a single hour of time but the Appointment report would consider each appointment two separate hours.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Hours Scheduled / Booked Report
Reports
Hours Scheduled / Booked Report
5 min read
Balance Plan
Practice Plan
Thrive PlanWhat’s the Hours Scheduled / Booked Report?
The Hours Scheduled/Booked report will provide an aggregate perspective on how productively your clinic’s schedule, or a staff member’s schedule, has been booked within a certain period of time.
You can find this report by heading to
Reports > Hours Scheduled / Booked
💡 Speed up or slow down the video speed using the ⚙️ button inside the video player!
...
You could also run the Appointments report for that practitioner for that same date range and only bring up no-show appointments so that you can subtract the duration of these appointments from the value provided by the Hours Scheduled/ Booked report.
Numbers Don’t Add Up? 🤔
If your ‘% Booked’ looks to be off, you’ll want to check if any appointments have been booked outside of your Shift. Jane will take into account all appointments booked outside of Shifts. This could make your ‘% Booked’ value seem higher than it is, compared to if you only look at appointments booked on the Shift.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/f6ca3473-9c83-43b7-be84-8371248ca0cc)
- ![](https://jane.app/thumbs/5c351ff8-75f2-4779-9e78-ea419c59b8ea)
- ![](https://jane.app/thumbs/680507b8-d112-4b2b-90d5-f598d0ab0f7f)
- ![](https://jane.app/thumbs/65e3ef39-00b5-412a-b5c3-9d7a0a1ce88d)
- ![](https://jane.app/thumbs/d18b5fef-bfaa-451b-9d40-83a1f517d030)
