...
*Source: [https://jane.app/guide/referral-report](https://jane.app/guide/referral-report)*

*Category: Reports*

*Scraped: 2025-08-07 02:27:39*
...
Feature OverviewReferral Report
Reports
Referral Report
5 min read
Balance Plan
...
Anyone
: The totals for all referral within the account. Encompasses the two clinic and staff member subdivisions below.
The Clinic:
The totals for patients referred to the clinic (but no practitioner in general)
A Staff Member:
The totals for patients who were referred specifically to this staff member.
...
If you would like to add some additional options to this drop-down, this list of referral options can be edited by a
Full Access User
under the
...
Administratively, staff members are not limited to selecting an option from the pre-determined list of referral options, and you can enter any information you would like into this referral field. Jane will auto-populate any source that’s been used before so that your data will be as compiled as possible. This can be done under the
Patient’s Profile > Edit/Settings
area.
...
Filter and Export
You can see by date range the number of clients that have come in by that referral source and the amount of income they represent. You will be able to toggle between the
Collected (Cash)
and
Invoice (Accrual)
versions of the report, depending on your preferred method of accounting.
Collected (Cash):
Based on the total value of payments applied during the specified date range. While the payments considered have been applied during the date range, the particular invoices that these payments are applied to may not necessarily fall within the specific date range.
Invoice (Accrual)
Totals up all of the invoice values during the specified date range, regardless of whether the invoices have been paid or not.
...
Can I merge referral types together?
No, a staff member with
Full Access
will need to manually update the types of referrals in the
Settings
>
Language
>
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Referral Report
Reports
Referral Report
5 min read
Balance Plan
Practice Plan
Thrive PlanThe referral report can be handy when looking to track how your patients are being referred and to whom (either to a specific practitioner or to the clinic in general).
Staff members with
Administrative/All Billing access or higher
can head over to the
Reports
...
>
Referral Sources
area.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/04/30/hx16bfdci_blob)
- ![](https://jane.app/thumbs/549d1854-68b4-4c4b-a07a-2b391b9d2b9c)
- ![](https://jane.app/system/dragonfly/production/2016/04/30/9ryjhqybcd_blob)
- ![](https://jane.app/thumbs/6252a1cf-ba49-4f64-96c1-e49d63e75609)
- ![](https://jane.app/system/dragonfly/production/2016/04/22/71bqet6pan_blob)
- ![](https://jane.app/thumbs/c74399df-388b-4b83-8731-1027400645d5)
- ![](https://jane.app/thumbs/ab5327bc-b81e-481e-b4ea-4a35956101ad)
- ![](https://jane.app/thumbs/069f4fcf-682f-4d78-b290-57d3efa2ea77)
