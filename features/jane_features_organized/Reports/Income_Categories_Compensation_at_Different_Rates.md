...
*Source: [https://jane.app/guide/income-categories-compensation-at-different-rates](https://jane.app/guide/income-categories-compensation-at-different-rates)*

*Category: Reports*

*Scraped: 2025-08-07 02:38:37*
...
Feature OverviewIncome Categories (Compensation at Different Rates)
Staff Profiles
Income Categories (Compensation at Different Rates)
7 min read
Balance Plan
...
⚠️ It is important to note that making changes to a staff member’s Commission Rate for an Income Category will retroactively change past Compensation Reports. For example, if a staff member’s Commission Rate was 60% for their first six months and it is then increased to 65%, once the Commission Rate is increased in Jane the staff member’s Compensation Reports for those initial six months will be updated to reflect the current 65% Commission Rate. For this reason, we strongly recommend exporting or printing past reports before making changes to an existing staff member’s Commission Rate.
📍 Jane Payments and the Compensation Report serve distinct functions and operate independently. For clinics looking to pay out percentages to their staff, we recommend using a single Jane Payments account and utilizing the Compensation Report to manage payouts externally.
Additionally, directly splitting a single payment across multiple Jane Payments accounts is not supported. The payment, minus the processing fee, will be 100% deposited into the linked bank account.
...
Do not put a zero here - Jane won’t let you anyway - but that would mean that you don’t want to pay your staff anything at all if the patient was directly referred, which I can’t imagine is the case :)
...
If you are working with this report within Jane, you will be able to filter between Appointments and Product sales. However, the data is also filterable by Income Category if you were to
export the report to a spreadsheet file
— there will be an additional “Income Category” column which you can use to sort and analyze the information further. This will allow you to review your profit by category and see how much you’ve sold or how popular certain categories of treatments are.
...
How can I change a practitioner’s commission?
If commissions need to be changed or updated, staff members with
Administrative/All Billing
or
Full Access
can head into the specific staff member’s
Profile
, click on
Edit/Settings
and then on
...
pencil icon
, you can change the commission rate for each income category.
Jane will redirect you to the page where you can edit the commission based on the income category and specific staff member.
Note
📝:
Jane reports are live, so changes to the commission rates will impact the
Compensation Report
in the past and present. A recommendation here would be to
export the report
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Income Categories (Compensation at Different Rates)
Staff Profiles
Income Categories (Compensation at Different Rates)
7 min read
Balance Plan
Practice Plan
Thrive PlanOften you will want to compensate your staff differently for different types of products.   Income categories will allow you to both pay your staff a different rate and also to break down categories of income in your reporting. I probably shouldn’t be so excited about that, but I am.
This document will talk about the Setup, Adding Products or Treatments to a Category, and how you can Report on them.
⚠️ It is important to note that making changes to a staff member’s Commission Rate for an Income Category will retroactively change past Compensation Reports. For example, if a staff member’s Commission Rate was 60% for their first six months and it is then increased to 65%, once the Commission Rate is increased in Jane the staff member’s Compensation Reports for those initial six months will be updated to reflect the current 65% Commission Rate. For this reason, we strongly recommend exporting or printing past reports before making changes to an existing staff member’s Commission Rate.
📍 Jane Payments and the Compensation Report serve distinct functions and operate independently. For clinics looking to pay out percentages to their staff, we recommend using a single Jane Payments account and utilizing the Compensation Report to manage payouts externally.
Additionally, directly splitting a single payment across multiple Jane Payments accounts is not supported. The payment, minus the processing fee, will be 100% deposited into the linked bank account.
...
export the report
before making this change.
If your clinic uses a different compensation model like tiered rates, flat rates, or hourly punch-in punch-out rates, those commissions will need to be tracked and calculated outside of Jane.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/aaf20c35-d9bc-4c67-8b6c-8e41be8466af)
- ![](https://jane.app/thumbs/fbb4e5d0-65c7-4068-9146-4b714b211376)
- ![](https://jane.app/thumbs/701d9066-67a9-4a14-8ac2-b2c9932900c1)
- ![](https://jane.app/thumbs/241df406-69b4-4cda-b021-11829b6f1f0d)
- ![](https://jane.app/thumbs/ecc19119-e4cc-46cd-a286-282322e732b6)
- ![](https://jane.app/thumbs/65816d73-2972-4293-a714-cab017e3d93b)
- ![](https://jane.app/thumbs/d4096bf8-e574-4ef7-87a7-9a81b73d7ac4)
- ![An image of the navigational steps](https://jane.app/thumbs/8c760f3a-1f4d-4f04-b97a-65b072b4ccaf)
- ![An image of what the redirect looks like and how to adjust the compensation for each staff member](https://jane.app/thumbs/dbdecd41-65de-4baf-a9b8-96fef646f9a3)
