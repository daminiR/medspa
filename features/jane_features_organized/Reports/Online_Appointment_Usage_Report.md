...
*Source: [https://jane.app/guide/online-appointment-usage-report](https://jane.app/guide/online-appointment-usage-report)*

*Category: Reports*

*Scraped: 2025-08-07 02:33:41*
...
Feature OverviewOnline Appointment Usage Report
Reports
Online Appointment Usage Report
3 min read
Balance Plan
...
Note
📝:
If you’re looking for a list of all the appointments booked through your online booking site, you’ll want to use the
Appointments Report
filtered to
Booked Online
. Check out our guide doc on the
...
: Jane starts the timer for an Online Appointment when both participants are in the video session, and stops when a participant hangs up.
Online Appointments for Groups
: The timer starts as soon as the first client is welcomed into the call. The time spent in the waiting room does not count. The timer stops when the call is ended by the practitioner
...
support@janeapp.com
if you have any further questions about the Online Appointment Report.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Online Appointment Usage Report
Reports
Online Appointment Usage Report
3 min read
Balance Plan
Practice Plan
Thrive PlanWhat’s the Online Appointment report?
This report shows you all of the Online Appointments made for the date range selected so clinic owners can see how Online Appointments are being used across practitioners.
Note
📝:
If you’re looking for a list of all the appointments booked through your online booking site, you’ll want to use the
...
We hope that this is helpful! Don’t hesitate to reach out to us at
support@janeapp.com
if you have any further questions about the Online Appointment Report.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/eaafdb68-f4db-4801-acb3-80446bb9a593)
- ![](https://jane.app/thumbs/1f86e99d-0140-410c-836d-5ccaebb87e8a)
- ![](https://jane.app/thumbs/982e2895-e2b6-4c52-ae75-d21172b2a122)
