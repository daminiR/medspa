...
*Source: [https://jane.app/guide/box-18](https://jane.app/guide/box-18)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:21:16*
...
What’s in the box?
If a patient is seeking treatment for a condition that resulted in a hospital admission— and the hospital admission and/or discharge dates are known to impact the payer’s adjudication process— then report the patient’s hospital
Admission
and/or
Discharge
dates.
...
and
Discharge
dates can be added when editing or creating a new Insurance Policy (
Profile > Billing tab > Insurance Policies > View + Edit
or
New Insurance Policy
).
**
Is this information required in Jane?
This information is
optional
when creating an Insurance Policy, and is only needed if relevant to the patient’s condition and known to affect the Insurer’s adjudication process.
What about the EDI file?
Both the Hospitalization Admission and Discharge dates are sent in
...
The qualifier for ‘Admission’ is
435
, and is sent in
DTP01
The date is sent in
...
date is sent in
Loop 2300, Segment DTP
The qualifier for ‘Discharge’ is
096
, and is sent in
DTP01
The date is sent in
DTP03
Note that if both the Hospitalization Admission and Discharge date are included in the submission, the
Admission DTP segment comes before the Discharge DTP segment
.
Here’s an example where both segments are included:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 18
US Insurance Billing Additional Resources
Box 18
2 min read
Practice Plan
Thrive PlanHospitalization Dates
What’s in the box?
If a patient is seeking treatment for a condition that resulted in a hospital admission— and the hospital admission and/or discharge dates are known to impact the payer’s adjudication process— then report the patient’s hospital
Admission
and/or
...
Admission DTP segment comes before the Discharge DTP segment
.
Here’s an example where both segments are included:Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b0d0a27a-37af-4f45-894c-e5f20e4b50d5)
- ![](https://jane.app/thumbs/a7c966be-796c-44c0-b196-efb49c61fde0)
- ![](https://jane.app/thumbs/ddee309a-dc1b-4976-a5d4-a29a91530fb4)
