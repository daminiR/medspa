...
*Source: [https://jane.app/guide/how-to-attach-supporting-documents-to-claims-in-claim-md](https://jane.app/guide/how-to-attach-supporting-documents-to-claims-in-claim-md)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:30:21*
...
Feature OverviewHow to Attach Supporting Documents to Claims in Claim.MD
...
Thrive Plan
Legacy Plans
Sometimes you’re required to submit insurance claims with supporting documentation, like patient chart notes. At this time, you can’t send chart notes with claims directly from Jane, but this can be managed in your Claim.MD portal.
How often do you attach charts to claims?
If you only need to attach documentation to claims once in a while you can
export your file in Jane
, then head to Claim.MD to
attach the documentation
and submit your claims.
If you’re required to submit documentation for most of your claims, we recommend that you turn on
Transmit Approval Required
in your Claim.MD portal under S
etting > Account Settings
. This pauses claims submitted through Jane in ClaimMD so documentation can be attached to those claims that require it. Transmission is approved in bulk in Claim.MD once you’re ready.
Additional resources
Check out Claim.MD’s guide
Transmitting and Approving Claims in Claim.MD.
If you use Claim.MD and would benefit from attaching chart notes to claims
sent directly from Jane
, we’d love for you to take a moment to add your vote to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Attach Supporting Documents to Claims in Claim.MD
US Insurance Billing Additional Resources
How to Attach Supporting Documents to Claims in Claim.MD
2 min read
Practice Plan
Thrive Plan
Legacy PlansSometimes you’re required to submit insurance claims with supporting documentation, like patient chart notes. At this time, you can’t send chart notes with claims directly from Jane, but this can be managed in your Claim.MD portal.
How often do you attach charts to claims?
If you only need to attach documentation to claims once in a while you can
export your file in Jane
, then head to Claim.MD to
