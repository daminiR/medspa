...
*Source: [https://jane.app/guide/box-29](https://jane.app/guide/box-29)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:15:52*
...
However, if you collect a patient responsibility at the time of service (
copay
,
coinsurance
, or
deductible)
, or the patient prepays for the visit (i.e. courtesy billing), then that amount will be put in this box.
...
Note:
Jane will populate the primary insurer-paid amount into Box 29 when submitting secondary claims through Jane.
...
So, even if the client has paid a portion of the visit at the time of service, or a payer has paid a portion, it will
not
be sent in the EDI.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 29
US Insurance Billing Additional Resources
Box 29
2 min read
Practice Plan
Thrive PlanAmount Paid
What’s in the box?
The amount that the patient and/or other payer has already paid towards the claim.
Where does this info live in Jane?
The value in this box is set automatically, based on Payments that are Applied in Jane.
...
So, even if the client has paid a portion of the visit at the time of service, or a payer has paid a portion, it will
not
be sent in the EDI.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/98e69a4d-a96c-4206-a9a4-48855477291b)
