...
*Source: [https://jane.app/guide/treatment-specific-cpt-codes](https://jane.app/guide/treatment-specific-cpt-codes)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:32:51*
...
Feature OverviewTreatment-Specific CPT Codes
...
Have a specific question in mind? Skip ahead to our
FAQ section
⬇️
...
Click
Edit
beside a treatment if you’d like to update an existing one, or
New Treatment
to add a new one.
In the treatment setup screen, you’ll see a field for
Default Billing Code
. You can either type in the CPT code if you know it, or search using a keyword — just like you would when adding a billing code to an appointment.
Once you’ve added the code, click
Save
, and Jane will start automatically adding that CPT code to new appointments booked with that treatment.
❗This only applies to appointments booked after the change is made. It won’t update anything already on the schedule.
💡
Note:
The fee associated with the billing code will override the treatment fee — so you’ll want to make sure your CPT codes are set up correctly. If you need a refresher on billing codes, check out
our guide on setting up billing codes
.
...
No
- currently, they can only be added to a
one-on-one
appointment.
If you have any questions or run into anything unexpected, we’re just a message away. Reach out to us at
support@jane.app
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Treatment-Specific CPT Codes
US Insurance Billing Additional Resources
Treatment-Specific CPT Codes
5 min read
Practice Plan
Thrive Plan
Legacy PlansIf your clinic uses CPT codes for insurance billing, Jane can help take one more thing off your plate. You can now add a default CPT code to a treatment so it’s automatically included whenever that treatment is booked, whether administratively by staff or online by patients or clients. It’s a simple way to make sure that billing codes don’t get missed and your workflow stays smooth.
Have a specific question in mind? Skip ahead to our
FAQ section
⬇️
Let’s walk through how it works.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/92cf0a03-801c-4693-bac7-d8259d6803c9)
- ![](https://jane.app/thumbs/7c7daed5-d873-43c8-a383-9e8122f2ee26)
- ![](https://jane.app/thumbs/ce62f806-0139-4295-9013-be091f42016b)
- ![](https://jane.app/thumbs/4c62f01e-cc52-4d38-8c36-82b6b565d8e7)
