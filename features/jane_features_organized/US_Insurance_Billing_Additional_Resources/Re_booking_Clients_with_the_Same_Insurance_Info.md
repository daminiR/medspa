...
*Source: [https://jane.app/guide/re-booking-clients-with-the-same-insurance-info](https://jane.app/guide/re-booking-clients-with-the-same-insurance-info)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:25:55*
...
Feature OverviewRe-booking Clients with the Same Insurance Info
...
If so, you can copy insurance information (i.e. policy information, diagnosis codes and billing codes) either when booking a patient visit or after the patient has booked to save yourself some time. This applies for both cash and insurance patients!
Copying Codes at the Time of Booking
Copying Codes After the Appointment is Booked
Copying Codes at the Time of Booking
If you book your patient in on the administrative side of Jane, you have the option of using the
Copy
button, or the
Copy Previous
option when booking a fresh appointment, to copy past insurance information. This can include CPT and Diagnosis codes, modifiers, patient policy(ies), and past patient responsibilities (i.e. co-pays).
...
Selecting the
Same as Previous
option will copy the insurance info over from the patient’s last visit.
...
When entering patient insurance information (“policies”) on their profile, the bottom area of the patient policy gives you the option to add in
default insurance information
.
...
to an appointment when you attach the policy. This comes in handy if the patient sees you for the same treatment where the same or similar procedures are performed.
...
1) Bring forward all billing codes, diagnosis codes, and insurance policy details from a previous visit. (This function was previously labeled Copy Previous.) You can either carry over the information from the patient’s last appointment, by clicking
Add all details
, or click on the
drop-down arrow
to select a different previous appointment to copy the details from.
💡 Hovering over the “i” button will show more details about the previous appointment, including the time of the visit, the type of treatment that was booked, and the practitioner the appointment was scheduled with.
2) Click
Add diagnosis codes
to copy just the diagnosis codes (ICD-10) from the most recent visit. This option is helpful when you’ve already added procedure codes (through default billing codes, for example), and just want to bring forward the related diagnoses.
Note: For the Add diagnosis codes option to be clickable, the current visit needs to have a procedure/CPT code applied, and the previous visit needs to have at least one ICD-10/diagnosis code applied.
More Questions?
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Re-booking Clients with the Same Insurance Info
US Insurance Billing Additional Resources
Re-booking Clients with the Same Insurance Info
6 min read
Practice Plan
Thrive PlanNeed to book in a patient for a subsequent visit where all (or most) of the Insurance Info will be the same as a previous service date?
If so, you can copy insurance information (i.e. policy information, diagnosis codes and billing codes) either when booking a patient visit or after the patient has booked to save yourself some time. This applies for both cash and insurance patients!
Copying Codes at the Time of Booking
Copying Codes After the Appointment is Booked
Copying Codes at the Time of Booking
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/19bfe83b-1d43-4951-b45e-8797c76c9bcb)
- ![](https://jane.app/thumbs/fea532ca-8d15-4f9f-b007-8c218f3a76ee)
- ![](https://jane.app/thumbs/8e39a8fc-9c49-4a3b-993d-aaa40ec9b0d5)
- ![](https://jane.app/thumbs/f7d4b3df-936f-42c6-9500-e0db78300173)
- ![](https://jane.app/thumbs/1869ddaa-ca00-4653-a429-58f6903ef759)
- ![](https://jane.app/thumbs/f2217449-658b-44eb-9874-5ab7854b45d2)
- ![](https://jane.app/thumbs/4aac50a3-f551-43f3-9ad2-9e65c6fa0609)
- ![](https://jane.app/thumbs/efa962cc-66b2-4cd9-bc9e-9341734b29db)
