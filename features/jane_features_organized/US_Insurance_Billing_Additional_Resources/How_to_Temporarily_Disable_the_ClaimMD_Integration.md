...
*Source: [https://jane.app/guide/how-to-temporarily-disable-the-claim-md-integration](https://jane.app/guide/how-to-temporarily-disable-the-claim-md-integration)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:30:55*
...
Feature OverviewHow to Temporarily Disable the Claim.MD Integration
...
Thrive Plan
Legacy Plans
Sometimes clinics need to switch back and forth between Clearinghouses, like when you’re waiting for the green light on EDI enrollment for claims submitted through Claim.MD.
...
Integrated Claims
section.
Lastly, you can click on the red
Disconnect
button.
From there, head over to the
Billing Settings
area within the
Settings
tab. You’ll want to scroll down to the
Insurance
section and set the Clearinghouse to the
blank option
within the dropdown menu.
When you’re ready to reconnect the integration again, you’ll want to login to your Claim.MD account, head over to
Settings
and then to
Account Settings
.
...
under the
STFP Password
section. Now, you’ll want to copy the new SFTP username and password, and head back over to your Jane account to paste the credentials within the Claim.MD integration details.
For more details on how you can reconnect
Claim.MD
to Jane again, check out our
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Temporarily Disable the Claim.MD Integration
US Insurance Billing Additional Resources
How to Temporarily Disable the Claim.MD Integration
2 min read
Practice Plan
Thrive Plan
Legacy PlansSometimes clinics need to switch back and forth between Clearinghouses, like when you’re waiting for the green light on EDI enrollment for claims submitted through Claim.MD.
To start, you’ll want to head over to the
Settings
tab,
Integrations
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps](https://jane.app/thumbs/58bb1555-1c50-4b00-b97d-b6c0a49d8b18)
- ![An image of where to view and click on the edit button within the Clearinghouse section](https://jane.app/thumbs/656a3546-db5c-4060-baf8-884c2e99402b)
- ![An image of the navigational steps and where to select the clearinghouse option](https://jane.app/thumbs/b7953a2b-498f-4986-bff3-c0c762938bb5)
- ![An image of the navigational steps within Claim.MD's platform](https://jane.app/thumbs/2d664d5d-988a-47e4-8141-2b26aec4892d)
