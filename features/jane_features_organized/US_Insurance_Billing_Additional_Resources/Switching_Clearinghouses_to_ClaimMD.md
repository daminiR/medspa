...
*Source: [https://jane.app/guide/switching-clearinghouses-to-claim-md](https://jane.app/guide/switching-clearinghouses-to-claim-md)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:08:50*
...
Feature OverviewSwitching Clearinghouses to Claim.MD
...
✍️ If you’d like to print off this checklist to keep on your desk, you can
download the PDF version.
📺 You can also watch the 20-minute session we hosted with Sara from Bushido Billing
on youtube.
Step 1: Sign up with Claim.MD
You can take a look at Claim.MD’s subscription plans
here
, and if you have any questions, you can schedule a demo with the Claim.MD team.
Once you’re ready, you can
sign up here
.
Don’t forget to indicate that Jane is your vendor to
receive 10% off your monthly subscription.
⚠️ Hang on to your current clearinghouse during this transition
There’s often a short transition period while insurer enrolments are finalized. Some insurers need to receive a claim before they can fully complete the process, which can take anywhere from 5 to 30 days. During this time, you may see responses flow into both Claim.MD and your previous clearinghouse. We recommend keeping access to your current clearinghouse until you’ve confirmed that all enrolments are complete and claims are processing smoothly in Claim.MD.
Step 2: Start the enrolment process
Check that all of your business information is up-to-date
Head to
Manage Account > Prov. Enrolment
in your Claim.MD account, where you’ll see that the enrolment process has been started for you! Many can be completed with a single click.
🔥
Tip
: Even with this pre-populated in Claim.MD, it might be helpful to create your own checklist to work from. You can use
Claim.MD’s payer list
to double-check the enrolment requirements for EDI, ERA, and Eligibility for all insurers you submit to.
...
Once all your approvals have been handled & confirmed, you can start billing with
Jane and Claim.MD
!
Optional: Medicare
If you submit claims to Medicare, you may need to look out for a couple of additional things:
Your Medicare Administrative Contractor (MAC) is often unique to the state you practice in— follow the enrolment guide for your state & MAC provider, as found on your MAC provider’s website:
cms.gov/mac-info
cms.gov/files/document/ab-jurisdiction-map-jun-2021.pdf
cms.gov/medicare/enrollment-renewal/annual-participation-announcement
Depending on your MAC provider, you may need to create a login from Medicare’s website & portal, complete a form, or do both. Details can be found using the above links.
Additional Notes
How do I fix the “Payer ID is invalid” error message?
The Payer ID is a unique identifier for insurers used in electronic claims submissions. If you encounter an issue with an invalid Payer ID, you can verify the correct number for your Clearinghouse.
For
Claim.MD
, check here https://www.claim.md/payer-list
For
Office Ally
, check here https://cms.officeally.com/payerlist
For
Trizetto,
you can log in to your Trizetto account: https://www.trizettoprovider.com/Resources/Payer-List
For
Availity,
you’ll want to login to your Availity account:  https://www.availity.com/edi-clearinghouse/
If you have any questions, feel free to reach out to
Jane’s support team
or the
Jane US Billing Community
on Facebook, where professionals like Sara from Bushido Billing are more than happy to give you a hand! 😁
If you’d like to learn more about Sara and Bushido Billing, you can schedule a call by visiting
www.bushidobilling.com
or emailing Sara.Hansen@BushidoBilling.com
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Switching Clearinghouses to Claim.MD
US Insurance Billing Additional Resources
Switching Clearinghouses to Claim.MD
5 min read
Practice Plan
Thrive Plan
Legacy PlansIn partnership with our friends at Bushido Billing, we’ve created a handy checklist for when you’re switching clearinghouses— like, say, from your current clearinghouse to Claim.MD in order to enjoy Jane’s insurance billing integration. 😉 Let’s dive in!
✍️ If you’d like to print off this checklist to keep on your desk, you can
download the PDF version.
📺 You can also watch the 20-minute session we hosted with Sara from Bushido Billing
on youtube.
...
If you’d like to learn more about Sara and Bushido Billing, you can schedule a call by visiting
www.bushidobilling.com
or emailing Sara.Hansen@BushidoBilling.comSubscribe to our monthly newsletter.Jane Software Inc.
