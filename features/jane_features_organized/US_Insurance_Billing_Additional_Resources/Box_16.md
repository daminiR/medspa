...
*Source: [https://jane.app/guide/box-16](https://jane.app/guide/box-16)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:09:20*
...
The ‘
From
’ date in the range is the
Last Date
the patient was able to work. The ‘
To
’ date in the range is the date the patient was able to
Return to Work
.
Where does this info live in Jane?
You can add a Last Worked date and a Return to Work date within the patient’s Policy (
Patient Profile > Billing tab > Insurance Policies > View + Edit
or
New Insurance Policy)
.
Note:
if both dates are filled in, the Last Worked date must be before Return to Work date (unless a time machine was involved). 😉
Is this required?
This information is
optional
and should only be reported if applicable to the patient’s case.
What about the EDI file?
Both the Last Worked and Return to Work dates are send in
Loop 2300 - Claim info
. Each date type is sent in its own segment. If both dates are present, the Last Worked date segment is sent first.
The
Last Worked
date is sent in Loop 2300 Segment DTP
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 16
US Insurance Billing Additional Resources
Box 16
2 min read
Practice Plan
Thrive PlanDates Patient Unable to Work
What’s in the box?
If a claim is related to an injury that caused the patient to miss work, this box is used to indicate the date range where the patient was unable to work in their current occupation.
The ‘
From
...
date is sent in Loop 2300 Segment DTP
DPT01 includes the qualifier for Return to Work → ‘296’
DTP03 includes the dateSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/04dda804-2b7b-4f45-8ff5-37176615409d)
- ![](https://jane.app/thumbs/1de7d4be-ecbe-4b85-a89a-ce422ae9a337)
- ![](https://jane.app/thumbs/eb0b7c1e-bb11-4117-85c4-21f0c045c92f)
