...
*Source: [https://jane.app/guide/what-s-an-era-in-insurance-billing](https://jane.app/guide/what-s-an-era-in-insurance-billing)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:00:39*
...
Feature Overview🇺🇸 What's an ERA in Insurance Billing?
US Insurance Billing Additional Resources
🇺🇸 What's an ERA in Insurance Billing?
9 min read
Practice Plan
Thrive Plan
ERA Meaning in Insurance Billing
Ah, yes. We thought you’d never ask! 😉
Ahem
… an ERA is an Electronic Remittance Advice. It’s a bit of a mouthful so we’ll refer to it as an ERA or remittance for simplicity’s sake moving forward. In the form of an 835 transaction, a remittance is basically one big text file that different systems, like Jane, can process.
The remittance provides details about insurers/payers’ claim payments… important details like the Paid Amounts and Patient Responsibility, or why a claim may be denied with an explanation.
How do remittances fit into the claim submission process?
When you submit a batch of claims to your clearinghouse, the clearinghouse forwards those claims to the respective insurers/payers. When the claim is received, the insurer will process it in a (hopefully) timely manner. During this process, the insurer determines what they’ll pay, what the patient should pay, and what amounts should remain unpaid. Insurers usually do this for many claims at once, and then send all of that data back to your clearinghouse in the form of an ERA.
What’s new with ERAs?
Previously, when a new ERA was available in your clearinghouse, you would have to pop in, download that remittance & upload it into Jane. With Jane’s new integration that allows
Integrated Claims with Claim.MD
, you won’t have to do this anymore! 🎉
Once Claim.MD receives an ERA, it will automatically be sent to your Jane Remittances folder where you can then use Jane’s ERA Management Tool to quickly & easily record payment.
If you choose not to enable this, you can download ERAs from your clearinghouse and then upload them to your Remittances folder. Once you’ve uploaded an ERA, you can post the payment using the ERA Management Tool.
Pro Tip: It isn’t always easy to tell the difference between
electronic remittance
and
paper remittance
options. PDFs, ZIPs, and Spreadsheet files (i.e., CSVs) cannot be processed as electronic remittances. Your clearinghouse should have the option to download ERAs in one of the following formats: 835, x12, txt, or dat.
Regardless of the method you choose, the ability to upload ERAs eliminates a lot of the manual entry work involved in posting payments from paper remittances, freeing up your time for other priorities at the clinic.
Electronic Remittance Management in 5 Steps
Here’s a simple step-by-step process we put together for our visual learners. We hope it’s helpful!
Use the arrows on the image to scroll back and forth through the steps!
Previous
Next
So, what’s the value of the ERA Management Tool? Is it really just a way to upload an electronic file into Jane?
Yes, and well, it was a
critical step to remove manual entry from the original process
.
Here’s how we sped up the process:
✅
Jane queues up the insurance payment.
No more searching for EFT and Check numbers.
✅
Jane links all ERA claim responses to those in your account.
Say goodbye to the invoice search bar.
✅
Jane displays the key remittance details right in front of you - both for the overall payment and for each claim response.See everything you need to in Jane.
No paper EOBs and no need for a second tab.
✅
Jane pre-fills the EOB screen with the info from the claim response.
No more manual entry.
Note📝
:
To manage or import ERAs in Jane, you’ll want to head over to the
Billing
tab >
Remittances
.
...
. To learn how to use Jane’s ERA Management Tool, you can take a look at the following guides:
Posting Insurer Payments with ERAs
ERA FAQ
.
Or, hop on over to our training
here
.
🎬 For a more in-depth look at this tool, you can watch our recorded webinar from our Allied 2021 Summer School, ‘
A New ERA: US Insurance Billing Features in Jane
’.
If you have any questions, we always love hearing from you. You can email our support team at support@jane.app.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)🇺🇸 What's an ERA in Insurance Billing?
US Insurance Billing Additional Resources
🇺🇸 What's an ERA in Insurance Billing?
9 min read
Practice Plan
Thrive PlanERA Meaning in Insurance Billing
Ah, yes. We thought you’d never ask! 😉
Ahem
… an ERA is an Electronic Remittance Advice. It’s a bit of a mouthful so we’ll refer to it as an ERA or remittance for simplicity’s sake moving forward. In the form of an 835 transaction, a remittance is basically one big text file that different systems, like Jane, can process.
The remittance provides details about insurers/payers’ claim payments… important details like the Paid Amounts and Patient Responsibility, or why a claim may be denied with an explanation.
...
A New ERA: US Insurance Billing Features in Jane
’.
If you have any questions, we always love hearing from you. You can email our support team at support@jane.app.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e3715350-84f8-40eb-b68d-3fe97a442188)
- ![](https://jane.app/thumbs/56af715c-7a0f-49c4-a385-4f12ab8318fc)
- ![](https://jane.app/thumbs/51e19b91-3365-452f-9eae-81795c1acb77)
- ![](https://jane.app/thumbs/5b29c3d9-dfea-459a-88ea-e0560c4136c6)
- ![](https://jane.app/thumbs/113f0e7d-5b49-4dbd-8d49-b38fb828e239)
- ![](https://jane.app/thumbs/fd4d8f38-7335-4cea-b6ab-782dea513533)
- ![](https://jane.app/thumbs/387fafd5-4d3d-405b-be9a-d162c59a08af)
