...
*Source: [https://jane.app/guide/box-6](https://jane.app/guide/box-6)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:19:56*
...
Feature OverviewBox 6
US Insurance Billing Additional Resources
Box 6
3 min read
Practice Plan
Thrive Plan
Patient Relationship To Member/Insured
What’s in the box?
...
This can be found by heading to the
...
Note
: by default, each new Policy is set to
Self,
which means the patient is the Policyholder. If an option other than Self is chosen, then a prompt to fill out some information for the Insured will appear.
Is this required?
The patient’s relationship to the Insured is
required
on the CMS1500.
The patient’s relationship to the Insured is
required
...
Although the patient’s relationship to the insured is always
required
,
where
this information is sent in the EDI is
situational
.
Option 1: Patient is the Subscriber
If the patient is also the subscriber (the patient is the one who holds the insurance policy), then
Loop 2000C - Patient
is
not sent in the EDI
. In this case, the patient relationship to the insured is only indicated in
Loop 2000B - Subscriber
.
The patient’s relationship to the insured is sent in HL - Loop 2000B - Subscriber,
Segment HL04
0
will be sent in this scenario (‘0’ means the patient is the subscriber)
Option 2: Patient is not the Subscriber
If the patient is
not
the subscriber (i.e. their spouse is the Policyholder and they are covered under that Policy), then the patient relationship to the Insured is sent in
Loop 2000B - Subscriber
AND it is also sent in
Loop 2000C - Patient
.
The patient’s relationship to the insured is sent in
HL - Loop 2000B - Subscriber, Segment HL04
1
will be sent in this scenario (‘1’ means the patient is not the subscriber)
The patient’s relationship to the Insurer is sent in
HL - Loop 2000C - Patient, Segment PAT01
The following possible options for relationships:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 6
US Insurance Billing Additional Resources
Box 6
3 min read
Practice Plan
Thrive PlanPatient Relationship To Member/Insured
What’s in the box?
This box indicates the patient’s relationship to the Insured (the Policyholder). For example, if the patient is the Policyholder (their Policy Member ID is reported in box 1a), then check ‘Self’.
Where does this info live in Jane?
This can be found by heading to the
...
The patient’s relationship to the Insurer is sent in
HL - Loop 2000C - Patient, Segment PAT01
The following possible options for relationships:Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/458aa1d7-6b17-4612-8b42-b3d79eb8558d)
- ![](https://jane.app/thumbs/b9580303-f310-4896-91ff-3012d76a4d92)
- ![](https://jane.app/thumbs/22efd3e0-b4ce-45d0-a84b-8e5d2e190fc2)
- ![](https://jane.app/thumbs/a346f35c-07f2-44e1-aa33-ffa69cb12a98)
- ![](https://jane.app/thumbs/37209020-e4e7-4bc9-811e-d340c8bc9765)
