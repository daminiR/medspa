...
*Source: [https://jane.app/guide/creating-and-setting-up-insurers-us](https://jane.app/guide/creating-and-setting-up-insurers-us)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:28:30*
...
Feature OverviewCreating and Setting Up Insurers (US)
US Insurance Billing Additional Resources
Creating and Setting Up Insurers (US)
5 min read
Note
📝:
This is for accounts with the
Insurance Add-on
...
Adding the Insurance add-on
.
To start creating insurers, a staff member with
Administrative / All Billing
access to the account can head over to the
Settings
...
While the only
Required
field is the insurer’s name, let’s break down what each of these options are to ensure smooth sailing with your insurance claims ⛵️
Note 📝:
If you plan on using our internal EDI generation tool, you’ll want to make sure to enter the Insurer’s full address as well.
Billing Portals
You may also enter a portal is appropriate. This could be a clearinghouse billing portal such as
Office Ally
,
Trizetta
, and/or
Availity
. This will allow you to launch the portal directly for claim submissions.
You can view some more information about managing claims and portals in this guide:
Generating an EDI to Submit to a Clearinghouse
.
Default User Fee
When setting up your insurers, you can select if there is an administrative fee associated with handling this insurance process. This default charge will be added to the Patient’s Invoice.
The actual amount you bill to each of your patients will be based on the coverage set on the claim you’ll create for each patient following this guide:
Creating a Patient Claim (US)
...
Some insurers treat each unit of a procedure individually, while others will treat all units of a procedure as a single or grouped line item on the bill. Additionally,  insurers will combine CPT units into one line, so before toggling on this option you may want to check with the insurer if they would prefer to treat them as separate line items.
The default for new insurers you create in Jane will be
treat multiple units of the same procedure as a single - or grouped - line item
. This means that when billing multiple units of a procedure, Jane will display a single Allowed Amount and a single line on the
EOB Screen
for all units.
Insurer Submits Claims to Secondary Payer
When this preference is enabled, in most cases secondary claims will move through the claim submission folders differently whenever this specific insurer is the primary payer for a patient with two insurance policies.
Note
📝:
While this can be toggled on for all insurers, this primarily would be used for Medicare
.
When a primary claim is submitted to the insurer, any associated secondary claim is automatically marked as submitted. This saves a little bit of time by submitting them both in one go.
Payer ID
This is a unique identifier for insurers. It is used in electronic claims submissions to specify the insurance company to which the claim is being sent. If the insurer does not have a Payer ID, you’ll want to enter the word
PAPER
in the
Other Payer ID
...
Note
📝:
You can verify the Payer ID with your Clearinghouse if you’re unsure of what this number would be
.
If you’re unable to find the Payer ID listed, you’re also able to create a custom Payer ID by entering it in the
Other Payer ID
field.
Insurance Program
This field is used to indicate the type of coverage or insurance program being submitted. This information is required when billing via EDI file and is optional on the CMS1500 form.
You’ll want to make the selection from the dropdown menu options.
More Questions?
...
Insurer Underpayment (Receiving an EOB)
Editing Date of Insurer Payments
Delete Insurer Payments
Launching Insurer Portal
Re-Setting Insurance Claim Counts/Limits
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating and Setting Up Insurers (US)
US Insurance Billing Additional Resources
Creating and Setting Up Insurers (US)
5 min readNote
📝:
...
Launching Insurer Portal
Re-Setting Insurance Claim Counts/Limits
Grouping Insurer InvoicesSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of navigational steps](https://jane.app/thumbs/e39bfdde-1511-45b8-8f57-dc888ff0024c)
- ![](https://jane.app/system/dragonfly/production/2017/08/07/8rxno2ewdj_image.png)
- ![screenshot of where to enter a the administrative fee for using this insurer](https://jane.app/thumbs/6d11690c-c9f6-41ee-84c1-d149a28ba17f)
- ![screenshot of the toggle within the new insurer page](https://jane.app/thumbs/3acf3661-4e01-4d28-890a-322fd6bf24d0)
- ![screenshot of where to view the toggle within the new insurer page](https://jane.app/thumbs/dd487978-bdc6-4700-80d2-b233f22c74b7)
- ![screenshot of the toggle within the new insurer page](https://jane.app/thumbs/be2e50a2-b0fc-4b62-917e-9068738c010c)
- ![screenshot of where to view the dropdown selections within the new insurer page](https://jane.app/thumbs/f4f4da68-8861-4fe8-8a41-a6092c54d234)
