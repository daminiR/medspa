...
*Source: [https://jane.app/guide/courtesy-billing-or-patient-pre-pay-us](https://jane.app/guide/courtesy-billing-or-patient-pre-pay-us)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:04:28*
...
Feature OverviewCourtesy Billing or Patient Pre-Pay (US)
...
On every Jane account, the insurance billing default is set to
Collect from Insurance
. This means that you are expecting the insurance company to pay you (the clinic) rather than send money directly to the patient. However, you do have the option to switch a purchase on your account to
Patient Pre-Pay
if you plan on courtesy billing.
...
insuring the visit
as normal.
2) Accept Assignment & Signature on File
Next, you’ll need to view the patient’s insurance claim/policy, and confirm that
Accept Assignment
and
Signature on File
are set to
No
.
When Accept Assignment and Signature on File are set to No, this tells the insurance company they should send payment directly to the patient.
Note:
Rules may vary depending on the insurance company. We always recommend checking with the insurance company directly for individual assignment guidelines. If payment is still sent to your clinic, you will need to contact the insurer to find out why the payment was not sent to the patient.
Here are the steps:
Click the drop arrow to the right-hand side of the claim, and then select
Edit Policy:
Scroll down to find
Accept Assignment
and
Signature on File
and set these options to
No
.
As mentioned earlier, some insurers have different requirements as to what information they would like as part of that submission. While “Accept Assignment” (Box 27) and “Signature on File” (Box 13) set to ‘no’ is very common a requirement for courtesy billing, some insurers may also want Box 12 — Patient Release of Information — set to “No”. We can toggle this field from the Policy while we are setting Accept Assignment and Signature on File.
3) Turn On Courtesy Billing/Patient Pre-Pay
With the policy attached to the appointment, click on the cogwheel button, and set the option to
Patient Pre-Pay
.
When you switch a purchase to Patient Pre-Pay, Jane will still generate an insurer invoice for the
full amount of what was billed
, but Jane will also push that full amount down to the patient so you can accept their payment at the time of service. Note that the full amount is passed to the patient — so if you add Allowed Amounts to the visit, they will be ignored when generating the patient invoice.
4) Submitting the Claim
Okay, so Jane has generated the insurer invoice for the visit, now what?
Well, if you’re submitting the claim on behalf of your patient, then you’ll want to generate either a paper (CMS - 1500) or electronic (EDI) file to submit to the insurer.
You can learn all about how to do that within Jane in our US Insurance Billing series:
Start Billing 4: Claim Management & CMS 1500 Forms
Start Billing 5: EDI Claim Submission
5) Approving the Insurer Invoice
...
Alternate Workflow
There is another workflow that can be used to manage courtesy billing that some clinics prefer - by
setting Coinsurance to be 100%
.
...
All we need to do is set our Coinsurance on the visit to be 100%. You can also add the default to be 100% when
...
When using this option - you will still need to manually mark the insurer invoice as
Approved.
...
Note:
When generating a receipt or statement for the patient, these charges will be indicated as
Co-Insurance.
...
If you are looking to change the insurance mode for a claim in Canada, you’ll want to pop on over to our
Insurance Mode on Claims: Payable to Patient vs Payable to the Clinic (CA)
guide that goes over how your clinic would accomplish this in more detail.
We hope this helps! As always, let us know if you have any questions on this, we’re happy to chat this through 😊
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Courtesy Billing or Patient Pre-Pay (US)
US Insurance Billing Additional Resources
Courtesy Billing or Patient Pre-Pay (US)
8 min read
Practice Plan
Thrive PlanCourtesy Billing refers to the workflow where your patients pay at the time of service, and you as the provider submit a claim to insurance on their behalf. Patients then receive reimbursement from insurance directly. For some clinics, it’s the Goldilocks of workflows that’s hits on a sweet spot between running a cash vs. insurance practice.
On every Jane account, the insurance billing default is set to
Collect from Insurance
. This means that you are expecting the insurance company to pay you (the clinic) rather than send money directly to the patient. However, you do have the option to switch a purchase on your account to
Patient Pre-Pay
...
Insurance Mode on Claims: Payable to Patient vs Payable to the Clinic (CA)
guide that goes over how your clinic would accomplish this in more detail.
We hope this helps! As always, let us know if you have any questions on this, we’re happy to chat this through 😊Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/8ede9db4-4c40-4885-935e-a4c6785a9ae5)
- ![](https://jane.app/thumbs/a2038e41-5893-45e2-b058-97e4812da41e)
- ![](https://jane.app/thumbs/e1ba458f-6380-4ba8-8b9c-4548ebf0db9b)
- ![](https://jane.app/thumbs/068dda88-e129-4ada-8cf2-0f1e3881f41f)
- ![](https://jane.app/thumbs/c944d688-3911-4772-bed7-e2a5f28079ad)
- ![](https://jane.app/thumbs/c6f07822-a896-45bf-b5c4-565b74a01d95)
- ![](https://jane.app/thumbs/180da125-f414-408a-82d3-b6178d6b8cc8)
- ![](https://jane.app/thumbs/62bde156-dbcd-4c36-9e96-a76018a7857c)
- ![](https://jane.app/thumbs/5a10f56f-d01c-4b08-b1bc-26ae23d83f63)
- ![](https://jane.app/thumbs/cda7709b-fd84-4809-9abd-e859c26bc664)
- ![](https://jane.app/thumbs/71f161cb-9177-4c1d-a216-07816c3bcdc6)
