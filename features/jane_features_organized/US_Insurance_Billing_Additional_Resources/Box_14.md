...
*Source: [https://jane.app/guide/box-14](https://jane.app/guide/box-14)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:20:52*
...
If an Insurance company requires that you report a date in Box 14, enter the date and date type under the
Date of Current Illness, Injury, or Pregnancy
section of the patient’s Insurance Policy (Patient Profile> Billing > Insurance Policies).
There are
3 different date types
...
⚠️
Important:
If you enter a date in a patient’s Policy but
don’t select a date type
, the
qualifier section of box 14 will be left blank
, which could result in a rejection.
Is this required?
Adding a date to Box 14 is
optional
when creating a Policy in Jane and when generating an EDI or CMS1500. Only enter a date in Box 14 if it is required by the Insurance Company.
What about the EDI file?
If a date is present under the
Date of Current Illness, Injury, or Pregnancy
section of a patient’s Policy, then Jane will send that date along with its date type in
...
segments sent in
Loop 2300
of an EDI file. If an
Other Date
(
Box 15
) is also present in a patient’s Insurance Policy, a second
DTP
segment will be sent in the EDI (directly below the DTP segment for Box 14).
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 14
US Insurance Billing Additional Resources
Box 14
3 min read
Practice Plan
Thrive PlanDate of Current Illness/Injury/Pregnancy
What’s in the box?
This box is used to display the date on which the patient’s current illness, injury, or pregnancy began. The qualifier in this box indicates the type of date being recorded.
Where does this info live in Jane?
If an Insurance company requires that you report a date in Box 14, enter the date and date type under the
...
DTP
segment will be sent in the EDI (directly below the DTP segment for Box 14).Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/8dee3c8e-e489-4aba-8c54-98a6046614a4)
- ![](https://jane.app/thumbs/b382ab69-b157-418b-ad16-312354e59d20)
- ![](https://jane.app/thumbs/9ca622c9-13be-4a63-bd0d-ff79105c20a7)
