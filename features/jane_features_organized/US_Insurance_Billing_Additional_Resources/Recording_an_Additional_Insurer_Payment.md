...
*Source: [https://jane.app/guide/recording-an-additional-insurer-payment](https://jane.app/guide/recording-an-additional-insurer-payment)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:31:55*
...
Feature OverviewRecording an Additional Insurer Payment
...
Note
: we left the full amount of initial exam code outstanding, since we still expect to receive payment from insurance after we re-bill.
...
After we record the second insurance payment (which can be done in
Billing > Insurer Invoices > New Payment
), find the claim, and click the ‘Edit’ button to access the EOB screen, this is what we see:
...
Note
: that we didn’t have to click the ‘Edit Existing Amounts’ text for the adjustment code, since the amounts remained unchanged between the first and second remittance.
And that’s it! Onto the next remittance. :)
If you have any questions about recording EOBs we’d love to hear from you! Use the Help button from within your Jane account or email us at
support@janeapp.com
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Recording an Additional Insurer Payment
US Insurance Billing Additional Resources
Recording an Additional Insurer Payment
3 min readSometimes an insurance company will send multiple remittances and payments towards a single claim. To learn how to manage any additional remittances/payments you may receive, read on!
Viewing the EOB Screen a Second Time
If you view the EOB screen for a purchase where you’ve already applied an EOB to the claim (i.e. after you’ve recorded an insurer payment and applied the remittance in detail using the EOB screen), the screen will look slightly different.
Although it looks different, you are still able to edit the numbers you’ve entered for each procedure if needed - you just need to click the ‘Edit Existing Amounts’ text under the procedure that requires edits.
Walking Through an Example: Recording a Second Insurer Payment Using the EOB Screen
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/6fec534f-150b-472e-a452-0724ce4a3896)
- ![](https://jane.app/thumbs/11f43aa3-144a-40ab-bc2a-221c0f5a6629)
- ![](https://jane.app/thumbs/7c84a25d-934e-4526-9077-c53d33488aab)
- ![](https://jane.app/thumbs/3a8ffc8c-9a2d-4470-81e2-92ae4ab730fc)
- ![](https://jane.app/thumbs/5616d9c2-44d1-4467-8318-0cb5a979fb38)
