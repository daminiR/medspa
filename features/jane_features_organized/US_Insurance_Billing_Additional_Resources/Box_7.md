...
*Source: [https://jane.app/guide/box-7](https://jane.app/guide/box-7)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:20:14*
...
Feature OverviewBox 7
US Insurance Billing Additional Resources
Box 7
3 min read
Practice Plan
Thrive Plan
Member/Insured’s Address
What’s in the box?
This box indicates the address and phone number of the
Insured
(the Policyholder).
...
Self
, then Jane will use the address and phone number entered in the
Patient’s Profile
. To adjust the patient’s address, head to their Profile and click
Edit/Settings
.
Note:
Both
Street Address
lines 1 and 2 can be included in claim submissions.
The patient’s
Mobile Phone
...
is set to something
other
than Self, then the address of the Insured can be added directly to the Policy, under the
Insured’s Info
heading.
Is this required?
The Insured’s Street Address line 1, City, State, and Zip Code are
required
on the CMS1500. Street address line 2 and Phone number are
optional
.
The Insured’s Street Address line 1, City, State, and Zip Code are
required
...
The Insured’s street address is sent in
...
Segment N403
Note:
In Jane, there is only an option to include a second address line if the patient is the Subscriber.
The patient’s Phone number is not included in the EDI.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 7
US Insurance Billing Additional Resources
Box 7
3 min read
Practice Plan
Thrive PlanMember/Insured’s Address
What’s in the box?
This box indicates the address and phone number of the
Insured
(the Policyholder).
...
Note:
In Jane, there is only an option to include a second address line if the patient is the Subscriber.
The patient’s Phone number is not included in the EDI.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/9bf524be-842d-46b5-bb0c-fa80312cef54)
- ![](https://jane.app/thumbs/fdb1b018-0962-4fde-a9a7-4d9429057afc)
- ![](https://jane.app/thumbs/a7388c15-b6f0-4bac-9aeb-ad7d065cb730)
- ![](https://jane.app/thumbs/78b93330-d47a-4429-895c-6d5b01a3f98a)
- ![](https://jane.app/thumbs/a4e5ef52-ef62-4568-bfc8-e160d262416e)
- ![](https://jane.app/thumbs/943a4f61-cb18-4889-87cb-c0c4d2ae31b2)
