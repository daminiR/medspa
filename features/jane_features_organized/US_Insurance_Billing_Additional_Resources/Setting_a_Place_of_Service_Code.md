...
*Source: [https://jane.app/guide/setting-a-place-of-service-code](https://jane.app/guide/setting-a-place-of-service-code)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:06:43*
...
Feature OverviewSetting a Place of Service Code
US Insurance Billing Additional Resources
Setting a Place of Service Code
4 min read
Practice Plan
Thrive Plan
Hey there friend! If you need help setting a
Place of Service (POS) code
for claims that you’re billing to insurance, or for superbills that you’re providing to your clients, then you’ve come to the right place.
🗝️
Note:
If you offer services in different physical settings, this is especially important for you! For example, if your practice offers a
mix of Telehealth and In-person appointments
.
...
CMS maintains the POS code set
. On paper claims (CMS1500), POS codes are communicated in
Box 24b
. On electronic claims, POS codes are sent in
Loop 2300, Segment CLM05.
⚠️
Without a POS code, you won’t be reimbursed by insurance (and neither will your clients!).
Where can I set POS codes in Jane?
There are
two
places where you can assign POS code.
Location Settings:
This will become the
default code
for all Treatments or Sessions you don’t add a specific POS code for.
If you bill/provide superbills for all of your Treatments or Sessions under a single POS code, you’ll only need to set your
default POS code in your Location Settings
.
Treatment or Session Settings:
This will override your default code for this Treatment or Session only.
If you bill/provide superbills for some of your Treatments/Sessions under different POS codes, you can set a default POS code in your Location Settings for your most commonly billed code, and set specific codes in the Treatment or Session Settings for appointment types that need it.
A super common version of this these days (
especially for our friends working in Behavioural Health!
) is offering both
in-person
and
Telehealth services
...
For each Location you add to your Jane account, a staff member with
Full Access
can assign a default POS code at the bottom of the Location Settings page (Settings >  Locations > Edit > scroll down to the
Insurance Information
section).
The POS code set here will apply to all claim submissions and superbills under appointments booked at this Location.
✨ Adding a specific POS code in your Treatment or Session Settings
For each treatment you offer, you have the option of setting a specific POS code (Settings > Treatments, Classes & Group Appointments > Edit). If you don’t set a Treatment/Session-specific POS code, the default Location POS code will be used.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Setting a Place of Service Code
US Insurance Billing Additional Resources
Setting a Place of Service Code
4 min read
Practice Plan
Thrive PlanHey there friend! If you need help setting a
Place of Service (POS) code
for claims that you’re billing to insurance, or for superbills that you’re providing to your clients, then you’ve come to the right place.
🗝️
Note:
...
Changing a POS code on the fly
If you need to change the POS code for a one-off claim that you’re billing, you have the option to change the POS code in the submit preview.
Note that changes made on the fly only apply to electronic submissions (837 EDI). They don’t affect paper claims (CMS1500) or superbills.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/53d1a83b-6ea3-4d9b-8636-cbd5c23d0d75)
- ![](https://jane.app/thumbs/aa839387-6715-449f-b17f-a36bff68f85f)
- ![](https://jane.app/thumbs/f48487ad-eb56-4cb2-9290-c96dae057404)
