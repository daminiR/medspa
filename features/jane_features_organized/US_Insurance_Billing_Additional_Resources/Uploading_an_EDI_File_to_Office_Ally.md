...
*Source: [https://jane.app/guide/uploading-an-edi-file-to-office-ally](https://jane.app/guide/uploading-an-edi-file-to-office-ally)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:27:19*
...
Feature OverviewUploading an EDI File to Office Ally
US Insurance Billing Additional Resources
Uploading an EDI File to Office Ally
3 min read
Once you have generated and downloaded some EDI files that are ready for submission, you’ll need to log in to your Office Ally account to upload the files. If you need a little refresher on that process, check out our guide on
Creating an EDI File to Submit to a Clearinghouse
.
Right when you log in to Office Ally, you’ll have the option to use Classic or the New Version by clicking on this button in the top right corner.
This guide will walk through both the classic and the new version!
New Office Ally
Office Ally Classic
New Office Ally
After logging into Office Ally, you’ll want to hover your mouse over
Submit Claims
and select
Upload Claims
from the menu options.
Next, you can either drag and drop the files or select
Browse
on your computer. With the files all uploaded, you’ll see either a confirmation or an error message for each file you’ve uploaded.
Once you’ve uploaded your EDI files, you’ll be able to view claims those claims by clicking on
Manage Claims
.
If there are any claims that fail and need correcting, you’ll be able to view under
Correctable Claims
.  Here you’ll be able to make the edits needed for the claims to pass through to the insurer:
You can find the EOB information under the
Manage Remits
area:
Now if you prefer to use the classic version, we’ve got the step for that too!
Office Ally Classic
For this version of Office Ally, after you log in, click on
Upload Files
and then select
Upload Professional
from the menu options.
...
Choose File,
select the EDI file
from your device. Once all the files are selected, click on
Upload
and you’re all set!
Once you have uploaded the EDI file, you’ll be able to see the claims by clicking
Claim Fix
and then on
Claims Awaiting Batch
.
If a claim does not pass through the system, because it needs to be corrected, you can find the claim under the
Repairable Claims
selection:
From here you can select the claim date and make any corrections needed.
After the claims have been submitted, a file summary can be found under
Download File Summary
.
You can find the EOB information under the
Download EOB/ERA
tab:
That should do it, but if you have any questions about using Office Ally, you can reach their support team here:
Office Ally Support
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Uploading an EDI File to Office Ally
US Insurance Billing Additional Resources
Uploading an EDI File to Office Ally
3 min readOnce you have generated and downloaded some EDI files that are ready for submission, you’ll need to log in to your Office Ally account to upload the files. If you need a little refresher on that process, check out our guide on
Creating an EDI File to Submit to a Clearinghouse
.
Right when you log in to Office Ally, you’ll have the option to use Classic or the New Version by clicking on this button in the top right corner.
This guide will walk through both the classic and the new version!
...
tab:
That should do it, but if you have any questions about using Office Ally, you can reach their support team here:
Office Ally SupportSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/adde9bfd-1836-4a0c-96b6-98280ab126ce)
- ![](https://jane.app/thumbs/5bbc14a2-d46b-4224-91fc-b9e8209d24ec)
- ![](https://jane.app/thumbs/f437fe8f-d25d-4a37-a915-5fe45e11ed86)
- ![](https://jane.app/thumbs/2712e798-5cb2-4b83-a245-9b611e9bbbc1)
- ![](https://jane.app/thumbs/e93ab586-5c71-474e-8941-5544351abfc3)
- ![](https://jane.app/thumbs/57b2896b-649b-47f7-bdf7-a49e89b3b16b)
- ![](https://jane.app/thumbs/bc99302f-71de-4442-818d-d355747357f6)
- ![](https://jane.app/thumbs/6954ce18-6f24-48b2-abe9-2b6cc56bbc09)
- ![](https://jane.app/thumbs/b1839fac-5c06-4e04-9b6d-0a91d51323bc)
- ![](https://jane.app/thumbs/62ce88d1-0c49-4af5-8e18-255fb1f76089)
- ![](https://jane.app/thumbs/78ac6382-6b4c-442e-98e0-cff2f1e1aeab)
