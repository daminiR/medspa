...
*Source: [https://jane.app/guide/jane-s-clearinghouse-integration](https://jane.app/guide/jane-s-clearinghouse-integration)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:28:08*
...
Feature OverviewJane's Clearinghouse Integration 🇺🇸
...
Looking to learn more about how to manage your day to day billing with Integrated Claims with Claim.MD? We’ve put together this guide to connect you with all the resources you might need for all things Claim.MD. Let’s dive in!
Claim.MD basics
Claim.MD is a clearinghouse that can be used for electronic claim submissions in the US. 🇺🇲 Through our integration with Claim.MD, you can:
Complete eligibility checks
Submit claims
View acknowledgements and manage rejections
Receive insurer remittances
All from right inside your Jane account.
Getting started with Claim.MD
If you don’t have a Claim.MD account yet and want to learn more, head on over to
Claim.MD’s website
. From there, you can book a demo with their team to learn more or sign up right away.
💰Be sure to mention that you’re working with Jane to receive a 10% discount on your monthly subscription cost!
For more information on how to get started with Claim.MD, check out:
Switching Clearinghouses to Claim.MD
Webinar: Step-by-Step Guide to Switching Clearinghouses
Eligibility Checks
Integrated Claims with Claim.MD allows you to run eligibility checks for your patients’ insurance policies directly in Jane.
Eligibility Checks with Claim.MD
Submitting Claims & Posting Payments
Submit your insurance claims electronically and receive electronic payments (ERAs) automatically without leaving your Jane account.
Integrated Claims with Claim.MD
Learn More
If you’re new to billing with Jane, you can check out our quick start guides:
Biller Training Course
Insurance Billing Training
If you have any questions, our team is happy to help. Reach out at
support@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane's Clearinghouse Integration 🇺🇸
US Insurance Billing Additional Resources
Jane's Clearinghouse Integration 🇺🇸
2 min read
Practice Plan
Thrive Plan
Legacy PlansWe’ve been making some updates to make insurance billing simpler. Check out
what’s new
and see how our Claim.MD integration can help you manage your entire revenue cycle in Jane.
Looking to learn more about how to manage your day to day billing with Integrated Claims with Claim.MD? We’ve put together this guide to connect you with all the resources you might need for all things Claim.MD. Let’s dive in!
Claim.MD basics
