...
*Source: [https://jane.app/guide/cash-visits-superbills](https://jane.app/guide/cash-visits-superbills)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:03:34*
...
Feature OverviewCash Visits & Superbills
...
Add Billing Codes as You Chart
Re-booking Clients With the Same Billing Codes
Time of Service Discount
Adding Billing Codes to a Paid Invoice
Generating Batch Superbills
...
Customizing Your Superbill Template
If you haven’t already customized your Superbill template such as adding your business logo, practitioner license number(s), and electronic signature to your profile, please review our guide on customizing receipts
here
first.
🔝
Skip back to top
...
You can generate a superbill for any appointment (paid or unpaid) after you’ve added billing codes. As a reminder, you can add billing codes to the
Insurance Info
section of an appointment from the Schedule.
Additionally, you can add billing codes via the patient’s profile in
Billing > Purchases > View > Insurance
If your clinic is not using the Insurance Add-On, you can add CPT and Billing codes through the
Insurance Info
section within the
Appointment Panel
. For clinics on a legacy plan without insurance features, you can check out this guide:
...
Any codes that you have starred as a favourite in
Settings > Billing Codes
will pop up first in the drop down list for quick access.
For more information on the work flow for adding billing codes to a visit, please have a look at our guide on
Adding Billing Codes and Insuring a Patient Visit
.
...
No problem! With a
Full Access
account, you can configure your billing code sets and add custom billing codes from the
Settings
of your Jane account. Check out our guide on creating
custom billing codes
for more information on adding billing codes that you don’t find from in pre-loaded sets in Jane.
Configure Your Billing Code Sets
: Under
Code Sets
choose which type of codes to display throughout Jane and hit
Save Billing Code Sets
.
Printing, Generating a PDF, or Emailing a Superbill
Once you have added all of your billing and diagnosis codes to your patient’s visit, you’ll be able to send an invoice (superbill) to the client through email, as a PDF, or as a printed document.
Note
📝:
Is a patient not able to access their emailed superbill? If your clinic has the
Hide Client Information from Financial Emails
setting turned on, clients receive an email with a link that prompts them to log into their client profile. Once authorized, they will be redirected to the document within their browser which they can view, print, or download.
To select from these options, you’ll need to click the arrow beside the
Pay
button either from the appointment window on the Schedule:
...
Are you using the
Insurance Add-on
? If not, take a peek at our guide on
Superbills on the Base Plan
with some alternate workflows.
Here’s what a standard Superbill looks like:
You can also email or print a receipt directly through the
Pay
workflow that will include your added billing codes.
...
💡Heads up — Packages & Memberships are available on the
Thrive Plan
.
...
By using the
Copy
button under the Billing Info section of the appointment pane of the previous appointment, you can re-book the client with all the billing codes from the last visit with a single click!
Click
here
for step-by-step instructions on copying appointments.
...
Pro Tip:
you can save your most commonly used codes as a
starred note
in the patient’s profile to quickly copy and paste your codes in :)
🔝
Skip back to top
Adding Billing Codes to a Paid Invoice
Have a paid visit that you need to add billing and diagnosis codes to? Have a look at our
Adding Billing Codes to a Paid Invoice
guide document for some help!
🔝
Skip back to top
Time of Service Discount
Would you like to offer your patient a time of service discount and you need that discount to reflect on the superbill? Our
Time of Service Discount
guide doc walks through how to do so!
🔝
Skip back to top
Generating Batch Superbills
💡Heads up — generating batch superbills requires Jane’s insurance billing features.
Want to export multiple superbills in one go? If so, check out the following guide:
Generating a Batch: Superbills & CMS-1500s
...
Additional Notes
How can I prevent claims from being created and submitted to Claim.MD when they will be submitting to Medicare themselves?
In this case, since you’ll be providing the patient with a superbill, ensure the claim isn’t attached to the visit. This will prevent claims from being submitted to Claim.MD, allowing patients to submit to Medicare themselves.
For more details on how to remove a claim from a visit, you can check out our
Step 3: Insuring the Visit
guide.
If there are any other workflows that you’re trying to act out, or have questions not answered by the guide don’t hesitate to reach out to us at
support@janeapp.com
Happy Superbilling!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Cash Visits & Superbills
US Insurance Billing Additional Resources
Cash Visits & Superbills
10 min read
Balance Plan
Practice Plan
Thrive PlanIn this lesson we’ll cover the following topics:
Customizing Your Superbill Template
Creating Superbills
Printing, Generating a PDF, or Emailing a Superbill
Add Billing Codes as You Chart
...
If there are any other workflows that you’re trying to act out, or have questions not answered by the guide don’t hesitate to reach out to us at
support@janeapp.com
Happy Superbilling!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5fd25211-4cb9-4163-8f2a-681a44679b29)
- ![](https://jane.app/thumbs/21c66cdd-240e-45d6-a535-bb1e0dc1b142)
- ![](https://jane.app/thumbs/1891633d-2e7c-485f-ad41-92fc066cd47e)
- ![](https://jane.app/thumbs/233d12d2-bea2-4001-8df7-43fead0cc833)
- ![](https://jane.app/thumbs/4d30d681-e6a6-4018-9093-3dfdec2dd755)
- ![](https://jane.app/thumbs/b53ddf60-0898-47f1-bed5-4bb55e54efe1)
- ![](https://jane.app/thumbs/cf54b9b1-4ca1-4688-83da-637445aa2dec)
- ![](https://jane.app/thumbs/fbe8c280-7c7b-4913-986b-2f6311f20b2d)
- ![](https://jane.app/thumbs/6b21dc77-3135-4a6b-b486-5ee4c85ba481)
- ![](https://jane.app/thumbs/76710c91-9334-4921-8cbd-2b7a4d772c04)
- ![](https://jane.app/thumbs/a277230a-1a54-4bdc-81a3-c525e14ba25b)
- ![](https://jane.app/thumbs/e108ebc4-be34-4c95-b9ad-74560275ab08)
