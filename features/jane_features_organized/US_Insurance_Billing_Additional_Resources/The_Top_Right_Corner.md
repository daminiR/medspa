...
*Source: [https://jane.app/guide/the-top-right-corner](https://jane.app/guide/the-top-right-corner)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:18:24*
...
Feature OverviewThe Top Right Corner
US Insurance Billing Additional Resources
The Top Right Corner
3 min read
Practice Plan
Thrive Plan
Insurer Info & Claim Destination
What’s in the box?
This area of the form holds the
Legal Name
and
Full Address
of the payer (
Insurer
) that is being billed. It indicates where the claim will be sent.
Where does this info live in Jane?
The Insurer
Legal Name
and
Address
are set when creating or editing an Insurer in
Settings > Insurers
. The screenshot below shows which fields in the
Insurer Settings
correspond to the info in this box:
Is this required?
For paper claims, the address should be treated as required, even though it’s not technically marked as such during the insurer setup process. This is because paper claims typically require an address, unlike most electronic submissions.
The Legal Name is optional. If left blank, Jane will default to using the internal Name of the insurer instead.
What about the EDI file?
This information is sent in
Loop 2010BB - Payer Name
The
Insurer Legal Name
is sent in
Loop 2010BB, Segment NM103
Note that
NM101
is hardcoded to
PR
...
is hardcoded to
2
, which identifies the Payer as an Organization (rather than an Individual).
Note that
NM109
is the Insurer
Payer ID.
...
Insurer Legal Name
is also used in
Loop 1000B Receiver Info, Segment NM101
📍
Key Note:
CMS1500 vs EDI
...
When submitting an electronic claim for a patient with dual coverage, a Payer ID for the secondary Insurer is
required
. If the secondary payer needs to be biller via paper, then enter the
‘PAPER’
as the Payer ID.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)The Top Right Corner
US Insurance Billing Additional Resources
The Top Right Corner
3 min read
Practice Plan
Thrive PlanInsurer Info & Claim Destination
What’s in the box?
This area of the form holds the
Legal Name
and
...
‘PAPER’
as the Payer ID.
Paper claims don’t consider the Payer ID. Only the Insurer address is used!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/3f7010f9-a297-4553-bed0-356e43163eb4)
- ![](https://jane.app/thumbs/a0de4dba-c244-4c74-8be9-71c69d42bc5d)
- ![](https://jane.app/thumbs/eb47c9a0-125a-4fc8-9540-a8537dec13b9)
- ![](https://jane.app/thumbs/e11135f4-4a1a-4fec-af3e-50e66a75bc1f)
