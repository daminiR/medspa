...
*Source: [https://jane.app/guide/creating-an-edi-file-to-submit-to-a-clearinghouse](https://jane.app/guide/creating-an-edi-file-to-submit-to-a-clearinghouse)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:31:11*
...
Feature OverviewCreating an EDI File to Submit to a Clearinghouse
...
first before creating an EDI file.
Generating an EDI File
From the Appointment Panel (Single Claim)
As long as your insurers, claims, and billing codes have all been added correctly when you add the billing codes and insurance claim to the visit, you will see a “Submit” button at the bottom of the
Insurance Info
section.
Clicking
Submit
will bring you to the “Submit Claims” pre-flight check page. If a required field for EDI generation wasn’t entered in properly prior to pushing the Submit button (i.e. no diagnosis codes were entered), you will need to fix those areas before you are able to generate an EDI.
...
After you’ve selected this button, you’ll see a
Download
button that you can click to download the EDI file for this claim. Once downloaded, you can upload this file to your clearinghouse account for submission.
From the
Billing
Tab (Multiple Claims)
To generate an EDI file for more than one invoice, head to the main
Billing tab > Unsubmitted >
select the claims that have insurers set up as a “US Insurer” so that these claims are highlighted in blue.
You will see a yellow/orange
View/Submit Selected
button. This will launch the pre-flight check page for all the selected invoices.
This is the same “Submit Claims” screen you can navigate to from the appointment panel.
Check the red text for errors and click on the blue “Edit…” text to launch a new tab to fix these errors. Once these errors have been fixed, you will be able to hit the
Refresh
button to update the changes.
Once all the fixes are reflected, then you can generate an EDI file for multiple claims.
Click the
Download
button in the top right corner. This will provide you with
one
EDI file that includes all of these claims and then you can upload this file to your clearinghouse account.
And voilà!
...
Availity
Claim.MD
Once you receive the Explanation of Benefits (EOB), you can follow the steps to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating an EDI File to Submit to a Clearinghouse
US Insurance Billing Additional Resources
Creating an EDI File to Submit to a Clearinghouse
4 min readThe time has come - Jane is now able to generate an EDI text file of your claims to download from Jane and then upload to either Office Ally, Trizetto, Claim.MD, and/or Availity!
👉 Click here if you use Availity and submit claims to Medicare
Jane’s EDI formatting and Availity don’t always work well together when it comes to Medicare claims. If you bill Medicare, we recommend using a different clearinghouse.
If you have not done so already, please go through the
Pre-Flight Checklist
...
Claim.MD
Once you receive the Explanation of Benefits (EOB), you can follow the steps to
Receiving an Insurer Payment (EOB)Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/884c930d-297f-44a1-90ff-2c23ff7ea5b4)
- ![](https://jane.app/thumbs/9ed2442a-ebda-46b1-907c-d04c095b0699)
- ![](https://jane.app/thumbs/3aa14212-c4a0-485d-a5ed-1c634cf370d0)
- ![](https://jane.app/thumbs/a7ec7d4c-ad8f-46c3-9701-d75b69cffed4)
- ![](https://jane.app/thumbs/98f26b19-b0b8-42a8-8d91-327efd644cce)
- ![](https://jane.app/thumbs/3467d422-8075-418c-8477-31ddedb71d81)
- ![](https://jane.app/thumbs/8bf07807-be28-4d0d-97a8-4b9c767c3588)
- ![](https://jane.app/thumbs/7e01b61e-6580-4a37-9c27-afaa240cf08d)
- ![](https://jane.app/thumbs/5d9c1691-d4b7-4b02-a233-9b96387b16d1)
