...
*Source: [https://jane.app/guide/box-32](https://jane.app/guide/box-32)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:11:32*
...
Feature OverviewBox 32
US Insurance Billing Additional Resources
Box 32
6 min read
Practice Plan
Thrive Plan
Box 32 - Service Facility Location Info
What’s in the box?
...
Jane uses a combination of information that’s present in
Settings
→
Clinic Info
or
...
of your Clinic. The
Name
is what you’ve entered in that field under
Settings > Clinic Info
, and the
Location Name
is what you’ve entered under the Location Name under
Settings > Locations > Edit the location of choice.
Lines 2 & 3
Lines 2 and 3 are pulled from the
Location Address & Map
also found in
Settings> Locations> Edit the location of choice.
Note that the Location Address will be used in both your CMS1500 forms and EDI files generated from Jane
even if “Use my location address for billing” is deselected.
It’s worth noting that Box 32 is a representation of the physical space that a service was rendered, and always populates from the “Location Address & Map”, even if you’ve added a separate billing address (That information populates into
Box 33
, though).
Is this required?
The Service Facility Location Name, Address, and Zip Code are
required
in Jane. This information may not be required by the Insurer (on the CMS1500), but at this time Jane will always transfer this info to box 32.
The Service Facility Location Name, Address, and Zip Code are
required
in order to generate an EDI in Jane.
What about the EDI file?
Service Facility information is sent in
Loop 2310C - Service Facility Location.
However,
Line 1 of box 32 is configured differently on the EDI file than it is on the CMS1500
. Lines 2 & 3 use the same information as the CMS1500 as outlined above.
Line 1:
Instead of using a combination of information that’s present in
Settings → Clinic Info & Locations,
Jane uses the sale location
Billing Legal Name
for the name of the Service Facility Location.
The Service Facility Name is sent in
Loop 2310C, Segment NM103
.
Lines 2 & 3:
As with the CMS1500, Jane uses the location (non-billing) address of the sale location for the Service Facility Address and Zip Code. The address is sent in
Loop 2310C, Segments N3 and N4.
The
Street Address Line 1
is sent in
Loop 2310C, Segment N301
Note that if the Second Address Line is filled out in the location, it will be sent in
Loop 2310C, Segment N302
.
The
City
is sent in
Loop 2310C, Segment N401
The
State
is sent in
Loop 2310C, Segment N402
The
Zip Code
is sent in
Loop 2310C, Segment N403
⭐️Note
Jane will only send Service Facility information (
loop 2310C
) if it is different than the billing provider information (
loop 2010AA
).
In other words, if the Service Facility location name, associated NPI, and full address are
exactly
the same as the Billing Provider name, associated NPI, and full address, then Jane
doesn’t include service facility info in the claim submission.
This is in part due to Jane ensuring we’re staying consistent with the submission requirements posed by X12, which dictate how claims should be submitted.
If this poses an issue, let us know at
support@janeapp.com
, and we’ll do our best to assist!
Box 32a - Service Facility NPI
What’s in the box?
This box indicates the NPI of the facility where the service(s) was performed.
Where does this info live in Jane?
The NPI of the Location of the service/sale will be set in box 32a for all claim submissions. You can set your Location NPI by heading into
Settings > Clinic Info & Locations > Edit Location
.
Is this required?
The Service Facility Location Name, Address, and Zip Code are
required
in Jane. This information may not be required by the Insurer (on the CMS1500), but at this time Jane will always transfer this info to box 32.
The Service Facility NPI is
required
in order to generate an EDI in Jane.
What about the EDI file?
The Service Facility NPI is sent in
Loop 2310C - Service Facility Location.
The
NPI
is sent in
...
Loop 2310C, Segment NM108.
The qualifier ‘
77
’, which means Service Location, is sent in
Loop 2310C, Segment NM102
Box 32b - Service Facility Secondary ID
What’s in the box?
A
secondary ID
number (non-NPI) to help identify the
Service Facility Location
. Typically a provider’s State License Number, Provider Commercial Number, or Location Number.
Where does this info live in Jane?
This box is not currently supported in Jane.
If you need a secondary ID number in box 32b, please let us know!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 32
US Insurance Billing Additional Resources
Box 32
6 min read
Practice Plan
Thrive PlanBox 32 - Service Facility Location Info
What’s in the box?
This box holds the Name, Address, and Zip code of the location where the services were rendered.
Where does this info live in Jane?
Jane uses a combination of information that’s present in
...
Where does this info live in Jane?
This box is not currently supported in Jane.
If you need a secondary ID number in box 32b, please let us know!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/482ee6bd-a41c-4fa6-b73b-c4d40ae0489d)
- ![](https://jane.app/thumbs/ae41bac4-d09f-4208-9cc7-d7b05064ae1d)
- ![](https://jane.app/thumbs/0915b5e4-1007-45aa-b9bf-4d9065eef80c)
- ![](https://jane.app/thumbs/8718f9d5-3305-4a1c-be43-fcc780ea63e6)
- ![](https://jane.app/thumbs/f80ec972-60b2-4a5a-8d23-3e994edcba22)
- ![](https://jane.app/thumbs/e33c24c2-a255-4782-bc5f-2d60d09416f0)
- ![](https://jane.app/thumbs/d0c8c5fc-4d9e-4c64-bf9b-1536bf037c6a)
- ![](https://jane.app/thumbs/578adf12-a5a4-4efd-8d8b-d067cd3ccd2c)
- ![](https://jane.app/thumbs/018a0df5-4334-4739-a49b-840d34a09b53)
- ![](https://jane.app/thumbs/c605261e-c02d-4c45-8434-a3372f5c44e3)
- ![](https://jane.app/thumbs/2cb2111d-9a94-48ba-9475-3de5e476d616)
- ![](https://jane.app/thumbs/dcd13ac6-aa82-4c9a-a434-bfa6dcfd4dc2)
- ![](https://jane.app/thumbs/fcecf633-c4b3-45a2-89ac-9d3c61d31053)
