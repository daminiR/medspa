...
*Source: [https://jane.app/guide/box-5](https://jane.app/guide/box-5)*

*Category: US Insurance Billing Additional Resources*

*Scraped: 2025-08-07 04:19:24*
...
The patient’s address and phone number are set within the
Patient Profile
. To adjust this information, head to their profile and click
Edit/Settings
.
Note:
Both
Street Address
lines 1 and 2 will be included in claim submissions.
The patient’s
Mobile Phone
number is used for claim submissions.
Is this required?
The patient’s Street Address line 1, City, State, and Zip Code are
required
on the CMS1500. Street address line 2 and Mobile Phone are
optional
.
The patient’s Atreet Address line 1, City, State, and Zip Code are
required
when billing via EDI file. Street address line 2 is
optional
, and the Mobile Number is
not included
in the EDI file.
What about the EDI file?
Although the patient’s address is always
required
,
where
...
is
not sent in the EDI
. Thus, the patient street address is sent in
Loop 2000B - Subscriber
.
The patient’s
street address line 1
is sent in
Loop 2010BA - Subscriber Info, Segment N301
The patient’s
street address line 2
is sent in
Loop 2010BA - Subscriber Info, Segment N302
The patient’s
City
is sent in
Loop 2010BA - Subscriber Info, Segment N401
The patient’s
State
is sent in
Loop 2010BA - Subscriber Info, Segment N402
The patient’s
Zip Code
is sent in
Loop 2010BA - Subscriber Info
,
Segment N403
Option 2: Patient is not the Subscriber
If the patient is
not
the subscriber (i.e. their spouse is the Policyholder and they are covered under that policy), then the patient’s street address is sent in
Loop 2000C - Patient
.
The patient’s
street address line 1
is sent in
Loop 2010CA - Patient Info, Segment N301
The patient’s
street address line 2
is sent in
Loop 2010CA - Patient Info, Segment N302
The patient’s
City
is sent in
Loop 2010CA - Patient Info, Segment N401
The patient’s
State
is sent in
Loop 2010CA - Patient Info, Segment N402
The patient’s
Zip Code
is sent in
Loop 2010CA - Patient Info
,
Segment N403
Note:
The patient’s Mobile Phone number is not included in the EDI in either scenario.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Box 5
US Insurance Billing Additional Resources
Box 5
3 min read
Practice Plan
Thrive PlanPatient’s Address
What’s in the box?
This box contains the patient’s full address and phone number.
Where does this info live in Jane?
The patient’s address and phone number are set within the
...
Segment N403
Note:
The patient’s Mobile Phone number is not included in the EDI in either scenario.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e28944a7-ea90-4b30-8a9c-238e66aaea18)
- ![](https://jane.app/thumbs/bfcd908b-5afd-4b9f-aa38-cbe2246742a8)
- ![](https://jane.app/thumbs/d2881b1a-ae8e-4e57-898c-bdbefcffb670)
- ![](https://jane.app/thumbs/97e9f26e-68fb-460f-b62d-fee42f5a726b)
- ![](https://jane.app/thumbs/d64dab37-8237-4a0b-a6ea-beb06fc7d1f6)
