...
*Source: [https://jane.app/guide/security-faq](https://jane.app/guide/security-faq)*

*Category: Security*

*Scraped: 2025-08-07 03:01:09*
...
Jane’s privacy and security standards, practices, and certifications
, you can head to our
Security and Trust homepage
to learn more.
...
Jane will store data for as long as the clinic holds an active subscription, and the clinic can choose when to delete data that is no longer needed. This includes chart, appointment and financial data. However, Jane does not make a commitment to store data long-term after a subscription is cancelled.
A cancelled subscription means that the account and any Subscriber Data associated with the account is no longer available for everyday use.
The recommendation here is to backup files to either your local device or a secure server to maintain your primary set of records for continued, unrestricted access. This allows for the safekeeping of data independently of Jane’s services.
For those leaving their practice - whether it’s retiring or switching to another software - you can request a
Batch Chart Export
. For all other data like appointment history, full patient demographics and billing data, check out our
...
we collect from Account Owners and our customers to open and maintain their Jane account (i.e. clinic name, billing information, contact information) is handled in the ways laid out in our
Privacy Notice
.
Patient data
that our customers collect about their patients (i.e. names, demographics, medical information, charts, appointment history, billing information, etc) is fully owned by the customer. Essentially, Jane acts as an agent that stores patient data on behalf of our customers, but we don’t control or own that data. The Account Owner / Subscriber of a Jane account retains ownership of all patient data.
...
and other data before cancelling your Jane account so you can keep a copy for your records.
Why am I receiving a “Your Connection is not Secure” error message when I try to access my Jane account?
This warning comes about when someone accidentally goes to
www.clinicname.janeapp.com
instead of just
clinicname.janeapp.com.
Though it may seem like the same website, the subtle difference is important! You’ll always want to use the version without the
www.
part.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Security FAQ
Security
Security FAQ
6 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansIf you’d like to learn more about
Jane’s privacy and security standards, practices, and certifications
, you can head to our
Security and Trust homepage
to learn more.
