...
*Source: [https://jane.app/guide/how-to-reset-your-email-password-and-enable-two-factor-authentication-2fa](https://jane.app/guide/how-to-reset-your-email-password-and-enable-two-factor-authentication-2fa)*

*Category: Security*

*Scraped: 2025-08-07 03:07:04*
...
Feature OverviewHow to reset your email password and enable Two-Factor Authentication (2FA)
Security
How to reset your email password and enable Two-Factor Authentication (2FA)
2 min read
...
Still Have Concerns?
If you’ve received this email and through these tips aren’t confident that the session wasn’t triggered by you, a good first step is to
reset your password
just to be safe. From there, you can reach out to Privacy and Security Support at security@jane.app and we can help you to investigate and ensure everything is secure.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to reset your email password and enable Two-Factor Authentication (2FA)
Security
How to reset your email password and enable Two-Factor Authentication (2FA)
2 min readIf you receive a new device sign-in email and are unsure whether the sign-in was authorized, it’s important to take proactive steps to secure your email accounts.
Update Passwords for Your Email Providers
To help keep your email accounts safe, updating your passwords regularly is a simple and effective step. For instructions on changing your password for commonly used email providers, you can click the relevant links below:
Change your password in Outlook.com
Change your Apple Account password
...
If you’ve received this email and through these tips aren’t confident that the session wasn’t triggered by you, a good first step is to
reset your password
just to be safe. From there, you can reach out to Privacy and Security Support at security@jane.app and we can help you to investigate and ensure everything is secure.Subscribe to our monthly newsletter.Jane Software Inc.
