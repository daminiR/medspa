...
*Source: [https://jane.app/guide/activity-log](https://jane.app/guide/activity-log)*

*Category: Security*

*Scraped: 2025-08-07 03:02:02*
...
The Activity Log is a powerful report that shows actions taken within the account. This internal reporting tool is used to comply with HIPAA regulations and
is not accessible to patients nor related to patient medical records
. The log can be used to troubleshoot or audit actions taken by staff members at the clinic. Especially things like who added a staff profile to the Jane account as that affects your
Jane Subscription
.
First, all users should be logging in individually with a unique profile with their own username and password. If your clinic uses one device at the front desk or a similar setup, we got some tips for you:
...
How to see the log
The Activity Log will be visible to all staff members. However, only the
Account Owner
and any staff member with
Full Access
, or
Administrator/All Billing
permissions will be able to see data across the clinic for different practitioners and administrative staff. To view the report, these users can head over to the
Reports
tab, and then scroll down to the bottom of the menu on the left. The very last report option is
Activity Log
.
...
“created staff member” - a user with
Full Access
added a staff profile to the Jane account
...
“deleted entry” — could be either archiving an unsigned chart draft or deleting a signed chart. More info on that
here
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Activity Log
Security
Activity Log
4 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansMost privacy and data protection regulations want individual users in electronic health record systems to be identified, and even more, they want all activity to be tracked.
Jane does this with the Activity Log.
What is Jane’s Activity Log?
The Activity Log is a powerful report that shows actions taken within the account. This internal reporting tool is used to comply with HIPAA regulations and
is not accessible to patients nor related to patient medical records
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/eddb0001-6646-44b7-8414-d4927ccbc3ca)
- ![](https://jane.app/thumbs/eff6e267-34ab-4d59-9768-a5f06ca9e717)
- ![](https://jane.app/thumbs/11ad9aef-596d-425c-9b17-5727661a8ec6)
