...
*Source: [https://jane.app/guide/how-to-change-the-name-of-your-clinic](https://jane.app/guide/how-to-change-the-name-of-your-clinic)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:34:39*
...
Feature OverviewHow to Change the Name of Your Clinic
Account Basics
How to Change the Name of Your Clinic
6 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Sometimes, your clinic gets the chance to embrace exciting changes, whether that’s by becoming part of a larger team through an acquisition or evolving from a solo practitioner into a thriving multi-disciplinary practice.
This guide walks through two key areas you’ll want to make sure are updated during this transition period.
Updating your clinic name
To start, a
Full Access
user or the listed
Account Owner
...
tab, click on
Clinic Info
within the left sidebar menu and then
Edit
.
You’ll want to make sure to update both the
Clinic Name
and the
Legal Name
before hitting the
Save
button at the bottom of the page to confirm those changes.
Legal Name of Clinic
: Used on financial documents (i.e.invoices, receipts, statements)
Clinic Name
: Used throughout Jane
Oftentimes, clinics will have the business name entered as the name of the location as well. To update this, head over to the
Locations
area within the
Settings
tab and then on
...
Legal Name
field if applicable as well.
Updating your Jane Payments Statement Descriptor
The Statement Descriptor is what you’d like your patients to see on their bank statements when you take a payment via credit card. To change this, click
Settings
>
Jane Payments
> then click on the
Pencil Icon
beside your Jane Payments account.
In the following page, you’ll be able to find your Statement Descriptor to make changes.  Be sure to click the
Save
button to lock it in!
Updating your Jane subscription information
When there are changes to the clinic name and it needs to be reflected on the invoices that are issued with your monthly subscription, you’ll need to update one last area! Updating the clinic’s information for your subscription is also reflected on when clients or staff search for the clinic name on our general
jane.app
website.
Note
📝: Updating the subscription details is something that only the listed
Account Owner
can do. Check out our guide on
How To Check Who’s Listed As Account Owner
for more details on how you can see who that person would be.
To start, the
Account Owner
...
On the next page that opens up, click on
Contact Info
within the grey bar. You’ll want to make sure to edit the name and any other applicable information and make sure to click the
Update Account
button to confirm those changes.
Updating your Jane Payments statement descriptor
If you’re using
Jane Payments
, you’ll likely also want to update your Statement Descriptor, which is the name clients see on their credit card or bank statements when they’re charged. You can find this setting by going to
Settings > Jane Payments
, then clicking the
blue pencil
icon next to your Jane Payments account.
In the
Statement Descriptor
field, enter the name you’d like to appear. We recommend using your clinic name or a recognizable abbreviation so clients can easily identify the charge. Hit
Save
when you’re done and you’re good to go.
Just a heads up: all statements will also include “North Vancouver” at the end of the descriptor. That’s because Jane processes transactions through our head office, and that part can’t be changed. But adding your clinic name or abbreviation helps make sure the statement still makes sense to clients.
...
How To Check Who’s Listed As Account Owner
.
For all things subscriptions, check out our
Managing Your Jane Subscription
and
FAQ: Subscription Licenses and Jane’s Usage Report
for more details.
Need to change the clinic’s website address or URL, here’s our guide on
How to Change (and Find!) Your Online Booking Website Address
.
As always, if you have any additional questions or concerns, you can
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Change the Name of Your Clinic
Account Basics
How to Change the Name of Your Clinic
6 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansSometimes, your clinic gets the chance to embrace exciting changes, whether that’s by becoming part of a larger team through an acquisition or evolving from a solo practitioner into a thriving multi-disciplinary practice.
This guide walks through two key areas you’ll want to make sure are updated during this transition period.
Updating your clinic name
To start, a
Full Access
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps](https://jane.app/thumbs/9efc68a1-2341-4f60-8099-b883e5fc87df)
- ![An image of where to update both the clinic's general and legal name](https://jane.app/thumbs/da3da823-6c0c-4bde-9ba9-f4b4201177ae)
- ![An image of the navigational steps](https://jane.app/thumbs/bef81bf6-2ad1-4564-8ded-1b7b39fa80ba)
- ![An image of where to find the legal name field to update the language](https://jane.app/thumbs/caaf0e39-3a08-4565-854c-d6049d0c842f)
- ![](https://jane.app/thumbs/14aab522-c562-4a28-8c12-cb5910a6a24a)
- ![](https://jane.app/thumbs/0c832df9-db4a-43bb-8929-d13b7c1d1485)
- ![An image of where staff members and patients of clinics can search their clinic from the main jane website page](https://jane.app/thumbs/af882234-eba0-4eeb-96fe-2565b6c93a15)
- ![An image of what the navigational steps look like for an account owner](https://jane.app/thumbs/a8671203-05c0-48ce-826c-64fa9b816efe)
- ![An image of which section you can update](https://jane.app/thumbs/f7d9ad1d-3663-4458-af23-2832f2ce4d3e)
- ![](https://jane.app/thumbs/ef47374e-bee5-45bb-bb71-bf8ff741f550)
- ![](https://jane.app/thumbs/44e5a459-f9ea-4991-97be-04c4a85bfafd)
