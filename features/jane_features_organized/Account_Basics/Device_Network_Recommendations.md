...
*Source: [https://jane.app/guide/device-network-recommendations](https://jane.app/guide/device-network-recommendations)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:31:23*
...
Feature OverviewDevice & Network Recommendations
...
Thrive Plan
Network
Since Jane is a web-based application, we’ll need a connection to the internet highway. How much of a connection?
Here are our recommendations for a smooth ride:
...
Unsure about the speed of your connection? You can do a quick test online using a website like
fast.com
.
Devices
...
The truth is that it is really up to you and your practice! Jane is compatible with desktop, tablet, and mobile devices. As long as the device is on a supported operating system and can run a browser that meets our minimum
...
Mobile & Tablet
Tips
Using Jane on your phone or tablet? We recommend adding Jane as a bookmark to your home screen for easy access to your schedule and patient charts. To learn more, check out our guide
Using Jane on a Smartphone
.
A Note on Browsers
Want to know which browsers are compatible with Jane? We have a dedicated guide document for that. Check out our
Browser Requirements
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Device & Network Recommendations
Practitioner Profiles
Device & Network Recommendations
2 min read
Balance Plan
...
Want to know which browsers are compatible with Jane? We have a dedicated guide document for that. Check out our
Browser Requirements
page for the most up-to-date information.Subscribe to our monthly newsletter.Jane Software Inc.
