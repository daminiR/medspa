...
*Source: [https://jane.app/guide/checklist-for-starting-with-jane](https://jane.app/guide/checklist-for-starting-with-jane)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:31:07*
...
Feature OverviewChecklist for Starting with Jane
Account Basics
Checklist for Starting with Jane
6 min read
Balance Plan
...
For guidance on these first two tasks, read this guide on
Setting Up Disciplines
. All these are available under the
Settings
menu.
☑
Set up additional disciplines
- Jane will have set up a single discipline through the setup wizard, but if you have a multi-disciplinary practice, you’ll want to set up your additional disciplines.
☑
Set up additional treatments
- Create any additional treatments that you want to offer to your patients.
Staff and Shifts
☑
Set up your additional staff
- If you have additional practitioners working with you, or you need to set up your admins, check out our guide docs on
Setting up Staff
.
☑
Create additional shifts
- You’ll probably want to set up some additional shifts for yourself or any new practitioners that you’ve added, so check out this guide doc on
Adding Staff Shifts
.
Electronic charting
Before you get started on charting for the first time, you might want to check out our
tips for switching to electronic charts
.
☑
...
template library
to see all the templates that other (real life!) practitioners have contributed to Jane.
☑
Create online intake forms
- See our doc on
intake forms
so that you can build online intake forms that can be sent out automatically to your new patients.
Jane Payments
Jane Payments is our fully integrated payment solution, designed to make running your practice smoother. With Jane Payments, you can collect payments right through Jane - no extra systems or clunky reconciliation required.
You’ll be able to:
🧾
Accept payments your way
: Credit cards, Interac, and online payments - from the front desk, in the treatment room, or during online booking.
🖥️
Use a Jane Payments Terminal
: Tap, swipe, or insert cards, and let Jane take care of the rest — with no need to re-enter payment details.
📅
Reduce no-shows with prepayment
: Ask for payment during online booking and cut down on costly last-minute cancellations or no shows.
📈
Reconcile faster
: Transaction reporting lives right inside your Jane account - clean, simple, and always up to date.
📦
Add time-saving perks
: Store cards securely, send automatic receipts, and skip the admin pile-up.
💡 And here’s the best part:
There’s no monthly fee to use Jane Payments.
You only pay a small processing fee when you get paid - that’s it. 🔗
Here’s a guide to help you get started with Jane Payments
...
Jane is also dedicated to providing our clinics with continued and ongoing support even after they’ve gotten settled in. Many of our FAQs can be found in our
Guide
and
Videos
support anytime. We’ve even built a feature into Jane that allows you to email our support team directly from your Jane account.
Importing
Jane can import your patient list, appointment data (past and future bookings), product list, and electronic charts, provided that they’re in a format that we can use. The only thing that we can’t import is billing data (invoices and payments). Our
basics of importing to Jane
and
diving deeper into imports
guides will give you some additional information about our imports, but here are some of the key tasks. (We recommend that you have completed all the tasks below
before
doing your import so that once the import is completed, you can switch immediately over to Jane).
☑
Book your import
- Head to
Settings > Schedule an Import > Begin
in your Jane account to get started. You can review our guide document here:
Scheduling Your Import
☑
Export your data
- You’ll need to consult your existing vendor if you’re not sure how to get the data out of the system.
☑
Upload your data
- Head to
Settings > Schedule an Import > View Details
in your Jane account to upload your data to us.
Once we have your data, we’ll process it and import it. We’ll send you an email once your import is complete and a Jane team member will even check-in on you the next day to ensure everything went smoothly. Here’s a handy checklist of to-dos for
After Your Import
.
What’s Next
Jane’s Integrations
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Checklist for Starting with Jane
Account Basics
Checklist for Starting with Jane
6 min read
Balance Plan
Practice Plan
Thrive PlanSo you’ve signed up for Jane! Here’s a list of most of the common setup tasks that you’ll want to go through.
Disciplines and Treatments
For guidance on these first two tasks, read this guide on
Setting Up Disciplines
. All these are available under the
...
Customizing Jane
Mass Welcome Email
Have fun using your new Jane account!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b905ae60-b547-4c71-9ab3-d94445d9457e)
- ![](https://jane.app/thumbs/9d3ca70d-c75e-4e07-be88-a2515b2d7149)
