...
*Source: [https://jane.app/guide/moving-your-practice-to-a-new-location](https://jane.app/guide/moving-your-practice-to-a-new-location)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:32:52*
...
Feature OverviewMoving Your Practice to a New Location
Account Basics
Moving Your Practice to a New Location
4 min read
Balance Plan
...
If you’re not operating out of both locations at the same time, there’s no need to
create a new location
in Jane. You can continue booking and scheduling under your existing location right up until the day of the move..
Informing your clients of the upcoming move
There are a few customizations you can make to inform clients that your practice location will be changing. To start, a staff member with
Full Access
...
option. A quick note that this is currently available on the
Practice
and
Thrive
Plans.
Updating the language in this area creates a banner on your online booking page that patients are able to see, regardless of whether they’re actively booking an appointment or viewing past appointments in their My Account Portal.
...
Appointment Reminders & Booking Notifications
In that language area, you can also add custom text to most of the emails that are sent out from within Jane. Feel free to add extra information to your emails that include extra instructions or details.
An option here would be to add some language to the
Thanks for Booking Email: Details
email:
And the Reminder Emails:
For more details on how you can make changes to different sections of these emails, you can check out the following guides:
Email Customization Cheatsheet (Appointment Reminder)
Email Customization Cheatsheet (Thanks for Booking)
Exporting Patient Emails
If you do want to export all of your patient’s emails, a staff member with
Full Access
can head over to the
Reports
tab and select the
Patient List
report within the left sidebar menu. To export the report, you can click on the
three horizontal black dots
and select your desired file format.
While this export will include the full patient demographics, it also includes a column for their email address. You can
customize the report in Excel
to filter out any information you don’t need.
From there, you can use that email list to send out a mass email either through a system like
Mailchimp
, or your own email service provider. For more tips and tricks for emailing your patients, you can check out our
How to Send an Email to All Patients
guide.
Changing your Clinic’s Location Address
...
area. Click
Edit
to open up the details.
Update the location address along with any other thing that is changing.
(You can also update the location name, short & long descriptions, & billing address - if needed)
Don’t forget to hit
Save
once done!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Moving Your Practice to a New Location
Account Basics
Moving Your Practice to a New Location
4 min read
Balance Plan
Practice Plan
Thrive PlanOften clinics will re-locate to a new physical location.  This could be because of a lease expiring, or the need for more space, or a solo practitioner with their own account changing practices.
If you’re not operating out of both locations at the same time, there’s no need to
create a new location
in Jane. You can continue booking and scheduling under your existing location right up until the day of the move..
Informing your clients of the upcoming move
...
Save
once done!
Congratulations on your move, and should you have any other questions about how to best manage this transition within Jane, please let us know, and we’d be happy to help!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps](https://jane.app/thumbs/1a848823-3477-4eb7-a9e8-7ecbd9bdfd96)
- ![](https://jane.app/thumbs/8e66f0d7-07f0-4197-8fbf-3faf115c5a4a)
- ![](https://jane.app/thumbs/a07f582c-4ec7-4d03-94bd-475d79f0c609)
- ![](https://jane.app/system/dragonfly/production/2017/12/11/54d4waa945_image.png)
- ![](https://jane.app/thumbs/8c74318b-3f6d-4a04-89ea-d25a95df07ff)
- ![](https://jane.app/thumbs/635fa581-dfe7-40c0-b1a5-a0a7415282cf)
