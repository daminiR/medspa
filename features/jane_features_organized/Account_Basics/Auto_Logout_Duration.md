...
*Source: [https://jane.app/guide/auto-logout-duration](https://jane.app/guide/auto-logout-duration)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:31:58*
...
Feature OverviewAuto-Logout Duration
Staff Profiles
Auto-Logout Duration
2 min read
Balance Plan
...
Thrive Plan
Legacy Plans
By default, Jane asks your staff to sign in with their username and password after
1 week of inactivity
, but Jane strongly
suggests
that you shorten the duration to
2 hours
so that if someone were to gain access to your device, they would be required to provide their login credentials again after more than 2 hours.
Here’s how!
Note: You’ll need to be logged in with full access to update this setting.
1) Head to
Settings
.
2) Click
...
3) Click
Edit
to the right of the Automatic Sign Out section:
4) Once you make a selection from the dropdown menu, click the
Save
button that appears at the bottom of the page, and you’re all set!
Jane will follow the period of inactivity you set here and prompt users to re-enter their password :)
Further Reading
If you’d like to learn more about our other security features, check out:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Auto-Logout Duration
Staff Profiles
Auto-Logout Duration
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansBy default, Jane asks your staff to sign in with their username and password after
1 week of inactivity
, but Jane strongly
suggests
that you shorten the duration to
...
And as always,
give us a shout
if you have questions or need a hand!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![](https://jane.app/thumbs/f61c7b44-5868-4f07-baca-1fe8af7a547e)
