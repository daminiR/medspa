...
*Source: [https://jane.app/guide/browser-operating-system-requirements](https://jane.app/guide/browser-operating-system-requirements)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:31:15*
...
Feature OverviewBrowser Requirements
Account Basics
Browser Requirements
3 min read
Balance Plan
...
Thrive Plan
Legacy Plans
To ensure your data is secure being sent to and from Jane, we only support browsers, calendar applications and operating systems which support the secure TLS version 1.2. We no longer support the insecure
TLS 1.1 or 1.0 versions
.
📣
Jane tip:
We strongly recommend using the most up-to-date operating system and browser that are available to you to keep PHI and PII secure. Older browsers that aren’t officially supported may still work with Jane but we can’t say whether your experience with them will be optimal.
Browser Requirements for Jane
Browser requirements for Online Appointments (Telehealth)
Browser requirements for our Jane Payments integration
Third-party applications
Browser Requirements for Jane
For both the admin and patient/client side of Jane, the oldest browser versions we officially support for desktop and mobile are the following:
Chrome v98
Firefox v101
Safari v15
Edge v116
Browser requirements for Online Appointments (Telehealth)
Feel free to use your browser of choice, just make sure that it’s updated to the latest version. Here are a few guides on how to update your browser:
...
Browser requirements for our Jane Payments integration
For our Jane Payments integration, we officially support Chrome, Firefox, Safari, and Edge
within 2 major versions
of their current release.
Third-party applications
There are certain third-party applications that you may use in tandem with Jane. Older versions of these applications may make non-secure requests and are no longer supported. If you run into any bumps, try installing a newer version of your application or updating your operating system.
Calendar Applications (
Troubleshooting Guide
)
Outlook 2019 and higher
Now that you’ve figured out your browser, we’ll need a device to run everything on. Learn more in our
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Browser Requirements
Account Basics
Browser Requirements
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansTo ensure your data is secure being sent to and from Jane, we only support browsers, calendar applications and operating systems which support the secure TLS version 1.2. We no longer support the insecure
TLS 1.1 or 1.0 versions
.
📣
Jane tip:
