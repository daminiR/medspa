...
*Source: [https://jane.app/guide/enabling-patient-self-check-in](https://jane.app/guide/enabling-patient-self-check-in)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:32:27*
...
Feature OverviewEnabling Patient Self Check-in
Online Booking
Enabling Patient Self Check-in
3 min read
Thrive Plan
...
All you’ll need is a piece of paper to print your branded Check-in signage (QR code) so that your patients can follow the instructions or scan the QR code to begin the check-in!
Note
📝:
This feature is currently only available to clinics on the
Thrive
plan.
Here’s how to get it all set up.
Step 1: View Your Signage and QR Code
...
Click
View Signage
. This is the instructions page for patients to self check in.You’ll also see the image of the QR code.
Step 2: Print your Signage
The next step is to print the QR code signage. To print in Chrome or Safari, navigate to the top of your application bar and select
File > Print
.
If your browser’s print dialog box pops up, just confirm your printer settings and hit
Print
:
Step 3: Post your Signage
Lastly,
post your signage up
in the lobby so your patients can follow the instructions or scan the QR code using their mobile device :)
How it Works for Patients
When your patient walks in, they can point their mobile device at the QR code or visit the URL posted on your signage to begin. Self check-in is available up to
1 hour before
...
Wander over to our guide doc on
Self Check In - For Patients
for more detailed info.
For Staff on the Admin Schedule
When a patient self-checks in, Jane will update their appointment to a light green color and display a timestamp showing the exact check-in time:
Note:
Self check-in won’t automatically mark the appointment as Arrived, so you’ll still need to click
Arrive
button in the appointment panel to invoice and take payment.
As always,
let us know
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Enabling Patient Self Check-in
Online Booking
Enabling Patient Self Check-in
3 min read
Thrive PlanSomething that comes up regularly is clinics and practitioners who want to allow their patients to self check-in when they arrive for their visit.
We’ve given a considerable amount of time and thought into developing a feature that doesn’t require an additional kiosk stand with a computer or tablet.
All you’ll need is a piece of paper to print your branded Check-in signage (QR code) so that your patients can follow the instructions or scan the QR code to begin the check-in!
Note
📝:
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/a20f5699-6ab6-4f19-b0ac-733078c67d79)
- ![](https://jane.app/thumbs/c4715e29-83c6-484c-ab78-67420409f04a)
- ![](https://jane.app/thumbs/40ecbad8-8fdf-465a-94f7-0639fbd3962e)
- ![](https://jane.app/thumbs/409cd9ae-5726-4bae-b27d-9874e3c66603)
- ![](https://jane.app/thumbs/b12dd5d0-31e7-4353-a7c5-593086b3d485)
- ![](https://jane.app/thumbs/97fe954b-9228-4ac4-a32d-e45b7fdc8b14)
- ![](https://jane.app/thumbs/d74025c6-4e82-49cc-9853-86ff72516c97)
- ![](https://jane.app/thumbs/2e3a08ae-c30d-4001-a68e-ad5322359395)
