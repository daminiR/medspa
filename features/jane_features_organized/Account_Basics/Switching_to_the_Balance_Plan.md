...
*Source: [https://jane.app/guide/switching-to-the-balance-plan](https://jane.app/guide/switching-to-the-balance-plan)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:34:04*
...
Feature OverviewSwitching to the Balance Plan
Account Basics
Switching to the Balance Plan
5 min read
Balance Plan
Welcome to our guide on switching to the
Balance Plan
. 👋 If you’d like a refresher on our different pricing plans and what they include, check out our
pricing page
.
The Balance Plan is a great fit for part-time, solo practitioners with 20 or fewer appointments per month. To see if you qualify for the Balance Plan, please take a look at the criteria below. If you qualify, reach out to us at
support@jane.app
to make the switch.
Staff profiles
Number of appointments per month
FAQ
If you’re planning to switch to the Balance plan from another Jane plan, there area a couple of things you might need to do:
Staff profiles
Accounts on the Balance Plan can have one practitioner and unlimited administrative staff members. An admin staff member is a staff profile who isn’t opted into any disciplines in Jane. You’ll want to head to the admin staff profiles in your account, click
Edit/Settings
, uncheck all disciplines and
Save
.
Number of appointments per month
The second eligibility criteria for the Balance Plan is having 20 or fewer appointments per month. The appointments could be booked, arrived, or no-showed (but cancelled appointments don’t count). 
To see how many appointments per month you have, you can head over to
Reports > Hours Scheduled/Booked
and filter the
Date Range
to the previous month.
You’ll want to check out the
Total Bookings
column to see if it’s 20 or fewer.
If you had 20 or fewer appointments last month and you only have one practitioner profile on your Jane Account, reach out to us at
support@jane.app
if you’d like to make the switch.
FAQ
What does the Balance Plan include?
The Balance Plan is a good fit for a solo practitioner with a smaller caseload who may be working part-time, so it has our lightest feature set. To see a full list of what’s included, you can check out our pricing page. Most notably, the Balance Plan does not include online booking, SMS reminders (emails are included though), and the insurance add-on is not available for this plan.
What if I had over 20 appointments last month, but I’ll have fewer next month onward?
When reviewing your account to move you over to the Balance Plan, we’ll always review the criteria based on the previous month, so you’ll want to wait until the end of the month when you’re eligible before reaching out to switch.
What happens if I go over the 20-appointment limit?
Great question! We know that sometimes appointment numbers fluctuate. We conduct monthly audits of accounts on the Balance Plan and if your account goes over the 20-appointment limit, you’ll receive a notification to let you know that your account has been moved up to the Practice Plan.
If I’m on a Legacy Plan and switch to the Balance Plan, can I ever switch back to the Legacy Plan again?
If you were on a Legacy Plan before the Balance Plan, you will have up to 3 months after the change to the Balance Plan to switch back to the Legacy Plan. After those three months, you won’t be able to switch back anymore and will be required to select a plan from our new options if you wish to upgrade your account. Reach out to the support team at support@jane.app if you’d like to switch back to your Legacy Plan within these initial 3 months.
Why can’t I add a license to my subscription?
Clinics on the Balance Plan are limited to one license per account. You can add as many admin staff profiles as you need without updating the license count. For more details on this process, check out our
Step 4: Staff
guide.
If you’re looking to add another practitioner to your subscription, the
Account Owner
needs to upgrade the subscription to either the
Practice
or
Thrive
plans. Visit our
Pricing Page
for more details on the cost and features of each of these plans.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Switching to the Balance Plan
Account Basics
Switching to the Balance Plan
5 min read
Balance PlanWelcome to our guide on switching to the
Balance Plan
. 👋 If you’d like a refresher on our different pricing plans and what they include, check out our
pricing page
.
...
plans. Visit our
Pricing Page
for more details on the cost and features of each of these plans.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b2658019-6220-4e47-a962-0d887f322e99)
- ![](https://jane.app/thumbs/ba9b0f35-fd3d-47a7-9efd-3e8a5c74c85e)
- ![](https://jane.app/thumbs/13484ae7-ad8d-4462-9f05-813f46999ad3)
- ![](https://jane.app/thumbs/4bfcd49e-dcb6-4b24-bf28-9bf08d2ee300)
