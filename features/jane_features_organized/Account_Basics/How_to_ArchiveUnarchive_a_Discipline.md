...
*Source: [https://jane.app/guide/how-to-archive-unarchive-a-discipline](https://jane.app/guide/how-to-archive-unarchive-a-discipline)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:34:30*
...
Feature OverviewHow to Archive/Unarchive a Discipline
Account Basics
How to Archive/Unarchive a Discipline
3 min read
Balance Plan
...
Thrive Plan
Legacy Plans
As your practice evolves, you may find it necessary to remove a discipline from your list of offerings. To get started, a
Full Access
user will want to head over to the
Settings
tab, select
Disciplines
on the left sidebar menu and then
Edit
to the right of that discipline.
Disciplines can only be deleted if there are no treatments currently assigned to the discipline. Jane will display an error message if you hit the
Archive
button with treatments still assigned.
To view the treatments still assigned to the discipline, you’ll want to head over to the
Treatments, Classes & Group Appointments
area of the
Settings
tab and click on the
Edit
to the right of the treatment still currently assigned to the discipline.
Note
📝:
For treatments assigned to a specific practitioner, you’ll want to verify which discipline they’re opted into by heading over to their
Staff Profile
.
Since all treatments need to be assigned to a discipline, you can either
reassign it to another discipline temporarily
or
archive the treatment
. When a treatment is archived in Jane, the discipline is automatically unassigned.
Now that the treatments are no longer assigned, you’ll be able to archive the discipline! Let’s head back over to the
Disciplines
area within the
Settings
tab and click on
Edit
to the right of the discipline. Now you’ll want to click on
Archive
in the bottom left corner and you’re all set!
Viewing an Archived Discipline
If you need to view an archived discipline, you can click on the blue
Show Archived
text in the top right of the
Disciplines
area of the
Settings
tab.
Any archived treatments will have the
Archived
tag to the right of it.
To unarchive it, click
Edit
to the right of the discipline, make any necessary updates and click
Save & Unarchive
to confirm those changes.
Additional Notes
If you need to remove a staff member from a discipline, you can head over to their profile and click on
Edit/Settings
. From there, you can toggle off the disciplines they no longer offer.
As always, our support team is happy to help if you have any additional questions or concerns. Feel free to
reach our to us
!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Archive/Unarchive a Discipline
Account Basics
How to Archive/Unarchive a Discipline
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansAs your practice evolves, you may find it necessary to remove a discipline from your list of offerings. To get started, a
Full Access
user will want to head over to the
Settings
tab, select
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps](https://jane.app/thumbs/fe10ce6a-7bf4-40a1-82db-0fbd31828613)
- ![An image of the error message Jane will display](https://jane.app/thumbs/12675fb8-5d3e-4786-adb0-0c0465738742)
- ![An image of the navigational steps](https://jane.app/thumbs/99908614-d0e9-42ab-a7f5-ecb648e61174)
- ![An image of where to view the disciplines a staff member is opted into within their profile](https://jane.app/thumbs/6c31972b-efad-4572-8078-c61aee7d184f)
- ![An image of the navigational steps and where to view the archive button](https://jane.app/thumbs/b28a2f6e-36b4-4e26-ae32-48c1d8ee7dc0)
- ![An image of the navigational steps](https://jane.app/thumbs/ba39e76b-2c64-4bec-aa68-bcb57aafbd73)
- ![An image of where Jane will display the archived tag on treatments](https://jane.app/thumbs/0ea2d2c2-9718-4c62-9ddb-4d5390d0b743)
- ![An image of where to view the sand and unarchive option](https://jane.app/thumbs/72008bbb-0269-4a66-9a64-4050feae7e98)
- ![](https://jane.app/thumbs/0e159f73-9a38-474d-b7ef-b94b0b024f01)
