...
*Source: [https://jane.app/guide/keyboard-shortcuts](https://jane.app/guide/keyboard-shortcuts)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:31:50*
...
Feature OverviewKeyboard Shortcuts
Staff Profiles
Keyboard Shortcuts
3 min read
Balance Plan
Practice Plan
Thrive Plan
Jane loves to be efficient!
That’s why there are a number of keyboard shortcuts you can use to navigate the Schedule with fewer clicks.
You can view a full list of available shortcuts account by
clicking on your username
in the top right corner of your Jane and selecting
Keyboard Shortcuts
. ⤵️
😎 Here are some of the more popular functions:
Function
Keyboard Shortcut
Double Booking View
D
Privacy / Blurred Patient Names
Shift + P
Search Patient
S
Today
T
View Staff Working Today
Shift + T
Next Day/Week
N
Previous Day/Week
...
Hide / Show Weekends
`
View the Next # of Upcoming Days
1 - 7
Change Location
L
View Wait List
...
Shift + ⬇️
The Spacebar 🪐
There are a couple of areas where the spacebar comes in handy for viewing complete lists of adjustments, products, packages & memberships. This is perfect for those times when you need to look up an item super quick, but can’t remember the name of it (we’ve all been there!)
In the search that appears when you’re adding an item, you’ll want to hit the
spacebar
on your keyboard. Jane will populate a list of all the offerings or price adjustments created, so there is no need to memorize the entire list. Neat, eh?
A quick note on Double Booking
Enabling
Double Booking
view (
keyboard shortcut: D
...
not
allow patients to Double Book online.  It simply squishes the appointments to half-size on your schedule so you can overlap appointments as needed. If you’ve enabled this by accident, not to worry! You can head to
Settings > Schedule Settings
to disable it.
If you
do
allow appointments to overlap regularly and are looking to open it to Online Booking, please view our guide on the best ways to set up
Staggered Booking (Multiple Rooms or Clients Overlapping)
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Keyboard Shortcuts
Staff Profiles
Keyboard Shortcuts
3 min read
Balance Plan
Practice Plan
Thrive PlanJane loves to be efficient!
That’s why there are a number of keyboard shortcuts you can use to navigate the Schedule with fewer clicks.
You can view a full list of available shortcuts account by
clicking on your username
in the top right corner of your Jane and selecting
...
do
allow appointments to overlap regularly and are looking to open it to Online Booking, please view our guide on the best ways to set up
Staggered Booking (Multiple Rooms or Clients Overlapping)Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/fafff51c-9da9-4316-adbb-b8989d2a6e8c)
- ![screenshot of what happens when you hit the spacebar in a search box](https://jane.app/thumbs/a590fb11-e9ac-48ea-835a-403ae473b499)
