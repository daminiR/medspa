...
*Source: [https://jane.app/guide/adding-a-billing-address-for-locations](https://jane.app/guide/adding-a-billing-address-for-locations)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:34:13*
...
Feature OverviewAdding a Billing Address for Locations
Account Basics
Adding a Billing Address for Locations
3 min read
If you’re setting up a location on your account, you might be wondering how billing addresses work.
Before we dive into this feature, you can check out our guide on
Adding a Location
for more information on setting up a location.
What is a Billing Address?
So glad you asked! This is the address that appears on all financial documents sent to your clients, such as invoices, receipts, and patient statements. If you’re noticing that the wrong address is being displayed on your invoices, this would be a great place to start investigating🕵️‍♀️.
If the address you want on financial documents differs from the location entered in the
Location Address & Map
field (located above the
Billing Information
field), simply uncheck
“Use my location address for billing.”
This action will reveal new fields where you can enter an alternate address.
Additionally, you can also add in your
Business Number
or
Tax Number
so they’re included on all financial documents issued from Jane, even with this setting toggled off.
Here’s a sneak peek at where it’s displayed:
...
To hide your address on invoices, receipts, and statements, scroll down to the
Billing Information
section.
After unchecking
“Use your location address as the billing address,”
you can enter details like “Virtual Practice” for the address along with City, Province, Country and Postal/Zip Code (these are the only required fields).
Note📍:
Jane will suggest addresses for you to select from, but you can click outside the box without choosing one.
This ensures Jane doesn’t display your location address on your financial documents. Once you’re happy with your changes, simply click
Save
to finish up!
...
for more details on how you can customize or remove the billing address or contact information that appears in the footer of an invoice.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adding a Billing Address for Locations
Account Basics
Adding a Billing Address for Locations
3 min readIf you’re setting up a location on your account, you might be wondering how billing addresses work.
Before we dive into this feature, you can check out our guide on
Adding a Location
for more information on setting up a location.
What is a Billing Address?
...
Check out our guide on
Customizing or Removing the Footer on Financial Documents
for more details on how you can customize or remove the billing address or contact information that appears in the footer of an invoice.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![image of the billing information panel when setting up a location](https://jane.app/thumbs/346518f9-6b9c-4953-a739-7616b82b118e)
- ![](https://jane.app/thumbs/6c757c02-5f47-42b9-8abe-39150fe8e234)
- ![](https://jane.app/thumbs/13202270-aab0-46b3-843b-735fb617579d)
