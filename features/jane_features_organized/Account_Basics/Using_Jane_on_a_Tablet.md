...
*Source: [https://jane.app/guide/using-jane-on-a-tablet](https://jane.app/guide/using-jane-on-a-tablet)*

*Category: Account Basics*

*Scraped: 2025-08-06 23:31:33*
...
Feature OverviewUsing Jane on a Tablet
...
Practice Plan
Thrive Plan
The easiest way for practitioners to view Jane on their tablet is to use the
Day Sheet
view at the top.  Click the patient appointment once to open the chart and then again to open the appointment details pane.  It would look like this:
...
Note that you’ll need to be using Safari on iOS (iPad/iPhone) or Chrome on an Android device and if you regularly open and view PDF documents, it would be best to run Jane directly from Safari instead of a bookmark. Apple designed its bookmarks in a way that prevents easily navigating out of an opened document.
...
iOS
Option 1 - Safari:
If you’re using Safari, you’ll want to ensure you have selected your
Day
...
Add to Home Screen
option in the list, which will let you save an app-like icon to the home screen that will take you directly to the current date in the Day tab.
Option 2 - Chrome:
If you are using Chrome, you can click the same
box arrow icon > Add to Home Screen
options to save the shortcut to your iPad’s home screen.
Android
Click
here
for instructions.
Additional Notes & Resources
See more helpful tips for working with tablets on the
Browsers and Devices
help page
Learn all the tips and tricks for
Using Jane on a Smartphone
Need to book time off on the fly? check out our
Booking a Break on a Mobile Device
Did you know you can use your mobile device to take photos and load those directly into a client’s chart? Learn more with our guide on
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Using Jane on a Tablet
Practitioner Profiles
Using Jane on a Tablet
3 min read
Balance Plan
Practice Plan
Thrive PlanThe easiest way for practitioners to view Jane on their tablet is to use the
Day Sheet
view at the top.  Click the patient appointment once to open the chart and then again to open the appointment details pane.  It would look like this:
To book appointments from the schedule on a tablet, it’s easiest to use the little magnifying glass icon next to the treatment type.  That will light up all available spots and then you can click the one you want to book.  That looks like this:
How do I save Jane to my home screen?
...
Whether you’re using Jane on an iPad, Android tablet or smartphone, our
Charting on a Mobile Device (Tablet or Smartphone)
guide walks through navigating charting on a smaller screen.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/475596d1-392d-4119-b113-8a8efa6299f1)
- ![](https://jane.app/thumbs/1a1bacac-bbba-48bb-b8a7-ab04cec23dd4)
- ![](https://jane.app/thumbs/9dcadb07-7bc8-49d7-8df2-6ca8a98a0a19)
- ![](https://jane.app/thumbs/cdbe1126-6723-4428-9fda-a5e748770830)
