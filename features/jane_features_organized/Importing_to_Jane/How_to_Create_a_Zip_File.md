...
*Source: [https://jane.app/guide/how-to-zip-and-upload-files-in-jane](https://jane.app/guide/how-to-zip-and-upload-files-in-jane)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:36:52*
...
Feature OverviewHow to Create a Zip File
Importing to Jane
How to Create a Zip File
4 min read
If you’ve stumbled on this page, chances are you’re getting ready to import your data into Jane. How exciting! Let’s dive in and make sure you’re set up for success.😄
Before you upload your files to the folder in your scheduled import, you’ll want to make sure you add them to a Zip folder. It’s a handy trick that will help ensure you don’t run into any issues when uploading your files — not to mention save you time and free up some space on your hard drive.
Why Your Data Needs to Be in a Zip Folder
In some cases, you may have hundreds (or maybe even thousands!) of client files that need to be imported to Jane. Even if you love handling data as much as our Imports team, having to upload each file individually wouldn’t be very fun.
Creating a ZIP file compresses one or more files or folders into a single file. You can even lock your ZIP files with passwords for fast and easy protection🔐
Why Zip Your Files?
You can think of it like you’re packing a bunch of coins into a single pouch and then zipping it closed. This makes it easy to move and easy to send.
...
Below is a step-by-step walkthrough on how to zip a folder to import your data to Jane:
Compressing Files on Windows
Find your files: Locate the files you want to zip. You can highlight and choose one or multiple files
Select and Right-click: Click on the files and right-click to open the menu
Choose “Compress”: Look for the option to “Compress” or “Send To” and give it a click
Wait for it: Let your computer do its thing. It’ll take a moment to zip everything up
Check it: Make sure everything’s in the ZIP file and the compression went smoothly
Compressing files on MacOS
You can follow the same steps if you are on a Mac device, and your screen should look like this:
Once your data’s all zipped up, you can head over to the Imports area in your Account Settings to upload it. And remember, you’ll want to wait for that progress bar to hit 100% before hitting
Done
or leaving the page. 😊
Need a hand? We’ve got your back every step of the way! You can send us a message in the Imports area of your account or drop us an email at
support@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Create a Zip File
Importing to Jane
How to Create a Zip File
4 min readIf you’ve stumbled on this page, chances are you’re getting ready to import your data into Jane. How exciting! Let’s dive in and make sure you’re set up for success.😄
Before you upload your files to the folder in your scheduled import, you’ll want to make sure you add them to a Zip folder. It’s a handy trick that will help ensure you don’t run into any issues when uploading your files — not to mention save you time and free up some space on your hard drive.
Why Your Data Needs to Be in a Zip Folder
In some cases, you may have hundreds (or maybe even thousands!) of client files that need to be imported to Jane. Even if you love handling data as much as our Imports team, having to upload each file individually wouldn’t be very fun.
Creating a ZIP file compresses one or more files or folders into a single file. You can even lock your ZIP files with passwords for fast and easy protection🔐
...
For more information on the
Basics of Importing to Jane
, you can click here.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of how to compress a file on a Windows device](https://jane.app/thumbs/3ea512e7-a4da-4641-b55c-bfb7ff7cc384)
- ![An image of how to compress a file on a MacOS device](https://jane.app/thumbs/ec95d479-2999-469d-975d-a1aeed06e650)
- ![An image of the progress bar when uploading import files to Jane](https://jane.app/thumbs/c757411f-da32-40d5-9a45-c524eb2fcae5)
