...
*Source: [https://jane.app/guide/manual-chart-transfers-transferring-selected-charts-to-a-different-jane-account](https://jane.app/guide/manual-chart-transfers-transferring-selected-charts-to-a-different-jane-account)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:37:01*
...
Feature OverviewManual Chart Transfers: Transferring Selected Charts to Another Jane Account
Importing to Jane
Manual Chart Transfers: Transferring Selected Charts to Another Jane Account
2 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Moving to a new Jane account and only need to transfer a specific group of charts? No worries, we’ve got you covered!
If you’re looking to transfer a subset of
more than 8-10 patients’ charts
to another Jane account, our Imports team can help out with a
Manual Chart Transfer
.
This process is a little different from a standard
Data Transfer (Jane-to-Jane Chart Transfer)
, which is used when you need to transfer a
full set of charts
, and does require an authorization form to be signed.
To get started, just shoot an email to our Imports team at
support@janeapp.com
. Here’s what to include:
Source Account: The name of the Jane account the charts are coming from.
Destination Account: The name of the Jane account the charts are going to.
The practitioner’s first and last name and email address.
An estimate of how many patients’ charts need to be transferred (no need for an exact count, just let us know if it’s more or less than 8-10 patients 😊).
Once we have these details, our Imports team will give you the next steps and guide you through the process.
If you’d like a sneak peek at the authorization form that we send for this process, feel free to check out
Jane-to-Jane Chart Transfer Authorization Form Explainer
, which dives into all of this 🤿
What If I’m Transferring Fewer Than 8-10 Patients’ Charts?
For fewer than 8-10 patients, it’s quicker to export the data from each patient’s profile and upload the charts to the
Files
section in the new account.
This method is faster than a manual chart transfer and doesn’t require an authorization form or a scheduled import.
Need help exporting charts from the original Jane account? This guide might come in handy:
Exporting Chart Notes
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Manual Chart Transfers: Transferring Selected Charts to Another Jane Account
Importing to Jane
Manual Chart Transfers: Transferring Selected Charts to Another Jane Account
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansMoving to a new Jane account and only need to transfer a specific group of charts? No worries, we’ve got you covered!
If you’re looking to transfer a subset of
more than 8-10 patients’ charts
to another Jane account, our Imports team can help out with a
Manual Chart Transfer
...
This method is faster than a manual chart transfer and doesn’t require an authorization form or a scheduled import.
Need help exporting charts from the original Jane account? This guide might come in handy:
Exporting Chart NotesSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of an image added to a patients Files tab](https://jane.app/thumbs/9ce7b3ba-a263-4def-98ca-d8cd204ebbbf)
