...
*Source: [https://jane.app/guide/where-can-you-import-from-our-software-import-guides](https://jane.app/guide/where-can-you-import-from-our-software-import-guides)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:35:20*
...
Feature OverviewWhere Can You Import From? Our Software Import Guides
Importing to Jane
Where Can You Import From? Our Software Import Guides
4 min read
Balance Plan
Practice Plan
Thrive Plan
Welcome to our imports page! 🎉
Over our long history of importing data from other softwares into Jane, we’ve created a list of guide documents on importing from some of the most common softwares to help facilitate your transition onto Jane. This list is by no means exhaustive, so if you don’t see your software on the list, don’t fret! Our team will do our best to help figure it out.
Speaking of our team, we have a group of import specialists that can provide guidance and support during any changes to Jane, completely for free. Don’t hesitate to reach out to book your import or if you have any questions.
...
File Type
We can import patients, appointments, and existing insurance policies from
Microsoft Excel
,
CSV
or
Numbers
text files that are provided in clearly labeled columns. Charts can be imported if they are provided in
Excel
,
CSV
or
...
If you’d like to see more information on importing from somewhere that’s not on this list or the process in general, you can look at the
Basics of Importing to Jane
which outlines not only file types, but the required information when importing different types of data.
Common Software from which we Import
Okay! We’re still building out the full list, but check below to to see if your software is listed. If you need further info, you can always contact us at
support@janeapp.com
or by calling 1-844-310-5263 (JANE).
Jane 🙂
Abelmed
Accuro
Acuity
...
Cerbo
ChiroTouch
ChiroTouch Cloud Version
ChiroFusion
Chirosoft
ChiroSpring
Chirosuite
Click4Time
ClientTracker (Ginko Software)
Clinic Essentials
Clinicmaster Desktop Version
Clinicmaster Cloud Version
ClinicND
Cliniko
Clinicsense
CounSol.com
...
TM2/TM3
Unified Practice
Universal Office by Antibex Software
Vagaro
WebPT
WellnessLiving
Wix
...
Write Upp
Zenoti
Don’t see your software on this list? Check our
basics of importing to Jane
guide to see what file types we can import into Jane!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Where Can You Import From? Our Software Import Guides
Importing to Jane
Where Can You Import From? Our Software Import Guides
4 min read
Balance Plan
Practice Plan
Thrive PlanWelcome to our imports page! 🎉
Over our long history of importing data from other softwares into Jane, we’ve created a list of guide documents on importing from some of the most common softwares to help facilitate your transition onto Jane. This list is by no means exhaustive, so if you don’t see your software on the list, don’t fret! Our team will do our best to help figure it out.
Speaking of our team, we have a group of import specialists that can provide guidance and support during any changes to Jane, completely for free. Don’t hesitate to reach out to book your import or if you have any questions.
You can reach us here
.
...
Don’t see your software on this list? Check our
basics of importing to Jane
guide to see what file types we can import into Jane!Subscribe to our monthly newsletter.Jane Software Inc.
