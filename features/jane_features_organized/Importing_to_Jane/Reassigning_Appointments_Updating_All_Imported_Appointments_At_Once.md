...
*Source: [https://jane.app/guide/reassigning-appointments-updating-all-imported-appointments-at-once](https://jane.app/guide/reassigning-appointments-updating-all-imported-appointments-at-once)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:36:14*
...
Feature OverviewReassigning Appointments (Updating All Imported Appointments At Once)
Importing to Jane
Reassigning Appointments (Updating All Imported Appointments At Once)
4 min read
Balance Plan
...
While we do our best to match up your exported information with your Jane information, we may have information that does not line up exactly. In this case we import the appointment, and prefaced any treatments that have not been matched up with the word
“Import - “
.
All the data has been brought into Jane for you, now you get to tell Jane which treatments these correlate too.
There are two methods of doing this as a batch.
Option 1 - Already Created Your Treatments
If you’ve already created your list of
Treatments
in Jane, the next step is to match up your imported treatments with your newly created treatments. You can do this by heading to
...
After you click
Reassign
, you can match up your imported treatments on the left with your Jane treatments on the right by selecting an option from the drop-down menu. You can also check the box to the right to archive the “import” treatment after it’s been re-assigned.
Once everything is matched up, scroll to the bottom of the page and select the “Change Past & Upcoming” option if you also want to update past appointments. Then click
Reassign Treatments
:
Option 2 - Forgot to Create your Jane Treatments
If this is a treatment that you still offer, but you forgot to create it in Jane, you can go to
Settings > Treatments & Classes > and find the imported treatment.
Click the Edit button
to rename the treatment, assign it to the proper Discipline or Staff Member, add in pricing, and all other required fields, then hit Save to finish.
Additional Notes:
I noticed that the ‘Upcoming Appointments’ Totals in the ‘Reassign Treatment’ area are higher than the actual upcoming booked appointments on the Schedule. Why is that?
This can be a bit tricky! Those numbers don’t just represent booked appointments, but will also take into account appointments of
all statuses
(i.e. cancelled, deleted etc). Why? Well, reassigning treatments means updating all appointments, regardless of status. This helps keep everything in sync for when you run reports in Jane. It’s like a domino effect but in a good way!
For the other appointments that you’re not seeing on the schedule, you can head over to the
Reports
tab and then select
Appointments
.
The default for this report will be All States but you can use the other filters to help narrow down the data a bit. For more information on this report, check out our guide doc on the
Appointments Report
!
Any Questions?
We know that this is your first (and only!) time working with treatments in this way, so if you have any questions about how to match up treatments, please do not hesitate to give us a call and we’d be more than happy to walk through it with you. 1-844-310-JANE (5263).
Just like that, you are done and ready to arrive your patients.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Reassigning Appointments (Updating All Imported Appointments At Once)
Importing to Jane
Reassigning Appointments (Updating All Imported Appointments At Once)
4 min read
Balance Plan
...
Any Questions?
We know that this is your first (and only!) time working with treatments in this way, so if you have any questions about how to match up treatments, please do not hesitate to give us a call and we’d be more than happy to walk through it with you. 1-844-310-JANE (5263).
Just like that, you are done and ready to arrive your patients.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/fe6b588d-de1b-4f46-8805-de165151f825)
- ![](https://jane.app/thumbs/0705565c-c8a3-4b0b-adf2-f02a03fbe5f5)
- ![](https://jane.app/thumbs/847c34e3-afef-48e0-97ba-d31baf830c70)
- ![](https://jane.app/thumbs/0955368d-d3a0-45b9-8a9c-021b7cb0c352)
