...
*Source: [https://jane.app/guide/importing-other-types-of-data-alongside-a-jane-to-jane-chart-transfer-data-transfer](https://jane.app/guide/importing-other-types-of-data-alongside-a-jane-to-jane-chart-transfer-data-transfer)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:37:19*
...
Feature OverviewImporting Other Types of Data Alongside a Jane-to-Jane Chart Transfer (Data Transfer)
Importing to Jane
Importing Other Types of Data Alongside a Jane-to-Jane Chart Transfer (Data Transfer)
2 min read
Balance Plan
...
Thrive Plan
Legacy Plans
If you’re helping a practitioner transfer charts from one Jane account to another via a
Jane-to-Jane Data Transfer
, you might be wondering, “How the heck do we transfer other types of data, like patient lists, appointments, and insurance policies?!” Don’t worry—we’ve got you covered 😉.
Transferring Additional Types of Data
To move other types of data, the destination account owner will just need to schedule an import in the practitioner’s
new
account by heading to
Settings > Schedule an Import > Begin
.
Once the import is scheduled, the account owner (or someone with full access) can export the
Appointments Report, Patient List Report
, and
Insurance Policies
from the
Reports
tab.
After exporting, simply share these files with the practitioner so the destination account owner can upload them to the import folder within their
Schedule an Import
settings.
Once the data is uploaded, the destination owner can click the blue
“Done”
button, and our wonderful imports team will take it from there!
As a heads-up
– the data in the original account stays exactly where it is, and it’s never removed. We simply make a duplicate copy and import the exported data into the new Jane account.
That should do it! For more detailed steps on the
Basics of Importing to Jane
, you can check out this guide, or visit:
Importing From Jane
To view what type of data we’re able to import, click here:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing Other Types of Data Alongside a Jane-to-Jane Chart Transfer (Data Transfer)
Importing to Jane
Importing Other Types of Data Alongside a Jane-to-Jane Chart Transfer (Data Transfer)
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansIf you’re helping a practitioner transfer charts from one Jane account to another via a
Jane-to-Jane Data Transfer
, you might be wondering, “How the heck do we transfer other types of data, like patient lists, appointments, and insurance policies?!” Don’t worry—we’ve got you covered 😉.
Transferring Additional Types of Data
To move other types of data, the destination account owner will just need to schedule an import in the practitioner’s
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![A picture of how to schedule an import fromt he account settings](https://jane.app/thumbs/87eec5a0-1dd0-4840-ad4c-fcf1aefbd066)
- ![A picture of the Upload Folder in the scheduled Import settings](https://jane.app/thumbs/ccffe2bb-b6f9-4366-a0c4-9c24434aa284)
