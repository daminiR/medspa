...
*Source: [https://jane.app/guide/update-appointment-individually](https://jane.app/guide/update-appointment-individually)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:36:22*
...
Feature OverviewUpdating an Imported Appointment Individually
Importing to Jane
Updating an Imported Appointment Individually
1 min read
Congratulation on importing your data!
You are almost done as you’ll need to change the appointments from the Imported Version to the version in Jane.
Note:
You will only be able to do this if a treatment has been set up in Jane. If you need help with this here is a good place to start:
setting up treatments
To do this individually for each appointment,
select the appointment on the Schedule
and then
click the pencil icon
next to the treatment name in the Appointment Pane.
From here, select the correct treatment from the list and click Update Appointment.
This can be done for each upcoming appointment as needed.
If you’d like to do that as a batch, mosey over to our other document:
Updating All Importing Appointments
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Updating an Imported Appointment Individually
Importing to Jane
Updating an Imported Appointment Individually
1 min readCongratulation on importing your data!
You are almost done as you’ll need to change the appointments from the Imported Version to the version in Jane.
Note:
You will only be able to do this if a treatment has been set up in Jane. If you need help with this here is a good place to start:
setting up treatments
...
This can be done for each upcoming appointment as needed.
If you’d like to do that as a batch, mosey over to our other document:
Updating All Importing AppointmentsSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/cfe7a8a7-24d8-413f-bf56-217ba083d02c)
- ![](https://jane.app/thumbs/3ed6f2b6-d301-40f3-860b-4db04c773db5)
