...
*Source: [https://jane.app/guide/transitioning-your-patient-credits-receivables-to-jane](https://jane.app/guide/transitioning-your-patient-credits-receivables-to-jane)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:36:03*
...
Feature OverviewTransitioning Your Patient Credits/Receivables to Jane
Billing
Transitioning Your Patient Credits/Receivables to Jane
4 min read
Balance Plan
...
If you would like to move over patient credits you can do so using “
Credit Memos
”.  It’s often a good idea to choose a date from before you started with Jane so that these credits don’t display on any of your current reporting.
...
From Import
If we imported your past appointments, you can create an A/R charge for your patient by returning to the appropriate appointment(s) in the past and activating the billing. Click on the appointment to open the “appointment panel”. If the appointment hasn’t been attached to a Jane treatment, then use the pencil button beside the treatment description to choose a treatment and attach a charge.
Be careful with insuring appointments, as you don’t want to create duplicate insurer invoices (especially for Teleplan insurers).
...
❗Please Note❗
: This option works best in cases where the client with an outstanding balance has only seen one practitioner, and where the balance owing does
not
need to be billed to a third party. In cases where the balance owing will need to be paid to multiple practitioners, or where a third party payer is requiring a detailed breakdown of each date of service billed for, you are best to manage invoicing for those amounts owing by booking and arriving appointments in the past, or arriving past appointments that were imported to generate these invoices. This ensures that all relevant (and important!) details are included on each invoice, and that each therapist is compensated accurately when payment is made.
...
create a product
called “Outstanding A/R From Previous Software”.
You can then
sell this product
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Transitioning Your Patient Credits/Receivables to Jane
Billing
Transitioning Your Patient Credits/Receivables to Jane
4 min read
Balance Plan
Practice Plan
Thrive PlanPart of the transition from one Management Software to another is working with your outstanding credits/balances.
Moving over Patient Credits
If you would like to move over patient credits you can do so using “
Credit Memos
”.  It’s often a good idea to choose a date from before you started with Jane so that these credits don’t display on any of your current reporting.
...
.
You’ll now see the outstanding balance here with the relevant invoice within the client’s account.
And that’s it! Now you can go ahead and collect your money 😊🎉Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/08/15/85t0blojpu_blob)
- ![](https://jane.app/thumbs/4805bbbb-ef1a-40bc-ad34-61417342bdeb)
- ![](https://jane.app/thumbs/e7e235bc-53ac-4497-9846-5475bba4f435)
