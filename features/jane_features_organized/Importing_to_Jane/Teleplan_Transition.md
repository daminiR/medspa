...
*Source: [https://jane.app/guide/teleplan-transition](https://jane.app/guide/teleplan-transition)*

*Category: Importing to Jane*

*Scraped: 2025-08-06 23:35:55*
...
Feature OverviewTeleplan Transition
Teleplan
Teleplan Transition
4 min read
Practice Plan
...
After the Remittance date, connect Jane to Teleplan (in the
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Teleplan Transition
Teleplan
Teleplan Transition
4 min read
Practice Plan
Thrive PlanIf you are already billing Teleplan within BC for MSP or WSBC claims there will be claims that you have billed in your old system before moving to Jane.
There’s a few steps we recommend to help make the transition as smooth as possible and to limit the number of claims that were created in your old system but paid into Jane.
You can start up with your Jane account anytime, but it’s best to transition the Teleplan billing in the couple of days between a Remittance and the next billing Cut Off.
Old System
DO NOT connect Jane to Teleplan until you will no longer be communicating with Teleplan in your old system.  Teleplan gets confused if multiple systems are talking to it at the same time.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2015/06/23/73cypkmlkm_blob)
