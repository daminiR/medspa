...
*Source: [https://jane.app/guide/privacy-compliance-for-clinics-in-alberta](https://jane.app/guide/privacy-compliance-for-clinics-in-alberta)*

*Category: Privacy*

*Scraped: 2025-08-07 02:45:39*
...
Feature OverviewPrivacy: Compliance for Clinics in Alberta
Privacy
Privacy: Compliance for Clinics in Alberta
6 min read
Balance Plan
...
Thrive Plan
Legacy Plans
The legislation that is applicable to clinics in Alberta will depend on the type of practice that you’re running. Alberta’s
Health Information Act
is the most prescriptive legislation but it only applies to a select group of practitioners who are designated as “custodians” under the Act. For typical Jane customers, this just includes chiropractors but you can view the full list of practitioners in
Section 2(1) and 2(2) of the Health Information Regulation
. Under
HIA Section 60
, clinics who act as custodians of health information have a “duty to protect health information.” Jane can help clinics act as trusted gatekeepers of the health information collected and stored.
For other practitioners not covered by the Health Information Act, Alberta’s
Personal Information and Protection Act
will apply.
Privacy Impact Assessment
For practitioners who are governed by the Health Information Act, you will need to complete a
Privacy Impact Assessment
. The
Alberta Privacy Commissioner’s Office
makes it clear that PIA is voluntary for other organizations not regulated by the Health Information Act:
...
and
Terms & Conditions
within your PIA, and reach out to the Jane Team so that we can provide you with an Information Management Agreement as well. These are the agreements you enter into when starting up with Jane.
...
Privacy guarantees via
Privacy Policy
and
Terms & Conditions
Charts are
signed, locked, timestamped
.
Access controls
- Jane account owner chooses which staff what access to what information in Jane.
Unique passwords - all Jane users are required to login individually, and all of their behaviour in Jane can be identified. Passwords are also
easily reset
for the highest level of security.
Behaviour tracking - logged in, every click of every button is tracked for each user. Clinic owners can audit their
Activity Log
Jane securely stores
health information in secured SOC2 Type2-certified data centers, and all data is backed up regularly on secondary servers.
Search and
tag
health information for easy retrieval
Flexible
charting
to meet regulatory requirements
Limited ability to delete
patient
for which health information has been added
Controlled disclosure and sharing of health information:
patients
Customizable electronic forms for alerting patients of privacy rights and collecting consent (use the
Intake Form
feature for all forms sent in Jane).
Keyboard shortcut
that blurs patient names on the schedule - in case someone likes to look over your shoulder while rebooking
Data is saved in real time as you add it to Jane.
For detailed information on these features and more, have a look at Jane’s
List of Security Features
. You can also read more about HIA directly from Alberta’s
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Privacy: Compliance for Clinics in Alberta
Privacy
Privacy: Compliance for Clinics in Alberta
6 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansThe legislation that is applicable to clinics in Alberta will depend on the type of practice that you’re running. Alberta’s
Health Information Act
is the most prescriptive legislation but it only applies to a select group of practitioners who are designated as “custodians” under the Act. For typical Jane customers, this just includes chiropractors but you can view the full list of practitioners in
Section 2(1) and 2(2) of the Health Information Regulation
. Under
