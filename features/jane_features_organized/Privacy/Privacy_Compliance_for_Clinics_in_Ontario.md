...
*Source: [https://jane.app/guide/privacy-compliance-for-clinics-in-ontario](https://jane.app/guide/privacy-compliance-for-clinics-in-ontario)*

*Category: Privacy*

*Scraped: 2025-08-07 02:46:25*
...
Feature OverviewPrivacy Compliance for Clinics in Ontario
Privacy
Privacy Compliance for Clinics in Ontario
14 min read
Balance Plan
...
Jane wants to help so in this post we first summarize:
Which privacy laws apply in Ontario
And then, answer these questions:
What information is considered Personal Health Information (PHI) in Ontario?
What are legal privacy obligations?
What actions do clinics/practitioners need to take to be compliant?
How does Ontario law define and require consent? (NOTE: Consent requirements are highly specific in Ontario)
Who enforces Ontario law?
Are there other privacy laws in Ontario to be aware of?
...
Keep all PHI and information that identifies individuals, administrative and clinical, as up-to-date as possible. The law also allows for
prioritization
. For instance, in a clinical setting, it will often be much more important to have up-to-date clinical health records than administrative contact information. In an ideal world, all data is perfect. In practice, first choose to spend time keeping health records as accurate as possible and then work on keeping additional patient information accurate as well.
Clinics and practitioners are required to make a reasonable effort to
correct any record that is inaccurate or incomplete
and respond to an individual’s request to correct a record within 30 days. Clinics and practitioners should also be available, to a reasonable extent, to inform anyone to whom the information has been disclosed of changes.
...
Jane can help you keep PHI secure:
Security FAQ
...
In Jane, you can share individual chart entries (PHI) by releasing them to a patient’s Jane account. When the person logs into Jane, that shared chart will be visible to them:
Sharing Chart Entries with Patients
.
Right of Access Limitations under PHIPA
The right of access applies only to records that are dedicated to one individual. If a record is about more than one individual, only the portion of the record about that individual may be granted. Right of access also does not apply to quality of care information, quality assurance information, raw data from psychological tests and assessments or other types of specified information. Certain legal privileges, laws, proceedings, inspections, and investigations may restrict disclosure in some cases. Right of access does not apply if disclosure would result in serious harm to any person.
For information on how your clinic can use Jane as a tool for privacy-compliant PHI, read our Guide document:
...
- permission for an action can be assumed based on the circumstance and related information. When PHI disclosure is for the purpose of providing further health care - for example, in the case of disclosing PHI when referring care to another practitioner - consent can be implied.
Definition of Express Consent
- the act of an individual expressly giving permission for an action. When PHI disclosure is for any other purpose not related to extending health care services, consent must be express.
Although,
Consent is NOT required
for collection, use and disclosure when the clinic/practitioner believes based on
reasonable grounds
that collection, use or disclosure is necessary to eliminate or reduce a significant risk of bodily harm to one or more persons.
There are also other
very specific
exceptions to consent regulations.
It’s OK to USE PHI without consent:
when you are using the information for the purpose for which it was
already
collected
...
Ontario’s privacy laws are upheld and enforced by the
...
- for the general public sector
As well as Ontario’s
Municipal Freedom of Information and Protection of Privacy Act
- specifically for municipal governments and organizations.
If you think you might be practicing under provincial or municipal public-sector law in Ontario, have a look at Ontario’s resource for step-by-step advice on how to follow the law from beginning to end:
Planning for Success: Privacy Impact Assessment Guide
Still Have Questions?
Have any questions about this guide or anything else related to privacy? Feel free to email Privacy and Security Support at privacy@jane.app and we’d love to clarify anything you’re unsure on!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Privacy Compliance for Clinics in Ontario
Privacy
Privacy Compliance for Clinics in Ontario
14 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansOntario is unique for having passed provincial legislation specifically regarding the privacy of Personal Health Information (PHI) that has also been deemed “Substantially Similar” to federal law. There are many details clinics need to keep in mind and actions they need to take to become compliant.
Jane wants to help so in this post we first summarize:
Which privacy laws apply in Ontario
And then, answer these questions:
What information is considered Personal Health Information (PHI) in Ontario?
...
Planning for Success: Privacy Impact Assessment Guide
Still Have Questions?
Have any questions about this guide or anything else related to privacy? Feel free to email Privacy and Security Support at privacy@jane.app and we’d love to clarify anything you’re unsure on!Subscribe to our monthly newsletter.Jane Software Inc.
