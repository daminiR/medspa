...
*Source: [https://jane.app/guide/gdpr-consent-language](https://jane.app/guide/gdpr-consent-language)*

*Category: Privacy*

*Scraped: 2025-08-07 02:47:48*
...
Feature OverviewGDPR Consent Language
Privacy
GDPR Consent Language
5 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Consent under GDPR refers to one thing:
COLLECTING AND PROCESSING DATA
. We recommend reading our document on this:
GDPR Consent Rules
. But to sum up, most clinics using Jane aren’t going to need consent to collect and process data. Instead, they will be documenting Article 6(f) and Article 9(1) of GDPR as the Legal Basis upon which they collect and process data.
...
For more related help docs:
Read our Guide on
email notifications
for more information on clinic-level changes.
On reminders read:
Email & SMS Reminders
Consent for Treatment
Consent for treatment will be handled differently depending on what health care service you offer. In Jane, consent forms are completely customizable to your needs, and are built from
Chart Templates
. If you don’t want to build the forms from scratch, you can start with our
Chart Template Library
, chose a form that looks similar to what you need, and then make any necessary adjustments.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)GDPR Consent Language
Privacy
GDPR Consent Language
5 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansConsent under GDPR refers to one thing:
COLLECTING AND PROCESSING DATA
. We recommend reading our document on this:
GDPR Consent Rules
. But to sum up, most clinics using Jane aren’t going to need consent to collect and process data. Instead, they will be documenting Article 6(f) and Article 9(1) of GDPR as the Legal Basis upon which they collect and process data.
...
Chart Template Library
, chose a form that looks similar to what you need, and then make any necessary adjustments.
This information is merely a general summary. It is not intended to be nor should it be interpreted as legal advice.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2018/05/07/7vz4vw25l_disable_clinic_notifications.jpg)
- ![](https://jane.app/system/dragonfly/production/2018/05/07/8e8l19b8un_generic_treatment_names.jpg)
- ![](https://jane.app/system/dragonfly/production/2018/05/07/8e8l19b8un_generic_treatment_names.jpg)
