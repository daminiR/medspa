...
*Source: [https://jane.app/guide/protecting-patient-data](https://jane.app/guide/protecting-patient-data)*

*Category: Privacy*

*Scraped: 2025-08-07 02:52:18*
...
Feature OverviewProtecting Patient Data
Privacy
Protecting Patient Data
5 min read
Balance Plan
...
At Jane, the Account Owner controls all of the patient data. They’ve agreed to accept our
Privacy Policy
and
Terms & Conditions
. This is their agreement with Jane and how we handle the health information to which the Account Owners are the custodian.
...
Jane never stores a patient’s plain credit card information directly on Jane’s servers. When you enter a credit card in Jane, Jane instantly transfers that data to one of our payment processing partners through encrypted transfer. Our
PCI-compliant
...
Blur Patient Names
A staff member can activate a feature in Jane that helps with hiding patient information by
blurring patient names and identifying information
. Great for front desk staff!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Protecting Patient Data
Privacy
Protecting Patient Data
5 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansWe take privacy and security very seriously and so we’ve implemented multiple processes to ensure that everything is kept safe and secure. Though, we understand that you, as patients, may have some questions about how your data is stored in Jane, so here’s a list of our most-asked-about privacy and security features:
Privacy Policy and Terms & Conditions
At Jane, the Account Owner controls all of the patient data. They’ve agreed to accept our
Privacy Policy
and
...
A staff member can activate a feature in Jane that helps with hiding patient information by
blurring patient names and identifying information
. Great for front desk staff!Subscribe to our monthly newsletter.Jane Software Inc.
