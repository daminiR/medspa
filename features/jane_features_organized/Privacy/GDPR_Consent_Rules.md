...
*Source: [https://jane.app/guide/gdpr-consent-rules](https://jane.app/guide/gdpr-consent-rules)*

*Category: Privacy*

*Scraped: 2025-08-07 02:48:23*
...
Feature OverviewGDPR Consent Rules
Privacy
GDPR Consent Rules
3 min read
Balance Plan
...
Thrive Plan
Legacy Plans
One of the most important things Jane users in the EU need to do to comply with GDPR is to
Determine and DECLARE the legal basis on which they will process personal data
.
...
Looking for the right words to document a Legal Basis for collecting and processing data? We’ve come up with a paragraph to get you started. Have a look at:
GDPR Consent Language
.
If you haven’t already, we recommend consulting the European Union Information Commissioner’s Office resources on
Consent
.
And finally, many of the links in this article send you to specific sections of EU ICO’s data protection guide. If you’d like to scroll through all the topics yourself:
Guide to Data Protection
. And as always, Jane is here to help.
Let us know
if you need a hand.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)GDPR Consent Rules
Privacy
GDPR Consent Rules
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansOne of the most important things Jane users in the EU need to do to comply with GDPR is to
Determine and DECLARE the legal basis on which they will process personal data
.
Here are the exact words from the EU Information Commissioner:
Consent is appropriate if you can offer people real choice and control over how you use their data, and want to build their trust and engagement. But if you cannot offer a genuine choice, consent is not appropriate. If you would still process the personal data without consent, asking for consent is misleading and inherently unfair.
...
Let us know
if you need a hand.
The information in this article summarizes consent for GDPR, and is not meant as legal advice.Subscribe to our monthly newsletter.Jane Software Inc.
