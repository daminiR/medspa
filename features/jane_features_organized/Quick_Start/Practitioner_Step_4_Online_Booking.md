...
*Source: [https://jane.app/guide/practitioner-step-4-online-booking](https://jane.app/guide/practitioner-step-4-online-booking)*

*Category: Quick Start*

*Scraped: 2025-08-06 23:30:23*
...
Feature OverviewPractitioner Step 4: Online Booking
Quick Start
Practitioner Step 4: Online Booking
6 min read
Practice Plan
...
Let’s start by navigating over to your Online Booking staff preferences together. Head on over to
Staff
in the top blue bar > Select your name in the staff list > and select
Edit/Settings.
...
The default here is “
Sequentially
”, which means that Jane will offer your appointments back to back based on their length.  If you have a 60-minute treatment, Jane will offer it every 60 minutes.  If you have a 90-minute treatment, that one will be offered every 90 minutes (1 pm, 2:30 pm, 4 pm).
...
A favorite of ours is the “
Based on my shortest treatment
” option, as this means that spaces left in your day would always be a size that could fit whatever your shortest treatment option is.
...
Some treatments have a longer
scheduled length
than the actual treatment duration (to allow for administrative work, to reset the room, to do your clinical notes, etc). This setting will allow an appointment’s buffer time to extend past when your shift ends, to fit more treatments into your day.
...
If this is the case for you, you might also find this guide document helpful:
Staggering Bookings
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Practitioner Step 4: Online Booking
Quick Start
Practitioner Step 4: Online Booking
6 min read
Practice Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5a0e34f2-dcb9-46d3-a430-7352a9800261)
- ![](https://jane.app/thumbs/31a4a9f2-50c9-4535-9fd4-b5e52f045499)
