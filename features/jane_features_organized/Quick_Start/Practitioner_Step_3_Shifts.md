...
*Source: [https://jane.app/guide/practitioner-step-3-shifts](https://jane.app/guide/practitioner-step-3-shifts)*

*Category: Quick Start*

*Scraped: 2025-08-06 23:30:12*
...
Feature OverviewPractitioner Step 3: Shifts
Quick Start
Practitioner Step 3: Shifts
3 min read
Balance Plan
...
Charting
☐
Set Up Step 3: Shifts
That’s right, we are now ready to set up your availability so you can start booking appointments and charting!
Jane uses
shifts
to communicate staff members’ availability in the administrative schedule. Of course, you’ll also have the option to enable Online Booking for your shifts so that your clients can book appointments online.
You’ll notice in our example below, Zoey does
not
have any shifts set up in Jane. Let’s go ahead and select the dropdown arrow
to the right
of the shift button, and select
Manage Shifts.
Manage Shifts is the primary scheduling tool in Jane
when setting up availability for the first time, and it will allow you to quickly create your weekly shift schedule across a time frame that you choose.
...
guide document here
.
If you need to create a biweekly shift schedule, or create, edit, or remove an individual shift, then we’d recommend taking a peek at this guide document here:
...
Advanced Scheduling
is turned on first in order for these options to be available for you. A full access user can help turn that on for you by heading into Settings > Schedule Settings > Advanced Scheduling ☑️.
Be sure to contact us to let us know how we can help! :)
Look at you go! Now that you’ve set up your availability in Jane, let’s hop on over to our next step to help you customize your schedule, and that’s
Online Booking
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Practitioner Step 3: Shifts
Quick Start
Practitioner Step 3: Shifts
3 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/dfd81663-fe7a-45c7-91eb-8d7c3879cc0b)
