...
*Source: [https://jane.app/guide/step-5-schedule](https://jane.app/guide/step-5-schedule)*

*Category: Quick Start*

*Scraped: 2025-08-06 23:29:42*
...
Feature OverviewStep 5: Schedule or Diary
Quick Start
Step 5: Schedule or Diary
4 min read
Balance Plan
...
That’s right, we are now ready to set up your schedule (or Diary if you’re in the UK 😉) so you can start booking appointments!
Jane uses
shifts
to communicate staff members’ availability in the administrative schedule. Of course, you’ll also have the option to enable Online Booking for your shifts so that your patients can book appointments online.
You’ll notice in our example below, Zoey does
not
have any shifts set up in Jane. Let’s go ahead and select the dropdown arrow
to the right
of the shift button. If you’re a
new clinic
setting up your shifts for the first time
, or a new staff member is starting at your clinic, you can select
Manage Shifts.
Manage Shifts is the primary scheduling tool in Jane
and it will allow you to quickly create your shift schedules for staff members across a time frame that you choose.
...
💡 If you’d like a more detailed walkthrough of Setting Up Shifts, please visit our
guide document here
.
Schedule or Diary Set-Up Tips
Here are a few tips to keep in mind while setting up your schedule:
Schedule/Diary Settings:
If you need to adjust the
opening and closing time
Adding Staff Shifts:
When adding staff shifts, it’s easiest to set up one staff member’s shift schedule and then copy those same shifts over to other staff members who work on the same schedule. If your practitioners’ shifts are unique from one another, then you will need to select “
Manage Shifts
” for each practitioner at a time.
💡Heads up — the advanced scheduling features below require the
Thrive Plan
Advanced Scheduling:
...
Advanced Scheduling
is turned on first in order for these options to be available for you.
...
To get the most out of your Jane Account, we’ve outlined a few additional account setup recommendations:
...
in Chapter 1 of our Front-Desk Training program. Click the link below to get started:
...
If everything is going smoothly - wonderful! Just know that we are available via email (support@jane.app) or phone (1-844-310-JANE) for support.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Step 5: Schedule or Diary
Quick Start
Step 5: Schedule or Diary
4 min read
Balance Plan
...
Front-Desk Staff Training Course
Our online training lessons include all things Jane where you can watch videos, read up on tips and tricks, try out workflow activities in our Demo site, and self-test with quizzes.
If everything is going smoothly - wonderful! Just know that we are available via email (support@jane.app) or phone (1-844-310-JANE) for support.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/9024c1c1-672e-41bb-98ae-532f25772d94)
