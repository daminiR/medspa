...
*Source: [https://jane.app/guide/step-3-treatments](https://jane.app/guide/step-3-treatments)*

*Category: Quick Start*

*Scraped: 2025-08-06 23:29:25*
...
Feature OverviewStep 3: Treatments
Quick Start
Step 3: Treatments
5 min read
Balance Plan
...
Now that you have let Jane know your area of practice, you can set up the different services that you offer. Under the
Settings
tab in the top menu, navigate to
Treatments, Classes & Group Appointments
on the left.
Note
📝:
If you charge tax on your services, you will want to head to
Settings
>
Taxes
to set up your taxes first. Check out our guide on
Setting Up Sales Taxes in Jane
that has more details on that process.
...
guide to learn more.
Note:
If your clinic has chosen to call your services
Sessions
, this tab will say Sessions, Classes & Group Appointments instead of Treatments, Classes & Group Appointments - and the same if you decide to call your services something else.
To start setting up the different services you offer, click the “
New Treatment
” button in blue on the right. You’ll want to create a new treatment for each service you’d like to offer your clients.
...
💡
Jane tip:
If you’re creating multiple similar treatments, you can create the first one and then duplicate it to save some time. From your list of treatments, you can click the
Duplicate
button next to the original treatment, edit the settings (make sure to remove “Copy of” from the name), and then click
Save
. All done!
...
For more on Class Bookings (eg. Yoga class), head here:
Class Booking
. And for more information on Group Appointments (eg. couples counselling), check out:
Group Appointments
.
...
Online Appointment
.
If you choose Online, Jane will automatically send a link to join a video call to your client or clients 1-hour before their appointment. Check out our guide on
1:1 Online appointments here
, and our
Online Appointment for Groups here
.
Discipline & Staff Member
Select the
Discipline
(type of practitioner) that will be offering this Treatment.
Next, you can choose the Staff member that will be offering it. If you select
No Staff Member (Shared Treatment)
then any Staff member of that Discipline will be able to choose to offer this Treatment. If you specify
one practitioner
, it will only appear under their name.
This will affect how your Online Booking page appears to your clients and how your Staff view their Treatments in their Staff Profile. Read more about that in our
...
If you ever decide you no longer want that treatment in your list of Treatments, Classes & Group Appointments, you can go ahead and
Archive it
...
Head on over to your account and mark step 3 as
complete
. Next up,
Step 4.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Step 3: Treatments
Quick Start
Step 3: Treatments
5 min read
Balance Plan
...
complete
. Next up,
Step 4.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/c554f80b-417f-4a81-8b4b-6a210c86cd9c)
- ![](https://jane.app/thumbs/93baab76-a365-4c18-a0d1-f95fe2e79ef5)
- ![](https://jane.app/thumbs/fa343405-1099-46e5-af11-c591162dbf9f)
- ![](https://jane.app/thumbs/012340b4-c149-4ad3-99a6-ac2edd08d076)
- ![](https://jane.app/thumbs/27b574b2-bf70-41d0-9061-1657a01f5af0)
- ![](https://jane.app/thumbs/1dda3720-41cd-4275-9b6a-06f447bfdad8)
