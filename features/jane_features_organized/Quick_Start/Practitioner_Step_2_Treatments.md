...
*Source: [https://jane.app/guide/practitioner-step-2-treatments](https://jane.app/guide/practitioner-step-2-treatments)*

*Category: Quick Start*

*Scraped: 2025-08-06 23:30:03*
...
Feature OverviewPractitioner Step 2: Treatments
Quick Start
Practitioner Step 2: Treatments
5 min read
Balance Plan
...
Charts
☐
Set Up Step 2: Treatments
Whether you offer treatments, sessions, classes, or services, it’s time to get
those
set up in Jane!
If you have full access, then you can refer to
this guide document
to set up your Treatments & Classes within
Settings > Treatments and Classes
. However, if you do not have access to that area of Jane, then there’s a slightly different approach to setting up your treatments that we’ll be going over together.
Let’s head on over to your Staff profile, and select
Treatments & Classes.
If you see a list of treatments already set up for you, and this list looks to be complete, then you can thank your clinic manager for setting this up on your behalf! 😍
But if you’re noticing that this list is empty or you’re missing treatments you offer, then let’s get those set up for you.
Once you’re ready, you can click
Manage Treatments.
Tip: Under your
Shared Treatments
section, you can toggle treatments ‘on’ or ‘off’ to communicate which treatments you offer and which ones you don’t under that specific discipline.
There are three things you’ll want to ensure are fully set up prior to creating a new treatment:
Disciplines
Taxes
Income Categories
If you notice something is missing (i.e., like an applicable tax), be sure to let your Clinic Manager know. A full access user will want to head over to
Settings
to ensure all three areas (disciplines, taxes, and income categories) have been completed.
In this set up document, we’ll go ahead and refer to the service a clinic offers as
Treatments
, but Jane lets you choose what to call yours. Hop into our
Customizing Jane
guide to learn more.
Let’s start off by clicking the “
New Treatment
” button in the top right-hand corner.
You can watch this quick video to learn how to set up your treatments:
Note: Speed up or slow down the video speed using the ⚙️ button inside the video player!
💡
Jane tip:
If you’re creating multiple similar sessions, you can create the first one and then duplicate it to save some time. From your list of treatments, you can click the
Duplicate
button next to the original session, edit the settings (make sure to remove “Copy of” from the name), and then click
Save
. All done!
Treatment Set Up Tips
Here are a few tips to keep in mind while completing this information:
Appointment Type
You’ll have the option to create an
Online Appointment (one-on-one Telehealth)
or an
In-Person Appointment
.
For more information on setting up Online Appointments, click here:
Setting Up Online Appointments
Selecting the Staff Member
When creating a new treatment, there are two
Staff Member
options to select from:
Clinic-wide Shared Treatments
Practitioner-specific treatments called My Treatments
Each type behaves differently on the online booking page, so you’ll want to review both before deciding how to set up your clinic. We go over all the nitty-gritty details in the video above, as well as in this guide document:
Setting Up Treatments
Treatment Descriptions
When creating a new treatment, Jane allows you to include a
Before Booking Description
, and
After Booking Description
. You’ll be able to Edit this treatment at any time, so you can come back to complete the description areas later if you’d like :)
Here’s an example of how the Before Booking Description area can be used:
👏  Mic drop! You’ve completed account set up Step 2! Only a few steps to go and you’ll be ready to start booking appointments and charting.
Head on over to your account and mark step 2 as
complete
. Next up,
Step 3
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Practitioner Step 2: Treatments
Quick Start
Practitioner Step 2: Treatments
5 min read
Balance Plan
Practice Plan
Thrive PlanThere are 5 basic steps that are required to get your Jane account up and running:
Set Up
Task Complete
Practitioner Training
🥳
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e4414e2f-7559-42ac-88f9-e0c56b8f662b)
- ![](https://jane.app/thumbs/cfa14bcb-7a1f-40a9-9259-5d7cf778b37c)
- ![](https://jane.app/thumbs/5b50b5f9-0dcb-4bcb-a2d3-504355b17ec0)
- ![](https://jane.app/thumbs/1b3a824e-f922-4916-9c61-c806428cd243)
- ![](https://jane.app/thumbs/9af9c356-ed27-464f-a11b-de46e796bc94)
- ![](https://jane.app/thumbs/4431f09b-4ae8-4a38-8e1b-c262b535b881)
- ![](https://jane.app/thumbs/a6e762d8-2a8d-4e99-9dd3-739d9b51c091)
