...
*Source: [https://jane.app/guide/importing-from-eclipse](https://jane.app/guide/importing-from-eclipse)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:41:23*
...
Feature OverviewImporting from Eclipse
...
Practice Plan
Thrive Plan
Here’s what we know about moving over from Eclipse to Jane.
...
.
Exporting your Patients from Eclipse
So coming from Eclipse, we’ll need you to upload your Patient export with as much detail as possible.
From the top menu in Eclipse, select
File > Data Import/Export > Export > ASCII Comma Delimited
. You will be presented with a screen where you can select one or more fields to export. Select the information that you would like to include in the export. Use the Filters button to narrow down the patients you want to export. Otherwise, all patients will be exported.
Exporting anything else from Eclipse
We’ve seen Products and Insurance data come from Eclipse in CSV format. We recommend
contacting Eclipse
for more details on exporting these files. We have never had a client successfully export any other data from Eclipse - so appointments need to be moved over manually by booking them in one at a time after we’ve imported your patients.  It’s good to plan your import over a time period where there’s some down time (such as a weekend) to book the appointments in.
Eclipse Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Eclipse
Importing from Other Software
Importing from Eclipse
3 min read
Balance Plan
Practice Plan
Thrive PlanHere’s what we know about moving over from Eclipse to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
