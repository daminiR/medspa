...
*Source: [https://jane.app/guide/importing-from-pteverywhere](https://jane.app/guide/importing-from-pteverywhere)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:51:53*
...
Feature OverviewImporting from PTEverywhere
...
Practice Plan
Thrive Plan
Here’s what we know about moving over from PTEverywhere to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different softwares, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty retrieving your data, it’s best to reach out directly to your current software provider.
...
So coming from PTEverywhere, we’ll need you to upload your Client List export with as much detail as possible.
You can download your full patient list from PTEverywhere by visiting:
Reports > Demographics Report > Apply
. From there, you can click on
Export to CSV
for importing into Jane
Exporting your PTEverywhere Appointments:
We have not seen clinics provide us with appointment data from PTEverywhere, so it’s suggested that you reach out to their support team to see if this is possible.
Exporting Charts from PTEverywhere:
You can download any selected patient’s lifetime notes in the
Charting
tab by clicking
Batch Download
.
Each patient’s
Documents
tab allows you to download individual files by clicking the
More
menu.
...
If you’d like to store your billing invoices from PTEverywhere outside of Jane, you can download any selected patient’s lifetime invoices in the
Payment
tab by clicking
Batch Download
.
It’s also our understanding that PTEverywhere offers a data migration service to compile all of these files for you for a one-time fee of $495 (subject to change).
Uploading into Jane:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from PTEverywhere
Importing from Other Software
Importing from PTEverywhere
3 min read
Balance Plan
Practice Plan
Thrive PlanHere’s what we know about moving over from PTEverywhere to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different softwares, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/78a100cd-2986-41e5-b188-4a63941ffcc1)
