...
*Source: [https://jane.app/guide/importing-from-mindbody](https://jane.app/guide/importing-from-mindbody)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:45:09*
...
Feature OverviewImporting from Mindbody
Importing from Other Software
Importing from Mindbody
4 min read
Here’s what we know about moving over from Mindbody to Jane.
...
.
Exporting your Patients from Mindbody
So coming from Mindbody, we’ll need you to upload your Client export with as much detail as possible.
To export a Client List:
Go to the Reports tab, and select Clients from the tabs on the left.
Select Mailing List in the filter on the top left.
Choose the group of clients you are interested in from the List Clients menu.
In the Client’s Opt-in Status menu, choose all clients.
Choose Clients Only, Prospects Only, or Clients and Prospects from the third row.
Choose a Sort By method, either Client Name or Client Barcode.
Click Generate to preview the results.
Click Export to Excel to save the list to your computer.
Exporting your Mindbody Appointments
You can export Appointments using the Schedule at a Glance Report.
This can be found in the Reports area - Schedule Report - Schedule at a Glance.  There are a few checkbox options that may show up when you export - if you can turn on the “Scheduled By” option then we can import that information for you.
If you have a lot of data Mindbody’s exporters sometimes seems to time out, so if that happens just break your appointments up by years (or smaller date ranges if necessary) and export each file separately.  Don’t forget to export your future appointments as well as your past appointments.
Exporting Charts from Mindbody
Charts from Mindbody can be exported at a cost through their
Subscriber Data Export
service. The following is included in a standard export, and can be imported into Jane:
Contact Logs
Formula Notes (Salon)
Client Notes (Profile notes, medical alerts, staff alerts)
Progress/SOAP Notes
The following can be done in addition to the standard export for an additional cost:
Client Documents
Client images
Note:
You will need to contact Mindbody directly for this service, and the process will be completed in 3-5 business days.
Mindbody Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Mindbody
Importing from Other Software
Importing from Mindbody
4 min readHere’s what we know about moving over from Mindbody to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
