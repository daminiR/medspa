...
*Source: [https://jane.app/guide/importing-from-theralink](https://jane.app/guide/importing-from-theralink)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:54:23*
...
Feature OverviewImporting from TheraLink
...
What can you expect?
Coming from TheraLink, we’ve successfully brought over
Client Demographics
,
Appointments
,
...
What can we import?
Client List (with demographic data)
Appointments (Past + Future)
Chart Data + Documents
Exporting your Clients from TheraLink
To export your
Client List
from TheraLink, please follow these steps:
You can export profiles from the My Clients, All Clients, Providers, Owners, Manages and Colleagues tabs in the Profiles section.
‼️ Note: Managers and Owners can view profile exports initiated by other providers, colleagues, and clients under the Exports tab in the Documents section.
Select the
appropriate tab
(most likely
All Clients
...
Export Profiles
button to export those profiles.
Click the
OK
button on the Export Requested pop-up box.
Click on the
Exports
tab in the Documents section.
Click the
Download
button to export the Client List as an
Excel
or
CSV
file.
If the
Active Vs Inactive
status is not provided in the Client List, all clients are imported as
active
unless otherwise specified.
💡 Helpful hint: TheraLink also has a guide on exporting this report in case that helps:
How to Export Profiles
Exporting Appointments from TheraLink
Appointment records (Past + Future) can be exported from TheraLink from the
Schedule
directly. Here are the steps to export your appointments:
Click the CSV button at the top of the schedule.
Enter a
Start
and
End
for the appointment date range you want to export. It is best to capture all data 💡
Click the
Start
...
Click the
Download
button to export the Appointments Report as an
Excel
or
CSV
file.
...
Exporting your Chart Notes from TheraLink
Here’s how you can export chart data from TheraLink:
‼️ According to their support documentation,
only signed chart data
can be exported and may need to be filtered by the practitioner as you export the data.
Click on the
Profile
section.
Select the appropriate tab, then click the
Export Notes
button.
Click the
OK
...
button to save the
.zip file
containing the chart notes from TheraLink.
Exporting your Chart Documents from TheraLink
Here’s how you can export the documents from TheraLink:
Head to the
Documents
section
Click the
Export Documents
button at the top of the Owned by Me and Shared with Me tabs to export each document list, or click the Export Practice Documents button to export all documents for the practice.
Click the OK button on the Export Requested pop-up box.
Click on the
Exports
tab in the Documents section.
Click the
...
button to save the
.zip file
containing the chart documents from TheraLink.
💡 Helpful hint # 1: If you are exporting chart data for multiple practitioners, you will want to make sure the data is
organized by staff member
so we can correctly identify who the author of the chart data is for the import process.
💡 Helpful hint # 2: If you happen to open the
zip file
...
Zipping Files Here
😊
💡 Helpful hint # 3: TheraLink also has a guide on exporting chart notes in case that helps:
How to Export Chart Notes
as well as
...
>
View Details
to securely upload the data you exported from TheraLink.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from TheraLink
Importing from Other Software
Importing from TheraLink
8 min read
Balance Plan
