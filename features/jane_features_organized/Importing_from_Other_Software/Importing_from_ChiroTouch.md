...
*Source: [https://jane.app/guide/importing-from-chirotouch](https://jane.app/guide/importing-from-chirotouch)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:39:37*
...
Feature OverviewImporting from ChiroTouch
...
Let Jane be your helping hand while you’re transitioning your busy Chiro practice. We have dedicated staff to ensure switching over is easy and can answer any questions that come up along the way. We’ll work with you to help set up your account and guide you through importing your data, so you can hit the ground running.
...
.
Moving from ChiroTouch to Jane
While moving your practice to Jane, we’ve got your back every step of the way. Whether you’re thinking about making the move, or have already signed up for your new Jane account, our support and dedicated imports team are available to ensure your success in getting started with us.
The best part? That’s all
free
with Jane. Even if you’re not practicing with Jane yet, you can feel free to reach out to us and ask any burning questions you have!
What can you expect?
Coming from the Desktop version of ChiroTouch, we’ve successfully brought over
patient demographics
,
past & future appointments
,
payors & insurance policies
,
patient notes
,
products
...
, and
files
from this system. Below you’ll find step-by-step instructions for how to export your data when you’re feeling ready to make the switch to charting, billing and booking in Jane 💙
What can we import?
Patient List
Past Appointments
Future Appointments
Payors & Insurance Policies
Chart Notes
Uploaded Files & Scanned Documents
Exporting your Patients from ChiroTouch
To export your patient list from ChiroTouch, please follow these steps:
In
...
EXPORT
on the right
In the window that pops up, name the file
Active Patients
Click
Open
to save the list of
...
Active Patients.csv
and
Inactive Patients.csv
files to bring your
full list
of patients into Jane.
💡
Helpful hint:
You may notice there is
no header row
in the files. No sweat! We’re able to identify where each column belongs in Jane, but if you’d like to help us out, please feel free to add in the appropriate
headers
(Full name, First Name, Last Name, Mobile phone, Home phone, etc.) 🙏
ChiroTouch also has a guide on filtering the Data Export tab in case that helps:
Data Export Tab
Exporting your Past Appointments from ChiroTouch
Past appointment records can be exported from ChiroTouch in the
End-of-Day Appointment Activity
report. Here are the steps to export your past appointments:
In
Billing Statement & Reports
, click on the
Reports
...
who will be moving over, or click
Select All
at the bottom to select all staff. Click
Next
at the top
On the calendar page, filter the
Start Date
to the first day of the year (e.g. January 1, 2024). Click
Next
In the ‘Show Total Charges for Appointments’ pop-up, click
No
On the next page, once the report loads, click the
EXPORT
button
...
dropdown and select
Microsoft Excel (xls)
If you’d like to designate where the file will be saved on your device, click
Browse
For
filename
, type in the
YEAR
of the appointments (e.g. “2024 Appointments”)
Click
Ok
to save the file
Repeat steps 1-10 filtering for
each year of past appointments
you’re looking to bring over (e.g. 2023, 2022, 2021, etc.)
💡
Helpful hint:
if you try to export the
full date range
of past appointments, ChiroTouch may crash, which is why we recommend breaking down the past appointments by
year
. If you’re still having difficulty, we recommended breaking it down even further by
date range
(e.g. every 6 months), or by
provider
.
Exporting your Future Appointments from ChiroTouch
Upcoming appointments can be exported from ChiroTouch in the
Future Appointment Schedule (By Date)
report. Here are the steps to export your future appointments:
In
Billing Statement & Reports
, click on the
Reports
...
On the calendar page, filter the
End Date
into the future to capture all upcoming appointments. Click
Next
On the next page, once the report loads, click the
EXPORT
button
...
Exporting your Payors & Insurance Policies from ChiroTouch
Payor and insurance policy information can be exported from ChiroTouch in the
Insurance Patient List
report. Here are the steps to export that data:
In
Billing Statement & Reports
, click on the
Reports
...
On the next page, select
each of the payors
you would like to bring over, or click
Select All
at the bottom to select all payors. Click
Next
at the top
On the following page, you’ll see a list of Case Types. Click
Select All
at the bottom > Click
Next
In the
Filter/Options
pop-up, you can skip the options and click
Ok
On the next page, once the report loads, click the
EXPORT
button
...
Ok
to save the file to your computer
⚠️ Please note it is common to have
multiple versions
of a payor in ChiroTouch. Unless specified otherwise, we create each of these as a
separate payor
in Jane. Following the import, you may need to
merge
any duplicate payors together. We have a handy guide to help walk you through that step:
Duplicate Insurers
Exporting your Chart Notes from ChiroTouch
Coming from ChiroTouch, we’re able to bring over your charting from the
Chart Notes
report. To export your chart notes to PDF, please complete the following steps:
In
Billing Statement & Reports
, click on the
Reports
...
Next
at the top
On the Case Types page, click
Select All
at the bottom. Click
Next
On the calendar page, filter the
Start Date
back to the beginning of a year (e.g. January 1, 2024). Click
Next
In the
Include Diagnose
pop-up, click
...
pop-up,
Account Number
is selected by default, which is fine. Click
Ok
On the next page, the report will either begin processing
or
you’ll receive an
error message
. If you receive the error message, click
Ignore
> click the
EXIT
button and filter the report again with a smaller date range.
If you don’t receive an error message, hang tight! It will take a
long
time for the report to generate. Maybe grab a coffee or a tea ☕️
Once the report loads, click the
EXPORT
button
In the pop-up, click the
Export Type
...
filename
, name the file
ProviderName_Year_Charts
(e.g. “JaneSmith_2024_Charts”)
Click
Ok
to save the PDF file to your computer
Repeat steps 1-15 for
each year
to export
all
of the provider’s charts
Repeat steps 1-16 for
each provider
moving over to Jane
💡
Helpful hint #1:
We’ve heard from clinics that exporting the Chart Notes report can take a very long time, which is why we recommend exporting the report by
year
for
EACH provider
to prevent ChiroTouch from timing out.
💡
Helpful hint #2:
The Chart Note PDF files are downloaded to the ChiroTouch folders on your computer. To help locate the files more easily, you can click the
Browse
button to choose where the files are downloaded.
Uploading Your Data into Jane
Thanks for following all those steps to export your data - you’re one tough cookie 🍪
The final step will be to upload your data in the
import
in Jane. You can navigate to
Settings
>
Schedule an Import
>
View Details
to securely upload the patient list
CSV files
, the appointments, insurance, and notes
xls files
, and the chart notes
PDF files
.
For a walkthrough of the import process from start to finish, please review our guide on
Scheduling Your Import
You did it! We appreciate you making it through that 😅 Once the files have been uploaded and you’ve clicked the
Done
button in the import, we’ll bring in your data as soon as we can and reach out if we have any questions. We look forward to having you join the Jane community 💙
Bringing over your Uploaded Files & Documents
The sections above outline how you’ll be able to independently export your
patients
,
appointments
,
...
, and
patient notes
. If that’s all the data you require, woohoo! You’re all set 🙂
If you would like to bring over
uploaded files & scanned documents
, these are included in the
bulk data export
from ChiroTouch. To request the bulk export, you will need to reach out directly to
ChiroTouch’s support team
. The export is free, although we have heard it can be difficult to request and may be dependent upon cancelling your ChiroTouch account first. In case it may help, their
phone support number
is listed
here
.
If you’re able to successfully receive the bulk export, you can
zip
the
02_ScannedDocs
folder and upload the
zip file
for us to bring those in. We have a handy guide on
How to Make a Zip File
📁
ChiroTouch Billing Data
We aren’t able to import billing information such as Accounts Receivable or Credits as there are formatting issues between the two systems, but our understanding is that ChiroTouch allows for the export of your billing data to back up files prior to your license expiring, so you can retain access to this information after your ChiroTouch access has ended.
We also have a great guide on
Transitioning Your Clients Credits/Receivables to Jane
that you can follow to ensure those are entered into Jane should you need to carry those over.
We’ve leveraged our experience with
various software imports
, along with official guides from other software providers, to create this comprehensive resource for transitioning to Jane. If you have any difficulty downloading your data, it’s best to reach out to your current software provider directly for assistance.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from ChiroTouch
Importing from Other Software
Importing from ChiroTouch
13 min read
Balance Plan
Practice Plan
Thrive PlanJane is here to make your switch a stress-free one 💙
Let Jane be your helping hand while you’re transitioning your busy Chiro practice. We have dedicated staff to ensure switching over is easy and can answer any questions that come up along the way. We’ll work with you to help set up your account and guide you through importing your data, so you can hit the ground running.
It doesn’t stop there! After you’re settled in, you’ll always have free and continued ongoing support from the Jane team whenever you need it.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5d7d5c6c-d709-4358-b69e-f473a54e6d0c)
- ![](https://jane.app/thumbs/f0884d20-d248-48ec-b941-99b3e44a9f90)
