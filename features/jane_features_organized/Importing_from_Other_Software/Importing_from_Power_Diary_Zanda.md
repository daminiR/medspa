...
*Source: [https://jane.app/guide/importing-from-power-diary-zanda](https://jane.app/guide/importing-from-power-diary-zanda)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:49:22*
...
Feature OverviewImporting from Power Diary (Zanda)
...
.
Moving from Power Diary (Zanda) to Jane
...
What can you expect?
Coming from Power Diary, we’ve successfully brought over
patient demographics
,
past & future appointments
,
insurers/payors & insurance policies
,
patient charts + files
...
What can we import?
Patient List
Appointments Report (Past + Future)
Chart Data + Files
Insurers/Payors + Policies
Exporting All Data from Power Diary (Zanda)
To export
all data
listed above from Power Diary, please follow the steps below:
Log in to Power Diary
– Go to the Power Diary login page and sign in with your administrator credentials.
Navigate to the
Data Export Section
– Look for the “Settings” or “Admin” menu in the top right corner of your dashboard. Under the settings or admin options, locate the
Data Export
or Reports section.
Select the type of Data to Export – Power Diary typically allows you to export various data types, such as ⬇️
Client Information
Appointments
...
Clinical Reports
Prescriptions
💡 Helpful hint # 1: Choose the relevant categories of data you need to export (or select all data which is what we suggest 😎) - We will import what is possible with regards to the process ‼️
Choose the Export Format
– Power Diary usually supports multiple formats, including
CSV
,
Excel
, and
PDF
. We recommend that reports be in CSV or Excel Format, whereas Chart Data & Files can be in PDF.
Customize the Export
– Depending on your needs, you may be able to apply filters (e.g., date range, client type, etc.) to narrow down the data being exported. If exporting client data, you will want to make sure to filter for both
Active Patients
and
Inactive Patients
so we can import the data accurately in Jane.
Export the Data
– Once you’ve selected the data type and format, click the Export or Download button. The system will prepare the export, which may take a few minutes, depending on the amount of data. After the export is ready, it will usually prompt you with a link to download the files.
Check the Exported Files
– Download the exported files and review them to ensure that all the necessary data has been included. Double-check the formats to make sure everything is organized in a way that suits your needs.
...
Zipping Files Here
😊
If you have any issues or if the export feature is not available, you may need to contact
Power Diary’s (Zanda) Support Team
. They can assist with more complex exports or help you with any limitations if they do come up ☀️
Uploading Your Data into Jane
Thanks for following all those steps to export your data - you’re the best, fun fact.
...
full data export
from Power Diary which should be in a
.zip file
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Power Diary (Zanda)
Importing from Other Software
Importing from Power Diary (Zanda)
7 min readJane is here to make your switch a stress-free one 💙
Let Jane be your helping hand while you’re transitioning your busy practice. We have dedicated staff to ensure switching over is easy and can answer any questions that come up along the way. We’ll work with you to help set up your account and guide you through importing your data, so you can hit the ground running.
It doesn’t stop there! After you’re settled in, you’ll always have free and continued ongoing support from the Jane team whenever you need it.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
