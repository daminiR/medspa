...
*Source: [https://jane.app/guide/importing-from-ezfacility](https://jane.app/guide/importing-from-ezfacility)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:41:48*
...
Feature OverviewImporting from EZFacility
...
.
Moving from EZFacility to Jane
...
What can you expect?
Coming from EZFacility, we’ve successfully brought over
clients
and
...
Client List
Appointments
Exporting your Clients from EZFacility
To export your client list from EZFacility, please follow these steps:
In EZFacility, click on the
Administration
tab
...
section
To export your complete client database, keep
All Contacts
selected in the dropdown
Click
Generate Report
Once the report has generated, click the
Save icon
💾
Select
Excel
...
Next, to ensure any
inactive clients
are labelled as inactive in Jane, you’ll want to also generate a list of inactive clients by following these steps:
From the same
Export Clients
page, select
Inactive Clients
...
and click
Save
Once you have the complete client list + inactive client list files, both files can be uploaded into the
import
area in Jane.
🔗 EZFacility has a handy guide to walk you through the steps above:
How to Export Client Demographic Information
Exporting your Appointments from EZFacility
To export your past & upcoming appointments from EZFacility, please follow these steps:
In EZFacility, click on the
Reports
tab
Scroll down and click on
...
Marketing Reports
section
Select a start date in the
desired report start date
field
Select an end date in the
desired report end date
field
(don’t forget to filter past today’s date to capture upcoming appointments!)
Leave the other dropdown fields as
Show All
Click
Generate Report
Once the report has generated, click the
...
💡
Helpful hint:
In case exporting the full date range of appointments causes EZFacility to timeout, you can generate and export the report
year-by-year
. All the appointment files can then be uploaded in the import.
🔗 EZFacility has another handy guide on how to export your appointments:
Attendance Report
Uploading Your Data into Jane
Thanks for following all those steps to export your data - you’re a catch ⚾️
...
complete client list file
, the
inactive client list file
, and the
appointments
Excel files
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from EZFacility
Importing from Other Software
Importing from EZFacility
6 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/4939718c-db76-42c2-aa40-ec0d705756b3)
