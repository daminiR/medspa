...
*Source: [https://jane.app/guide/importing-from-wix](https://jane.app/guide/importing-from-wix)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:57:07*
...
Feature OverviewImporting from Wix
...
Exporting your Contacts from Wix
To export your contact list from Wix, you can follow these steps:
In Wix, go to your
Contact List
.
Click the
...
Click
Export
The CSV file will download to your device, which you can then upload in the import area in Jane.
In case you’re only looking to bring over a specific set of your contacts, the contact list can also be filtered by
Selected Contacts
.
For more information, we’d recommend checking out Wix’s support guide:
Exporting Your Contacts
Exporting your Appointments from Wix
To bring over your appointments, please follow these steps:
Go to
Bookings List
in your Wix dashboard
In the
Date Range
fields, enter your preferred date range to capture all past
and
upcoming appointments
Click the
Search
button
Scroll to the bottom of the page to load all of the bookings
Click
Download CSV
up at the top
Please note:
the steps above will capture your
Confirmed Bookings
. If you would also like to bring over your
Cancelled
,
Declined
, or other appointments, you can click the
Filter
button to filter for those statuses and generate additional Bookings files. You can upload all of those into the import area in Jane.
For more information on exporting appointments, we’d recommend taking a look at Wix’s guide:
Wix Bookings
Uploading into Jane
...
:
We have a great guide to help walk you through that as well:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Wix
Importing from Other Software
Importing from Wix
5 min read
Balance Plan
Practice Plan
Thrive PlanJane makes it easy to switch! 💙
Let Jane be your co-pilot while you’re switching over your busy practice. We have dedicated staff to ensure your transition is an easy one and to answer your questions every step of the way. We’ll help you set up your account so you can hit the ground running and guide you through importing your data.
It doesn’t stop there! After you’re settled in, you’ll always have free and continued ongoing support from the Jane team whenever you need it.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/6663bdf0-7e49-49dc-aed2-d96998ae5d43)
- ![](https://jane.app/thumbs/bc42b501-eaca-49f5-96d1-5132372027bc)
