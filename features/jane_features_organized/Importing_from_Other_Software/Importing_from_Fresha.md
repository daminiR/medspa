...
*Source: [https://jane.app/guide/importing-from-fresha](https://jane.app/guide/importing-from-fresha)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:42:32*
...
Feature OverviewImporting from Fresha
Importing from Other Software
Importing from Fresha
3 min read
Here’s what we know about moving over from Fresha to Jane.
...
.
Exporting your Fresha (Shedul) Clients
So coming from Fresha, we’ll need you to upload your
Client List
with as much detail as possible.
From the Main Menu in Fresha, you can export your clients by going to
Clients > Options > Download Excel
.
You’ll then be left with an excel file on your device containing all of your clients, which you’ll then be able to import to Jane.
Exporting your Fresha (Shedul) Appointments
Fresha also allows you to export your clients past and future appointments to excel.
From the Main Menu in Fresha, you can export your appointments by heading to
Sales > Appointments > Export > Excel
.
Fresha (Shedul) Billing Data
...
into Jane.
The billing data in your Fresha account can be exported to hold in backup files after you’ve transitioned to Jane. Fresha’s help document,
Reports Overview
, outlines how you can export this data.
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Fresha
Importing from Other Software
Importing from Fresha
3 min readHere’s what we know about moving over from Fresha to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
