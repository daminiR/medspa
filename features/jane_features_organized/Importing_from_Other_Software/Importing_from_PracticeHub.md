...
*Source: [https://jane.app/guide/importing-from-practicehub](https://jane.app/guide/importing-from-practicehub)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:50:53*
...
Feature OverviewImporting from PracticeHub
Importing from Other Software
Importing from PracticeHub
5 min read
This guide brings together everything we know about moving from PracticeHub to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
Sometimes, due to the complexity or volume of the data, as well as the time difference between the UK and Canada (Pacific Time), you may experience a delay in some of your data being imported. When you schedule your import, you will choose two dates; one date that will be the date you plan on uploading the data to us, and the second date being the expected date you’d like your data imported.
We aim to have your patient demographics and things like appointments imported in time for your expected date, though, if you’re planning on providing charts for us to import, depending on the length of history and the size of the files you provide, it may take anywhere from 2 to 7 extra business days to import your charting data. By importing your patient demographics and past & upcoming appointments first, this allows you to begin working out of Jane right away. It’s a good idea to maintain access to your previous software for a short time to be able to refer to your charts should you need to while our team is processing this data for you.
For more information, you can also refer to our guide,
Time Zones, Big Data and Your Import
.
Exporting your Patients from PracticeHub
Please refer to this handy guide from the PracticeHub website:
Exporting your Patient Data
.
This will walk you through how you can export your client list into a CSV file.
You can do this by heading over to
Reports > Data Exports > Patients.
From here, you can select the
Date Range
required, and you can click
Download CSV file
.
Exporting your Appointments from PracticeHub
...
as your
Data Type
. Again, you can select the
Date Range
required, and you can click
Download CSV file
.
Remember to run the entire date range of appointments (past and future)!
Exporting Charts/Clinical Notes from PracticeHub
Again, you can export your Treatment Notes as CSV files by following the steps above, this time selecting
Treatment Notes
as your
Data Type
. Your Treatment Notes can also be downloaded as CSV files and as long as the files remain unedited, we can generally import your treatment notes into Jane.
Billing Data from PracticeHub
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from PracticeHub
Importing from Other Software
Importing from PracticeHub
5 min readThis guide brings together everything we know about moving from PracticeHub to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
Sometimes, due to the complexity or volume of the data, as well as the time difference between the UK and Canada (Pacific Time), you may experience a delay in some of your data being imported. When you schedule your import, you will choose two dates; one date that will be the date you plan on uploading the data to us, and the second date being the expected date you’d like your data imported.
We aim to have your patient demographics and things like appointments imported in time for your expected date, though, if you’re planning on providing charts for us to import, depending on the length of history and the size of the files you provide, it may take anywhere from 2 to 7 extra business days to import your charting data. By importing your patient demographics and past & upcoming appointments first, this allows you to begin working out of Jane right away. It’s a good idea to maintain access to your previous software for a short time to be able to refer to your charts should you need to while our team is processing this data for you.
For more information, you can also refer to our guide,
