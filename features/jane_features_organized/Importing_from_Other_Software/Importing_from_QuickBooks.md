...
*Source: [https://jane.app/guide/importing-from-quickbooks](https://jane.app/guide/importing-from-quickbooks)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:52:10*
...
Feature OverviewImporting from QuickBooks
...
Practice Plan
Thrive Plan
Here’s what we know about moving over from QuickBooks to Jane.
...
.
The steps below may vary slightly depending on the version of Quickbooks you’re using. Nevertheless, Quickbooks allows you to export a wide range of reports into Excel or CSV including your customer and product list.
Exporting Clients from Quickbooks Online
You can export a client list from QuickBooks Online by exporting a detailed
Customer Contact List
from the
Reports
section:
In the grey left-side menu under
MENU
, click on
Reports
...
section, select
Customer Contact List
In the top right report menu, select
Columns
and click the
More Columns
tab. Now you’ll want to supercharge this list by adding as much detail as possible. Underneath
Customer
click on the green
Show more
link to bring up additional options. Please
...
Mobile
Fax
Just above the “Columns” button you clicked earlier you’ll see a green
More actions
button where you’ll have the option to
Export to Excel.
Ta-da! 🎉
Exporting Products from Quickbooks Online
In the grey left-side menu under
MENU
, click on
Reports
Scroll down to and click on
Standard reports
Under “Sales and customers” click on
Product/Service List
Just like with your clients you’ll want to add as much detail as possible to this list. In the top right report menu select
Columns
to bring up a menu that allows you to select additional options. You’ll want to click on the
More Columns
tab and underneath
Customer
click on the green
...
Linked Attributes
, select Sales tax
In that same top grey menu bar where you selected “Columns” for the previous step, you’ll now see a green
More actions
button and the option to
Export to Excel.
Exporting from Quickbooks Desktop Version
Here’s how to grab your customer list from the desktop version:
Launch
QuickBooks
.
Click
...
Customize Report
to select various information to include in your export. If you want to bring over client notes, be sure to choose the
Note
column.
When you’re ready to export your list, click
Excel
in the top menu bar and select
Create New Worksheet
from the pull-down menu. Ensure that the options
...
Lastly, click
Export
and then save the Excel file that opens up via
File > Save As
to your desktop 🙂
Similar steps can be taken for your inventory list from Quickbooks.
QuickBooks Billing Data
...
into Jane.
Uploading to Jane
To ensure that your data is uploaded to the correct account, and for security reasons, we do not accept patient data via email.
You can upload the files to us in the
Settings > Schedule an Import area.
You can find an overview of this process here:
Scheduling Your Import
Further Reading
While we are so excited to have you on board (we really are, and we mean it), you’re also welcome to continue using Quickbooks for issuing payroll and running your business financials!
We have clinics entering periodic sales data and expenses into their accounting software. For more information on using Jane and Quickbooks together, click
here
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from QuickBooks
Importing from Other Software
Importing from QuickBooks
6 min read
Balance Plan
Practice Plan
Thrive PlanHere’s what we know about moving over from QuickBooks to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
