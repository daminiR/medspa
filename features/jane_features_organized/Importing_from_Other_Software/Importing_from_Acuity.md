...
*Source: [https://jane.app/guide/importing-from-acuity](https://jane.app/guide/importing-from-acuity)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:37:55*
...
Feature OverviewImporting from Acuity
...
Practice Plan
Thrive Plan
Here’s what we know about moving over from Acuity to Jane.
...
.
Exporting your Patients from Acuity
So coming from Acuity, we’ll need you to upload your
Client List
export with as much detail as possible.
Under the
Clients > Import/Export
area in Acuity, click on the button that says
Export Client List
, the
Client List
can be exported to
...
There’s a support document on their website that goes through the step-by-step process on exporting your client demographics here:
Exporting Client Demographics
Exporting your Acuity Appointments
Acuity will also allow you to export your
clients’ appointments
to
CSV
by heading to
Reports > Export
. Next, select the date range of appointments, and whether you would like to include cancelled appointments > select
Export Appointments
to download the CSV file.
Acuity has a support document on their website that will walk you through step by step:
Exporting Appointments from Acuity
.
Acuity Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Acuity
Importing from Other Software
Importing from Acuity
3 min read
Balance Plan
Practice Plan
Thrive PlanHere’s what we know about moving over from Acuity to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
