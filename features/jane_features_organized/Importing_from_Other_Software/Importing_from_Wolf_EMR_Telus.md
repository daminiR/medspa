...
*Source: [https://jane.app/guide/importing-from-wolf-emr-telus](https://jane.app/guide/importing-from-wolf-emr-telus)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:57:40*
...
Feature OverviewImporting from Wolf EMR (Telus)
Importing from Other Software
Importing from Wolf EMR (Telus)
3 min read
Here’s what we know about moving over from Wolf EMR (Telus) to Jane.
...
.
Exporting your Patients from Wolf
So coming from Wolf, we’ll need you to upload your patient list export with as much detail as possible.
The Patient List can be exported from the Practice Search Tab located on the Home page in Wolf.
Here’s a detailed
help document from Wolf EMR
. To find the instructions on exporting your patient list look for “Producing A Patient Physician List In Wolf” on page 13 of that help document.
You will end up with an exported csv document with all of your Patients.
Appointments in Wolf EMR
Wolf doesn’t appear to provide an export of your appointment data beyond a patient’s last visit date, which isn’t enough information for us to import into Jane.
Exporting Your Charts from Wolf EMR
The tech support team at Wolf/Telus can provide an export zip file of your charts, as PDF files, upon request.
You can request an export of your charts from Wolf, in PDF files, by
Contacting Wolf/Telus Support
.
Wolf Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Wolf EMR (Telus)
Importing from Other Software
Importing from Wolf EMR (Telus)
3 min readHere’s what we know about moving over from Wolf EMR (Telus) to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
