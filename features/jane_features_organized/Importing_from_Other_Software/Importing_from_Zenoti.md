...
*Source: [https://jane.app/guide/importing-from-zenoti](https://jane.app/guide/importing-from-zenoti)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:58:25*
...
Feature OverviewImporting from Zenoti
...
.
What can you expect?
While you’re making the switch over to Jane, Zenoti allows you to export most of your data fairly easily. Below are step-by-step instructions on getting as much as you can export from there, which you can provide to Jane. The below instructions are very important, as we require you to let us know a bit of information and what to expect from us post-import.
What can we import?
Appointments
Guests/Clients
Products
To export data from Zenoti, you’ll want to ensure that the necessary role permissions are enabled. It is also recommended to sign in to your Zenoti account using either the Owner or Manager roles.
Exporting Appointments from Zenoti
To export a list of Appointments to CSV, you can follow the steps below:
Navigate to
Reports
and search for the
Appointments report
.
Open the report and select the
export to CSV
icon
Exporting Clients/Guests from Zenoti
To export a list of Guests (Clients) to CSV, you can follow the steps below:
Navigate to
...
export to CSV
icon.
Exporting your Products from Zenoti
To export a CSV list of your
...
Inventory > Vendors
.
On the Manage Vendors page, click the
export to Excel
or
Export to CSV
icon.
To import Products from Zenoti, you’ll want to make sure the exported files contain some key points of information, such as
Price
and
Product Name
. If this information is not provided, you may need to manually add it to the CSV file before uploading it to Jane.
Zenoti Billing Data
...
For step-by-step instructions that on how to export your Sales Accrural and Collections to store outside of Jane for your reference, you can refer to this
Backup Your Data
guide from Zenoti.
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Zenoti
Importing from Other Software
Importing from Zenoti
5 min read
Balance Plan
