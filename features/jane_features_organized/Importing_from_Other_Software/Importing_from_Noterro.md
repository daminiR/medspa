...
*Source: [https://jane.app/guide/importing-from-noterro-previously-soap-vault](https://jane.app/guide/importing-from-noterro-previously-soap-vault)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:46:58*
...
Feature OverviewImporting from Noterro
...
Practice Plan
Thrive Plan
Here’s what we know about moving over from Noterro to Jane.
...
.
Exporting your Customers from Noterro
Coming from Noterro, we’ll need you to upload your Customer export with as much detail as possible.
Here are the steps on how to export a Client List from Noterro. You can also reference
this guide
from their website on how to export this type of data.
Log in as Admin and head to the patient list page.
Click on the Patient icon (left header).
Click the Three Dots next to the Add Client button.
Click Export Patient.
This will download all of your patient/client information into a CSV file, which can be opened by products like Microsoft Excel spreadsheets.
Exporting your Noterro Appointments
Log in as Admin.
Click on the Graph icon (Reports) in the left navigation.
Click Events under the Patient section.
Click on Appointments left side bar.
Click Download (it will be downloaded as a CSV file).
Note: Filter for Date Range to grab all historical + future appointment history if possible.
Exporting Charts/Medical Records from Noterro
Click on the Patient name.
Click the Clinical Note in the sidebar.
Click on the Printer icon to the right of Add Note button.
Select the appropriate Filters.
Click Print.
When your printer preview screen opens, select Print to PDF (this will create a single digital file of all the notes on your computer).
Note: Referenced in this
Noterro Guide
, they also mention the ability to export
Forms
. We would also recommend reaching out to their
Support Team
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Noterro
Importing from Other Software
Importing from Noterro
3 min read
Balance Plan
Practice Plan
Thrive PlanHere’s what we know about moving over from Noterro to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
