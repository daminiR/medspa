...
*Source: [https://jane.app/guide/importing-from-pps-pps-express-rushcliff-software](https://jane.app/guide/importing-from-pps-pps-express-rushcliff-software)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:50:08*
...
Feature OverviewImporting from PPS/PPS Express (Rushcliff Software)
...
Practice Plan
Thrive Plan
Here’s what we know about moving over from PPS to Jane.
...
.
We’ve broken the below information into separate sections for the different versions of PPS; PPS Local/Hosted and PPS Express
Due to the complexity of the data provided by PPS, as well as the time difference between the UK and Canada (Pacific Time), you may experience a delay in some of your data being imported. When you schedule your import, you will choose two dates; one date that will be the date you plan on uploading the data to us, and the second date being the expected date you’d like your data imported.
...
For more information, you can also refer to our guide,
Time Zones, Big Data and Your Import
.
Exporting your Patients from PPS
PPS Local/Hosted
We’ll need you to upload your Client export with as much detail as possible.
Here’s some guidance from PPS’s support page on how to
Run a Report
. Following their guidance you can run a report of all patients, for all practitioners, for a custom date range, and then select to save this as an Excel file.
You have the additional option to pick and choose exactly which fields are included in the final export. Here’s some more guidance from PPS’s support page on how to
Create a Custom Excel Export
.
PPS Express
If using PPS Express you can head to the
Reports
tab and click to generate a
Client List
. You’ll see the option to
Email Report
near the top of the page. Enter your email address and click that button and you’ll receive a CSV version of the report attached to an email.
There’s some guidance from PPS on this here:
Reporting in PPS Express
.
Exporting your PPS Appointments
PPS Local/Hosted
Here’s a link to the same guidance from PPS’s support page on how to
Run a Report
.
Remember to run the entire date range of appointments (past and future!) for all practitioners.
You can choose to save the file in
Full Detail
then select
Excel
as your output. You have the additional option to pick and choose exactly which fields are included in the final export. Here’s another link to PPS’s support page on how to
Create a Custom Excel Export
.
PPS Express
If using PPS Express you can head to the
Reports
tab and click to generate an
Appointment Report
. You’ll see the option to
Email Report
near the top of the page. Enter your email address and click that button and you’ll receive a CSV version of the report attached to an email.
...
Reporting in PPS Express
.
Exporting Treatment Notes/Charts from PPS
In order to complete a successful transition to Jane we recommend speaking with PPS to arrange a
formatted data export.
PPS will arrange and complete this for you, and you’ll receive a folder for each patient that contains all of their treatment notes, letters, images and documents. This is a paid service from PPS so you’ll want to arrange this directly with them to find out the details, price and process.
PPS might also offer a free “data dump” that contains all of the data tables from your PPS account. We’re not able to import from these file types and the best way to ensure a successful import is to receive the data formatted.
PPS Billing Data
We don’t import billing information as there are formatting issues between the two systems.
Uploading into Jane
To ensure that your data is uploaded to the correct account, and for security reasons, we do not accept patient data via email.  You can upload the files to us in the Settings > Schedule an Import area of your Jane account.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from PPS/PPS Express (Rushcliff Software)
Importing from Other Software
Importing from PPS/PPS Express (Rushcliff Software)
7 min read
Balance Plan
Practice Plan
Thrive PlanHere’s what we know about moving over from PPS to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
...
or give us a ring at
0 808 164 0893
If you need any further help getting all set up to run with Jane, just let us know!Subscribe to our monthly newsletter.Jane Software Inc.
