...
*Source: [https://jane.app/guide/importing-from-practice-better](https://jane.app/guide/importing-from-practice-better)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:50:17*
...
Feature OverviewImporting from Practice Better
...
.
What can you expect?
While you’re making the switch over to Jane, Practice Better allows you to export most of your data fairly easily. Below are step-by-step instructions on getting as much as you can export from there, which you can provide to Jane. The below instructions are very important as we require you to let us know a bit of information, and what to expect from us post-import.
What can we import?
Client List
Session Notes (Charts & all the data this encompasses)
Appointment History
Exporting your Client List, Session Notes & Appointment History from Practice Better
To export the client list and session notes from Practice Better, you can follow these steps below:
Go to your
Client List
...
Click the
more options
button next to a client and click the
Export data
button
Select the items you’d like to export for the client (Ex: Personal & Contact Information, Session Notes & Booking History)
Select
Create Archive
in the toolbar to start the export process.
From there, Practice Better should send you an email when your client archive is ready.
Exporting Contact Information
You can export your client contact information, such as, first name, last name, email, etc.) by following these steps:
Head over to
My Clients
Click
Export contacts
from the Fast Action Button
Practice Better has an amazing guide article that you can reference on
How to Export your Data
which we recommend peeking at.
Practice Better  Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Practice Better
Importing from Other Software
Importing from Practice Better
5 min read
Balance Plan
