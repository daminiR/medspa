...
*Source: [https://jane.app/guide/importing-from-cerbo](https://jane.app/guide/importing-from-cerbo)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:38:49*
...
Feature OverviewImporting from Cerbo
...
.
What can you expect?
While you’re making the switch over to Jane,  Cerbo allows you to export most of your data fairly easily. Below are step-by-step instructions on getting as much as you can export from there, which you can provide to Jane. The instructions below are very important as we require you to let us know a bit of information, and what to expect from us post-import.
What can we import?
Client List
Appointments Report
Chart Data
Exporting your Client List
To export the client list from Cerbo, you can use their
Advanced Patient Search
tool to export all the reports you need. You will be able to export these reports in either Excel or CSV Format.
You can follow
this guide
which walks through how to use the tool in detail.
Note: They also have a great video resource on
How to Use the Advanced Patient Search
tool which we have added here for you to reference as needed.
Exporting your Appointments Report
To export the Appointments Report from Cerbo, you can use their
Calendar Report
tool to export this report in particular. You will be able to export this report in either Excel or CSV Format.
You can follow
this guide
which walks through how to use the tool in detail.
From the top menu go to
Scheduling » Calendar Report(s)
.
Select your filter options for the report (Date Range, Appointment Status, Appointment Type, etc).
Lastly, click “Create Report” to generate it. It will either open in a new tab (if you picked Print View) or in Excel (if you picked Spreadsheet).
Note: The Calendar report can be filtered with the Advanced Patient Search to show more details about patients.
Exporting your Chart Data
From what we have seen, you can export chart data in full per client OR as a Batch Chart Export of all client records from Cerbo.
This article from Cerbo goes over
Exporting a Patient’s Chart as a Zip File
.
You can use this article To
Bulk Export All Patient Charts as a Package
.
Cerbo Billing Data
...
If you need any further help getting all set up to run with Jane,
just let us know!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Cerbo
Importing from Other Software
Importing from Cerbo
5 min readDisclaimer
: This guide uses our experience importing from different software, as well as any guides different software publish, to assist our customers in transitioning over to Jane. If you have any difficulty downloading your data, it’s best to reach out to your current software provider directly.
Jane is here to make your switch a stress-free one
Let Jane be your helping hand while you’re transitioning your busy practice. We have dedicated staff to ensure switching over is easy and to answer your questions every step of the way. We’ll help you set up your account so you can hit the ground running and guide you through importing your data.
It doesn’t stop there! After you’re settled in, you’ll always have free and continued ongoing support from the Jane team whenever you need it.
...
Scheduling Your Import
If you need any further help getting all set up to run with Jane,
just let us know!Subscribe to our monthly newsletter.Jane Software Inc.
