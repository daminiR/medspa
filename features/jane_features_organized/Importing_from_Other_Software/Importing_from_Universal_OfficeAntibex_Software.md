...
*Source: [https://jane.app/guide/importing-from-universal-office-antibex-software](https://jane.app/guide/importing-from-universal-office-antibex-software)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:56:04*
...
Feature OverviewImporting from Universal Office/Antibex Software
Importing from Other Software
Importing from Universal Office/Antibex Software
3 min read
Here’s what we know about moving over from Universal Office/Antibex Software to Jane.
...
.
Exporting Your Patients and Appointments from Universal Office
So coming from Universal Office, we’ll need you to grab your patient list and appointment information in an
Excel or CSV file format
from your Reports Manager area.
To open Reports Manager, click
Start > All Programs > Universal Office CPR > Reports Manager Plus
.
Alternatively, click
Reports Manager
on the main toolbar when Universal Scheduling is open.
Then, to export a report template:
Click
Tools
on the toolbar and select
Export
.
Locate and select a report template, then click
Save
to disk.
In the
Save As
windows, browse and select a folder, then click
Save
.
Here is a help document by Antibex with more details on
generating and exporting reports
.
Exporting Universal Office Patient Case Files
Unfortunately Antibex doesn’t offer a batch export of your charts.
You can export charts individually, so exporting to PDF and then uploading them to Jane one at a time.
Here is their help guide on
exporting patient case files
to
upload to Jane charts
manually.
Universal Office Billing Data
...
Other Notes
You might want to print out or save any billing reports generated from the Reports Manager area as it may be helpful to have these records on hand. Otherwise, it seems like they offer a read-only version of the software when the subscription is discontinued.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Universal Office/Antibex Software
Importing from Other Software
Importing from Universal Office/Antibex Software
3 min readHere’s what we know about moving over from Universal Office/Antibex Software to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
