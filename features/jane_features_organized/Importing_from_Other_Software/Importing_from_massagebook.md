...
*Source: [https://jane.app/guide/importing-from-massagebook](https://jane.app/guide/importing-from-massagebook)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:44:47*
...
Feature OverviewImporting from massagebook
Importing from Other Software
Importing from massagebook
4 min read
Here’s what we know about moving over from massagebook to Jane.
...
.
Exporting Clients from massagebook
To export your entire list, navigate to your:
Business Profile
Select Clients
Select Import / Export in the top right corner to expand the menu
Select Export client file to download the file to your device
This will give you a CSV file of your clients that we’re able to import for you. There’s also
this guide
from massagebook that outlines that.
Exporting Appointments from massagebook
To view upcoming appointments for all clients, you should be able to use the Future Appointments report located in your business’ Sales section in massagebook.
To do this, you can navigate to the ‘Business’ tab and follow the steps below:
Select Reports
Select Future Appointments
Select Import / Export in the top right corner to expand the menu
Enter the date range for the period that you want to report on
To view appointments for a specific staff member only, use the Filter tool and choose the staff member’s name from the drop-down
Select the Print option to the far-right to print the report, or select ‘Export’ to download a CSV spreadsheet of the data and sort the data how you would like
To view appointments for a specific staff member only, you can use the Filter tool and choose the staff member’s name from the drop-down.
Use the Print option to the far right to print the report, or select Export to download a CSV spreadsheet of the data and sort the data how you’d like.
You can access
this guide
for reference.
massagebook Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from massagebook
Importing from Other Software
Importing from massagebook
4 min readHere’s what we know about moving over from massagebook to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these software to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
