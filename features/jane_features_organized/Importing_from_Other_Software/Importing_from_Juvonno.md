...
*Source: [https://jane.app/guide/importing-from-juvonno](https://jane.app/guide/importing-from-juvonno)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:44:03*
...
Feature OverviewImporting from Juvonno
...
Thrive Plan
Legacy Plans
Here’s what we know about moving over from Juvonno to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty retrieving your data, it’s best to reach out directly to your current software provider.
...
.
Juvonno suggests that you run these reports after regular business hours so that your reports will run much faster and exporting your data won’t take as long.
Exporting your Juvonno Patients
So coming from Juvonno, we’ll need you to upload your
Patient Report
with as much detail as possible.
Under the
Settings > Reports > Export
section in Juvonno, click on the button that says
Patients
.
The
Patient Report
can be exported to
Excel
for importing into Jane.
There’s a support document on their website that shows you where to export your patient demographics here:
Exporting Patient Demographics
💡Note on Active/Inactive Statuses:
From past experience, this report from Juvonno
may not include Active Vs Inactive Status
for patients. You’ll want to double-check this before uploading the data into Jane for import. If it’s missing, simply
adding a column called “Active Status”
to the file with either
TRUE or FALSE values
will allow our team to import this status.
Exporting your Juvonno Appointments
Juvonno will also allow you to export your
...
to
Excel
for uploading to your Jane import request.
Juvonno has a support document on their website that shows you where to locate and export your
Appointments
report:
Exporting Appointments from Juvonno
.
Exporting your Juvonno Charts
Juvonno allows you to export charts in an
XML Format
, but we’re not able to tell what we would be able to extract from that data until we see it. We can’t guarantee data imported in this format has everything that you’re expecting, and it’s best to reach out to the software first to see if there are any specific things we should look out for.
🚨 From our experience, the
XML Chart Export
only really allows us to import
SOAP Notes
in
Text Format
to Jane. The rest of the Chart Data
is not something we can import
in this format.
💡 We have seen that Juvonno offers
Batch Chart Exports
in
PDF Format
but
...
. Please connect with
their support team
to find out more information about this. The
Chart Data in PDF Format
is recommended for the Data Import as it provides all of your
Chart Data
in a format that we work best with.
Note: We will still need to verify the data export from Juvonno to confirm that the data can be imported/mapped accordingly with success. We have seen clinics request a “sample” of the chart export in PDF Format to provide to us here at Jane via an Import Request for our wonderful Imports Team to review as needed.
Juvonno Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Juvonno
Importing from Other Software
Importing from Juvonno
5 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansHere’s what we know about moving over from Juvonno to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
