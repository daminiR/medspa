...
*Source: [https://jane.app/guide/importing-from-cliniko](https://jane.app/guide/importing-from-cliniko)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:40:47*
...
Feature OverviewImporting from Cliniko
Importing from Other Software
Importing from Cliniko
3 min read
Here’s what we know about moving over from Cliniko to Jane.
...
.
If you need to export all of your data from Cliniko—and not just items from a specific date range—select Any time to Any time under the date range field (this will make the fields appear blank; this is okay!). Check out the examples in their guidance, which is linked below.
Exporting your Patients from Cliniko
Coming from Cliniko, we’ll need you to upload your Client export with as much detail as possible.
Cliniko offers easy to use exports for your data, and you can head to the
Settings Page
and then find the
Data Exports
area.
Here’s a Help Doc from Cliniko’s support page on how to
Export your Client List
.
Exporting your Cliniko Appointments
Same steps as above but using the
Appointments
filter.
The default CSV format is fine for us to import.  And be sure to remember to run the entire date range of appointments (past and future!).
Exporting Charts from Cliniko
Clinko provides a CSV export of charts as well. We can use that export to import Cliniko charts in Jane formatted SOAP notes with the original signature and appointment dates.  These will not be editable after import.
Cliniko Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Cliniko
Importing from Other Software
Importing from Cliniko
3 min readHere’s what we know about moving over from Cliniko to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
