...
*Source: [https://jane.app/guide/importing-from-noustalk](https://jane.app/guide/importing-from-noustalk)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:47:09*
...
Feature OverviewImporting from NousTalk
...
Let Jane be your helping hand while you’re transitioning your mental health practice. We have dedicated staff to ensure switching over is easy and to answer any questions that come up along the way. We’ll work with you to help set up your account and guide you through importing your data, so you can hit the ground running.
...
.
What can you expect?
When making the switch over to Jane, NousTalk exports your data fairly easily. Below are instructions on how you can initiate the process of exporting your files when you’re feeling ready to make the switch to charting, billing and booking in Jane.
What can we import?
Client List
Appointments
Session Notes
Documents & Image files
Exporting your Data from NousTalk
We have seen clinics provide us with a data export that includes the following files:
users.csv
- Client demographics
appointments.csv
...
- Session notes
docs folder
- uploaded Documents & Image files
To request the data export, we recommended reaching out to NousTalk. Here’s a link to their
Contact Us page
⚠️
Please note
if there are multiple therapists in your NousTalk account, you’ll want to request a separate export for
each therapist
.
Uploading Your Data into Jane
You can upload the
.zip file
(or files if there are multiple therapists) directly into the import in your Jane account. No need to unzip the files first! You can navigate to the
Schedule an Import
page to securely upload your data.
For an overview of the import process, please have a gander at our guide:
Scheduling Your Import
NousTalk Billing data
We aren’t able to import historical
billing data
as there are formatting issues between the two systems, but we have a guide on
...
We recommend securely storing the
invoices.csv
and
payments.csv
files outside of Jane in case you may need to reference these in the future.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from NousTalk
Importing from Other Software
Importing from NousTalk
4 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/2ffc17c3-2261-4fdd-9dad-f87d9a74b70a)
