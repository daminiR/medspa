...
*Source: [https://jane.app/guide/importing-from-prompt-emr](https://jane.app/guide/importing-from-prompt-emr)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:51:41*
...
Feature OverviewImporting from Prompt Health
...
,
Chart Notes & Files
from Prompt Health. Below you’ll find step-by-step instructions on how to export your data when you’re feeling ready to make the switch to charting, billing and booking in Jane.
What can we import?
Patient List
Appointments
Charts
Products
Insurance Policies
Exporting your Patient List from Prompt Health
To export your full list of patients from Prompt Health, please follow these steps:
Click the
Patients
...
In the pop-up,
All Dates
will be selected. Click
Export
The Patient List
Excel file
will download to your device
💡 Helpful hint: if you would like to export patients for a
specific provider
, there is the option to select one or more providers in the
Providers Seen
filter.
Prompt Health also has a handy guide on exporting your Patient List:
Patient Data Download Explained
Exporting your Appointments from Prompt Health
To export your past & upcoming appointments from Prompt Health, you can follow these steps:
Click the
Reports
tab in the left-hand menu
On the next screen (Downloads tab), click into the
date range filter
and select
All Time
to grab both past and future appointments (or filter for a specific date range if required)
Click the purple
Apply Filters
link to the right
Click the
...
The
Excel file
will take a few moments to download to your device
💡 Helpful hint: if you would like to export appointments for a specific location or staff member, you can use the
Facility
or
Providers
filters in the filter bar.
Exporting your Charts from Prompt Health
From what we know, Prompt Health only allows you to export your charts and files
patient-by-patient
. Here are the steps to generate a
single PDF file
containing a patient’s chart notes, forms, and files:
Click the
Patients
tab in the left-hand menu
Click into the patient’s
profile
Navigate to their
Files
tab
...
Select
Print
In the PDF file that opens, click the
download button
Name the file
Firstname_Lastname_PromptAccount#
(the Prompt Account # is in
column A
in the Patient List)
Save
...
yet
seen a bulk chart export from Prompt Health. We recommend reaching out directly to their
support team
to inquire about how to export your charting in bulk. Let us know! 💙
Exporting your Products from Prompt Health
Click the
Reports
tab in the left-hand menu
On the next screen (Downloads tab), click the
date range filter
and select
All Time
Click the purple
...
Revenue
column)
Exporting your Insurance Policies from Prompt Health
Insurance policy information (Member ID# and Payor Name) is included in the
Patient List report
and
in the
Operations report
, so we’re all good! 🎉 No steps to follow 😉
...
Prompt Health Billing data
We aren’t able to import historical
billing data
due to the complex nature of this kind of data and formatting issues between the two systems, but we have a guide on
Transitioning Your Clients Credits/Receivables to Jane
that you can follow to ensure those are entered into Jane should you need to carry this information over.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Prompt Health
Importing from Other Software
Importing from Prompt Health
7 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/18678d3a-6bb0-40a7-bd7d-add68119ad4f)
