...
*Source: [https://jane.app/guide/importing-from-schedulista](https://jane.app/guide/importing-from-schedulista)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:52:39*
...
Feature OverviewImporting from Schedulista
Importing from Other Software
Importing from Schedulista
3 min read
Here’s what we know about moving over from Schedulista to Jane.
...
.
Exporting your Clients from Schedulista
Coming from Schedulista, you can export your Clients to a CSV file for us to import.
The Client List can be exported from the “Clients” tab, then select the Gear Icon, and select “Export Clients to file”.
You will end up with an exported CSV document with all of your Clients.
Here is the
Exporting Clients
from Schedulista guide.
Exporting your Appointments from Schedulista
For appointments, you will need to run the Appointment Report. You can
click here
to see how to do that.
After you have run the appointment report, you will need to click the Gear Icon in the top right corner and select an option from the list.
You will be able to choose if you want to export All Appointments, Past Appointments, Future Appointments, or a custom selection.
You can choose All Appointments for a set of appointment data including future appointments.
Here is the
Exporting Appointment Report
guide from Schedulista as well.
Schedulista Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Schedulista
Importing from Other Software
Importing from Schedulista
3 min readHere’s what we know about moving over from Schedulista to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
