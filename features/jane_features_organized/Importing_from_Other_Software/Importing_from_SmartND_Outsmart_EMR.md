...
*Source: [https://jane.app/guide/importing-from-smartnd](https://jane.app/guide/importing-from-smartnd)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:53:49*
...
Feature OverviewImporting from SmartND (Outsmart EMR)
Importing from Other Software
Importing from SmartND (Outsmart EMR)
3 min read
Here’s what we know about moving over from SmartND to Jane.
...
.
Exporting your Patients from SmartND
So coming from SmartND, we’ll need you to upload your patient export with as much detail as possible   The Patient list can be exported using the Master Patient List Page. Here’s a link to a SmartND Help Document about
Exporting your Patient List
.
Note: You can follow
this guide
as well to help “add columns” to the patient list report which will be very important for the data import process. You can add as many demographic details as possible to ensure you have all the data you need.
Most importantly, make sure to include the
ID Column
as this is needed to help map all data to the correct client profiles via the import process.
SmartND Charts and Appointments
Unfortunately, SmartND doesn’t offer a batch export of your charts from within their platform.
However, we have had clients provide us with Charts that they received by requesting them from SmartND directly.  Once you receive the data file from Smart ND we can import your Charts as PDF attachments.
For the
Appointments Report
you can follow
this guide
. Let’s make sure to add as many columns/identifiers as mentioned above when exporting the Patient List Report. Please make sure to include the
ID Column
for this as well to map the data accordingly.
SmartND Billing Data
...
When you create treatments in Jane, you only need to create private pay treatments as Jane will work with Insurers separately.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from SmartND (Outsmart EMR)
Importing from Other Software
Importing from SmartND (Outsmart EMR)
3 min readHere’s what we know about moving over from SmartND to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
