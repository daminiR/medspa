...
*Source: [https://jane.app/guide/importing-from-office-ally](https://jane.app/guide/importing-from-office-ally)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:47:34*
...
Feature OverviewImporting from Office Ally
Importing from Other Software
Importing from Office Ally
4 min read
Here’s what we know about moving over from Office Ally to Jane.
...
You’re able to export this information out of
Office Ally EHR
, which is what this guide is primarily referring to.
...
We suggest reaching out to Office Ally as they require you to reach out to them to install the program, so you will be able to export your patient demographics in Excel or CSV.
...
A recent update we’ve seen on this, however, is a detailed document provided by Office Ally that explains how to export your Appointments.
You can reference this document by clicking here:
Exporting your Appointments from Office Ally
You’re also able to reach out to Office Ally directly
here
...
transition your patient credits and receivables into Jane
.
You can also print or export and store your past Receivables for reference.
Other Data
If you see other reports within your Office Ally account that you are wondering about importing just let us know! In most cases, the data (excluding
BILLING
data) that is exported to Excel or CSV can be imported in some capacity. You can learn more about what kind of data Jane can import in our
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Office Ally
Importing from Other Software
Importing from Office Ally
4 min readHere’s what we know about moving over from Office Ally to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
You’re able to export this information out of
Office Ally EHR
, which is what this guide is primarily referring to.
...
If you need any further help getting all set up to run with Jane, just
let us know
and happy Importing!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/943fa265-3c86-4d28-952a-477a0c963ed6)
