...
*Source: [https://jane.app/guide/importing-from-drchrono-ehr](https://jane.app/guide/importing-from-drchrono-ehr)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:41:14*
...
Feature OverviewImporting from DrChrono EHR
Importing from Other Software
Importing from DrChrono EHR
4 min read
Here’s what we know about moving over from DrChrono EHR to Jane.
...
.
Exporting your Patients from DrChrono
Coming from DrChrono, we’ll need you to upload your Patient List export with as much detail as possible.
DrChrono offers easy to use exports for your data.
1) Select the
Patients
tab from your menu bar.
2) Then select
Patient List
from the drop-down menu.
3) From here click on
Export (CSV)
button in the top right corner to download the file.
Here’s a guide from DrChrono on how to
Export your Patient List
for more information.
Exporting your DrChrono  Appointments
Same steps as above but select the
Appointment Report
in the
Reports
tab.
On the Appointment report, there are a number of filter options.
Please click as many as possible, the more information the better for our team.
And be sure to remember to run the entire date range of appointments (past and future!).
Once you have successfully found the information you are looking for hit the
Export to File
button.
The report will then be sent to your
message center
as a
.CSV file
for you to save locally.
For more information, head over to DrChrono’s support page on how to
Export your Appointment Report
.
Exporting Charts from DrChrono
DrChrono now manages charts through a service called Acronis.
For more information on how to retrieve your charts, please reach out to DrChrono to see the best way to provide those over to us. You will need to upload the chart files to the import area in your Jane account for us to be able to import those.
DrChrono Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from DrChrono EHR
Importing from Other Software
Importing from DrChrono EHR
4 min readHere’s what we know about moving over from DrChrono EHR to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
