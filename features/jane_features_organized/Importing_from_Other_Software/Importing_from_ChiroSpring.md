...
*Source: [https://jane.app/guide/importing-from-chirospring](https://jane.app/guide/importing-from-chirospring)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:39:20*
...
Feature OverviewImporting from ChiroSpring
...
Thrive Plan
Disclaimer
: This guide uses our experience importing from different software, as well as any guides different software publish, to assist our customers in transitioning over to Jane. If you have any difficulty downloading your data, it’s best to reach out to your current software provider directly.
...
.
What can you expect?
While you’re making the switch over to Jane, ChiroSpring allows you to export most of your data fairly easily. Below are step-by-step instructions on getting as much as you can export from there, which you can provide to Jane. The below instructions are very important as we require you to let us know a bit of information, and what to expect from us post-import.
What can we import?
Client List
Appointments
Client Files
Exporting your Client List from ChiroSpring
ChiroSpring allows you to export your Client List to a CSV file, which can then be opened in CSV.
...
Search
4. Click
Select patients from all pages
5. Click Action
6. Select
Export CSV
Exporting your Appointments from ChiroSpring
To export your appointments from ChiroSpring, you can follow these steps:
1. Click
Reports
2. Click
Appointments
...
5. Specify Start and End Date
6. Click
Search
7. Click
Select appointments from all pages
8. Click
Export CSV
Exporting Chart PDFs (treatment notes) from ChiroSpring
When it comes to charts in PDF files, it’s good to note that Jane can typically import treatment chart notes from a CSV or Excel file. Since ChiroSpring exports treatment notes in PDF files, we may have a workaround for you to be able to import these to Jane under the
Files
tab on a patient’s profile.
To export chart PDFs from ChiroSpring, you can follow these steps:
1. Click the
Search & Add Patient
field.
2. Type the Patient’s Name, and Select
Patient
3. Click on the patient icon to open the menu dropdown
4. Click
Treatment Notes
5. Scroll to the bottom to expand per page
6. Select all
7. Scroll to click
Generate PDF Report
After the files have been exported, you’ll want to add all the PDFs in a
zip file
so that you can upload them in Jane to your scheduled import, rather than uploading each PDF individually.
To ensure the PDFs get added to the correct profiles, you’ll also want to ensure the individual PDFs clearly state which patient the file belongs to, such as having the patient’s first name, last name, and patient number in the file name.
Exporting your Client Files from ChiroSpring
To export client files from ChiroSpring (notes, medical records, labs, etc.) for a specific client, you can follow the steps below:
Click the
Search & Add Patient
field.
Type Patient’s Name
Open the patient menu dropdown
Click
Documents
Click
All documents
Select documents to export
Once all documents have been selected, click the
Download selected files
icon
In Jane, these downloaded files can be imported to the
Files
tab on the patient’s profile.
ChiroSpring Billing Data
...
For step-by-step instructions on how to export your data from ChiroSpring, including screenshots, you can refer to this
Exporting Data From ChiroSpring
guide provided by ChiroSping.
It’s our understanding that ChiroSpring offers a service to export your data for you if you’d like to save some time. If you’d like to have this done for a fee, we recommend reaching out to ChiroSpring’s support team to inquire about this.
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from ChiroSpring
Importing from Other Software
Importing from ChiroSpring
6 min read
Balance Plan
...
in the secure import area.
You can find an overview of this process here:
Scheduling Your ImportSubscribe to our monthly newsletter.Jane Software Inc.
