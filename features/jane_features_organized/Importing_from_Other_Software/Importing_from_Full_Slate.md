...
*Source: [https://jane.app/guide/importing-from-full-slate](https://jane.app/guide/importing-from-full-slate)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:42:10*
...
Feature OverviewImporting from Full Slate
Importing from Other Software
Importing from Full Slate
3 min read
Here’s what we know about moving over from Full Slate to Jane.
...
.
Exporting your Customers from Full Slate
So coming from Full Slate, we’ll need you to upload your Customer export with as much detail as possible.
The Customer List can be exported from the Clients - List.   Click the export icon in the top right corner.
Here’s a
help doc from Full Slate
on how to export the Client List.
You will end up with an exported csv document with all of your Customers.
Exporting your Full Slate Appointments
For appointments you can go to the Schedule area.  From there choose “More” then “Sync, Import & Export” and then “Export Appointments”.
If you have a lot of data Full Slate exporters sometimes seems to time out, so if that happens just break your appointments up by years (or smaller date ranges if necessary) and export each file separately.  When you run them in batches make sure you set the filters in the exact same way.
Don’t forget to export your future appointments as well as your past appointments.
Full Slate Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Full Slate
Importing from Other Software
Importing from Full Slate
3 min readHere’s what we know about moving over from Full Slate to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
