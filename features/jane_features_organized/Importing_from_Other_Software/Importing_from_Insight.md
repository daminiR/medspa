...
*Source: [https://jane.app/guide/importing-from-insight](https://jane.app/guide/importing-from-insight)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:43:52*
...
Feature OverviewImporting from Insight
...
Thrive Plan
Disclaimer
: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these software to assist our customers in transitioning over to Jane. If you have any difficulty retrieving your data, it’s best to reach out directly to your current software provider.
...
Exporting your Patients from Insight
To export your patient list from Insight, you can follow these steps:
From the Insight dashboard, click
Report
...
Select
Guest Listing
In the panel that pops up, click
Export
Choose
‘Excel (XLS)’
Click
Save
to save the file to your local device
Exporting your Appointments from Insight
To bring over your appointments, you can follow these steps in Insight:
From the Insight dashboard, click
Report
up in the top menu bar
Select
...
Select
Appointment Listing
In the panel that pops up, leave the options as selected to export appointments for
All Employees
.
Filter for a date range by using the
Start Date
and
End Date
calendar fields at the bottom. (Don’t forget to filter past today’s date to grab
upcoming
appointments!)
Click the
Run Report
...
Enter a
filename
such as “Appointments report”
We are able to extract the appointments from the PDF file to import those into Jane.
Exporting your Products from Insight
To export your product list from Insight, please follow these steps:
Click
Report
up at the top, select
Inventory Reports
Select
Inventory & Service Listings
Leave
Retail Products
selected
Click the
...
Insight also allows you to export your
Professional Products
if those differ from your Retail products. If you haven’t yet created your
Services in Jane
, you can export the services from Insight as well by selecting the
Services
toggle.
Please note
that the Products file may not include a column for
Price
, which is required in order to import the products. Please open the file prior to uploading to check if there is a column containing pricing information.
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Insight
Importing from Other Software
Importing from Insight
5 min read
Balance Plan
