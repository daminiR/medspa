...
*Source: [https://jane.app/guide/importing-from-my-client-schedule](https://jane.app/guide/importing-from-my-client-schedule)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:46:14*
...
Feature OverviewImporting from My Client Schedule
Importing from Other Software
Importing from My Client Schedule
4 min read
Here’s what we know about moving over from My Client Schedule to Jane.
...
Jane is a Great Alternative
Jane is a wonderful alternative to My Client Schedule, and with My Client Schedule closing its doors, we’re happy to provide new customers with an exceptional experience and to make your transition as smooth as possible.
If you’re wondering if Jane is the right fit for you, we encourage you to
schedule a demo
with one of our great support team members, who can walk you through everything Jane has to offer such as Booking, Billing, Charting, as well as integrations such as Telus and Mailchimp. We’d love to get to know you and show you what Jane can do!
We don’t charge for extras like 1-on-1 New Account Setup calls, importing your data, or any of the ongoing support that you have access to. Just your monthly subscription fee! Our goal is to make your transition as smooth as possible, and to make sure that you’re set up for success in your practice. You can also check out
Jane’s features
here!
...
.
Exporting your Patient List or Past & Upcoming Appointments from My Client Schedule
In order to move over your patient list to populate profiles with demographics or get your Past & Upcoming Appointments into Jane, you’ll want to get that information from your current software in either
Excel or CSV
format.
Here’s a guide to get you started on the
Basics of Importing to Jane
.
If you’re not sure how to retrieve this information from My Client Schedule, we recommend reaching out to them to see how you’re able to do this in the best way possible.
My Client Schedule Billing Data
Due to the incredible complexity of billing data, and each software doing it differently, we’re not able to import billing data into Jane. We do have a great guide, though, on how you can
Transitioning Your Patient Credits and Receivables
to Jane, which will take you through step-by-step how to enter that into Jane after your import is complete.
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from My Client Schedule
Importing from Other Software
Importing from My Client Schedule
4 min readHere’s what we know about moving over from My Client Schedule to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these software to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
Jane is a Great Alternative
Jane is a wonderful alternative to My Client Schedule, and with My Client Schedule closing its doors, we’re happy to provide new customers with an exceptional experience and to make your transition as smooth as possible.
If you’re wondering if Jane is the right fit for you, we encourage you to
