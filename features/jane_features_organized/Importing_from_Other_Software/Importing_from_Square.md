...
*Source: [https://jane.app/guide/importing-from-square](https://jane.app/guide/importing-from-square)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:54:00*
...
Feature OverviewImporting from Square
...
.
Here’s what we know about exporting your data from Square 🔲
Exporting a Customer List from Square
To export your list of customers to a CSV (comma-separated values) file, please follow these steps:
Sign in
to your online Square account to open your Square Dashboard.
Select
Customers
in the options menu on the left
Select
Directory
Select
Import/Export
...
To export your past & upcoming appointment history as a CSV file from Square, you can follow these steps:
From the Square Dashboard, click on
Appointments
on the left
Navigate to
Settings
Click on the
History
tab to view your appointment history
Click
Export
in the top-right corner
The file will save to your device
The History CSV file will contain your
full appointment history
(both past and upcoming appointments), which we can import into Jane when you’re ready to make the switch 🙂
Exporting your Item Library from Square
To export your item library as a CSV file from Square:
Visit
Items
in your
...
>
Export
Choose to download an Excel or CSV file
Select
Export
Exporting anything else from Square
We recommend
contacting Square
to inquire about exporting any other sets of data you may be looking to bring over, such as customer notes. For a refresher on what data we’re able to import, please view our
Basics of Importing
guide.
Uploading into Jane
To ensure that your data is uploaded to the correct account, and for security reasons, we do not accept patient data via email. You can upload the files to us by scheduling an import in your account and then uploading them for us there. To book an import, you can navigate to
Settings
>
Schedule an Import
>
...
We are
unable
to import billing data into Jane from any software due to the complex nature of this kind of data and formatting issues between both systems. We advise starting fresh with billing in Jane and storing any financial reports, like sales or transaction histories, outside of Jane for future reference if need be.
For any patients with
credits
or
outstanding balances
, these can be recreated in Jane following the import and we have a handy to walk you through
Transitioning Your Clients Credits/Receivables
should you need to bring those over.
We’re here to work with you to ensure the smoothest transition possible so please don’t hesitate to reach out to our
support lines
if you have any questions about transitioning from Square.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Square
Importing from Other Software
Importing from Square
4 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/877e2a1e-f997-4887-a7fa-694e1969e57f)
- ![](https://jane.app/thumbs/edfe8489-37dd-4612-af3c-a6675a708a59)
