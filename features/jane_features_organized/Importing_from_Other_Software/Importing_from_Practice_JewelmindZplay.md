...
*Source: [https://jane.app/guide/importing-from-practice-jewel-mindzplay](https://jane.app/guide/importing-from-practice-jewel-mindzplay)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:45:29*
...
Feature OverviewImporting from Practice Jewel/mindZplay
Importing from Other Software
Importing from Practice Jewel/mindZplay
3 min read
Here’s what we know about moving over from Practice Jewel/mindZplay to Jane.
...
.
Exporting your Patient List from Practice Jewel
We recommend exporting your patient list with as much information as possible.
Head to
...
General
section.
Name the report as “Patient List” and ensure that all variables are selected under the
Options
tab to bring over all profile fields data.
Then click the
Results
tab and choose
Create File
...
A
CSV
file will save to your computer which you’ll need to locate to upload to Jane.
Exporting your Appointments from Practice Jewel
To export your appointments, head to
Reports > General Reports > Appointments Report
Name the report as “Appointments” and ensure that all variables are selected under the
Options
tab as you’ll want to bring over as much appointment information as possible.
...
CSV
file will save to your computer which you’ll need to locate to upload to Jane.
Exporting your Patient SOAP Notes from Practice Jewel
Mindzplay allows you to export all SOAP notes for a particular practitioner which we can import as a batch.
Alternatively, you can export chart notes per patient from
Patient > Records > SOAP History > Print
by hitting the
Download
icon at the top right of the document preview.
Each file can then be uploaded manually by following the instructions
here
.
Practice Jewel Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Practice Jewel/mindZplay
Importing from Other Software
Importing from Practice Jewel/mindZplay
3 min readHere’s what we know about moving over from Practice Jewel/mindZplay to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
