...
*Source: [https://jane.app/guide/importing-from-mbiz](https://jane.app/guide/importing-from-mbiz)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:44:57*
...
Feature OverviewImporting from mBiz
...
What can you expect?
Coming from mBiz, we’ve successfully brought over
patients
,
...
Appointments
Products
Exporting your Patients from mBiz
To export your patient list from mBiz, please follow these steps:
In the
Reports
tab in the left-hand menu, navigate to the
Client Listing
report
Up at the top, keep the first option,
Listing
, selected
Leave the other toggles below as-is
In the top-right corner, click the
Print
icon 🖨️ to generate the report
When the report generates, click the
Export
icon 💾 up at the top
Select
Excel
...
Client Listing
report and this time select the second option,
Listing with Email/Birthdate/Age
Repeat
steps 4-7 above to export this file as well
Navigate back to the
Client Listing
report and this time select the third option,
Listing with Address
Repeat
steps 4-7 above to export the additional file
💡
Helpful Hint:
To bring over as much patient demographic information as possible (phone number, email, birthdate, gender, address), you will want to export all
3 patient list files
as outlined above.
Exporting your Appointments from mBiz
To export your past & upcoming appointments from mBiz, please follow these steps:
In the
Reports
tab in the left-hand menu, navigate to the
Projection Report
In the
Date Range
fields at the top, filter for
one year
at a time (e.g. January 1, 2025 to December 31, 2025)
Select a
Location
Select
ONE
...
from the dropdown
Title the file
StaffMemberFirstName_StaffMemberLastName_YEAR_Appts
, e.g.
Jane_Smith_2025_Appts.xlsx
Repeat
steps 2-9 for each
year
the staff member has appointments
Repeat
steps 2-10 for
each individual staff member
💡
Helpful Hint #1:
If you receive a “Could not get a projection” error message when trying to generate the report, you will need to filter for a
smaller
date range, which is why we recommend filtering for
one
year at a time.
💡
Helpful Hint #2:
If you would like to bring over appointments for
inactive
staff, you can toggle on
Include Terminated Staff
to select them from the dropdown. Staff members can be marked as inactive in Jane following the import.
⚠️
Please note:
As appointment
duration
isn’t present in the files, we import the appointments with a placeholder duration of 30 minutes. No sweat! Once the import is complete, the appointments can be
bulk updated
with the correct duration.
Exporting your Products from mBiz
To export your product list and inventory from mBiz, please follow these steps:
In the
Reports
tab in the left-hand menu, navigate to the
Products
report
If you would like to include inactive products, toggle on the
Include Inactive
...
Click the
Export
option in the top right to download the inventory file
💡
Helpful Hint #1:
To bring over your products with their current inventory, both files are required. If you would prefer to start fresh in Jane with inventory, you can skip exporting the Inventory Report.
💡
Helpful Hint #2:
If
Sales Category
information is important to bring over, you can export the reports for each
individual sales category
. You’ll also want to make sure to recreate each corresponding
income category
in Jane.
Uploading Your Data into Jane
Thanks for following all those steps to export your data - you’re the snazziest ✨
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from mBiz
Importing from Other Software
Importing from mBiz
8 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/87993447-0a16-4a0e-95d5-5aa2a5333039)
