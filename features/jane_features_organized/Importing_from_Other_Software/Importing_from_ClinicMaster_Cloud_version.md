...
*Source: [https://jane.app/guide/importing-from-clinicmaster-cloud-version](https://jane.app/guide/importing-from-clinicmaster-cloud-version)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:40:20*
...
Feature OverviewImporting from ClinicMaster (Cloud version)
...
It doesn’t stop there! After you’re settled in, you’ll always have
free
and continued ongoing support from the Jane team whenever you need it.
...
.
👉 Still using ClinicMaster’s
Desktop
version? No worries, we’ve
got a guide for that
as well!
Moving from ClinicMaster to Jane
...
What can you expect?
Coming from the cloud version of ClinicMaster, we’ve successfully brought over
clients
,
...
Charts
Admin Notes
Exporting your Clients from ClinicMaster
Coming from ClinicMaster, we’ll need you to export your client list with as much detail as possible. To do so, you can follow these steps:
Click on 🔧
Manage
...
Clients
section, click on
4 - Clients - Demographic & Case & Appts & Financial
Click the
Filters
button (and remove any pre-loaded filters)
Search for and select the
Client Create Date
filter
Using the
Between
option, set a date range from
before
you started using ClinicMaster up until today’s date > Click
Apply
Click on the
Columns
button
...
Exporting your Appointments from ClinicMaster
Like the client list, you’ll want to export your appointments with as much detail as possible. Please follow these steps:
Click on 🔧
Manage
in the left-hand menu
Under the
Appointments
section, click on
4 - Appts - Demographic & Case & Appts & Financial
Click the
Filters
button (and remove any pre-loaded filters)
Search for and select the
...
option, set a date range from
before
you started using ClinicMaster and then go
into the
future
to capture upcoming appointments as well > Click
Apply
Click on the
Columns
button
...
Export to Excel
The file will download to your device
Exporting your Insurance Policies from ClinicMaster
To export your insurance information from ClinicMaster, please follow these steps:
Click on 🔧
Manage
in the left-hand menu
Under the
Cases
section, click on
4 - Cases - Demographic & Case & Appts & Financial
Click the
Filters
button (and remove any pre-loaded filters)
Search for and select the
...
The file will download to your device
Please Note:
For us to import insurance policies, we require a
Claim or Identification number
. If you have been entering this number in the
Claim #
field in ClinicMaster, then you’re all set as these numbers are included in the report. 🎉 If you have been entering this number in the
Certificate #
field, you will need to request the data export from ClinicMaster (outlined
below
) to import your policies as certificate number information is only included in the data export.
Subscriber Data Export from ClinicMaster
ClinicMaster offers a
bulk export
of your data, which includes your
charts
in PDF, but there is a
fee
for this service. To request the data export, you will need to contact ClinicMaster for more information:
Contact ClinicMaster
Once ClinicMaster has completed your export, you will receive an
email
containing a link to download your data. Once downloaded, you can upload the
zip
file directly into the import in your Jane account. There is no need to extract the contents of the zip file to upload. Instead, the
.zip file
can be dragged and dropped into the import as-is.
The email will also contain PDF instructions on how to convert the CSV files to Excel format. It is
NOT
necessary to convert the CSV files to Excel. 🙂
...
in PDF format
Please Note:
the Client List in the data export does
not
contain
active/inactive
status,
...
, and
Patient Since
information. You will want to follow the steps listed
above
to export the
Client List report
and include this file in addition to the data export in order to import your clients with the appropriate active/inactive status, sex, referral source, employer and patient since information.
💡
Helpful Hint:
If you will be requesting the Subscriber Data export from ClinicMaster, you can
skip
the steps listed on this page for exporting your
appointments
,
insurance policies
, and
...
. It is
not
required to export these additional files as they are already included in the export. 🎉
Cancelling your ClinicMaster subscription is not required to request the data export. As outlined in their
Terms of Use
, you are able to request the Subscriber Data export “at any time.”
For questions about the
timeline
of the export, it is best to reach out directly to ClinicMaster for assistance.
Exporting your Admin Notes & Alerts from ClinicMaster
To export admin notes from ClinicMaster, please follow these steps:
Click on 🔧
Manage
in the left-hand menu
Under the
...
To bring over your
alerts
, such as administrative and medical alerts, you can repeat the above steps and export the
10 - Alerts
report as well.
💡
Helpful hint:
As mentioned in the section above, admin notes & alerts are
included
in the Subscriber Data Export from ClinicMaster. If you are planning on requesting the data export, you can skip exporting the admin notes and alerts.
Uploading Your Data into Jane
Thanks for working through the steps to export your data. We really appreciate it! 💕
The final step before going live will be to upload your data in the
import
in Jane. (For security reasons, we do not accept patient data via email.) You can navigate to
Settings
>
Schedule an Import
>
View Details
to securely upload your files.
For a walkthrough of the import process from start to finish, we have a handy guide on
Scheduling Your Import
.
You did it! Once the files have been uploaded and you’ve clicked the
Done
button in the import, the rest is up to us. We’ll reach out via the import
Message
area if we have any questions about your data. We look forward to having you join the Jane community 💙
ClinicMaster Billing Data
We are
not
able to import billing information, such as sales and transaction histories, payments, receipts, gift card balances, etc., as this data is quite complex and there are formatting issues between the two systems. Our understanding is that ClinicMaster allows for the export of your billing data to backup files prior to your license expiring, so you can retain access to this information after your ClinicMaster access has ended.
We have a great guide on
Transitioning Your Clients Credits/Receivables to Jane
that we can help guide you through to ensure your clients’ credits and outstanding balances are recreated in Jane should you need to carry these over.
We’ve leveraged our experience with
various software imports
, along with official guides from other software providers, to create this comprehensive resource for transitioning to Jane. For questions about downloading your data, we recommend first reaching out to your
software provider
, as they’re the experts on their system. If you have any further questions or need additional support, please don’t hesitate to contact us – we’re here to help!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from ClinicMaster (Cloud version)
Importing from Other Software
Importing from ClinicMaster (Cloud version)
11 min read
Balance Plan
...
, along with official guides from other software providers, to create this comprehensive resource for transitioning to Jane. For questions about downloading your data, we recommend first reaching out to your
software provider
, as they’re the experts on their system. If you have any further questions or need additional support, please don’t hesitate to contact us – we’re here to help!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/822e9349-ea7e-44ba-8535-97a0620e109e)
