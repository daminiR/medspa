...
*Source: [https://jane.app/guide/importing-from-mrx](https://jane.app/guide/importing-from-mrx)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:46:02*
...
Feature OverviewImporting from MRX
...
Moving your data from MRX to Jane?
Jane is able to import data from a variety of software, and MRX is one of the ones we are certainly familiar with. We’ve completed many imports from this software, along with thousands of other imports from many others.
We have a dedicated imports team here at Jane that’s ready to import your data when you’re ready to make the switch, along with answering any questions you may have about migrating your data over or getting your business started with us. We understand the transition process can be stressful, and we’re here to make it as smooth as possible.
...
.
What can you expect?
You’re able to retrieve a
Backup File
out of MRX that you can provide to us which will have the data you’re looking to import.
While we’re able to retrieve quite a bit of data out of the
Backup File
, we’re currently not able to retrieve any Insurance Data out of that.
What Type of Data can be Imported?
We can import a variety of data from the
Backup File
which includes:
Patient Demographics to populate patient profiles
Past & Upcoming Appointments
Chart data
Products
Creating your Backup
After you’re done your day, close out of MRX.
Choose to backup when prompted.
Find the backup file that was created which will look something like this although with different numbers: full20181030-1119.zip.  The date should be the current date.
A Note About Backup Files
Backup Files from MRX can sometimes be quite large. When following the next steps to upload data to Jane, it’s important that you stay on the import page while uploading your data and not navigate away or press the
Done
button until the file has been completely uploaded
Depending on the size of your backup file and your internet speed, if the file times out while uploading, it may be best to break the backup file into smaller-sized files. We typically see this happen if a file is larger than around 50-60GB.
Uploading into Jane
...
Teleplan
If you are in BC and using Teleplan, we have a help file for
transitioning Teleplan
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from MRX
Importing from Other Software
Importing from MRX
4 min readDisclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
Moving your data from MRX to Jane?
Jane is able to import data from a variety of software, and MRX is one of the ones we are certainly familiar with. We’ve completed many imports from this software, along with thousands of other imports from many others.
We have a dedicated imports team here at Jane that’s ready to import your data when you’re ready to make the switch, along with answering any questions you may have about migrating your data over or getting your business started with us. We understand the transition process can be stressful, and we’re here to make it as smooth as possible.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
...
Teleplan
If you are in BC and using Teleplan, we have a help file for
transitioning TeleplanSubscribe to our monthly newsletter.Jane Software Inc.
