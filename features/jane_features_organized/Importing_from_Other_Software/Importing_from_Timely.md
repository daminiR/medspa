...
*Source: [https://jane.app/guide/importing-from-timely](https://jane.app/guide/importing-from-timely)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:55:12*
...
Feature OverviewImporting from Timely
Importing from Other Software
Importing from Timely
3 min read
Here’s what we know about moving over from Timely to Jane.
...
.
Exporting your Customers from Timely
So coming from Timely, we’ll need you to export your Customer List with as much information as possible.
From the
Reports
section, choose
Customer List
under the Customers section and click
CSV
to save the file locally to your computer.
Step-by-step screenshot instructions are laid out by Timely
here
.
Exporting your Appointments from Timely
Similar to the Customer List, you’ll want to export the
Appointment Schedule
from the
Reports
section.
Using the filter at the top of this report, select your
date range
to include all your past and future appointments and then click
View Report
to generate your data.
Once you’re satisfied with what’s displayed, select
CSV
to save the file to your computer.
Locate the file on your desktop and upload it to Jane!
Exporting your Products from Timely
To bring your inventory over, export the
Stock Levels
report from the
Reports
section as a
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Timely
Importing from Other Software
Importing from Timely
3 min readHere’s what we know about moving over from Timely to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
