...
*Source: [https://jane.app/guide/importing-from-platinum-chiropractic-software](https://jane.app/guide/importing-from-platinum-chiropractic-software)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:48:59*
...
Feature OverviewImporting from Platinum Chiropractic Software
...
What can you expect?
Coming from Platinum Chiropractic Software, we’ve successfully brought over
...
, and
SOAP chart notes
. Below you’ll find step-by-step instructions for how to export your data when you’re feeling ready to make the switch to charting, billing and booking in Jane 💙
What can we import?
Patient List
Appointments
SOAP Notes
Payors & Insurance Policies
Admin Notes
Exporting your Patients from Platinum
To export your patient list from Platinum, please follow these steps:
Click the
List, Report
...
Click
Create a New Report
In the Report Builder box, check
ALL
checkboxes
Click
Execute
The progress bar will begin to scroll slowly
In the Report Builder screen that opens, click the
Excel
icon up at the top
Name the file and click
Save
Note #1:
If the progress bar loads
instantly
after clicking the
Execute
button and you’re returned to the main Report List screen, the export has failed. You will need to
split the export up
into multiple files, selecting a smaller selection of checkboxes each time along with the 4
REQUIRED
checkboxes:
Patient ID
(required),
...
naming the file
, it will save if you enter a
number value (1, 2, 3, 4, etc.)
instead. The file can be
renamed
once saved to your computer.
Exporting your Appointments from Platinum
To export your past & upcoming appointments from Platinum, please complete the following steps:
‼️
Pre-export step:
click
Alt
+
E
on your keyboard to select the
Excel [XLS] Table Format
output type, then hit
Enter
Click the
List, Report
icon in the top menu
...
Post-export step:
staff member
is denoted by a number value in
column I (Profession)
. To import the appointments correctly, you will need to specify which
staff member
corresponds to
each number
in this column. Similarly, the
treatment/visit type
is denoted by a letter in
column O (Code)
...
for each
letter value
. This information can be added in a
text file
(e.g. Word document, etc.) uploaded along with your data, or added in a
message
in the import area.
💡
Helpful hint:
if you’re having difficulty exporting the full range of appointments, you can try breaking down the export into smaller date ranges (e.g. by year, 6 months, etc.)
Exporting your SOAP Chart Notes from Platinum
To export your SOAP notes to PDF, please complete the following steps:
‼️
Pre-export step:
click
Alt
...
Click the
E.H.R.
button in the top menu (under Print)
Click the
U
Utilities
icon
Select
Z) List All Patients SOAP Notes Between 2 Dates
Select the full
date range
Save to
PDF
...
TEMP
folder in the Platinum server database (Network > Server > Platinum > TEMP). If you’re using the cloud version of Platinum, the location will be listed when downloading the file.
Exporting your Payors & Insurance Policies from Platinum
To bring over insurance information, please follow the steps above on exporting your Patient List with all the
insurance checkboxes
(e.g. Insurance Policy Number, Insurance Policy Group, Insurance Payor, etc.) checked off.
☑️ You will need to make sure to also include the 4
REQUIRED
checkboxes (
Patient ID
,
...
&
File No.
) in addition to the insurance checkboxes when exporting.
Exporting your Patient Notes from Platinum
To include any admin notes that may have been entered in the
Miscellaneous
or
F5 notes
sections of patient profiles, you can similarly follow the steps above on exporting your Patient List with the
Miscellaneous
and
F5 notes
boxes checked off.
☑️ You will need to make sure to include the 4
REQUIRED
checkboxes (
Patient ID
,
...
&
File No.
) as well when exporting the file.
Uploading Your Data into Jane
Thanks for following all those steps to export your data - you’re pretty amazing ✨
...
>
View Details
to securely upload the patient list, appointments, insurance, and notes
xls files
, and the SOAP notes
PDF file(s)
.
...
Done
button in the import, we’ll bring in your data as soon as we can and reach out in the import area if we have any questions.
Platinum Billing Data
We are
not
able to import historical
billing data
into Jane due to the complex nature of this kind of data and formatting issues between the two systems. To bring over any patient credits or outstanding balances, we have a handy guide on
Transitioning Your Clients Credits/Receivables
that you can follow to ensure those are recreated in Jane should you need this information.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Platinum Chiropractic Software
Importing from Other Software
Importing from Platinum Chiropractic Software
8 min read
Balance Plan
...
- ![](https://jane.app/thumbs/62eeab07-785e-4a36-a39c-f666c76f021a)
