...
*Source: [https://jane.app/guide/importing-from-unified-practice](https://jane.app/guide/importing-from-unified-practice)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:55:50*
...
Feature OverviewImporting from Unified Practice
...
.
Here’s what we know about moving over from Unified Practice to Jane.
Exporting your Patients from Unified Practice
So coming from Unified Practice, we’ll need you to upload your
Patient List
export with as much detail as possible.  Your patients’ demographics can be exported to
CSV
for easy import into Jane.
To export your
Patient List
go to
...
Click the
Export
button in the upper right-hand corner of the screen to export this report to
CSV
file.
Here is a helpful guide on
Exporting Patients and Other Reports
from Unified Practice.
Note: This report from what we have seen does not indicate the
Active vs. Inactive status
for the Client List. This is something that would need to be edited post-import administratively.
Exporting your Unified Practice Appointments
To have your appointments exported in a usable format that Jane can import, you may need to
contact Unified Practice
and request a “Calendar Export.”
In the past, we’ve seen clinics upload an Excel (.xlsx) file of their appointments, which is exactly what we need 😊
Exporting your Unified Practice Chart Notes
Unified Practice will perform a chart export for you free of charge as far as we know. Your chart notes will be exported in
PDF
format which is one of Jane’s preferred file types for importing chart notes.  You will need to ensure that the
PDF
files have a way to link back to the patient. You can learn more or get a refresher on the best approach for linking chart notes to a specific patient in our
Basics of Importing
.
To speak with a Unified Practice representative about exporting your patients’ charts, you will want to
Contact Unified Practice
directly.
💡 A Note about Chart Exports
The Unified Practice Chart Export provided to you will also include a patient list specific to the unique IDs this EMR uses. We will also reference this when importing this type of data.
...
, along with official guides from other software providers, to create this comprehensive resource for transitioning to Jane. If you have any difficulty downloading your data, it’s best to reach out to your current
software provider
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Unified Practice
Importing from Other Software
Importing from Unified Practice
5 min readJane is here to make your switch a stress-free one 💙
Let Jane be your helping hand while you’re transitioning your busy practice. We have dedicated staff to ensure switching over is easy and answer any questions that come up along the way. We’ll work with you to help set up your account and guide you through importing your data, so you can hit the ground running.
It doesn’t stop there! After you’re settled in, you’ll always have free and continued ongoing support from the Jane team whenever you need it.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
