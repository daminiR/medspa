...
*Source: [https://jane.app/guide/importing-from-appointmentplus](https://jane.app/guide/importing-from-appointmentplus)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:38:23*
...
Feature OverviewImporting from AppointmentPlus (DaySmart)
...
.
Exporting your DaySmart Data
AppointmentPlus EMR
has now been acquired by
DaySmart
In the past, we’ve seen clinics importing from DaySmart bringing their
customers
and
appointments
information across to Jane.
DaySmart Patient Data
Coming from DaySmart, we’ll need you to upload your patient export with as much detail as possible. You can take a look at the guide from there on
Exporting Your Patient List
to an Excel file.
To Access the Customer Report ⬇️
Click on the
Reports
tab
Click
...
demographic details
as possible
Run the Report and export it as an
Excel
File
NOTE: If you receive an alert message when attempting to run a report with a large amount of data, you may need to limit the date range selected before running the report.
DaySmart Appointment Data
To access the Appointment Report ⬇️
Click on the
Reports
tab
Select the
...
Excel
File
You can also reference this guide from
DaySmart
on
Exporting Your Appointment Report
from their system.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from AppointmentPlus (DaySmart)
Importing from Other Software
Importing from AppointmentPlus (DaySmart)
3 min readHere’s what we know about moving over from DaySmart (Previously known as Orchid - pre, 2022) to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
