...
*Source: [https://jane.app/guide/importing-from-wellnessliving](https://jane.app/guide/importing-from-wellnessliving)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:56:57*
...
Feature OverviewImporting from WellnessLiving
...
.
What can you expect?
We’ve seen clinics easily export their data from WellnessLiving. Below you’ll find step-by-step instructions on how to export your files when you’re feeling ready to make the switch to charting, billing and booking in Jane.
What can we import?
Client List
Appointments
Products
Exporting your Client List from WellnessLiving
To export your
client list
from WellnessLiving, please follow these steps:
Click the
Dashboard
...
Date Range
button
Filter by date range from when you
first started using WellnessLiving
up into the
future
to capture all clients. Click
Apply
Click the
Export
...
Excel
(not PDF, please!)
The Client List file will download to your device, which you can then upload into the
import
in Jane.
Exporting your Appointments from WellnessLiving
To export your
...
or
Excel
Exporting your Products from WellnessLiving
To export your products, please follow these steps:
Click the
Dashboard
icon in the top-left corner
...
or
Excel
Exporting additional information from WellnessLiving
Coming over from WellnessLiving, we’ve frequently seen clinics provide us with just the Client List and Appointments files. But we’ve seen some clinics provide us with CSV/Excel files of
Intake Form responses
, which we’re able to bring in as
chart entries
containing the clients’ responses.
We’ve also seen
SOAP Notes
in PDF but we believe these may need to be exported one-by-one for each patient. Once exported, each file (or the
folder
containing each client’s files), will need to be
labelled accordingly
.
We recommend reaching out
directly to WellnessLiving
to inquire about how to export Intake Form files, SOAP notes, or any other information you’re looking to bring over. Here’s a handy link that outlines how to request support from their team:
Contacting WellnessLiving Support
Uploading Your Data into Jane
You can upload the
CSV/Excel files
directly into the import in your Jane account. You can navigate to the
Schedule an Import
...
that you can follow along with to ensure those are entered into Jane should you need to carry these over.
We’ve leveraged our experience with
various software imports
, along with official guides from other software providers, to create this comprehensive resource for transitioning to Jane. If you have any difficulty downloading your data, it’s best to reach out to your
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from WellnessLiving
Importing from Other Software
Importing from WellnessLiving
5 min read
Balance Plan
