...
*Source: [https://jane.app/guide/importing-from-acusimple](https://jane.app/guide/importing-from-acusimple)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:38:05*
...
Feature OverviewImporting from Acusimple
...
Acupuncture clinic
. We have dedicated staff who can answer any questions that come up along the way to ensure switching over is easy. We’ll work with you to help set up your account and guide you through importing your data, so you can hit the ground running. 🏃‍♀️
...
.
Moving from Acusimple to Jane
Whether you’re thinking about making the move, or have already signed up for your new Jane account, our support and dedicated imports team are available to help every step of the way.
The best part? That’s all
free
with Jane. Even if you’re not practicing with Jane yet, feel free to
reach out to us
and ask any burning questions you have!
What can you expect?
Coming from Acusimple, we’ve successfully brought over
patients
,
...
, and
charts
. Below you’ll find step-by-step instructions for how to easily export your data when you’re feeling ready to make the switch to charting, billing and booking in Jane 💙
What can we import?
Patient List
Appointments
Products
Charts
Exporting your Patients from Acusimple
To export your complete list of patients from Acusimple, please follow these steps:
In Acusimple, click on
Practice Settings
on the left-hand menu (under System Settings)
Navigate to the
System
tab
Under the
...
💡
Helpful Hint:
The steps above will export your
complete list
of patients (both active & inactive). If you are looking to bring over a
specific set
of patients (e.g. only active, or patients seen within the last year, etc.), you can use the
Filter
option under
People
>
Patients
to export a filtered group of patients.
Exporting your Appointments from Acusimple
To export your past & upcoming appointments from Acusimple, please follow these steps:
Click on
Practice Settings
on the left-hand menu (under System Settings)
Navigate to the
...
complete set of appointments
(both past & future), so you’ll want to initiate the export once you’re ready to make the full switch to Jane. If this sounds a bit nerve-wracking, reach out to us and let us know - we may be able to import your patients first, then import your appointments, charts, and products whenever you’re feeling comfortable billing, charting and booking in Jane.
Exporting your Products from Acusimple
To export your list of products from Acusimple, please follow these steps:
Click on
Goods & Services
on the left-hand menu
Click on
Products
On the Products page, click the
cog wheel
⚙️
Select
Download CSV File
...
products.csv
file will download to your device
Exporting your Charts from Acusimple
To initiate the bulk export of your
charting
...
Data Export
section on the right, click the
EHR, Documents & Submissions
button
A notice will pop down that says “✅ You will receive an email with a link to your archive soon.”
Once the export has successfully completed, you will be able to download the
zip file
...
>
Data Export
and clicking the blue link
You can upload the
full zip file
to Jane’s secure upload area when you’ve booked your import.
Acusimple Billing Data
...
into Jane.
Uploading into Jane
To ensure that your data is uploaded to the correct account, and for security reasons,
we do not accept patient data via email.
You can securely upload the files to us in the
Settings
>
Schedule an Import
area.
...
🪡 If you’re not already part of the Jane community, welcome! We’re so glad you found us. If you’re an
Acupuncturist looking for an online booking system
, we think Jane might be the one for you. Take a
virtual tour
,
book a demo
with one of our lovely support staff, or
sign up here
! 💙
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Acusimple
Importing from Other Software
Importing from Acusimple
6 min read
Balance Plan
