...
*Source: [https://jane.app/guide/importing-from-simplepractice](https://jane.app/guide/importing-from-simplepractice)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:53:07*
...
Feature OverviewEMR data migration: How to import data from SimplePractice
...
Practice Plan
Thrive Plan
Hi there! 👋 I’m Shane from the Imports Team. Switching software can feel a bit scary, right? Whether you’re contemplating the move to Jane or have already signed up, we know it can feel like a big task.
But you’re not in this alone. Our team offers unlimited support, so you always have someone to turn to. Reach out by phone, email, or chat and you’ll be connected with a real person who’s ready to help you every step of the way.
Read more about how we make your
switch to Jane
...
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
Four steps to a successful SimplePractice import
When exporting your data from SimplePractice, there are
four key steps
you’ll want to follow to bring over your
complete client demographics
and to minimize
potential delays
in your import. These are outlined in the below steps and include:
Client Details and Client Demographics reports
Data Export per clinician
Appointments report
Attendance report
Please note, while we do our best to import as much data as possible, if we can’t be 100% sure we’re matching the correct client to the correct data,
those records won’t be imported
. If you have any questions or need any help exporting your data, please reach out and we’ll be happy to give you a hand.
🩵
Tailored Support:
We recommend
booking an Account Set-up Consultation call
before going live to review your account and help prepare you for your import. We have a dedicated team of onboarding specialists who would love to talk to you.
Step 1. Exporting your client demographics from SimplePractice
Your client demographics are spread out between your
Client Details and Client Demographics reports
which are found in your
Analytics
tab. These are key to allowing accurate mapping of client information. To export them you’ll want to follow the steps from
SimplePractice’s guide
as outlined below:
In SimplePractice, navigate to
Analytics > Reports
...
Select CSV or Excel
from the dropdown (either is fine)
⚠️ Please make sure to select the
full date range
as well as both
active
and
inactive
patients when exporting the above two reports.
If you’re not on SimplePractice’s Essential or Plus plans, the
Client Demographics report may not be available
to you.
Step 2. Data Export: Charts and basic client information
You can export your
full chart history
(signed and draft charts) which includes basic client demographics by using SimplePractice’s
Data Export
feature. To do so, you can follow the steps from
SimplePractice’s guide
outlined below:
Navigate to
...
Please be sure to
provide the password in a message
in the secure import area of Jane when uploading to
minimize any potential delays
.
Generating your export will take some time, (a few minutes to a few hours depending on how much data you have).
You will receive an email letting you know when this file is ready to download.
After you receive this email, you should return to the Data Export page where you’ll see a link to download the export file to your computer.
🍎
Heads up Mac users:
The Safari web browser may automatically unzip your export upon download. If this is the case, you’ll want to
re-zip the folder before upload
.
Step 3. Exporting appointments from SimplePractice
Currently, SimplePractice only allows you to export
past appointment records
. You’ll want to manually add any future appointments following the import.
To provide us with past historical appointments, you can follow the steps in the
Appointment Status Report guide
from SimplePractice listed below:
In SimplePractice, navigate to
Analytics > Reports
in the left-hand menu
Scroll down to the
...
Click on the
calendar icon
to filter for past appointments from the earliest date up to today’s date to capture the
full range of past appointments
Click the
Export
...
If you have multiple clinic locations, or need to know the status of past appointments (cancellations or no shows), you’ll want to provide us your
Client Attendance Report
:
Click on
Analytics > Reports > Attendance
Click on the date range
and adjust it to cover the desired period
Click
Apply
Ensure that all other filters are set to
“All”
Click
Export > Excel
...
Treatment Names:
Since the Appointment Status Report doesn’t include treatment names,
Clinician Name + Billing Code is used
to  create a placeholder treatment name (e.g. Import - Practitioner Name, Billing Code).
Treatment Duration:
All treatments will be imported with a default
30 minute duration
since no accurate duration information is provided in the Appointment Status Report.
Once your import is complete, there is a simple step to easily
update the past appointments
with the existing treatment name and duration information in Jane.
...
Since status information isn’t present in SimplePractice’s exported data,
all policies are imported as Open
. This policy status can be manually adjusted after the import.
SimplePractice billing data
We recommend
manually inputting your billing data
since, due to formatting issues between the two systems, historical billing information can’t be imported. We have a great guide on
Transitioning Your Clients Credits/Receivables to Jane
that you can follow along with to ensure that’s entered into Jane for you should you need to carry these over.
Secure EMR data migration: Uploading files into Jane
You can upload the .zip file (or files if there are multiple clinicians) as-is into the import along with any report files (Client Details, Appointment Status, etc.) directly into the import. If you
password-protected* your zip file, please remember to include the password in a message
in the secure import area.
You can find an overview of this process here:
Scheduling Your Import
.
Getting Started with Jane: Setup & Ongoing Support 💙
If you’ve made it this far, kudos to you! 👏 I know this was quite a technical guide so don’t hesitate to reach out if anything felt unclear.
If you're not running with Jane yet, feel free to
book a demo
with one of my friendly colleagues — it’s one of the best ways to get any questions answered quickly and to see firsthand if Jane could be the right fit for you and your mental health practice.
Just signed up with Jane and ready to get things set up? We offer a free
Account Setup Consultation
.
This’ll be another shared screen experience where another one of my colleagues will offer suggestions on how you can customize your settings to match your practice style — they can also help you get your import scheduled if you need an extra hand. 🤝
And if you’re considering making the switch, know that Jane has been designed to grow with your practice. We designed our pricing plans with the idea that one billable hour ideally covers your monthly subscription cost. No hidden fees or binding contracts either — we’re all about building a community through trust and transparency. You can find our flexible pricing plans on our
Pricing Page
.
Whether you're still exploring your options or you’ve already decided that Jane's the right fit for you, you have access to
unlimited support
from our team and a community of peers in our
Facebook community group
to seek advice and learn from. Folks are always happy to share their experiences, and you don’t need to be a customer to join, either.
Take care and hope to chat with you soon,
Shane, on behalf of the Imports Team
💡Learn more about our
Balance Plan
, designed to be flexible for cash-based solo practitioners who book up to 20 appointments a month.
We’ve leveraged our experience with
various software imports
, along with official guides from other software providers, to create this comprehensive resource for transitioning to Jane. For questions about downloading your data, we recommend first reaching out to your software provider, as they’re the experts on their system. If you have any further questions or need additional support, please don’t hesitate to contact us – we’re here to help!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)EMR data migration: How to import data from SimplePractice
Importing from Other Software
EMR data migration: How to import data from SimplePractice
11 min read
Balance Plan
Practice Plan
Thrive PlanHi there! 👋 I’m Shane from the Imports Team. Switching software can feel a bit scary, right? Whether you’re contemplating the move to Jane or have already signed up, we know it can feel like a big task.
But you’re not in this alone. Our team offers unlimited support, so you always have someone to turn to. Reach out by phone, email, or chat and you’ll be connected with a real person who’s ready to help you every step of the way.
Read more about how we make your
switch to Jane
as stress-free as possible.
...
We’ve leveraged our experience with
various software imports
, along with official guides from other software providers, to create this comprehensive resource for transitioning to Jane. For questions about downloading your data, we recommend first reaching out to your software provider, as they’re the experts on their system. If you have any further questions or need additional support, please don’t hesitate to contact us – we’re here to help!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/ca031560-aa4a-4f80-ae1a-f05988da5c86)
- ![](https://jane.app/thumbs/73cc412e-4347-4bc8-87c0-ef126c8211d1)
