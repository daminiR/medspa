...
*Source: [https://jane.app/guide/importing-from-owl-practice](https://jane.app/guide/importing-from-owl-practice)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:48:32*
...
Feature OverviewImporting from Owl Practice
...
Thinking about moving from Owl Practice to Jane?
Read more about how we make
switching to Jane
as smooth as possible.
Here at Jane, we have a dedicated import team that can help move your data from Owl into Jane. We’ve completed many imports from Owl successfully, and thousands of others from various software. One of the best parts about it? It’s completely free to you. Everything is included in your regular Jane subscription, including importing your data and our support.
While we can’t access your software to retrieve the data on your behalf, this guide will walk you through how to export as much information as possible to have imported into Jane.
Before you make the jump, if you have questions, feel free to reach out to us and ask about anything that’s on your mind. Our imports team is available to you, even if you’re not a current customer yet. :)
...
Whether it’s your schedule, charting, or our
Free Telehealth Features
, Jane keeps you and your patients completely safe and secure.
Take a look through our
Security and Trust
page to find out how we’re keeping you safe, and what it means to be
SOC 2 Type 1 Certified
.
What can you expect?
What we can help you import into Jane is your
Client List, Past & Upcoming Sessions, Session Notes, and your Non-Session Notes
! The following steps will help guide you in getting this data for us to upload into your new Jane account’s import area.
...
Exporting your Clients and Sessions from Owl Practice
While looking to export your client list and sessions from Owl, you’ll want to select as many options as possible to provide us with detailed reports. Each of these reports provides a selection of options, so you’ll want to ensure that there is either as much information as possible selected, or at least everything you’d like to have brought over to Jane.
The Client list can be exported using the
Client Export
, and the Sessions using the
Session Export
from the Dashboard. You’ll want to ensure these files are either in
Excel or CSV
format.
From what we understand, here are the steps to exporting the
Cient List
in full ⬇️
First ensuring you’re the
owner of the account
and are using a computer, not a mobile device
Then going to your
Dashboard
Next, go to
Data Export
Lastly, click on
Client Export
. You’ll want to ensure you’re in the “Data Export” area and not using the “Client Export” area of the Client’s Profile 💡
Export to
Excel
or
CSV
Format
For your Sessions Report, there should be the option to select a date range, so you can decide whether you want to bring over all Past Sessions as well as Future Sessions, or just your future ones.
Here’s some help documents from Owl’s guide about
Data Export
and
Cancelling your Owl Account and Exporting Info
.
Note: When exporting the
Sessions Report
, please make sure to filter for both
past
and
future sessions
to capture all the required data ☀️
Session Notes from Owl Practice
Owl Practice lets you export Session Notes per individual client. Unfortunately, there’s no way for you to export all Session Notes as a batch for all clients. It may be worth reaching out to Owl to see if they are able to provide that for you.
Once you’ve exported all session notes for each client, you can place all the individual client folders into a single folder. After that,
compress the folder into a zip file
and upload that to your import area. Each folder you download for clients should have their names present.
To export all Session Notes for an individual client, you can:
Head to the
Client Profile
In the left sidebar, click
Client Export
and a pop-up will open
Choose which sections you wish to include, and be sure that
Notes
is selected
Select a
Date Range
Click
Export
Once exported, place each client folder into a single folder and compress the folder into a zip file for upload into Jane
Owl Practice also has a guide on
Exporting Session Notes
you can view should that help.
Non-Session Notes
When exporting your Session Notes, there should also be an option to include
Non-Session Notes
. Should you want to include those, which may be administrative or other notes outside of Sessions, these can be included in the export for each client.
...
Once you’ve opened your new Jane account and have exported your data, you’ll want to schedule your import in the account. To get started, head over to
Settings > Schedule an Import > Begin
.
Here’s a great guide to walk you through doing that as well:
Scheduling Your Import
If you need any further help getting all set up to run with Jane, just
let us know
!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Owl Practice
Importing from Other Software
Importing from Owl Practice
7 min read
Balance Plan
Practice Plan
Thrive PlanDisclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these software to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
Thinking about moving from Owl Practice to Jane?
Read more about how we make
switching to Jane
as smooth as possible.
