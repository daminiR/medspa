...
*Source: [https://jane.app/guide/importing-from-booker](https://jane.app/guide/importing-from-booker)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:38:40*
...
Feature OverviewImporting from Booker
Importing from Other Software
Importing from Booker
2 min read
Here’s what we know about moving over from Booker to Jane.
...
.
Exporting your Customers from Booker
So coming from Booker, we’ll need you to upload your Customer export with as much detail as possible. The Customer List can be exported from the Customers Tab.
Here’s a
help doc from Booker
on how to export this report with as many demographic details as possible.
You will end up with an exported CSV document with all of your Customers which we can import into Jane.
Exporting your Booker Appointments
Here is a
help doc from Booker
on how to export an
Appointments Report
from their system.
Note: Don’t forget to export your future appointments as well as your past appointments.
Booker Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Booker
Importing from Other Software
Importing from Booker
2 min readHere’s what we know about moving over from Booker to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
