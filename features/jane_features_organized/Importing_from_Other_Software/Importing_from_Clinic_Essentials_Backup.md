...
*Source: [https://jane.app/guide/importing-from-clinic-essentials-backup](https://jane.app/guide/importing-from-clinic-essentials-backup)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:40:12*
...
Feature OverviewImporting from Clinic Essentials Backup
Importing from Other Software
Importing from Clinic Essentials Backup
3 min read
Here’s what we know about moving over from Clinic Essentials to Jane.
...
Clinic Essentials data is brought over via backup file.  From the backup we move over patient list, patient profiles, past and future appointments.
Billing Data is unfortunately not stored in a way that is compatible with Jane so invoice and payment information does not transfer.
At this time, we have not been able to successfully import insurance information from Clinic Essentials.
Creating your Backup
After you’re done your day, close down your Clinic Essentials program.
Find your clinic essentials folder on your hard drive. We’ve seen this located in the C drive, and usually called CLINESSE. So, hopefully it will be easy to find. :)
Inside this folder is a folder called data. This is the one we need. Right click on this folder and find the option to create an “archive” or “zip” file, and follow the instructions that show up there. This will create a file called data.zip which should be right next to the data folder in the CLINESSE folder.
Uploading your Backup to Jane
...
Other Notes
Importing from the backup
usually takes 18-24 hours to run.
So be sure to book your import at a time where you have the most down time.
Teleplan
If you are in BC and using Teleplan, we have a help file for
transitioning Teleplan
Setting up your Jane Treatments
When you create treatments in Jane, you only need to create private pay treatments as Jane will work with Insurers separately. You will need to transition your insurance claims manually.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Clinic Essentials Backup
Importing from Other Software
Importing from Clinic Essentials Backup
3 min readHere’s what we know about moving over from Clinic Essentials to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
