...
*Source: [https://jane.app/guide/importing-from-schedulicity](https://jane.app/guide/importing-from-schedulicity)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:52:26*
...
Feature OverviewImporting from Schedulicity
Importing from Other Software
Importing from Schedulicity
4 min read
Here’s what we know about moving over from Schedulicity to Jane.
...
Exporting your Patients from Schedulicity
So coming from Schedulicity, we’ll need you to upload your Client export with as much detail as possible.
The
Complete Client List
report can be found by logging into the Schedulicity website, and going to
My Business > Settings
. From here you can export to
Excel
.
Exporting your Schedulicity Appointments
We have had customers mention that it’s easier to use the
Agenda View
option to retrieve the appointments file as it includes ALL practitioners in the account in a single file instead of individually as outlined below. We can’t confirm this, but if that works, we hope it helps! We’ll still require that file in Excel or CSV for appointments.
You can export your Schedulicity appointments by logging into the Schedulicity website, and go to
My Business > Reports
.  From the settings panel click on
Schedule by Provider/Instructor
, which will bring up the exporter so you can select the staff and date range of appointments to export.
Schedulicity appointment data can only be exported one practitioner at a time, so after downloading all of your practitioner’s schedules you’ll need to compress them into a zip file.  Put all of your staff schedules into a single folder on your computer, right-click the file or folder, select
Send to
, and then select
Compressed (zipped) folder
. A new zipped folder with the same name is created in the same location.
If you have a lot of data some exporters seem to time out, so if that happens just break your appointments up by years (or smaller date ranges if necessary) and export each file separately.  Don’t forget to export your future appointments as well as your past appointments.
Schedulicity Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Schedulicity
Importing from Other Software
Importing from Schedulicity
4 min readHere’s what we know about moving over from Schedulicity to Jane.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
