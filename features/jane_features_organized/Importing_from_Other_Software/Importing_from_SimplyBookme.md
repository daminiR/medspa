...
*Source: [https://jane.app/guide/importing-from-simplybook-me](https://jane.app/guide/importing-from-simplybook-me)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:53:36*
...
Feature OverviewImporting from SimplyBook.me
Importing from Other Software
Importing from SimplyBook.me
2 min read
Here’s some info on moving your data over from SimplyBook.me to Jane.
Exporting your Patients from SimplyBook.me
Simply Book offers a client list report with a number of different data filtering options - we’ll need you to upload your Client export with as much detail as possible.
When you run the report you should see an option near the filters to export to Excel.
Here’s a Help Doc from Simply’s support page on how to
...
.
Exporting your SimplyBook.me Appointments
From the instructions available, you can find the list of all your bookings in
Reports // Detailed report
.  As with the client list, export options can be found near the filters.
Be sure to remember to run the entire date range of appointments (past and future)!
Here’s a Help Doc from Simply’s support page on how to
find your Detailed Appointments report
.
SimplyBook.me Billing Data
We don’t import billing information due to the complex nature and different ways of storing financial data.
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from SimplyBook.me
Importing from Other Software
Importing from SimplyBook.me
2 min readHere’s some info on moving your data over from SimplyBook.me to Jane.
Exporting your Patients from SimplyBook.me
Simply Book offers a client list report with a number of different data filtering options - we’ll need you to upload your Client export with as much detail as possible.
When you run the report you should see an option near the filters to export to Excel.
Here’s a Help Doc from Simply’s support page on how to
