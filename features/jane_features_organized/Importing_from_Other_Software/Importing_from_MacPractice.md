...
*Source: [https://jane.app/guide/importing-from-macpractice](https://jane.app/guide/importing-from-macpractice)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:44:24*
...
Feature OverviewImporting from MacPractice
Importing from Other Software
Importing from MacPractice
4 min read
Here’s what we know about moving over from MacPractice to Jane.
...
.
Exporting your Patients from MacPractice
So coming from MacPractice, we’ll need you to upload your
Patient List
export with as much detail as possible. We have seen this report come to us in
Excel
format which is perfect for importing to Jane. We would recommend reaching out to the
Support Team at MacPractice
for any guidance on how to export these types of reports.
Exporting your MacPractice Appointments
MacPractice appointments can also be exported to
Excel
from what we have seen in the past.  Be sure to export both
past and future
appointments if applicable.
Exporting Charts from MacPractice
MacPractice allows users to batch export DR Images, EDR/EMR Narratives, and Notes to
PDF
from what we have seen in the past.
We have seen practices bring over a full batch export of charts in PDF format - This would include individual PDF files labelled with patient names for all of your clients with a single export.  Jane can then import these files for you.
Images, however, can only be exported from MacPractice one patient at a time from what we have seen.
This means that while Jane can import the Notes and Narrative files, Images need to be moved over manually one at a time.  Many people will choose to do this on an as-needed basis - much as if you were moving from paper charts.  You might want to review the next day and download and upload these as files to the correct Jane Patient profile.  Here’s some more information about how to
add files to a Jane chart
.
Note: As always, we would recommend reaching out to the
Support Team at MacPractice
for any guidance with the Data Export process.
You can also learn more or get a refresher on the best approach for linking chart notes to a specific patient in our
Basics of Importing
guide documents.
MacPractice Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from MacPractice
Importing from Other Software
Importing from MacPractice
4 min readHere’s what we know about moving over from MacPractice to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
