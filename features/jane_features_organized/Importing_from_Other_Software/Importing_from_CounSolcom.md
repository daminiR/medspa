...
*Source: [https://jane.app/guide/importing-from-counsol-com](https://jane.app/guide/importing-from-counsol-com)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:41:04*
...
Feature OverviewImporting from CounSol.com
...
Thinking about moving from CounSol.com to Jane?
Here at Jane, we have a dedicated import team that can help move your data into Jane. We’ve completed many imports from Counsol.com successfully, and thousands of others from various software.
...
Before you make the jump, if you have questions, feel free to reach out to us and ask about anything that’s on your mind. Our imports team is available to help you out, even if you’re not a current customer yet. 🙂
...
.
What can you expect?
When moving over from another software to Jane, the one thing we like to make note of is the fact that we can’t import billing data. This type of data is incredibly complex and does not transfer between software, as each software formats this data differently. It’s best to keep any records you need on hand securely outside of Jane.
...
Exporting your Client List from CounSol.com
To export a list of all your active clients’ demographic information, you can follow these steps:
Select the
Clients
icon.
Scroll to the bottom of the page and click the
Active Clients - List Download Zip/CSV
link.
Select
the fields you would like to include in the export list. You’ll want to select as many as possible to bring over as much demographic data as possible.
Click the
List Download Zip/CSV
button to download the Zip/CSV file to your device.
If you’ve enabled the option in your CounSol.com account to password-protect the Zip/CSV file, you’ll want to include the password in a message in the secure import area in Jane when uploading your files.
CounSol.com has a guide to help with
exporting your Clients List/Info
.
Exporting your Client Records from CounSol.com
Coming from CounSol.com, you’re able to export your Client Records in bulk:
Select the
Clients
...
New Export
button.
Select which areas to export, and filter by status, label, or assigned counselor (for groups).  Then click the
Create Export Job
button.
Once the export has been completed, return to the Export page and click the
Download
link in the Actions column on the right to save the zip file to your device.
You can then upload the zip file directly into the import in Jane!
From the data we’ve seen from CounSol.com, no date information is present for client records in a way we can import them with the specific authored date. Once imported, chart entries have the Created Date of the
date of the import
.
We’re not aware of a way to export your client records in a way we can import them with date information. It may be worth
reaching out to CounSol.com
to see if they are able to do this for you. The date information would need to be present within the
File Name
specifically and not the actual PDF chart entry itself.
CounSol.com also has a guide on
Exporting Client Records
to help with exporting records for multiple clients or for each client individually.
Exporting your Sessions from Counsol.com
We have seen some clinics provide us with an export of their Sessions, although we’re not quite sure how to export that data. You’ll want to
reach out to CounSol.com
to export that information for you.
We can import your Sessions as appointments in Jane from either a
CSV
or
Excel
file format.
Uploading into Jane
To ensure that your data is uploaded to the correct account, and for security reasons, we
do not accept patient data via email
. You can securely upload the files to us in the import area.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from CounSol.com
Importing from Other Software
Importing from CounSol.com
6 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/0a5489c9-4fd2-4b17-bb87-5d7faf56ee12)
