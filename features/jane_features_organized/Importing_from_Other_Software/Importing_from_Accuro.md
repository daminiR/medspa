...
*Source: [https://jane.app/guide/importing-from-accuro](https://jane.app/guide/importing-from-accuro)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:37:44*
...
Feature OverviewImporting from Accuro
Importing from Other Software
Importing from Accuro
3 min read
Here’s what we know about moving over from Accuro to Jane.
...
.
Exporting your Patients or Appointments from Accuro
We require a patient demographic file or past & upcoming appointment history to be provided in Excel or CSV.
At this time, we haven’t seen customers able to export these lists to easily populate patient profiles for appointment history in Jane.
Where we can populate your new Jane account with patient profiles, it’s limited to what we’re able to get from your Chart export from Accuro.
Exporting your Charts from Accuro
Accuro should be able to provide you with a batch export of your charts.
From our experience, you’re able to get a batch export that provides you with a folder per patient of any documents you’ve created for them as well as uploaded files such as images.
Each patient folder will have the Patient Name, Health Number, as well as Date of Birth. This is typically all we’re able to populate the patient profiles in Jane with, as we’re unable to “scrape” any image files or PDFs for the data that is contained on there, such as extra demographic information.
If you’re unsure of how to batch export your charts, we suggest reaching out to Accuro.
If your experience was different than this while getting your information from Accuro, please let us know as it’s valuable information that we can assist customers with in the future. Thank you!
Accuro Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Accuro
Importing from Other Software
Importing from Accuro
3 min readHere’s what we know about moving over from Accuro to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
