...
*Source: [https://jane.app/guide/importing-from-clienttracker-gingko-software](https://jane.app/guide/importing-from-clienttracker-gingko-software)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:40:03*
...
Feature OverviewImporting from ClientTracker (Gingko Software)
...
.
Exporting your Customers from ClientTracker
...
You can see more information from their help guide by
clicking here
.
...
We recommend either individually downloading a patient’s chart and then uploading it as a single upload day by day or systematically over time transitioning your whole database.  Take heart that Jane
does
export charts in a batch if you ever need to cancel your subscription!
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from ClientTracker (Gingko Software)
Importing from Other Software
Importing from ClientTracker (Gingko Software)
4 min readHere’s what we know about moving over from ClientTracker to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
