...
*Source: [https://jane.app/guide/importing-from-innocare-previously-clinic-server](https://jane.app/guide/importing-from-innocare-previously-clinic-server)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:43:32*
...
Feature OverviewImporting from Innocare (Previously Clinic Server)
Importing from Other Software
Importing from Innocare (Previously Clinic Server)
3 min read
Here’s what we know about moving over from Innocare to Jane.
...
.
Exporting your Patients and Appointments from Innocare/Clinic Server
So coming from Innocare/Clinic Server, we’ll need you to upload your patient export with as much detail as possible and all your past and future appointments.  The Patient and Appointment lists can be exported from the Management Tab in your Innocare/Clinic Server account.   Don’t forget to export your future appointments as well as your past appointments by selecting “All Dates” when Exporting the Appointments.
Here’s a
link to their help document
on exporting your client list and appointments.
When exporting from Innocare/Clinic Server you will end up with a .txt file, which we can import from so no need to convert the file.
Innocare/Clinic Server Charts
We have not heard of a batch export of charts from Innocare/Clinic Server.
Sometimes you can export charts individually, so exporting to PDF and then uploading them to Jane one at a time is also an option.
Innocare/Clinic Server Billing Data
We don’t import billing information as there are formatting issues between the two systems.  There is an option to export financial reports - you can also find
...
Other Notes
You might want to print out your Teleplan A/R and your regular A/R to reference.
Teleplan
If you are in BC and using Teleplan, we have a help file for
transitioning Teleplan
Setting up your Jane Treatments
When you create treatments in Jane, you only need to create private pay treatments as Jane will work with Insurers separately. You will need to transition your insurance claims over manually.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Innocare (Previously Clinic Server)
Importing from Other Software
Importing from Innocare (Previously Clinic Server)
3 min readHere’s what we know about moving over from Innocare to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
