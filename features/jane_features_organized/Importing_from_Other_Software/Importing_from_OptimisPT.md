...
*Source: [https://jane.app/guide/importing-from-optimispt](https://jane.app/guide/importing-from-optimispt)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:47:56*
...
Feature OverviewImporting from OptimisPT
...
Let Jane be your helping hand while you’re transitioning your busy
physical therapy
practice. We have dedicated staff who can answer any questions that may come up along the way to ensure switching over is easy. We’ll work with you to help set up your account and guide you through importing your data, so you can hit the ground running. 🏃‍♀️
...
free
with Jane. Even if you’re not practicing with Jane yet, feel free to reach out to us with any burning questions you may have!
What can you expect?
Coming from OptimisPT, we’ve successfully brought over
patients
,
...
Insurers
Charts
Exporting your Patients from OptimisPT
To export your complete list of patients from OptimisPT, please follow these steps:
Click the
Reports icon
📊 on the left-hand menu
From the Reports dropdown, select the
Complete Patient List
report
Keep the dropdown below set to
For Practice
to capture all patients
Check all the
boxes
halfway down (Include Patient Address, Email, Birthdate, Phone, Date Last Seen, Patient Portal) ☑️
Adjust the
Start Date
to
before
you started using OptimisPT
Adjust the
End Date
to today’s date
Click the
...
Once the report runs, up at the top, click the
Download Excel (CSV)
button
A banner will pop up letting you know the file will be delivered to your email
Exporting your Appointments from OptimisPT
To export your past & upcoming appointments from OptimisPT, please follow these steps:
Click the
Reports icon
📊 on the left-hand menu
From the Reports dropdown, select the
Daily Visits by Status
report
Keep the dropdown below set to
For Practice
to capture appointments for the entire practice
Scroll to the bottom and adjust the
Start Date
to the first day of the year (OptimisPT only allows the report to be filtered a year at a time)
Adjust the
End Date
...
💡
Helpful hint:
If you’re looking to export appointments for only one therapist, you can select
For Therapist
from the dropdown and then select their name.
Exporting your Insurance Policies from OptimisPT
To export the insurance policies for your patients, please follow these steps:
Click the
Reports icon
📊 on the left-hand menu
From the Reports dropdown, select the
...
report
Keep the dropdown set to
For Practice
to capture policies for all patients
Keep the dropdown below set to
By Insurance
Select an
Insurance
...
to be the
full date range
you’ve been using OptimisPT
Click the
View Report
button to generate the report
Up at the top, click the
Download Excel (CSV)
button
Repeat steps 5-8
for
...
not
included in the export. If you open up the CSV file, there is only Member ID included, no Group or Plan #s. If required, we recommend
reaching out to OptimisPT
to see if it’s possible to export this information.
Exporting your Insurers from OptimisPT
To export your list of insurers from OptimisPT, please follow these steps:
Click the
Settings cogwheel
⚙️ on the left-hand menu
Click on
Billing
(on the left)
Select the
...
Download Insurances
link on the right
Exporting your Charts from OptimisPT
OptimisPT is able to provide a
batch export
of your charting data upon cancellation of your account. Once the account has been cancelled, the export will be provided within
15 days
according to OptimisPT. We recommend reaching out to OptimisPT for more information on requesting the batch chart export:
Contact OptimisPT
A Recommended Timeline for Transitioning from OptimisPT to Jane
As the chart export takes additional time, we’ve created a handy timeline for navigating the process of exporting your data and making the switch to Jane 💙
Sign up
with Jane
Work through the
setup steps
to the point where all staff are feeling comfortable making the switch to booking, charting, and billing in Jane (our
Jane University
can assist with this)
Once you’re ready,
schedule the import
in your Jane account
When the time comes to export your data, follow the steps above to
export
your Patient List, Appointments, Insurance Policies, and Insurer files from OptimisPT
Upload
the files in your import in Jane. Our team will bring the data in within
48 hours
. Following completion of the import, ALL staff members will begin using Jane from then on
Cancel
your OptimisPT account and request the batch chart export
After 15 days, once you’ve received the batch chart export, you can schedule an
additional import
to bring over your charting. The charts will be imported into the existing patient profiles 🙂
🎁
A gift from us:
When signing up, a
two-week grace period
can be requested in the sign-up notes to assist with the transition phase
Bringing over Referral Information
In case you’d like to bring over referral info (i.e. how your patients heard about your practice), you can follow steps similar to those above to also export the
How Did You Hear About Us
report.
Uploading Your Data into Jane
Thanks for following all those steps to export your data - you’re incredible 🙂
...
>
View Details
to securely upload the patient list, appointments, insurance policies, and insurers
CSV files
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from OptimisPT
Importing from Other Software
Importing from OptimisPT
9 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e19b4338-17ed-45b7-9275-f3a87983851a)
