...
*Source: [https://jane.app/guide/importing-from-chirosoft](https://jane.app/guide/importing-from-chirosoft)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:39:10*
...
Feature OverviewImporting from Chirosoft
Importing from Other Software
Importing from Chirosoft
3 min read
Here’s what we know about exporting your data from Chirosoft.
...
.
Exporting your Patients from Chirosoft
The steps for exporting patient information are as follows:
Navigate to the
Go To
tab.
Select
...
Mail Merge
.
Make sure all activities and products are selected, and all provider boxes are checked.
The next step will show results and the number of clients in the report in the bottom left corner. This will include all active and inactive patients.
Select
Export Results
.
Select
...
Save
file as Excel type.
These steps will work to export patient name, address, email, telephone number(s), and file # information, as well as some pop-up notes and insurance information.
Exporting anything else from Chirosoft
We have seen a few clinics export Charts, Appointments, and Product data from Chirosoft in Excel or CSV format. We recommend
contacting Chirosoft
for more details on exporting these files.
Chirosoft Billing Data
We don’t import billing information into Jane due to its complex nature and different ways of storing financial information. We can show you how to manually
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Chirosoft
Importing from Other Software
Importing from Chirosoft
3 min readHere’s what we know about exporting your data from Chirosoft.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
