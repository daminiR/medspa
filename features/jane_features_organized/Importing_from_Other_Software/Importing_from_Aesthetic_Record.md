...
*Source: [https://jane.app/guide/importing-from-aesthetic-record](https://jane.app/guide/importing-from-aesthetic-record)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:38:14*
...
Feature OverviewImporting from Aesthetic Record
...
Practice Plan
Thrive Plan
Here’s what we know about moving over from Aesthetic Record to Jane.
...
Let Jane be your co-pilot while you’re switching over your busy practice. We have dedicated staff to ensure your migration is an easy one, and to answer your questions every step of the way. We’ll help you set up your account to ensure you’re set for success and guide you while importing your data.
It doesn’t stop there! After you’re settled in, you’ll always have free and continued ongoing support from the Jane team when you need it.
...
.
💡 Keep in mind that various platforms could have specific procedures, differing timeframes, or additional charges related to data exports.
Exporting your Patients
Coming from Aesthetic Record, we’ll need you to upload your patient export with as much detail as possible. You can take a look at the guide from there on
Exporting Your Patient List
to an Excel file.
Click on the
Clients
tab located in the top navigation bar.
You can always click on the
+
button and select all the fields you want to display
Then click on Import/Export.
Next, choose
Export to Excel
. Keep this in mind for future lists that you want to export.
Note: Be sure to click the
+
button and select as many demographics as possible so we’re able to import patient profiles with as much information as we can.
Exporting your Aesthetic Record Appointments
Go to
Appointments
in the top bar of Aesthetic Record
Select the
Date Range
to capture all appointment records you would need for this export
Select the appropriate
Filter By
options that make the most sense here (Booked, Confirmed, Checked In, Cancelled etc). Choose
All
to capture all appointment data
Run
the Report
Select the
Download to Excel
option and voila :)
Aesthetic Record Charts
Aesthetic Record offers you the ability to
Export Patient Procedures and/or Photos
via a patient’s profile.
If you’re able to export these in
*PDF Format
, we should be able to import these to each patient’s profile. Please note, that the PDF file name itself should include identifying information for the patient (patient number, patient name) so that we are able to match that specifically to a patient’s profile in Jane, should the file name not already include that upon export.
It may be worth reaching out to Aesthetic Record to see if they are able to perform this for you in a
Batch Export
so you don’t have to complete this for each individual patient.
Exporting your Inventory
To export your Inventory, head into Inventory > Options > Download CSV or Excel.
Here is a link to Aesthetic Record’s guide on
Exporting Your Inventory
Aesthetic Record Billing Data
We don’t import billing information such as A/R or Credits as there are formatting issues between the two systems, but you’re able to re-create this in Jane following our guide
Transitioning Patient Receivables and Credits to Jane
.
Uploading into Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Aesthetic Record
Importing from Other Software
Importing from Aesthetic Record
5 min read
Balance Plan
Practice Plan
Thrive PlanHere’s what we know about moving over from Aesthetic Record to Jane.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
Jane makes it easy to switch
Let Jane be your co-pilot while you’re switching over your busy practice. We have dedicated staff to ensure your migration is an easy one, and to answer your questions every step of the way. We’ll help you set up your account to ensure you’re set for success and guide you while importing your data.
It doesn’t stop there! After you’re settled in, you’ll always have free and continued ongoing support from the Jane team when you need it.
