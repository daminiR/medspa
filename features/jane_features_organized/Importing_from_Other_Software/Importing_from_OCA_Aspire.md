...
*Source: [https://jane.app/guide/importing-from-oca-aspire](https://jane.app/guide/importing-from-oca-aspire)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:47:23*
...
Feature OverviewImporting from OCA Aspire
...
Exporting your Patients from OCA Aspire
To export your patient list from OCA Aspire, you can follow these steps:
Click
FreshBooks
...
Select
Export Clients
Exporting your Appointments from OCA Aspire
To bring over your appointments, you can follow these steps in OCA Aspire:
Navigate to
Reports
Select the
...
Select a
date range
(Make sure to filter for any
upcoming
appointments as well if you’re looking to bring those over)
Click
Run Report
Select
Export to CSV
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from OCA Aspire
Importing from Other Software
Importing from OCA Aspire
4 min read
Balance Plan
