...
*Source: [https://jane.app/guide/importing-from-healthquest-by-microquest](https://jane.app/guide/importing-from-healthquest-by-microquest)*

*Category: Importing from Other Software*

*Scraped: 2025-08-06 23:43:22*
...
Feature OverviewImporting from Healthquest by Microquest
Importing from Other Software
Importing from Healthquest by Microquest
3 min read
Here’s what we know about moving over from Healthquest to Jane.
...
Exporting your Data from Healthquest
You need to work with Healthquest to get your data for import. At your request they will provide files for your patient list, appointments, chart entries and scanned documents.
Here’s what we’ve seen from other accounts.
· t_client.csv - a list of all patients, employees and physicians in the system
· t_appointment.csv - list of appointments. The client_no field will link to the patient record
· t_chart.csv - all chart notes. Client_no links to the patient
· t_image.csv - all scanned documents/images along with a file path to the image.
Note: When exporting the Appointments Report from Healthquest, from experience, we have seen clinics also upload a
doctor_list.csv
file for the import which can help us identify which staff member belongs to the appointment record itself.
Healthquest Billing Data
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Importing from Healthquest by Microquest
Importing from Other Software
Importing from Healthquest by Microquest
3 min readHere’s what we know about moving over from Healthquest to Jane.
📹 Join us each month for our webinar “Everything You Need to Know About Switching to Jane”. We’ll walk you through the process of moving to Jane and share our top tips so that your import, setup, and onboarding run smoothly.
Sign up or learn more
.
Disclaimer about our import guides: We create our guides through the experiences we have importing from different software, as well as searching for guide documents from these softwares to assist our customers in transitioning over to Jane. If you have any difficulty while retrieving your data, it’s best to reach out directly to your current software provider.
