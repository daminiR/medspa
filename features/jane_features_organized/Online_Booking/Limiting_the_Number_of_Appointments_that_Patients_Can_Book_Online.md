...
*Source: [https://jane.app/guide/limiting-the-number-of-appointments-that-patients-can-book-online](https://jane.app/guide/limiting-the-number-of-appointments-that-patients-can-book-online)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:37:00*
...
Feature OverviewLimiting the Number of Appointments that Patients Can Book Online
Online Booking
Limiting the Number of Appointments that Patients Can Book Online
3 min read
Sometimes, you want to limit the number of appointments that a patient or client can book in advance. You can manage this by working with the upcoming appointments limit.
Working with the upcoming appointments limit
Full access staff members can limit the number of appointments that patients can book online by heading to
Settings > Online Booking
, scrolling to the
Booking, Cancelling, & Relationships
section, and then setting the
upcoming appointments limit
. Remember to save if you make any changes.
The upcoming appointments limit option is a clinic-wide setting.
💡
Jane tip
: the Online Booking Settings page also has other helpful options, including display preferences for contact info, practitioners, and treatments. Check out our guide for more info about different online booking settings options:
Online Booking: Choosing What Is Offered Online (Locations, Staff, Shifts, Treatments, etc.) and Individual Staff Preferences
How does the upcoming appointments limit work with appointments booked by patients or by staff?
The upcoming appointments limit includes
appointments booked administratively
and
appointments booked online
. For example, if you set the limit to ten appointments, if a patient has nine appointments booked by staff members, Jane will only allow the patient to book one more appointment online.
The upcoming appointments limit only applies to appointments that patients book online. You can add more bookings administratively though. For example, if you set the limit to ten appointments and a patient has ten appointments booked, you can still book additional appointments for the patient administratively. In that case, the patient wouldn’t be able to add more bookings online.
You can remove restrictions to the number of appointments that patients can book online at any time by heading to
Settings > Online Booking
, scrolling to the
Booking, Cancelling, & Relationships
section, and setting the Upcoming appointments limit to
No Limit
.
Additional resources:
If you’re looking for more information about online booking settings in Jane, these pages may also be helpful:
Online Booking: Choosing What Is Offered Online (Locations, Staff, Shifts, Treatments, etc.) and Individual Staff Preferences
Turning on Online Booking and Setting up Different Permissions
Setting up Online Booking like a Boss
Staff Access Levels
We hope this helps you manage your online booking! If you have questions, or if you want to chat through settings in Jane, please don’t hesitate to
get in touch
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Limiting the Number of Appointments that Patients Can Book Online
Online Booking
Limiting the Number of Appointments that Patients Can Book Online
3 min readSometimes, you want to limit the number of appointments that a patient or client can book in advance. You can manage this by working with the upcoming appointments limit.
Working with the upcoming appointments limit
Full access staff members can limit the number of appointments that patients can book online by heading to
Settings > Online Booking
, scrolling to the
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![Online Booking Settings page highlighting the Upcoming appointments limit options](https://jane.app/thumbs/53f92779-6207-42b4-b8d9-0c9c7e41cd7d)
