...
*Source: [https://jane.app/guide/self-check-in-for-patients](https://jane.app/guide/self-check-in-for-patients)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:26:19*
...
Feature OverviewSelf Check In (For Patients)
Online Booking
Self Check In (For Patients)
3 min read
Thrive Plan
If your clinic has
enabled the patient self check-in feature
.
Here’s how!
Step 1: Look for the Check-in Signage
First, look for a signage that looks something like this in the waiting area:
Note: If you’re looking around and don’t see a post resembling the image above, your practitioner or clinic may not have this feature set up yet. If you’re unsure, just ask them to confirm! ;)
Step 2: Access the Check-in Page
Simply visit the
URL
posted on the signage or
point your mobile device at the QR code
to begin.
Apple devices:
Open the Camera app and point the device at the code. The device should recognize the code and show a notification that can be clicked on to visit the checkin page. Click
here
for Apple’s support guide on scanning QR codes.
Android devices:
You’ll want “Google Lens Suggestions” enabled on the most updated version of the Camera app. Once that’s on, you should be able to scan the QR code with your camera to access the checkin page via the pop up at the bottom of the screen. For detailed instructions on enabling Google Lens Suggestions, click
here
.
Whether you’ve entered the URL or scanned the code, you’ll be taken to a check-in page:
Step 3: Select your Check-in Option
You have three check-in options.
You can:
Enter a mobile phone number and get a link by SMS
Enter an email address and receive a link by email
Enter your existing online booking login credentials if you are a returning client
If you’ve entered a phone number or email address, you’ll receive a verification text or email shortly.
Open the verification message and
click the Check In button or link
.
Here’s one by text:
If you’ve signed in with your username and password, you can confirm your arrival right away as shown in Step 4.
Step 4: Confirm Your Arrival
In the new window, click
Check In
again:
If you have multiple upcoming appointments, just select the one you’ve arrived for.
And you’re all done. Wahoo, super easy!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Self Check In (For Patients)
Online Booking
Self Check In (For Patients)
3 min read
Thrive PlanIf your clinic has
enabled the patient self check-in feature
.
Here’s how!
Step 1: Look for the Check-in Signage
...
again:
If you have multiple upcoming appointments, just select the one you’ve arrived for.
And you’re all done. Wahoo, super easy!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/c4715e29-83c6-484c-ab78-67420409f04a)
- ![](https://jane.app/thumbs/b2232037-581b-4257-bdd7-d46437310556)
- ![](https://jane.app/thumbs/b7876e45-6f0e-4fdb-80b6-324d89a4b1da)
- ![](https://jane.app/thumbs/320b0bbc-1079-4d76-87b3-6ca5d5106cf7)
- ![](https://jane.app/thumbs/6a9ccf9b-db20-40cb-b5b2-544b3ba46aa6)
- ![](https://jane.app/thumbs/84e52789-9a0a-48d2-9481-f77b122612dc)
