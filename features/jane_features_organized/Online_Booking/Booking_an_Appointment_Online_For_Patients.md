...
*Source: [https://jane.app/guide/booking-an-appointment-online-for-patients](https://jane.app/guide/booking-an-appointment-online-for-patients)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:23:06*
...
Feature OverviewBooking an Appointment Online (For Patients)
Online Booking
Booking an Appointment Online (For Patients)
3 min read
Practice Plan
Thrive Plan
Note: These instructions are for patients who want to book their own appointments. Booking instructions for clinic staff are available
here
.
Jane makes it ridiculously simple for patients to book their own clinic appointments online. With a few clicks of your mouse, you can see which time slots are available and add one or more appointments — in real-time — to your clinic’s schedule.
Let’s walk through the steps together!
First, you’ll want to ensure that you’re logged into your patient profile for the clinic. Once you’ve logged into your Jane account, you can click on the
Book Appointment
button either in the top right corner or on the bottom left, just below the options in the left sidebar menu:
If the clinic you attend has multiple locations, you’ll first want to ensure that you’ve selected the correct one.
Next, you’ll be able to select the
Discipline
from the menu options on the left to help narrow down the treatment type that you’’re looking to book. Alternatively, you can select a specific treatment type under the
Book by Treatment
section or select your practitioner under the
Book by Practitioner
section to get started:
Once you’ve selected one of the above-mentioned options, Jane will display a list of treatments on the left (just in case you’ve selected the wrong one initially) and a calendar displaying all available appointments on the right.
To view available appointment times on a different date, either click on the
Next 7 Days
button or click on the
calendar icon
to the right of the dates to use a date picker.
Here’s what the date picker looks like after you’ve selected it:
Once you find a date and time that work best for you, you’ll want to select the appointment slot. A pop-up will appear, asking if you’d like to book more than one appointment at the same time, or continue on with the single booking.
If you selected the wrong time by mistake, you can also click on the
Whoops, don’t do that!
button to undo the reservation.
And that’s all there is to it, smooth as butter!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Booking an Appointment Online (For Patients)
Online Booking
Booking an Appointment Online (For Patients)
3 min read
Practice Plan
Thrive PlanNote: These instructions are for patients who want to book their own appointments. Booking instructions for clinic staff are available
here
.
Jane makes it ridiculously simple for patients to book their own clinic appointments online. With a few clicks of your mouse, you can see which time slots are available and add one or more appointments — in real-time — to your clinic’s schedule.
Let’s walk through the steps together!
...
Whoops, don’t do that!
button to undo the reservation.
And that’s all there is to it, smooth as butter!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of where to find the book an appointment button in either area](https://jane.app/thumbs/d43c8c0c-2744-437e-ae3d-a916da6aeb58)
- ![screenshot of where to select the location the appointment is at](https://jane.app/thumbs/ee339428-dee3-448b-a726-78341cee650c)
- ![screenshot of where the disciplines appear on the left in addition to where to click to view the treatments and the staff profile pictures](https://jane.app/thumbs/efadb9a3-0cfb-46c9-83d2-ebfe51f3c13f)
- ![screenshot of where the treatment list on the left appears and the calendar for available treatments appears on the right](https://jane.app/thumbs/15babed1-84f1-4e58-8bce-0e571bcd2ec2)
- ![screenshot of where to view either of the mentioned buttons](https://jane.app/thumbs/c869d929-58d1-4ccd-8a2c-fe884b1fceb2)
- ![screenshot of what the date picker looks like](https://jane.app/thumbs/2dcc4585-36c5-45ec-ac49-0ed5083ac54e)
- ![screenshot of the pop up message with the booking options](https://jane.app/thumbs/dd3688b2-170d-490e-831f-3092845f25ce)
