...
*Source: [https://jane.app/guide/working-with-patients-in-different-timezones-hub](https://jane.app/guide/working-with-patients-in-different-timezones-hub)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:37:14*
...
Feature OverviewWorking with Patients in Different Timezones Hub
Online Booking
Working with Patients in Different Timezones Hub
3 min read
Practice Plan
Thrive Plan
Legacy Plans
With more and more clinics offering virtual services, we’ve compiled a hub with all our recommendations when it comes to working with clients in different time zones.
All set? Let’s dive right in and check ‘em out!
Adding a Location
comes in handy if you wanted to create some visual separation between staff located in different locations.
We have gathered a list of features and suggestions in our
Working with Patients in Different Timezones
guide that will help with patient booking and communication for those patients based in a different timezone to your clinic.
Add a disclaimer or add a welcome note to your online booking site using the
...
based on whether they’re in-person or online helps create a smoother booking experience so patients know what to expect.
Discover how to efficiently manage and categorize your treatments, offerings, and modalities by organizing through
Disciplines
.
For all the details on setting up pricing based on location and gift card load limits, we’ve got a guide on
Setting up Your Billing Settings
.
Breeze through
Setting Up Taxes in Jane
while still ensuring that you meet the tax requirements of your discipline and jurisdiction.
Privacy and Security is always top of mind at Jane, and with our
Security and Trust
page, you can learn more about what we’re doing, and what you can do to keep your data safe.
Cover patient Medical History with
Intake Forms
and
Intake Forms FAQ
. Need to collect pre-treatment consent? Check out our
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Working with Patients in Different Timezones Hub
Online Booking
Working with Patients in Different Timezones Hub
3 min read
Practice Plan
Thrive Plan
Legacy PlansWith more and more clinics offering virtual services, we’ve compiled a hub with all our recommendations when it comes to working with clients in different time zones.
All set? Let’s dive right in and check ‘em out!
Adding a Location
comes in handy if you wanted to create some visual separation between staff located in different locations.
We have gathered a list of features and suggestions in our
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of where to view the sign up for the newsletter on the Jane website](https://jane.app/thumbs/002d2402-d088-4b6d-8b72-c957aec1d0ad)
