...
*Source: [https://jane.app/guide/online-booking-pre-payments](https://jane.app/guide/online-booking-pre-payments)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:27:37*
...
Feature OverviewOnline Booking Pre-Payments
Online Booking
Online Booking Pre-Payments
9 min read
Practice Plan
...
Jane Payments
users. If you’re not signed up yet, you can learn more about
Jane Payments
and
get all set up
when you’re ready!
...
To do so, head to that
Patient Profile > Edit / Settings
and scroll down to the
Online Booking Payment Policy
. Simply use the
drop down menu
to select their Payment Policy then
Save
and you’re good to go.
For example, you can select
No payment required
to exempt the patient from entering a credit card at the time of booking, or choose a payment policy to require a credit card from a specific patient even if there’s no clinic-wide policy in place. This allows you to tailor the booking experience based on individual patient needs.
...
Balance Remaining
= Total Credit (Intended Credit + Available Credit)
Available to Apply
= Available Credit (appears when there is available credit)
Note
: If the No-show button is selected the pending amount is removed and resides in credit. If you would like to use that payment to apply it towards the no-show, you can do so using the receive payment button.
Payment Policy FAQs
...
Why are patients being charged a pre-payment when the policy is only for First Visits?
⭐️Can I collect different deposits for unique treatments, staff members, or disciplines?
...
We do have a feature request for this and we would love to hear from you! You can upvote this feature request and add your feedback here:
Payment policies (pre-payment, deposits) by Treatment/Class, Location, or Practitioner
⭐️Can I collect pre-payment deposits if I book the appointment administratively?
Pre-payment deposits can only be captured if the patient is booking themselves online. If you book the appointment on the admin and require partial payment, you can mark the appointment as Arrived ahead of time and collect a partial payment. Visit our guide to learn how to accept a partial payment:
Partially Pay an Invoice
.
Wondering how to handle pre-payments administratively from clients without an invoice? We’ve got just the guide:
Taking an Administrative Pre-Payment
.
⭐️Will the Online Booking Pre-Payment policy be prompted for a $0 treatment?
Yes,
but there are certain conditions to keep in mind. If the policy requires a credit card on file to complete the booking, then Jane prompts patients to add a card even when the treatment is $0. However, if the policy requires a deposit, the patient does not receive a prompt to pay for the treatment upfront.
⭐️Why was a client able to by-pass my Online Booking Pre-Payment policy?
If you’re noticing that a deposit was collected, this could happen for two main reasons:
If the treatment is set to $0, no deposit will be collected.
The Jane Payments account is assigned to one staff member, and the appointment is booked under a different staff.
Multi-location Clinics
: Ensure Jane Payments is enabled at all the applicable locations for the Jane Payments account.
To view and update the location settings for a Jane Payments account, head over to the
Settings
tab, click on
Jane Payments
in the left sidebar menu, and then on the
pencil icon
to the right.
You’ll want to set the staff-assigned dropdown to
All Staff
for the online booking payment policy to apply universally for all their providers.
Lastly, you’ll want to make sure to assign the
Location
checkboxes to the locations where the online booking policy should be enabled for. Make sure to hit the blue
Save Details
button at the bottom of the page to confirm those changes and you’re all set!
⭐️How can I Refund a Pre-Payment?
To start, you’ll want to ensure that the payment is removed from the visit by clicking on the red
Remove
text.
Jane will give you a heads-up that this action cannot be undone, confirming if you’d still like to proceed.
Next, you’ll see a
Refund
button. To complete this process, make sure to select the first option from the dropdown to return the funds to their original payment method.
For more information on how refunds work, check out our guide doc on
Refunding a Patient Payment
.
⭐️Why are patients being charged a pre-payment when the policy is only for First Visits?
Jane will only count a visit as the ‘first’ after a staff member marks the appointment as
Arrived
. How Jane charges the deposit depends on how the patient books their appointments online as well.
Let’s walk through a couple of scenarios using our
Demo Clinic
.
Demo Clinic
has a first-visit payment policy of $20, but they are not charging deposits on returning clients. Here’s what the settings look like:
Scenario 1
Client A
booked two 60-minute massage appointments with Demo Clinic on Mar 27th, and it’s their first time visiting the clinic. At the time of booking, Jane will collect two deposits (Total: $40) for each of the massage appointments.
Scenario 2
Client B
booked one 60-minute massage appointment with Demo Clinic on Mar 27th. It is their first time visiting the clinic, so Jane will collect one payment of $20 for the deposit.
After their first visit, Client B booked another follow-up appointment online. This time, they won’t be collecting a deposit, as long as the first appointment was marked as Arrived.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Online Booking Pre-Payments
Online Booking
Online Booking Pre-Payments
9 min read
Practice Plan
Thrive PlanThis feature is available for
Jane Payments
users. If you’re not signed up yet, you can learn more about
Jane Payments
and
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/81782391-bc34-4d77-9a23-37eec6b67ab7)
- ![](https://jane.app/thumbs/1712a1bb-633a-4065-8634-ef2f963dac1a)
- ![](https://jane.app/thumbs/42dd9e4b-8b7c-4518-8c99-db77d2f6b1e5)
- ![](https://jane.app/thumbs/ddaa3a86-fe72-469e-a30c-b0187feee049)
- ![](https://jane.app/thumbs/8b3a07ac-f150-46b2-8b09-2e82b1a04068)
- ![](https://jane.app/thumbs/4897a70f-de13-487f-827e-4a42dd234e22)
- ![](https://jane.app/thumbs/f2ec382f-8afd-4111-ac9b-1bdaf6f26c84)
- ![](https://jane.app/thumbs/86720ed2-b0a5-456d-b76d-99a4eabb20de)
- ![](https://jane.app/thumbs/88dde03c-6bca-4e62-a188-515120dc37d2)
- ![](https://jane.app/thumbs/8860b8c9-2bef-4054-8738-ceed32a81a7d)
- ![screenshot of what the settings look like](https://jane.app/thumbs/bbd7b4da-0745-493a-849a-df35d7eaf6e5)
