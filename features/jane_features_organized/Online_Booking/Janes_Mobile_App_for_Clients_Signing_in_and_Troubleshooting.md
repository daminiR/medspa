...
*Source: [https://jane.app/guide/jane-s-mobile-app-for-patients-signing-in-and-troubleshooting](https://jane.app/guide/jane-s-mobile-app-for-patients-signing-in-and-troubleshooting)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:37:51*
...
Feature OverviewJane's Mobile App for Clients: Signing in and Troubleshooting
Patient Profiles
Jane's Mobile App for Clients: Signing in and Troubleshooting
3 min read
...
Looking for a general overview of using the app?
Check out our guide here
.
Are you a practitioner or clinic owner?
Check out our clinic-facing guide here
.
Let’s dive in!
...
If you’ve ended up on the screen below and haven’t yet created an account for the mobile app, click the blue text that reads
Create an account
to set up your mobile app password.
I’ve forgotten my username or password for the app
No worries. You can click the
Forgot password?
link to reset your password for the mobile app.
...
For more details on linking your clinics to the app,
check out our patient guide
.
Is my password for the mobile app the same as my password for one of the clinics I visit?
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane's Mobile App for Clients: Signing in and Troubleshooting
Patient Profiles
Jane's Mobile App for Clients: Signing in and Troubleshooting
3 min readWelcome to our troubleshooting guide for the mobile app. Below you’ll find some frequently asked questions about creating an account and logging into the mobile app.
Looking for a general overview of using the app?
Check out our guide here
.
Are you a practitioner or clinic owner?
...
Is my password for the mobile app the same as my password for one of the clinics I visit?
Good question! Your login for the mobile app is separate from your login info for any of the clinics you visit.
Technically, you can set up your mobile app login using the same password that you use for a clinic, but for security purposes, we’d strongly recommend using a unique password when you create your account for the mobile app.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/49979797-837c-4923-bf06-d47002da58b3)
- ![](https://jane.app/thumbs/add45333-31a7-43c0-b909-6562b24ce114)
- ![](https://jane.app/thumbs/d1d0ffa0-a147-467b-8e75-4e6ab167611f)
