...
*Source: [https://jane.app/guide/mobile-services-hub](https://jane.app/guide/mobile-services-hub)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:32:19*
...
Feature OverviewMobile Services Hub
Online Booking
Mobile Services Hub
3 min read
Balance Plan
Practice Plan
Thrive Plan
Hey there! 👋 Do you offer mobile services and could use some helpful resources on set up and workflows within your Jane account? If so, we’ve collected some of our favourite guides to help you get started.
Check these out!
Adding a Location
- For information on creating a new Location in your account in case you’d like to keep your mobile services schedule separate from other services
How to Hide Your Location from Your Online Booking Site
- For information on how you can hide your address on your Online Booking Site and on financial documents
How to Hide an Address on Financial Documents
- For information on hiding your address and adding a different billing address than your Location’s address.
Billing for Per Unit (Mileage, Botox, Materials Used, Reporting etc.)
- For information on billing clients per unit of mileage
Intake Forms
- For information on creating Intake Forms to collect information such as client addresses and/or creating specific consent forms for in-home services
Tags – Limiting Treatment Availability
- For information on how you can set up your schedule to offer certain services on certain shifts (ie. you only offer mobile services on certain days)
Setting a Post Treatment Reset Time or Break
- For information on how you can add a post treatment time after a session as a buffer between bookings (ie. you’d like to add a 30 minute buffer after all your appointments)
Special Notes
- For information on how you can use Notes within a Patient Profile to keep track of and quickly reference important info pertaining to the patient (ie. buzzer codes, parking information, etc)
Contact to Book
- For information on how you can have your Online Booking Site set to Contact to Book, so you have full administrative control over booking patients but they can still see your general availability
Using Jane on a Smartphone
- For tips and tricks when using Jane on a smartphone for staff members on the go!
Using Jane on a Tablet
- For details on what using Jane on a tablet looks like.
We think these are great guides to get you started but if you have any questions about mobile services which are not covered by the above guides, or if you’d just like to chat with us about your setup, we’re happy to connect with you. Check out our
Contact Us
page.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Mobile Services Hub
Online Booking
Mobile Services Hub
3 min read
Balance Plan
Practice Plan
Thrive PlanHey there! 👋 Do you offer mobile services and could use some helpful resources on set up and workflows within your Jane account? If so, we’ve collected some of our favourite guides to help you get started.
Check these out!
Adding a Location
- For information on creating a new Location in your account in case you’d like to keep your mobile services schedule separate from other services
How to Hide Your Location from Your Online Booking Site
...
We think these are great guides to get you started but if you have any questions about mobile services which are not covered by the above guides, or if you’d just like to chat with us about your setup, we’re happy to connect with you. Check out our
Contact Us
page.Subscribe to our monthly newsletter.Jane Software Inc.
