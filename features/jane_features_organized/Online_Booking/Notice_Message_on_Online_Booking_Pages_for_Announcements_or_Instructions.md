...
*Source: [https://jane.app/guide/notice-message-on-online-booking-pages-for-announcements-or-instructions](https://jane.app/guide/notice-message-on-online-booking-pages-for-announcements-or-instructions)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:28:02*
...
Feature OverviewNotice / Message on Online Booking Pages (for Announcements or Instructions)
Online Booking
Notice / Message on Online Booking Pages (for Announcements or Instructions)
3 min read
Practice Plan
...
We commonly see clinics using this area to communicate the following scenarios:
Clinic hour changes
Not accepting new clients
Accepting new clients!
Vacation alerts
Emergency clinic closure (i.e., due to inclement weather)
Meet our newest practitioner [enter staff name and discipline]
Health and safety protocols
Links to external forms or resources
And really, anything your ♥️ desires.
...
💡
Pro-tip:
you can use your browser’s ‘Find’ feature to help locate things faster!
Mac Users:
Press the
command key
on your keyboard, followed by the
f key
(slightly over-lapping so they’re both held down at the same time for a sec) this will open up your browser “find” feature. Here you can type in a keyword to search the page.
PC/Windows Users:
Press the
ctrl key
on your keyboard, followed by the
...
(slightly over-lapping so they’re both held down at the same time for a sec) this will open up your browser “find” feature. Here you can type in a keyword to search the page.
Formatting Options
You will be given an area to enter the new text for the online notice, and then see a preview of how it looks below.
You can also add in some fancy formatting - check out the cheat sheet
linked here
. You’ll also find the same sheet of formatting options just below the text boxes at the bottom of the section titled,
“View formatting instructions”
.
Increasing text size is another popular formatting option for announcements, which is done by adding hashtags prior to the title. One hashtag is the largest font size, and increasing the hashtags will decrease the size of your font.
Here’s an example:
And just to give you an idea, here are the examples of our font sizes once saved:
This is a really big title.
This title isn’t AS big.
Here’s a title with three hashtags.
Really, you can use these hashtags at the start of any sentence to make it into a title.
A few other popular formatting options are adding:
And here’s what these will look like once saved.
Bullets
Numbered Lists
and
Quotes
You can also drag the bottom right-hand corner of your text box to enlarge it to make it easier while typing and formatting. It’s nice to have that extra real estate.
Lastly, here’s a sneak peek at what it looks like and where it appears as a header on your online booking site:
If you have any questions, we’d love to hear from you. Our email is support@janeapp.com.
Happy formatting :)
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Notice / Message on Online Booking Pages (for Announcements or Instructions)
Online Booking
Notice / Message on Online Booking Pages (for Announcements or Instructions)
3 min read
Practice Plan
Thrive PlanFull access users or account owners are able to post announcements as a header at the top of their online booking page.
We commonly see clinics using this area to communicate the following scenarios:
Clinic hour changes
Not accepting new clients
Accepting new clients!
...
Lastly, here’s a sneak peek at what it looks like and where it appears as a header on your online booking site:
If you have any questions, we’d love to hear from you. Our email is support@janeapp.com.
Happy formatting :)Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/4ac88ca0-aad9-4b6b-88af-d8f54969466f)
- ![](https://jane.app/thumbs/79e1a973-9f65-4dc3-abab-35d0272058f1)
- ![](https://jane.app/thumbs/a94c23dd-a731-466d-abf0-7c31d1eff882)
- ![](https://jane.app/thumbs/bb25b841-4976-45ec-9b90-21b25b4742fc)
- ![](https://jane.app/thumbs/5f2581c0-ea10-4c89-8535-c389ff77db86)
- ![](https://jane.app/thumbs/d3a90faf-dfd1-4890-bd85-435bf1f145b4)
- ![](https://jane.app/thumbs/73926f0e-f3e7-4888-a1fe-0d2f71c790bf)
