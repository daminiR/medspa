...
*Source: [https://jane.app/guide/turning-on-online-booking-and-setting-up-different-permissions](https://jane.app/guide/turning-on-online-booking-and-setting-up-different-permissions)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:25:01*
...
Feature OverviewTurning on Online Booking and Setting up Different Permissions
Online Booking
Turning on Online Booking and Setting up Different Permissions
8 min read
Practice Plan
Thrive Plan
In this guide, we’ll show you how to enable online booking across your clinic and explore various clinic-wide settings. With this setting turned on, Jane will create an online booking site that displays your availability and allows them to book their appointments themselves online. We’ll also discuss various set-up options available for your clinic-wide settings, allowing you to tailor the online booking experience to best suit your practice’s needs.
📍
Online booking is currently only available to clinics on the
Practice
or
Thrive
plans, as well as any clinics on our Legacy plans, the
Base Plan
and
Insurance Plan
. If you’re not seeing the option to enable online booking, you’ll want to check out the type of subscription your plan your on. Here’s a guide on
Managing Your Jane Subscription
that goes over this in more detail.
How to Turn on Online Booking
Verify New Users
...
How to Turn on Online Booking
📍
These settings define your clinic-wide preferences but can be customized for individual patients as needed. To learn more about these options, take a look at our guide on
Online Booking: Choosing what is Offered Online
.
To enable online booking for the clinic, as a
Full Access
user you can head over to the
Settings
tab and then click on
Online Booking
. From there, you can set the online booking policy to
Online Booking Allowed
.
Scrolling down a bit further on the page, you can further customize what is offered online, such as the location, specific discipline, staff member or treatment.
With Online Booking set to allowed, your availability will be displayed and bookable to anyone who heads over to your Jane booking page. Practitioners don’t need to approve the booking they receive in the online booking site, but there is a way to receive a notification of the booking. For more information on staff notifications, you can check out our
Email Notifications
guide.
With Online Booking set to disabled, this requires that the patient or patient signs in before they can access your patient-facing Jane page.
As an alternative, you can choose to screen patients before granting them access to online booking. This option is useful if you prefer to control which patients can book appointments online. For more information on setting up this feature, please refer to our help page about
Only Allowing Approved Online Booking
.
Verify New Users
If you’d like to enable two-step authentication for online booking, which requires patients to enter a mobile verification code or click on an email link, just let us know by sending a message from the
Need Help?
area in the top right corner of your Jane account.
This can be handy if you’ve had trouble with deviant booking, but can also slow down the process for patients booking online.
Online Booking Payment Policy
📍
Please note that the following section is available only for those using
Jane Payments
, our integrated payment processing solution.
Online pre-payments are only available for patients booking appointments through the online booking site. Currently, pre-payments can’t be enabled for appointments booked by staff through the administrative side of your Jane account
For your Online Booking Payment Policy, you have a few options:
Online booking requires full payment
- Have your patients pay in full when booking their treatment
Online booking requires a deposit
- Have your patients pay a deposit/portion of the treatment
Online booking requires a credit card on file
- Store a credit card on file, with no payments taken
No payment requirements for online booking
- No credit card information is collected
When a patient puts a card on file, they will not be able to remove it after booking, since that would be against your clinic’s payment policy!
⚠️
The Online Booking Policies set in Jane are for
all treatments
. You are unable to set Online Booking Payment Policies for specific treatments at this time.
Additionally, you can set a First Visit Payment Policy specifically for a patient’s first visit with your clinic. You can choose to use the same policy as for subsequent appointments or select a different option from the available choices, allowing you to tailor the payment experience for new patients.
Here’s what it looks like if you’re requesting a card on file that will not be charged:
Booking, Cancelling, & Relationships
The “Booking, Cancelling, & Relationships” section allows you to tailor various aspects of your online booking system to better suit your clinic’s needs.
⚠️
Please note these settings are clinic wide settings and can not be customized per practitioner.
Allow Same-Day Booking
: When enabled, this setting allows patients to book appointments online for the same day. If unchecked, only clinic staff can book same-day appointments.
Do Not Allow Booking Within
: This setting determines the minimum advance notice required for online bookings. For example, if set to 24 hours, patients can only book appointments at least 24 hours before the scheduled time.
Show Openings Within Unallowed Period as ‘Contact to Book’
: When enabled, this option displays time slots within the restricted booking period as “Contact to Book,” prompting patients to reach out to the clinic to schedule an appointment.
Allow Cancellations Online
: If enabled, this setting allows patients to cancel or delete their appointments online. If unchecked, patients must contact the clinic directly to cancel.
Late Cancellation Period
: This setting defines the minimum notice period for canceling appointments without being considered a “late cancellation.”
Allow Patients to Add Related Profiles
: When enabled, this option lets patients add related profiles, such as family members, to their account.
Don’t forget to
Save
after editing these settings.
Additional Notes & FAQ
When it comes to setting up your online booking site, several areas and settings on the administrative side of Jane have an impact on what’s displayed for your patients. If you’re noticing that online booking isn’t working the way you hoped, here are the areas that you’ll want to take a look:
Location
Settings
Disciplines
...
Shift
Settings
For all the steps on how to troubleshoot why your availability might not be displayed, you can check out our guide:
Why isn’t my Availability Displaying Online? A Troubleshooting Guide
.
We’re always here to help, so please don’t hesitate to reach out if you have any questions or need more information about these settings. Our support team is just a few clicks away – feel free to use the
Need Help?
option within your Jane account.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Turning on Online Booking and Setting up Different Permissions
Online Booking
Turning on Online Booking and Setting up Different Permissions
8 min read
Practice Plan
Thrive PlanIn this guide, we’ll show you how to enable online booking across your clinic and explore various clinic-wide settings. With this setting turned on, Jane will create an online booking site that displays your availability and allows them to book their appointments themselves online. We’ll also discuss various set-up options available for your clinic-wide settings, allowing you to tailor the online booking experience to best suit your practice’s needs.
📍
Online booking is currently only available to clinics on the
Practice
or
...
We’re always here to help, so please don’t hesitate to reach out if you have any questions or need more information about these settings. Our support team is just a few clicks away – feel free to use the
Need Help?
option within your Jane account.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/43f5cbd5-e483-41d4-8fe5-2d5082d328e0)
- ![](https://jane.app/thumbs/77b6c41e-2ebd-4cc8-83fa-1732641fd6d4)
- ![](https://jane.app/thumbs/e95649ea-927a-473f-acd0-8f07c6565884)
- ![](https://jane.app/system/dragonfly/production/2016/03/02/2ves3agtfj_blob)
- ![](https://jane.app/system/dragonfly/production/2016/03/02/9dyrmcrk5y_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/24/7wqzozx1lg_blob)
- ![](https://jane.app/thumbs/39cb6aff-44d4-4d39-a0a7-3b95237aee4d)
- ![](https://jane.app/thumbs/3cfbc850-c427-4cc1-91cd-be94a93ba707)
