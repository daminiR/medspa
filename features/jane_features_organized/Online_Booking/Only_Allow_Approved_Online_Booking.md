...
*Source: [https://jane.app/guide/only-allow-approved-online-booking](https://jane.app/guide/only-allow-approved-online-booking)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:24:48*
...
Feature OverviewOnly Allow Approved Online Booking
Online Booking
Only Allow Approved Online Booking
4 min read
Practice Plan
...
In some situations, you may want to limit online booking to just your existing clients, meaning only people who are signed in to their Jane account will see your availability. This can be useful for clinics that want to prevent new clients from booking online without reaching out first.
This setting works by hiding your availability from the general public, so only clients who are signed in and have been approved can view and book appointments online.
Online Booking Policy
If we want to only allow specific clients to book in with us (such as the current client base), the first thing we’ll want to do is to set our default Online Booking policy to Online Booking Disabled. This will be the default – meaning that anyone who hasn’t been made an exception to this rule will not be able to book online.
To set the default rule to not allow booking, you can head to
Settings
and pop into the
Online Booking
area. Here, you can set the
Online Booking Policy
to be
Online Booking Disabled
.
From here, you can either set individual profiles to book online or set all current profiles to book online (while still blocking any new profiles).
Opting in specific clients to access Online Booking
If you’d like to set this on a client-by-client basis, you can opt them into Online Booking by heading over to the
Client’s Profile
from the
Client
tab and clicking
...
From there, scroll down to find a setting that grants or denies them access the online booking site.
Opting in all existing clients
If you’d like to opt-in all existing client profiles (while still not allowing new client profiles to book), you can do this from the same area we set our defaults. If you head to the
Online Booking
area of your
Settings
, you’ll see an option to
Set All to Allowed
– this would be all client profiles that exist in your account.
What Patients See
When they get to your Jane site online, they will first be asked to sign in:
Once logged in, if they are approved for online booking, they will see a “Book an Appointment” Button. If they do not have online booking enabled, those buttons just don’t show up.
Note📍:
There will be no mention of online booking if they do not have permission, so your clients will not be aware that online booking is available.
See
this help page
on what gets displayed online.
See
this help page
for other options and restrictions with online booking.
And one more!  Check out
Setting Up Online Booking like a Boss
for more help with fleshing out your online booking site.
Additional Notes
Is there a way to ban a patient/client from booking in appointments?
While there isn’t a direct way to ban a patient (since they’ll have the ability to create another profile) you can
disable their online booking
.
If you suspect a patient is using a Jane booking site maliciously, either by booking a sizeable number of fake appointments, or is using inappropriate language on those bookings, you can reach out to our privacy and security team at security@jane.app.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Only Allow Approved Online Booking
Online Booking
Only Allow Approved Online Booking
4 min read
Practice Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/c06d8be5-8e5f-4115-baa1-9c1331bb4f19)
- ![](https://jane.app/thumbs/c41b91a4-0a56-431e-ad21-72316afd105c)
- ![](https://jane.app/thumbs/7787a463-4dd6-43e5-beec-a85e9f446194)
- ![](https://jane.app/thumbs/ba7e3d0e-a30e-4abc-837f-505c7a397c86)
- ![](https://jane.app/thumbs/d31135aa-9803-4010-93ba-648216b296d1)
