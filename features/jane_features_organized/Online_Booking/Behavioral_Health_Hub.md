...
*Source: [https://jane.app/guide/mental-health-hub](https://jane.app/guide/mental-health-hub)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:31:38*
...
Feature OverviewBehavioral Health Hub
Online Booking
Behavioral Health Hub
11 min read
Welcome to Jane’s hub for all things Behavioral Health!
We created this hub for our behavioral health practitioners so you can find everything you need all in one place. You can refer to this page when setting up your account and reference key behavioral health workflows as you continue using Jane.
...
Ready to kick-start your Jane journey? Book your free Account Setup Consultation Call on our Online Booking Site! It’s a fantastic chance to chat with our support specialists before launching with Jane.  Here’s our handy
Account Setup Guide
with more info!
If you’re a
US Clinic
...
To get your account basics set up, you can follow the handy onboarding checklist in the top left corner of your account. This includes adding your
Clinic Information
,
Disciplines
, and
...
Staff Profiles
, and finally, creating your
Schedule
.
Importing Data?
Our dedicated imports team has got your back!
Schedule your Import
in Jane, and let our experts handle the rest. Wondering if your software is supported? Check our “
Where Can You Import From?
guide. If it’s not listed, don’t fret! Our team will work their magic to find a solution!
Other Set-up Recommendations
Reminders & Notifications
Set up
Email and SMS Reminders for Clients
to avoid missed appointments.
Online Booking Site
Did you know you can customize your Jane online booking site and link it to your current website? This guide on
Branding Your Online Booking Site
will help get you started.
Clinic Sites
For those who don’t have a clinic website, would you like one that’s integrated with your Jane site, super easy to create, and even easier to update for only $59 per month? We’re partnered with Clinic Sites who would love to make all of your website dreams come true. Here’s a link to our guide on all things
Clinic Sites
if you’d like more information.
Jane Payments
Explore
what makes Jane Payments so Special
and some of our
frequently asked questions
.
Prevent lost income from no-shows and late cancellations with an
Online Booking Pre-Payments
policy.
Important Workflows
Need to restrict access to the online booking site to just current clients? Check out our
Only Allow Approved Online Booking
guide for details.
Manage charts for practicum students, interns or staff who haven’t received their full license yet with the
Supervision
feature.
Use
Adjustments
for Sliding Scale pricing
Link client profiles and enable permissions between them using
Jane’s Relationships
Make sure to chart from the Day tab as it is the most efficient workflow. Here is a handy video that gives an overview of the
practitioner’s Day View
Edit invoices for clients who are minors
Learn
How to Hide Your Location from Your Online Booking Site
if you operate a virtual clinic
How to Hide an Address on Financial Documents
, and adding a Virtual billing address to
Locations
You can
Hide Client Information from Financial Emails
if you would prefer clients need to log into their My Accounts to view their financial documents
Jane’s
Group Appointments
feature comes in handy for any in-person group sessions. No double-booking or joint profiles are required! If you’re interested in learning about online appointments for groups, you can click
here
.
Communicate securely with clients through Jane’s HIPAA-compliant
Messaging feature (Beta)
.
Charting
...
Chart Parts
you can choose from
If you’d like to see templates other Jane practitioners have shared, you can check out Jane’s
Chart Template Library
. The best part about this resource is that once you save a template, it is yours to do with as you please!
Check out our webinar:
From Chart to Finish - Tips, tricks tools for mastering charting in Jane
Make sure to chart from the Day tab as it is the most efficient workflow. Here is a handy video that gives an overview of the
practitioner’s Day View
.
Upload
Files
to Client Profiles as a way to store documents and/or share documents with your Clients for safe and secure access.
Intake Forms
...
Intake Forms
guide and video
Intake Form Workshop
Check out Jane’s
Chart Template Library
to see templates uploaded by other practitioners. If you decide to use a template from the library, you can make changes to really make it your own
Collect Credit Card Information
in your intake forms (when using Jane Payments)
For clinics who accept insurance, you can
Collect Insurance Information in Intake Forms
as well!
If you’d like to create a form that is just consents, check out our guides on
Using Intake Forms for Consent to Treat or Update Forms
and
Consent Forms
.
For more information on our intake forms and where the information is stored in Jane, check out our webinar:
Take Back your Treatment Time with Online Intake Forms
Find out more about
Creating & Sending Manual Intake Forms
Surveys
Surveys are a great tool to help gather client feedback and progress in Jane. You can set Surveys to go out automatically before or after their scheduled appointment, or at the time of booking online. You can also set up a survey to send daily, weekly, or monthly to individual clients. Surveys can also be sent manually on the administrative side. Survey questions are added to the chart, much like Intake Forms.
Check out our
Clinical Surveys
overview guide
If you’re interested in scoring Clinical Surveys as a means of tracking client progress, our
Outcome Measure Surveys
guide has you covered
Online Appointments
Did you know you can see clients virtually through Jane’s integrated online appointments? This platform is fully HIPAA, PHIPA, and PIPEDA compliant. Thinking of offering Online Appointments? Check out our
guide on some of the benefits and considerations
.
1:1 Online Appointments
(included in all Jane subscriptions)
Check out these guides to learn
How to Set up Online Appointments
and
How to Book and Start Them
You can see the client experience by clicking this guide on
How to Join Your 1:1 Online Appointment (For Clients)
.
You can also share this guide with your clients before their scheduled session to help them connect with you smoothly.
1:1 Online Appointment Training Resources for Your Clients
Online Appointments for Groups
Jane’s
Online Appointments for Groups
is an optional paid add-on that allows practitioners to see up to 12 related participants in one session. Check out the linked guide for more information on how to enable and start using this feature in your account!
You can also check out
Navigating the ‘My Account’ Client Portal
Your clients can access a secure client portal in Jane called
My Account
. They can set up this account during the Online Booking process or when they receive their Welcome Email.
To view the client experience when navigating the My Account Portal, you can check out this guide:
My Account - Your Patient/Client Portal
.
The Client Experience
If you’re curious about the client experience as a whole, we’ve got a handy
Patient/Client Help Hub
with links to all of our client focused guides for you to check out.
Other Resources
Jane Support
We have a team full of lovely support members who are eager to help with all things Jane! You can reach them at
1-844-310-5263
from
6 AM to 5 PM PST
,
...
.
We also have live chat support from
6 AM to 5 PM PST, Monday - Friday
and you can always send us an email at support@jane.app
Community Facebook Groups
We have a wonderful customer community on Facebook. You can join at the link here:
https://www.facebook.com/groups/janerunsclinics
. Once your request has been approved, you can connect with other Jane clinics and find out how they’re using Jane.
For those US practitioners who bill insurance, we also have a group specifically for billing questions you can find here:
https://www.facebook.com/groups/janeusbilling
Front Desk Magazine
...
It’s a free, print magazine that has a list of 10,500 subscribers (and growing!). If you’d like to check it out, you can access the digital version as well as sign up to receive the next issue by clicking
here
.
Webinars & Workshops
You can view our past and upcoming webinars on
Jane’s Webinars & Events Library
page.
Feature Requests
We regularly review our
Feature Request Page
which is available to our current community. At Jane, our mission is to Help the Helpers
(that’s you!)
Our community is full of engaged members who love sharing their experiences using Jane to run their practice.
Not a Jane user? Subscribe to our newsletter
from our guide
to receive feature updates.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Behavioral Health Hub
Online Booking
Behavioral Health Hub
11 min readWelcome to Jane’s hub for all things Behavioral Health!
We created this hub for our behavioral health practitioners so you can find everything you need all in one place. You can refer to this page when setting up your account and reference key behavioral health workflows as you continue using Jane.
Tips for Getting Started
There’s always a learning curve when starting something new, but we’re here to make this process as smooth and easy as possible! We hope you can give yourself the time you need to learn and adjust to the change. It’ll be worth it, we promise 💙
Account Set Up Consultations & Sign Up
...
Not a Jane user? Subscribe to our newsletter
from our guide
to receive feature updates.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/27cf3210-76ff-47ae-b51f-c1ac23f1c5e8)
