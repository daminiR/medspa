...
*Source: [https://jane.app/guide/adding-book-online-buttons-to-your-website](https://jane.app/guide/adding-book-online-buttons-to-your-website)*

*Category: Online Booking*

*Scraped: 2025-08-07 00:22:52*
...
Feature OverviewAdding "Book Online" Buttons to Your Website
Online Booking
Adding "Book Online" Buttons to Your Website
2 min read
Practice Plan
...
Note:
In order to access Jane’s embed codes you must be logged in having Full Access.
Here’s how to access the HTML embed codes:
Click on “
Settings
”. If you don’t see “Settings” as an option, you are not logged in with sufficient permission.
From Settings, select “
Branding
” from the sidebar on the left.
Scroll down to the section called “
Book Online Buttons
.” You will see a number of embed codes which look like this:
...
Not all website platforms support HTML (
some popular website builders that fall into this category are Wix and Squarespace
) but these website builders will often have their own
Add Button
type options.  You add a button and specify the text that appears, and then add the URL you’d like that button to link to.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adding "Book Online" Buttons to Your Website
Online Booking
Adding "Book Online" Buttons to Your Website
2 min read
Practice Plan
Thrive PlanFor a quick and easy way to link patients to your clinic’s online booking site, Jane provides a number of different “embed codes.” These snippets of code can be copied and pasted into any HTML page, including your clinic’s website, a blog post, or even your LinkedIn profile. The buttons look like this:
Note:
In order to access Jane’s embed codes you must be logged in having Full Access.
Here’s how to access the HTML embed codes:
Click on “
...
In this situation you would ignore the HTML code and use the plain URL link on the lower-right side:
Just choose the section you’d like the link to and copy the URL onto your websites button option.
Now you have all of your clinic’s “Book Online” buttons ready to be added to your website. Use them often!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/2f8dab43-cc65-4711-8caa-3cf50b9b160b)
- ![](https://jane.app/thumbs/41df4e5d-9b6a-493f-9b2e-8c0d280a66ca)
- ![](https://jane.app/thumbs/c48d00a0-130e-4d77-96c1-1c3334b77915)
