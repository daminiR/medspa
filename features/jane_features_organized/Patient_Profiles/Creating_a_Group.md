...
*Source: [https://jane.app/guide/creating-a-group](https://jane.app/guide/creating-a-group)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:29:33*
...
Feature OverviewCreating a Group
Patient Profiles
Creating a Group
3 min read
Balance Plan
...
Psst…
Clients don’t need to be linked by a relationship to be added to a Group. For example, a sports team could be added to a Group without any relationship features enabled for their profiles.
...
Creating a Group
To create a Group, we’ll head to the
client profile
we’d like to start with, and you’ll notice there’s a fancy new
Groups button
under their name:
...
New Group button
on the right:
A window will open where we can
name
this Group:
Important
: The first client you add to your Group will be your Primary Client. You’ll notice that Beatrice is the
Primary Client
because we started the Group from their profile. The Primary Client is the one who’s billed for Group Appointments.
If you’d like to
edit
who the Primary Client is in your Group, you can do this in two ways:
From the appointment panel, which will change the Primary Client
for that appointment only
.
Delete your existing Group, and add the new Primary Client first.
Once we’re happy with our Primary Client, we can add the Secondary Clients:
When we’ve added everyone, we can click the
Create
...
It’s that easy.
For a detailed overview of booking a Group Appointment check out our
Group Appointments guide
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating a Group
Patient Profiles
Creating a Group
3 min read
Balance Plan
Practice Plan
Thrive PlanThe more the merrier! Administratively booking couples, families, and groups just got easier. 👩‍👧‍👦
If you have a group of clients who will be attending multiple sessions together, you can make things faster by adding those clients to a Group.
Psst…
Clients don’t need to be linked by a relationship to be added to a Group. For example, a sports team could be added to a Group without any relationship features enabled for their profiles.
When you’re about to add your clients to their Group Appointment, just search up the name of their Group instead (eg. Clark Family), and Jane will add all the Clarks to the visit. No need to remember how many Clarks there are.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/4ea02e54-fba1-410e-9b95-11eff2c99e11)
- ![](https://jane.app/thumbs/6f15cf07-839c-4788-8aa0-a2cd68231e39)
- ![](https://jane.app/thumbs/19d14f15-f9be-4241-b7e1-8cda45dd3927)
- ![](https://jane.app/thumbs/0f444444-3160-4030-a928-13b84e051d38)
- ![](https://jane.app/thumbs/ab56f736-fdca-4e97-bd69-1b346ae7562a)
