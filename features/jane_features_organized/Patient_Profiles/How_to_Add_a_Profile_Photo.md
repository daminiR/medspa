...
*Source: [https://jane.app/guide/how-to-add-a-profile-photo](https://jane.app/guide/how-to-add-a-profile-photo)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:35:14*
...
Feature OverviewHow to Add a Profile Photo
Staff Profiles
How to Add a Profile Photo
4 min read
Balance Plan
...
How to Add a Staff Profile Photo
Staff can add their own profile photo or a Full Access user can do it on their behalf. First, head to the
Staff Profile
and click
Edit/Settings
or
...
Photo & Bio
.
Here, you’ll see a box that prompts you to either
Drag & Drop to upload
or you can click
Select Photo
, which will allow you to choose a file from your device.
Once you upload a photo, make sure to click
Save
.
How to add a Patient Profile Photo
Staff members aren’t the only ones you can add profile photos for!
To add a profile photo for a patient, head to the
Patient Profile > Edit / Settings
and scroll down to the bottom of the page.
Here you can use a similar
Drag & Drop to upload
option or hit
Select Photo
to choose a file from your device.
Once again, don’t forget to hit
Save
...
You also don’t want your image to be too small, too long, or too tall. The key factor to consider is the
ratio of height to width
. Try for an image size no smaller than 146x190 pixels. Images sized 300x391 pixels work well. And we’ve seen images sized 750x1000 pixels work well also. Many clinics use images 300-750 pixels wide. All of these variations work well in Jane as long as the height is about 25% more than the width.
And no worries!
If you don’t get an image with the exact ratios described above, go ahead and upload what you have. Jane is an expert at making certain adjustments on the backend that in most cases produce a stunning profile image.
Most clinics find this sufficient and get beautiful profile photos uploaded into their online booking rather quickly. As always,
let us know
if you need a hand.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Add a Profile Photo
Staff Profiles
How to Add a Profile Photo
4 min read
Balance Plan
Practice Plan
Thrive PlanAs more and more clients out there request online booking, clinics really want to make their online presence shine. One of the most effective yet simple ways to do that is to add profile photos for each practitioner’s profile in Jane.
The photo will show up on the admin side on the:
active user profile (top right corner of Jane identifying the current person who is logged in)
single-practitioner day sheet
clinic-wide schedule
...
Most clinics find this sufficient and get beautiful profile photos uploaded into their online booking rather quickly. As always,
let us know
if you need a hand.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e3494884-ecad-462f-a589-2ba04252c99c)
- ![](https://jane.app/thumbs/cf700dad-0c21-424b-b9de-270da8df1df4)
- ![](https://jane.app/thumbs/d42a9809-3b18-40a1-b27a-ceeeb7def521)
- ![](https://jane.app/thumbs/1cfd9a8a-032a-4bed-b70a-757cfeefc1ad)
- ![](https://jane.app/thumbs/090a488f-a0b3-446c-8798-cbcb3fdbbf45)
