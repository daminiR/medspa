...
*Source: [https://jane.app/guide/test-patient-client](https://jane.app/guide/test-patient-client)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:30:38*
...
Feature OverviewTest Patient/Client
Patient Profiles
Test Patient/Client
10 min read
Balance Plan
...
Thrive Plan
Legacy Plans
If you want to log in as a patient or client to see what it’s like to book in an appointment or fill out an intake form, you can use your Test Patient profile, Ted Test. You can also use Ted Test to try out admin workflows like creating a chart or booking an appointment.
The nice thing about the Test Patient profile is that you can toggle it on when you want to try out a workflow (and even pretend to be a patient) and then toggle it off when you’re finished. Any associated data you’ve created like charts, payments, and appointments will be archived when the Test Patient is not in use so that they don’t skew your reports or clutter up your schedule. When you want to use the Test Patient profile again, you can toggle it back on and all the data you created will be right where you left it.
Enabling Test Patient profile
Disabling Test Patient profile
Resetting Test Patient profile
...
access or higher can enable the Test Patient profile by heading to
Settings
on the top blue bar of Jane and selecting
Test Patient
...
📣
Jane tip
: While we’re on the subject of test data, just a reminder not to enter any real patient information into Ted Test’s profile.
Disabling Test Patient profile
When you’re finished using it, you can toggle the Test profile off by heading back to
Settings
, selecting
Test Patient
, and then clicking the toggle so it turns grey. All of Ted Test’s data will be archived and will come back when you enable the Test Patient profile again.
Resetting Test Patient profile
Any staff member with
Practitioner / Front Desk
access can give Ted Test a fresh start. You can head over to the
Settings
tab and then click on
Test Patient
within the left sidebar menu.
Next, you’ll want to ensure Ted Test is
toggled on.
From there, you’ll be able to view and click on the
Reset Ted Test
button.
You’ll get a pop-up window as a final confirmation of the reset. All of the test data created using this profile will be
permanently deleted
and there isn’t a way to recover this information once this action is completed.
How to log in as the Test Patient
If you’d like to see what your patients see when they book an appointment with you online, you can log in as Ted Test. It’s an easy way to pretend to be a patient without having an impact on your patient list or financial reporting.
💡
Jane tip
: Before you start, make sure you have your own username and password handy so that you can log back into your staff profile when you’re done.
You’ll start by heading to the Test Patient profile either from the link in
Settings
>
Test Patient
, or by heading to your Patients or Clients tab on the top bar of Jane and searching for Ted Test.
Next, you’ll click
Edit/Settings
along the top bar of the patient profile:
...
⚠️ We strongly recommend you
do not
use your staff profile email address as the email you add to your test patient profile as this may cause you trouble when signing into your staff profile later on.
You can also take a moment to opt the Test Patient profile into any
SMS and email reminders
,
waitlist notifications
, or marketing emails so you can see how those look from the patient’s perspective as well.
...
Explore the “My Account” patient portal
where you can see what it’s like for patients to update their contact info, view their upcoming appointments, and add themselves to your waitlist.
Book an appointment online as a patient. You can also play around with your online booking site
branding
and
set up
when you’re logged back into your staff profile.
💡 A note about the
online booking pre-payments and deposits
: The Test Patient profile can’t use Jane Payments features, so if you require a deposit, a card on file, or payment upfront to book an online appointment, here’s how you can exempt the Test Patient from that policy. ⤵️
You’ll want to head to the Test Patient’s profile and click
Edit/Settings
. Next, scroll down to
...
Save
:
There’s just one more step if you have a
First Visit Payment Policy
, specifically.
While you’re still logged in to your own staff profile, head to the schedule and book the Test Patient an appointment. Next, click the
Arrive
button.
...
You can, but first, you’ll need to delete all payments, appointments, and charts attached to their profile. Read more in our guide on
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Test Patient/Client
Patient Profiles
Test Patient/Client
10 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansIf you want to log in as a patient or client to see what it’s like to book in an appointment or fill out an intake form, you can use your Test Patient profile, Ted Test. You can also use Ted Test to try out admin workflows like creating a chart or booking an appointment.
The nice thing about the Test Patient profile is that you can toggle it on when you want to try out a workflow (and even pretend to be a patient) and then toggle it off when you’re finished. Any associated data you’ve created like charts, payments, and appointments will be archived when the Test Patient is not in use so that they don’t skew your reports or clutter up your schedule. When you want to use the Test Patient profile again, you can toggle it back on and all the data you created will be right where you left it.
Enabling Test Patient profile
Disabling Test Patient profile
Resetting Test Patient profile
...
Yes, it will, in which case you’ll return to your clinic’s login screen and will need to log in as a practitioner to re-enable Ted Test.
Why can’t I change the Test Patient’s name?
We’ve removed the ability to change the Test Patient’s name to keep the profile from getting confused with a real patient.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/53aa3d5a-6af1-484d-96f3-0ac4c31bb43a)
- ![](https://jane.app/thumbs/71674643-3f52-4429-b080-c48f41204fe0)
- ![An image of the navigational steps to view the reset button under the settings tab](https://jane.app/thumbs/b27722ad-203d-4b5f-9344-a7bebab3530c)
- ![An image of the pop-up window and the message about the data being deleted permanently](https://jane.app/thumbs/6fdb91c2-56b5-4e97-8722-5371ea586d55)
- ![](https://jane.app/thumbs/bab087d8-4646-411a-8f05-83b54a61f185)
- ![](https://jane.app/thumbs/9fb70dc0-570c-4979-9862-c389df4d8c56)
- ![](https://jane.app/thumbs/a7efda9a-8402-49ee-8b68-16dc0a8088cb)
- ![](https://jane.app/thumbs/7805ea07-bd54-4fb9-bff8-4b98f9065a87)
- ![](https://jane.app/thumbs/2fb44bac-4cc8-47d0-ad5c-f3c124a226c2)
- ![](https://jane.app/thumbs/e32a1a90-b20b-48a0-8fab-464c3288a988)
- ![](https://jane.app/thumbs/b98ae468-2b00-4307-bc9c-160708b9a93f)
