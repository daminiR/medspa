...
*Source: [https://jane.app/guide/message-log](https://jane.app/guide/message-log)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:22:09*
...
Feature OverviewCommunications Log
Patient Profiles
Communications Log
4 min read
Balance Plan
...
Note
📝:
The Communications Log is not accessible to profiles with the
Practitioner (Limited)
Staff Access Level. Check out our guide doc on
Staff Access Levels
for information on the different permissions in Jane.
The
Communications Log
can be found under your
staff profile
and within
patient profiles
. Here, you’ll see a list of all of the emails and text messages delivered from Jane. You can check out this area to verify what was sent, when it was triggered to go out, and how successful Jane was at delivering that message.
...
Unsent
: Jane has received a prompt to send an email, and is preparing it for delivery.
Sent
: Jane has successfully sent out that email or SMS.
Delivered
: The email was received by the recipient’s inbox.
Opened
: The recipient has opened that email.
Clicked
:
T
he recipient has clicked on a link in that email.
Bad Recipient
: Invalid email address, or email address not found. You can update their email and try again.
Bounced
: A valid email address, but the message was not received by their inbox. Spam filters or an unresponsive domain might cause this.
Complaint
: This patient has marked one of your messages as spam. Jane will no longer communicate with an email that has a complaint on it.
If you or a patient has marked an email as spam by accident, or if you have any concerns about a patient’s messages, you can contact the Jane team at
support@janeapp.com
to get that sorted out for you.
...
Why didn’t my patient or client receive a Wait List notification?: A troubleshooting guide
My patient didn’t receive their Intake Form: A troubleshooting guide
As always, if you have any additional questions or concerns, please don’t hesitate to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Communications Log
Patient Profiles
Communications Log
4 min read
Balance Plan
Practice Plan
Thrive PlanReady to put on your detective hat and dig into the notifications sent to your patients or fellow staff members? You’ve landed on the perfect guide!
Let’s dive into all the different statuses to help you become a Communications log sleuth 🕵️
Note
📝:
The Communications Log is not accessible to profiles with the
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/7a381f1f-5cd6-4afa-ab56-963fa5df05eb)
- ![](https://jane.app/thumbs/f66b7f7d-308c-464c-9f73-7f1771af4471)
