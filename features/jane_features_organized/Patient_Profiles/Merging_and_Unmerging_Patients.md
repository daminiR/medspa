...
*Source: [https://jane.app/guide/merging-and-unmerging-patients](https://jane.app/guide/merging-and-unmerging-patients)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:20:59*
...
Feature OverviewMerging and Unmerging Patients
Patient Profiles
Merging and Unmerging Patients
4 min read
Balance Plan
Practice Plan
Thrive Plan
If you’re a patient with two profiles with a clinic, you’ll want to reach out to your clinic directly. For privacy and security reasons, our Support Team isn’t able to make changes to patient profiles, including merging or unmerging records, as outlined in our
Terms of Use
.
Let’s say your patients have created a duplicate profile on your online booking site. Now you see the patient listed twice (or sometimes three times) when you look up their profile in the Patient list.  No problem – Jane makes it easy to merge duplicate patient profiles with just a few clicks.
Merging Patient Profiles
Un-merging Patient Profiles
Merging Patient Profiles
In the
Patients
tab, search for the patient with a duplicate profile. You’ll see their name listed twice when you search the patient list.
Click the
+
button on each patient to bring up the
Merge
view. You’ll see the + button when you hover your mouse over the patient’s name.
Next, choose the record you want to be the
primary record
. Jane conveniently lets you know the likelihood of the profiles being a match. It’s generally a good idea to select the profile with a username set up so that the patient doesn’t run into trouble when trying to access their
My Account
area.
All conflicting information will be shown in
Notes
once you’ve merged, so don’t worry about losing anything.
Potential Duplicates Report
Another option for merging profiles would be for a staff member with
Administrative / All Billing
access to head over to the
Reports
tab and click on
Potential Duplicates
within the left sidebar menu.
You’ll be able to see a list of all the profiles that have enough similarity to be merged and you can hit the blue
Merge
button with the patient numbers to begin the process:
You’ll still want to ensure that the
Primary Record
is the profile with a username created so the patient doesn’t have issues logging into their profile.
Note
...
. This report may not recognize duplicate profiles if there is a different
Preferred Name
...
To start, a
Full Access
user can head back over to the
Patient’s Profile
, scroll down to the bottom of the page and hit the black
dropdown arrow
beside
Edit.
From here, select
Merge History
to see the previous merges that have taken place for this profile.
On the next page, select the orange
Undo Merge
button to un-merge the profiles and turn the profile back into two.
There you have it! As always, you can
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Merging and Unmerging Patients
Patient Profiles
Merging and Unmerging Patients
4 min read
Balance Plan
Practice Plan
Thrive PlanIf you’re a patient with two profiles with a clinic, you’ll want to reach out to your clinic directly. For privacy and security reasons, our Support Team isn’t able to make changes to patient profiles, including merging or unmerging records, as outlined in our
Terms of Use
.
Let’s say your patients have created a duplicate profile on your online booking site. Now you see the patient listed twice (or sometimes three times) when you look up their profile in the Patient list.  No problem – Jane makes it easy to merge duplicate patient profiles with just a few clicks.
Merging Patient Profiles
...
There you have it! As always, you can
contact our support team
if you have any additional questions 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/851d931b-33c8-4d6a-b870-33e202459444)
- ![](https://jane.app/thumbs/e774aee3-bbf4-49af-979f-361733c947ae)
- ![screenshot of navigational steps to get to the report](https://jane.app/thumbs/377b97ab-2cb1-45c4-a7f2-c53837d1ed3e)
- ![screenshot of profile similarities](https://jane.app/thumbs/10d08d2f-3079-4ab1-a52c-597457869151)
- ![](https://jane.app/thumbs/c00cda20-cbc9-4310-8ae2-1c30f1a14cdd)
- ![](https://jane.app/thumbs/ecc5d788-486e-4ced-a357-c6ccd6e9580b)
