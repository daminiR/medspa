...
*Source: [https://jane.app/guide/transitioning-an-intern-to-a-practitioner](https://jane.app/guide/transitioning-an-intern-to-a-practitioner)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:39:21*
...
Feature OverviewTransitioning an Intern to a Practitioner
Staff Profiles
Transitioning an Intern to a Practitioner
3 min read
Practice Plan
Thrive Plan
So, the time has come for your Intern to spread their wings into a full-fledged Practitioner and you may be wondering “
How do we make this switch in Jane
?”
...
What you will essentially be doing is retiring the Intern profile, and creating a new Practitioner Profile with all applicable I.D. numbers and assigned Disciplines.
To start, head to the
Intern’s Staff Profile
and
deactivate
the existing Intern profile to prevent any confusion between profiles moving forward, and click
Save
in the top right-hand corner of your page.
Now let’s create the
new profile
for the newly credentialed practitioner.
Under the
main Staff tab,
using the
New Staff Member button
- we can set this staff member up with a newly re-vamped profile, complete with:
I.D. numbers
Discipline(s)
Staff Access Level
New username and password
Various I.D. numbers can be added within the area indicated below:
Within their new profile, you can opt this practitioner into their appropriate Discipline by heading back into
Edit/Settings
and
Disciplines
-
...
and set up this practitioner’s
Staff Access Level.
Any commission rates can be set up in this area too!
If you utilize Jane’s Online Booking features, you can set this practitioner upon your Online Booking page in the Online Booking tab of their profile as well.
Last but not least, a “
Welcome Email
” can be sent to this new profile to prompt them to set up a new username & password to login to their new Practitioner Profile:
We’ll pass along some other guides that can help along the way:
Staff Access Levels
Setting up Staff Shifts
Charting Tips & Tricks
Charting Privacy & Changes
We hope this guide makes for a
smooth transition
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Transitioning an Intern to a Practitioner
Staff Profiles
Transitioning an Intern to a Practitioner
3 min read
Practice Plan
Thrive PlanSo, the time has come for your Intern to spread their wings into a full-fledged Practitioner and you may be wondering “
How do we make this switch in Jane
?”
Let me show you how to do this in a way that allows you to retain chart entries authored as an Intern, and sets them up for success as a Practitioner.
What you will essentially be doing is retiring the Intern profile, and creating a new Practitioner Profile with all applicable I.D. numbers and assigned Disciplines.
...
smooth transition
from Intern to Practitioner. 🎉 🎉  🎉
As always, let us know if you have any questions!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/4adeee42-37a7-4a47-a8be-853b6c0b5bfd)
- ![](https://jane.app/thumbs/8522baf6-d1d6-4c6c-96d7-70044b5ced98)
- ![](https://jane.app/thumbs/cd7a0c54-a869-49fe-b00f-80de7c669362)
- ![](https://jane.app/thumbs/e01721a8-816b-4e4d-8ec9-df9bf52418b8)
- ![](https://jane.app/thumbs/de7257ec-425a-4709-aa63-25e1ef716524)
