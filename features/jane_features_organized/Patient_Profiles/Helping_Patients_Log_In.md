...
*Source: [https://jane.app/guide/helping-patients-log-in](https://jane.app/guide/helping-patients-log-in)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:19:32*
...
Feature OverviewHelping Patients Log In
Patient Profiles
Helping Patients Log In
4 min read
Balance Plan
Practice Plan
Thrive Plan
Your patients will need to set up a username and password to access their patient portal called
My Account
. In their My account section, patients can book appointments, join their Online Appointments (telehealth), view/download their receipts, and much more. 
For more on the patient’s My Account page -
click here
.
...
View the
patient’s profile
and check if there is a username on file for them.  They will only have a username if they have previously set up an online booking account.  They might just need a reminder of their username.
...
Sometimes patients end up creating a duplicate profile in the system and, when they log in, they don’t see their appointment history.  If this happens, search for the patient, see if there is a duplicate and, if there is,
...
From account basics to learning how to join an online session, we also have a full list of helpful guides to assist with navigating Jane as a patient:
...
Now when a patient books, the appointment will automatically show up in their calendar.
Do you have a parent who keeps getting logged in as their child, or perhaps they find themselves getting constantly logged into their partner’s account instead of their own? Check out all of our recommendations in our
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Helping Patients Log In
Patient Profiles
Helping Patients Log In
4 min read
Balance Plan
Practice Plan
Thrive PlanYour patients will need to set up a username and password to access their patient portal called
My Account
. In their My account section, patients can book appointments, join their Online Appointments (telehealth), view/download their receipts, and much more. 
For more on the patient’s My Account page -
click here
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2015/12/07/sbutrzdu5_blob)
- ![](https://jane.app/system/dragonfly/production/2015/12/07/81moxdewze_blob)
- ![](https://jane.app/system/dragonfly/production/2015/12/07/8g7vjl6gwm_blob)
- ![](https://jane.app/system/dragonfly/production/2015/12/07/yd889onn5_blob)
- ![](https://jane.app/thumbs/a4cb5541-d8e1-411d-b521-584318016168)
