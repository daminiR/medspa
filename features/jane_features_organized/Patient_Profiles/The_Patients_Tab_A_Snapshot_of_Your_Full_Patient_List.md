...
*Source: [https://jane.app/guide/the-patients-tab-a-snapshot-of-your-full-patient-list](https://jane.app/guide/the-patients-tab-a-snapshot-of-your-full-patient-list)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:32:39*
...
Feature OverviewThe Patients Tab: A Snapshot of Your Full Patient List
Patient Profiles
The Patients Tab: A Snapshot of Your Full Patient List
6 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Have you ever wondered what the Patients tab shows? Or maybe you’re new to Jane and are wondering if this list shows all of your imported patients? There are a couple of areas in Jane to view Patient or Client lists. The Patients tab is a page that shows a snapshot of your full patient list.
Note
📝: The term Patient is customizable, so your account may say something different in the top blue bar, like Clients, Guests, etc. If you’d like to change how you refer to your patients, a
Full Access
staff member or an
Account Owner
can update this in
...
Customizing Jane
(under ‘Terminology’) for more details.
What does the Patients, Clients or Guests tab show?
Patient List
When you click the
Patients, Client or Guests
tab in the blue banner at the top of the page, Jane displays up to 50 active patients who have an appointment in the next 3 days.
If there are less than 50 patients that meet that criteria, Jane will list additional patients at random, based on their patient numbers. This means you might see a patient you haven’t seen for a long time included in the list.
Patient search
You can easily search for patient profiles in various sections of your Jane account, such as when scheduling appointments or processing product sales. The patient search feature functions as a directory, providing quick access to all patients who have created profiles with your clinic.
You can search for patients using any of the following:
First Name
Preferred Name
Last Name
Email
...
Patient Number
Phone Number (Mobile, Work, Home, Fax)
If you’re unsure of what the patient’s profile number is, you can search for their name in the Patient search bar. Once you have their profile opened up, you’ll see their profile number in the top right corner.
For patients with shorter names (i.e. Mo or Al), you’ll want to ensure their profile has another piece of supporting identification to help narrow down the profiles that populate. This can be a phone number or a date of birth.
Note
📝:
For staff members with
Practitioner (Limited)
access to the Jane account, the Patient Search bar and 50 active patients list will only show a list of patients that they have had appointments with themselves or for staff they supervise. To learn more about the different access levels, head over to our
Staff Access Levels
guide for more detailed information.
Adding a new patient:
Along with the main Schedule page, the Patients tab is an easy place to add a new patient. Check out our guide on
Adding a New Patient
for more info about how you can welcome new folks to your clinic.
💡
Jane tip
: Staff members with Practitioner Limited access levels will see a slightly different view of the Patients page without the option to add a new patient since that access level is not able to view or book patients that they haven’t seen before, even if the patient is an existing patient of other practitioners at the clinic. Check out our guide for more info about how different staff access levels can add new patients:
Adding a New Patient
Why are only 50 patients shown in the Patients tab?
Jane loads up to 50 active patients in the Patients tab to help quickly load the list and to help keep searching for an individual patient a speedy task. This can be especially helpful if your account has hundreds or thousands of patients.
Where can the full Patient List be found?
Full Access users and Account Owners can generate a full
Patient List
for the entire clinic by going to
Reports > Patient List
. This report can also be filtered and exported when needed.
Note
📝:
The Patient List Report cannot be filtered based on Treatment Type at the moment.
Additional resources:
If you’re looking for more information for patients in Jane, these pages may also be helpful:
Patients Reports
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)The Patients Tab: A Snapshot of Your Full Patient List
Patient Profiles
The Patients Tab: A Snapshot of Your Full Patient List
6 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansHave you ever wondered what the Patients tab shows? Or maybe you’re new to Jane and are wondering if this list shows all of your imported patients? There are a couple of areas in Jane to view Patient or Client lists. The Patients tab is a page that shows a snapshot of your full patient list.
Note
📝: The term Patient is customizable, so your account may say something different in the top blue bar, like Clients, Guests, etc. If you’d like to change how you refer to your patients, a
Full Access
staff member or an
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of the Patients Page Tab in the blue banner at the top of your Jane page](https://jane.app/thumbs/8732afad-2a3e-4105-aa72-ab5d966d0c0f)
- ![screenshot of the Patients page that shows the Patient Search Bar, Patient List, and the Add a New Patient button](https://jane.app/thumbs/a14f8238-3f21-4a14-bef2-9bac89f61b61)
- ![An image of where to view and find a patient or client's profile number](https://jane.app/thumbs/373d9fc9-8094-46b9-b1a2-aeb3943fd291)
- ![screenshot of the New Patient button on the Patients page, along with the patient list](https://jane.app/thumbs/6eed9343-9a93-46f5-b622-30e905c5d5cf)
- ![screenshot of the Patient List Report](https://jane.app/thumbs/86e10b93-b5c6-4736-8de8-d08d5d677be8)
