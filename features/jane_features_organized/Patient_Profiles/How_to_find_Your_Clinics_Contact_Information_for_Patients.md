...
*Source: [https://jane.app/guide/how-to-find-your-clinic-s-contact-information-for-patients](https://jane.app/guide/how-to-find-your-clinic-s-contact-information-for-patients)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:33:50*
...
Feature OverviewHow to find Your Clinic’s Contact Information (for Patients)
Patient Profiles
How to find Your Clinic’s Contact Information (for Patients)
3 min read
Having trouble logging into your account or need to reschedule an appointment that’s within the cancellation window? Don’t worry; we’ve got you covered!
This guide walks through the various ways to locate your clinic’s contact information so you can get in touch with them directly and sort things out in no time!
Note📝
:
While the Jane team is happy to help troubleshoot general issues, we do not manage patient bookings or profiles for clinics. Patients will need to reach out to the clinic or practitioner for further assistance. Feel free to take a peek at the
Notice to Patients
section in our
Terms of Use
.
Let’s dive in 🤿
Booking Notifications and Appointment Reminders
The easiest place to find your clinic’s contact information is within the email that’s sent out letting you know of your upcoming appointment.
Once you locate and open the email, you’ll want to scroll down to the bottom and view their contact information here:
Pro-tip
💡: You can also reply to that email and it’ll be sent directly to the clinic’s email!
Online Booking Site
Depending on how the clinic is set up, you can also find the contact information listed on the clinic’s online booking site. If you’re not logged into your patient profile, you can find the clinic’s information if you scroll all the way down to the bottom of the page here:
If you’re logged into your account, you’ll want to find the appointment under the
Upcoming Appointments
section and click on the blue text with the location name.
After clicking on the blue text, you’ll be redirected to a page with more details on the location and how to contact the clinic via phone or email.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to find Your Clinic’s Contact Information (for Patients)
Patient Profiles
How to find Your Clinic’s Contact Information (for Patients)
3 min readHaving trouble logging into your account or need to reschedule an appointment that’s within the cancellation window? Don’t worry; we’ve got you covered!
This guide walks through the various ways to locate your clinic’s contact information so you can get in touch with them directly and sort things out in no time!
Note📝
:
While the Jane team is happy to help troubleshoot general issues, we do not manage patient bookings or profiles for clinics. Patients will need to reach out to the clinic or practitioner for further assistance. Feel free to take a peek at the
...
Upcoming Appointments
section and click on the blue text with the location name.
After clicking on the blue text, you’ll be redirected to a page with more details on the location and how to contact the clinic via phone or email.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of where contact information is displayed when a patient scrolls down to the bottom of the notification](https://jane.app/thumbs/c5ac0fa5-38d0-4376-b652-06a720dc721c)
- ![An image of what it looks like to scroll down to the bottom of the page to view the clinic's contact information](https://jane.app/thumbs/952adb25-1e28-4681-b160-db7c18fec8d4)
- ![An image of where to click to view the clinic's location](https://jane.app/thumbs/237005d9-7cae-4bef-ac86-bdf7b0433cdb)
- ![An image of where they can find the clinic's contact information on the new page they're redirected to](https://jane.app/thumbs/9704ab50-4f42-483d-a03c-e6db02d023a9)
