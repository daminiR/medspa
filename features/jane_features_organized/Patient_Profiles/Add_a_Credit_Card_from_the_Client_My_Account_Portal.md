...
*Source: [https://jane.app/guide/add-a-credit-card-from-the-client-my-account-portal](https://jane.app/guide/add-a-credit-card-from-the-client-my-account-portal)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:26:08*
...
Feature OverviewAdd a Credit Card from the Client My Account Portal
Patient Profiles
Add a Credit Card from the Client My Account Portal
2 min read
Balance Plan
...
has enabled
Jane Payments
, patients can add a new credit card on file from their My Account area. This account area can be accessed by logging in from your Jane booking site, or after completing the booking process.
*Note that this option is not available outside of North America at this time.
Once they’ve logged in, patients can navigate to the Credit Cards on File area, followed by the
Add New Card
button.
Click the
Add New Card
button to provide your credit card information. You’ll need to provide:
Credit card number
Expiration date
Security Code
Country
Postal code (Canada) or Zip code (USA)
When you’re all done, click
Save Credit Card
.
And that’s it! If you check the Credit Cards on File area again, you’ll see the card that was added. This card can then be charged by the practitioner before or after an online or in-person treatment.
Patients will be notified to enter a new credit card number if their credit card expires or needs updating.
💡Jane uses PCI-compliant credit card processors to store sensitive credit card data. Read more about how Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Add a Credit Card from the Client My Account Portal
Patient Profiles
Add a Credit Card from the Client My Account Portal
2 min read
Balance Plan
Practice Plan
Thrive PlanIf a clinic in
North America
has enabled
Jane Payments
, patients can add a new credit card on file from their My Account area. This account area can be accessed by logging in from your Jane booking site, or after completing the booking process.
...
Patients will be notified to enter a new credit card number if their credit card expires or needs updating.
💡Jane uses PCI-compliant credit card processors to store sensitive credit card data. Read more about how Jane
keeps your data safeSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/efd18d0c-a77e-4632-b965-6afbc31cf2f9)
- ![](https://jane.app/thumbs/639d24fd-283d-4b35-86d1-143781febeef)
- ![](https://jane.app/thumbs/6c173426-5753-46a8-82da-84fb929d0599)
- ![](https://jane.app/thumbs/769a445a-3357-47b9-a49b-b5e020e086ad)
