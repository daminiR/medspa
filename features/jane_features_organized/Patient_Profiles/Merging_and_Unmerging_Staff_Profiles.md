...
*Source: [https://jane.app/guide/merging-and-unmerging-staff-profiles](https://jane.app/guide/merging-and-unmerging-staff-profiles)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:36:04*
...
Feature OverviewMerging and Unmerging Staff Profiles
Staff Profiles
Merging and Unmerging Staff Profiles
2 min read
Balance Plan
Practice Plan
Thrive Plan
Staff profiles can be merged (and un-merged)the same way as
duplicate patient profiles
.
Merging Staff Profiles
Unmerging Staff Profiles
Merging Staff Profiles
Head to
Staff
and click the
+
sign when you hover your mouse on each staff’s name to bring up the merge function on the centre of the page.
Then, choose the record you want to be the primary record.  It’s a good idea to choose the profile with a username so that the practitioner’s login is maintained.
Unmerging Staff Profiles
Uh-oh! Accidentally merged two staff profiles? Don’t worry; it happens to the best of us. Luckily, there’s a simple solution to get things back on track!
To start, a
Full Access
user can head over to the
Settings
tab, and scroll down within the left sidebar menu and select
Merge History.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Merging and Unmerging Staff Profiles
Staff Profiles
Merging and Unmerging Staff Profiles
2 min read
Balance Plan
Practice Plan
Thrive PlanStaff profiles can be merged (and un-merged)the same way as
duplicate patient profiles
.
Merging Staff Profiles
Unmerging Staff Profiles
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/9b648123-84d0-4b6f-addc-39ad9a8c2a42)
- ![an image of the navigational steps and where to view the button to unmerge the profiles](https://jane.app/thumbs/d81f1bfe-4f90-4a63-89e5-0eb20b0d2622)
