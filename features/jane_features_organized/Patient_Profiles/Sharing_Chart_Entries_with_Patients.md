...
*Source: [https://jane.app/guide/sharing-chart-entries-with-patients](https://jane.app/guide/sharing-chart-entries-with-patients)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:25:28*
...
Feature OverviewSharing Chart Entries with Patients
Patient Profiles
Sharing Chart Entries with Patients
3 min read
Balance Plan
...
Learn more about the Patient Portal by clicking here
Learn how to share a chart entry
The author of the chart can make any chart entry visible to their patient by clicking the
...
If you select
Confirm and Notify
, Jane will give you an option to “add a note” or a custom message so that the patient is notified by email.
Here’s what the email looks like once sent to the client:
The notification will prompt the patient to log into their secure “My Account” area to access the shared document. Once signed in, patients will see a section on their
My Account
page called
Documents.
What is shared?
...
🔥 Hot Tip
If you are sending your client information that you don’t wish to have connected to a specific appointment, you can head to your client’s profile and add a new entry in the
Chart
tab or upload a document in the
File
tab.
Bonus
: If you want to send them a gentle reminder that they have something waiting for them, you can always do so from this area as well.
Additional Notes & Resources
I shared a chart entry with a patient but there are blank sections and parts missing. Why is that?
The
Instruction
chart part isn’t a printable or exportable item in Jane. This means that when charts are shared with this chart part, that portion of the form won’t be displayed.
If you need to show the details in the
Instruction
box to the patient, an option here would be to use the
Note
chart part instead.
Here are some related guides in case you’d like to read more about sharing and sending chart entries:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Sharing Chart Entries with Patients
Patient Profiles
Sharing Chart Entries with Patients
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansThere’s a feature in the charts where you can make chart entries visible to your patients. So long as your patient has an account set up, you can use this to share treatment plans, exercise prescriptions,  lab results, files, or any other chart note.
Learn more about the Patient Portal by clicking here
Learn how to share a chart entry
The author of the chart can make any chart entry visible to their patient by clicking the
Not Visible to Patient
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of where to click on a chart to make it visible to the patient](https://jane.app/thumbs/c8ede0fc-a61d-4252-a86d-ca4a5d418167)
- ![](https://jane.app/thumbs/668760d0-3117-4057-9c3e-eff3387d3b18)
- ![](https://jane.app/thumbs/8211a4c1-5ad4-41f9-8ede-658d06298d9f)
- ![](https://jane.app/thumbs/913d1ee3-4b9f-4c4f-bf6b-5f8ec8f2f6dc)
- ![](https://jane.app/thumbs/d39a8fd5-ecc7-413f-8dcb-5d43b7ae63a7)
- ![](https://jane.app/thumbs/f00529ea-843f-4ce2-aaec-f16385a0b952)
- ![](https://jane.app/thumbs/c65da310-95c9-4e9e-aa40-5917254338e6)
- ![](https://jane.app/thumbs/272afa0b-19a2-4e6d-badf-928b9581f4bc)
