...
*Source: [https://jane.app/guide/updating-the-default-email-account-on-your-device](https://jane.app/guide/updating-the-default-email-account-on-your-device)*

*Category: Patient Profiles*

*Scraped: 2025-08-07 03:28:48*
...
Feature OverviewUpdating the Default Email Account On Your Device
Patient Profiles
Updating the Default Email Account On Your Device
2 min read
Balance Plan
...
If you have a Macbook, here’s how you can update the email account on
Apple Mail
.
If you have a Windows PC, here’s how you can update the email account on Window’s default
Email Application
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Updating the Default Email Account On Your Device
Patient Profiles
Updating the Default Email Account On Your Device
2 min read
Balance Plan
Practice Plan
Thrive PlanWhile using Jane, you can send an email to your patients by clicking on the email address associated with the patient profile. You can find this directly within the patient profile, as well as in the appointment panel on the schedule.
When you click a patient’s email in Jane, this is a mailto link that tells your device (computer, tablet, or smartphone) to open your devices default email application to compose and send an email to that patient.
Your Devices Default Email Application
Many people aren’t familiar with using the default email application on their device because they will often open their web browser and navigate directly to the email service provider of their choice.
For example, Apple devices use the default email application Apple Mail. Apple Mail uses your email address to send emails from your devices. If you were to click on a mailto link (email address) on your Macbook, then your computer would open Apple Mail with the default email account.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/23dd2c81-058b-4d89-8e7b-394d039f1663)
