...
*Source: [https://jane.app/guide/my-patient-or-client-didn-t-get-their-email-reminder-a-troubleshooting-guide](https://jane.app/guide/my-patient-or-client-didn-t-get-their-email-reminder-a-troubleshooting-guide)*

*Category: Troubleshooting*

*Scraped: 2025-08-07 05:02:01*
...
Feature OverviewMy Patient or Client Didn’t Get Their Email Reminder: A Troubleshooting Guide
Troubleshooting
My Patient or Client Didn’t Get Their Email Reminder: A Troubleshooting Guide
3 min read
Balance Plan
...
, and or the
History & Status
section on the appointment panel.
If they
are
opted in, there’s a couple of ways to look into communication with a patient.
First of all you are able view the email/electronic communication log with patients in the “Communications” tab in their profile, you will be able to see whether the receipt was sent/delivered. This is also a helpful tool to see whether an email/text reminder was sent for an appointment in the event of a no-show.
Here’s our Guide doc on the
Communications log
, for further information on what those other statuses (delivered, sent, opened, bad_recipient, etc)
...
With a Full Access account, head to
Settings > Reminders & Notifications
and make sure that the primary switch is on, or if you’re looking at the reminders– make sure the reminder is enabled.
Still need help?
...
Just click the
Need Help?
button in the top-right of your Jane screen to reach out to our team—we’re happy to help! 😊
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)My Patient or Client Didn’t Get Their Email Reminder: A Troubleshooting Guide
Troubleshooting
My Patient or Client Didn’t Get Their Email Reminder: A Troubleshooting Guide
3 min read
Balance Plan
Practice Plan
Thrive PlanPatient or Client mentioned that they didn’t get their reminder? Here’s how to look into this!
1️⃣Check to see if they are opted in.
You will just want to check and make sure that they are opted in on their profile. If not, you can click the pencil, scroll down and opt them in. I’ve demonstrated how to check and how to opt them in, in the GIF below:
2️⃣Check their
Communications log
...
Just click the
Need Help?
button in the top-right of your Jane screen to reach out to our team—we’re happy to help! 😊Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/df276895-c289-4798-abf0-d657a36176b9)
- ![](https://jane.app/thumbs/d9d5e68b-eb6e-44c2-8ea1-dcfa6d296c46)
- ![](https://jane.app/thumbs/46c99333-b601-4458-9e29-36269fd0746d)
- ![](https://jane.app/thumbs/fcbe6f33-2a2c-4272-abd7-52cac00ef50c)
