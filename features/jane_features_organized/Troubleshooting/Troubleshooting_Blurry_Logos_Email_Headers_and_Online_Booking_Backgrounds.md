...
*Source: [https://jane.app/guide/troubleshooting-blurry-logos-email-headers-and-online-booking-backgrounds](https://jane.app/guide/troubleshooting-blurry-logos-email-headers-and-online-booking-backgrounds)*

*Category: Troubleshooting*

*Scraped: 2025-08-07 05:00:30*
...
Feature OverviewTroubleshooting Blurry Logos, Email Headers and Online Booking Backgrounds
Troubleshooting
Troubleshooting Blurry Logos, Email Headers and Online Booking Backgrounds
8 min read
Balance Plan
...
600 pixels in width
and between
70-150 pixels in height
. The file size should also be no more than
1MB
.
For the
Online Booking Background
, you’ll want to make sure to use a
JPG file
that is at least
1200 pixels
by
1200 pixels
and the file size should be no more than
5MB
.
For logos, you’ll want to ensure that the image is
horizontal
on a
...
Checking Image Dimensions using Preview on a Mac
Let’s start by heading over to where you’ve saved the image and
...
Preview
.
Next, you’ll open the Inspector tool by clicking on
Tools
on the top of the screen and then on
Show Inspector
.
Alternatively, you can use the
Command + I
shortcut using your keyboard to open the Inspector.
To view the image’s dimensions, click the
i
button at the top of the inspect window. If the image’s dimensions are listed, you’ll see the
Pixel (px) Height
and
Pixel Width
listed.
Checking Image Dimensions using File Explorer on a Windows Device
For those using a Windows device, you’ll want to
right-click
on the image file and select
Properties
from the
dropdown menu
options.
In the Properties window, you’ll want to click on the
Details
tab. Within the Image section, you’ll see the
Dimensions
(width and height) of the image.
The Size of the image (in bytes, kilobytes, or megabytes) is also displayed at the top of the
General
tab.
Resizing an Image on Mac
Once you’ve opened up the image using
Preview
, click
Tools
and select
Adjust Size
.
A smaller window will pop up, and it will show the
Width
,
Height
, and
Resolution
of the image. To change the size of the image, you’ll first want to ensure that the
Fit into
field is set to
Custom
.
Next, let’s make sure the units are changed to
pixels
for the Width and Height. Now we can  set the
Width to 600 pixels
.
Toggle on the
Scale proportionally
box so the height adjusts automatically before clicking the blue
OK
button to confirm those changes. For some devices, this setting might already be toggled on automatically.
To save the image, click on
File
just above the open window and select
Save
(or
Save As
if you’d like to keep the original size of the image) from the
dropdown menu.
Resizing an Image on a Windows Device
For those using a Windows device, you’ll want to start by
right-clicking
on the image file, selecting
Open with
from the dropdown options and clicking on
Paint
.
Once your image is open in Paint, go to the
Home
tab in the top menu. In the
Image
...
On some Windows devices, this will display as
Horizontal
and
Vertical
. In this case,
horizontal
would be the width of the image.
After selecting the desired size, click
Save
or
Save As
(so you don’t lose the original image) to confirm those changes.
Additional Notes & Resources
...
Clearing the cache
can fix this if Jane actually uploaded the image properly.
If you’re unable to use the applications within your device to resize the image, there are online tools that can help!
Fotor
ResizeImage.net
For more information about customizing your Jane emails and online booking site, check out our guides on
Branding Your Online Booking Page
and
Customizing Your Online Booking Background
guides.
As always, if you have any additional questions or concerns, please feel free to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Troubleshooting Blurry Logos, Email Headers and Online Booking Backgrounds
Troubleshooting
Troubleshooting Blurry Logos, Email Headers and Online Booking Backgrounds
8 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansBlurry images can be frustrating, but don’t worry—there’s usually a reason behind the blur, and more importantly, a fix!
Before we jump into the specifics, here’s a general overview of the size recommendations:
The
Email Header
should be no more than
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps and what the dropdown menu should look like once you right click on the image](https://jane.app/thumbs/b990e52f-6237-481f-b184-ae855eb9060c)
- ![An image of where to view and find tools within an apple devices menu and then selecting show inspector from the dropdown menu options](https://jane.app/thumbs/76d8bdba-4aaa-4147-afee-239c9b8988a1)
- ![An image of what the pop up window looks like and where to view the image dimension details](https://jane.app/thumbs/0754429b-87dd-44f4-a070-3bbad0e0c5fd)
- ![An image of what the dropdown menu looks like once you right click on the image](https://jane.app/thumbs/4cfe01e7-3819-492d-bccb-2dbc0a59a21b)
- ![An image of what the pop-up window looks like and where to view the dimensions within the details section](https://jane.app/thumbs/3e65c03e-770b-49ac-9aab-4408786eea42)
- ![An image of what the menu looks like once tools is clicked](https://jane.app/thumbs/802f993f-0fc6-49a5-8f3b-1b7e61f291d0)
- ![An image of the navigational steps and where to enter the pixel dimensions for the image](https://jane.app/thumbs/28e4006c-1ac6-48f5-afba-323da4af532e)
- ![An image of the navigational steps and where to select Save within the dropdown menu options](https://jane.app/thumbs/36f2ec9f-743d-4b0a-89de-89e325d8262a)
- ![An image of the navigational steps and how to access the resize option within paint](https://jane.app/thumbs/1d047f0b-ad84-4c8c-b146-a0980e4df991)
- ![An image of what the resize window looks like and where the option to edit the pixels is](https://jane.app/thumbs/ef550c87-03b6-44b6-9b38-8bad75efaaeb)
