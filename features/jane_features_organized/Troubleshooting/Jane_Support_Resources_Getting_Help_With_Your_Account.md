...
*Source: [https://jane.app/guide/jane-support-resources-getting-help-with-your-account](https://jane.app/guide/jane-support-resources-getting-help-with-your-account)*

*Category: Troubleshooting*

*Scraped: 2025-08-07 05:01:32*
...
Feature OverviewJane Support & Resources: Getting Help With Your Account
Troubleshooting
Jane Support & Resources: Getting Help With Your Account
7 min read
Balance Plan
Practice Plan
Thrive Plan
Is that a burning question we smell? Then you’ve come to the right place! Here are the ways that you can get the answers you need when you need them:
💙
Get in touch
-
We really do love talking to you
💻
Self-serve learning
-
Chances are, we’ve got a guide for that
Note
📝:
For our support team to access your Jane account directly, please make sure that you have an
active
,
named
profile within the Jane account. For more details on this, you can check out our guide on
Receiving Support Securely
and our
Terms of Use
.
Getting in touch with the Jane team
☎️ Call Now
📆Schedule a Call
💭Chat
📧Email
☎️ Give us a ring
Sometimes, it’s just nice to talk to a real human. Our Support Team is ready to answer your call and we’re proud to share our phone wait times are usually only a couple of minutes!
During the summer months of
July and August
, our regular hours will change slightly on
Fridays
only - we will be available from
6 am - 1:30 pm PT.
🇨🇦🇺🇸
US/Canada
...
+1 604-670-JANE (5263)
📆 Schedule a call
We’re happy to offer two different scheduled call types which you can book at a time that works best for you.
We offer
Demos
for anyone thinking about starting with Jane, and
Account Setup Consultation Calls
for our newcomers who want to set aside some time to walk through their setup with our team.
If you don’t see your country down below, feel free to choose whichever has the timezone closest to you. Just a heads up, we do schedule all our calls in
Pacific Time
to make sure we never get mixed up and miss you!
If you’re a Canadian Clinic 🇨🇦
book here
If you’re a US Clinic 🇺🇸,
book here
If you’re a UK/Europe Clinic 🇬🇧🇪🇺 looking for a demo,
book here
and for an Account Setup Consultation,
book here
💭 Chat us up
We offer
live chat
for our users in Canada, the U.S., Central and South America.
From your account, you can use the
Need Help?
button in the top right corner to see if one of our team members is available to chat with you. If you’re not a Jane user yet, you can chat with us right from the bottom right-hand corner of this website!
📧 Drop us a line
Ah, trusty old email. This is a great option if you’d like to fire off a question and come back to a step-by-step, personalized response that you can refer back to whenever you need it.
From your account, you can use the
Need Help?
button to send us a message or email us at
support@jane.app
.
❗
A note on privacy:
we ask that you don’t send us any identifying patient information (ex. name or contact info) via email. If you need our team to dig into something specific within a patient profile, you can send us a link or even just patient # and initials.
For Addison here, you could send us the link to the profile (see above
☝️)
or something like, “Patient #25, A.A.” using the Patient # on the right.
If you need to send us a
screenshot
of your account to help us understand what’s going on, please be sure to enable
Privacy Mode
(shift + P) to blur out your patient details.
Self-Serve Learning with Jane
All of these materials can be accessed within the
Jane Guide
which, if you’re reading this, you’ve already found! A+ 🤓
You can
Search the Guide
from within your Jane account using the
Need Help?
button in the top right corner or click the blue
browse the guide
lettering to open it up in another tab. Sometimes, we’ve found it’s even helpful to Google your question and add Jane App to the search (ex. ‘patient didn’t receive reminder jane app’). Google’s algorithm is so powerful, sometimes it can find guides that our own search function misses. 🙈
Jane Sidekick
The Jane Guide has a new AI assistant to help you find the answers you need, fast. Ask a question and your AI sidekick will search through all of our guide docs for you and share a detailed answer right within your account. To access your AI assistant, just click on
Need Help?
near the top right-hand side of your account.
Quick Start
These guides are a mix of written and video tutorials that will help get you
up and running with Jane!
Jane University
Looking for specific training resources for yourself or your new staff?
👉Click here for our
Front Desk Training Program
👉Click here for our
Practitioner Training Program
We do not recommend practicing in your own account
since it can create data that is hard to delete and causes confusion in your reports later on. We have a
Demo Clinic
that you can play around in without worrying about making a mess. If you’re a current Jane user, you can find the login information by clicking the
Need Help?
Button in your account. This password is updated every Monday. You can also join our
Community group on Facebook
where we post the new password weekly. As a bonus, there are lots of super helpful Jane users in there who love to help out if you have questions.
Training Video Playlists
If you love learning through videos, you can hop into our
Training Video Playlist
section to work through videos on all the Jane basics. 👍
Alright, folks! If you ever have a question (or a comment, idea, or musing) please don’t hesitate to get in touch. We really do love chatting with you.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane Support & Resources: Getting Help With Your Account
Troubleshooting
Jane Support & Resources: Getting Help With Your Account
7 min read
Balance Plan
Practice Plan
Thrive PlanIs that a burning question we smell? Then you’ve come to the right place! Here are the ways that you can get the answers you need when you need them:
💙
Get in touch
-
We really do love talking to you
...
Training Video Playlist
section to work through videos on all the Jane basics. 👍
Alright, folks! If you ever have a question (or a comment, idea, or musing) please don’t hesitate to get in touch. We really do love chatting with you.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/59f0d5ef-5b5e-4873-9de7-0137f2218b86)
- ![A gif of how to access Jane Sidekick when logged into Jane](https://jane.app/thumbs/f6fbc157-ce48-4686-8596-9568f30db289)
