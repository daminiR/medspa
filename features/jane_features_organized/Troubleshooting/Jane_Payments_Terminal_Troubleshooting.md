...
*Source: [https://jane.app/guide/jane-payments-terminal-troubleshooting](https://jane.app/guide/jane-payments-terminal-troubleshooting)*

*Category: Troubleshooting*

*Scraped: 2025-08-07 05:02:34*
...
Feature OverviewJane Payments Terminal Troubleshooting
Troubleshooting
Jane Payments Terminal Troubleshooting
5 min read
Balance Plan
...
Ensure the battery is in the terminal the right way. The customer warning message on the battery will be facing outward.
Note: if the battery is already installed, please remove and reinstall it in the device.
...
3️⃣  Ensure Your Terminal Uses Secure Encryption
When connecting your terminal, it’s essential to verify that your Wi-Fi network is secured with encryption protocols such as
WPA/WPA2/WPA3-Personal
or
WPA2/WPA3 EAP-PEAP
Enterprise. Additionally, your network must be password protected.
4️⃣ Restart your Terminal
Hold down the power button, until the “Power off / restart” buttons show up. Tap restart, then confirm you’d like to restart.
Here typically a Jane logo will show up
Reconnect the reader by swiping left to right and tap
Settings
Enter the administrative pin: 0 7 1 3 9
Tap
Generate Pairing
Code
Back in your Jane account enter the pairing code. That’s under
Settings > Jane Payments >
click the
blue pencil
beside the Jane Payments Account then
> Link Jane Payments Terminal
.
5️⃣ Do a Factory Reset on your Terminal
Step 1: Before You Begin
Make sure the reader is powered on, it is plugged into the charger, and you have access to a working WiFi network with Internet.
Step 2: Start the Factory Reset
Press and hold
the two side buttons
(with blue lines) for 10–15 seconds (one button is on each side of the reader)
A confirmation dialog will appear - Tap
“Yes”
to confirm the factory reset
Step 3: Wait for the Reset to Complete
The screen will go blank, then cycle through several screens as it erases and resets
Once the reset is complete, the screen will say “Not connected to the Internet”
Tap
“Connect to WiFi”
Choose your WiFi network, enter the password, and tap
“Connect”
Once connected, tap the
Back
button in the bottom-left corner of the screen
Step 4: Update and Configure the Reader
The reader will now say it’s connected and ready to update - Tap
“Update”
The device will download and install firmware, then ask you to select a language
It may flicker or switch screens a few times, then prompt you to select your country
The reader will download the appropriate software and configuration for your selected country
Step 5: Restart the Reader
When installation is complete, hold the
power button
down and tap
“Restart”
After restarting and connecting to the network, the device should land on the normal splash screen
6️⃣ Try processing a payment
Once you have tried all the above tips,
try processing a payment
starting from within Jane and selecting the Jane Payments Terminal as the payment method. Within the appointment or purchase click the blue
Pay
button, then follow the steps to
process the payment in-person
.
Still running into issues with your terminal?
We’re here to help get things sorted quickly. Reach our team at
payments@jane.app
and we’ll jump in.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane Payments Terminal Troubleshooting
Troubleshooting
Jane Payments Terminal Troubleshooting
5 min read
Balance Plan
Practice Plan
Thrive PlanHere are a few useful suggestions that you can try if you’re experiencing any trouble with your Jane Payments Terminal.
1️⃣ Is the Terminal being charged correctly?
The Terminal needs to be plugged into a wall outlet (with at least 5W power) with the cable that was provided with the Terminal and an adaptor to connect the cable to the wall. The terminal cannot be plugged into a laptop or another device for charging.
Ensure the battery is in the terminal the right way. The customer warning message on the battery will be facing outward.
Note: if the battery is already installed, please remove and reinstall it in the device.
...
We’re here to help get things sorted quickly. Reach our team at
payments@jane.app
and we’ll jump in.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e66fcf59-eab2-4ad3-8c8d-9b42ccbe8d22)
- ![](https://jane.app/thumbs/29d84e16-234e-4564-9687-581b771abd8b)
