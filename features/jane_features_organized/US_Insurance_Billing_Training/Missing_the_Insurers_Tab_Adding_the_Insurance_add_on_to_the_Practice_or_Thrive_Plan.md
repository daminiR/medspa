...
*Source: [https://jane.app/guide/missing-insurers-tab-upgrading-from-the-base-plan-to-the-insurance-plan](https://jane.app/guide/missing-insurers-tab-upgrading-from-the-base-plan-to-the-insurance-plan)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:48:57*
...
Feature Overview​Missing the Insurers Tab? Adding the Insurance add-on to the Practice or Thrive Plan
...
Note
📝:
If you are currently on one of our Legacy Plans, you’ll need to upgrade to one of our new subscriptions and then select Insurance as an add-on. Check out our guide doc on
Managing Your Jane Subscription
that walks through this process in a bit more detail.
If you would like to invoice and track insurance claims in Jane, you will need to add the insurance add-on to your subscription. You can find more information on our
Pricing Page
.
To make this change, the listed
Account Owner
can change this by heading over to the
Settings
tab and then clicking on
Jane Subscription
.
Towards the bottom of the page, you’ll see a blue button to
Update Subscription
.
You’ll then want to
toggle on
...
.
Once this change has been made, you will be invoiced for the difference in price and you should see the additional charge processed approximately 4 hours from the time the change was confirmed.
Learning Resources:
Here’s our Insurance Billing video series to help show you the ropes, as well:
🇨🇦Click here for Canadian insurance
🇺🇸Click here for US Insurance
For more information on what you can expect when
removing the insurance add-on
from your subscription, this guide may help.
If you’d like access to the demo site to practice tracking claims,  without corrupting your own data, you can find the login information by clicking the
Need Help?
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)​Missing the Insurers Tab? Adding the Insurance add-on to the Practice or Thrive Plan
Insurance Billing (Canada)
​Missing the Insurers Tab? Adding the Insurance add-on to the Practice or Thrive Plan
3 min read
Practice Plan
Thrive PlanAre you trying to set up your Insurers but the tab seems to missing? It sounds like you might not be signed up for Jane’s insurance add-on. Heads up — the insurance add-on can be added to the Practice or Thrive plans.
Note
📝:
If you are currently on one of our Legacy Plans, you’ll need to upgrade to one of our new subscriptions and then select Insurance as an add-on. Check out our guide doc on
Managing Your Jane Subscription
...
support@jane.app
.
We always recommend using the demo clinic for testing and practice so that your own account stays nice and tidy. ✨Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps for the listed Account Owner to head over to the subscriptions area](https://jane.app/thumbs/adf558df-7db1-4dc9-90fb-db270cb61f0b)
- ![An image of the navigational steps and where to view and click on Change Subscription at the bottom of the page](https://jane.app/thumbs/dcbb1784-a269-45e4-b7d7-4c4c49ed6bbe)
- ![an image of where you'll see the plan you're subscribed to in addition to the toggle for the insurance add-on](https://jane.app/thumbs/a73bab69-af3c-4e97-a1e7-3a0ae8258b6a)
