...
*Source: [https://jane.app/guide/start-billing-1-patient-insurance](https://jane.app/guide/start-billing-1-patient-insurance)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:50:43*
...
Feature OverviewStart Billing 1: Patient Insurance
US Insurance Billing Training
Start Billing 1: Patient Insurance
10 min read
Practice Plan
Thrive Plan
Welcome back to the Jane US Insurance Billing training!
If you have not done so already, please go through the
US Insurance Set Up Steps
first.
Now that you’ve set up your insurance features, you can start submitting insurance claims. Woo-hoo!
Let’s get started!
Patient Insurance Policy
The billing workflow begins by entering patient insurance information inside their profile. This is done by setting up a new
Insurance Policy.
Once an Insurance Policy has been created, it can be attached to any appointment covered by that specific insurance payer.
Entering Patient Insurance
To create a patient insurance policy, you can begin from two main areas; The Patient’s Profile or from their Appointment.
Here’s a quick video reviewing the steps:
📣 Since filming the video below, some labels have now been updated! Instead of
Claims
, you’ll need to select
Insurance Policies
to create a patient insurance policy in the patients Profile.
Video recap
:
Creating patient policies is how you save patient insurance information in Jane
Start by opening a patient’s profile > Billing > Claims > New Claim
Select the patient’s insurance payer then submit their policy information for EDI or paper submission
Jane can track a patient’s policy if you submit information like max number of visits or policy end date
You can add or change the policy if it is from a spouse or other relationship
Default Coverage Amounts is helpful to collect any recurring coverage or information for that patient’s billing, but you can always adjust them at the time of visit
Can I do eligibility checks to see coverage in Jane?
Yes! All US customers with insurance features can connect their Claim.MD accounts with Jane to make real-time eligibility checks. You can learn all about it
here
.
From the Patient Profile
From the patient
Profile
, you can enter your patient’s insurance information by heading into the
Billing
tab and then clicking into
Insurance Policies.
Use the “
...
In the Appointment window, scroll down and click to open the
Insurance Info
area
...
If you need to create a new insurer see this guide on
Adding Health Insurers.
Next, give the insurance policy a name – this is internal and should be useful in identifying the policy. Example: Personal Injury Claim or Shoulder Injury.
...
While you can always return to this area later to fill in more details, you will want to complete this area before you generate a CMS 1500 form or submit an insurance claim under this policy.
Here are a few of the Insurance Policy fields and the box line they match up with on the CMS-1500 form:
...
Example:
Policy End Date & Approved # of Treatments
Within a Patients Insurance Policy, you’ll see this area on the left-hand side where you can enter in a policy end date or the max number of treatments:
This area can be helpful as Jane will help you with the tracking.
Let’s say you enter 12 treatments in the “Max Treatments” line once you know they’re approved. Jane is going to count the number of visits billed under this insurance policy, and will give you a notification once you book and arrive on the 12th visit:
You can also “View” the insurance policy at any time from the Patient Profile > Billing > Insurance Policies > View to see how many visits the patient has used.
If a patient gets approved for more visits you can “Edit” the policy to jump in and update the number of visits left.
Accept Assignment & Signature on File
When filling out this new insurance policy for a patient, you’ll notice the Signature on File and Accept Assignment radio buttons.
These fields will be included on both CMS-1500 forms (box 13 & 27) and EDI files that you generate for submission.
These fields can be handled in each individual policy you create, or you can set up a clinic/insurer wide setting to default one or both of these fields to ‘Yes’ for all patient insurance policies where you haven’t selected ‘Yes’ or ‘No’.
You can find that clinic wide setting by heading into
Settings > Billing Settings
If you were to check off either of these settings (let’s say both for this example), then each insurance policy on your account that doesn’t have a value inputted for these fields would default to ‘Yes’.
If you had a policy where you selected ‘No’ and have enabled the ‘Yes’ default, Jane will ignore the default and use the ‘No’ value on the CMS-1500s and EDIs that you generate.
Please Note:
If you do choose to default your Signature on File to Yes, it’s important that you do obtain your patient’s signature before billing for their visits. For specific questions on the importance of when and how to obtain your patient’s signature, it’s best to contact your regulating body or college.
Interested in collecting your patient signatures using Jane’s intake form feature? If so, please have a look at the following guide document:
Intake Form: Require Signature Setting
💡
Pro tip
:  If you are courtesy billing, meaning you are out of network and not expecting the insurer to pay you directly, but rather reimburse the patient directly, it is very important to specifically select “No” on both Signature on File and Accept Assignment.  On the EDI files these combine into one response.  If either is marked “Yes”, the EDI file will default to “Yes”.
Default Policy Information
The bottom area of the patient insurance policy gives you the option to add in default insurance information.
You can add default billing codes, co-pays, etc. to a policy which will then
automatically add those same billing codes and amounts
to an appointment when you attach the insurance. This comes in handy if the patient sees you for the same treatment with the same or similar billing codes each time.
You will have the option to adjust any default information at the time of visit should you need to make any changes. Jane gives you the option to remove a billing code, change a billing code, or add any additional billing codes. You can also add or remove diagnosis codes at the time of the visit.
...
You’re not required to add default coverage amounts. If you prefer to enter the billing code information on each visit separately, just create the policy with no default coverage amounts.
Click “Save” to finish!
All insurance coverage will be saved under the “Insurance Policies” area for the patient:
📘 Continue learning the insurance billing workflow in
Start Billing 2 - Adding CPT & Dx Codes.
, or jump back to the
US Insurance Training Hub
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Start Billing 1: Patient Insurance
US Insurance Billing Training
Start Billing 1: Patient Insurance
10 min read
Practice Plan
Thrive PlanWelcome back to the Jane US Insurance Billing training!
If you have not done so already, please go through the
US Insurance Set Up Steps
first.
Now that you’ve set up your insurance features, you can start submitting insurance claims. Woo-hoo!
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/d20a7d4c-cacc-4fdd-b3e7-6d215b93fd08)
- ![](https://jane.app/thumbs/1457b9cf-0e79-4b90-9a80-c544ad9b2cc2)
- ![](https://jane.app/thumbs/489b2c23-abe8-41f0-be85-a11be0497ad4)
- ![](https://jane.app/thumbs/bfaca6d8-511a-4e7f-8bdf-0fcf82e4c770)
- ![](https://jane.app/thumbs/a385a757-a694-49a3-99db-1fb4883c62bd)
- ![](https://jane.app/thumbs/724de363-3112-4f6f-a1ab-99f9fda3c51a)
- ![](https://jane.app/thumbs/f3a8e51f-8256-4aab-be72-25915369fa2d)
- ![](https://jane.app/thumbs/9e9f4462-2248-4029-894b-8e99cc1cfbca)
- ![](https://jane.app/thumbs/8a60451b-5646-4390-bc03-ac0b5d9ab7a0)
- ![](https://jane.app/thumbs/8339ed55-5ba5-4b54-822b-f3d1928b1859)
- ![](https://jane.app/thumbs/a9e0e45e-b8bd-432d-858d-159edb211cb4?dimensions=700x500)
- ![](https://jane.app/thumbs/f901f4bd-e32b-434b-880f-597a36874807)
- ![](https://jane.app/thumbs/f0ab1fbf-83cc-4058-a7ba-63337768371a)
- ![](https://jane.app/thumbs/faa93b44-2e9c-4225-9ba1-f805bb8bc5ce)
- ![](https://jane.app/thumbs/3cb7b346-a10a-47aa-8441-377fc5e77ac0)
- ![](https://jane.app/thumbs/48df5dac-19f3-47c9-8360-db9e273a92da)
- ![](https://jane.app/thumbs/9585bc87-b102-4868-a20e-9c5273317637)
- ![](https://jane.app/thumbs/5fa1b859-7fdb-4154-9d2a-fcaa422e0794)
