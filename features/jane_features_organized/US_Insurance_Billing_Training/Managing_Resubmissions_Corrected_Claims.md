...
*Source: [https://jane.app/guide/managing-resubmissions-corrected-claims](https://jane.app/guide/managing-resubmissions-corrected-claims)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:54:51*
...
Feature OverviewManaging Resubmissions & Corrected Claims
...
If you have received a rejection from the
clearinghouse
that you’re using to submit your claims, or from one of the
payers
that you bill, then you’ll likely need to create a new EDI file that you can use for resubmission.
...
enabled, you can simply hit the Submit button like you would for any claim & Jane along with Claim.MD will take care of the resubmission for you.
...
✨New✨: With Jane’s new integration with Claim.MD called
Integrated Claims with Claim.MD
, if you receive (dare I say it) a rejection, Jane will automatically move the claim to the Rejected folder. You can then hit View > Submissions & Acknowledgements > click onto the Rejection notice in Red to take note of what you need to correct in Jane!
...
Pro Tip
: Some clearinghouses may flag your resubmission as a duplicate claim (if they have a feature designed to catch potential duplicates). If so, you may need to temporarily disable this feature in your clearinghouse before uploading your new EDI for resubmission.
...
To submit a voided or corrected claim in Jane, head over to the
Billing
tab and click on
Search
within the left sidebar menu. You can use the search bar to find the claim in question and hit the
View
button to the right.
Next, click on the
dropdown arrow
...
Next you’ll head over to your
Unsubmitted
folder, and search for the claim. Once you select the claim using the checkbox on the left, click on the blue
Submit Selected Claim(s)
button.
Within the Pre-Flight checklist, you’ll see a new section called
Resubmission / Correction Code
with a dropdown menu.
You have three choices here:
While we have a
Corrected Claim (6
) code listed, it is not recommended for use.
For a voided claim you will select
Void / Cancel Prior Claim (8)
.
For a denied claim, you’ll select
Replacement of Prior Claim (7)
.
Once you’ve selected the code type, click on the blue
Add
button within the
...
More Questions?
If you’re looking to chat with others who have worked with resubmissions and claims in Jane, including a helpful bunch of billers, join our
US Billing Community
! 🎉 Current customers can join this group to connect with other Jane users to share tips, tricks and best practices and have exclusive access to the helpful support of third-party billers who work with Jane.
We hope to see you there! 💙
Please also feel free to email us at
support@jane.app
for some extra help.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Managing Resubmissions & Corrected Claims
US Insurance Billing Training
Managing Resubmissions & Corrected Claims
10 min readIf you’re using Jane’s EDI feature to submit to a clearinghouse and you need some help resubmitting corrected claims, then please read on!
What To Do If You Encounter a Rejected Claim
If you have received a rejection from the
clearinghouse
that you’re using to submit your claims, or from one of the
...
Please also feel free to email us at
support@jane.app
for some extra help.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e8a6b549-af9d-44e2-813e-e26690ecfcc6)
- ![](https://jane.app/thumbs/febf5040-a7c1-498d-9a86-7055a5675400)
- ![](https://jane.app/thumbs/32e215e3-da71-498e-92b3-bc65e824176a)
- ![](https://jane.app/thumbs/f4dc6b07-2c53-4a98-9fb8-0d4f359d3ee2)
- ![An image of the navigational steps and where to click to view the claim](https://jane.app/thumbs/741c1a52-6d38-49ae-a52b-27f5c8405280)
- ![An image of the navigational step and where to click on the dropdown option](https://jane.app/thumbs/9bd7348d-04f4-407c-b7d1-d381ac995539)
- ![An image of the navigational steps](https://jane.app/thumbs/082cbf61-86c9-4ef9-b1e0-b2b581bcc48e)
- ![An image of the navigational steps and the dropdown menu options for corrected claims](https://jane.app/thumbs/99d2d777-6ff1-486d-9cb1-fced1ce7447c)
- ![An image of the navigational steps and where to view the add button within the pre-flight checklist](https://jane.app/thumbs/8e5ccac5-ce33-4d35-9a6c-d0d2d0ce6b5f)
- ![An image of the navigational steps and where to view the field to enter the claim control number](https://jane.app/thumbs/596146a0-7ba7-4ec4-ae93-99b67c5e9392)
- ![](https://jane.app/thumbs/4db3bc79-b357-4b77-8b82-e85d5c7f1fa4)
- ![An image of the navigational steps and where to view the field to enter the claim control number](https://jane.app/thumbs/d2e62d11-fbb6-4f8d-aa05-312af1676964)
