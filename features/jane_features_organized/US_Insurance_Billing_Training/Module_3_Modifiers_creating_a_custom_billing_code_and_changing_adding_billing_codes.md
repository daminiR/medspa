...
*Source: [https://jane.app/guide/module-3-modifiers-creating-a-custom-billing-code-and-changing-adding-billing-codes](https://jane.app/guide/module-3-modifiers-creating-a-custom-billing-code-and-changing-adding-billing-codes)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:57:11*
...
Feature OverviewModule 3: Modifiers, creating a custom billing code, and changing & adding billing codes
Biller Training
Module 3: Modifiers, creating a custom billing code, and changing & adding billing codes
8 min read
Practice Plan
...
Arriving
the visit will generate an invoice for the default
Treatment price
, $50 in this case. You can ignore this invoice price for now, as
any CPT fees will override this treatment price.
The provider has now treated Victoria and is ready to proceed to check out.
The provider will need to add in the CPT and Diagnosis codes that apply to the patient’s visit. CPT & Diagnosis codes can be added to the
Insurance Info
section of the appointment by searching and selecting their desired codes.
This information can be entered in two ways by the practitioner while charting from the
Day
view:
Add CPT & Diagnosis codes to chart entries and send them to the appointment from there
Click on the appointment twice to open the Appointment Panel and add CPT & Diagnosis codes directly to the Insurance Info section:
...
Insurance Info
section
Search for the applicable CPT code in the “
Add Billing Code
” search bar
...
For more info on generating superbills in Jane, please have a look at our
Creating Superbills
guide.
Adding Modifiers
...
Schedule
tab and clicking on an appointment to open the
Appointment Panel
.
Scroll down to the
Insurance Info
section and enter in a
CPT
code
...
Next, add a
Modifier
beneath the diagnosis code(s).
Finally, we can correct the billing code by selecting the
dropdown menu
and choosing to
Change Billing Code.
Simply type in another billing code and voila!
Touchdown! 📣
...
We’ve got this handy guide that covers all the details:
Re-booking Clients with the Same Insurance Info
.
Way to go! Another module is complete. Let’s take a look at getting paid in our next Module:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Module 3: Modifiers, creating a custom billing code, and changing & adding billing codes
Biller Training
Module 3: Modifiers, creating a custom billing code, and changing & adding billing codes
8 min read
Practice Plan
...
.
Way to go! Another module is complete. Let’s take a look at getting paid in our next Module:
Module 4: Remittances.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/f2afa3e0-3bc0-4a64-8d79-404e8834bf5e)
- ![](https://jane.app/thumbs/e8a5e7d7-0dd9-4eea-8a9d-1f9388240985)
- ![](https://jane.app/thumbs/fec9ef7a-d858-45c9-881b-59f07705cebc)
- ![](https://jane.app/thumbs/019131a2-5a25-4e62-90a5-57cff66c9213)
- ![](https://jane.app/thumbs/5f4677a9-5f54-4231-9c5b-817740901c27)
- ![](https://jane.app/thumbs/2a46ed85-2c98-47b5-8412-47bc50573f94)
- ![](https://jane.app/thumbs/efc2a8bb-8ad5-43c3-9fa9-be2ce59ed505)
- ![](https://jane.app/thumbs/e0bd891f-03aa-4cf7-b6ee-694ad0cb137b)
- ![](https://jane.app/thumbs/6b814e24-e894-499c-b0a0-fc47ed58f891)
- ![](https://jane.app/thumbs/f31cd88b-1812-4f41-be58-76ca413c534a)
