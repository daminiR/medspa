...
*Source: [https://jane.app/guide/us-insurance-step-2](https://jane.app/guide/us-insurance-step-2)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:49:54*
...
Feature OverviewUS Insurance Step 2
...
If you plan to bill based on the applicable procedural codes, you’ll need to set up your clinic fees!
CPT codes are required to have an assigned fee for claim submission
.
Video recap
:
You can find Billing codes within Settings > Billing Codes in the left side menu
Use the search bar to find commonly-used codes
Click Assign Rate, then input the Billed Amount (single unit price of the procedure), Modifiers, * Allowed Amount (used to calculate coinsurance)
Favorite diagnosis codes for quick use by searching with the Billing Codes search bar, then click the Star
You can access all of your Favorited code by using the space bar in the appointment Billing Codes area
...
To set up your clinic CPT fees,
scroll down
...
When setting up your clinic billing code fees, you can also set up some handy
defaults
to save time, prevent billing mistakes, and make your insurer Accounts Receivable more realistic.
These defaults include insurer-specific
Allowed Amounts
and
Modifiers
. This allows you to account for any Contracted Rates or Fee Schedules that you might have with an insurer.
💡
Pro tips
:
Leave the Allowed Amount fields blank to use the Billed Amount instead.
A Procedure’s default Billed Amount,
not its Allowed Amount
, is sent to the insurer when billing through Jane’s Electronic Submission (EDI) feature. Allowed Amounts are only used as the basis for Co-insurance % calculations and internal invoicing.
Default Modifiers
will automatically apply when adding a billing code to a visit. If you’d like to assign multiple Modifiers, you can do so by separating each two-character modifier with a space.
You’ll notice there is a box for a
Default
Modifier and Allowed Amount, as well as boxes for each insurance company you have set up in your Jane account. This Default box will be used if the insurer-specific box is empty, but the insurer-specific box will be favorited if you’ve filled it in.
The insurer-specific boxes are there in case some insurers you bill have different requirements for the same procedure code.
...
It might also be a good idea to set up some favorite
diagnosis codes
while you’re at it, to save you a little time down the road.
Favorite codes are available for quick access when insuring a visit by using the
space bar
on your keyboard.
...
💡Pro tip:
If you don’t want all the codes from our library to populate when you adding billing codes to a visit (you just want your fees and custom codes to display when searching), uncheck the CPT code set box when you’re done setting up your billing codes.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)US Insurance Step 2
US Insurance Billing Training
US Insurance Step 2
5 min read
Practice Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/cf7f38e0-b90a-462f-ae1e-19bfb0f872e9)
- ![](https://jane.app/thumbs/35a67f6b-275c-4846-8f5e-f768ed608090)
- ![](https://jane.app/thumbs/f5f3aaab-ee93-48af-a704-c5b86d753f7b)
- ![](https://jane.app/thumbs/afe50315-21f0-418a-9e86-6627efb44497)
- ![](https://jane.app/thumbs/63fe4278-7252-499b-913d-5c5ad0c21e45)
- ![](https://jane.app/thumbs/f9f551fa-62f0-400c-9f79-b8cf65ff5437)
- ![](https://jane.app/thumbs/a8aa42cc-0e60-4083-9b9e-afa692760872)
