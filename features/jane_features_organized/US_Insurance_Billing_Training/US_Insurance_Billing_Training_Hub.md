...
*Source: [https://jane.app/guide/us-insurance-training-welcome](https://jane.app/guide/us-insurance-training-welcome)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:48:41*
...
Feature OverviewUS Insurance Billing Training Hub
US Insurance Billing Training
US Insurance Billing Training Hub
3 min read
Practice Plan
Thrive Plan
Welcome! If you’ve signed up for Jane’s Insurance add-on you’re likely eager to get started—and we’re here to guide you through it. We’ve put together a quick, step-by-step guide to help you set up your account for insurance billing. The training is split into nine lessons across two parts, so you can progress at your own pace.
💡 If you’re new to Jane,
here’s how to add Insurance to your Jane plan
. Jane’s Integrated Clearinghouse is Claim.MD, and we highly recommend using it for the best billing experience. If you haven’t signed up yet, check out the integration details and how to get started
here
.
In this course, we’ll start by showing you how to set up your account, then dive into billing directly from Jane. The whole process takes about two hours to complete.
The US Insurance Billing training is designed for practitioners or admin staff handling insurance claims in the US. If you’re a Billing Specialist, be sure to check out our dedicated training
here
.
This page is your training hub—where you can see and open all the lessons. You’ll also be able to progress seamlessly through the course at the end of each lesson page.
Before we dive into the training, let’s quickly review revenue cycle management in Jane.
Ready to get started? Jump into the first lesson below!
Part One: US Insurance Setup
US Insurance Setup Step 1
: Adding your insurers
US Insurance Setup Step 2
: Assign rates to your CPT codes
US Insurance Setup Step 3
: Location & staff billing info
Part Two: US Insurance Billing
Start Billing 1
: Patient insurance
Start Billing 2
: CPT & diagnosis codes
...
: Insuring the visit
Start Billing 4
: Claim management & CMS1500 forms
Start Billing 5
: EDI Claim Submission
Start Billing 6
: Posting insurer payments & EOBs
US Insurance Billing Training survey
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)US Insurance Billing Training Hub
US Insurance Billing Training
US Insurance Billing Training Hub
3 min read
Practice Plan
Thrive PlanWelcome! If you’ve signed up for Jane’s Insurance add-on you’re likely eager to get started—and we’re here to guide you through it. We’ve put together a quick, step-by-step guide to help you set up your account for insurance billing. The training is split into nine lessons across two parts, so you can progress at your own pace.
💡 If you’re new to Jane,
here’s how to add Insurance to your Jane plan
. Jane’s Integrated Clearinghouse is Claim.MD, and we highly recommend using it for the best billing experience. If you haven’t signed up yet, check out the integration details and how to get started
here
...
Start Billing 6
: Posting insurer payments & EOBs
US Insurance Billing Training surveySubscribe to our monthly newsletter.Jane Software Inc.
