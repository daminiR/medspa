...
*Source: [https://jane.app/guide/module-5-a-r-tracking-aging-claims](https://jane.app/guide/module-5-a-r-tracking-aging-claims)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:58:20*
...
Feature OverviewModule 5: A/R Tracking (Aging Claims)
Biller Training
Module 5: A/R Tracking (Aging Claims)
6 min read
Practice Plan
...
Module 5: A/R Tracking (Aging Claims)
Still with us? Great! Hang on tight as we’re rounding out our skillset with some tips and tricks on using Jane to stay on top of what’s been submitted, what’s been paid, and everything in between.
In this last module, we’ll be covering the
Accounts Receivable
report and how it can help with your A/R tracking.
...
To view only outstanding invoices, find the Filter button, and filter the Status to All Outstanding:
Patients
Clicking on a patient name brings you to their
Profile > Billing > Purchases
area displaying full billing history.
To view only outstanding invoices, find the Filter button, and filter the Status to All Outstanding:
...
In case you haven’t seen it yet, here is our guide on
...
area of Jane.
Having trouble reconciling your A/R between months? There’s a guide for that as well that dives deeper into how Jane calculates A/R and what formula to use to arrive at an accurate calculation:
...
Wooohooo! 📣
You’ve made it through all of the modules and should now have a better understanding of
pretty much
everything a biller needs to know in Jane. Of course, if you have any questions, don’t hesitate to contact us at support@jane.app or give us a call on our phone line +1 844-310-JANE (5263).
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Module 5: A/R Tracking (Aging Claims)
Biller Training
Module 5: A/R Tracking (Aging Claims)
6 min read
Practice Plan
...
You’ve made it through all of the modules and should now have a better understanding of
pretty much
everything a biller needs to know in Jane. Of course, if you have any questions, don’t hesitate to contact us at support@jane.app or give us a call on our phone line +1 844-310-JANE (5263).Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/7ee5cc62-9c00-44d1-b189-4340ec9b4e06)
- ![](https://jane.app/thumbs/cef2a9d0-0ebd-4d40-8878-a059732d7652)
- ![](https://jane.app/thumbs/2de1ccf9-fe61-42ec-94d6-9147c60cfca6)
- ![](https://jane.app/thumbs/5d2718b0-a9c8-4f6c-b73e-580308fd6813)
