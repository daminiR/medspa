...
*Source: [https://jane.app/guide/module-4-remittances](https://jane.app/guide/module-4-remittances)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:57:53*
...
Feature OverviewModule 4: Remittances
Biller Training
Module 4: Remittances
6 min read
Practice Plan
...
If an insurer sends you electronic remittances (ERAs), you’ll want to post payments this way. Check out the following guide to learn more about this workflow:
...
This is how you’ll need to manage payments if an insurer only provides paper remittances. To dive into this workflow, check out the following guide:
...
Click on the
Billing
tab at the top of Jane, then scroll down on the left hand side to the Insurance Invoices section, then click on the
Aetna
folder
Create a
New Payment
...
field and click
Next.
Choose an invoice from the menu to
Apply
the money to, and repeat the
Apply
process until your
Balance Remaining
reaches $0.
...
Sometimes an insurance company will send multiple remittances and payments toward a single claim. To learn how to manage any additional remittances/payments you may receive, have a look at this guide:
...
To learn how to unapply an insurance payment, hop into this guide,
...
Click
Unapply
(the oval with a line through it) for each of the invoices the payment is applied to.
Finally, click on the
Delete
button (trash can) and confirm by selecting
OK.
Touchdown! 📣
Courtesy Billing
...
.
Great work! It’s time to round out this course by exploring how we can track aging claims in our next Module:
Module 5: A/R Tracking (Ageing Claims)
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Module 4: Remittances
Biller Training
Module 4: Remittances
6 min read
Practice Plan
