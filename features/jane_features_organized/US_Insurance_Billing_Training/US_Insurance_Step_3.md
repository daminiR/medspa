...
*Source: [https://jane.app/guide/us-insurance-step-3](https://jane.app/guide/us-insurance-step-3)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:50:07*
...
Feature OverviewUS Insurance Step 3
...
Video recap
:
In Settings > Clinic Info & Locations, Edit your locations to update your NPI and Place of service code
In the Staff tab, choose a practitioner and open their Billing area
Click Add to update any ID numbers
Under Default Claim Information, click Add New to update NPIs, tax numbers, tax ID type, and any other required details
Insurance Specific Claim Information gives you the option to add any additional information that different insurance providers require
Setting Up Claim Information in Location(s)
This information can be entered by heading into
Settings > Locations > Edit Location
.
The following information is
required
for all claim submissions. Note: If you have multiple Locations, you’ll need to add this information to each:
Location Name & Address
(Box 32 on the CMS-1500)
Location Billing Name & Address
(Box 33** on the CMS-1500)
Location/Service Facility NPI
(Box 32a and Box 33a** on the CMS-1500)
Special note: if you have an individual NPI, you will enter it here. Look closely for more directions regarding this in the next section.
Place of Service Code
(Box 24B on the CMS-1500)
Billing Provider Taxonomy
Code (Box 33b** on the CMS-1500)
Tax ID Number and type
(Box 25** on the CMS-1500)
**
These boxes can be determined by the information in a Staff Member’s Billing settings instead of the location if needed. See the
...
The following information is
required
for claim submissions. It should be entered into the
Default Claim Information
section for each Staff Member who bills insurance.
Rendering Provider Identifier
- this would usually be your own NPI (Box 24j), as the provider that rendered this service. You can also add an alternate identifier, such as a license number (Box 24i) if your insurer calls for this.
Overriding Location Claim Info With Staff Billing Settings
If one or more Staff at your practice needs a little more flexibility with the information that’s sent on their claim submissions, then they can adjust their
Default
and
Insurance Specific Claim Information
.
For example, if a Staff Member is submitting claims as an individual provider, and would like to submit their own info instead of the location/business info in Box 33 and Box 33a on the CMS-1500, then they can set up
Default Claim Info
(if they need their claims set up like this for all or most insurers), or they can set up an
Insurance Specific Claim Information
form for a particular insurer (if only one insurance company requires this custom info).
Default Claim Information
In addition to the required and optional fields outlined in the ‘Setting Up Claim Information in Staff Profile(s)’ section, Jane gives each Staff Member the flexibility to add some custom claim information for fields that are otherwise set with information in the
Location
of the service.
Specifically, each staff member has the option to:
Use a Custom Billing Provider NPI
(Box 33a on the CMS-1500)
Used instead of the Location NPI
If you only have an individual NPI, you’ll also want to use the Custom Billing Provider Information, entering your individual NPI once more and dropping down the menu for Billing Provider NPII Type and choose Individual (Type 1)
Set themselves up as the Billing Provider
(Box 33 on the CMS-1500)
Used in place of the Location Billing Legal Name
Use a Custom Billing Provider Address
(Box 33 on the CMS-1500)
Used in place of the Billing Location Address
Use a Custom Tax ID number
(Box 25 on the CMS-1500)
Used in place of the Location Tax ID number
This information can be set up by heading into
Staff > Staff Profile > Billing > Default Claim Information
...
For example, if there is one insurance company that requires that you submit a Taxonomy Code (and all other insurance companies you submit to don’t want your Taxonomy included in the submission), then you can create
Insurance Specific Claim Information
for that insurer.
...
📘 Get started here:
Start Billing 1 - Entering Patient Insurance
, or jump back to the
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)US Insurance Step 3
US Insurance Billing Training
US Insurance Step 3
8 min read
Practice Plan
...
Start Billing 1 - Entering Patient Insurance
, or jump back to the
US Insurance Training Hub.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/51b50c4a-93b1-40f2-a64c-41638283a438)
- ![](https://jane.app/thumbs/c2f0f57b-d208-404a-8055-f9afb2201e25)
- ![](https://jane.app/thumbs/4f37cb2d-f4a3-4068-84bf-b9aa471e0dc9)
- ![](https://jane.app/thumbs/4f3c4aff-5a1c-49aa-8c64-c92fa687288d)
- ![](https://jane.app/thumbs/5cf019bd-6542-40d0-ab36-b7512f736760)
- ![](https://jane.app/thumbs/58ccfe1f-58da-41b3-b80d-39d3d62dc6fe)
- ![](https://jane.app/thumbs/699722a9-4512-42c8-bdfa-8d948490bdab)
- ![](https://jane.app/thumbs/0aaf8599-e734-4ea7-b526-2c6efd3cfaa0)
- ![](https://jane.app/thumbs/c6c82581-a46e-4958-aec5-8e17552c4412)
- ![](https://jane.app/thumbs/6b11d98d-0e8a-4ec3-a66a-c2c554efcf62)
