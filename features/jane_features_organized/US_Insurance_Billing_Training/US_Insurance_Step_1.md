...
*Source: [https://jane.app/guide/us-insurance-step-1](https://jane.app/guide/us-insurance-step-1)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:49:26*
...
Feature OverviewUS Insurance Step 1
US Insurance Billing Training
US Insurance Step 1
6 min read
Practice Plan
Thrive Plan
Welcome! If you signed up for Jane’s insurance plan, you are likely super eager to get started. This guide is the first step in setting up US insurance billing. We’re happy you’re here!
To start, there are 3 steps that are required to get your account ready to use Jane’s Insurance features:
Set Up Task
Task Complete
...
Video recap
:
You can submit claims through the Claim.MD integration, or through any other insurance portal
Using integrated claims through Claim.MD will help you submit claims, view claim acknowledgements, manage rejections, and receive insurer remittances directly within your Jane account
Add new Insurers from the Settings > Insurers area of your Jane account
You can choose to treat multiple units of the same procedures as the same line item, or separately if your insurance requires it by selecting the Treat CPT Units as Separate Line Items check box
Repeat the setup process for each insurance company you bill to
...
Important Note:
If you’d like to bill using our EDI generation/download tool for submission, you’ll need to add the following fields to your insurer:
Insurer Name
Payer ID
Insurance Program
💡
Pro tip
:  Each Clearinghouse may have a unique payer ID for an insurer.  To avoid possible delays in processing, hop over to Claim.MD and check out their payer list.  Search for your payer and use the one listed there.  If you are using another clearinghouse be sure to check their site for a list of payer IDs.
Billing Portals
If you’re using
Jane’s Clearinghouse Integration
through Claim.MD, you won’t need to worry about this as your claims will go directly to the Clearinghouse from Jane (we highly recommend this!). However, if you do choose to submit through Office Ally, TriZetto, and/or Availity, then you can input the Clearinghouse portal web address here for quick access. This will allow you to launch the Clearinghouse portal from Jane for claim submissions. The link is stored, however it is not usable.
...
. This means that when billing multiple units of a procedure, Jane will display a single
Allowed Amount
and a single line on the
EOB Screen
for all units.
However, if your insurer treats each unit of a procedure separately, then you’ll want to check this setting to ensure that when billing multiple units of a procedure, each unit has its own
Allowed Amount
and line item on the
EOB Screen
. ☑️
That said, we’re getting a bit ahead of ourselves. You’ll learn more about
Allowed Amounts
and managing insurer
EOBs
in later parts of this course!😅
Saving Your Insurer
Once you’ve finished entering the insurer details, click “Create Insurer” to finish. Continue setting up each insurance company you’ll be billing. There’s no need to set up all possible insurers from the get-go, as you can always come back to this area and create a new insurer later (i.e. if you start treating a client with insurance coverage you’ve never billed before).
💡
Pro tip
: For any insurers you have set up, you can have your patients upload a picture of their insurance card through their intake form. Find some info on that tool
here
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)US Insurance Step 1
US Insurance Billing Training
US Insurance Step 1
6 min read
Practice Plan
Thrive PlanWelcome! If you signed up for Jane’s insurance plan, you are likely super eager to get started. This guide is the first step in setting up US insurance billing. We’re happy you’re here!
To start, there are 3 steps that are required to get your account ready to use Jane’s Insurance features:
Set Up Task
Task Complete
Adding Your Insurers
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/34ae7ba3-0ff7-42b4-b30c-d7860fe4eecd)
- ![](https://jane.app/thumbs/aba6bf2c-9cf9-4eff-854a-ee0e0d82a632)
- ![](https://jane.app/thumbs/e585b4b6-b560-473e-a94e-15d472d67962)
- ![](https://jane.app/thumbs/8a3af924-4fc0-46c2-87e8-7cf756ad7ab0)
- ![](https://jane.app/thumbs/ef8a6bfc-8dce-4b40-935e-305aef4e4570)
- ![](https://jane.app/thumbs/35079ec9-480f-45b0-a776-320d6d9994b5)
- ![](https://jane.app/thumbs/52f445e6-37a4-4289-a17f-9f223f33ffa1)
- ![](https://jane.app/thumbs/2457a835-581f-400e-bc69-630413098b1f)
- ![](https://jane.app/thumbs/06b577a5-6543-4163-935e-857b0b21b63f)
