...
*Source: [https://jane.app/guide/module-1-setting-up-insurers-billing-codes-billing-info](https://jane.app/guide/module-1-setting-up-insurers-billing-codes-billing-info)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:55:58*
...
Feature OverviewModule 1: Setting Up Insurers, Billing Codes & Billing Info
Biller Training
Module 1: Setting Up Insurers, Billing Codes & Billing Info
15 min read
Practice Plan
...
Complete
1.
Setting up insurers, billing codes, and billing info
✍️
2.
Claim submissions & management
☐
3.
Modifiers, creating a custom billing code, changing and adding billing codes
☐
4.
Remittances
☐
5.
A/R tracking (aging claims)
☐
💡
Jane Tip
: We recommend heading over to Jane’s
Demo Clinic
to practice as you learn! If you’re a current Jane user, you can find the login information by clicking the
Need Help?
Button in your account. This password is updated every Monday.
If you haven’t signed up with Jane just yet, you can find the login password by heading to the
Jane Community Group
on Facebook and clicking the
Featured
tab. You can also request the password by emailing
support@jane.app
.
...
Step 1: Setting up insurers (adding, creating & saving)
Step 2: Assigning rates to the clinic’s billing codes (CPT & ICD10) and setting up default allowed amounts & modifiers
...
👉 Click here if you use Availity and submit claims to Medicare
Jane’s EDI formatting and Availity don’t always work well together when it comes to Medicare claims. If you bill Medicare, we recommend using a different clearinghouse.
It’s a good thing to note here that we can skip a ton of manual work in these initial set-up steps by importing both insurers and patient policies. You can find out more about that process by heading to our guide, ‘
Importing Your Insurers and Policies to Jane
’.
...
You will need an account with Full Access permissions to see this page in Settings.
Creating the Insurer
Starting from the Settings tab, scroll down to the
Insurers
...
Important Note: If you’d like to generate your claim submissions electronically to submit through Jane’s integrated Clearinghouse (Claim.MD) or by generating an EDI file for an external Clearinghouse (Office Ally, Trizetto, Availity), you’ll need to add the following fields to the insurer:
Insurer Name
Payer ID
Insurance Program
Saving the Insurer
...
If you’d like to read a more detailed guide on each of the fields, and how they interact with other sections of Jane you can head to
Step 1 of our US Insurance Set-Up Guide
.
Practice Drill 🏈
...
Select
New Insurer
from the top right, and then fill out the following insurer’s information:
Insurer Name - Aetna, Medicare, etc.
Payer ID - Choose an option from the Payer ID dropdown menu
or
type in a custom Payer ID.
Insurance Program - Select any of the choices from the dropdown menu.
Once you’ve finished entering the insurer details, click
Create Insurer
to finish.
Touchdown! 📣
Step 2:
Assigning rates to the clinic’s billing codes (CPT & ICD10)
...
To set up the clinic CPT fees,
scroll down
to find our database search bar. Search to find a CPT code you use, and assign it to the appropriate fee schedules.
Here’s how it works:
Use the search bar to find a CPT code.
Click “
Assign Rate
” to enter the Default Billed Amount for this CPT code in the Billed Amount box.
Enter the Insurer’s Allowed Amounts associated with this procedure code.
Click “
Create Billing Code
” to save this new code to the clinic’s list.
When setting up clinic billing code fees, you can also set up some handy
defaults
to save time, prevent billing mistakes, and make insurer Accounts Receivable more realistic.
These defaults include insurer-specific
Allowed Amounts
and procedure-specific Modifiers. This allows the clinic to account for any Contracted Rates or Fee Schedules that they might have with an insurer.
💡Pro Tip: A Procedure’s Allowed Amount is not sent to the insurer (the default Billed Amount is!) when submitting claims in Jane. Allowed Amounts are only used as the basis for Co-insurance % calculations and internal invoicing.
Practice Drill 🏈
...
Once you’ve found the code you’d like, click
Assign Rate
on the right-hand side.
Enter a $ amount under the
Billed Amount
text box and then
Create Billing Code
.
...
Billing Code Default Amounts & Modifiers
Create Custom Billing Codes
Correcting a Visits CPT/Diagnosis Codes or Modifiers
Step 3: Location & Staff Billing Info
We’re almost ready to start billing! Let’s explore one more area of Jane which has some important ties to insurance submissions in Jane, the Location details and Staff Billing Info. These areas are where you’ll set your Billing Provider, Rendering Provider, and Service Facility info that’ll be used in your claim submissions.
Location Info
...
If you bill/provide superbills for some of your Treatments/Sessions under different POS codes, you can set a default POS code in your Location Settings for your most commonly billed code, and set specific codes in the
Treatment/Session Settings
for appointment types that need it. A super common version of this these days (especially for our friends working in Mental Health!) is offering both in-person and Telehealth services.
...
- typically a Rendering Provider NPI (Box 24i and Box 24j on the CMS-1500)
Once again, if you’d like to read a little bit more on the different areas of the Staff & Location Billing Numbers head over to
Step 3 of our US Insurance Set-Up Guide
Got questions about how to populate a certain box on a CMS1500 form? Or maybe you just want to see where certain areas of Jane relate to your submissions, we’ve compiled all of this in our
CMS Reference Sheet.
Practice Drill 🏈
...
tab and into the
Billing
section on the tab within a profile of your choice.
Scroll down to the Default Claim Information section and click
View.
Enter a new
...
Save.
Touchdown! 📣
Great! Now that we’re all set up and ready to submit insurance, let’s head to
Module 2: Claim Submissions and Management
to learn about actually submitting these claims!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Module 1: Setting Up Insurers, Billing Codes & Billing Info
Biller Training
Module 1: Setting Up Insurers, Billing Codes & Billing Info
15 min read
Practice Plan
Thrive PlanAs a US Biller, there are 5 learning modules for you to walk through before you get up and running with Jane’s insurance features:
Learning Modules
Complete
1.
Setting up insurers, billing codes, and billing info
...
Great! Now that we’re all set up and ready to submit insurance, let’s head to
Module 2: Claim Submissions and Management
to learn about actually submitting these claims!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5e8e398f-d8c7-4675-bf04-c2d74ef6a0c2)
- ![](https://jane.app/thumbs/c2ec7d64-fe4a-4ec5-9a37-710f607cf3d2)
- ![](https://jane.app/thumbs/17e737d9-8cfe-4591-8323-c213d258fb4f)
- ![](https://jane.app/thumbs/6124ea91-843e-459a-867a-ae7e139f330d)
- ![](https://jane.app/thumbs/6e318386-2870-4f5e-b8da-4ab82837f2ca)
- ![](https://jane.app/thumbs/d2f3e38d-b6aa-4a13-a9fe-b99302e4a288)
- ![](https://jane.app/thumbs/993f70aa-e05f-4d16-8aac-06c7430edb9a)
- ![](https://jane.app/thumbs/f11c5237-a6a1-4252-bb1c-845c7398dcfd)
- ![](https://jane.app/thumbs/3c6c7a9e-f4ef-46b1-be97-97bb4b663a95)
- ![](https://jane.app/thumbs/084d6d4b-bac1-46bd-8919-66e5d277cbda)
- ![](https://jane.app/thumbs/837e73b6-c192-494b-821d-08fa926c9c50)
- ![](https://jane.app/thumbs/badec925-db42-4e4c-9a6c-8dfd19a58c2e)
- ![](https://jane.app/thumbs/8ecef2ec-e3a4-4e70-a413-cf64a09ee110)
- ![](https://jane.app/thumbs/fd9f96a8-7767-4ffb-a1be-64d62f969e5d)
