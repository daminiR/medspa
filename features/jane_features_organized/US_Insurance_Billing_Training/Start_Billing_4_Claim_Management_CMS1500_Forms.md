...
*Source: [https://jane.app/guide/start-billing-4-claim-management-cms1500-forms](https://jane.app/guide/start-billing-4-claim-management-cms1500-forms)*

*Category: US Insurance Billing Training*

*Scraped: 2025-08-07 03:52:05*
...
Feature OverviewStart Billing 4: Claim Management & CMS1500 Forms
...
Creating a CMS1500 - Health Insurance Claim Form
Batch CMS1500 Forms
Claim Submission Folders
All insurance claims are managed under the main
Billing
tab in Jane.
...
The
Draft
folder is an optional folder used for reviewing claim information. You can set up your account so that all new claims start here. This folder can be helpful if you have dedicated billing staff who need to easily know which claims have been finalized (i.e. all billing codes have been entered) and are ready to be submitted. When your draft claims have been finalized, they can then be moved to the Unsubmitted folder by the practitioner.
The
Unsubmitted
folder holds all insurance claims ready to be submitted. This is where new EDI files are generated.
The
Submitted
folder holds any claims that have been submitted, and are awaiting remittance from the insurance company.
The
Approved
folder is your “Done” folder! It holds all claims that have been marked as paid or a response has been received.
The
Response Received
folder holds any claims that populate in your
Remittances
folder, that you haven’t yet looked over to record those responses. Once the remittance is recorded, claims in this folder will typically move to your Approved folder if there aren’t any outstanding insurer balances or resubmissions that would need to occur.
The
Waiting on Primary
folder holds any secondary claims that are awaiting primary claims’ adjudication. These secondary claims will automatically move toward your Unsubmitted folder (or Draft if you use this as your review area) once the remittance for any relevant primary has been recorded.
Draft Folder:
If you are interested in using the draft folder as a “review” area, you’ll want to set up this default by heading over to
Settings > Billing Settings > Set New Claim Submissions As…
and select “Draft” from the drop-down menu.
Claim Summary
If you’d like to dive deeper into a claim, you can click the View button to open up the
Claim Summary.
The Claim Summary panel shows you everything you need to know about a particular claim. You can see the following information about the patient’s insurance policy:
the date of service
billing code & diagnosis codes
any submissions you’ve already made towards this claim and the dates of submission
any claim responses you’ve received, and even if they have any secondary coverage!
...
Jane can generate a CMS1500 (or HCFA) form into an editable PDF for claim submission, however Jane cannot print claim details directly onto a pre-printed CMS1500 form.
Once you have Arrived an appointment and have added in all insurance claim information, you can click the downward arrow next to the “Pay” button and select
Generate CMS1500
:
From the Draft or Unsubmitted folder, you can also generate a CMS1500 form by clicking the right side arrow, and selecting
View Purchase
. This form can now be
Printed
, or edited further if required. For editing, it’s best to
Save
the form first and then make any needed edits to the downloaded copy.
​The CMS1500 Forms will print best on blank paper. Some Payers can’t process the claim if it is printed in black and white, so
printing in color
is generally a good idea.
📍 ​Note:
SOF stands for Signature on File. ​This is an accepted term but feel free to remove this if you are printing and signing.
Need a little help figuring out what’s supposed to go into each box (and where that info is coming from in Jane)? Check out our guide to
Insurance claims and the CMS1500
or our
CMS1500 Reference Sheet
.
Batch CMS1500 Forms
Want to export multiple CMS1500 forms in one go? If so, check out the following guide:
Generating a Batch: CMS1500s
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Start Billing 4: Claim Management & CMS1500 Forms
US Insurance Billing Training
Start Billing 4: Claim Management & CMS1500 Forms
6 min read
Practice Plan
Thrive PlanIn this lesson we’ll cover the following Claim Submission topics:
Claim Submission Folders
Creating a CMS1500 - Health Insurance Claim Form
Batch CMS1500 Forms
Claim Submission Folders
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/7d83d8cc-2bc2-4652-bdcc-1cfccbb062bf)
- ![](https://jane.app/thumbs/637a8fed-eff2-481b-a2df-1a7d32278e3c)
- ![](https://jane.app/thumbs/d40e67f6-9a55-4e99-8b0c-2e8022820f01)
- ![](https://jane.app/thumbs/86a316ab-43c7-41ad-be83-aba29ed56c0b)
- ![](https://jane.app/thumbs/52dda69f-48fe-4b77-a72a-32328a497574)
- ![](https://jane.app/thumbs/3cb10575-e566-498b-ac59-cf5c67f40dba)
