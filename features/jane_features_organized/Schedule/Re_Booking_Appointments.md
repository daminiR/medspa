...
*Source: [https://jane.app/guide/re-booking-appointments](https://jane.app/guide/re-booking-appointments)*

*Category: Schedule*

*Scraped: 2025-08-07 00:09:29*
...
Feature OverviewRe-Booking Appointments
Schedule
Re-Booking Appointments
2 min read
Balance Plan
Practice Plan
Thrive Plan
Jane offers users a couple of ways to manage repeat appointments. See
Recurring Appointments
to learn how to set up appointments that repeat automatically at regular intervals. Or, to learn how to quickly re-book appointments using the copy and paste tools, read on:
...
💡
Pro tip:
If you re-book a patient
before
billing them, you can automatically print their upcoming appointment(s) onto their receipt. Check out our guidance on this here:
Add Upcoming Appointments to Receipts
. Nice.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Re-Booking Appointments
Schedule
Re-Booking Appointments
2 min read
Balance Plan
Practice Plan
Thrive PlanJane offers users a couple of ways to manage repeat appointments. See
Recurring Appointments
to learn how to set up appointments that repeat automatically at regular intervals. Or, to learn how to quickly re-book appointments using the copy and paste tools, read on:
First, click on the patient’s last appointment in the Schedule. The Appointment Pane will appear on the right.
Click on the “Copy” button in the Appointment Pane.
...
billing them, you can automatically print their upcoming appointment(s) onto their receipt. Check out our guidance on this here:
Add Upcoming Appointments to Receipts
. Nice.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/74a6ae8b-69a0-4fa8-b1d1-2faf1609e394)
- ![](https://jane.app/thumbs/66eff6f8-c0bc-4d36-8a91-44cd5e175065)
- ![](https://jane.app/thumbs/79f52316-84cf-45c1-9cec-b28088c23128)
