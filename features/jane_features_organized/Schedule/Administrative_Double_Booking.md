...
*Source: [https://jane.app/guide/double-booking](https://jane.app/guide/double-booking)*

*Category: Schedule*

*Scraped: 2025-08-07 00:16:57*
...
Feature OverviewAdministrative Double Booking
Schedule
Administrative Double Booking
3 min read
Balance Plan
...
Legacy Plans
Are you:
A practitioner with the ability to see multiple patients at once?
An office administrator trying to double book a practitioner but can’t fit it in the shift?
A staff member trying to book a Break next to an appointment?
Have no fear our Double Booking feature is here!
Before getting started with the Double Booking feature, you would need to ensure this setting is turned on under
Settings
>
Schedule Settings
>
...
Once you have completed the fields required for the New Appointment, you can hit
Book Appointment
and Jane will Double Book the appointment at the Time you specified.
Additional Notes
Online double-booking and the ability to prevent double-booking for specific appointment types requires access to our advanced scheduling features
Rooms
and/or
Resources.
These features are available to clinics on the
Thrive Plan
.
Check out our guide on
Resource Booking
for more detailed information on how you can use this advanced scheduling feature to prevent double-booking for specific appointment types.
Since online double booking uses a different setup, we’ve put together a
Online Double Booking
guide which covers this process from start to finish.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Administrative Double Booking
Schedule
Administrative Double Booking
3 min read
Balance Plan
...
Since online double booking uses a different setup, we’ve put together a
Online Double Booking
guide which covers this process from start to finish.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/9257bccc-aada-428c-afe5-a3da9099193b)
- ![](https://jane.app/thumbs/e22a3e60-42c9-4604-98fe-a86dba5894e3)
- ![Screenshot of booking an appointment on a mobile device](https://jane.app/thumbs/05b66be6-9469-4d62-a6bd-487159fe8665)
