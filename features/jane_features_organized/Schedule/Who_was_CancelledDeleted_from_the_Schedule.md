...
*Source: [https://jane.app/guide/who-was-cancelled-deleted-from-the-schedule](https://jane.app/guide/who-was-cancelled-deleted-from-the-schedule)*

*Category: Schedule*

*Scraped: 2025-08-07 00:13:49*
...
Feature OverviewWho was Cancelled/Deleted from the Schedule?
Schedule
Who was Cancelled/Deleted from the Schedule?
5 min read
Balance Plan
...
Click the
cogwheel
icon at the bottom right of the page to pull up the Schedule Settings window.
...
Click on the appointment for more details. The
History & Status
area at the bottom of the appointment panel records who deleted or cancelled an appointment, who rescheduled or moved an appointment, and when other changes were made and by whom.
...
Jane keeps track of everything related to appointments, from online bookings to arrivals and cancellations.
To view the
Appointments Report
...
tab and click on
Appointments
in the left sidebar menu. From there, you’ll be able to filter the report based on the location, staff member, date range, appointment status (i.e. canceled, deleted etc) or chart status.
Note
📝:
Currently, this report cannot be filtered by specific treatments or individual patients.
3. Patient Profile
...
The other place on the patient profile that is really handy in investigating appointment mysteries is the “Communications” tab.
There, you can see if the patient was emailed any booking or reminder notifications about the appointment in question.
Group Appointments
Jane will remove the participants and the
History & Status
portion of the
Appointment Panel
for cancelled or deleted group appointments.
Note📝:
Class appointments retain the information within the Appointment Panel on the
Schedule.
There are two different ways you can view the details of the cancelled or deleted group appointment:
Patient Profile
If you remember the names of the participants, you can head over to their
Profile
, click on the
Appointments
tab and then use the filters to narrow down the data to just cancelled or deleted appointments.
From there, you can click on the appointment and scroll down within the
Appointment Panel
that slides out from the right to the
History & Status
section.
Appointments Report
If you’re unsure which participants were part of the group appointment,  you can head over to the
Reports
tab, and click on
Appointments
within the left sidebar menu. From there, you’ll want to ensure the report is filtered to the correct date and appointment state (cancelled or deleted).
We hope this helps you solve the mystery, but feel free to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Who was Cancelled/Deleted from the Schedule?
Schedule
Who was Cancelled/Deleted from the Schedule?
5 min read
Balance Plan
Practice Plan
Thrive PlanWhether it was an “oh shoot” administrative error, or a mysterious spot you were sure used to be filled by a patient, or someone showing up in a spot where they don’t have an appointment there are a few ways to troubleshoot missing appointments.
1a. From the Schedule
Click the
cogwheel
icon at the bottom right of the page to pull up the Schedule Settings window.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/c2ac07e9-f24e-4126-a86b-54d2d5076253)
- ![](https://jane.app/thumbs/b2b50659-53da-4aa6-97a1-eb85eb36366b)
- ![](https://jane.app/thumbs/31fd8ef0-e991-4411-8706-1bed60576c9f)
- ![](https://jane.app/thumbs/9b03274b-86dd-4449-80e9-e6bdbb3809b0)
- ![](https://jane.app/system/dragonfly/production/2015/11/22/5ld7q9mq7v_blob)
- ![](https://jane.app/thumbs/92ef9858-94f1-41ad-b082-bf3d709643e9)
- ![An image of the report filtered to Cancelled](https://jane.app/thumbs/9fc3231f-759b-473e-90bf-a68c985c92a6)
- ![](https://jane.app/system/dragonfly/production/2015/11/22/c4kwuefrz_blob)
- ![](https://jane.app/thumbs/5ab2b94d-6219-4925-a852-78e311959c6c)
- ![An image of the schedule when the cancelled schedule filter is turned on and you've clicked on the black appointment block](https://jane.app/thumbs/bcd106a8-ed34-4e1a-8d31-0570e5d4ffd5)
- ![An image of the appointments tab within the patient's profile and how to filter the appointment state](https://jane.app/thumbs/45ee4783-ca17-4bd2-8002-0991c04ef9a3)
- ![An image of what the appointment panel looks like once you click on the appointment](https://jane.app/thumbs/f300ec37-338c-490c-a1ca-a1ed681ad157)
- ![An image of the appointments report filtered to the specific date and appointment state](https://jane.app/thumbs/2bd15b38-4a6f-4e27-bb46-fb8e2429a94e)
