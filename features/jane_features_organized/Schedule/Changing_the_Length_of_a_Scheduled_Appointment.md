...
*Source: [https://jane.app/guide/changing-the-length-of-a-scheduled-appointment](https://jane.app/guide/changing-the-length-of-a-scheduled-appointment)*

*Category: Schedule*

*Scraped: 2025-08-07 00:17:09*
...
Feature OverviewChanging the Length of a Scheduled Appointment
Schedule
Changing the Length of a Scheduled Appointment
3 min read
Balance Plan
...
adjust scheduled appointments
to make them longer or shorter than the usual treatment length? This can be helpful if you have clients that may need more or less treatment time, or need some extra time to get in/out of your treatment space.
Let’s take a look!
This will work for
Shifts
and
Breaks
too once you’ve clicked the Shift or Break button!
Time to give it a go
Hover
your mouse over the appointment you would like to adjust.
A double arrow will appear in the bottom right corner of the appointment:
click it!
Small dots
will appear on the top and bottom of the appointment. You can use these to
pull
the appointment up to start earlier or down to end later.
Jane will ask if you would like to
Confirm
or
Confirm and Notify.
If you’d like an email to be sent to your client with the time change, you can click Confirm and Notify. If not, you can click Confirm.
Additional Notes & FAQ
⭐️The scheduled length for my appointments isn’t correct. How can I fix this?
A staff member with
...
Details
section and ensure that the schedule length either matches the treatment length or is the
treatment length + any additional time
to reset the room, complete charting, etc.
For example, if you have a 60-minute massage appointment but would like to add 15 mins in between appointments to reset the room, you’ll want to ensure the
Treatment Length
is
1 hr
and the
...
Note
📝:
If staff members need different amounts of time between appointments, you can adjust this in their
Staff Profile
. Go to
Edit/Settings
>
...
and update the
Post Treatment Time
setting. The setting within the profile will always override the overall settings for the treatment. For more details on various staff schedule settings, check out this guide:
Step 4: Staff
For more details, you can check out this guide:
Setting up Treatments
📱 If you are on a
tablet or mobile device
, you can easily change appointment lengths by
tapping and holding
the appointment you would like to adjust. Now, you can drag the appointment (or shift or break) up or down to extend it.
That’s all, folks! Happy adjusting ☺️
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Changing the Length of a Scheduled Appointment
Schedule
Changing the Length of a Scheduled Appointment
3 min read
Balance Plan
Practice Plan
Thrive PlanDid you know you can
adjust scheduled appointments
to make them longer or shorter than the usual treatment length? This can be helpful if you have clients that may need more or less treatment time, or need some extra time to get in/out of your treatment space.
Let’s take a look!
This will work for
...
tapping and holding
the appointment you would like to adjust. Now, you can drag the appointment (or shift or break) up or down to extend it.
That’s all, folks! Happy adjusting ☺️Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/8e79d528-ddf9-4d10-9c37-93ab7072467d)
- ![](https://jane.app/thumbs/50fb67b6-284b-49ef-b32d-a8243e8b6e8a)
