...
*Source: [https://jane.app/guide/patient-arrivals-no-shows](https://jane.app/guide/patient-arrivals-no-shows)*

*Category: Schedule*

*Scraped: 2025-08-07 00:08:23*
...
Feature OverviewPatient Arrivals & No Shows
Schedule
Patient Arrivals & No Shows
4 min read
Balance Plan
...
June 13th, 2023
:
Recently, we made an update to the colour of Arrived appointments where the client invoice is paid or is $0. You can
read about that initial change here
.
Following feedback from our awesome community, we’re making some updates to the feature. You can read all about those (and any other upcoming changes!) on
our feature request board.
Thank you for always letting us know what you think. 💙 - The Jane team
Arrivals & No-Shows
When a patient arrives — or fails to arrive- for an appointment, you can set their appointment’s status to “Arrived” or “No Show.” This automatically creates an invoice for the appointment, and it tells practitioners at a glance when their next patient has been checked in by a staff member.
Think of marking the appointment as “Arrived” as a way to check in a patient manually.
Need to charge for these invoices? Check out our guide doc on
No Show and Late Cancellation Fees
for more detailed information on how to set these fees up!
❗️ If you’re on the Insurance Plan, and mark a visit as a No-Show
while the insurance policy is attached to the visit, this will count the No-Show visit toward the max number of visits set for the policy
, if that is set.
To ensure that only visits the patient came in for (visits we would mark as Arrived) count against that max number of visits, remove the insurance policy from the appointment prior to marking it as a No-Show.
You can do this by following the steps outlined at the bottom of
this guide
.
Here’s the lowdown:
Click on the appointment in the Schedule view. The Appointment panel will appear on the right.
The “Arrived” and “No Show” buttons are at the top of the Appointment pane. Click either button to set the status of the appointment. Dealing with a
Late Cancellation?
...
When an appointment has been Arrived and you have collected the entire
client-owed amount
, it will now turn
dark green
!
...
at-a-glance
if there are any past appointments that you need to collect client payments for.
💚 Light green = Arrived + client balance is
unpaid
🌲 Dark green = Arrived + client balance is
paid
or $0
📌 Please note that the appointment will turn dark green any time the client-owed amount is $0. For example:
...
If the colour change isn’t helpful for you, you can turn it off by clicking on the cogwheel ⚙️ in the lower right corner of your Schedule, and then toggling off
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Patient Arrivals & No Shows
Schedule
Patient Arrivals & No Shows
4 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/77f1f1a8-008f-4555-a356-0633cc53aaa1)
- ![](https://jane.app/thumbs/2ce37cae-5a3d-4b63-a2e3-3bf7a58d192e)
- ![](https://jane.app/thumbs/cfe512ae-99fa-4431-9b3e-1a041e8ec9ac)
- ![](https://jane.app/thumbs/29a32cb6-3b07-4636-b057-ed8e10a63afc)
