...
*Source: [https://jane.app/guide/setting-up-treatments](https://jane.app/guide/setting-up-treatments)*

*Category: Schedule*

*Scraped: 2025-08-07 00:11:36*
...
Feature OverviewSetting up Treatments
Staff Profiles
Setting up Treatments
10 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Jane’s default is to call the services a clinic offers ‘Treatments’, but you can customize this depending on what you call the services you offer your clients. This guide to
Customizing Jane
(under ‘Terminology’) tells you how you can change Jane’s default language.
Now let’s get started on how you can add services, treatments or sessions to your Jane account. Staff members with
Full Access
or the
Account Owner
can create or add a new appointment type by heading over to the
Settings
tab and selecting
...
Click the
New Treatment
button in the top, righthand corner (or the
Edit
button next to an existing Treatment) to get started.
💡
Jane tip
: If you’re creating multiple treatments that are similar, check out the section below on
duplicating treatments
to save some time. We don’t currently have a limit on the number of treatments you can add to your Jane account at the moment.
If you ever decide you no longer want that Treatment in your list, you can
Archive it
and Jane will tuck it away for you.
Feel free to jump to a section below:
Appointment Type
Discipline and staff member
Details
Treatment Colours
Online Booking Settings
Duplicating a Treatment
Appointment Type
The first thing you’ll need to choose is whether this appointment type is a
One-on-One
,
Class
, or
Group Appointment
using the dropdown menu. If you choose Class or Group Appointment, you’ll be able to select the
Capacity
(number of participants) using the next dropdown below.
Classes are for multiple unrelated clients, like a yoga or Pilates class. For more on Class Bookings, head here:
Class Booking
.
Group Appointments are for multiple (often related) clients joining a session together, like a Family Counselling session. To learn more about Group Appointments, head here:
Group Appointments
.
Finally, let Jane know if this is an
In-Person
or
Online Appointment
. If you choose Online, Jane will automatically send your client or clients a link to join the video call 1-hour before their appointment.
Jane offers
1:1 Online Appointments
, which are included in all accounts, and
Online Appointments for Groups
as an optional paid add-on.
Discipline & Staff Member
Select the
Discipline
(type of practitioner) that will be offering this Treatment.
Next, you can choose the Staff member that will be offering it. If you select No Staff Member (Shared Treatment) then any Staff member of that Discipline will be able to choose to offer this Treatment. If you
specify one practitioner
, it will only appear under their name.
...
When offering online booking to your customers, you will want to know all of your options so we’ve created a handy guide to break those options down:
Choosing What is Offered Online
.
🙂 Staff Profiles
To see this in action, head into the Staff Profile of someone in the Discipline that you created the Treatment for.
If you have specified them as a Staff Member on any Treatments, those will appear at the top of their
...
Details
Continuing filling in all the details you need to identify the treatment, including
Treatment Length, Scheduled Length, Price,
and
Income Category.
You can pick specific colours for your cash versus insurance appointments, in-person versus telehealth sessions and so on, changing how they would appear on the admin Schedule!
❗
Pro Tip
: You can set your Scheduled Length shorter or longer than the Treatment Length in order to allow for staggered booking or clinic-wide post-treatment breaks. You can learn more about
Setting Up Staggered Appointments
and
Setting Up Post Treatment Breaks
in our handy guides.
The
Description (Before Booking)
is a feature designed to provide your patients with a bit more information about what they can expect for their visit before booking the appointment. This is a hardcoded setting for clinics on a
Legacy
,
Thrive
or
Practice
plan as they have online booking features.
Treatment Colours
Looking to change the colour of the appointments on the administrative schedule? Here’s where to do it! Just below the
Details
section is where you get to choose the colours of your treatments. These colours are handy for differentiating the treatment types at a glance 🎨
...
to learn more about using accessibility mode in the schedule.
These colours are displayed on the administrative side of your Jane account only. To customize how your online booking site appears, check out our guide doc on
...
Call to book
means that clients will be able to see the appointment availability online, but will have to call you to have you book it for them on the admin Schedule. It gives you a little bit of extra control over your Online Booking.
Display price on Online Booking Pages
: Toggle this setting on to show appointment prices to patients while booking their appointments online or off so prices aren’t displayed.
Don’t forget to hit
Create Treatment
and you’re good to go!
Duplicating Treatments
If you’re adding multiple services that are pretty similar, then you can make one and duplicate it to speed up the process. This is great for treatments that share most of the same settings but just need a few tweaks, like 30, 60, and 90-minute massages, for example.
From
Settings > Treatments, Classes & Group Appointments
, click the
Duplicate
button next to the treatment you’d like to copy.
...
Once you’ve made your changes, just click the
Save
button.
Additional Notes
Does Jane set a maximum number of treatments or services that can be listed within the dropdown menu while booking an appointment?
Currently, you don’t have a set maximum on the number of treatments you can create in your Jane account, but we recommend keeping it streamlined to avoid performance issues (i.e. slow loading times).
Can you edit treatment details at a later date?
Yes, absolutely! Sometimes you may need to update a treatment. For example, you may be rebranding session types and want to change the name of a treatment. You can do so by heading to
Settings > Treatments > Edit
. You can edit the name and then click
Update Treatment
to save the changes.
It can be helpful to note that the new treatment name will appear as the name for previously booked appointments. If you wish to keep the previous name for records, you may want to duplicate the treatment, edit the name, and then archive the past treatment.
If you need a hand with your treatments,
let us know
, and we’ll be happy to help.
Why don’t I see the
Description(Before Booking)
option when I view my treatment details?
It’s likely that your clinic is on the
Balance plan
and there currently isn’t a way to add that box in without upgrading your Jane account.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Setting up Treatments
Staff Profiles
Setting up Treatments
10 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansJane’s default is to call the services a clinic offers ‘Treatments’, but you can customize this depending on what you call the services you offer your clients. This guide to
Customizing Jane
(under ‘Terminology’) tells you how you can change Jane’s default language.
Now let’s get started on how you can add services, treatments or sessions to your Jane account. Staff members with
Full Access
...
It’s likely that your clinic is on the
Balance plan
and there currently isn’t a way to add that box in without upgrading your Jane account.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps](https://jane.app/thumbs/9f8b15dd-18a6-496c-92b4-fce56d3413e5)
- ![An image of the first part of adding treatments, services or sessions to the Jane account](https://jane.app/thumbs/8eb68a05-29aa-4948-9031-b032fcc27967)
- ![](https://jane.app/thumbs/71b9cac2-d3ed-4295-a2a8-d71cfaea0b71)
- ![](https://jane.app/thumbs/bf700649-0d35-41d2-8c5b-8c97ced6c60b)
- ![](https://jane.app/thumbs/a2d8af90-6193-43f3-9cc3-3b7d4e62f2fa)
- ![](https://jane.app/thumbs/748eae6e-88f3-4ba5-8166-2291fb96c234)
- ![](https://jane.app/thumbs/1c00bdf4-3b7f-49bc-ba30-e8af103c6c09)
- ![](https://jane.app/thumbs/e8777359-8e88-4b10-836f-3f7e0644c047)
- ![](https://jane.app/thumbs/c61337a1-8cd8-40f3-ac6f-df6be388b302)
- ![](https://jane.app/thumbs/e00b680d-f8dc-42ff-bf04-80fc924e4cab)
