...
*Source: [https://jane.app/guide/using-the-wait-list](https://jane.app/guide/using-the-wait-list)*

*Category: Schedule*

*Scraped: 2025-08-07 00:13:24*
...
Feature OverviewUsing the Wait List
Schedule
Using the Wait List
8 min read
Balance Plan
...
Jane’s Wait List
features, like sending Wait List Notifications, you can
hop on over to this page!
Here are some of the basics of Wait Lists in Jane!
Adding, Viewing, Editing, or Removing clients from the Wait List
Booking a Wait List client (for those not using Wait List Notifications)
The Wait List Report
Additional Notes
Adding Clients to the Wait List
To open up each practitioner’s Wait List, you can either click the
Wait List
button on the top right side of the
Schedule,
or you can click the little numbered bubble next to their (or your!) name.
...
💡
Fun Fact
: the Wait List is arranged to show clients who have been waiting the longest at the top and any newly added clients at the bottom!
...
By default, clients’ availability will be set for all of the day you add them on. You can update the times, date range, and days they’re available under the
Availability
section of the panel. If the client is available any time for a week or a month, you can use the “Anytime for a Week” or “Anytime for a Month” buttons to set their availability in a single click.
...
Fun Fact
: You can let clients add themselves to the Wait List in your Settings under the Wait List tab!
Editing Wait List Clients
You can change a Wait List client’s preferences and availability at any time by clicking on their name on the Wait List and using the
Edit
button once the Wait List panel has opened.
Removing Wait List Clients
To remove a client from the Wait List, you can click on their name and use the
Remove
button once the Wait List panel has opened.
Booking Wait List Clients
If you’re using the Thrive or Legacy plan, Check out Jane’s
Wait List Notifications!
Otherwise, here’s how you can book your client’s from the Wait List:
...
Book
button and then click on an empty time slot in the schedule to drop the Wait List client in. You will see an alert saying that the appointment has been booked and you’ll have the option to leave the client on the waitlist or remove them:
If you receive an error, double-check that the time slot you’ve chosen doesn’t overlap with an existing appointment.
The Wait List Report
Curious to see who’s on the waitlist for specific days? We’ve got a report for that!
To start, you’ll want to head over to the
Reports
tab and then click on
Wait List
within the left sidebar menu.
There are a number of filters at the top of the page you can use to help narrow down the data:
Staff Member:
The practitioner they’re on the waitlist for. Staff with
Practitioner Front Desk
or
Limited
access will only be able to view their own waitlist data. Users with
Administrative / All Billing Access
or
higher
can view the entire clinic’s waitlist.
Created Date:
This would be the date that the client added themselves, not the date they’re requesting.
Location:
If you have multiple locations, you can narrow this down based on where they’re requesting the visit.
Pro-tip
💡:
While there isn’t a way to filter this report to a specific patient, you can use your browser’s search function (
CMD + F
for Mac and
CTRL + F
for PCs) to highlight a patient’s name anytime it appears on the page. So if you’re looking to see the days a patient is waitlisted for, you can use your browser’s search function to find their name and look to the column on the right to see which days they’re on the waitlist for.
If you need to export the Wait List, you can head over to the
Reports
tab and select
Wait List
within the left sidebar menu. Next, you’ll want to click on the
...
How can I adjust the waitlist availability?
Whether it’s a patient adding themselves to the waitlist or a staff member, they will always be able to select any day of the week (Monday to Sunday), but the hours they can select are based on the clinic’s opening and closing times, which are set up in the
Settings
tab >
Schedule Settings
.
Currently, Jane does not have the ability to customize the available times when selecting the desired time for the waitlist request. The hours offered do not vary based on scheduled shifts or working hours of the specific staff member for whom they are creating a waitlist.
To allow clients and patients to add themselves on to the waitlist, a
Full Access
user can head over to the
Settings
tab and click on
Waitlists
in the left sidebar menu. Next, you’ll want to make sure that
...
To add or view a waitlist request, clients and patients can click on
Upcoming Appointments
in the left sidebar menu and then on
Add a Waitlist Request
in their My Account portal:
Here’s a link to our guide on
Waitlist Notifications: Client Experience
which has more detailed information on what it looks like on their end of things.
NOTE 📍
:
When a client adds themself to the waitlist the clinic
will not
be notified or sent an alert, however, you can review the practitioner’s waitlist from the
Schedule
tab
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Using the Wait List
Schedule
Using the Wait List
8 min read
Balance Plan
...
tab
.
Let us know if you have any additional questions, our support team would be happy to help 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/12f36992-ca3a-4b20-ae2b-ae83e51f2fbb)
- ![](https://jane.app/thumbs/9603aeb7-8b99-4fc6-ae02-b0e155a3916e)
- ![](https://jane.app/thumbs/af372a09-42bf-4b9c-9826-3b39ed73e553)
- ![](https://jane.app/thumbs/5e79e8d3-de4e-425a-b590-15e71da3e07c)
- ![](https://jane.app/thumbs/cfc656b2-aca3-41e3-b3e4-800d51543696)
- ![](https://jane.app/thumbs/ecdd4067-f949-45c6-89ad-852185852adf)
- ![](https://jane.app/thumbs/5e0f80f0-d72d-4bd4-8455-b3cc2a9f0348)
- ![](https://jane.app/thumbs/c3faea36-8073-418f-8def-c302daa680f0)
- ![An image of where to find the report and what the data looks like](https://jane.app/thumbs/cbe2556a-308f-4c9c-9d6f-4268057b578a)
- ![An image of the navigational steps to get to the report and where to click to export it](https://jane.app/thumbs/c992cafc-d15f-409a-8877-00fada3c7051)
- ![](https://jane.app/thumbs/f084313f-73af-44ab-b56e-26c2a42aa3ef)
- ![](https://jane.app/thumbs/6227ce86-00ea-4da4-a3dd-fff9b4a82a2e)
