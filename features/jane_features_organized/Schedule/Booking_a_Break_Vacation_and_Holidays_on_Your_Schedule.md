...
*Source: [https://jane.app/guide/booking-a-break-vacation-and-holidays-on-your-schedule](https://jane.app/guide/booking-a-break-vacation-and-holidays-on-your-schedule)*

*Category: Schedule*

*Scraped: 2025-08-07 00:07:01*
...
Feature Overview​Booking a Break, Vacation and Holidays on Your Schedule
Schedule
​Booking a Break, Vacation and Holidays on Your Schedule
9 min read
Balance Plan
...
If you need to block off time on your schedule, diary, or calendar, there are 2 ways to do this:
1. Using Breaks
You can use the
Break
feature to block out time in your staff calendar for activities that aren’t related to client or patient appointments. This is a quick option for scheduling a day off or blocking off parts of your day.
Some common uses for Breaks include:
Reserving a spot on your schedule for your patients without booking in an appointment (maybe the patient needs to double-check availability on their end)
Blocking off your lunch breaks
Adding non-billable meetings like staff meetings or training sessions to your schedule
Booking vacation time
Any time spent out of office
The list goes on!
2. Removing Shifts
You can remove shifts from an individual (or multiple practitioners) schedule using the
Manage Shifts feature
. This option is great if you need to book staff members’ holidays or vacations.
...
For booking breaks on a smartphone, mobile device or any small screens, review this page and then see
this guide doc instead
.
Booking a Break
Click and release the “Break” button at the bottom left of the schedule. It will turn blue when it’s activated.
Then, click where you want the break to start. Just clicking once will open up a “New Break” panel on the right where you can set the “end time”, or you can click and then drag on the schedule (as if you’re highlighting text) to create the length of the break in one go.  It’s okay if it’s not perfect as you’ll have a chance to edit the start and end time when you release the drag.
...
You’re still also able to use breaks if you’d like to label your lunch breaks on your schedule, if you prefer!
...
If you or your staff are taking time off, or going on vacation and holiday, you can use the break to cover the entire shift. This is a great option for all staff with access to your schedule to know why the shift isn’t available to be booked. You can also add notes, such as who might be covering that shift or that the staff member is way of vacation.
Administrative Notes & Meetings
The final reason we sometimes use Breaks in Jane is to remind staff or practitioners of administrative tasks that need to be performed. For example, if you have a team meeting coming up, staff can pop a break into their schedule to prevent any patient or client bookings.
Then, when that staff member logs in for their day it would look like this:
This workflow can also be used if the clinic has non-billable meetings they’d like to block off time for, like staff meetings, interviewing new staff, or setting aside some time to call Jane if the clinic needs a hand with something 😉
Deleting a Break
To delete a break on the schedule, click on it and then you will get an option to update or delete the break.  Jane will find any other break with the same start and end time and treat them as a group.
Note - you may not have created the break as a series, but Jane will look for others that are similar
Then you can delete or change just that one break or all of the ones listed.
💡
Jane tip
: You can view deleted breaks by filtering to
Breaks
on the
Appointments Report
. To see a detailed history of changes, including which staff member modified a break, click the
...
History & Status
section.
For more info about the Appointments Report, feel free to check out this guide page:
Appointments Report
...
Jane has another way for you to quickly schedule staff holidays using the
Manage Shift feature
. Take a peek at the two scenarios below to choose the one that applies to you!
I’d like to remove multiple shifts from one practitioner’s schedule.
In this case, Jane’s
Manage Shifts
tool will get the job done faster.
Important first step: Select your staff member within your schedule view first.
Open up your
Manage Shifts
tool,
set the date range to the exact dates you’d like removed
, then be sure that there are
no shifts populating
to the left of your Manage Shifts window. If there are, simply click the
X
to remove them.
Here’s a fresh example after having removed all of my shifts to the left so that Zoey can go on holiday between
...
Now, with the Manage Shifts window open, you can select your date range in which you’d like your shift schedules removed, select your staff members from your staff list, and remove any shifts to the left. If your shift schedule is
empty
, then
Jane will know to remove all existing shifts within the date range you’ve chosen.
💡
Note
:
Being the overprotective parents that we are, Jane would like to remind your clinic to be extra careful when selecting the date range here. Any shifts within this range will be removed so long as your shift schedule is empty.
In this example below, I am removing
ALL EXISTING SHIFTS
for Amy, Jonathan, and Zoey between
December 25th and January 1st.
🔴
Warning:
If you see
no Shifts populated to the left
of your Manage Shifts window, and you proceed by clicking “
Apply Shift Schedule
”, then you are
overriding your existing schedule
by
removing all existing shifts between this date range.
Jane will open a pop-up box that says, “
Please note: if you already have shifts created, continuing will override those shifts”.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)​Booking a Break, Vacation and Holidays on Your Schedule
Schedule
​Booking a Break, Vacation and Holidays on Your Schedule
9 min read
Balance Plan
Practice Plan
Thrive PlanWell, I guess you can’t work all the time!
If you need to block off time on your schedule, diary, or calendar, there are 2 ways to do this:
1. Using Breaks
You can use the
Break
...
removing all existing shifts between this date range.
Jane will open a pop-up box that says, “
Please note: if you already have shifts created, continuing will override those shifts”.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/721d005e-332e-46ee-9411-56ce86aa814e)
- ![](https://jane.app/thumbs/acf751e7-8577-4022-9f83-80df14caa207)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/16l62tkw2b_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/444ztdoyk8_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/6quhxgsavc_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/5akve50qpz_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/9tqx5l5hot_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/yoev6uy81_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/6edv2qwu42_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/1q8f98lq51_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/9ijnxfhia2_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/69wp6n0hou_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/02/5oihsr6vah_blob)
- ![Appointments Report filtered to Breaks](https://jane.app/thumbs/dbe9769b-b822-459e-8b69-df45406adea9)
- ![](https://jane.app/thumbs/cbad0e4f-40fc-44b5-aa2e-83e87178daff)
- ![](https://jane.app/thumbs/af980979-0458-486e-86da-43be7546a3db)
- ![](https://jane.app/thumbs/83d01684-e7bc-4821-a6dc-f03c5669bf2c)
- ![](https://jane.app/thumbs/9d7e3c79-4049-481f-b855-2f01e7183464)
