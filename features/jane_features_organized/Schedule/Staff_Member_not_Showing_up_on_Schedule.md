...
*Source: [https://jane.app/guide/staff-member-not-showing-up-on-schedule](https://jane.app/guide/staff-member-not-showing-up-on-schedule)*

*Category: Schedule*

*Scraped: 2025-08-07 00:15:07*
...
Feature OverviewStaff Member not Showing up on Schedule
Schedule
Staff Member not Showing up on Schedule
3 min read
Practice Plan
...
, but they aren’t showing up on the schedule yet.
Here’s a couple of things to check!
1️⃣ Have you opted them into a discipline yet?
For practitioners to display on the schedule in Jane, they will need to be opted into a discipline. This will allow Jane to determine that the practitioner should be listed on the Schedule, and allow them to book shifts and appointments. This is also true for the discipline to appear on the online booking site.
To opt the practitioner into their discipline, you can head to the
Staff Tab
on the top-blue bar, and from there select the staff member from the left-hand side of the staff list.
...
Once the staff member has been selected, you can select
Edit/Settings
under their name.
From here, you can select the
Discipline
that the practitioner falls under by selecting the check box beside their discipline. Hit
Save
in the bottom right to update.
...
If that’s the case, you will just want to create their shifts for them. I’ve demonstrated this in the GIF below, but here’s
Guide on Shifts
as well in case you wanted to check that out.
If neither of these seem to be the solution, feel free to reach out to us by clicking the
Need Help?
button in the top right of your Jane screen, just make sure that you provide us with enough information to look into the situation, such as the practitioner’s name.
If ever you need help with patient profile– you will want to avoid using their name or any identifiable information. Check out our Guide on
Getting Help with Jane
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Staff Member not Showing up on Schedule
Schedule
Staff Member not Showing up on Schedule
3 min read
Practice Plan
Thrive PlanSo you’ve just
added a new staff member
, but they aren’t showing up on the schedule yet.
Here’s a couple of things to check!
1️⃣ Have you opted them into a discipline yet?
...
If ever you need help with patient profile– you will want to avoid using their name or any identifiable information. Check out our Guide on
Getting Help with Jane
for more information!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/58a384f9-aaea-4d6a-99c1-86d8365afe54)
- ![](https://jane.app/thumbs/9c41808b-0714-443c-ac61-3b4616d330ab)
- ![](https://jane.app/thumbs/bc049e42-0242-4951-877f-9707e7a7ef3c)
