...
*Source: [https://jane.app/guide/room-booking](https://jane.app/guide/room-booking)*

*Category: Schedule*

*Scraped: 2025-08-07 00:10:20*
...
Legacy Plans
Room Booking
Need to see more than one patient at a time? Or do you have rooms dedicated to specific providers at a time? If so, you might find
Rooms
in Jane helpful to organize your schedule!
...
💡Jane tip — can you see multiple clients at once but need your appointments to start at slightly different times? Check out how to create a
Staggered Booking Setup
.
A quick note before we get started — if your clinic has
shared
rooms that any provider can book on a first-come-first-served basis, you’ll want to use
Resource Booking
instead of Rooms so that you don’t overbook your spaces.
Creating Rooms
A
Full Access
user can set up Rooms in Jane, but first, you’ll need to head to your
Settings
>
Schedule Settings
and turn on
...
Optional:
You can then choose to assign a
specific
practitioner’s existing shifts to a room.
We recommend selecting
Skip This Step
if the staff member already has upcoming appointments or the Room will be used by any other providers, as that will affect those current booked appointments:
...
Creating or editing individual Shifts
Using the
Manage Shifts
tool
...
Click the
Shifts
button in your Schedule to go into Shifts mode
Click on the Shift you want to assign to a Room
Use the
drop-down menu
to choose a Room and
Save
If that Shift repeats and is part of a series, Jane will ask if you want
all future Shifts
to be assigned to that room, or if you only want to change
this one Shift
:
💡 Heads up — if multiple practitioners are assigned to the same rooms
at the same time
,
you can accidentally overbook the rooms!
Make sure only
one provider
is using a room at a time, or use
Resource Booking
if staff are competing for the same rooms.
>
Once you’ve assigned your Shifts to Rooms, you can check your
Rooms View
for scheduling conflicts and to make sure everything’s set up the way you need 👇
...
Then you’ll see a
Rooms
button pop up in the top-right corner:
Daily View of All Rooms
If you click
Rooms
, you’ll see which providers are assigned to your rooms
per day
:
Seeing Rooms per day is the default view, but you can use the
arrow buttons
at the bottom of your Schedule to go to a different date, or click
Week
to get the weekly overview of your room usage:
Just a heads up — Rooms are ordered by their capitalization first,
then
alphabetical order. So if your room names were spelled like, “alpha, Bravo, charlie, DELTA”, they would display like, “Bravo, DELTA, alpha, charlie”
If anyone has Shifts that are not assigned to a Room, they will show up in an “
Other
” column:
Weekly View of One Room
If you click the
arrow next to Rooms
, you can choose one specific room to see which providers are using that room this week:
Again, the week view is the default here, but you can use the navigation buttons at the bottom of your Schedule to view one
Day
at a time, or go to a different date range:
Deleting a Room
To delete a room, a
Full Access
...
section and then on
Edit
to the right of the room you’d like to delete.
You’ll only be able to delete the room if it is
Unoccupied
. Jane will tell you right away under the room name if it’s been assigned to a staff member.
If the room is unassigned, you can click on the red
Delete
button.
If the room is assigned, you’ll see a
“Sorry, this room has booked appointments in the future. Please cancel or move these appointments before deleting”
error message.
In this case, you can head back to the
Schedule
and take a peek at the shifts to see which ones still have a room attached to them. In the top left corner of the shift, you’ll see the room assignment.
To remove the room assignment, click on the
Shifts
button in the top right corner. The button will turn orange and it’ll look like the appointments will disappear, but don’t fret! They haven’t been deleted—we’re just looking at the schedule in shift editing mode.
Within the
Edit Shift
panel, you can update the room assignment under the
Room
field. You can either assign the shift to another room or choose
Select a Room.
Make sure to click the blue
All Shifts
button to update all the shifts on that specific day of the week. For example, this will update all of the Fridays that have the same shift scheduled.
For any other days of the week that have the room attached, you’ll want to repeat this process.
When you head back over to the
Settings
tab and click on
Room Scheduling
, you should see the room unoccupied and ready for deletion!
Additional Notes & FAQ
Is there a way to get room usage analytics?
Jane doesn’t currently have a report that directly tracks room usage. However, you can estimate it by using the
Hours Booked/Scheduled
report.
...
To dig deeper, you can also
export the report to Excel and analyze
or visualize the data based on your room assignments.
We hope this helps you set up and fine-tune your schedule, but if you have any questions or encounter any bumps in the road, just give our
Support Team a call
or email support@janeapp.com!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Room Booking
Schedule
Room Booking
9 min read
Thrive Plan
Legacy PlansRoom Booking
Need to see more than one patient at a time? Or do you have rooms dedicated to specific providers at a time? If so, you might find
Rooms
in Jane helpful to organize your schedule!
Rooms in Jane are a way for practitioners to see multiple clients at the same time. They can help you create “columns” in your schedule so you can book 2-3 patients into the same timeframe, for example. They can also help you to organize your calendar per Room instead of per practitioner.
...
We hope this helps you set up and fine-tune your schedule, but if you have any questions or encounter any bumps in the road, just give our
Support Team a call
or email support@janeapp.com!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/fef96737-8e8e-4f42-84a9-a5f0756e0fa6)
- ![](https://jane.app/thumbs/a8a1721b-df18-44db-b649-7c16cf75cf45)
- ![](https://jane.app/thumbs/6d612152-9353-4c5a-995b-2535b0085252)
- ![](https://jane.app/thumbs/879b3f15-1d7c-4d8f-9401-94f6f8c2fe31)
- ![](https://jane.app/thumbs/515b9594-fa5b-456b-b64a-ee2496185a33)
- ![](https://jane.app/thumbs/a8c9b567-b3d0-4ab4-8732-50b08ffdcf4b)
- ![](https://jane.app/thumbs/2899e17e-fc4e-4d9f-9206-7ef25a6a36f1)
- ![](https://jane.app/thumbs/18646ad6-7ba4-4250-8142-91e74d4e5782)
- ![](https://jane.app/thumbs/b2d7ee5d-fc05-4b64-a1f2-2adab3ed3440)
- ![](https://jane.app/thumbs/889a020d-c76f-4e31-a22a-358e9106e758)
- ![](https://jane.app/thumbs/f90b216a-f9fc-4884-a037-c27654270b39)
- ![](https://jane.app/thumbs/92629bc5-0082-4b14-b010-4be13af82042)
- ![An image of the navigational steps and what the difference looks like between assigned and unassigned rooms](https://jane.app/thumbs/1ab57625-e423-4770-b2cc-8ecb7f20b1b7)
- ![An image of where to view and click on the delete button](https://jane.app/thumbs/2ad89314-30c6-4bef-aa4f-854e8e86d401)
- ![An image of what the error message will look like](https://jane.app/thumbs/a54708cc-40be-47fb-8b3e-2cbdb2fbad04)
- ![An image of where the room assignment is displayed on a shift in the top left corner](https://jane.app/thumbs/be3d2d35-b235-45a8-8f08-27a3a05057cb)
- ![An image of where yo view the room assignment within the edit shift panel](https://jane.app/thumbs/23db0566-c3f8-4dd2-b92d-a5393b8b96f8)
- ![An image of what the pop up confirming the change looks like](https://jane.app/thumbs/d2713141-5ca7-4fd1-8839-2b4c248d3f57)
