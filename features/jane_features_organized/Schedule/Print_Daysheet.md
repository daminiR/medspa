...
*Source: [https://jane.app/guide/print-daysheet](https://jane.app/guide/print-daysheet)*

*Category: Schedule*

*Scraped: 2025-08-07 00:09:05*
...
Feature OverviewPrint Daysheet
Schedule
Print Daysheet
2 min read
Sometimes we just like to have the paper copy! 📄
Accessing the Day Sheet
To print a staff member’s Day Sheet or daily schedule, start by heading to the
Staff
tab and selecting the staff member in question.
There, you’ll see a
Print Day Sheet
button:
Clicking this button will open a preview of how the day will be structured.
View Options
Jane offers three different print layouts, which you can toggle between using the dropdown at the top of the print preview screen:
Schedule
- Displays appointments in time blocks, just like in the schedule view.
List
- A simplified, back-to-back list of appointments with no indication of duration. Breaks will not be shown.
List (Show unscheduled times)
- Same as the List view, but includes unscheduled time blocks and breaks
Choose the format that works best for your clinic, then print.
Tip: Using a Receipt Printer
If you’re printing these every day, some clinics find it helpful to use a receipt printer—it can save time and paper. Many models work well (like the Epson ReadyPrint TM-T20 Direct Thermal Receipt Printer USB), and they’re widely available online and at office supply stores. Just make sure your computer can connect to the type of printer you choose.
Multi-Day or Multi-Practitioner Printing
Jane doesn’t offer the option to print a Day Sheet for more than one practitioner or more than one day at a time. If you’re trying to print the entire practice’s schedule, you’ll need to print each Day Sheet individually.
Alternatively, if you’d like to print a schedule for multiple days (such as a week, month, or year) or multiple practitioners, we recommend using the
Appointments Report
, which allows you to include several practitioners and days in one report.
If you have further questions, as always - let us know!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Print Daysheet
Schedule
Print Daysheet
2 min readSometimes we just like to have the paper copy! 📄
Accessing the Day Sheet
To print a staff member’s Day Sheet or daily schedule, start by heading to the
Staff
tab and selecting the staff member in question.
...
Appointments Report
, which allows you to include several practitioners and days in one report.
If you have further questions, as always - let us know!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2017/10/05/9igm2u155t_image.png)
- ![](https://jane.app/system/dragonfly/production/2017/10/05/60m17oun8m_image.png)
- ![](https://jane.app/system/dragonfly/production/2017/10/05/2u0uloi8wf_image.png)
- ![](https://jane.app/system/dragonfly/production/2017/10/05/6hhzmxl7zk_image.png)
- ![](https://jane.app/system/dragonfly/production/2017/10/05/4837vrlxm7_image.png)
