...
*Source: [https://jane.app/guide/setting-the-schedule-grid](https://jane.app/guide/setting-the-schedule-grid)*

*Category: Schedule*

*Scraped: 2025-08-07 00:11:15*
...
Feature OverviewSetting the Schedule Grid
Schedule
Setting the Schedule Grid
1 min read
Balance Plan
...
Schedule Grid
value you want for your clinic and click
Save
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Setting the Schedule Grid
Schedule
Setting the Schedule Grid
1 min read
Balance Plan
Practice Plan
Thrive PlanOn your schedule you can adjust the minimum increments.  The greatest common divisor of appointment length for your clinic is the value you need to use.  For example if you have one practitioner who schedules on 15 minute intervals but another who uses 20 minute intervals, you should use 5 minutes as your
Schedule Grid
value.
In order to adjust this value, head over to
Settings
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2018/01/04/2ms9khuddu_image.png)
- ![](https://jane.app/thumbs/2dc7e229-5b42-4039-ad69-5aa965b28bbc)
