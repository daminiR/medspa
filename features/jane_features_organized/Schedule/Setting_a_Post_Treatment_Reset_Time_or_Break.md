...
*Source: [https://jane.app/guide/setting-a-post-treatment-reset-time-or-break](https://jane.app/guide/setting-a-post-treatment-reset-time-or-break)*

*Category: Schedule*

*Scraped: 2025-08-07 00:10:36*
...
Feature OverviewSetting a Post Treatment Reset Time or Break
Schedule
Setting a Post Treatment Reset Time or Break
3 min read
Balance Plan
...
Head to the
Staff
tab and select the staff member you want to edit
Click on
Edit / Settings
Next, click on
Setting
...
Save
Note:
If this preference is set, the scheduled duration will be ignored on your treatments, and the duration will be calculated as the “Treatment Duration” + this “Post Treatment” time.
...
Click
Edit
next to the treatment you would like to add extra time for
In the Edit Treatment window, you’ll see options for both
Treatment Length
and
Scheduled Length
. To add post-treatment time, simply set the Scheduled Length to be
longer
than the Treatment Length
...
Post-treatment time at the end of a shift
If online booking is enabled and you’d like to allow Jane to book patients right up until the end of a shift so that post-treatment time rolls over past the end of that shift, check out our
Allow Post-Treatment Time After Shift Ends
guide.
Note:
Post-Treatment Time will count toward your account usage and be factored in when calculating the number of licenses your account requires.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Setting a Post Treatment Reset Time or Break
Schedule
Setting a Post Treatment Reset Time or Break
3 min read
Balance Plan
Practice Plan
Thrive PlanSometimes practitioners need a little extra time between appointments, whether it’s to prepare for the next patient or just to take a breather. We feel you! Jane offers a couple of different ways to automatically add post-treatment time to appointments.
Or, maybe you don’t need any post-treatment time and you are wondering why your appointments are longer than you set them!
You can add post-treatment time for specific staff members, or you can apply it to specific treatments so that the extra time is added no matter which staff member it is booked under.
We will show you both methods below.
Setting post-treatment time for a specific practitioner
...
Note:
Post-Treatment Time will count toward your account usage and be factored in when calculating the number of licenses your account requires.
That’s all there is to it!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/3ff02425-4ee3-4b6a-939b-c6082c923127)
- ![](https://jane.app/system/dragonfly/production/2015/01/05/3909h6ebdg_blob)
- ![](https://jane.app/thumbs/12b20f2b-04ab-46c5-b267-bbd2a61d65cf)
