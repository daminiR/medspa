...
*Source: [https://jane.app/guide/patient-privacy-and-privacy-mode](https://jane.app/guide/patient-privacy-and-privacy-mode)*

*Category: Schedule*

*Scraped: 2025-08-07 00:08:47*
...
Feature OverviewPatient Privacy and Privacy Mode
Staff Profiles
Patient Privacy and Privacy Mode
4 min read
Balance Plan
...
Are patient names in your schedule blurry, fuzzy or you can see them at all? We promise it isn’t a glitch – sometimes clinics accidentally enable
Privacy Mode
by using our keyboard shortcut (
Shift + P
)!
To turn this off, you’ll want to click on your name in the top right corner of your Jane account and then on
Disable Privacy.
You can also enable the feature in this area as well.
To enable or disable privacy mode on a mobile device, you can click on
Back
in the top left corner and either hit the
three horizontal white lines
or on the
circle with your initials
.
Lastly, you’ll want to select
Disable Privacy
within either menu and you’re all set!
Privacy Mode
...
Using
Privacy Mode
, Jane will hide client names in your schedule, while charting, and in your patient list by blurring them out. You can enable it by clicking the drop-down menu at the top right of your screen under your login name and selecting
Enable Privacy
.
Or the absolute fastest way (for when that patient walks around behind the desk!) is to use
Shift + P
on your keyboard to make the switch.
Pro Tip:
Hop over to our
Keyboard Shortcuts guide
to see all that Jane can do with just a few keystrokes :D
What is not blurred:
Once you click into the Appointment panel, Jane displays the patient name at the top. This is because otherwise you wouldn’t know which appointment/patient you’re working with. If you couldn’t see any names at all, it would be all too easy to make a mistake.
Hitting refresh:
Also, if you’re really not wanting to show any names, you won’t want to hit refresh here because Jane will disable privacy. If you do, however, and you need to blur the names again quickly, just hit Shift + P, and you’re all set.
...
Each staff member can set that individually in their
Staff Profile
.
Click
Edit/Settings
on the profile and head over to the
Settings
tab.  You’ll find a drop-down in the “Privacy & Sharing” area where you can make the changes.
If you have just
First Name, Last Initial
selected for example, your booking notifications will look like this:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Patient Privacy and Privacy Mode
Staff Profiles
Patient Privacy and Privacy Mode
4 min read
Balance Plan
Practice Plan
Thrive PlanJane offers a few quick and easy features to keep your patient’s information confidential when working in areas where your screen might be visible to others.
Are patient names in your schedule blurry, fuzzy or you can see them at all? We promise it isn’t a glitch – sometimes clinics accidentally enable
Privacy Mode
by using our keyboard shortcut (
Shift + P
...
First Name, Last Initial
selected for example, your booking notifications will look like this:
Okay!  As always let us know if you have any questions or if you’re having any trouble getting your settings just the way you want them.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image the navigational steps](https://jane.app/thumbs/ccca5b79-c561-4f0f-9970-95a79d0700a8)
- ![An image of where to click on either of the listed options](https://jane.app/thumbs/e47a4a0a-1218-4503-8203-e15237c9ac3a)
- ![An image of the menu options](https://jane.app/thumbs/5bd92c8f-e85c-4c10-8402-304d3feb303f)
- ![](https://jane.app/system/dragonfly/production/2016/05/13/7t66de5m6p_blob)
- ![](https://jane.app/system/dragonfly/production/2016/05/13/5xykrzo0g0_blob)
- ![](https://jane.app/system/dragonfly/production/2016/05/13/2mwwmbczm4_blob)
