...
*Source: [https://jane.app/guide/booking-changing-or-moving-an-appointment-staff](https://jane.app/guide/booking-changing-or-moving-an-appointment-staff)*

*Category: Schedule*

*Scraped: 2025-08-07 00:06:35*
...
Feature OverviewBooking, Changing or Moving an Appointment (Staff)
Schedule
Booking, Changing or Moving an Appointment (Staff)
7 min read
Balance Plan
...
Note
📝:
These instructions are for clinic staff. Patients can learn how to book their own appointments
here
.
Managing appointments is one of the most important parts of running a clinic. It’s also something your team does every day. Whether it’s booking, moving, or cancelling, we know it’s about more than just time slots; you’re helping real people find care.
This guide walks through everything you need to know to handle appointments with confidence. You’ll learn how to schedule and reschedule with ease, support your patients through changes, and navigate any hiccups that come up along the way. It’s designed to support your team and make your day a little smoother.
Booking an Appointment Administratively
Switching the Staff Member on an Appointment
Changing the Appointment Type
Troubleshooting a Missing Treatment
Booking an Appointment Administratively
Scheduling appointments or booking patients is exclusively handled through the
Schedule
tab. By clicking on an available time slot for the desired day, front-desk staff and practitioners can easily create and book appointments.
Start the process by clicking on a start time in the schedule.
The
New Appointment
pane will slide out on the right where you can specify the patient, the treatment and add notes. When you’re done, click
“Book Appointment”
.
Curious about the list of treatments that appears in the dropdown options? Check out our
Setting up Treatments
guide!
A
Thank You For Booking
email will be sent out to the patient after the appointment has been made. While this allows the patient to review their booked appointment, in Jane we are not able to mark the appointment as
confirmed
by the patient or the admin.
When the patient has come for their appointment time, you can then mark the appointment as
arrived
.
Switching the Staff Member on an Appointment
Imagine a practitioner calls in sick or has some unplanned time off (we’ve
all
been there), but another can fill in! There are two options when it comes to changing the staff member on an appointment.
Drag & Drop
If the appointment is being moved, but it’s still on the same date and time, you can ‘drag’ it from one doctor’s schedule and ‘drop’ it onto the other’s. It’s just like grabbing something on your screen, moving it, and letting go where you want it.
Click and hold an appointment (using your mouse or finger on the touchscreen). While holding, drag it to the new desired date, time, and staff member slot. Lastly, release to drop it in place and Jane will ask if you’d like to confirm the move or confirm and notify the patient of the changes to their appointment.
Move
For appointments that aren’t on the same day, you can save some extra clicks by clicking on
Move
within the
Appointment Panel.
At the top of the page, you’ll see a notification that you’re rescheduling an appointment. Use either the
arrows
or
Go to Date
buttons at the bottom to navigate to your desired new date.
To move an appointment between locations, you can either select the location or use the keyboard shortcut
L
to switch to that location.
Click on a time within the gridlines and you’re all set!
Changing the Appointment Type
Once you click on the appointment to open the
Appointment Panel
, click on the
pencil icon
.
Within the
Treatment
section of the panel, you can use the
dropdown menu
to select the desired treatment.
If you’re looking to switch an in-person appointment to an online appointment, you’ll want to first make sure that you have two separate treatment types set up. Here’s what those two session types would look like:
For more information on creating these offerings, you can check out our
Setting Up Treatments
and
...
To make this available for the new staff member, a user with
Full Access
will want to head over to the
Settings
tab, click on
Treatments, Classes & Group Appointments
and then on
Edit
to the right of the treatment you’re trying to book:
Next, take a peek at the
Discipline & Staff Member
section. Typically you’ll want to make sure that the treatment is assigned to the right discipline that the staff member offers. Additionally, make sure that the
Staff Member
field is set to
No Staff (Shared Treatment)
:
...
To view this setting, you’ll want to head over to the staff member’s
Profile
and then click on
Edit/Settings:
Next, scroll to the
Disciplines
section and ensure that the disciplines they’re opted into align with the disciplines the treatments are assigned to.
Voilà!
If you have any additional questions and would like to get in touch with our support team, you can
contact us
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Booking, Changing or Moving an Appointment (Staff)
Schedule
Booking, Changing or Moving an Appointment (Staff)
7 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of where to find an empty slot on the schedule with a shift in place](https://jane.app/thumbs/6c802b78-79f3-42ac-8b73-fe37c29efa2f)
- ![An image of the blue Book Appointment buttom within the appointment panel](https://jane.app/thumbs/7fa26d97-765c-40ee-b923-2dbaa8a418f3)
- ![An image of the appointment panel when the appointment is marked as arrived](https://jane.app/thumbs/4836fa06-b08e-4fef-984f-49d0751e273d)
- ![An image of the navigational steps and where to find the option to move the appointment using the Move button](https://jane.app/thumbs/4a95ce72-d564-425c-bd6a-d6e6dbcd92a6)
- ![An image of where Jane will display the notice as well as where to find the arrows and date picker at the bottom of the page](https://jane.app/thumbs/cad41f52-a97f-4c89-b1f6-5cc5187b005c)
- ![An image showing the two places you can click to switch the location while moving an appointment](https://jane.app/thumbs/31a833fb-c24d-41bf-8aa7-aad75ca6821a)
- ![An image of the navigational steps to open up the appointment panel](https://jane.app/thumbs/715aa3d1-4ff0-464a-b72d-a4ff01c9ecb9)
- ![An image of where to view and click on the dropdown menu to select the new treatment type](https://jane.app/thumbs/05e781f4-3933-443d-b538-ffc94bca59f4)
- ![An image of the settings tab and what the two different session types look like](https://jane.app/thumbs/2f32df0f-2292-402f-a40f-5e2fc4813a1c)
- ![](https://jane.app/thumbs/c8397524-4931-4973-905a-f1d0a1f1326a)
- ![](https://jane.app/thumbs/e56b3f4a-135f-44b2-8cb8-b20c63303b8c)
- ![](https://jane.app/thumbs/4991dba7-4691-4782-bfac-fe7d2532d470)
- ![](https://jane.app/thumbs/e36d735b-4466-471e-a093-9ebf4f138d55)
