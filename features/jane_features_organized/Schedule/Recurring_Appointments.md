...
*Source: [https://jane.app/guide/recurring-appointments](https://jane.app/guide/recurring-appointments)*

*Category: Schedule*

*Scraped: 2025-08-07 00:09:53*
...
Feature OverviewRecurring Appointments
Schedule
Recurring Appointments
6 min read
Balance Plan
Practice Plan
Thrive Plan
❗️ Heads up! You can only schedule recurring appointments within your designated Shifts, which you’ll need to set up in your schedule. If you haven’t already done that, check out our helpful FAQ on
Setting Up Shifts
to get started.
...
Yes!
Jane will send notifications for recurring appointment bookings; however, Jane will only send one email notification with information on all appointments rather than sending an individual notification for each appointment booked. There is a 3 minute window before an appointment booking notification is sent, any appointments booked within that 3 minute window will be included in one email notification.
Is there a limit to how far out a recurring appointment can be booked in for?
Yup
- at the moment recurring appointments can be booked administratively up to
1 year
in advance. To get around this limitation, you can toggle to Jan 1st of the following year, book the appointment on the Schedule and Jane will expand the year selection to the next year.
For example, if we wanted to book
Bob
in up until 2025, we’ll head over to the
Schedule,
click the
Go to Date
button in the bottom right corner of the screen, and toggle to Jan 1st, 2024 (or any date within that year)
Once we’re on that day in the Schedule, we can book the first appointment in the series like a regular appointment.  With the appointment booked, we can make the appointment recurring by clicking on the
two forward arrows
When the
Repeat Until
field is clicked and the
year
for the date range is selected, Jane opens that up to 2025:
...
Yes!
To do this, you may need to disable email notifications from being sent to your patients, as this will require us to re-book the patient in for their future recurring visits with the updated insurance policy. You can do this under the patients
Profile > Edit/Settings > check off
Do Not Email
.
...
From here, click onto the arrows beside the Copy/Move button again, and
delete
any future booked appointments, and re-book the appointments again:
Once you’ve done that, feel free to head back to the patients’ profile to deselect
Do Not Email
so your patient can receive email notifications again.
💡
Jane tip
: You can follow the same workflow as above for editing insurance policies if you need to edit the treatment type for a series of recurring appointments. You can use the Recurring Appointments feature to delete upcoming appointments, and then you can create new recurring appointments. Reminder that you’ll want to unarrive an appointment before editing the treatment type. Check out our guide for more info about how to
edit an appointment that has been arrived
.
Can I delete or cancel appointments in bulk?
Yes,
appointments can be mass cancelled or deleted if they are all booked for the same patient. To do this, you’ll want to head over to the
Schedule
tab and click on the patient’s appointment. Within the
Appointment Panel
, click on the
»
button.
...
text so that it’s toggled on:
Scroll down to the bottom and hit the
Delete X Appointments
button.
Can I delete appointments for different patients at once?
No
- at the moment this feature is only designed to delete multiple appointments for a specific patient.
Is there a recurring appointment feature for clients booking online?
No
- This is an administrative feature at the moment. Clients or patients of the clinic would need to book these repeating appointments individually.
How do I resolve the “Staff Not Available” error when booking recurring appointments?
This error occurs for two main reasons -
Shifts
and
Tag
s. Here’s some troubleshooting steps for either of these options.
Shifts
: Recurring appointments can only be booked if there is a
Shift
present on that day. You can ensure that you have shifts created for as far out as the appointments should be scheduled for.
Advanced Scheduling
:
Tags
on shifts and appointments always need to correspond with one another. If there is a tag on the appointment type but not on the shift, Jane will display
Staff Unavailable
.
We’d love to hear more about how we can improve the online booking experience for your clients and patients.
You can share your feedback with the team here
💙
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Recurring Appointments
Schedule
Recurring Appointments
6 min read
Balance Plan
Practice Plan
Thrive Plan❗️ Heads up! You can only schedule recurring appointments within your designated Shifts, which you’ll need to set up in your schedule. If you haven’t already done that, check out our helpful FAQ on
Setting Up Shifts
to get started.
Choose an appointment on the schedule that you would like to recur.
On the appointment panel, select the arrows beside the “Copy/Move” buttons to create a recurring event.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2017/09/05/41fc8ngbwn_image.png)
- ![](https://jane.app/system/dragonfly/production/2014/07/12/5ml3dbarxm_undefined)
- ![](https://jane.app/system/dragonfly/production/2014/07/12/7yf2klnlia_undefined)
- ![](https://jane.app/system/dragonfly/production/2014/07/12/7lwodm0dj3_undefined)
- ![](https://jane.app/system/dragonfly/production/2017/09/05/2h0wikv95o_image.png)
- ![](https://jane.app/thumbs/32d75819-2505-465d-a104-4602de439141)
- ![](https://jane.app/thumbs/e1c415e5-f972-4600-b5e1-b09d1fc7a19b)
- ![](https://jane.app/thumbs/f8a2b357-19d5-4b9e-9554-10674daa3489)
- ![](https://jane.app/thumbs/f550a04b-6cae-4eb3-894c-5bd3655d5614)
- ![](https://jane.app/thumbs/16356cb9-2ac1-4290-ae93-a8469886fd42)
- ![An image of the navigational steps](https://jane.app/thumbs/12c4d49c-e8c9-4a87-a6e6-17ac38098f89)
- ![An image of where to view and click on Show All Upcoming Appointments](https://jane.app/thumbs/2305a1f3-ba0f-489f-ba5b-d21817620c96)
- ![An image of where to view and click on the Delete Appointments button](https://jane.app/thumbs/d4e0cee0-2a6d-4464-84c1-607adf4515cd)
