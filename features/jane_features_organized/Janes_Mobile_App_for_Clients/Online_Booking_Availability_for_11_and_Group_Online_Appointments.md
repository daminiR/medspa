...
*Source: [https://jane.app/guide/online-booking-availability-for-1-1-and-group-online-appointments](https://jane.app/guide/online-booking-availability-for-1-1-and-group-online-appointments)*

*Category: Jane's Mobile App for Clients*

*Scraped: 2025-08-07 00:41:22*
...
Feature OverviewOnline Booking Availability for 1:1 and Group Online Appointments
Online Booking
Online Booking Availability for 1:1 and Group Online Appointments
6 min read
Thrive Plan
Legacy Plans
There are a few ways that you can customize your online booking availability for 1:1 and Group Online Appointments.
In this guide we’ll cover:
How to only offer Online Appointments in online booking
...
For 1:1 Online Appointments:
Setting up Jane’s Online Appointments
For Online Appointments for Groups:
...
.
Find the
Treatments (or Sessions) Listed in Online Booking
section, and use the checkboxes to select and deselect the treatments you would/wouldn’t like to have displayed online.
Click
Save
to finish.
And that’s it! You can return here at anytime to update the sessions you would like to be visible.
Jane Tip:
Click your name in the top right corner, and then select Online Booking Site from the menu to see how your online booking site looks to clients.
How to offer Online Appointments on a specific day or time in online booking:
Do you only want to offer Online Appointments on a specific day? Or maybe only in the mornings? If so, you can set this up using our
tags feature
.
Jane’s Tags feature is available on our
Thrive
and
Legacy
subscription plans and lets you limit treatment availability on your online booking site by tagging treatments to specific shifts.
Important Note:
Tags only apply to online booking. Staff will always have the ability to override tag requirements when booking administratively.
Here are the steps!
Step 1: Create the Tags
While any
access level
can create a tag when editing their shift settings,
Full Access
is required to enable this feature.
To turn this on, head over to the
Settings
tab, select
Schedule Settings
in the left sidebar, and
check the box
at the bottom of the page.
You’ll now see a new section appear called
Advanced Scheduling
under the
Settings
tab. Scroll down to find the
Tags
area.
Use the New Tag button on the top right in order to create tag(s):
We recommend creating two tags: “Virtual” and something like “Regular” or “In Person” (the wording doesn’t really matter). These are only used internally and will never be displayed to your patients.
Step 2: Assigning Tags to Sessions
Next, you’ll assign each of your sessions to the matching tag.
To apply the appropriate tag, head over to
Settings > Sessions & Classes.
Click to
Edit
the session, and then scroll down to the very bottom and select the tag.
So any Online Telehealth Appointments will get the “Virtual” tag, and in-person sessions get the “In-Person” tag.
Continue matching each session with the correct tag.
...
Important Note:
Untagged sessions will NOT be offered on a tagged shift in online booking.
Appointments can only be booked into a shift with a matching tag.
If you have not assigned a tag to your shift, any sessions with a tag will NOT be offered.
If you want a shift to be bookable by two types of sessions, then you’ll want to have two tags on that shift.
To tag your shifts, head to the Schedule view and click
Shifts
in the top right.
When you click to edit one of your shifts, you’ll see an area to add tags at the bottom. Start typing in the name of your tag, select the appropriate tag, and
Save
:
Example 1
...
Example 2
Let’s say you would like to offer only Online Appointments for the next two weeks, and allow in-person appointments to resume the following week.
You’d want to assign each Shift for the next two weeks the “Virtual” tag. After that, you’ll assign the tag for your in-person and regular services to the following weeks. This will ensure for the next two weeks only “Virtual” tagged sessions can be booked, and after that date clients can only book regular in-person sessions.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Online Booking Availability for 1:1 and Group Online Appointments
Online Booking
Online Booking Availability for 1:1 and Group Online Appointments
6 min read
Thrive Plan
Legacy PlansThere are a few ways that you can customize your online booking availability for 1:1 and Group Online Appointments.
In this guide we’ll cover:
How to only offer Online Appointments in online booking
How to offer Online Appointments on a specific day or time in online booking
If you have not yet set up your Online Appointment offerings, you’ll want to do that first :)
...
Jane will do the same thing for your online booking site.
And that’s it!
We hope this has helped, but do let us know if you have any questions about this process.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/cc15145f-5423-4528-b7f6-abaa9311a916)
- ![](https://jane.app/thumbs/7983637d-e37c-41ea-897e-db523c8e81e3)
- ![](https://jane.app/thumbs/0cb28eac-8bcf-4b42-9aaf-a092ad9a06be)
- ![](https://jane.app/thumbs/afdf6e61-d10e-4011-90d0-47cfda96c86c)
- ![](https://jane.app/thumbs/7217f503-b8a2-4012-a679-186748e349c1)
- ![](https://jane.app/thumbs/6b55247b-3ee4-4a7e-8308-792bfc7d4d6f)
- ![](https://jane.app/thumbs/a8870516-4851-4a10-bd3e-0a6848964f7f)
- ![](https://jane.app/thumbs/102fb522-048f-4e74-a0ac-a8e039dc30e5)
