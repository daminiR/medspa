...
*Source: [https://jane.app/guide/a-message-from-ali-on-jane-s-mobile-app-for-clients](https://jane.app/guide/a-message-from-ali-on-jane-s-mobile-app-for-clients)*

*Category: Jane's Mobile App for Clients*

*Scraped: 2025-08-07 00:42:00*
...
Feature OverviewA Message From Ali on Jane's Mobile App for Clients
...
If you’re one of our Canadian customers, you would have received an email the week of Feb 17th announcing the full release of the Jane Client app on the Canadian
Apple
and
Google Play
app stores.
We have been working with many of you over the last few months, while the app was in a Beta period, to ensure we heard your feedback during the development process, and now,
Jane’s Mobile App for Clients
is publicly available! (In Canada… We’re working on the release for US and rest of world 🌎❤️).
I thought it could be helpful to share more about why I’m so excited about this release!
Here’s the
TL;DR
for those of you between clients, and I’ll add the full novella of details below if you’re interested in the long form journey:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)A Message From Ali on Jane's Mobile App for Clients
Jane's Mobile App for Clients
A Message From Ali on Jane's Mobile App for Clients
9 min readHi everyone - I’m Ali, Co-Founder and Co-CEO of Jane.
I’m coming here to share some background into the new mobile app you can offer to your clients or patients.
If you’re one of our Canadian customers, you would have received an email the week of Feb 17th announcing the full release of the Jane Client app on the Canadian
Apple
and
...
we’d love to hear from you
.
-AliSubscribe to our monthly newsletter.Jane Software Inc.
