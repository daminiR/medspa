...
*Source: [https://jane.app/guide/ai-scribe-working-with-recordings](https://jane.app/guide/ai-scribe-working-with-recordings)*

*Category: AI Scribe*

*Scraped: 2025-08-07 00:52:34*
...
Feature OverviewAI Scribe: Working with Recordings
Charting
AI Scribe: Working with Recordings
6 min read
If you’ve opted into AI Scribe, prepped your templates, and are ready to record, then this guide is for you! If you haven’t gotten started with AI Scribe yet,
this guide can help
.
...
Accessing your recordings & transcripts
Deleting recordings
Pre-recording tips
Let’s go over a few recording recommendations to make sure you have a smooth experience putting your template to use.
...
If you’re accessing AI Scribe on a mobile device, we recommend launching Jane directly from your web browser app rather than a homescreen shortcut.
...
Make sure your microphone has a clear line of sight to each person being recorded (we don’t recommend headsets to record multiple people since they are designed only to record the wearer’s voice)
We recommend going through the steps below with your
Test Patient
profile to try it out before recording a real session.
Additionally, it doesn’t hurt to take backup notes just in case something goes wrong.
💡 Jane tip: Whether you’re recording a session or dictating post-session, the workflow is the same.
Recording directly in Jane
Once you’ve created a new chart entry with your template, click the
microphone icon
, confirm all parties have consented to be recorded, and then click
Record audio
.
...
Next, you can change what microphone you’re using if needed, and you can see whether it’s picking up audio with the
Mic check
bars. When you’re all set, click the
Start Record
button.
Now you should see a banner letting you know that the recording is in progress. The banner will stay up no matter which page in Jane you move to. You can pause or finish the recording from the banner or the patient’s charting area.
Once the audio recording has finished uploading, you’ll see the note fields have been populated according to the prompts you added to your template. You can edit this text as much as you like.
Uploading an existing audio file
💡
Jane tip
: We strongly recommend
recording your session directly in Jane
instead of uploading an existing file so that you don’t have to record in a separate program and then and then find and transfer the file to Jane.
Once you’ve created a new chart entry with your template, you’ll click the microphone icon at the top of the chart entry. confirm that all parties in the recording have consented, and then click
Upload audio file
.
You can upload any of the following file types: mp3, mp4, m4a, wav, or webm.
Next, select the file from your device and let AI Scribe work its magic. ✨
📣
Jane tip:
We recommend storing your audio files in a secure program, or deleting them from your device once you’re finished with them, since they contain PHI.
...
Once the audio file is processed, you’ll see the note fields have been populated according to the prompts you added to your template. You can edit this text as much as you like.
Accessing your recordings & transcripts
To access the recording or transcript from your session, click on the
microphone icon
at the top of the chart entry, followed by
Manage recordings
.
This will open a panel to the right, where you will be able to listen to any recordings from this session, or review your transcripts.
This panel will
only
show recordings and transcripts from this session. Recordings and transcripts for other appointments, practitioners, or patients won’t be shown here.
Deleting recordings
To
manually delete
a recording, head to the
Manage Recording
panel using the steps in the section above. ⤴️
Next, click the three dots to the right of the date and select
Delete
.
NOTE: When a recording is deleted, it’s immediately removed from the clinic account and no longer accessible. A copy remains in Jane’s secure backup servers for a short time, but these recordings are permanently deleted after one week.
Alternatively, a user with
Full Access
to set up a
...
Recording deletion policy
area.
You can choose between keeping files indefinitely, deleting files immediately after successfully generating a chart entry, or deleting the files after a set number of days.
Make sure to save your changes when you’re finished. The policy will apply to all recordings by all practitioners at the clinic.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)AI Scribe: Working with Recordings
Charting
AI Scribe: Working with Recordings
6 min readIf you’ve opted into AI Scribe, prepped your templates, and are ready to record, then this guide is for you! If you haven’t gotten started with AI Scribe yet,
this guide can help
.
Have questions? Check out our
FAQ and Troubleshooting guide
...
area.
You can choose between keeping files indefinitely, deleting files immediately after successfully generating a chart entry, or deleting the files after a set number of days.
Make sure to save your changes when you’re finished. The policy will apply to all recordings by all practitioners at the clinic.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/427570d2-8c8d-488a-aae3-f4a18cfdf070)
- ![](https://jane.app/thumbs/dea82580-8c02-4a18-bbae-a776098bc84d)
- ![](https://jane.app/thumbs/3708bc8a-c16d-48ff-8cb2-18e077fb43ca)
- ![](https://jane.app/thumbs/5f5f6be4-0218-45e9-942b-766fd222e0bf)
- ![](https://jane.app/thumbs/8ba3e27d-2c10-428b-ad34-64f82b63f3fe)
- ![](https://jane.app/thumbs/cb6fed41-bf00-429c-8db4-a49dab86ed53)
- ![](https://jane.app/thumbs/0ae1e66f-13d7-4fd9-b5ca-31235314ebf5)
- ![](https://jane.app/thumbs/0db51981-62ac-4e76-8100-bbf303ff3596)
- ![](https://jane.app/thumbs/8f99dd7d-7d37-4781-8059-5df521e0bd24)
- ![](https://jane.app/thumbs/3847fa02-cf5b-4314-90cf-d013e54911e2)
- ![](https://jane.app/thumbs/58424dd1-ae94-4e61-ba3d-f0a455d5f304)
