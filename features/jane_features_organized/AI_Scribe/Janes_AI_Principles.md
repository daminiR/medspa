...
*Source: [https://jane.app/guide/jane-s-ai-principles](https://jane.app/guide/jane-s-ai-principles)*

*Category: AI Scribe*

*Scraped: 2025-08-07 00:53:51*
...
Feature OverviewJane's AI Principles
Privacy
Jane's AI Principles
3 min read
Balance Plan
...
AI Scribe, our first AI-powered add-on, is available for customers in Canada and the US! 🇨🇦🇺🇲
...
If there’s anything you’re curious about or need help with, just shoot us an email at
support@jane.app
. We’re always here to chat and clear up any questions you might have.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane's AI Principles
Privacy
Jane's AI Principles
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansUnderstanding Jane’s Approach to AI
As we explore the benefits of AI technology to help more helpers, we want to provide you with an understanding of our AI principles.
These principles will ground the decisions we make when using this technology to imagine and create AI-powered solutions for clinics, influence how we introduce and educate clinics on AI-powered clinical features, and will continue to evolve as this technology does.
AI Scribe, our first AI-powered add-on, is available for customers in Canada and the US! 🇨🇦🇺🇲
Check out our guide to learn more
...
If there’s anything you’re curious about or need help with, just shoot us an email at
support@jane.app
. We’re always here to chat and clear up any questions you might have.Subscribe to our monthly newsletter.Jane Software Inc.
