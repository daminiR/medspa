...
*Source: [https://jane.app/guide/ratings-reviews-faqs](https://jane.app/guide/ratings-reviews-faqs)*

*Category: Patient Feedback*

*Scraped: 2025-08-07 05:00:11*
...
Feature OverviewRatings & Reviews FAQs
Patient Feedback
Ratings & Reviews FAQs
23 min read
Thrive Plan
...
What if I arrive then unarrive a
past
appointment? Is this any different?
...
If “Request Visit after Initial Visit” is selected, does Jane know that it is a unique initial visit with Practitioner A vs. Practitioner B?
Receiving Surveys and Opting-Out
Does the clinic have the option to opt-out a specific patient from receiving surveys from the clinic?
Do individual patients have the option to opt-out of receiving surveys?
...
I’m a practitioner at a multi-disciplinary clinic. I’m not allowed to use Google Reviews as per my Regulatory Body’s Standards of Practice, but others in my clinic are allowed to. What does this mean for our clinic’s Ratings & Reviews settings?
...
General
Why didn’t my patient receive a Ratings email?
Can I manually send a rating email to a patient?
Access and Permissions
What access level is required to enable Ratings and Reviews?
You’ll need to be the Account Owner or have Full Access to enable Ratings & Reviews within Settings.
Do all staff members have permission to see practitioners’ internal ratings and reviews?
Only
Full Access & Administrative/All Billing
have access to see each staff member’s ratings and reviews at the clinic. Here’s a nifty little table we put together to display the Role and Access:
Will my account be opted-out of Ratings and Reviews by default?
Yes - when Jane made ratings and reviews available to all clinics, clinics will have the feature disabled by default. You will need to actively enable it via Settings > Ratings & Reviews.
One thing to mention is that all existing patients will be opted-in to the Ratings & Review email – however, the email
will not send
unless the feature has been enabled.
Arriving Appointments
Yikes, I just unarrived - then rearrived the same appointment for a patient. Will they get two surveys?
Jane will not send out a second rating email if one has already gone out. In other words, you will not be able to manually generate a
new
survey by un-arriving then re-arriving an appointment in Jane.
If I arrive an appointment early, will Jane send the survey to the client earlier too?
...
Yes! By default, when creating a new patient, the new patient will be
opted-in
to receive Ratings & Reviews emails. This can be turned off administratively by clicking
Edit / Settings
within the patient’s profile, and
unchecking
the *Send Ratings Emails** box.
Do individual patients have the option to opt-out of receiving Ratings & Reviews emails?
Individual patients can opt-out of receiving these emails. In their
My Account
, they have an option to
uncheck
the option for
I would like to provide my feedback on my experience
, under their Notifications & Reminders.
I’m a guardian/parent of a minor and I’d like to provide feedback to the clinic for my child’s appointment. Will I receive this email?
If the guardian/parent is set-up to receive the minor’s emails & notifications via Jane’s
Family Relationship
feature, they will also receive the Rating email.
Google Reviews
I have Google Reviews enabled for my clinic. Will Jane automatically help me post my reviews to Google as well?
...
We make it easy for patients to leave a review on Google. Once they complete their star rating, they can simply click to “Open Google Review”. This will open your Google Review page for them, all setup ready for their review. To see how that looks, read more about it
in the guide here
.
I’m a practitioner at a multi-disciplinary clinic. I’m not allowed to use Google Reviews as per my Regulatory Body’s Standards of Practice, but others in my clinic are allowed to. What does this mean for our clinic’s Ratings & Reviews settings?
Google reviews is a
clinic-wide
rule. With this in mind, we’ve put together one scenario and two possible setting options for clinics that may fall under this category.
Scenario: I am a multi-disciplinary clinic with 1 Discipline that is
allowed
to collect external Google Reviews, and 1 Discipline that is
not approved to
.
Settings Option 1
:
Internal Feedback enabled for all practitioners ✅
External Google Reviews disabled for all practitioners 🚫
Settings Option 2
:
Internal Feedback enabled for
only those practitioners who also are approved for Google Reviews
✅
External Google Reviews enabled ✅
I’m using Google Reviews. If a client’s feedback is posted to Google as well, will the clinic or staff member be notified?
You’ll be able to see when a patient has clicked the “Rate Your Experience” survey from the patient
Communications
tab, however, we don’t know if they’ve actually left a review in Google.
...
You can find the customization under
...
If I have Google Reviews enabled, does my client get prompted to leave a review for any star rating from 1-5?
Yes
, Google now requires that any star rating (between 1-5) prompts a Google Review, so we have now gone ahead and implemented this change in Jane. It’s a change that Google made to increase the authenticity and trust of Google Reviews (which is a good thing for all of us consumers!).
If Google thinks that we are only sending over positive reviews from Jane, then Google can pull those reviews off of your business listing and block Jane as a referrer of reviews.
Does my regulatory body allow me to publicly market patient testimonials online?
Jane is working hard on creating a region-specific list with some easy to digest information based on different regulatory bodys’ marketing standards.
We are not lawyers nor are we equipped to interpret licensing regulations and bylaws. You should confirm with your regulating body that our summary of the regulations linked below are accurate.
...
Link
Acupuncture
Possibly. Please refer to pages 48-50 of the bylaws, which indicate
      practitioners need to watch the content of the reviews closely.
Link
Counsellor
Unlikely, due to association requirements. Please check with your registration body.
Link
Psychologist
No
Link
...
Standards of Practice
Naturopathic Doctors
Possibly. Within the Standards of Practice, there is no reference to
      prompting patients for testimonials.
Link
Registered Massage Therapist
Yes
Link
...
Link
Physiotherapist
Possibly. The Standards of Practice indicates that practitioners need to
      watch the content of the reviews closely to ensure they are represented
      accurately online.
Link
Acupuncture
Possibly. Within the Standards of Practice, there is no reference to
...
General
Why didn’t my patient receive a Ratings email?
Sorting out why a ratings and review email wasn’t sent can be a bit tricky at first but there are specific conditions where Jane won’t send the notification out. Here are some reasons why:
The patient’s appointment was not marked as
Arrived
(this includes No Show, cancelled/deleted, and unarrived appointments as Jane won’t send a Ratings email for an appointment that did not occur)
The patient’s is arrived
after
the calendar date of the appointment. For example, if an appointment is booked for August 18th, but is not marked as arrived until  August 19th, then Jane will not send out a notification.
The patient has “Do Not Email” selected in their profile
The patient has opted out of Ratings emails in their My Account
The patient has no email address or an invalid email
The practitioner is not opted into the clinic’s Ratings and Reviews settings.
Can I manually send a ratings email to a patient?
No
, at the moment there isn’t a way to manually resend these emails to clients and are only automatically prompted after the appointment is marked as arrived.
Additional Resources
If you haven’t seen them already, we have a handful of ratings & reviews guides on several topics:
How to Setup Ratings & Reviews
Review Your Ratings (for Practitioners)
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Ratings & Reviews FAQs
Patient Feedback
Ratings & Reviews FAQs
23 min read
Thrive PlanThis guide is a compilation of some of the most frequently asked questions around Jane’s Ratings & Reviews feature. Have a read through these, and stay tuned for some links at the bottom of this Guide to some additional resources to help you get set up and on your way with Ratings and Reviews.
Access and Permissions
What access level is required to enable Ratings and Reviews?
Do all staff members have permission to see practitioners’ internal ratings and reviews?
Will my account be opted-out of Ratings and Reviews by default?
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/f3b60b43-2b3c-40c1-93d7-41fd9270d639)
- ![](https://jane.app/thumbs/0ba5f713-777a-407c-8d0c-0e4e282ecafd)
- ![](https://jane.app/thumbs/563228f0-2320-4612-a2a8-ae6d7814b3ad)
- ![](https://jane.app/thumbs/b7165d0c-0be1-4533-8578-691b08be567f)
- ![](https://jane.app/thumbs/89155813-6504-4b92-bed5-52df659d3696)
