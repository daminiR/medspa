...
*Source: [https://jane.app/guide/my-patient-didn-t-receive-their-intake-form-a-troubleshooting-guide](https://jane.app/guide/my-patient-didn-t-receive-their-intake-form-a-troubleshooting-guide)*

*Category: Intake Forms*

*Scraped: 2025-08-07 05:30:14*
...
Feature OverviewMy Patient Didn’t Receive Their Intake Form: A Troubleshooting Guide
...
Looking for more general info about Intake Forms? Check out our
Intake Forms
and
Intake Form FAQ
guides.
...
Full Access users
can create and edit Intake Forms.
Does the patient have a valid email and email notifications enabled in their Patient Profile?
Does the patient’s Communications tab show a Complaint, Bounced, or Bad Recipient status on an attempted notification?
...
Is the Patient able to login to their My Account portal?
Does the patient have a valid email and email notifications enabled in their Patient Profile?
Does the patient have a valid email address on their profile? Does the profile have
Email notifications for new, cancelled, and rescheduled appointments
enabled?
A valid email address and appointment notifications are required for an automatic Intake Form to be sent to your patient.
Does the patient’s Communications tab show a Complaint, Bounced, or Bad Recipient status on an attempted notification?
In the patient’s profile, under their Communications tab, do any notifications have a
complaint
,
bounced
, or
...
For additional info on these statuses and how to resolve them, check out our
Communications Log
guide.
Is the intake form set to send automatically or manually?
In the Intake Form settings, which can be found in
Settings > Forms & Surveys > Intake Forms > Edit
on the form, is the form set to
Automatically prompt patients who have not completed this form
?
If a form is set to send manually, it must be sent administratively from the
Patient Profile
by using the
Email
button in the Online Intake Forms section of the profile.
For automatic Intake Forms, does the Appointment Type match the patient’s appointment?
If the Intake Form is set to
Automatically prompt patients who have not completed this form,
does the appointment that was booked for the patient match the appointments selected in the
Appointment Type
tab of the form?
Has the patient reviewed their Thanks for Booking and Appointment Reminder emails?
Sometimes patients don’t know that their Intake Form is included in their Thanks for Booking and Appointment Reminder emails so they’re looking for a separate email specifically for the form. You can let patients know that the form will be included in their appointment emails with a button to
Fill Out Intake Form
.
Has the patient already filled out this Intake Form in the past?
You can check the patient’s profile to see if they’ve completed this form in the past.
Jane will not prompt a patient to complete an Intake Form again if they have already done so in the past. However, if you need patients to complete the same form again after a specific time period, you can change the
Require for new and existing patients
or
Valid for
setting for your Intake Form.
Was the Intake Form linked to an appointment booked retroactively for a date that has already passed?
If you’ve booked an appointment retroactively for a date that has already gone by, then Jane will not send an intake form automatically. However, you can send the intake form manually from the patient’s profile by clicking the
Email
button in the Online Intake Forms section.
Is the Patient able to login to their My Account portal?
Jane requires patients to log in to Jane using their username and password to complete any online forms sent. If the patient is stuck at this step, then they can
Reset their Jane Password
or you can send them a
Password Reset Email
from their profile.
We hope you feel like a confident “form-ensic” expert now, but if you still need help with your investigations, please
contact us
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)My Patient Didn’t Receive Their Intake Form: A Troubleshooting Guide
Forms, Surveys, and Ratings
My Patient Didn’t Receive Their Intake Form: A Troubleshooting Guide
6 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansHello, fellow detectives! 🕵️️🔍 Do you have a patient who did not receive their Intake Form? We’ve put together this troubleshooting guide for you to help you investigate.
Looking for more general info about Intake Forms? Check out our
Intake Forms
and
Intake Form FAQ
...
We hope you feel like a confident “form-ensic” expert now, but if you still need help with your investigations, please
contact us
as we’d love to help.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of intake form settings](https://jane.app/thumbs/afc79b50-c324-4a22-a1ef-408936eb5af8)
- ![screenshot of intake form settings](https://jane.app/thumbs/64f51b7f-f7ba-42e0-944a-75fe839f74fb)
- ![](https://jane.app/thumbs/30a7b65a-e848-425a-b984-45dc34cccd68)
- ![screenshot of completed intake form in patient profile](https://jane.app/thumbs/f4efaf9f-830a-47cf-b5c3-0658dd77c348)
- ![screenshot of email button for intake form](https://jane.app/thumbs/d3179460-9827-46e9-b14a-1d1767e34a19)
- ![screenshot of the where to view and find the option to send a password reset email](https://jane.app/thumbs/5698bcfb-eb93-4464-b4be-4ecd18613f7e)
