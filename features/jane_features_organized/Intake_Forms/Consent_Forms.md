...
*Source: [https://jane.app/guide/consent-forms](https://jane.app/guide/consent-forms)*

*Category: Intake Forms*

*Scraped: 2025-08-07 05:30:57*
...
💡For an in-depth resource on creating Intake Forms, check out our
Intake Forms
guide. It covers each section of the form setup, along with useful tips, so it’s a great place to start. This guide, however, focuses specifically on using Intake Forms to manage client consent, with a focus on the setup options for those types of Intake Forms specifically. Both resources will help you master Intake Forms in no time!
...
By selecting
Automatically prompt clients who have not completed this form
and linking it to all injectable appointments under the
Appointment Type
tab, you can ensure that clients receive the necessary form each time they book an appointment.
Under the
General
tab, you can set the Valid for option to
3 days
. This ensures that Jane sends a new Intake Form for each applicable injectable appointment, as long as it’s booked more than 3 days after the client’s most recent appointment.
...
By selecting
Send manually
, you’re able to select what clients to send this form to so that these requests can be handled as they arise.
Building Consents in the Questionnaires or the Consents Tab?
...
🔥
Hot tip!
This option is best suited for written consent where the client needs to simply agree, disagree, or acknowledge the consent.
Default Consents
In the
Consents
tab, Jane offers several pre-built, commonly used consents for clinics, including agreements on the accuracy of information, privacy and sharing policies, and cancellation policies. These default options can save you time and effort in creating these common consents; however, they can also be easily removed by hitting
Remove Consent
...
🔥
Hot tip!
This option is best suited for situations where you are providing your clients with options to select from for the consent. For example, if they are provided with an a, b, c, and/or d option to pick from.
Creating Questionnaires
In the
Questionnaires
tab, there are items such as
Check Boxes
,
Drop Down
,
Range / Scale,
etc. which allow you to build out different options for clients to select.
You can add as many chart items as you need for each question that you would like included in your form.
For an in-depth breakdown of each item that can be used, our Intake Forms guide has a whole section dedicated to
Questionnaires
.
❗️
Heads up!
...
Within the
Consents
tab, there is a simple
Require Signature
check box that can be used.
To learn more about this setting, feel free to check out our
...
Signature
item which can be added at any point throughout the form.
When a Signature item is added, you can make the signature mandatory by clicking the
three dots
and then the
pencil
to edit.
From there, you can simply slide the toggle for
Required
and
Save
.
...
As always, we’re here to help, so don’t hesitate to
Contact Us
if you have any questions or need assistance with setting up your consents. Happy form-building! 📝
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Consent Forms
Forms, Surveys, and Ratings
Consent Forms
9 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansCollecting and storing client consent is a crucial step for many practices so we’ve put together this guide to show you how Intake Forms can make the consent process easier and more efficient! ✍️
💡For an in-depth resource on creating Intake Forms, check out our
Intake Forms
guide. It covers each section of the form setup, along with useful tips, so it’s a great place to start. This guide, however, focuses specifically on using Intake Forms to manage client consent, with a focus on the setup options for those types of Intake Forms specifically. Both resources will help you master Intake Forms in no time!
Want to skip to the section you need? Go for it! Or you can keep reading to learn everything about setting up consents:
...
As always, we’re here to help, so don’t hesitate to
Contact Us
if you have any questions or need assistance with setting up your consents. Happy form-building! 📝Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![automatic consent forms](https://jane.app/thumbs/f2ccde45-435b-4141-8924-f59f2fb6f7fa)
- ![manual consent forms](https://jane.app/thumbs/48bfe90f-1716-4efe-a305-c828d7a5418e)
- ![consents in the consent tab](https://jane.app/thumbs/fd6c03d4-b955-4285-8322-2a60a177beef)
- ![formatting consents](https://jane.app/thumbs/94984c60-a3a5-4c52-95ef-efe7267cbd16)
- ![consents example](https://jane.app/thumbs/0bcad2ff-1880-4106-ac79-1de93be4ee90)
- ![consents in the questionnaires tab](https://jane.app/thumbs/b03e21a4-1206-40d4-99f8-5f634c2b1db2)
- ![consent questionnaire example](https://jane.app/thumbs/13b679e7-5e39-49a4-ad78-f0f18dce99a4)
- ![requiring signature for consents](https://jane.app/thumbs/327a79d3-cb6f-49ef-b3aa-1935b2634d2d)
- ![signature item](https://jane.app/thumbs/efc251e4-e967-4330-8f64-5e7bdbcba9b3)
- ![making signatures required](https://jane.app/thumbs/201944e6-0676-4aec-88af-fd6ccaee51c9)
