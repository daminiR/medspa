...
*Source: [https://jane.app/guide/take-back-your-treatment-time-with-online-intake-forms](https://jane.app/guide/take-back-your-treatment-time-with-online-intake-forms)*

*Category: Intake Forms*

*Scraped: 2025-08-07 05:32:29*
...
Feature OverviewTake back your treatment time with Online Intake Forms
Intake Forms
Take back your treatment time with Online Intake Forms
4 min read
Balance Plan
...
There’s no need to start from scratch with Jane’s Online Intake Forms. Choose a pre-made questionnaire template from our Template Library to get started, and customize it to fit your needs.
You can also create multiple forms and consents to be sent automatically for different practitioners, disciplines, or treatments.
...
Intake forms
.
Take a deeper dive into Intake Form settings with our
Intake Form Workshop
.
Make multiple Intake Forms for different practitioners, disciplines, or treatments with our guide on
Intake Forms in a Multi-Disciplinary Practice
.
Check out our tips and tricks to personalize your Intake Forms with our
Intake Forms Done Right
blog post.
Catch the
On Demand Webinar: Intake Forms over on our blog
.
Browse a list of the most widely used
...
. If you’re on Jane’s Insurance Plan, this is an excellent way to prepare for billing to one of Jane’s integrations (like
Claim.md
🇺🇸), or to a 3rd party biller.
Collect credit cards on Intake Forms
with Jane Payments to help reduce no-shows (or collect payment if they do happen).
See how easy it is for a patient to fill out their family member’s intake form with our
...
Collect signatures on your consents with our guide on
Intake forms: Require Signature Setting
.
Check out our guide on how to use
Intake Forms as consent to treat or to update forms
.
Want to learn more about a current Jane customer’s experience with Intake Forms?
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Take back your treatment time with Online Intake Forms
Intake Forms
Take back your treatment time with Online Intake Forms
4 min read
Balance Plan
Practice Plan
Thrive PlanStreamline the intake process
There’s no need to start from scratch with Jane’s Online Intake Forms. Choose a pre-made questionnaire template from our Template Library to get started, and customize it to fit your needs.
You can also create multiple forms and consents to be sent automatically for different practitioners, disciplines, or treatments.
Create and send as many forms as you like — they’re all free and included in your Jane subscription.
Get started setting up your
