...
*Source: [https://jane.app/guide/how-to-format-text-in-jane-a-markdown-cheatsheet](https://jane.app/guide/how-to-format-text-in-jane-a-markdown-cheatsheet)*

*Category: Intake Forms*

*Scraped: 2025-08-07 05:29:46*
...
Feature OverviewHow to Format Text in Jane: A Markdown Cheatsheet
...
💡
Jane tip
: You can use markdown in Jane anywhere that you see formatting instructions.
Each separate line of formatting needs its own space! This means you should hit
Enter
twice between different formatted sections to make sure they display correctly.
...
Add
four
spaces before the dash or number to create sub-items.
Type this:
You’ll see:
Main item
Sub-item
...
Type this:
[Visit Jane's website](https://jane.app)
You’ll see:
Visit Jane’s website
Email Links
You can also link to email addresses.
Type this:
[Email support](mailto:support@jane.app)
You’ll see:
Email support
Quoting and Highlighting
Block Quotes
...
🚗
Street parking
is available directly in front of our clinic. Please note that parking fees apply and can be paid at the nearby meters.
Line Breaks, Spacing, and Dividers
Creating Line Breaks
To create a new paragraph, hit
Enter
twice (leave a blank line).
Type this:
You’ll see:
...
If you’re having trouble with any formatting or have additional questions about using markdown in your Jane account, we’re here to help, so don’t hesitate to
Contact Us
. Happy formatting! 📝
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Format Text in Jane: A Markdown Cheatsheet
Forms, Surveys, and Ratings
How to Format Text in Jane: A Markdown Cheatsheet
5 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansMarkdown is a simple way to format your text using just a few special characters. Instead of hunting for buttons or menu options, you can make text bold, create headers, or add lists by typing symbols like asterisks (*) or hashtags (#).
This guide will teach you all the formatting tricks with examples that make sense, so you can go from plain text to perfectly formatted in minutes.
💡
Jane tip
: You can use markdown in Jane anywhere that you see formatting instructions.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/8f85745a-3f01-4875-9cca-9f67c86ff431)
- ![An image of what the clinic should type in to get a bulleted list created](https://jane.app/thumbs/de2a07e3-c688-4faa-a2b0-92cc048845ed)
- ![An image of what the clinic should type in to get a numbered list created](https://jane.app/thumbs/c6c7290f-905c-459a-9142-2f9f01cf92bd)
- ![An image of what the clinic should type in to get a nested list created](https://jane.app/thumbs/b2ba6ba2-7f8a-4335-a2ba-d581f2ead469)
- ![An image of what a clinic would type in to get a quoted line](https://jane.app/thumbs/49789bdb-91ab-4f55-9fe8-fc8b6900110a)
- ![A short video walking through howe to create a paragraph break](https://jane.app/thumbs/00fd91cb-5fc9-45de-9670-2b3b0c9f696e)
- ![An image of how the divider appers when added](https://jane.app/thumbs/239a3268-e0d5-43cb-9af1-3d96dafef18b)
- ![Like this cute cat for example](https://jane.app/thumbs/d8b070c4-d0fc-4011-9124-d97495541d5b)
