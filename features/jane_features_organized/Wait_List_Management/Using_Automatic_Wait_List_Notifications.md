...
*Source: [https://jane.app/guide/using-automatic-wait-list-notifications](https://jane.app/guide/using-automatic-wait-list-notifications)*

*Category: Wait List Management*

*Scraped: 2025-08-07 03:07:50*
...
Feature OverviewUsing Automatic Wait List Notifications
Wait List Management
Using Automatic Wait List Notifications
5 min read
Thrive Plan
Legacy Plans
❗️ Heads up that the Wait List Notifications feature is only available on the Thrive or Legacy Plans. If you’re interested in upgrading your plan, check out our
Managing Your Jane Subscription
guide.
If you’re looking for more on
Jane’s Wait List
features, including
using Wait List Notifications without automatic notifications
, you can
hop on to this page!
Alright, now that we’re all set up, let’s talk about how you can use
automatic
Wait List Notifications to make your day a whole lot easier!
As mentioned in the
Set Up guide
, when an appointment is
cancelled
(administratively or by a client on your Online Booking site),
deleted, or moved
, Jane will scan your Wait List and
hold that spot
for any clients whose preferences/availability fit within that appointment time.
When you click on the black appointment block (which we refer to as your Wait List cue), the Wait List Notification panel will slide out and you’ll be able to:
1: ⏲️ Check the
countdown!
It starts as soon as an appointment is cancelled, deleted, or moved and will show:
The
admin buffer time
remaining before Jane sends an automatic notification
If an automatic notification has been sent, or if you send one early by clicking Send Notification Now, it will show how long your Wait List clients have left in their Exclusive Access period before the spot is released and can be booked by anyone
Admin Buffer Time:
If the appointment starts in
less than 24 hours
, Jane will give you
15 minutes
of admin buffer time before sending a notification
If the appointment starts in
more than 24 hours
, Jane will give you
2 hours
of admin buffer time before sending a notification
2: 🚀 Click
Send Notification(s) Now
to let all those clients know there’s an opening available.
If you’d like to send a notification earlier than Jane’s scheduled automatic send time, you can override that by clicking Send Notification(s) Now.
3: 🕊️
Cancel Notifications and Release the spot
so anyone can book into it.
If a notification hasn’t been automatically sent yet, you can choose to
Cancel Notification(s) and Release the Spot
.
If a notification has been sent, you can choose to release the spot before the Exclusive Access period is over by clicking
Release Time Slot
4: 👀 See which of your
Wait List client’s fit into that spot
based on their appointment preferences and availability. This is the list of clients that Jane will be sending a notification to!
Jane will also show you their
contact info
and give you the option to
hop directly into their profile
to see more about them (including their last appointment or any notes on their profile!)
When you click
Expand
, Jane will show you the details of their Wait List Request
...
When the spot is
released
, either by you or automatically when the countdown ends, anyone can book into that spot as they normally would (administratively or through the Online Booking site).
To see what notifications will look like for your clients, you can check out our guide
Wait List Notifications: Your Client’s Experience.
More questions? Need some troubleshooting help? Want to see how this will look for your clients? Find the answers you need in our
Wait List hub!
If you’d like to chat with us about how this feature could work best for you, please don’t hesitate to
reach out
. 💙
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Using Automatic Wait List Notifications
Wait List Management
Using Automatic Wait List Notifications
5 min read
Thrive Plan
Legacy Plans❗️ Heads up that the Wait List Notifications feature is only available on the Thrive or Legacy Plans. If you’re interested in upgrading your plan, check out our
Managing Your Jane Subscription
guide.
If you’re looking for more on
Jane’s Wait List
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/9c7a0724-d212-4db9-9607-9ead74c87728)
- ![](https://jane.app/thumbs/c5854ed9-d7bd-469f-8409-7269eb32c347)
- ![](https://jane.app/thumbs/65596a23-07a8-40b4-8945-92259c4d97a3)
- ![](https://jane.app/thumbs/4a254277-6a56-4003-ac36-698bf777b257)
- ![](https://jane.app/thumbs/7eb3cb65-400e-4c61-9ab9-121b20d3e109)
- ![](https://jane.app/thumbs/d070f90e-795a-42ac-955e-af0d7b4e7165)
- ![](https://jane.app/thumbs/40abc323-6de0-48c5-9e10-c013c839e924)
- ![](https://jane.app/thumbs/60e0a231-0169-4ac4-8ffc-81663a4ce61c)
- ![](https://jane.app/thumbs/62c70d6d-f7e2-4403-951f-0d3539200c86)
