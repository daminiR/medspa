...
*Source: [https://jane.app/guide/practitioner-sign-in](https://jane.app/guide/practitioner-sign-in)*

*Category: Practitioner Profiles*

*Scraped: 2025-08-07 03:43:15*
...
Feature OverviewPractitioner Sign In
...
Thrive Plan
Welcome!
Well it looks like you’re with a clinic that is running things with Jane! :)
That’s very exciting, and this guide is a great place to start.  We hope you enjoy working with Jane as much as we do, and please let us know if you run across anything you think could be better (or anything that you just LOVE!).  We like hearing both.
Getting Started
To get you started please watch this video below about creating a username and password and signing in for the first time. It covers a few things which you can find more information about in some other help documents in this and other areas of the guide including Browsers and Devices, Email Notifications, Signing In and Accessing Jane.
Charting Review
And it would be a good idea to review the whole Charting Section above and to the left in this guide:
Further Video Tutorials
Here’s some other helpful videos for further viewing:
Charting Overview Video
Charting Details Video
Don’t be Shy!
We’re always here to help - so if you can’t find the info you’re looking for in the guide please give us a shout either at support@janeapp.com, through the Need Help button or by giving us a call.
Welcome to Jane!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Practitioner Sign In
Practitioner Profiles
Practitioner Sign In
2 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/12/08/25lp92ycpu_blob)
