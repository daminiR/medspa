...
*Source: [https://jane.app/guide/jane-s-brand-assets](https://jane.app/guide/jane-s-brand-assets)*

*Category: Welcome*

*Scraped: 2025-08-06 23:27:49*
...
Feature OverviewJane's Brand Assets
Welcome
Jane's Brand Assets
6 min read
Looking to use Jane’s brand assets on your website, social media, or newsletter? We’ve got you covered.
Our Name
Jane.
It’s simple, clean, and easy to remember.
We also go by
Jane App
if you prefer.
Want to learn more about how we chose the name Jane?
Check out our blog post on how we came up with the name Jane
, and some of the other options we were considering.
Our Voice
If our mission is what we say, our voice and tone is how we say it.
And since humans are social beings, when it comes to making connections – personality counts.
Here’s what we are (and aren’t)
Friendly (but never bubbly or over-the-top)
Clever (but never silly)
Helpful (but not too technical or overcomplicated)
Delightful (by going beyond what’s to be ‘expected’)
Knowledgeable (but we always stay curious)
Confident (but never aspirational or over-exaggerated)
Human (because we speak as if we’re sitting next to you)
Here’s a simple rhyme we made up to help you remember:
Jane’s tone is casual and sometimes fun, but not goofy or overdone.
🎵
Below, we’ve put together a few descriptions of Jane so that you don’t have to.
About Jane
When talking about Jane, knowing some common vocabulary used in different regions can come in handy.
We’ve bolded a few words
below that often vary between our friends in Canada 🇨🇦 and the US 🇺🇸. For instance, in Canada, “practitioners” is preferred while in the US, “providers” is more common. Depending on where your audience is from, you can drop the word that doesn’t fit (we’ve got little flag emojis to help guide you).
About Jane in One Sentence
Jane is a clinic management software and EMR for health and wellness [
practitioners
🇨🇦
/providers
🇺🇸
]
that makes it simple to book, schedule, meet, chart, bill, and get paid.
Jane is a clinic management software and EMR for health and wellness [
practitioners
🇨🇦
/providers
...
that helps them open, run, and grow their businesses.
Meet Jane. A clinic management software and EMR with features designed to reduce your admin load so you can get back to doing more of what you love – helping your patients or clients.
About Jane in One Paragraph
Jane is a clinic management software and EMR designed to be an extra set of helping hands in your health and wellness business. Available online and on any device, Jane has branded online booking, scheduling, [
...
templates and online forms, integrated payments, telehealth, and more — wrapped up in one beautiful package that even your patients/clients will love. Backed by our unlimited human support available by phone, email, and chat (even on Saturdays!), Jane is here to help you get back to the work you love.
About Jane in a Few Paragraphs
Co-founded by an owner of a multi-disciplinary clinic and a developer with an obsessive eye for design, Jane is both beautiful to use and very intentionally focused on the needs and workflows of hard-working private practices.
Jane is a clinic management software and EMR designed to be an extra set of helping hands in your health and wellness business. Available online and on any device, Jane has branded online booking, scheduling,
[insurance management
🇨🇦
/insurance billing
...
templates and online forms, integrated payments, telehealth, and more — wrapped up in one beautiful package that even your patients/clients will love.
Backed by our unlimited human support available by phone, email, and chat (even on Saturdays!), Jane is here to help you get back to the work you love.
Our Story
Want to learn more about how Jane came to be?
Pop over here to read the Jane Story
.
Our Colour
Our Logo
Think of our logo as a name tag. You could even wear it as a costume at your next Halloween party. Seriously, this happens almost every year, and we love it. 💙
The wordmark of our logo is constrained within a specific curved shape. Our classic logo is our Jane blue logo. On darker backgrounds, use the reverse white logo to help make Jane pop.
Download the Jane Logo
The Fine Print
But wait…
✔ Keep the space around the logo clear of graphics, patterns, and other type. Please use the “e” character from the logo as a reference for creating a clear space around.
✔ Do scale our logo proportionally, as long as it’s readable, go as big or small as you need though we do recommend a minimum size of no smaller than .5” x .5” or 48px x 48px.
✔ When placing our logo on a dark background, use the reverse (white) version which we designed specifically for this type of application.
You can download our logos here.
✗ Do not modify, distort or alter the Jane logo in any way. Please only use the files we’ve provided above.
When showcasing your
official marketing partnership
with Jane (i.e., Jane Ambassadors, Education, Association, and Alliance Partners), we ask that you use our logo correctly and in accordance with our brand guidelines. If you’d like guidance on how to make this announcement or have any questions about logo usage, please reach out to us:
For Ambassador Program inquiries:
ambassadors@jane.app
For all other Partnership inquiries:
partnerships@jane.app
And remember…
This is a friendly reminder that these graphics are proprietary and protected under intellectual property laws. For detailed guidelines on using our trademarks, please visit our
Trademark Usage Page
.
Questions?
Send us an email at
support@jane.app
, and our team would be happy to answer any questions you might have.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane's Brand Assets
Welcome
Jane's Brand Assets
6 min readLooking to use Jane’s brand assets on your website, social media, or newsletter? We’ve got you covered.
Our Name
Jane.
It’s simple, clean, and easy to remember.
We also go by
...
Send us an email at
support@jane.app
, and our team would be happy to answer any questions you might have.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/052bc284-701a-451f-a7c8-8ff419caeb11)
- ![](https://jane.app/thumbs/1b11eff4-3461-4db9-8e5d-8e14e112b97f)
- ![](https://jane.app/thumbs/0197aeeb-af77-4056-a8ed-e5cc0df992ca)
- ![](https://jane.app/thumbs/e98c9846-edf6-4ccd-8041-d6dfc7e97b1b)
- ![](https://jane.app/thumbs/6d7260cb-efb2-4750-a239-af9c95dc1508)
- ![](https://jane.app/thumbs/ae638ece-cbb9-44da-ad75-19e5cfed687b)
- ![](https://jane.app/thumbs/a4d0fdde-9c26-4756-bbbe-56bfc91768c8)
