...
*Source: [https://jane.app/guide/getting-started-with-online-appointments-12065ba0-38d1-4f0a-a045-f53a091e26d5](https://jane.app/guide/getting-started-with-online-appointments-12065ba0-38d1-4f0a-a045-f53a091e26d5)*

*Category: Online Appointments (Telehealth)*

*Scraped: 2025-08-07 00:42:34*
...
Feature OverviewGetting Started with Online Appointments
...
Thrive Plan
Legacy Plans
Check out the following guides to learn how to get started with Online Appointments:
Getting Started - For Clients
How to Join Your Online Appointment (For Clients)
Troubleshooting Tips for Online Appointments
...
Weighing the benefits of offering Online Appointments
Setting up Jane’s Online Appointments
How to Join Your Online Appointment (For Practitioners)
Collecting Payments for Online Appointments
Online Booking Availability for Online Appointments
...
Online Appointments for Groups is our first optional add-on,
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Getting Started with Online Appointments
Online Appointments (Telehealth)
Getting Started with Online Appointments
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansCheck out the following guides to learn how to get started with Online Appointments:
Getting Started - For Clients
How to Join Your Online Appointment (For Clients)
Troubleshooting Tips for Online Appointments
Joining an Online Appointment in Jane’s Mobile App
...
Troubleshooting & FAQ
Online Appointments: A Troubleshooting Guide
Online Appointments FAQSubscribe to our monthly newsletter.Jane Software Inc.
