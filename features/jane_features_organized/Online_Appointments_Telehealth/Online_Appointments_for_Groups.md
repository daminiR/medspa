...
*Source: [https://jane.app/guide/online-appointments-for-groups](https://jane.app/guide/online-appointments-for-groups)*

*Category: Online Appointments (Telehealth)*

*Scraped: 2025-08-07 00:47:50*
...
Feature OverviewOnline Appointments for Groups
Online Appointments (Telehealth)
Online Appointments for Groups
8 min read
Online Appointments for Groups is an optional add-on,
for an additional $15 per practitioner, per month
. It is compatible with all plans and can be added to your subscription and cancelled at any time.
With Online Appointments for Groups, you can securely host unlimited online sessions for
up to 12 related clients
at once. This feature is meant for multiple clients who know each other and are joining virtually online from separate locations (or on separate devices). Examples of Group Online Appointments are family and couples therapy sessions.
All calls are HIPAA, PIPEDA, and GDPR-compliant. To learn more, check out our
...
💡 Before we dive in, it’s important to note that Online Appointments for Groups cannot currently be used to meet with a group of unrelated clients who do not know each other (e.g., a fitness class or group therapy). This is a functionality that the team is actively exploring, and if this would make the feature more helpful to you,
we’d love for you to share your feedback here
.
...
The first step in using Online Appointments for Groups is to enable it for any practitioners who offer this type of service.
Note:
These steps will need to be completed by a
Full Access
user.
Start by heading to
Settings
...
toggles
to enable all the practitioners who will offer Online Appointments for Groups. As a reminder, a Group Online Appointment is any appointment where more than two related clients join virtually online from separate locations (or on separate devices).
💡 You do not need to enable Online Appointments for Groups for practitioners who only offer 1:1 Online Appointments. A 1:1 Online Appointment is where one practitioner and one client join the call. Jane’s
1:1 Online Appointments
is available for all accounts at no extra cost.
Don’t forget to hit
Save
!
A pop-up will appear confirming the changes to your account and notify you of the per-practitioner charge for using Online Appointments for Groups. When you’re ready, click
Confirm
to save those changes.
Setting up a Group Online Appointment
To set up a Group Online Appointment, start by navigating to
Settings > Sessions, Classes & Group Appointments > New Session.
Note:
These steps will also need to be completed by a
Full Access
user.
...
And those are all of the unique fields you need to select to set up a Group Online Appointment! From here, you’ll want to finish filling out the rest of the preferences as you would a standard session. For an in-depth walkthrough on how to configure the remaining settings, check out our guide on
...
Scheduling a Group Online Appointment
You can schedule an Online Group Appointment the same way as all other appointment types. You’ll want to head to the schedule and click on the time when you’d like to book the session.
...
You can learn more about managing (adding and arriving) clients in an Online Group Appointment, by reading our guide on
Group Appointments
.
Disabling Online Appointments for Groups for a Practitioner
...
Once there are no longer any upcoming Group Online Appointments, you can head to the
Staff tab > click on the staff member’s name > Sessions, Classes & Group Appointments > disable the toggle
next to any Online Group Appointments.
The final step is to head into your
Settings > Online Appointments for Groups
and disable the practitioner in the list. You’ll see the same pop-up confirming the changes you’re making to the account. Don’t forget to Save the changes.
Additional Notes & Features
Breakout Rooms
For group sessions, you can also create breakout rooms for your participants. Once you’ve joined the virtual session, you’ll want to hover over the
People
icon and then click on
Breakout Groups.
Within the panel on the right, you’ll have the option to drag the names of each participant into a group, use the auto-assign feature, or give participants the option to split themselves into groups.
To rename a breakout group, click on the pre-populated group name and type in the desired name.
To end a breakout session, you’ll want to click on the
End
button in the bottom right corner. This doesn’t end the entire session, just ends the breakout rooms.
Here are some additional guides on all of the different settings you can adjust within your Online Appointments:
Online Appointments: Sharing your Screen
guide for details on how both clients and practitioners can share their screen during a session.
How to Join Your Online Appointment (For Practitioners)
for details on all the settings you can adjust within your online appointment.
If you have any questions about Online Appointments for Groups, don’t hesitate to
get in touch
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Online Appointments for Groups
Online Appointments (Telehealth)
Online Appointments for Groups
8 min readOnline Appointments for Groups is an optional add-on,
for an additional $15 per practitioner, per month
. It is compatible with all plans and can be added to your subscription and cancelled at any time.
With Online Appointments for Groups, you can securely host unlimited online sessions for
up to 12 related clients
...
If you have any questions about Online Appointments for Groups, don’t hesitate to
get in touch
and we’ll be happy to help.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/0576189c-fdaa-4aec-bec0-ab24be198f41)
- ![](https://jane.app/thumbs/17f1edc1-b332-45ae-a72b-54ad3f0ea745)
- ![](https://jane.app/thumbs/6031031d-a4b2-474c-92d9-76a5afc88fea)
- ![](https://jane.app/thumbs/d833f075-563f-401a-bd5e-2ee225e23503)
- ![](https://jane.app/thumbs/66e3ce81-29b2-4cb9-8a4f-6bdc8d758c5d)
- ![](https://jane.app/thumbs/b770d0bb-ede3-4279-8f82-241d8ff5141d)
- ![](https://jane.app/thumbs/e9c37e42-511b-4a7d-bf59-ccac2f801f10)
- ![](https://jane.app/thumbs/6c621864-db3a-4089-90e3-271d14bfe3ec)
- ![](https://jane.app/thumbs/3d1f820a-e078-494f-afd8-f32358641346)
- ![](https://jane.app/thumbs/6ceefc6d-a932-4fcd-b77f-3d74f916845d)
- ![](https://jane.app/thumbs/daada7c6-1dc8-4ee8-9cc8-878821eb552a)
