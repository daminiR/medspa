...
*Source: [https://jane.app/guide/create-and-load-a-gift-card-administratively](https://jane.app/guide/create-and-load-a-gift-card-administratively)*

*Category: Gift Cards*

*Scraped: 2025-08-07 04:37:36*
...
Feature OverviewCreate and Load a Gift Card Administratively
Gift Cards
Create and Load a Gift Card Administratively
6 min read
Balance Plan
Practice Plan
Thrive Plan
You don’t need to have fancy Starbucks-style gift cards to use Jane’s gift cards feature.  You can create, track, and redeem gift cards all within Jane. We can work with gift cards in a few different places in Jane.
🎁 Did you know that clients can purchase gift cards online? Learn more in our
Working with Online Gift Cards
guide.
Enable Gift Cards
First, you’ll want to enable Gift Cards. To do this head to
Settings
from the top blue bar of your account and scroll down to and select
Billing Settings
.
...
, is where you can set the maximum amount of money that can be loaded onto a Gift Card.
Where to Create Gift Cards in Jane
Receive Payment Screen
You may have noticed anytime you take a payment from your clients, Jane will allow you to
Load a Gift Card
from the
Receive Payment
screen.
Billing Tab
You can also generate a gift card by heading to the
Billing
tab in the upper left-hand side of your screen.
Click
the
Gift Cards
button in the menu on the left-hand side.
Client’s Profile > Billing > Gift Cards
Jane will allow you to load gift cards directly from the client’s profile as well by heading to
Billing > Gift Cards
.
Once you have landed on one of these screens, you can either enter in a name or number to
create a new gift card
, or you can even let Jane generate a unique gift card number for you.
Let Jane Generate a Fresh (Gift Card) Number
To have Jane generate a gift card number, go to the
Billing
tab, then
click
the
Gift Cards
item in the menu on the left. You’ll see a
New Gift Card
button in the top right corner. Give it a click.
In the pop-up window, click the
generate a fresh number
link.
Jane will ask you to search for the client who is loading money onto the gift card. If the person buying the gift card is not a client at your clinic, you can use a profile with your clinic’s name or named something like “walk-in purchases” instead.
Select the profile you will be recording the payment under, and the
Receive Payment
screen will open with your gift card.  Enter the payment details and amount to load onto the card, click
Pay
, and you’re done!
Or, If you already have gift certificates with numbers
Go to the
Billing
tab, then click the
Gift Cards
item in the menu on the left.
In the search field enter in your Gift Card number, or if you do happen to have a plastic gift card, you can use a USB scanner to scan in the number for you.
💡
Note:
The gift card number you enter must be at least
6 digits long
and cannot start with a 0. You may start with letters, so if your card number is #003 you could label it something like “
GC#003
”
Click the
Create New Gift Card #
text.
Then Jane will ask you to search for the client who is loading money onto the gift card. Again, if the person buying the gift card is not a client at your clinic, you can use a profile with your clinic’s name, or named something like “walk-in purchases” instead.
Select the client, and the
Receive Payment
screen will open with your gift card.  Enter the payment details and amount to load onto the card, click
Pay
, and you’re done!
Pro Tip: Name vs. Number
If your client is buying a gift card for another client already within your practice, consider giving your gift card a
name
rather than a number. This makes the gift card real easy to search when the recipient comes in to redeem the card for treatment or services.
; )
Should you decide to give your gift card a name instead of a number, just be sure to have at least 6 digits and no spaces within the name as pictured above.  Who doesn’t love a good hashtag? No need to add that
#
symbol though when creating the Gift Card Name/Number. Jane will put that in there for you on your behalf.
Additional Notes
When a gift card is sold administratively, there isn’t a direct way for staff to email the gift card to the recipient from Jane. During the payment process, the receipt is emailed to the person that loaded the gift card, including details with the gift card number.
Here’s what it looks like:
If you already have the gift card created in Jane and would like to re-load it for another transaction, check out the
How to reload a gift card
page for instructions. To redeem a Gift Card, check out
Redeeming a Gift Card
.
As always, give us a shout if you
need a hand
!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Create and Load a Gift Card Administratively
Gift Cards
Create and Load a Gift Card Administratively
6 min read
Balance Plan
Practice Plan
Thrive PlanYou don’t need to have fancy Starbucks-style gift cards to use Jane’s gift cards feature.  You can create, track, and redeem gift cards all within Jane. We can work with gift cards in a few different places in Jane.
🎁 Did you know that clients can purchase gift cards online? Learn more in our
Working with Online Gift Cards
guide.
Enable Gift Cards
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/3dd2e671-6aa7-41be-8a8d-e2fb25737541)
- ![](https://jane.app/thumbs/45cf68b2-fb6d-4b76-b7c2-14331dfa0fa5)
- ![](https://jane.app/thumbs/0c2a2917-1b33-4e5c-800b-cc1fe7f639af)
- ![](https://jane.app/thumbs/d3de670f-aa0a-4256-ba3a-1b80940af665)
- ![](https://jane.app/thumbs/f0778030-75c2-4c1c-a1af-5d1ea06884b7)
- ![](https://jane.app/thumbs/cb44ae98-027d-4e82-b427-c81ec6d270ea)
- ![](https://jane.app/thumbs/fd447e08-ddf9-49e5-9d99-727d7f5d63f8)
- ![](https://jane.app/thumbs/637a63db-a3d1-481a-81b7-2c018bc1f9f4)
- ![screenshot of where to find the gift card number on the emailed receipt](https://jane.app/thumbs/f2bd95f8-375e-48ca-b4b3-1fb3f372752c)
