...
*Source: [https://jane.app/guide/transferring-a-gift-card-balance](https://jane.app/guide/transferring-a-gift-card-balance)*

*Category: Gift Cards*

*Scraped: 2025-08-07 04:36:59*
...
Feature OverviewTransferring a Gift Card Balance
Gift Cards
Transferring a Gift Card Balance
5 min read
Balance Plan
Practice Plan
Thrive Plan
From time to time family members and friends like to share their own
Gift Cards
with their loved ones. In these instances, Jane will allow us to do this in a couple of ways.
Simple Way to Share a Gift Card
The quickest way to share a
Gift Card
balance from one patient to another is to simply
Redeem the Gift Card
at the time of purchase.
Receive Payment
as usual. In the final
Pay
screen click
Add Payment Method
and select
Redeem Gift Card…
from the list in the popup window.
Search the name or number of the
Gift Card
belonging to the patient who wants to share their
Gift Card
balance with the client.
If the
Gift Card
covers the entire amount, you can remove the default payment method by clicking the
X
or you can leave it if the
Gift Card
only covers a portion and another payment method is required to pay in full.
Hit
Pay
and you are done…Easy peasy!
Officially Transfer the Balance
Since direct transfers aren’t a thing (yet), this process comes in handy if you’d like to see the credit reflected on another patient’s profile or if you need to transfer a credit between two patient profiles. For those needing to transfer a credit from one account to another, you’ll want to start by
Loading the Gift Card with the Credit on File
.
Let’s break down the steps together!
Head to the profile of the patient whose
Gift Card
you wish to transfer. Go to
> Billing > Gift Cards
and click on the name of the
Gift Card
you would like to share between patients.
Click the
Transfer Balance
button.
Search and select the name of the patient you wish to
Transfer the Balance
to.
You’re done!  Jane is now storing the balance as a credit on the recipient’s profile and listing it under their
Billing > Gift Cards
tab.
NOTE:
Using the transfer balance feature will update the payment method on receipt and statements from
Gift Card
to
Account Credit
.
Transferring a Balance Back to a Gift Card
To start, you’ll want to go back to the gift card itself by heading over to the
Billing
tab and selecting
Gift Cards / Certificates
. From there, you’ll want to click on the word
View
to the right of the gift card:
Next, click on the blue
Load Card
button in the top right corner.
Enter the name of the patient that the gift card balance was
transferred to
and who now has a credit on their account.
Look a little familiar? Now you’ll enter in the total amount of the credit that was transferred. In the below example, we’re working with
$100
.
Make sure to remove any pre-populated payment methods and to click on the blue
Add Payment Method
text.
A pop-up will appear and make sure to select the
Account Credit
as the payment method:
To ensure that you’re not sending a notification to the patient about this change, the recommendation here would be to select the
Pay
button with no icons
.
After reloading the gift card, you have the option to delete or refund the original payment. For more details on how you can delete or refund a gift card purchase, check out this guide:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Transferring a Gift Card Balance
Gift Cards
Transferring a Gift Card Balance
5 min read
Balance Plan
Practice Plan
Thrive PlanFrom time to time family members and friends like to share their own
Gift Cards
with their loved ones. In these instances, Jane will allow us to do this in a couple of ways.
Simple Way to Share a Gift Card
The quickest way to share a
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/0dbcabe3-c858-4d20-8da4-321fbeccc620)
- ![](https://jane.app/thumbs/9b56f288-b42a-4b56-93b0-c15c1867d1e1)
- ![](https://jane.app/thumbs/b8964132-54b2-4e01-bfd3-2df9dce406e7)
- ![](https://jane.app/thumbs/0988e94b-f1a9-4352-aa14-c5817045cecc)
- ![](https://jane.app/thumbs/b63645e1-6e93-43a9-acce-54c8945ffbe1)
- ![](https://jane.app/thumbs/1ef6fdf6-5238-46e6-894e-cf8ac39e24f0)
- ![](https://jane.app/thumbs/755f5f93-e9b2-4b8c-ae7f-f9cd185edde8)
- ![screenshot of navigational steps](https://jane.app/thumbs/15b2ebc0-532a-432f-92eb-ed5dd02b5070)
- ![screenshot of where to find the load gift card button](https://jane.app/thumbs/6d8d6081-6566-4e75-8857-c2ab345285ca)
- ![screenshot of where to enter the name of the gift card](https://jane.app/thumbs/703a3f78-b0c7-4039-9074-b0ee197768a6)
- ![screenshot of where to enter the amount you're loading](https://jane.app/thumbs/d81457bd-1bcc-443d-8b2b-280c5314b2e6)
- ![screenshot of where to find the blue add payment method text](https://jane.app/thumbs/18ec5672-8b28-4c16-b39d-5d2f5d41e3e9)
- ![screenshot of where you'll see the account credit listed to select](https://jane.app/thumbs/329ac06b-0549-4649-a521-7e7c0c799f2b)
