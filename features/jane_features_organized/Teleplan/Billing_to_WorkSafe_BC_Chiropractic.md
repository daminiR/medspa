...
*Source: [https://jane.app/guide/billing-to-worksafe-bc-chiropractic](https://jane.app/guide/billing-to-worksafe-bc-chiropractic)*

*Category: Teleplan*

*Scraped: 2025-08-07 04:39:38*
...
Feature OverviewBilling to WorkSafe BC – Chiropractic
Teleplan
Billing to WorkSafe BC – Chiropractic
7 min read
Practice Plan
...
so you can use Jane to handle all of your WSBC submissions.
If you haven’t already done so, you will need to
Sign Up with Teleplan
and then
Add Your Data Centre to Jane
.
Additionally, you must apply for and sign a contract with Worksafe BC in order to become an approved provider. You can find more information about that
here
.
In the meantime, you can still set up the WSBC insurer and claims in Jane.
Note
📝:
If you’re unsure of which injury codes to use for these claims, you can head over to WSBC’s website for more detailed information:
WorksafeBC Body Part Codes
and
...
, click on the
New Insurer
button in the top right and select the “WSBC - Teleplan” insurer type from the list or
Create a New One
to track this manually instead if you do not wish to use our integration.
...
Legal Gender
Address (the province is the most important part, make sure that
BC
is entered just like that, no dots or spaces)
Create a Claim
You can review our guide for the basics of
Creating a Claim
.  WSBC claims don’t vary too much from other claims you’d track through Jane.
...
Nature of Injury
End Date
These fields must match what has been approved on the claim. To check the status of the claim and what has been approved, you can visit Worksafe’s Claim Status page
Here
.
...
19134
Fee:
base $86 + $15 timely completion bonus (within 3 business days) + $15.00 Teleplan submission bonus = $122.50 Total
Fee includes all services required to complete the Form 8C and the
first two visits
.
NOTE
: If you do not receive all the bonuses associated with 8C fee code (i.e. do not submit the report within 3 business days) you will need to
Write Off
the balance of the visit not paid by WSBC. You cannot bill the $15 to the patient.
Also, it’s a good idea to
avoid using special characters
like apostrophes or accents in the report, as this can sometimes prevent the claim from going through.
11C and 8 Week Treatment Block
Billing code:
19135
Fee:
base $505 base + $15 Teleplan submission bonus = $520 Total
...
Scroll to the
Insurance
section and click on the “Add Document” button.
...
The completed report will be attached to the claim when sent to Teleplan.
Always make sure that the Report is complete, with all boxes filled and with the correct information before you move the claim into the Queued area.
Forms that are submitted with any blank fields will be rejected and may take more than one billing cycle to resolve.
...
For more information about any other fee codes you might need to bill for WSBC or for information regarding the Chiropractic updates beginning January 2020 please refer to
WorkSafe BC’s Chiropractic Services Memorandum of Agreement
...
Chiropractor looking for an online booking system
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Billing to WorkSafe BC – Chiropractic
Teleplan
Billing to WorkSafe BC – Chiropractic
7 min read
Practice Plan
Thrive PlanIf you’re practicing in BC, you should be eligible to submit your Worksafe BC claims and Chiropractic Reports 8C and 11C online via our Teleplan integration.
To make things one step easier, we’ve integrated with the
Medical Services Plan (MSP) Teleplan system
so you can use Jane to handle all of your WSBC submissions.
If you haven’t already done so, you will need to
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/61538939-9fe0-4e20-a342-d62fd985b251)
- ![](https://jane.app/thumbs/76da9f00-ce35-438f-b68a-683cbcd45378)
- ![](https://jane.app/thumbs/2f6a7e67-60eb-4e07-b871-5e180d0f88cf)
- ![](https://jane.app/thumbs/7c75c057-22c1-4d13-8362-9382b7a94d82)
- ![](https://jane.app/thumbs/b1b59433-ec96-4047-b8f1-94ffc57a0307)
- ![](https://jane.app/thumbs/0b53abd9-c3fc-4ba1-82c1-22ad58f761bd)
- ![](https://jane.app/thumbs/63d5d7ac-e096-4982-8b0f-add119519544)
- ![](https://jane.app/thumbs/b98be3f6-7263-4e7d-9423-6f16613f8477)
- ![](https://jane.app/thumbs/c5cdd5ac-5cd8-4821-ab06-6a63dad292bc)
