...
*Source: [https://jane.app/guide/adding-your-data-centre-to-jane](https://jane.app/guide/adding-your-data-centre-to-jane)*

*Category: Teleplan*

*Scraped: 2025-08-07 04:38:23*
...
Feature OverviewAdding Your Data Centre to Jane
Teleplan
Adding Your Data Centre to Jane
4 min read
Practice Plan
Thrive Plan
Please remember to view our guide on managing the Teleplan transition from one software to Jane:
Teleplan Transition
If you need to create a new Data Centre, please refer to this guide:
...
Start by logging into the Teleplan Portal:
...
Once you’ve updated your password and have your Data Centre and Payee number handy, go into
Teleplan Info
...
💡Pro Tip
: This section is case-sensitive. Typically we see Data Centre numbers are capitalized (e.g.
T1234
), and usernames are lowercase (e.g.
ttut1234
)
If you click the
Manage Password
checkbox, Jane will auto-update your password every 40 days when Teleplan prompts for a new one, instead of requiring you to manually update it each month.
You can click “Test Login” afterwards to ensure the account is connected.
Step 3: Add Your Staff’s Teleplan Information
Now that you have your Data Centre ready, we’ll need to add your MSP information into the staff profile. Go into each practitioner and go to
Edit/Settings > Settings
At the bottom of this page is a
Teleplan
section, where you will need to add some more information.
Teleplan Service Location
is the code used to describe the type of clinic and is used by the Ministry of Health to collect data about treatment locations. This field is
optional
. The default which is already set for every Jane account is “N - Health Care Practitioner Office (non-physician)”. If you need to use a different Service Location Code for the type of billing you do (i.e. certain physicians) you can change that here. Otherwise, skip to the next field.
Teleplan Practitioner Number
is the number assigned to them by MSP
Teleplan Payee Number
is the MSP number of the account receiving payment.  If the practitioner receives payment directly, you will need to put the same number in both fields. If the clinic receives payment and pays this out to the practitioner, you can leave the field blank and payment will be assigned to the payee number listed on the Data Centre.
MSP Enrolment
is the enrolment status you registered with MSP.  Most practitioners will be Soft-Opted Out (where you collect part of the fee from the patient, and part from MSP)
And now you’re set to go!
You can follow our guide on
Creating a Patient Claim
to bill your items through Teleplan.
And here’s how to
Send Your Claims to Teleplan
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adding Your Data Centre to Jane
Teleplan
Adding Your Data Centre to Jane
4 min read
Practice Plan
Thrive PlanPlease remember to view our guide on managing the Teleplan transition from one software to Jane:
Teleplan Transition
If you need to create a new Data Centre, please refer to this guide:
Signing Up for Teleplan
Step 1: Update the Temporary Password
...
We already have all of the Teleplan codes you will need built into out system, so you just need to know the appropriate codes to use.
As always, feel free to connect with our support team if you need any help with this along the way.
Hope this helps!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/08/15/4m3kc9y1h1_blob)
- ![](https://jane.app/system/dragonfly/production/2016/08/15/1zshohidzv_blob)
- ![](https://jane.app/thumbs/c1490ad3-e77b-4819-8c61-8a89e1a885af)
