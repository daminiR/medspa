...
*Source: [https://jane.app/guide/signing-up-for-teleplan](https://jane.app/guide/signing-up-for-teleplan)*

*Category: Teleplan*

*Scraped: 2025-08-07 04:42:38*
...
Feature OverviewSigning Up for Teleplan
Teleplan
Signing Up for Teleplan
2 min read
Practice Plan
Thrive Plan
All of the forms found in the document below can be accessed on the government site:
Click Here
This is also a helpful guide:
Click Here
Data Centre
To register for Teleplan, you’ll need to register your location as a “Data Centre”.  You can either sign up as a Solo Practice or you can get a Clinic Number.  To begin this process, submit an
Opted Out Enrolment Form
(Supplementary Benefits Providers - e.g. Physiotherapy, Massage Therapy, Chiropractic Care) or an
Opted In Enrolment Form
(medical physicians covered through MSP - e.g. MDs, Midwives).
To register with Jane as your Vendor, you would list:
Software Name
:  Jane Clinic App
Vendor
: Jane Clinic App
Supplier
: Thought Shop Creative Inc.
Application for Direct Deposit
It’s easy to let Teleplan know where to deposit your money.  Just fill out an
Application for Direct Bank Payment Form
.
MSP Practitioner Number
You will also have to register for an MSP number.  Naturopaths, Massage Therapists, Optometrists, Acupuncturists, Podiatrists, Chiropractors and Physiotherapists would fill out this
Practitioner Registration Form
.
Midwives will fill out this
Application for MSP Billing Number (Midwives) Form
.
Joining a Clinic
If you are joining a clinic that works with a clinic payee number, fill out an
Assignment of Payment Form
.
Teleplan Support Contact:
If you’re having any trouble setting up or receiving payment from Teleplan, here are some numbers to keep near:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Signing Up for Teleplan
Teleplan
Signing Up for Teleplan
2 min read
Practice Plan
Thrive PlanAll of the forms found in the document below can be accessed on the government site:
Click Here
This is also a helpful guide:
Click Here
Data Centre
...
If you’re having any trouble setting up or receiving payment from Teleplan, here are some numbers to keep near:
Vancouver: 604 456-6950
Other areas of B.C. (toll-free): 1 866 456-6950Subscribe to our monthly newsletter.Jane Software Inc.
