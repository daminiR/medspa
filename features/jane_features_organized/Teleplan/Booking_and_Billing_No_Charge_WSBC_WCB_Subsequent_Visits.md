...
*Source: [https://jane.app/guide/booking-and-billing-no-charge-wsbc-wcb-subsequent-visits](https://jane.app/guide/booking-and-billing-no-charge-wsbc-wcb-subsequent-visits)*

*Category: Teleplan*

*Scraped: 2025-08-07 04:40:05*
...
Feature OverviewBooking and Billing No Charge WSBC (WCB) Subsequent Visits
Teleplan
Booking and Billing No Charge WSBC (WCB) Subsequent Visits
2 min read
Practice Plan
...
Set Up the Insurer
In the Insurer area (Settings - Insurers) open your WSBC Insurer, first of all, ensure that your WSBC Insurer is set to not charge a user fee by leaving the box blank.
Next, make sure that the “patient pays remaining” check box is unchecked.
Create the Insurance Policy
Then when you create the insurance policy for the patient, just leave the default billing code blank.
When adding the claim to one of these zero dollar subsequent visits, it will look like this in the Insurer area of the Appointment Panel:
...
Once the billing code is added, you can add a diagnosis code:
Managing the Claim
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Booking and Billing No Charge WSBC (WCB) Subsequent Visits
Teleplan
Booking and Billing No Charge WSBC (WCB) Subsequent Visits
2 min read
Practice Plan
Thrive PlanBlock Billing Notes
Some disciplines have block payment agreements with WSBC. You’ll want to record and track these subsequent visits without sending anything in to WSBC.
At Jane, we’ve found the best way to do this is to insure the visit to the claim but leave the billing code blank.  This will attach the visit to the claim with a no charge appointment.
Set Up the Insurer
In the Insurer area (Settings - Insurers) open your WSBC Insurer, first of all, ensure that your WSBC Insurer is set to not charge a user fee by leaving the box blank.
...
And the associated appointments all in one place:
Hope that helps!
Now you’re done!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b250acf8-027f-4fb4-8ab4-8eb8d7073fdd)
- ![](https://jane.app/thumbs/a12a68b2-d63b-401c-96c8-bf93358b1a87)
- ![](https://jane.app/thumbs/17d8559c-20d5-4a68-bedb-928c6139c8c1)
- ![](https://jane.app/thumbs/3da55c71-c605-4dad-b52a-3d0bbe2cbcd3)
- ![](https://jane.app/thumbs/d33ab2ef-9bcd-4400-b389-7509795bf867)
- ![](https://jane.app/thumbs/efcadfa1-2fd8-4afc-89b7-c0f158934292)
- ![](https://jane.app/system/dragonfly/production/2016/04/10/12umsoc3m8_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/10/41glipd6rw_blob)
