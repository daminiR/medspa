...
*Source: [https://jane.app/guide/favourite-teleplan-codes](https://jane.app/guide/favourite-teleplan-codes)*

*Category: Teleplan*

*Scraped: 2025-08-07 04:40:48*
...
Feature OverviewFavourite Teleplan Codes
Teleplan
Favourite Teleplan Codes
2 min read
Practice Plan
...
There is the rare occasion where you might need to create a custom Teleplan Billing Code.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Favourite Teleplan Codes
Teleplan
Favourite Teleplan Codes
2 min read
Practice Plan
Thrive PlanJane pulls in the directory of codes every morning, so if there is an update to a price or addition of new codes they will be automatically updated for you.
As I write this, there are 14,798 codes in the Teleplan directory. That’s a lot.
You likely won’t use the majority of those, so you can favourite the ones you do so that they show up on your short list within Jane.
You can find the Teleplan Codes in the Billing Codes area of the Settings Tab. The Teleplan Directory includes the Fee Codes and the Diagnosis Codes so you do not need to enable either of the ICD directories.
To create your short list you can search for the codes you use in the directory and then click on the star at the end of the line.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/04/08/1cspuwmmm6_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/08/5bnrlqmiq3_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/08/6c9go7jnsi_blob)
- ![](https://jane.app/system/dragonfly/production/2016/04/08/7cjo1dsymi_blob)
