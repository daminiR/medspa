...
*Source: [https://jane.app/guide/adding-a-note-to-a-teleplan-claim](https://jane.app/guide/adding-a-note-to-a-teleplan-claim)*

*Category: Teleplan*

*Scraped: 2025-08-07 04:38:07*
...
Feature OverviewAdding a Note to a Teleplan Claim
Teleplan
Adding a Note to a Teleplan Claim
1 min read
Practice Plan
Thrive Plan
Sometimes filling in all the required boxes doesn’t tell the whole story. When you need to give a little more detail, you can add a Note to any Teleplan claim. Here’s how that looks:
Create a Patient Policy
Book the appointment under the policy.
“Arrive” the appointment
In the “Billing Info” section, hover over the information so that a “View” tab appears.  Click this “View” button.
Scroll to the Insurance section and click on the “Add Document” button.
Select the Note option (or the WSBC Chiropractic if applicable)
Enter the note and hit “Save”. Easy, right?
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adding a Note to a Teleplan Claim
Teleplan
Adding a Note to a Teleplan Claim
1 min read
Practice Plan
Thrive PlanSometimes filling in all the required boxes doesn’t tell the whole story. When you need to give a little more detail, you can add a Note to any Teleplan claim. Here’s how that looks:
Create a Patient Policy
Book the appointment under the policy.
“Arrive” the appointment
In the “Billing Info” section, hover over the information so that a “View” tab appears.  Click this “View” button.
Scroll to the Insurance section and click on the “Add Document” button.
Select the Note option (or the WSBC Chiropractic if applicable)
Enter the note and hit “Save”. Easy, right?Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/9191e10b-822e-4d67-a208-49709e37399c)
- ![](https://jane.app/thumbs/ca24eeaf-1953-4a47-be9b-68bf326a03f9)
- ![](https://jane.app/thumbs/ae94bff6-e109-42d0-b7f4-8e601d3ced15)
