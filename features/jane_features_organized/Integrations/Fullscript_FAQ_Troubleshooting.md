...
*Source: [https://jane.app/guide/fullscript-faq-troubleshooting](https://jane.app/guide/fullscript-faq-troubleshooting)*

*Category: Integrations*

*Scraped: 2025-08-07 04:54:44*
...
Feature OverviewFullscript FAQ + Troubleshooting
Integrations
Fullscript FAQ + Troubleshooting
7 min read
Balance Plan
Practice Plan
Thrive Plan
This is a compilation of some of the most frequently asked questions we receive about working with Fullscript and Jane, now in a handy bite-sized format!
Feel free to scroll through the different topics, or jump straight to a particular question:
How many staff members can I have integrated and accessing Fullscript?
I’ve integrated with Fullscript but I’m not able to prescribe any prescriptions or supplements. How can I fix this?
I’m looking to generate some reports of prescription trends through Fullscript. Where can I find that information?
...
Do Fullscript Recommendations sent through Jane appear in the Patient’s Message’s log?
How many staff members can I have integrated to access Fullscript in Jane?
There is no limit to the number of practitioners you can have integrated to Fullscript.  Each practitioner will need to have their own profile in Fullscript to add and create recommendations.  Once you’ve set up a Fullscript account, you can add the integration by following our
Fullscript and Jane
guide.
I’ve integrated with Fullscript but I’m not able to prescribe any prescriptions or supplements, how can I fix this?
Each practitioner is required to submit proof of licensure to confirm their status as a healthcare provider. If your documents contain expiration dates, renewed documentation will be required to prescribe through your account.  For steps on where to submit this see the Fullscript guide
Maintaining your professional certification with Fullscript
.
I’m looking to generate some reports of prescription trends through Fullscript, where can I find that information?
Fullscript manages a number of reports for all prescriptions and this information is not brought into your Jane Account.  You can find your reports by logging into Fullscript directly then by going to the
Reports
tab.
Fullscript provides reports for income tax purposes, practitioner earning reports as well as prescription details which can be further filtered here.  You can check out further details on their reports by visiting the
Fullscript Report Knowledgebase
How often do I see payouts in Fullscript and how can I get paid?
...
It is possible for a practitioner to add a patient discount on Fullscript, which will apply to the patient’s order as normal.  If you were wanting to discount Fullscript orders, you can find more about this under Fullscript’s guide
Make a Profit with Fullscript
in the
Patient Discounts
section.
These discounts will be reflected on the patient end when they click into their Fullscript recommendation email.  When the patient receives this link and clicks on it, it will take them to their Fullscript profile where they will be able to see their recommendation, including the % discount saved.  For a visual on how this would look, check out the
where do I see my discount applied to my orders
Fullscript guide.
Make a profit with Fullscript
How do I customize my Fullscript programs, landing page and add my own branding?
A practitioner is able to customize their own online store and landing page within your Dispensary Settings under
Your Landing Page
.
If I sign a chart entry before I hit Send on my Fullscript recommendation can I still send my patient their recommendation?
...
I’ve accidentally linked a patient profile to the wrong Fullscript account, how do I fix this?
Not to fret, as our support team is able to help out with this!
Get in touch with us here
.
Do Fullscript Recommendations sent through Jane appear in the Patient’s Communications log?
No
, Jane does not record the status or content of Fullscript emails, so these will not appear under the patient’s
Communications
tab.
Practitioners will receive a green pop-up message in Jane after submitting the recommendation, which says ”Recommendation sent to Patient.”
Within their chart area, practitioners will see the recommendation along with any personalized language sent along with the recommendation.
Not part of the Jane community yet? Check out how you can prescribe and manage your patient’s supplements with
Jane’s Fullscript integration!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Fullscript FAQ + Troubleshooting
Integrations
Fullscript FAQ + Troubleshooting
7 min read
Balance Plan
Practice Plan
Thrive PlanThis is a compilation of some of the most frequently asked questions we receive about working with Fullscript and Jane, now in a handy bite-sized format!
Feel free to scroll through the different topics, or jump straight to a particular question:
How many staff members can I have integrated and accessing Fullscript?
I’ve integrated with Fullscript but I’m not able to prescribe any prescriptions or supplements. How can I fix this?
I’m looking to generate some reports of prescription trends through Fullscript. Where can I find that information?
...
Within their chart area, practitioners will see the recommendation along with any personalized language sent along with the recommendation.
Not part of the Jane community yet? Check out how you can prescribe and manage your patient’s supplements with
Jane’s Fullscript integration!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/69c97e25-fcd9-4d6f-aabb-9f2318ebe260)
- ![](https://jane.app/thumbs/7f89468a-02db-4d17-8a68-fb277217917b)
- ![](https://jane.app/thumbs/8178c2a4-2c66-4947-859f-00af6398c810)
- ![](https://jane.app/thumbs/30bf2a9f-8dc7-4efb-949e-8bf8d3ff7f88)
- ![screenshot of what it looks like to send a recommendation through the Jane integration](https://jane.app/thumbs/cc09621f-3d60-4caf-833c-33c212e41225)
- ![screenshot of what the recommendation looks like within a client's chart](https://jane.app/thumbs/7e83e9c8-132a-453d-9b62-1457e4821cec)
