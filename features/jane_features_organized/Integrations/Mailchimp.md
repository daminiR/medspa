...
*Source: [https://jane.app/guide/mailchimp](https://jane.app/guide/mailchimp)*

*Category: Integrations*

*Scraped: 2025-08-07 04:52:59*
...
Thrive Plan
Mailchimp
is an email marketing platform that allows you to create and automate personalized journeys for many customer scenarios. You can manage your contacts, send emails, and track results of your clinic’s email campaigns.
...
.
At least one Mailchimp list (aka an Audience in Mailchimp land).
Here’s how to add a list in Mailchimp
.
Step 1
A user with
Full Access
...
tab and click on
Integrations
in the left sidebar menu. Next, click the
Get Started
button in the Mailchimp section.
The page will list any Mailchimp lists that you have already connected. To add your first list, click
“Authenticate your Mailchimp account”
. This will take you over to Mailchimp to enter your username and password.
Step 2
...
Select the list you would like to sync with and click
Save
.
That’s it, you’re done! Jane will automatically keep your lists in sync according to the
Marketing Emails opt-in
checkbox on your customers’ profiles in Jane.
If you already have permission granted from your customers to opt-in to marketing emails, you can opt-in your customers in bulk in
...
Head over to the patient’s profile by selecting them in the
Patient
section:
Once you’re there, scroll down to find a Mailchimp section with a
Check Member Status
link.
When you click the link, it’ll show you if they’re subscribed or not. Here’s what each of those statuses means:
Subscribed
- The patient has been sent to Mailchimp and is subscribed to your mailing list
Unsubscribed
- The patient has been sent to Mailchimp but they are
NOT subscribed
to your mailing list
Never Added
- The patient hasn’t been sent to Mailchimp, likely because they have opted out of marketing emails since they signed up.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Mailchimp
Integrations
Mailchimp
4 min read
Balance Plan
Practice Plan
Thrive PlanMailchimp
is an email marketing platform that allows you to create and automate personalized journeys for many customer scenarios. You can manage your contacts, send emails, and track results of your clinic’s email campaigns.
Our Jane & Mailchimp integration is handy because you can keep your Mailchimp marketing email list in sync with your clients in Jane! Your clients in Jane will automatically be added to your Mailchimp list if they have opted into marketing emails.
The fields that will move over to Mailchimp include:
First Name
...
How to Send an Automated Birthday Email
For those of you interested in learning a bit more about what MailChimp has to offer, check out one of the webinars we hosted as part of our online Allied Conference sessions.
Happy emailing!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/f6dd093f-eb2d-409b-8d9c-702eab6b31fc)
- ![](https://jane.app/system/dragonfly/production/2017/09/07/1t2hp6nmmc_image.png)
- ![](https://jane.app/thumbs/67deeb3c-187f-400c-83e2-bfbaff696219)
- ![](https://jane.app/thumbs/e882ea59-dc84-40e4-8370-5e909c1bb3cc)
