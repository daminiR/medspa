...
*Source: [https://jane.app/guide/integrations-hub-faq](https://jane.app/guide/integrations-hub-faq)*

*Category: Integrations*

*Scraped: 2025-08-07 04:56:56*
...
Feature OverviewIntegrations Hub & FAQ
Integrations
Integrations Hub & FAQ
10 min read
Balance Plan
Practice Plan
Thrive Plan
Welcome to our Integrations hub page. Here, you’ll find information about each integration and some guides to get you started. We also have some frequently asked questions below. As always, if you have any questions that aren’t answered here, don’t hesitate to reach out to us and we’ll be happy to help.
Table of contents:
Jane Payments
Claim.MD
Clinic Sites
...
Setting up Jane Payments
Jane Payments FAQ
Claim.MD
Connect your Claim.MD clearinghouse account to submit claims, receive responses, manage rejections, and receive ERAs, all directly in Jane.
This integration provides more streamlined, error-free billing for Jane users, and with supportive onboarding and enrollment, Claim.MD clearinghouse makes it quick and easy to get started.
Read more about Integrated Claims with Claim.MD
Clinic Sites
Clinic Sites is the only website platform with a direct integration for Jane customers, offering fully hosted websites at a partnership price of $59/month. (Regular $79/month)
No setup fee!
...
Check out our Clinic Sites guide
Documo
We’ve partnered with
Documo
, a HIPAA, PIPEDA, and GDPR-compliant, cloud fax software so that you can send faxes directly from your patients’ charts.
Jane users can sign up for a Documo license from their Jane account for a
special rate of $15 USD/month
. This includes:
500 fax pages per month + $0.08 per page for each additional page
This includes inbound faxes which you can receive through the Documo portal and outbound faxes which you can send directly through Jane.
3 fax numbers + $3 a month for each additional number
Documo’s suite of
inbound and outbound faxing features
Check out our Integrated Outbound Fax guide
Telus eClaims
Jane’s TELUS eClaims integration enables real-time claim adjudication for your patients in Canada. The integration allows you to submit a claim and receive a real-time response right from the schedule in Jane.
How to get set up
Submitting claims
Reversing claims
...
Your customers in Jane will automatically be added to your MailChimp list if they have opted in to marketing emails.
Read more about the Mailchimp integration
...
Receive special pricing for Jane clients using our referral code (JANE30). Full integration instructions can be found in our guide below, and Clinic Plans are available for larger practices.
Using Physitrack and Jane
Setting up the Physitrack integration
FAQ & Troubleshooting
Fullscript
Fullscript is a free online dispensary that helps keep your patients happy and your practice successful by providing you with the industry’s largest catalog of professional-grade supplements. Prescribe through your personalized store and Fullscript will ship directly to your patients.
Jane’s Fullscript integration allows you to build recommendations as part of a chart. This means it not only documents the prescription in the patient’s chart but also gives your patient a super simple way to fulfill it.
Fullscript and Jane
FAQ & Troubleshooting
Pacific Blue Cross
...
For customers in British Columbia, Canada, Jane can directly submit and track insurance billing for those insurers billing through Teleplan. Depending on your discipline this might include MSP, and/or WSBC.
...
Thrive Plan
and Legacy Base & Insurance Plans.
...
For those tracking analytics using Google’s Analytics tool, Jane can include your Tracking ID through our integration to help you gather stats on your online booking site. This helps people looking to manage conversions defined as appointments that were booked online. Jane is now supporting Google Analytics 4 (GA4).
Read more in our guide on Google Analytics
Reserve with Google
Go from being found on Google, to booked in Jane. This integration between Jane and your Google Business Profile simplifies the process for clients to learn about your practice and seamlessly directs them to your Jane online booking page.
Reserve with Google is currently available for clinics in Canada 🇨🇦 with availability in the US coming soon.
Check out our Reserve with Google guide
Calendar Subscriptions
Staff can view their Jane schedule (appointments and shifts) in any calendar app that supports the iCal format.
Jane provides a private Calendar URL that can be synched with an outside calendar where Jane will send appointment or shift information over to your calendar app. It’s important to note that this is a one-way conversation - so changes made in your outside calendar will not be reflected back in Jane.
Subscribing for staff
Subscribing for patients
Troubleshooting tips
Frequently Asked Questions (FAQ)
How do we define integrations at Jane?
Great question; an integration for us can be a product integration or a marketing partnership.
Our product integrations are a mix of workflows starting from Jane and ending in another platform, a workflow in another platform that speaks to some parts of Jane, or a workflow in Jane that’s powered by different technology.
Does Jane have any more integrations that aren’t listed here?
No, this page is our source of truth for Jane product integrations. However, not all marketing partnerships are listed. If you’ve seen Jane integrations advertised elsewhere, please feel free to
reach out to us
.
I need help setting up or understanding an integration, who should I reach out to?
We’re happy to be your first stop for all Jane workflows. When it comes to integrations, we can’t guarantee that what you’re encountering is within our expertise, but we’ll do our best to help find an answer or point you in the right direction. As a general rule, if a problem arises on another platform (for example, in Fullscript) then we recommend you start there.
Who can I reach out to about building an integration or forming a partnership with Jane?
Great question! You can reach out to partnerships@jane.app.
Does Jane have an open API?
No, Jane doesn’t currently have an open API.
How can I learn about new Jane integrations?
Subscribing to our monthly newsletter is the best way to stay in the loop on new and improved Jane integrations. You can head to
jane.app/guide
and enter your email address to sign up.
Does Jane support Google Tag Manager or Meta (Facebook) Pixel?
No, Jane does not support Google Tag Manager or Meta (Facebook) Pixel. For a little insight into this decision, Jane would need to allow deep embedding within your Online Booking Site to support these integrations. Our Privacy and Security Team feels that this would cause privacy and security implications; therefore, since our customers’ data is our top priority, we’ve chosen to not support these integrations.
What steps can I take to make sure that I’m protecting my clinic’s privacy and security while working with Jane’s integrations?
Privacy and security are at the heart of everything we do at Jane. That’s why we choose companies who share our commitment to protecting your information.
That said, security is everyone’s responsibility — so you’ll still want to follow some
Security & Privacy Best Practices
. These include using a strong password, enabling 2-step verification, using auto-logout, and signing out when you step away from your computer.
When it comes to your accounts (for both Jane and the companies we integrate with), it’s a good idea to provide each user with access to only what’s needed to get the job done. In the security world, this is called the
Principle of Least Privilege
. This means that people should only have access to the information they need to do their job, and nothing more. Sensitive information is safest when access is limited — make sure staff only have what they need for their role and skip any unnecessary systems or integrations.
...
When it comes to your accounts (for both Jane and the companies we integrate with), it’s a good idea to provide each user with access to only what’s needed to get the job done. In the security world, this is called the
Principle of Least Privilege
. This means that people should only have access to the information they need to do their job, and nothing more. Sensitive information is safest when access is limited — make sure staff only have what they need for their role and skip any unnecessary systems or integrations.Subscribe to our monthly newsletter.Jane Software Inc.
