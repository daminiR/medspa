...
*Source: [https://jane.app/guide/mailchimp-integration-a-troubleshooting-guide](https://jane.app/guide/mailchimp-integration-a-troubleshooting-guide)*

*Category: Integrations*

*Scraped: 2025-08-07 04:53:33*
...
Feature OverviewMailchimp Integration: A Troubleshooting Guide
Integrations
Mailchimp Integration: A Troubleshooting Guide
1 min read
Balance Plan
...
Thrive Plan
Legacy Plans
​Every once in a while with changes to the code and full-on software updates, we see the communication between Jane and Mailchimp get disrupted.  No fear, however! If you head to the integrations area of your Jane account, you can manually push an update to your mailing list with just the click of a button.
Go to
Settings > Integrations > (Mailchimp) 1 Integration
and click on the name of your mailing list.
​
​On the next screen, you will see an orange button and a blue button.
Click the blue one
to resync your account.
​Give it about 10-15 minutes and then log in to your Mailchimp account to see if your mailing list has been updated.
While you’re waiting, you may as well
create your Mailchimp campaign
to email to your newly updated mailing list.
Happy Marketing!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Mailchimp Integration: A Troubleshooting Guide
Integrations
Mailchimp Integration: A Troubleshooting Guide
1 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy Plans​Every once in a while with changes to the code and full-on software updates, we see the communication between Jane and Mailchimp get disrupted.  No fear, however! If you head to the integrations area of your Jane account, you can manually push an update to your mailing list with just the click of a button.
Go to
Settings > Integrations > (Mailchimp) 1 Integration
and click on the name of your mailing list.
​
...
create your Mailchimp campaign
to email to your newly updated mailing list.
Happy Marketing!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![Mailchimp List](https://jane.app/thumbs/f8aa05d2-e2c2-4086-9de5-f9ab6d31088e)
- ![](https://jane.app/thumbs/45d828d0-85eb-4491-a26b-34d11f0e6524)
