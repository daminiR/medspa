...
*Source: [https://jane.app/guide/how-to-send-an-automated-birthday-email](https://jane.app/guide/how-to-send-an-automated-birthday-email)*

*Category: Integrations*

*Scraped: 2025-08-07 04:56:08*
...
Feature OverviewHow to Send an Automated Birthday Email
Integrations
How to Send an Automated Birthday Email
3 min read
Balance Plan
...
To do this, you’ll need to take advantage of Jane’s
Mailchimp integration
, which allows you to pass information to Mailchimp on patients who have consented to receive promotional materials from you. If you haven’t already set that up, it would be a good idea to check out this Guide doc on
...
Now, for all your detailed questions on Mailchimp, you’ll need to chat with them or check out their website. But we put together this guide so you could see how easy it is.
Let’s head on over to your
Mailchimp account
. Since you already have your patients’ birth dates on file, you can start by clicking on
Automations
from the menu on the left-hand side of your screen.
Next, click
Create
in the top right, and then select
Classic Automations
from the drop-down.
Head to the
Date Based
section and select
Say Happy Birthday
You can select from a single email or a series of emails, name your campaign, and
Begin
to create the new campaign.
The email series will create three emails, one for the day before, one for the day of, and one for the day after. Using all three would likely be overkill, but they’ve done all the legwork if you do for some reason need multiple emails.
You can also edit the timeframe as well, making the email send out multiple days or the week before, the world is your oyster!
Once you’re ready to go– hit
Design Email
!
Now you get to
design the email
that you want going out to your party people.
Need a little help designing your email? We’ll leave that to the pros at Mailchimp. Check out this Guide doc from Mailchimp on
Designing an Email.
Follow along until you press the
Start Sending
button to complete the campaign setup and with that, the email is designed! Mailchimp will now take care of emailing your best birthday wishes to all your clients.
Last but not least, some birthday email tips from MailChimp:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Send an Automated Birthday Email
Integrations
How to Send an Automated Birthday Email
3 min read
Balance Plan
Practice Plan
Thrive PlanSo you want to remind your lovely clients to remember to indulge in some self-care on their birthday?
To do this, you’ll need to take advantage of Jane’s
Mailchimp integration
, which allows you to pass information to Mailchimp on patients who have consented to receive promotional materials from you. If you haven’t already set that up, it would be a good idea to check out this Guide doc on
setting up Mailchimp.
...
Start Sending
button to complete the campaign setup and with that, the email is designed! Mailchimp will now take care of emailing your best birthday wishes to all your clients.
Last but not least, some birthday email tips from MailChimp:Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5d0cf386-ebb7-4e6d-96db-2b33ffd0369a)
- ![](https://jane.app/thumbs/9f6bbf41-fc2e-4f40-a898-a5cbeba4f11c)
- ![](https://jane.app/thumbs/00d77e21-5270-45e9-a014-0234e627757c)
- ![](https://jane.app/thumbs/48031956-547e-4859-beaf-14cdd45eb7fa)
- ![](https://jane.app/thumbs/daacc9a8-60da-4381-8a13-4afed88dd4dc)
- ![](https://jane.app/thumbs/2bf9bce9-fb01-45ec-8fe0-e645d97297a7)
