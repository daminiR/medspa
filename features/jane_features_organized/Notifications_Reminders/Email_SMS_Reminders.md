...
*Source: [https://jane.app/guide/email-sms-reminders](https://jane.app/guide/email-sms-reminders)*

*Category: Notifications & Reminders*

*Scraped: 2025-08-07 03:10:28*
...
Feature OverviewEmail & SMS Reminders
...
You can decide and configure whatever options you’d like to offer within the
Settings
tab and select
Reminders & Notifications
within the left sidebar menu. Next, click on the blue
Edit
button to the right of the reminder type you’d like to edit or on
Add Reminder
to create a new one.
Looking for information on
Intake Form Reminder Emails
? Check out our guide
...
SMS availability varies by region and is offered in select locations. Have questions? We’re here to help at support@jane.app.
...
Phone Reminders
If a patient doesn’t have an email address or the patient has opted into Phone Reminders, they will be added to the Phone Reminders list for your staff to call. Read about the
phone reminders list here
.
Additional Notes
Subscribed by Default
If your clinic has the
Subscribed by Default
setting enabled in the
Reminders and Notifications
settings, patients must first opt-in to receive SMS reminders before they will begin to receive any SMS reminders. Once the patient has consented to receiving SMS Reminders, any notifications set up as
Subscribed by Default
, will then automatically be sent.
...
Note
📍:
This pop-up will appear if there is a reminder delivery type the patient is not opted-in to.
...
What phone number will my patients receive automatic SMS notifications/messages from?
...
Absolutely! To start, you’ll want to head over to the
Patient’s Profile
and scroll to the
Reminders
widget. Next, click on the
Email
button.
...
Can I send an SMS notification to two phone numbers?
No
- at the moment only one mobile number can be added to a patient’s profile for SMS notifications. There isn’t a way to add another field for a secondary number. Additionally, our
Relationships
is currently only available for sending copies of email notifications.
We’d love to hear your thoughts on why this feature would be helpful to you. You can [share your thoughts and vote on the existing request here]. Check out this guide on
Feature Requests
that walks through how our team uses this page in more detail.
If a patient has several appointments on the same day, will they receive separate SMS and Email reminders for each one?
To avoid overwhelming patients with multiple notifications, Jane will only send one reminder per type (email or SMS). This single reminder will include details of all appointments scheduled for that day. Here’s an example:
Patient
Bob
has two appointments coming up on the same day, and the Demo clinic has the following reminders set up:
2-Day Email Reminder
2-Day SMS Reminder
2-Hour SMS Reminder
Jane will only send of
one
email and
two
SMS reminders using the
Appointment Reminder (Multiple Appointments)
email and
SMS Appointment Reminder: Multiple Appointments Same Day
templates.
How can I preview the emails sent from Jane to my patients?
A staff member with
Full Access
...
From the dropdown menu, you can select the email type you’d like to preview from the list.
Still have questions about Reminders and Notifications? Feel free to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Email & SMS Reminders
Notifications & Reminders
Email & SMS Reminders
9 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansWith all the things people have to juggle in this world, isn’t getting a reminder lovely? We think so. That’s why Jane lets you send your patients or clients automatic email and text message (SMS) reminders before each appointment.  You can offer multiple reminder options, such as:
an email reminder 48 hours before the appointment
a second email reminder 12 hours before the appointment
a text message reminder 3 hours before the appointment
💡Heads up — while email reminders are available on all of our plans, SMS reminders are available only on Legacy, Practice, or Thrive plans.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![Remind patients of their upcoming appointment at your health care clinic using email and text messages.](https://jane.app/system/dragonfly/production/2014/10/14/17razg3kog_blob)
- ![](https://jane.app/thumbs/26092d28-4d2f-4010-ac5c-fdf134c23fb5)
- ![](https://jane.app/thumbs/feffd1da-bdd2-4424-9d7c-a31f9a4d4788)
- ![](https://jane.app/thumbs/cafcf72d-0391-4194-b46c-6a2eab3ee053)
- ![](https://jane.app/thumbs/e7d935f3-bd46-4be5-a5d5-603c28bd1232)
- ![](https://jane.app/thumbs/3c0bffa8-d314-487b-826d-07af0d7893e5)
- ![An image of the navigational steps](https://jane.app/thumbs/0d6c7cf0-300b-47b7-bee6-76cf99fab3b0)
