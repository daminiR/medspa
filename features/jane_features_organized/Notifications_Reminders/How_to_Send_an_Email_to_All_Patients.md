...
*Source: [https://jane.app/guide/send-an-email-to-all-patients](https://jane.app/guide/send-an-email-to-all-patients)*

*Category: Notifications & Reminders*

*Scraped: 2025-08-07 03:12:15*
...
Feature OverviewHow to Send an Email to All Patients
...
Practice Plan
Thrive Plan
If you’re looking to populate a list of all your patients’ email addresses, look no further than the patient list report! It’s got all the demographics within a patient’s profile in one place, including their email address. You can import the list to an external email marketing platform (i.e. Mailchimp) and send a customized, mass email to all of your patients!
This option is great if you need to email all patients about changes to pricing or if a practitioner leaving the clinic.
For more information on our Mailchimp integration, check out our
Mailchimp
guide that walks through setting this integration up in a bit more detail!
Note
📝:
If you’re looking to send a feedback email to your patients after their appointment, clinics on the
Thrive
plan can send these out through Jane. For more details, you can check out our
Ratings and Reviews
guide.
...
By default, Jane will populate your entire patient list once the report loads. If you’d like to send an email to your full patient list, you can skip down to
...
Created Date
: this will help you narrow down the list of patients to those that were created by the patient or practitioner within the date range.
Appointment Date
: this will help you narrow down the list of patients to those that had an appointment booked in the schedule, with any practitioner, during that date range.
...
Alternatively, if there are specific clients that you would like to email, we’ve got just the workaround for you! We recommend exporting the report to Excel and customizing the columns by removing any clients that you don’t want to be included. Check out our guide doc on
Exporting Reports and Customizing them in Excel
that has some tips and tricks when using Excel.
...
on the top right of the report and then select
...
Last Name
Email Address
💡 If you’re using Mailchimp, make
Email Address
the first column in the CSV to simplify the import process.
...
You will need to set up a Mailchimp account if you haven’t done so already. To do this, head over to
Mailchimp
and sign up for a free account. A free Mailchimp account allows you to send up to 1000 emails to 500 contacts per month (if you have 500 contacts that’s 2 emails per month).
...
Recommended if you already have a Mailchimp account for other purposes.
This allows you to have a list of just these patients for future mass emails.
5)
...
Marketing List
As mentioned at the start, Jane has a built-in integration to keep your marketing email list synchronized with Mailchimp, but
Jane doesn’t send these emails, Mailchimp does
. This list is made up of all the clients who have checked the box to indicate that they are okay with marketing emails.
...
If you need help connecting your Jane account to Mailchimp, we’ve got a handy Guide that can help you with the steps and just generally understand more about our integration with Mailchimp:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Send an Email to All Patients
Notifications & Reminders
How to Send an Email to All Patients
7 min read
Balance Plan
Practice Plan
Thrive PlanIf you’re looking to populate a list of all your patients’ email addresses, look no further than the patient list report! It’s got all the demographics within a patient’s profile in one place, including their email address. You can import the list to an external email marketing platform (i.e. Mailchimp) and send a customized, mass email to all of your patients!
This option is great if you need to email all patients about changes to pricing or if a practitioner leaving the clinic.
For more information on our Mailchimp integration, check out our
Mailchimp
guide that walks through setting this integration up in a bit more detail!
...
Happy emailing, and
let us know
if you have any questions on this!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/c6824a46-1348-4d69-95de-c4ef60c3d174)
- ![](https://jane.app/thumbs/a33bdc2b-e907-40ae-ab26-d86a67427618)
- ![](https://jane.app/thumbs/fe6cc481-5138-4c31-995e-d7dbfaf82201)
