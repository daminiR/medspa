...
*Source: [https://jane.app/guide/customizing-language-in-jane](https://jane.app/guide/customizing-language-in-jane)*

*Category: Notifications & Reminders*

*Scraped: 2025-08-07 03:09:27*
...
Feature OverviewCustomizing Language in Jane
...
Practice Plan
Thrive Plan
Did you know that you can add your own flair to much of the language in Jane?  You’ll need to be set up as a “Full Access” account to get to the right spot in the Settings tab.
Language
The
Language
area of your Settings is where you can customize a lot of the default wording in Jane, set your preferred terminology, and even update the language (French, Spanish, German, etc) that you want Jane to be in for staff and patients.
...
Keep in mind this is how Jane will refer to clientele and offerings overall — individual offerings are named when you
create them
.
Online Booking Banner
In
Language
, you can also customize and
Create a Message Banner
for your online booking site to be used for important messages about moving locations, parking instructions, upcoming fee increases, or any other information you’d like to be highlighted to all clients.
...
To create a banner like this, you’ll want to find a section called
...
For example, you can update your
...
These areas let you get a little magical with Markdown, which can let you make text bigger, bolder, italic, and more. We’ve included a little
Markdown cheatsheet
below the text boxes that can teach you how to use the code:
And then if you want to see what that would look like in your actual email to clients, you can hop over to the
Emails
tab in your main
Settings
to preview the full email with your new text:
...
Please note that text reminders have a character limit of 130 characters.
...
Customizing Chart Footers
Customizing Patient Invoice Details
Customizing Receipts
Customizing Billing Codes
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Customizing Language in Jane
Notifications & Reminders
Customizing Language in Jane
5 min read
Balance Plan
Practice Plan
Thrive PlanDid you know that you can add your own flair to much of the language in Jane?  You’ll need to be set up as a “Full Access” account to get to the right spot in the Settings tab.
Language
The
Language
area of your Settings is where you can customize a lot of the default wording in Jane, set your preferred terminology, and even update the language (French, Spanish, German, etc) that you want Jane to be in for staff and patients.
...
Customizing Patient Invoice Details
Customizing Receipts
Customizing Billing CodesSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/3uli2s3u8z_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/7s0c65j056_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/78d64imy65_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/4xtcb8vxl0_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/2ne832mugf_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/4n08cisase_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/4uweo3geeo_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/19z608ruvm_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/6odke8cu0r_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/5z8fwhdjoo_blob)
- ![](https://jane.app/system/dragonfly/production/2017/02/03/4tlr5sn0g7_blob)
