...
*Source: [https://jane.app/guide/email-customization-cheatsheet-thanks-for-booking](https://jane.app/guide/email-customization-cheatsheet-thanks-for-booking)*

*Category: Notifications & Reminders*

*Scraped: 2025-08-07 03:15:08*
...
Feature OverviewEmail Customization Cheatsheet (Thanks for Booking)
...
Note:
The prompt to have patients visit their account page to cancel their appointment is dependent on whether you allow cancellations in your
Settings > Online Booking > Allow cancellations.
If you allow cancellations, this sentence is hardcoded and cannot be modified. If you have “Allow cancellations” unchecked, then the prompt will
...
> Click the
Edit
button. You’ll find a Booking Information (After Booking) field. This note will be included in both your “Thanks for Booking” and any “Reminder emails” that are sent out.
Make sure to click
Save
...
This is within our
Settings > Language
area which you’ll also be able to edit a number of different text that appears in Jane. From here we can look for the customized language area and find the
Email: Cancellation Policy option
.
Tip: The Customized list here can be quite lengthy. You can use
Ctrl+F(Windows)
or
Cmd+F(Mac)
to quickly search for this text
...
Then, you can customize the text here in the box, and be sure to hit
Save
at the bottom once you’re done.
Note
📝:
At the moment, there isn’t a way to remove the cancellation policy from a specific notification or appointment type.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Email Customization Cheatsheet (Thanks for Booking)
Notifications & Reminders
Email Customization Cheatsheet (Thanks for Booking)
3 min read
Balance Plan
Practice Plan
Thrive PlanOur “Thanks for Booking” emails are pulled from many different areas in Jane. Here’s a quick cheatsheet to show you all the places this email pulls from so you can handcraft each email to each situation.
Booking Information (After Booking)
Clinic Locations
Language: Email Cancellation Policy
Note:
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/0a5a229a-72fc-495e-8e9d-f9e742c6407d)
- ![](https://jane.app/thumbs/ca20ea93-c6d2-457f-9288-85f65bb6a29b)
- ![](https://jane.app/thumbs/2ddac57f-8616-4159-8d23-d92f26abe16f)
- ![](https://jane.app/thumbs/160aa002-32cd-438c-b93f-069325ebe747)
