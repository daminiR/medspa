...
*Source: [https://jane.app/guide/why-does-my-patient-or-client-s-email-say-complaint](https://jane.app/guide/why-does-my-patient-or-client-s-email-say-complaint)*

*Category: Notifications & Reminders*

*Scraped: 2025-08-07 03:16:48*
...
Feature OverviewWhy Does My Patient or Client’s Email Say ”Complaint”?
...
When you see the ‘complaint’ tag on messages in the Communications tab, this is an indication of the email being sent but, is stuck in transit and undeliverable (Return to Sender– email style).
...
The patient has marked one of your messages as spam or their email provider has an anti-spam filter that blocks automatically generated emails (i.e. notifications@jane.app).
To remain a safe email sender, Jane will stop sending all notifications out to that email address and they’re email gets put on our
Do Not Email
list or what we like to call, a suppression list.
How do we fix this?
...
You’ll want to reach out to the patient and ask that they add
notifications@janeapp.com
to their safe sender list and confirm that you have their permission to start sending clinic communications again.
Once you’ve confirmed that we’ve got the go-ahead to send emails again, you’ll want to reach out to us via
support@janeapp.com
letting us know that you’ve received the consent of the patient to receive emails again. You can pass along the patient’s details by sending us a
direct link
or URL to the patient’s profile, and we can get them removed from the list on your behalf.
...
Though unlike with our example, please let us know why you’re sending us this link, with a short explanation of they steps you’ve completed on your end.
You can check out our
Communications Log
guide for more details on what the different notification statuses are in Jane.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Why Does My Patient or Client’s Email Say ”Complaint”?
Notifications & Reminders
Why Does My Patient or Client’s Email Say ”Complaint”?
3 min read
Balance Plan
Practice Plan
Thrive PlanWhat does “Complaint” mean on emails?
When you see the ‘complaint’ tag on messages in the Communications tab, this is an indication of the email being sent but, is stuck in transit and undeliverable (Return to Sender– email style).
This means that the email provider (eg. ‘@gmail.com’ ‘@hotmail.com’ etc) was unable to deliver the email to their client (your patient) as we’ve been marked as spam.
How does this happen?
The patient has marked one of your messages as spam or their email provider has an anti-spam filter that blocks automatically generated emails (i.e. notifications@jane.app).
...
You can check out our
Communications Log
guide for more details on what the different notification statuses are in Jane.Subscribe to our monthly newsletter.Jane Software Inc.
