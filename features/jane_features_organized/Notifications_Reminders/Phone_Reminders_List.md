...
*Source: [https://jane.app/guide/phone-reminders-list](https://jane.app/guide/phone-reminders-list)*

*Category: Notifications & Reminders*

*Scraped: 2025-08-07 03:12:37*
...
Feature OverviewPhone Reminders List
...
If you need to mass subscribe all your patients after the reminder type is created, please contact Jane Support (support@janeapp.com).
Phone Reminders Due Report
Jane also has a dedicated
Phone Reminders Due
Report that will list patients who have an upcoming appointment and are scheduled to be reminded. The date range at the top of the report indicates the day they are scheduled to be reminded for (e.g. 1 day prior to their appointment) with their appointment date and time listed in the line item.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Phone Reminders List
Notifications & Reminders
Phone Reminders List
2 min read
Balance Plan
Practice Plan
Thrive PlanJane keeps a handy list of any patients that need a phone call reminder. These patients have been set to be reminded by phone. (Note that Jane is much too nice to use a robotic voice to call your patients–you or your staff will get a reminder so that your patients can get the human touch.)
Click the “Reminders” button on the schedule page to view the Reminders list.
The list will display all the patients who need a reminder today. Once you’ve called the patient, click the “Reminded” button to mark them as reminded.
In order to create the telephone reminder type, go to Settings, then Reminders, then click Add Reminder.
Then fill out your reminder options.
...
Phone Reminders Due
Report that will list patients who have an upcoming appointment and are scheduled to be reminded. The date range at the top of the report indicates the day they are scheduled to be reminded for (e.g. 1 day prior to their appointment) with their appointment date and time listed in the line item.
Once a patient has been called, the clinic can mark the patient as “called”, so the rest of the team knows that they have already been contacted.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2015/03/24/1ofyjlgdxz_blob)
- ![Offer phone reminders to your patients for their next massage therapy, physiotherapy or chiropractic visit at your health care clinic.](https://jane.app/system/dragonfly/production/2014/06/05/467qozb43t_undefined)
- ![](https://jane.app/system/dragonfly/production/2015/06/15/25r7a1nr5j_blob)
- ![](https://jane.app/system/dragonfly/production/2016/03/08/4m8rznwqif_blob)
- ![](https://jane.app/thumbs/d29d0d27-5c1d-4d46-9870-14c540266eeb)
