...
*Source: [https://jane.app/guide/email-notifications](https://jane.app/guide/email-notifications)*

*Category: Notifications & Reminders*

*Scraped: 2025-08-07 03:09:53*
...
Feature OverviewEmail Notifications
...
First of all, decide at a clinic level when you’d like to offer email notifications. A user with Full Access will find the global preference that will override everything in
Settings > Reminders & Notifications
.
Note
📝:
This setting will affect both patient and staff notifications sent out from Jane. This means there isn’t currently a way to offer notifications to only staff members while preventing notifications from going out to patients.
Notification Options
An appointment is booked - automatic, after 3 minutes.
An appointment is changed (if the time or staff member changes) - triggered manually at the time of change
An appointment is cancelled - triggered manually by choosing a cancellation reason
When a staff member administratively updates the assigned staff member or appointment time, Jane will prompt you with a pop-up asking if you’d like to confirm the change or confirm and send a notification to the patient
Pro Tip💡:
There’s a
three-minute delay
before notifications are sent. So, if you accidentally move an appointment and then undo it or move it back, no emails will be sent.
...
Staff Notifications
Staff can choose whether they would like to be notified by email when appointments are changed on their schedule.   This setting can be found in
...
Notifications aren’t sent to staff when patients are added to a practitioner’s Wait List but you can see wait list requests at a glance on the
Schedule
, and by viewing the
Wait List Report
(
Reports > Wait List
). To learn more about using the Wait List, this guide can be helpful:
Using the Wait List
Recurring appointments are bundled into one confirmation email that lists all upcoming sessions. Jane waits 3 minutes after booking before sending notifications, allowing you to schedule multiple appointments that will all appear in a single email.
Looking to send an email to all your patients? Check out our
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Email Notifications
Notifications & Reminders
Email Notifications
4 min read
Balance Plan
Practice Plan
Thrive PlanJane can help keep everyone informed, and you can decide when that happens.
Clinic Preference on Notifications
First of all, decide at a clinic level when you’d like to offer email notifications. A user with Full Access will find the global preference that will override everything in
Settings > Reminders & Notifications
.
...
Looking to send an email to all your patients? Check out our
How to Send an Email to all Patients
guide for more details!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b73b6aab-5d90-460a-b0c4-4137544103ec)
- ![An image of what the manual notification looks like when the patient or time of appointment is changed](https://jane.app/thumbs/128d5852-c860-45ba-a0db-b022fa8dd7e0)
- ![](https://jane.app/thumbs/e4450352-d40f-4af9-88d4-130c1f97fdb6)
