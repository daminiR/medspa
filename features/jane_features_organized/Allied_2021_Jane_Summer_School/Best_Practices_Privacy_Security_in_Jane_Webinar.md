...
*Source: [https://jane.app/guide/best-practices-privacy-security-in-jane-webinar](https://jane.app/guide/best-practices-privacy-security-in-jane-webinar)*

*Category: Allied 2021: Jane Summer School*

*Scraped: 2025-08-07 05:27:23*
...
Feature OverviewBest Practices: Privacy & Security in Jane (Webinar)
...
Here’s a list of Jane guides that we think might be helpful:
...
We suggest using a password manager to help ensure your passwords are strong and different for every account.
Our favourite is
1Password
Jane’s always innovating:
Take a peek at our latest idea for
secure log-in
😉 -
don’t forget to check the rollout date at the bottom of the article!
From the Chat and Q&A
...
A: We hear this a lot! You will still have the capabilities to do your billing, setting up, and reporting with a
Full Access
profile, which is the level of access an account owner has within the Jane account. The only difference for the account owner is access to changing the Jane subscription and some instances regarding deletion of data or transferring charts.
...
Should you ever run into a situation where you are a practitioner or administrator and the account owner has passed away suddenly, the first step would be to reach out to your regulatory body, but you can also reach out to us at privacy@jane.app for guidance.
Q: “How can we set 2 staff as account owners?”
We consider there to be a
single
account owner as per our
Terms of Use
. In most cases, the named account owner merely acts as a messenger who relays mutual decisions made at the clinic level by all parties. Here’s a snippet from our Terms of Use:
...
💙
Update:
As of 2023, Jane now has a
2-Step Verification
feature! By enabling 2-Step Verification on your staff profile, you’ll receive a one-time SMS code to your mobile phone that you enter in Jane each time you log in, after entering your password.
If you ever have
privacy or security concerns
, please don’t hesitate to reach out to us at
privacy@jane.app
Looking for more
Jane Summer School Sessions?
You can check out the
entire curriculum here!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Best Practices: Privacy & Security in Jane (Webinar)
Allied 2021: Jane Summer School
Best Practices: Privacy & Security in Jane (Webinar)
6 min read
Balance Plan
Practice Plan
Thrive PlanLearn how you can set up your Jane account to be as secure as possible. It’s easier than it sounds!
Additional Resources:
Here’s a list of Jane guides that we think might be helpful:
Security and Privacy Best Practices
List of Security Features
...
Jane Summer School Sessions?
You can check out the
entire curriculum here!Subscribe to our monthly newsletter.Jane Software Inc.
