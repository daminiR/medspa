...
*Source: [https://jane.app/guide/billing-in-the-usa-tips-tricks-from-billers](https://jane.app/guide/billing-in-the-usa-tips-tricks-from-billers)*

*Category: Allied 2021: Jane Summer School*

*Scraped: 2025-08-07 05:26:44*
...
Feature Overview🇺🇸 Billing in the USA: Tips & Tricks From Billers
...
Extra tip:
add a disclaimer to your
Intake Forms
regarding who is responsible for payment if the insurer doesn’t pay. You can even
collect a signature
for this in Jane!
We’re never done improving our US insurance features. Here are a few key
feature requests
mentioned in the session, and if you have an idea on how to make billing insurance more frictionless in Jane, let us know!
How to make a feature request
Automatically reconcile electronic remittances
Support for secondary electronic and paper claim submissions
Insurance Eligibility Checks
Allow CMS1500 to be printed on pre-printed paper
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)🇺🇸 Billing in the USA: Tips & Tricks From Billers
Allied 2021: Jane Summer School
🇺🇸 Billing in the USA: Tips & Tricks From Billers
2 min read
Practice Plan
Thrive PlanHear what three professional billers have to say about getting started with billing insurance and how you can streamline the process.
Additional Resources:
Learn more about
Cortney’s services
at
...
Support for secondary electronic and paper claim submissions
Insurance Eligibility Checks
Allow CMS1500 to be printed on pre-printed paperSubscribe to our monthly newsletter.Jane Software Inc.
