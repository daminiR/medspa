...
*Source: [https://jane.app/guide/lesson-6-online-booking](https://jane.app/guide/lesson-6-online-booking)*

*Category: Practitioner Training*

*Scraped: 2025-08-07 00:03:52*
...
Feature OverviewLesson 6: Online Booking
...
You’ll be able to find this setting inside the
Staff Profile
, under the
Online Booking
tab.  If you uncheck the
Enable Online Booking
box, that staff member will not be displayed at all online.
Individual staff preferences
If you are interested in offering online booking, there are a few special ways you can customize how your appointments are shown online. These settings can be found inside a staff profile by clicking “Edit/Settings” and then heading to the “Online Booking” Tab.
...
:  This one is only relevant if you are offering multiple appointments in multiple rooms at the same time for the same staff member.  If this is the case you might find this guide document helpful:
Staggering Bookings
.
Down the rabbit’s hole of managing online booking
Depending on the nuances of your schedule, you may want to use
Tags
to manage the availability of rooms or equipment necessary for your treatments. (💡Heads up — tags and other advanced scheduling features are available on the
Thrive Plan
.)
Using some of these advanced features in Jane can have a few layers during your account set up, and we want to be sure to get it right before your
Online Booking
site in Jane “goes live.”
Be sure to
contact us
to let us know how we can help! :)
You are so close! Try out
this quiz
to test your knowledge. Let’s make our way to the finish line in Chapter 7. If you’re a Canadian clinic, check out
this lesson on Canadian insurance
. If you’re located in the US, the
US insurance lesson can be found here
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Lesson 6: Online Booking
Practitioner Training
Lesson 6: Online Booking
7 min read
Practice Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/02/01/85aqt2dxom_blob)
- ![](https://jane.app/thumbs/f7e490fa-e9f3-4f07-b184-2e26cc2935e2)
