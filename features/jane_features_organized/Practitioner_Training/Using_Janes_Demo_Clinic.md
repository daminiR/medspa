...
*Source: [https://jane.app/guide/using-jane-s-demo-clinic](https://jane.app/guide/using-jane-s-demo-clinic)*

*Category: Practitioner Training*

*Scraped: 2025-08-07 00:05:22*
...
Feature OverviewUsing Jane’s Demo Clinic
...
Practice Plan
Thrive Plan
The Demo Clinic is a fake Jane account where you can play around without worrying about making any mistakes. It can be useful when you want to try a new feature before enabling it in your own account, or maybe you’d like to practice a workflow like taking a fake payment but don’t want to throw off your bookkeeping.
Before we get started on how to use the Demo Clinic, there are four very important things to keep in mind:
🔒
All the information you see in the Demo Clinic is fake.
Under no circumstances should you enter any personal information, as it will be visible to anyone else who’s logged in. Consider the Demo Clinic to be a public space.
🥸
Almost everything in the Demo Clinic can be edited or changed
by any user, so you may see locations added or deleted, names changed, practitioner disciplines switched, appointments cancelled or moved around…etc. Lots of folks are in there at any time trying things out, so don’t be alarmed if things look a little different from time to time.
🌙
The Demo Clinic resets every night
, so if you’re a night owl and testing out something complicated, keep in mind that anything that was changed in the Demo Clinic during the day will be reset at the following times:
🇨🇦
CA Demo Clinic
: 12:00am PST
🇺🇸
...
Chrome
on a computer, laptop, or android device.
Safari
on an iPad or iPhone.
Edge
on a Windows Surface Tablet or Windows Phone.
Check out our guide to learn more >
Logging into the Demo Clinic
Choose your Demo Clinic based on your location:
🇨🇦
CA Demo Clinic
🇺🇸
US Demo Clinic
...
You can log in as any of the staff profiles listed below using their unique username and the
password of the week that resets every Monday
. To get the weekly password, you can click the Need Help button in the upper-right of your screen:
Underneath our contact details, you’ll see the weekly password. You can click the
Copy
button to copy the password to your clipboard for easy access.
Or, if you’re a member of the
Jane Community Forum on FB
, you’ll find the updated password posted weekly there! 
(If you’re not a member yet, you can join
here
).
Staff Profiles
You can log in with the username “
owner”
to log in with full access. If you want to use the other profiles to play around with
different levels of access
you can use the following log-ins as well. Just keep in mind as folks are using the Demo Clinic throughout the day, they may edit the access levels of different staff profiles.
▶ 🧑‍💻 Staff Logins
April Kennedy. Username: "frontdesk"
- Role: Admin Staff
Marcus Gregory. Username: "chiro"
- Role: Chiropractor
Susan Lo. Username: "therapist"
-Role: Massage Therapist
Jo-Ellen McKay. Username: "physio"
- Role: Physiotherapist, Clinical Pilates instructor
Maya Lopez-Chapman. Username: "counsellor"
- Role: Mental Health Counsellor
Michael Carroll. Username: "naturopath"
- Role: Naturopath
Zoey Swift. Username: "massage"
- Role: Massage Therapist, Acupuncturist
Frank Warren. Username: "practitioner"
- Role: Massage Therapist
Fiona Quinn. Username: "aesthetics_doc"
- Role: Physician & Aesthetics Injector
Rohan Mehta. Username: "aesthetics"
- Role: Medical Aesthetician
Jane Tip
: Mental health practitioners who work together in one Jane site commonly have their
staff access level
set to
Practitioner Limited
by the Account Owner so that the practitioners can’t see each other’s schedules or client info. Curious to see what Practitioner Limited looks like? Try changing a staff member’s access level, and then log in as them.
Guides for Basic Workflows
When you first log into the Demo Clinic, it can feel like there’s a lot going on! If you’re not sure where to get started, we have some step-by-step training resources you can complete at your own pace, which have been reported by clinics to be helpful resources to speed up onboarding.
We refer to this training program as Jane University, and we have lesson plans for both Front Desk and Practitioners:
Front-Desk Training: Lesson 1
Practitioner Training: Lesson 1
You can browse through the chapters of each resource on the menu to the left of
our guide
:
Testing out Jane Payments
Jane Payments
is the name of our PCI-compliant payment solution for both terminal and online payments. You can test out the online payments function in the Demo Clinic as much as you like. 💰
Here are some
Jane Payments workflows
you might like to try:
Process a payment
Send a Pay Balance Email or Text
Set up an Online Booking Pre-Payment Policy
(Intermediate)
💳 You can use this fake credit card number when testing out Jane Payments:
Card Number
: 4111 1111 1111 1111
Date
: any future date
...
: any 3 digits
Postal/ Zip code
: any combo of 5 digits or letters
We hope you have fun playing around in the Demo Clinic! Whether you do some serious testing or just want to record a million-dollar payment for fun, we hope you find it helpful. If you have any questions or need a hand, don’t hesitate to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Using Jane’s Demo Clinic
Practitioner Training
Using Jane’s Demo Clinic
6 min read
Balance Plan
Practice Plan
Thrive PlanThe Demo Clinic is a fake Jane account where you can play around without worrying about making any mistakes. It can be useful when you want to try a new feature before enabling it in your own account, or maybe you’d like to practice a workflow like taking a fake payment but don’t want to throw off your bookkeeping.
Before we get started on how to use the Demo Clinic, there are four very important things to keep in mind:
🔒
All the information you see in the Demo Clinic is fake.
Under no circumstances should you enter any personal information, as it will be visible to anyone else who’s logged in. Consider the Demo Clinic to be a public space.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/22e72283-af29-414e-99d7-0b875d4dbd74)
- ![](https://jane.app/thumbs/c455c3e4-4e96-48d0-958f-036132b19ca3)
- ![](https://jane.app/thumbs/26b30ef1-4761-427e-9f87-a4c06b350f7e)
- ![](https://jane.app/thumbs/83ebcda6-f5db-452a-954d-56515f9b7b92)
