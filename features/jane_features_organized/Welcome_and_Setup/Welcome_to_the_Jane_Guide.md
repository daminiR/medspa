...
*Source: [https://jane.app/guide/welcome-to-the-jane-guide](https://jane.app/guide/welcome-to-the-jane-guide)*

*Category: 01_Welcome_and_Setup*

*Scraped: 2025-08-06 17:58:38*
...
Feature OverviewWelcome to the Jane Guide
Welcome
Welcome to the Jane Guide
2 min read
Balance Plan
...
On the left, you can check out guides on every topic imaginable, including our
Training Courses
! These are structured learning sets that take the guesswork out of learning Jane. We’ve heard they’re great for training new staff.
Considering a switch to Jane?
If you’re contemplating switching your EMR, we know that you may have some questions. That’s why we’ve put together all of our most helpful resources on importing your data, getting started in your account, and what to expect when you join Jane.
We’ve helped thousands of practitioners make the switch to Jane — learn how our support team and the helpful Jane community can help you do the same.
Ready to learn more?
Click here
to learn more about switching to Jane.
If you have any questions or want to see Jane in action, we’d love to chat:
Book a demo
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Welcome to the Jane Guide
Welcome
Welcome to the Jane Guide
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansThis guide is a growing library of tips and instructions for having the best experience with Jane.
On the left, you can check out guides on every topic imaginable, including our
Training Courses
! These are structured learning sets that take the guesswork out of learning Jane. We’ve heard they’re great for training new staff.
Considering a switch to Jane?
