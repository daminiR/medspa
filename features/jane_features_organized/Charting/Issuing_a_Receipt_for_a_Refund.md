...
*Source: [https://jane.app/guide/issuing-a-receipt-for-a-refund](https://jane.app/guide/issuing-a-receipt-for-a-refund)*

*Category: Charting*

*Scraped: 2025-08-07 02:12:13*
...
Feature OverviewIssuing a Receipt for a Refund
Billing
Issuing a Receipt for a Refund
2 min read
Balance Plan
...
This first option is for payments processed manually outside Jane, such as through e-Transfer, Venmo, or an unlinked terminal. To do so, navigate to the
Billing
tab within the client’s
Profile
, click on
Receipts
, and then select
View Receipts
to the right of the refunded payment.
Jane will open up a new tab that will allow you to
Print
the receipt or
save it as a PDF
and email it externally of Jane.
Option Two: Payments Processed using Jane Payments
For payments originally processed through
Jane Payments
, you can follow the above-outlined steps or email it directly from Jane.
To send a receipt for the refund from Jane, you’ll want to head over to the
Billing
tab within the
Patient’s Profile
and click on
Payments
. Find the original payment that says
Refund
and a series of numbers (i.e. Refund #1234). This will be located under the
Applied to
column in grey here:
Next, click on the
...
and select
Email Receipt
from the options within the menu.
While the body of the email will look like this:
If your clinic has
Hide Client Information from Financial Emails
toggled off, there will be a PDF attachment sent along with the email with more details of the refund.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Issuing a Receipt for a Refund
Billing
Issuing a Receipt for a Refund
2 min read
Balance Plan
Practice Plan
Thrive PlanIf you’ve refunded a patient payment and now you need to send them a receipt, then you’ve come to the right place! There are two options, depending on how the refund was processed.
Option One: Manually Processed Payments
This first option is for payments processed manually outside Jane, such as through e-Transfer, Venmo, or an unlinked terminal. To do so, navigate to the
Billing
tab within the client’s
...
toggled off, there will be a PDF attachment sent along with the email with more details of the refund.
Here’s a sneak peek at what this would look like on the client’s end:
Of course, if you have any additional questions that weren’t covered in this guide, feel free to reach out to our team directly!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/d5732cad-1975-4d02-84bb-c8f7f2308926)
- ![](https://jane.app/thumbs/09ba8b10-7a6d-488b-a285-8507a53021b1)
- ![](https://jane.app/thumbs/76b382ac-ca6f-4d08-95db-63bae293fd92)
- ![](https://jane.app/thumbs/e11f7d19-de5d-4a69-8fa8-1326a646d74e)
- ![](https://jane.app/thumbs/0b705077-c03d-48d8-86ee-e01d9dc61be5)
- ![](https://jane.app/thumbs/7a54047f-14be-42d9-999f-cdd81d86a0d0)
