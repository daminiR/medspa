...
*Source: [https://jane.app/guide/creating-a-credit-memo-patient-credit-when-no-payment-received](https://jane.app/guide/creating-a-credit-memo-patient-credit-when-no-payment-received)*

*Category: Charting*

*Scraped: 2025-08-07 01:33:27*
...
Feature OverviewCreating a Credit Memo (Patient Credit when No Payment Received)
Billing
Creating a Credit Memo (Patient Credit when No Payment Received)
6 min read
Balance Plan
...
Credit Memos are not the same as creating an account credit due to a real payment. If you’re looking to create a credit because a patient is pre-paying for appointments or otherwise, please refer to our guide here:
Creating a Credit from Payment
You can create a credit for a patient by going to their Patient Profile and then to their
Billing
tab. There is a
Credit Memo
tab where you can create a
New Credit Memo
for that patient. Credit memos will not show as income on your transaction report or affect your invoiced totals.
The balance you create here will be available for use against future invoices.
FAQ
Will Credit Memos appear on my reports?
Great question! Since a patient payment has not been received, a Credit Memo
will not
appear on the
Transactions Report
or the Daily Transactions Report.
Credit Memos
will
appear on the following reports:
...
💡
Jane tip
: The “Credit” area of the Billing Summary report is interested in whether there was a net change in credit for a particular day (or for a filtered date range). If a credit was created, and then used on the same day, no overall net change was experienced, and it will not display on the report.
Sales Report
:
A Credit Memo will appear on the Sales Report once it has been applied to an invoice
Compensation Report
(Collected Cash version):
...
💡
Jane tip
: Credit Memos don’t affect the Invoiced version of the report because payments aren’t taken into account.
...
A person with
any
permission level can adjust or delete a credit memo from 
 a client’s profile under the
Billing > Credit Memos
section, as long as it hasn’t been applied to an invoice.
Once applied, only those with
Full Access
permissions can unapply it from the invoice. If you need to change the amount after it’s been applied, you’ll need to unapply the Credit Memo first, delete it, and then add a new one with the correct amount.
...
We hope the info about Credit Memos is helpful. If you have questions, or if you want to chat through workflows in Jane, please don’t hesitate to
get in touch
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating a Credit Memo (Patient Credit when No Payment Received)
Billing
Creating a Credit Memo (Patient Credit when No Payment Received)
6 min read
Balance Plan
Practice Plan
Thrive PlanThis guide is going over how to create a credit on an account when no payment has been received by the patient.
This is suited for things like trades, where you might be trading $100 worth of Massage services for $100 worth of website development.  Or if you have a special promotion where a client wins a free treatment, you can put the cost of the treatment in as a Credit Memo to pay for that appointment without any cash-flow being recorded in your transaction reports.
Credit Memos are not the same as creating an account credit due to a real payment. If you’re looking to create a credit because a patient is pre-paying for appointments or otherwise, please refer to our guide here:
Creating a Credit from Payment
You can create a credit for a patient by going to their Patient Profile and then to their
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/08/15/8zt2v9fa1q_blob)
- ![](https://jane.app/system/dragonfly/production/2016/08/15/2y75725v49_blob)
- ![](https://jane.app/thumbs/3d634ec3-1025-4632-8111-3eca0a7b8f4c)
