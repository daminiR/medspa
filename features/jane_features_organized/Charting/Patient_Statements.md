...
*Source: [https://jane.app/guide/patient-statements](https://jane.app/guide/patient-statements)*

*Category: Charting*

*Scraped: 2025-08-07 01:39:11*
...
Feature OverviewPatient Statements
Billing
Patient Statements
5 min read
Balance Plan
...
Start in the patient’s
Billing
tab:
See that
Filter
button (arrow #3)? That can help you get to the invoices you want to show up on the statement.  You can filter the list right down to a single practitioner, or to a specific date range.
...
(You’ll only see that “Pay Balance” button if you’re connected with Jane Payments integration. Here’s more info on
Jane Payments
...
The first way to generate a statement is to select specific invoices and then click the
Statement
button.
If you
select
specific invoices, the statement will show the selected invoices and any payment made paid by the client and insurer. It will also show the outstanding balance if there is anything to be paid.
...
Alternately, you can hit the
Statement
button
without
selecting any invoices.
If you click
Statement
without selecting any invoices, Jane creates a statement that includes all of the invoices and payments specific to that patient. While this would
exclude any gift cards or credit memos
that belong to another profile (e.g family member), it does
include tips and refunds
.
...
Once you’ve clicked
Statement
, you’ll be able to choose filters for what you would like to appear on each one!
...
Payments
.
For more detailed information on how this is reflected on a statement and recommendations, check out our
Tips & Gratuities FAQ
section.
⭐️Can I generate and send statements for all patients with an outstanding balance at the same time?
No,
at the moment this action happens on an individual level within a patient’s profile. However, if you’re looking for a list of all the patients with an outstanding balance, you can head over to the
Reports
tab >
Accounts Receivable
. This report can be filtered to patient accounts specifically and when you click on the patient’s name in blue, you’ll be redirected to the billing area of their patient profile where you can send out a statement.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Patient Statements
Billing
Patient Statements
5 min read
Balance Plan
Practice Plan
Thrive PlanPatient Statements can be handy when you want to run a report showing multiple visits together, show amounts owing or make a summary of payments for a client. You can print statements with just the patient’s info, the patient and insurer, and with invoices and payments or either on their own.
Let’s take a look at how that works.
Start in the patient’s
Billing
tab:
...
tab >
Accounts Receivable
. This report can be filtered to patient accounts specifically and when you click on the patient’s name in blue, you’ll be redirected to the billing area of their patient profile where you can send out a statement.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/44420f0c-dcaf-46f0-8c1d-fbc0f95eda44)
- ![](https://jane.app/system/dragonfly/production/2016/03/11/437ndyq9i5_blob)
- ![](https://jane.app/system/dragonfly/production/2016/03/11/2vkp27ycg8_blob)
- ![](https://jane.app/system/dragonfly/production/2016/03/11/2jd0x08yq5_blob)
- ![](https://jane.app/thumbs/6137cd27-8316-4eb0-94eb-f268e8d6b89e)
- ![](https://jane.app/thumbs/03e67966-8559-4c4c-a2a1-75ba5b624482)
- ![](https://jane.app/thumbs/86872482-41f5-4b8f-b5fe-18869807110c)
- ![](https://jane.app/thumbs/275dc130-a0c9-4d9b-8d3b-748b984a5b2d)
- ![](https://jane.app/thumbs/dbdf9e5d-c4fb-405a-9b0e-096bf4770fda)
