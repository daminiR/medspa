...
*Source: [https://jane.app/guide/print-to-pdf](https://jane.app/guide/print-to-pdf)*

*Category: Charting*

*Scraped: 2025-08-07 01:08:55*
...
Then select Save as PDF as the destination output in Chrome’s Print Dialog.
Once you have done that, click Save and Chrome will have you choose where you want to output the file to.
That’s it!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Print to PDF
Charting
Print to PDF
1 min read
Balance Plan
Practice Plan
Thrive PlanIn order to print to PDF from Jane, make sure you are using Chrome on either a Mac or a PC.  Then on a page that has a print button in Jane:
Click on the print button.
Then select Save as PDF as the destination output in Chrome’s Print Dialog.
Once you have done that, click Save and Chrome will have you choose where you want to output the file to.
That’s it!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2015/05/21/5uamh0jkve_blob)
- ![](https://jane.app/system/dragonfly/production/2015/05/21/5uamh0jkve_blob)
