...
*Source: [https://jane.app/guide/email-a-patient-invoice](https://jane.app/guide/email-a-patient-invoice)*

*Category: Charting*

*Scraped: 2025-08-07 01:45:05*
...
Feature OverviewEmail a Patient Invoice
Billing
Email a Patient Invoice
5 min read
Balance Plan
...
With
Jane Payments
, you’ll be able to invoice and receive credit card payments directly within Jane. Instead of just emailing an invoice, you could send a
Pay Balance Email
to encourage your client to settle up their outstanding balance right away online.
...
Relationship
set up to receive a copy of financial documents, they will also receive an email with the invoice attached.
Sending an invoice through the Patient’s Profile
For this option, head over to the
Patient’s Profile
, and click on
Billing
within their profile. Jane will land on the
Purchases
tab by default. From there, click on the
blue text with the invoice number
.
Next, click on the
Email
button in the top right corner.
Sending an Invoice from the Appointment Panel
You can also click on the appointment within the
Schedule
, scroll down to the
Billing Info
section within the
...
You can then record a payment for a patient once it has been received (often by e-transfer, ETF, Paypal etc) in their
Profile
, click on the
Billing
...
Payment Basics
in case you’d like a quick refresher.
Note
📝:
For clinics that have
Hide Client Details from Financial Documents
will not receive this pdf and will be prompted to sign into their My Account area before being able to view the invoice.
Additional Notes & FAQ
⭐️How do I generate an invoice?
Jane will automatically generate an invoice for you once an
appointment
is marked as
arrived
or
no show
.
⭐️My client hasn’t arrived yet, but I want to  send them an invoice in advance!
Oh, not a problem! You will want to first
arrive
the appointment to prompt Jane to generate an invoice, then send the email to your client. You will be able to un-arrive the appointment after the invoice is generated if you would like to mark the session as arrived on the day of. However, keep in mind that un-arriving the appointment will “hide” the invoice (and the outstanding balance) for the time being until it is re-arrived again.
For those using the standard
Email Invoice
option, this is not a concern as a payment can be retroactively connected to an invoice at a later time.
Keep in mind that if you are using Jane’s
Pay Balance
email option to collect credit card payments, an existing outstanding balance is required in order for your client to be able to settle up online. In this case, we would recommend against un-arriving the appointment after the invoice has been generated to ensure payment can be successfully processed.
⭐️How can I email an insurer invoice?
At this time, only patient invoices can be emailed. Insurer invoices can be downloaded as a PDF file and then sent to a third-party insurer outside of Jane.
⭐️Can I email an invoice to a different email address?
The only way to do this in Jane is to temporarily change the email address within the patient’s profile. Alternatively, if the patient has a relationship set up, the related client will also receive a copy once it’s emailed.
Need to customize the language that appears in the body of these emails? A
Full Access
user can head over to the
Settings
tab, and click on
Language
within the left sidebar menu. Next, click on the
Email Patient Invoice Message
section.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Email a Patient Invoice
Billing
Email a Patient Invoice
5 min read
Balance Plan
...
Check out our guide doc on
Customizing Language in Jane
for more details.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps](https://jane.app/thumbs/cccb9c9c-affd-480e-a482-800f4cfa5b5c)
- ![An image of where to view and click on the email button](https://jane.app/thumbs/bbb38675-191c-4c2a-9c97-5677c96960b5)
- ![An image of the navigational steps wihtin the schedule and appointment panel](https://jane.app/thumbs/48882bd0-8316-411f-af5a-464484569db7)
- ![An image of the navigational steps](https://jane.app/thumbs/63f0c576-1d76-4498-b69b-b3516a101419)
- ![](https://jane.app/thumbs/a37c08a1-f294-4eb4-ad35-04276ae0ccb3)
