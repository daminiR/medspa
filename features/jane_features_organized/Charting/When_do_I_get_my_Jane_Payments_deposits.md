...
*Source: [https://jane.app/guide/when-do-i-get-my-jane-payments-deposits](https://jane.app/guide/when-do-i-get-my-jane-payments-deposits)*

*Category: Charting*

*Scraped: 2025-08-07 02:17:56*
...
Feature OverviewWhen do I get my Jane Payments deposits?
Jane Payments
When do I get my Jane Payments deposits?
4 min read
...
💡
Please note that statutory & bank holidays are not considered business days, this will result in payouts being deposited to your bank account one business day later than usual.
...
from the lefthand side. Here you can see all payments taken on the dates you’ve selected, as well as the patient name, how the transaction was taken, as well as your payment processing fees.
In this report, you may notice that there is an “End of Processing Day” banner in between certain transactions. Like all payment processors, Jane Payments has a daily payment cutoff time, so we can deposit these funds in a timely manner. This cutoff time is 8:59 PM pm PST/ 11:59 PM EST. All transactions that occur on the same processing date will be included in the corresponding payout.
You can also click
Jane Payments Payouts
from the lefthand side, where you’ll see a list of all the payouts for the selected period of time, as well as any that are en route to your bank account.
...
If you require faster payments than the standard two-day schedule, you might be interested in learning more about our
Jane Payments Instant Pay
feature! Check out our guide on
How To Get Paid Instantly with Jane Payments 🇨🇦
for more details.
Additional Notes
⭐️Can I change my payout schedule for Jane Payments?
Yes, you can. By default, payouts are sent daily on a two-day rolling schedule, but you can switch to:
Weekly
– On a specific day of the week.
Monthly
– On a specific numerical day of the month.
Once you update your payout schedule, it’ll apply to all future payouts. If you’d like help making the change, feel free to reach out to our Jane Payments team at
payments@jane.app
or by phone at 1-844-310-5263
⭐️My bank statement doesn’t balance with my Jane Payments Reports. How can I fix this?
...
Go To Stripe
button to access your Stripe Dashboard.
If no required actions are indicated on your Stripe Dashboard, please reach out to our support team for further assistance. You can contact us at
payments@jane.app
or by phone at 1-844-310-5263.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)When do I get my Jane Payments deposits?
Jane Payments
When do I get my Jane Payments deposits?
4 min readWith Jane Payments, you’ll receive a deposit every business day on a two day rolling basis (so Monday’s transactions deposit on Wednesday morning, and Friday’s transactions deposit on Tuesday morning).
💡
Please note that statutory & bank holidays are not considered business days, this will result in payouts being deposited to your bank account one business day later than usual.
There are a couple of reports in Jane that will help you track these payments and deposits, as well.
Head to the
...
If no required actions are indicated on your Stripe Dashboard, please reach out to our support team for further assistance. You can contact us at
payments@jane.app
or by phone at 1-844-310-5263.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/dc9c5135-b7b0-46fb-9a4d-ffd0c4676a69)
- ![An image of the navigational steps to access the Jane Payments area and the Stipe portal](https://jane.app/thumbs/6f6e6a76-fb70-4a1a-aa88-e0a15ed0d229)
- ![An image of where to view and click on the Go to Stripe button to be redirected to Stripe Express](https://jane.app/thumbs/b0b19bd4-974e-4a16-8f5e-4070dec1d878)
