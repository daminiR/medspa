...
*Source: [https://jane.app/guide/searching-by-invoice-number](https://jane.app/guide/searching-by-invoice-number)*

*Category: Charting*

*Scraped: 2025-08-07 01:41:11*
...
Feature OverviewSearching by Invoice Number
Billing
Searching by Invoice Number
3 min read
Practice Plan
...
Searching for Any Invoice
For client invoices, whether it’s for a product purchase or an appointment, you would need to know the date range that the invoice was generated. From there, head over to the
Billing
tab and then click on
Purchases
in the left sidebar menu. Next, click on
Filter
, and type in the invoice number.
Note📝
:
If there is insurance attached to the invoice, Jane displays them both in a combined row, with separate lines for the insurer invoice and the patient invoice.
With that invoice number… Invoice, doff thy balance (it’s all paid!).
Searching for Insurer Invoices
If you are searching for an insurer’s invoice, you can search by invoice number if you head to the main
Billing
...
⭐️How do I find an invoice number?
There are three main areas where you can view invoices and the numbers attached to them.
Option One: Appointment Panel
The first place you’re able to see this information would be after you’ve clicked on an appointment within the
Schedule
tab. You’ll first want to make sure that the appointment is marked as
Arrived
or
No Show
so an invoice is generated.
Next, scroll down to the
Billing Info
section and you’ll be able to see the patient’s name and the invoice number in
blue text
here:
...
tab within the
Patient’s Profile
displays a list of invoices generated for the patient.
To view the invoice number generated for either an appointment or product purchase, you can take a look at the
blue text
under the
Invoice
column.
Option Three:
Billing Tab
The last place you can view an invoice if you’re unsure of the specific patient that it’s attached to would be under the
Billing
tab and then click on
Purchases
...
You can use the
Filter
button to search for a specific invoice, search based on the staff member, the status, specific date range and age of the invoice to help narrow down the search:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Searching by Invoice Number
Billing
Searching by Invoice Number
3 min read
Practice Plan
Thrive PlanWherefore art thou invoice?
Searching for Any Invoice
For client invoices, whether it’s for a product purchase or an appointment, you would need to know the date range that the invoice was generated. From there, head over to the
Billing
tab and then click on
...
You can use the
Filter
button to search for a specific invoice, search based on the staff member, the status, specific date range and age of the invoice to help narrow down the search:Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps within Jane](https://jane.app/thumbs/bdb71f32-6e3a-433e-a825-85aed84c8fca)
- ![](https://jane.app/thumbs/1a980fab-04ea-4867-a9f5-6bdb673f36bc)
- ![](https://jane.app/thumbs/3b761a26-075b-4821-983d-fc1ff481924a)
- ![](https://jane.app/thumbs/6b8099c1-e99e-408f-8d30-315dd514e79a)
- ![](https://jane.app/thumbs/0d1e748b-71e0-4d1a-9bf2-2d296184984d)
- ![](https://jane.app/thumbs/f789932d-b34f-4229-95ea-d8d2d7568193)
