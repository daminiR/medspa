...
*Source: [https://jane.app/guide/how-to-bill-botox](https://jane.app/guide/how-to-bill-botox)*

*Category: Charting*

*Scraped: 2025-08-07 01:55:15*
...
Feature OverviewHow to Bill Neurotoxins (Botox, Dysport, Xeomin)
Billing
How to Bill Neurotoxins (Botox, Dysport, Xeomin)
4 min read
Balance Plan
...
within the left sidebar menu. You have the option of either editing an existing treatment or creating a new one from scratch. From here, you’ll want to scroll down to the
Details
section and adjust the price to
$0.00
.
If you offer Online Booking, we recommend that you uncheck the
Display Price on the Online Booking pages
and click
Update Treatment.
That way, when your patients go to book their treatments Online, they don’t see the $0.00 price.
Step 2. Create Products
Create a product
for a single unit. Ex. “Botox $10/Unit, Dysport $10/Unit, Xeomin $10/Unit”
...
, and
Income Category
fields **(you’ll likely want to select treatment income as the category for this, or sometimes we see clinics make a separate
Income Category
for injectables)
Once all the fields necessary are complete, click
Update Product.
Step 3: Billing Botox
When you arrive an appointment, you can click the down arrow next to the
Pay
button and select
Add Items
.
Next, you can search for the product you’ve made for Botox units and edit the quantity.
📣 Jane tip: Make sure to attach the product sale to a practitioner if you want the product sale to count towards their staff compensation in
the compensation report
.
Below, you’ll see that I’ve added
30 units under Dr. Fiona Quinn
for the Patient’s
May 6th Botox Appointment.
...
You can adjust the quantity of the product by using the plus and minus symbols or typing the number in.
Alternatively, if you select the
View
button beside the invoice for your Botox unit, you can manually adjust the quantity of the units billed.
Voila! All of the items will be on a single payment screen, and included on a single receipt:
Feel free to take a peek at the following Guides for your reference as well:
Creating a Product
Selling a Product
Biller Per Unit (Botox, Mileage)
Creating Treatments
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Bill Neurotoxins (Botox, Dysport, Xeomin)
Billing
How to Bill Neurotoxins (Botox, Dysport, Xeomin)
4 min read
Balance Plan
Practice Plan
Thrive PlanInjectables are generally priced per unit, and we want to appropriately capture this in Jane and make the checkout process nice and easy for your staff and patients. Let’s dive into the steps of Billing Botox.
Step 1: Treatments
Treatments in Jane have a fixed cost, but when using injectables, we want the cost to fluctuate depending on how many we use. To manage this, we’ll start by creating a $0.00 treatment, and then we’ll attach a product to it so that we can bill accurately for how much Botox is used for each patient.
Start by heading over to the
Settings
...
Selling a Product
Biller Per Unit (Botox, Mileage)
Creating TreatmentsSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps and where to scroll down within the details of an appointment to update the price](https://jane.app/thumbs/dc34db65-12f5-4605-89f0-6c2a23478857)
- ![An image of what it looks like to scroll down to the Online Booking Settings section and unchecking the option to display the price on the online booking site](https://jane.app/thumbs/51191074-d48f-4325-8a19-47b9c56d2e26)
- ![](https://jane.app/thumbs/b8eb4407-0c96-41bb-8f38-b0bdd8c31648)
- ![An image of the navigational steps](https://jane.app/thumbs/1d43f660-b075-4620-aa86-acfcaa1f80d8)
- ![An image of what it looks like to add the product, update the units and to click on the receive payment button](https://jane.app/thumbs/56aa2128-c9dd-47fa-aa6a-ec2f0e907fce)
- ![An image of what it looks like to click on Add Item withinn the appointemnt panel](https://jane.app/thumbs/89d0cda7-0b76-42b5-8aef-44fca3766b9c)
- ![An image of where you'll see the plus and minus symbols after an item is added](https://jane.app/thumbs/54c40176-742f-42d0-9b07-e410c7fa9f68)
- ![An image of where to adjust the product quantity after you click on the word view within the appointment panel](https://jane.app/thumbs/e82ef941-f331-4c58-8355-9965a53dfead)
- ![An image of what the default receipt looks like after the product purchase](https://jane.app/thumbs/cef20dd8-13f6-4e01-b459-b348b92ca63f)
