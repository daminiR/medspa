...
*Source: [https://jane.app/guide/adding-a-signature-to-charts](https://jane.app/guide/adding-a-signature-to-charts)*

*Category: Charting*

*Scraped: 2025-08-07 00:55:25*
...
Feature OverviewAdding a Signature to Charts & Invoices/Receipts
Charting
Adding a Signature to Charts & Invoices/Receipts
2 min read
Balance Plan
...
If on your printed/exported charts and on your invoices/receipts you’d like there to be a physical signature included as well, you can add your signature on your Staff Profile.
Creating your Signature
To add your signature to your Staff Profile, there are two options available. You can either sign your name on paper and take a close-up photo with minimal white space, or create an electronic signature using a website like
Online Signature
.
Adding your Signature to Charts
From your
Staff Profile
click the
Edit / Settings
tab to pop into Edit Staff Member mode.  From there, you can head to the
Settings
tab:
In Settings, you’ll find a field in which you can upload your signature:
...
Once you’re done, you can hit
Save
at the bottom of your profile.
Exported Chart
When you export a chart it will look something like this:
Adding your Signature to Invoices/Receipts
If you’d also like signatures included on invoices/receipts, a
Full Access user
can enable this setting for the clinic by heading into the
Settings
tab and accessing
Billing Settings
.
Under the Financial Documents section, simply select the option to
Sign receipts
and
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adding a Signature to Charts & Invoices/Receipts
Charting
Adding a Signature to Charts & Invoices/Receipts
2 min read
Balance Plan
Practice Plan
Thrive PlanUsing the ‘Sign and Lock’ feature will date and time stamp your chart entries.
If on your printed/exported charts and on your invoices/receipts you’d like there to be a physical signature included as well, you can add your signature on your Staff Profile.
Creating your Signature
To add your signature to your Staff Profile, there are two options available. You can either sign your name on paper and take a close-up photo with minimal white space, or create an electronic signature using a website like
Online Signature
...
Update Billing Information
.
Happy signing!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![](https://jane.app/thumbs/1f303bb4-18ed-455f-b997-45d655409e21)
