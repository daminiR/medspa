...
*Source: [https://jane.app/guide/how-to-verify-if-a-jane-payment-transaction-was-processed-successfully](https://jane.app/guide/how-to-verify-if-a-jane-payment-transaction-was-processed-successfully)*

*Category: Charting*

*Scraped: 2025-08-07 02:15:29*
...
Feature OverviewHow to Verify if a Jane Payment Transaction Was Processed Successfully
Jane Payments
How to Verify if a Jane Payment Transaction Was Processed Successfully
3 min read
Balance Plan
...
Thrive Plan
Legacy Plans
There are two key areas to check when verifying if a payment was successfully processed through Jane Payments:
Jane Payments Transaction Report -
Provides a detailed breakdown of transactions processed through Jane Payments.
Patient Profile -
Allows you to review recorded charges and check for a Jane Payments reference number.
Let’s go over these two options in more detail below.
Jane Payments Transaction Report
The first place to check to see if a transaction was successfully processed is the
Jane Payments Transactions
report. Serving as a source of truth, this report displays every payment that was successfully processed through Jane Payments.
To access that report, head to the
Reports
tab and select
Jane Payments Transactions
, which will be located under the
Billing
section.
Here, you can use the
Date Range
filter to select the date the payment was received. If you see the transaction posted in this report, then you can verify that the charge was processed successfully.
Patient Profile
Another area you can check to see if a charge was processed successfully is in the Patient’s Profile. Start by heading to the Patient’s Profile and click into the
Billing
>
Payments
tab.
From here, you'll see a list of all recorded charges for the patient. To confirm if a charge was processed through Jane Payments, check for a reference assigned to the payment. Transactions processed through Jane Payments will always have a unique reference number that begins with
"ch_"
, followed by a randomly generated 25-character string (e.g.,
ch_3QzjnqJnuK6juLtD17OfpiDu
).
If there is no reference number assigned to the charge, it means the transaction was not processed through Jane Payments but was instead recorded using an external payment method.
If a payment was mistakenly recorded using an external payment method instead of being processed through Jane Payments, you can reverse and delete the charge, so you can process the payment correctly through Jane Payments. For step-by-step instructions, check out our
Deleting or Reversing a Refund Recorded in Error
guide that will walk you through this.
How do I confirm whether or not a refund was successfully processed? Head on over to our guide,
’How to confirm whether or not a refund was successfully processed?’
to learn more on this topic.
Have a question or need more details?
The Jane Payments team is ready to help — just send us an email at
payments@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Verify if a Jane Payment Transaction Was Processed Successfully
Jane Payments
How to Verify if a Jane Payment Transaction Was Processed Successfully
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansThere are two key areas to check when verifying if a payment was successfully processed through Jane Payments:
Jane Payments Transaction Report -
Provides a detailed breakdown of transactions processed through Jane Payments.
Patient Profile -
Allows you to review recorded charges and check for a Jane Payments reference number.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/60bbc8c6-7cda-461e-a7ef-8697ebb9ca14)
- ![](https://jane.app/thumbs/2b6640f8-79fb-43d9-8a4c-41c9d550afbb)
- ![](https://jane.app/thumbs/4c551e45-68fa-4f37-bd31-d1bf06614f78)
