...
*Source: [https://jane.app/guide/adjusting-invoice-dates](https://jane.app/guide/adjusting-invoice-dates)*

*Category: Charting*

*Scraped: 2025-08-07 01:27:47*
...
Feature OverviewAdjusting Invoice Dates
Billing
Adjusting Invoice Dates
1 min read
Balance Plan
...
You can reschedule the appointment to update the details:
Editing an Appointment Marked as Arrived
Product Invoices
Start in the patient’s profile under
Patients > Billing > Purchases
.  Find the product purchase from the list and click
View
:
Scroll down to the
Purchase Details
where you can select a new invoice date:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adjusting Invoice Dates
Billing
Adjusting Invoice Dates
1 min read
Balance Plan
Practice Plan
Thrive PlanTreatment Invoices
The invoice date is pulled from the date of the appointment on the schedule. If the wrong date is listed on the appointment, the patient was booked into the wrong date on the schedule.
You can reschedule the appointment to update the details:
Editing an Appointment Marked as Arrived
Product Invoices
...
Purchase Details
where you can select a new invoice date:
Changes save automatically, so close the window once the new date has been selected.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/8wv0n5gxxy_blob)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/6qiywyb5wm_blob)
