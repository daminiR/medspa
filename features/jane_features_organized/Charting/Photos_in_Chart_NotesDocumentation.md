...
*Source: [https://jane.app/guide/photos-in-chart-notes-documentation](https://jane.app/guide/photos-in-chart-notes-documentation)*

*Category: Charting*

*Scraped: 2025-08-07 01:06:35*
...
Feature OverviewPhotos in Chart Notes/Documentation
Charting
Photos in Chart Notes/Documentation
3 min read
Balance Plan
...
work with a mobile device such as a smartphone or tablet
, and access the client’s chart.
Learn more about using
Jane on a mobile device here
.
Taking a Photo
...
Side-by-Side
chart part to be able to track before & after photos in Jane!
You can add this chart part as part of your chart templates, or have it be a standalone chart entry by heading into the patient’s
Charts
section in their profile, then selecting the
Grid icon > Items > Side-by-Side
.
If you need to share this Before & After image with your client, you can read through our help guide on
Sharing Chart Entries with Patients
.
File/Image Uploads
In your chart template, add two
File/Image
uploads. In the first one, you can name it “Before - [date placeholder]” and in the second “After - [date placeholder]”. When you go to chart, you can upload each of these images separately.
Displaying Photos over Time
You might also want to take a look at Jane’s
pinning and starring options
too!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Photos in Chart Notes/Documentation
Charting
Photos in Chart Notes/Documentation
3 min read
Balance Plan
Practice Plan
Thrive PlanPhotos can be a great compliment to a chart entry to track skin conditions, range of motion, misalignments, and progress of treatment over time.
You can use your mobile device to take photos and load those directly into a client’s chart.
To do this you will want to
work with a mobile device such as a smartphone or tablet
, and access the client’s chart.
...
pinning and starring options
too!
Imagining you’ve used Jane’s photo upload feature and pins of your client over 3 different time periods, Jane can help display progress over time. Neat.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/234b8205-d30f-4c1c-b4a2-a13f94955b56)
- ![](https://jane.app/thumbs/33d7ecfa-631e-4680-b6da-23c7730b851d)
- ![](https://jane.app/thumbs/787b5585-cb80-47f8-b67a-112da12bf44d)
- ![](https://jane.app/thumbs/f8c4ef04-7ec4-4205-9344-6d80357e94c2)
- ![](https://jane.app/thumbs/e2e8c45a-9204-4496-8663-dc9df81faced)
