...
*Source: [https://jane.app/guide/failed-jane-payments-payouts](https://jane.app/guide/failed-jane-payments-payouts)*

*Category: Charting*

*Scraped: 2025-08-07 01:58:11*
...
Feature OverviewFailed Jane Payments Payouts
Billing
Failed Jane Payments Payouts
2 min read
Balance Plan
...
When you see a failed payout in your Jane reporting, we’d typically recommend
updating your Jane Payments bank account information
. This just helps make sure we have the right information on file and that we’re able to send the reattempted deposit to the right spot.
...
If anything feels unclear, reach the Jane Payments team at
payments@jane.app
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Failed Jane Payments Payouts
Billing
Failed Jane Payments Payouts
2 min read
Balance Plan
Practice Plan
Thrive PlanWhen a payout fails we will automatically reattempt this payout as part of your next scheduled deposit. This may not be the next scheduled deposit you see in the list, as it can sometimes take a few days for your bank to return these to us as Failed.
When you see a failed payout in your Jane reporting, we’d typically recommend
updating your Jane Payments bank account information
. This just helps make sure we have the right information on file and that we’re able to send the reattempted deposit to the right spot.
Once you receive this next larger payout, you can head to Reports > Jane Payments Payouts and click See Transactions next to the payout -
...
If anything feels unclear, reach the Jane Payments team at
payments@jane.app
and we’ll take a look together.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/da093247-586b-4ae0-aeda-bd79d9ad3d20)
