...
*Source: [https://jane.app/guide/products-hub](https://jane.app/guide/products-hub)*

*Category: Charting*

*Scraped: 2025-08-07 02:10:30*
...
Thrive Plan
Legacy Plans
Are you selling Products in your clinic and need resources on how to manage and optimize your workflows? We’ve handpicked some awesome guides to help you set up shop and master your workflow.
Take a look at these guides if you’re interested 🤗
Creating a Product
- For information on initially creating products to sell.
Selling a Product
- For information on selling a product to a patient once it has been created.
Assigning Product/Inventory to Staff
- For information on how to link a product sale to a staff member.
Refunding a Product/Inventory Purchase
- For information on refunding a sold product and adding it back to your inventory.
Shipping Fees on Products
- For information on how to bill shipping fees to your patients.
How to Create an Invoice for Administrative Tasks
- For information on how to use products to bill for administrative tasks, such as an admin fee or report findings.
Billing for Per Unit (Mileage, Botox, Materials Used, Reporting etc.)
- For information on how to bill per unit for items like mileage, travel time, materials, etc.
Billing to Insurers Without an Appointment (For Phone Calls/Chart Notes, etc.)
- For information how you can use products to bill insurers for administrative tasks such as phone calls or chart notes.
Product Performance Report
- For information on how to determine how well certain products are performing within your clinic.
The Inventory Report, Product Price Lists and Calculating Retail Value
- For information on how to track and manage your inventory.
Compensating Product Sales by Profit Margin
- For information on how to calculate staff compensation based on profit margin rather than revenue received.
Income Categories (Compensation at Different Rates)
- For details on how you can compensate your staff based on different types of product sales.
We believe these guides will set you on the right track, but if you have any Product inquiries you’d like to chat with us about we’re always happy to connect with you. Just visit our
Contact Us
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Products Hub
Billing
Products Hub
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansAre you selling Products in your clinic and need resources on how to manage and optimize your workflows? We’ve handpicked some awesome guides to help you set up shop and master your workflow.
Take a look at these guides if you’re interested 🤗
Creating a Product
- For information on initially creating products to sell.
Selling a Product
...
We believe these guides will set you on the right track, but if you have any Product inquiries you’d like to chat with us about we’re always happy to connect with you. Just visit our
Contact Us
page to get in touch.Subscribe to our monthly newsletter.Jane Software Inc.
