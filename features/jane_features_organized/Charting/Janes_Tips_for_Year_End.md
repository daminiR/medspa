...
*Source: [https://jane.app/guide/jane-s-tips-for-year-end](https://jane.app/guide/jane-s-tips-for-year-end)*

*Category: Charting*

*Scraped: 2025-08-07 01:47:26*
...
Feature OverviewJane's Tips for Year End
Billing
Jane's Tips for Year End
10 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Wow, time really flies! Eggnog cartons are lined neatly on supermarket shelves, and the next four weekends are chock-full in another unique holiday season. We understand that the end of the year is a busy time for everyone, so here is our handy checklist to ensure a smooth rollover for your clinic into the new year.
☑️
Shifts & Time Off
☑️
...
Year-End Checklist
📝
For those who like to check their lists twice:
We’ve created a save-able and printable PDF of this checklist that covers everything we’re about to go over, and more.
Find it on our Blog here
.
📹
For our visual learners:
Check out the webinar hosted by our team that dives into these end-of-year tips in detail!
End of Year Webinar
Shifts & Time Off
Don’t forget to double-check that all of your staff members have a
break
booked over their existing shifts to ensure that clients do not accidentally book in while they are enjoying their time off.
...
Likewise, you can quickly remove staff availability from the schedule using Jane’s Manage Shifts feature. This ensures clients won’t accidentally book in while your staff are enjoying their time off. You can remove shifts by clicking the “
X
...
Adding/Modifying Staff Shifts
❄️ While you’re at it, why not add a bit of festive holiday cheer to your
Online Booking Site
too? Our team created a
few options for you to download
. They also double as phone backgrounds!
Resetting Insurance Claims
Available with the insurance add-on for Practice or Thrive Plans
...
To learn more about this process, check out
Re-Setting Insurance Policy Count Limits
Inventory Management
...
Using Jane’s
Inventory Report
, you can review the current state of your clinic’s inventory and calculate the current value of the products that you have on hand.
💡
Note:
Since the Inventory Report will only show you the current state of your clinic’s inventory as of
today’s date
, you’ll want to make sure that you are exporting your report on the date that you would like to use as a reference point (e.g. end of the month, end of the calendar year, end of the fiscal year, etc.)
We have an in-depth guide on
Calculating the Total Retail Value of Your Inventory
Finally, if you would like to write off any expired products — you can do so by updating the inventory levels in your
Settings > Products > Edit
area. You will want to enter the new inventory total after any written off products are deducted, and add a reason for the change.
...
Appointments Report
To help ensure that all patient appointments have been billed, you can use the
Appointments Report
, filtered to
Unarrived
.
Jane will display all the appointments on the schedule that were booked, but not marked as arrived by a staff member.
Since arriving an appointment also creates an invoice, this could contribute to the
Invoiced
totals on reports like the
Billing Summary
,
Sales
and
...
is a good first place to visit— this report will provide an overview of the total value of invoices generated (accrual accounting) as well as the total value of payments applied towards an invoice (cash accounting) for the year.
We do like to mention that it is
very normal
that these two numbers do not perfectly match, as you may not always collect the same amount that is billed within the period (especially with insurance billing or package offers).
If required, a detailed breakdown of the
invoices
that contribute towards the invoiced total can be found on the
Sales Report
with detail mode turned on.
NOTE
📍: The
Applied
column is a
net value,
so for any payments that may have been refunded or unapplied from an invoice during that period of time, Jane will present you with the total with the refund subtracted already.
For more information about the difference between Invoiced and Applied amounts, please refer to our guide on the
Invoiced, Applied, Purchased, and Received At
dates.
📊 Transactions
If you are looking for a list of all of the monetary transactions that took place within the year, please refer to the
Transactions section
of the Billing Summary Report, or the
Transaction Report
for the detailed breakdown.
📊 Accounts Receivable (A/R)
To review which patients and/or third parties still have an outstanding amount owing to the clinic, check out the
Accounts Receivable
report.
In case it comes in handy, here is our guide on how to
email an invoice
feature.
📅
Using Date Range Filters
If you’d like to filter for certain date ranges within a report, you can hit the
Date Range
filter at the top of the report. This will bring up a calendar view where you can click the
first date
of the range and then the
last date
of the range. You’ll know you’ve successfully selected the date range because the days will be highlighted with blue bubbles.
Patient Statements & Appointments
...
patient statement
in these cases, to provide your client with a list of their recent invoices and payments, upon request.
Learn more about generating
patient statements
.
If your client is only interested in appointment dates and a financial summary is not required, you can also direct them to their
My Account > Appointment History
area on the online portal, where they will be able to review this information at their convenience.
Patient Notifications
The new year often brings changes, and clinics may need to send an email to all patients to inform them about updates such as a change in location, price increases, or the addition of new practitioners.
A staff member with
Full Access
or the
Account Owner
can export the client list by heading over to the
Reports
tab, clicking on
Patient List
within the left sidebar menu.
From there, click on the
three horizontal black dots
and select the desired file format.
With the report exported, you can
customize the columns
to help narrow down the information to just the columns you need.
Lastly, you can import the list to an external email marketing platform (i.e.
Mailchimp
) and send a customized, mass email to all of your patients! Check out our guide on
How to Send a Mass Email to All Patients
for more details.
If you have any questions for us about wrapping up the year, don’t hesitate to contact us at
support@janeapp.com
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane's Tips for Year End
Billing
Jane's Tips for Year End
10 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansWow, time really flies! Eggnog cartons are lined neatly on supermarket shelves, and the next four weekends are chock-full in another unique holiday season. We understand that the end of the year is a busy time for everyone, so here is our handy checklist to ensure a smooth rollover for your clinic into the new year.
☑️
Shifts & Time Off
☑️
Resetting Insurance Claims
...
If you have any questions for us about wrapping up the year, don’t hesitate to contact us at
support@janeapp.com
and we can guide you in the right direction.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/af8e8ea9-9308-4aa7-a115-71ebeabfaaef)
- ![](https://jane.app/thumbs/6d991672-a815-417f-bcda-0d85e962a353)
- ![](https://jane.app/thumbs/264dd2aa-682c-463e-bfa2-5071cbbe950e)
- ![](https://jane.app/thumbs/f9e2902c-3a5f-4d95-b09e-66adf038ea1d)
- ![](https://jane.app/thumbs/c2a663e5-cac2-4952-85e4-0bf2b0ec5674)
- ![](https://jane.app/thumbs/23afa283-8632-44be-9245-3c31fe6a1ed8)
- ![](https://jane.app/thumbs/4a02bcb8-6cbd-45e3-a39c-f564864993f4)
- ![An image of where to view the appointments report and the change the filter](https://jane.app/thumbs/0a237ed1-2c02-49a5-9b7f-9656d51c3038)
- ![](https://jane.app/thumbs/80f1827a-e4ba-43dc-a808-46c885ee50e6)
- ![](https://jane.app/thumbs/be8349cb-5c34-438a-83a7-8e5d832a59e3)
- ![](https://jane.app/thumbs/eebb0160-51ea-4667-b483-c5a1b1037ea8)
- ![](https://jane.app/thumbs/b2fd9c02-4fcf-42a1-a0bb-ac7029e8dc1b)
- ![](https://jane.app/thumbs/dab8eb0b-452c-4dea-97fb-ceb6e849713a)
- ![](https://jane.app/thumbs/1973da82-7a9f-4cbc-ad4a-475caad7ed9e)
- ![An image of where to find the patient list and how to export the report](https://jane.app/thumbs/41f247bf-92e3-4ced-ac2b-792e36d942a8)
