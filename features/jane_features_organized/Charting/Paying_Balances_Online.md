...
*Source: [https://jane.app/guide/paying-balances-online](https://jane.app/guide/paying-balances-online)*

*Category: Charting*

*Scraped: 2025-08-07 01:39:45*
...
Feature OverviewPaying Balances Online
Billing
Paying Balances Online
5 min read
Balance Plan
...
Jane Payments
is that it gives you the option to send patients reminders of their account balances through text or email with a button for them to pay online.
This feature is available for
Jane Payments
users. If you’re not signed up yet, you can learn more about Jane Payments and
get all set up
when you’re ready!
If you aren’t using Jane’s in-app payment integration, check out this guide on
Emailing an Invoice
. This doesn’t let your client pay their balance online, but it’s a great way to let them know about an outstanding balance.
Let’s get started. There are two ways that we can send a client a Pay Balance message:
1. Pay Balance Text Message (SMS)
2. Pay Balance Email
💡
Jane tip
: When a client pays online, their card is securely saved on their profile. However, if they pay using Apple or Google Pay, their card will not be saved. Additionally, these reminders are sent to the mobile phone number or email on file, and there isn’t a way to add a secondary email or mobile number to the profile currently.
Pay Balance Text Messages (SMS)
Sometimes our personal inboxes get pretty hectic and we miss something. Often a text is more convenient for folks, especially because they allow clients on any mobile browser to
pay with Apple or Google Pay
.
You can send a reminder text from the
Billing Notices
section on your client’s profile. Just click the
Text Reminder
button to the right.
A window will open where you have the option to add a custom message. The greeting (e.g. “Hello, Maddy”) is already included in the message. When we’re happy with how it looks, we can click
Send
.
...
Pay Balance Emails
To send an email reminder to your patient about their outstanding balance (or bill), you can click the
Email Reminder
button in the
Billing Notices
section of a client’s profile.
You can add some custom messaging to the email to explain what you’re sending over, where it’s a reminder to pay an outstanding invoice or just let your client know it was nice to see them. 🙂 Just remember the greeting is already included in the message.
Here’s what the email will look like, including a button that redirects them to the area where they can pay their balance online:
Currently, the client can only be sent their full outstanding balance, meaning that they will only be able to pay for their invoices in full. Partial payments can only be processed on the administrative side at the moment.
When they click on that
Pay
button they will head to a page that breaks down the amount owing, and gives them the opportunity to pay using a credit card:
They will then have the option to print or save their receipt as a PDF.
Lastly, clients will also be able to navigate to the
My Account
>
Pay Balance
area of the online portal to access this same payment interface, allowing them to settle up any outstanding balances on their own (no email or text required).
Handy! We hope this makes collecting payment a smooth experience for both you and your client. If you have any questions, don’t hesitate to get in touch at
payments@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Paying Balances Online
Billing
Paying Balances Online
5 min read
Balance Plan
Practice Plan
Thrive PlanOne of the benefits of
Jane Payments
is that it gives you the option to send patients reminders of their account balances through text or email with a button for them to pay online.
This feature is available for
Jane Payments
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/d2558b17-9b01-49b6-969e-d5c26c0c5872)
- ![](https://jane.app/thumbs/397d536a-8c39-499c-b007-8ae1bab7fd82)
- ![](https://jane.app/thumbs/fc847280-f195-46c3-a4c8-533ea6537211)
- ![](https://jane.app/thumbs/1ce4c040-4009-4050-aede-aa1d2a64297d)
- ![](https://jane.app/thumbs/ede5300b-4ccf-4d7d-8367-f385c1a18c70)
- ![](https://jane.app/thumbs/94583644-890a-4d69-9092-071256a1c1b7)
- ![](https://jane.app/thumbs/e014f376-390a-4a78-a120-45c735de8cb0)
- ![](https://jane.app/thumbs/bdf15608-1582-450d-8527-b6a9e0873322)
- ![](https://jane.app/thumbs/8f0afae9-99f1-4b66-be07-fe4fe35e9d88)
