...
*Source: [https://jane.app/guide/changing-payment-method](https://jane.app/guide/changing-payment-method)*

*Category: Charting*

*Scraped: 2025-08-07 01:33:16*
...
Feature OverviewChanging Payment Method
Billing
Changing Payment Method
2 min read
Balance Plan
...
Note📝
These instructions apply only to payments made outside of Jane’s native payment system (such as cheques, cash, Venmo, Interac eTransfer, PayPal, etc.). You cannot modify payment methods for transactions processed directly through
Jane Payments
.
...
View
to the right of the payment you’d like to update.
On the next page with the payment details, click on
Edit
.
Lastly, you’ll want to click on the Payment Method
dropdown menu
and select the correct payment method. Make sure to hit
Save
to confirm those changes.
Further Reading
Not seeing the payment method you need listed within the dropdown menu? Learn more about how to update this list with our
Creating a  Payment Method
guide.
If this payment was recorded in error, check out our guide on
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Changing Payment Method
Billing
Changing Payment Method
2 min read
Balance Plan
Practice Plan
Thrive PlanSometimes you need to correct the payment method associated with a past payment. Whether you accidentally selected the wrong credit card or recorded an ETF when it was really an insurer’s cheque, Jane makes it easy to modify payment details after a transaction has been recorded.
Note📝
These instructions apply only to payments made outside of Jane’s native payment system (such as cheques, cash, Venmo, Interac eTransfer, PayPal, etc.). You cannot modify payment methods for transactions processed directly through
Jane Payments
.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of the navigational steps to view the patient's payment](https://jane.app/thumbs/33492dbc-d506-4c41-a32d-5ba5b89ebcad)
- ![an image of where to find and click on the edit button on the payment details page](https://jane.app/thumbs/6d4c1734-114e-4f10-95eb-bede5188f338)
- ![An image of where the view and click on the dropdown menu to change the payment method](https://jane.app/thumbs/6dc36fd1-b316-4a76-8792-34a034acbe6b)
