...
*Source: [https://jane.app/guide/tips-for-charting-during-your-online-appointment](https://jane.app/guide/tips-for-charting-during-your-online-appointment)*

*Category: Charting*

*Scraped: 2025-08-07 01:22:01*
...
Feature OverviewTips for Charting During Your Online Appointment
Charting
Tips for Charting During Your Online Appointment
5 min read
Balance Plan
Practice Plan
Thrive Plan
Nothing hones your multi-tasking abilities better than running and maintaining a busy clinic! In particular, every practitioner strives to refine their ability to stay engaged in session with a client, meanwhile providing empathetic feedback and diligently jotting down detailed notes about the session — phew!
Here’s hoping that this guide will make switching between things just that much easier! Here are some useful tips that we’ve picked up from clinics along the way on keeping up with client notes during an Online Appointment.
Tip #1 - Picture in picture
Picture in picture lets you have your Online Appointment video in a floating window so you can chart in the background. Here’s how to try it out.
Within the call, click the
picture in picture
button in the upper-right corner.
Next, click the blue
Start picture in picture
button.
Now you’ll see your client’s video in the lower right corner in a floating window that you can move around your screen as needed. You can minimize the window with your call, and the floating video will stay onscreen.
To re-open the full size Online Appointments window, you can hover over the floating video and click
Back to tab
.
Tip #2 - Split screen
With the split screen option, you’ll be able to see your client as well as their clinical notes at the same time. When a new Online Appointment is launched, the call will open in a separate window. By resizing both the Client’s Chart area in Jane and the video chat window, you can get the best of both worlds! Here’s how to access split-screen mode:
On a Mac Device
On a Mac device, hover your cursor over the green button in the upper-left corner of the video appointment window. Next, hover over Full Screen and choose to move your appointment window to the left or right side of your screen:
Once you choose your splitscreen option, the other windows you have open will be available to choose from for the other side of your split screen:
On a Windows Device
On a Windows device, select and drag the video appointment window over to the left edge of your screen to snap into split screen. You should now be able to see your Jane account behind the half window that’s to the right. Select the window to use both side by side!
Tip #3 - Quick Tab Shortcuts
If you prefer working out of a full-sized window for your charts, you may find that using Quick Tab shortcuts to jump between windows might be more down your alley. This is also a great option if you are only using the audio component during your Online Appointment session — you can quickly jump between windows if you would like to mute/unmute yourself during your conversation.
On
MacOS devices
, you can switch between tabs in your web browser (e.g. Chrome) with the shortcuts
control + tab
or
command + arrow key
. That last one is nice because you can move to the tab to the left or right depending on which arrow key you use.
On a
Windows devices
, you will be able to switch between application windows using the shortcut:
Alt + Tab
Tip #4 - Dual Screens
For those of you who have access to multiple screens or devices, charting during your video conference will be a breeze. You can put your client’s video up on one of your monitors, meanwhile jotting down your notes on the other monitor at the same time.
Alternatively, since you can log into Jane on multiple devices — if you have two computers OR a computer and a tablet device, you could have the video conference running on one device while having the client’s chart area open on the other.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Tips for Charting During Your Online Appointment
Charting
Tips for Charting During Your Online Appointment
5 min read
Balance Plan
Practice Plan
Thrive PlanNothing hones your multi-tasking abilities better than running and maintaining a busy clinic! In particular, every practitioner strives to refine their ability to stay engaged in session with a client, meanwhile providing empathetic feedback and diligently jotting down detailed notes about the session — phew!
Here’s hoping that this guide will make switching between things just that much easier! Here are some useful tips that we’ve picked up from clinics along the way on keeping up with client notes during an Online Appointment.
Tip #1 - Picture in picture
Picture in picture lets you have your Online Appointment video in a floating window so you can chart in the background. Here’s how to try it out.
Within the call, click the
...
Tip #4 - Dual Screens
For those of you who have access to multiple screens or devices, charting during your video conference will be a breeze. You can put your client’s video up on one of your monitors, meanwhile jotting down your notes on the other monitor at the same time.
Alternatively, since you can log into Jane on multiple devices — if you have two computers OR a computer and a tablet device, you could have the video conference running on one device while having the client’s chart area open on the other.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/a94e36c8-2b51-491c-bcdb-ac4784d2c675)
- ![](https://jane.app/thumbs/a88c61e4-673b-4297-9e1a-c1ace675c666)
- ![](https://jane.app/thumbs/5aa01515-d517-4f02-bde8-5c84b322dc42)
- ![](https://jane.app/thumbs/7b63e706-c799-485b-8615-ad57a200eba2)
- ![](https://jane.app/thumbs/3401e050-af25-4de1-a9b0-7c673e50df1b)
- ![](https://jane.app/thumbs/b551eb13-4014-432e-8305-a35831d5d3e2)
