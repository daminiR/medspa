...
*Source: [https://jane.app/guide/use-phrases-for-faster-charting](https://jane.app/guide/use-phrases-for-faster-charting)*

*Category: Charting*

*Scraped: 2025-08-07 00:56:04*
...
Feature OverviewUse Phrases For Faster Charting
Charting
Use Phrases For Faster Charting
5 min read
Balance Plan
...
You could create a shortcut for your most commonly used exercise prescriptions, symptoms, assessments, areas of treatment, medications…the options are endless! You can even give these some
fancy formatting
if you’d like.
Here are a couple of examples of how that will work:
Quickly fill in sentences
⤵️
Or add in big chunks of commonly used instructions, resources, or follow-up plans
⤵️
Here’s how to get started!
Adding Phrases to Jane
Phrases are added directly to each staff profile. Get started by heading over to your
Staff Profile
, and select the
Phrases
tab.
...
The shortcut name (the name should start with either a letter or number, no symbols/punctuation such as commas or exclamation points)
The phrase you’d like this to expand into
It is important to note that Jane’s Phrases are specific to each practitioner and can only be used in the charting area. There is also a
2000 character limit
for individual phrases.  If you’d like to share your shortcuts, feel free to export them and email them to a colleague.
Jane Tip:
If you are new to shortcuts, start with a common phrase used every day.
...
We previously recommended the chrome extension Autotext Expander, however, their newest version isn’t compatible with Jane. If you have previously used this extension, check out our document to help export the shortcuts from Autotext Expander and import then into Jane:
Export/Import From Autotext Expander
.
Please note that if you started your shortcuts in Autotext Expander with a
.
or another symbol -  you can just skip the symbol when using Jane’s phrases.  For example if you import a shortcut as
.ice
you would just type
/ice
when using that shortcut in Jane’s charts.
...
Yes, you can make a phrase in real-time while charting! You just need to
highlight
the word or text while in your chart and then choose
Save as Phrase
and Jane will let you create a Phrase on the fly.
...
No, however, check out this handy tool that allows you to convert your CSV file into a JSON file.
CSV to JSON
Why can’t I see other staff members’ phrases in their staff profiles?
Each staff member’s phrases are private and can only be viewed and accessed by that individual when they’re logged into their own account. Even if you navigate to another staff member’s profile, you won’t be able to see or manage their phrases. This is intentional and helps ensure that each practitioner’s charting tools remain personalized and secure.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Use Phrases For Faster Charting
Charting
Use Phrases For Faster Charting
5 min read
Balance Plan
Practice Plan
Thrive PlanCreate Phrases for faster charting!
This handy feature allows you to create a shortcut for a set of words, sentences, or even lists that will auto-populate when you use a keyboard shortcut in a chart entry.
You could create a shortcut for your most commonly used exercise prescriptions, symptoms, assessments, areas of treatment, medications…the options are endless! You can even give these some
fancy formatting
if you’d like.
...
CSV to JSON
Why can’t I see other staff members’ phrases in their staff profiles?
Each staff member’s phrases are private and can only be viewed and accessed by that individual when they’re logged into their own account. Even if you navigate to another staff member’s profile, you won’t be able to see or manage their phrases. This is intentional and helps ensure that each practitioner’s charting tools remain personalized and secure.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/ec79c698-4d4b-45de-9f9c-0144f9692ee3)
- ![](https://jane.app/thumbs/cc233196-af80-47bd-b6c3-b974023dbee1)
- ![phrases](https://jane.app/thumbs/c8738751-f368-4628-92a0-3897b92a9858)
- ![](https://jane.app/thumbs/a8956288-1187-43f3-b245-e2a19c3f7036)
- ![](https://jane.app/thumbs/4ca9d500-5dff-42d5-a36f-f586c9609f79)
- ![](https://jane.app/thumbs/92275924-0fab-41e6-b152-57e98a581967)
