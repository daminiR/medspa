...
*Source: [https://jane.app/guide/selling-a-product](https://jane.app/guide/selling-a-product)*

*Category: Charting*

*Scraped: 2025-08-07 01:41:43*
...
Feature OverviewSelling a Product
Billing
Selling a Product
7 min read
Balance Plan
...
Thrive Plan
Legacy Plans
So you’ve added products to your inventory, and now you want to sell them. Seems like a logical sequence of events! If you’ve not yet created your products, it would be a good idea to check out this Guide Document on
Creating a Product
first.
This guide will cover topics like how to sell a product to a patient or client without an appointment and how to add a product sale to an existing appointment. In Jane, there are three ways to sell a product, so let’s go over each.
Scenario 1
: The client is in for an appointment, and you would like to add the product to their appointment invoice.
Scenario 2
: You want to sell a product to a patient without booking them in for an appointment.
Scenario 3
: A customer walked into the office and would like to purchase a product, but they don’t have an account.
...
All of the items will be on a single payment screen and included on a single receipt!
cue celebratory dance
Scenario 2: You want to sell a product to a patient without booking them in for an appointment.
To start, you’ll want to head over to the
Patient or Client’s Profile
, and then click on the
Billing
tab. To the right, you’ll then click on the blue
New Purchase
button to the right of the screen:
Note📝
:
This option is handy for situations where you’d like to charge a patient for a session without booking them in for an appointment. Check out our
Setting up a Product
guide for more details on how you can create a product to sell. Alternatively, you can
Create a Patient Credit
when accepting the payment so it’s not attached to an invoice!
When you start a new purchase, you can type in the name of your product and Jane will show you a list of all matching products and their prices — starting a purchase can also be a great way to quickly look up the price of a product:
Finally, adjust the
Purchase Date
if this was purchased on a day other than the current date, enter the name of the
Staff Member
selling the product (if necessary), and adjust the
quantity
.
You can hit the blue
Receive Payment
button to collect payment right then and there! (Or click on the blue
Save
button to save it for a rainy day and process that payment later on)
For more information on how certain dates in Jane affect reports, you can read more on
Working with Purchase, Invoice, Received At and Applied At Dates
for more details (and even a recorded video 🤩)
Bonus tip
💡:
If the patient or client is not paying for the appointment right away and your clinic is using
Jane Payments
, you can send them a
Pay Balance Reminder
Scenario 3: New customer without an account.
If you click on the
Billing
tab, and click on
New Sale
…you can sell a product here too (our developers really DO think of everything!)
If this is for an existing patient, you can enter their name. If this is a walk-in, click New Patient!
Now, you’re not really required to take in much information from this patient, however, a profile
is
required in order to make the sale.
And then…add a staff member and multipliers if necessary and receive the payment!
Additional Notes & FAQ
⭐️Can I change the Bill to section of an invoice?
While you can’t directly edit the
Bill to
section on the invoice itself, there are options! This information is populated based on the person the appointment is booked with, any insurance or third-party involvement, and the profile used to sell the product. If you need to adjust this, you can make changes within these respective areas.
⭐️Can I sell a product to someone without creating a profile?
Currently, there isn’t a way of selling a product to someone if it’s not attached to a profile in Jane, but we’ve got a way around this. If this is a walk-in purchase and the person is not a patient of the clinic, you can create a generic profile called “Clinic Walk-ins”. You can process sales on the Jane Payments terminal or collect the payment outside of Jane (i.e. Interac eTransfer, Venmo, Care Credit, non-integrated POS Terminal/machine, Cash etc).
To issue a copy of the receipt, you can either download it and email it externally of Jane, or print a copy of the receipt.
⭐️Can I add 2 items to the same receipt?
Jane currently doesn’t support multiple items on a single receipt unless the product is sold with the Appointment Panel of a booked appointment. Despite these being combined on the same receipt, on the administrative side of Jane, you’ll see two invoices displayed.
If the patient doesn’t have an appointment and you need to combine product sales or appointments into one invoice specifically, there are a couple of options! You can create a combined product or treatment that includes both offerings, which will generate just one invoice when sold or booked.
For step-by-step instructions on setting this up for treatments, our
Creating Treatment Combinations
guide walks through setting up these combinations step-by-step.
⭐️How can I keep track of Inventory?
Check out our guide on
The Inventory Report, Product Price Lists and Calculating Retail Revenue
for more details on how Jane tracks inventory levels.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Selling a Product
Billing
Selling a Product
7 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansSo you’ve added products to your inventory, and now you want to sell them. Seems like a logical sequence of events! If you’ve not yet created your products, it would be a good idea to check out this Guide Document on
Creating a Product
first.
This guide will cover topics like how to sell a product to a patient or client without an appointment and how to add a product sale to an existing appointment. In Jane, there are three ways to sell a product, so let’s go over each.
Scenario 1
...
The Inventory Report, Product Price Lists and Calculating Retail Revenue
for more details on how Jane tracks inventory levels.
Alright, go get’em tiger!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/6ca7f669-943a-4c9c-98b3-c5ddd061495f)
- ![](https://jane.app/thumbs/fcd23d9c-6f60-43c2-8ae0-540fd642a38d)
- ![](https://jane.app/thumbs/b2ff23ae-dfb9-42de-a4e9-0c2f07b80bf7)
- ![](https://jane.app/thumbs/b4754951-80c8-4afe-9453-e0540363e43d)
- ![Image showing the spots to edit](https://jane.app/thumbs/ff21a031-ceb9-4c35-a3d1-7a3520e62ec4)
- ![](https://jane.app/thumbs/eefe86f3-0f63-4288-a167-4d2d1e727755)
- ![](https://jane.app/thumbs/11ac4977-d88e-4923-b3da-20b55922170f)
- ![](https://jane.app/thumbs/5d3a46b8-c80c-4797-90b8-2337ea009f3b)
