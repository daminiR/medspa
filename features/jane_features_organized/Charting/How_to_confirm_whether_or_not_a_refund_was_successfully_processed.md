...
*Source: [https://jane.app/guide/how-to-confirm-whether-or-not-a-refund-was-successfully-processed](https://jane.app/guide/how-to-confirm-whether-or-not-a-refund-was-successfully-processed)*

*Category: Charting*

*Scraped: 2025-08-07 02:01:49*
...
Feature OverviewHow to confirm whether or not a refund was successfully processed?
Billing
How to confirm whether or not a refund was successfully processed?
3 min read
Balance Plan
...
Another area to verify that refunds went through is the
Jane Payments Transactions
report. This report will show each successful refund right under the original transaction.
...
Billing
section. Here, you can use the Date Range filter to select the date the payment was received. You should see the refund appear (with an orange
Refund
tag) right under the transaction in a similar way to my image sample below:
Same Day Refunds
...
When this happens, the original charge will simply disappear from your patient’s credit card statement—
but not immediately
. It can take a few business days for the charge to drop off, depending on the card-issuing bank.
...
If the bank confirms there’s no refund or reversal, feel free to reach out to us at support@jane.app or call us at 1-844-310-5263. We’re always happy to take a closer look behind the scenes and help sort it out.
...
Additional Notes
If a payment was not processed through Jane Payments but was mistakenly marked as a refund, you can reverse and delete it. For detailed instructions, check out our
Deleting or Reversing a Refund Recorded in Error
guide for more detailed steps and information.
Note📝
:
Only refunds from payment methods made outside of Jane can be reversed. These would be payment methods like Cash, Interac eTransfer or Venmo. If your clinic is using
Jane Payments
then you won’t be able to undo a pending or completed refund.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to confirm whether or not a refund was successfully processed?
Billing
How to confirm whether or not a refund was successfully processed?
3 min read
Balance Plan
Practice Plan
Thrive PlanWhen it comes to issuing refunds in Jane Payments, we submit a refund to your patient’s bank immediately after the refund is processed. Once a payment has been refunded, you’ll see a little banner next to the refund, as well as a Reference Number - this lets you know that the refund has been successfully processed behind the scenes.
From there, it can take anywhere up to ten business days for your patient’s bank to process the refund, and deposit it back into their account.
Verifying Refunds Through a Report
Another area to verify that refunds went through is the
Jane Payments Transactions
...
Only refunds from payment methods made outside of Jane can be reversed. These would be payment methods like Cash, Interac eTransfer or Venmo. If your clinic is using
Jane Payments
then you won’t be able to undo a pending or completed refund.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![Screenshot of a patients Billing Payments](https://jane.app/thumbs/e3bce191-1087-4157-b084-bde8a907ab65)
- ![Screenshot of the Jane Payments Transactions Report](https://jane.app/thumbs/60df906a-f651-4c16-8007-cab07bd443fd)
