...
*Source: [https://jane.app/guide/applying-patient-credit-to-a-specific-invoice](https://jane.app/guide/applying-patient-credit-to-a-specific-invoice)*

*Category: Charting*

*Scraped: 2025-08-07 01:28:56*
...
Feature OverviewApplying Patient Credit to a Specific Invoice
Billing
Applying Patient Credit to a Specific Invoice
2 min read
Balance Plan
Practice Plan
Thrive Plan
For clinics that use multiple payment methods, applying
patient credit
can be tricky if you want to keep payments applied to only certain invoices.
...
If your clinic requires you to be a stickler on which invoices are getting paid from certain payments, Jane allows you to specify this. This is handy for applying a credit to a no show, late cancellation and even a product purchase.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Applying Patient Credit to a Specific Invoice
Billing
Applying Patient Credit to a Specific Invoice
2 min read
Balance Plan
Practice Plan
Thrive PlanFor clinics that use multiple payment methods, applying
patient credit
can be tricky if you want to keep payments applied to only certain invoices.
If you pay for an invoice via Account Credit on the Payment screen, Jane will simply use up the account credit, starting with the oldest payment.
If your clinic requires you to be a stickler on which invoices are getting paid from certain payments, Jane allows you to specify this. This is handy for applying a credit to a no show, late cancellation and even a product purchase.
First, identify the payment that is generating the credit that you want to use up. Head to the patient’s Billing profile, click on the Payments section, and then click the View button for the specific payment that you’re interested in:
Next, use the search bar to locate the invoice that you’re looking for (you can search by a few fields including invoice number, staff name, treatment/product name, or amounts). Or click View All to see all the unpaid invoices for the patient.
Once you have the appropriate invoice(s) up, you can click the Apply button to apply the credit to those invoices. And poof!–your work is done.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/17brjvuho4_blob)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/7d13cfoomb_blob)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/97d1pvzb9m_blob)
