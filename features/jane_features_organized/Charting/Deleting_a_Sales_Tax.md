...
*Source: [https://jane.app/guide/deleting-a-sales-tax](https://jane.app/guide/deleting-a-sales-tax)*

*Category: Charting*

*Scraped: 2025-08-07 02:06:09*
...
Feature OverviewDeleting a Sales Tax
Billing
Deleting a Sales Tax
5 min read
Has there been a recent change to how you should (or should not) be charging tax in your region? Navigating these quick pivots in billing can be tricky but this guide walks through updating this setting step-by-step!
Note📍:
If you’ve already worked through removing the tax, you can head on over to our
Sales Tax: Updating Past Invoices
guide for more details on how you can update those past invoices.
Before a Tax can be deleted, you’ll need to remove the tax from any package, membership, product or treatment that it’s attached to. This process looks a little different for each offering so we’ve broken it down for each!
Removing Tax from Treatments
Removing Tax from Products
Removing Tax from Packages & Memberships
Deleting a Sales Tax
Removing Tax from Treatments
...
and click on
Edit
to the right of a treatment:
Next, you’ll scroll down to the
Details
section and
de-select the tax option
. Make sure to hit the blue
Update Session
button to confirm those changes.
Friendly reminder that this will update all invoices going forward. You’ll want to repeat the above steps for treatments where tax is not required.
Removing Tax from Products
To update the tax attached to a specific product, you’ll want to head over to the
Settings
tab, and click on
Products
within the left sidebar menu. Next, click on
Edit
to the right of the Product:
Pro-Tip 💡:
Jane will display a tax column and list which sales tax is attached to each product
.
Next, you’ll
de-select the tax option
. Make sure to hit the blue
...
button to confirm those changes.
Removing Tax from Packages & Memberships
To update the tax attached to a specific membership or package, you’ll want to head over to the
Settings
tab, and click on
Packages & Memberships
within the left sidebar menu. Next, click on the blue
View
button to the right of the offering you’d like to update:
Pro-Tip 💡:
Jane will display a quick preview for any Packages or Memberships that have a Sales tax attached to them
.
For both packages and memberships, you’ll want to
de-select the tax
:
Make sure to scroll down to the bottom of the page and click the blue
Update Package or Update Membership
button to confirm those changes. Jane will redirect you to another page where you’ll be asked if you’d like to update all sold packages.
NOTE📍:
This will only apply to changes such as the name, quantity, income category, auto selection and/or eligible items. If you need to update the taxes charged, you’ll need to resell the package.
Deleting a Tax
Now that the offerings are updated, you’ll want to head over to the
Settings
tab, click on
Taxes
within the left sidebar menu and then on
Edit
to the right of the tax.
Pro-Tip 💡:
Jane will display a quick preview for offerings that still have a Sales tax attached to them in case there are any that were missed
.
Next, hit the red
Delete Tax
button to confirm the deletion. If the tax is not properly removed from all the offerings, you’ll receive an error message.
Note
📝:
If you need to remove your tax number from invoices in the future, you can head over to your
Staff Profile
and click on
Billing
. Next, click on the
...
icon to delete it.
And you’re all set!
Need to remove a sales tax from just one invoice? We’ve got just the guide -
Disabling Tax on an Individual Purchase
.
As always, if you have any additional questions, feel free to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Deleting a Sales Tax
Billing
Deleting a Sales Tax
5 min readHas there been a recent change to how you should (or should not) be charging tax in your region? Navigating these quick pivots in billing can be tricky but this guide walks through updating this setting step-by-step!
Note📍:
If you’ve already worked through removing the tax, you can head on over to our
Sales Tax: Updating Past Invoices
guide for more details on how you can update those past invoices.
...
As always, if you have any additional questions, feel free to
contact our support team
and we’d be more than happy to help 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of navigational instructions](https://jane.app/thumbs/23df2087-7e47-4ccc-aac8-bec29bb325c3)
- ![screenshot of checkboxes under the tax section of the edit treatment screen](https://jane.app/thumbs/12bacb41-859b-4602-aa3f-ba8724c82a7f)
- ![screenshot of navigational steps and where to view items that have tax added](https://jane.app/thumbs/fc7b2586-7b56-4f82-8ef6-259741813ba4)
- ![screenshot of where to deselect the tax](https://jane.app/thumbs/97b3157b-a18f-40da-b364-fe5107731c04)
- ![](https://jane.app/thumbs/b6a56c46-2d77-446f-ba59-5c0d65b4ec79)
- ![screenshot of where to remove a tax under a membership or package](https://jane.app/thumbs/9372c98b-0b22-4bcb-92bc-5e8603efeeac)
- ![screenshot of the navigational steps](https://jane.app/thumbs/e42fec93-7ae1-4b7f-a11d-e0fed4d3caef)
- ![screenshot of the red delete button](https://jane.app/thumbs/36d0169b-43e7-4ede-84ae-0402b75147a5)
- ![](https://jane.app/thumbs/67813676-8051-40b5-8326-bfe04a9865c3)
