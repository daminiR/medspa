...
*Source: [https://jane.app/guide/customizing-your-chart-footer](https://jane.app/guide/customizing-your-chart-footer)*

*Category: Charting*

*Scraped: 2025-08-07 01:14:50*
...
Feature OverviewCustomizing Your Chart Footer
Charting
Customizing Your Chart Footer
3 min read
Balance Plan
...
Whether you need to meet the requirements of your insurers, membership organization, or college body, Jane has got you covered with our new
Language
settings allowing you to customize the footer of your chart notes. You can now select which information is displayed at the bottom of the chart’s footer.
This will be displayed on every page!
To do this just head over to
Settings > Language
and click on
Customize Footer for PDF Chart Exports
...
Pro Tip:
Key commands can be a speedy way to work when copying and pasting information from one location to another.
If you are using a Mac, hold down the
Command
button and click
‘C’
to copy and
...
Control > ‘V’
to paste.
Once you have added the fields you’d like, you can
print and export a chart
and it will contain the newly added information!
While we cannot guarantee you’ll pass with flying colors, hopefully, this will earn you a few extra points.
If you need any further help getting your chart footer all set up, just
let us know
:)
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Customizing Your Chart Footer
Charting
Customizing Your Chart Footer
3 min read
Balance Plan
Practice Plan
Thrive PlanSo, you were the chosen one this year.
No, not by the Jedi Council, rather the all being College and Board of Regulations, your patient’s insurer, or that Membership Organization you joined to ensure that you stay on top of your game. They’ll be auditing your records, and one of the requirements they are looking for is specifically around your charts.
Do you have the patient name on each page? Is there a phone number listed? Have you listed their third cousin twice removed on their mother’s side’s new surname? Well, that last one might be a bit much, we think we made the point.
Whether you need to meet the requirements of your insurers, membership organization, or college body, Jane has got you covered with our new
Language
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/235d2fce-70ea-4054-bef4-9b215e5845ea)
- ![](https://jane.app/thumbs/4114c21d-ae17-471c-a6f2-7ef72604be45)
