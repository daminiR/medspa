...
*Source: [https://jane.app/guide/creating-a-patient-invoice-without-an-appointment](https://jane.app/guide/creating-a-patient-invoice-without-an-appointment)*

*Category: Charting*

*Scraped: 2025-08-07 02:06:27*
...
Feature OverviewCreating a Patient Invoice without an Appointment
Billing
Creating a Patient Invoice without an Appointment
1 min read
...
Use the pencil button to assign the purchase to a practitioner if appropriate.
Add more products as appropriate then hit Pay!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating a Patient Invoice without an Appointment
Billing
Creating a Patient Invoice without an Appointment
1 min readHead over to the Patient’s Profile using the Patient tab at the top.
Find the patient under whom you’d like to bill a fee code.
Head to their “Billing” Tab and choose the “New Purchase” button at the top right of the screen.
Select the product from the search bar and then hit “Add Product.”
Use the pencil button to assign the purchase to a practitioner if appropriate.
Add more products as appropriate then hit Pay!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2014/06/26/2syu0aj7n6_undefined)
- ![](https://jane.app/system/dragonfly/production/2014/06/26/2maidqk2uh_undefined)
- ![](https://jane.app/system/dragonfly/production/2014/06/26/7wmlw88e0w_undefined)
- ![](https://jane.app/system/dragonfly/production/2014/06/26/58g2ieh2kl_undefined)
