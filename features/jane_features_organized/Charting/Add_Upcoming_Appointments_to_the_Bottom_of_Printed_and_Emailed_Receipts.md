...
*Source: [https://jane.app/guide/add-upcoming-appointments-to-the-bottom-of-printed-and-emailed-receipts](https://jane.app/guide/add-upcoming-appointments-to-the-bottom-of-printed-and-emailed-receipts)*

*Category: Charting*

*Scraped: 2025-08-07 01:27:08*
...
Feature OverviewAdd Upcoming Appointments to the Bottom of Printed and Emailed Receipts
Billing
Add Upcoming Appointments to the Bottom of Printed and Emailed Receipts
2 min read
Balance Plan
Practice Plan
Thrive Plan
To add upcoming appointments to the bottom of a patient’s receipt, you can select the appointment that you’d like to arrive from the schedule, and hit
Arrive
. The appointment will turn green in the schedule.
From there, next to the
Pay
button, there’s a
drop-down arrow
. Give that a click, and select
Print Receipt (Options)
.
This will open a new window with the receipt that you can print or turn into a PDF to email to your patient from the email program on your device.
At the top left of the receipt, ensure that
Upcoming Appointments: On
is enabled.
The setting is device-specific, so all upcoming appointments should now be listed at the bottom of the receipts generated from the device you’re using.
Now you can go ahead and take payment for this appointment and email or print the receipt for this client with upcoming appointments/visits indicated at the bottom!
Bonus Tip: Emailing Just Upcoming Appointments Directly from Jane
Just want to email upcoming appointments directly from Jane?
Head into the
patient’s profile
and click on the
Email
...
area. You can even add a personalized message if you like!
Additional Notes and Resources
If you need to print appointments for a particular patient, you can learn more about sharing
Past
and
Upcoming Appointments
with patients in our
Printing Upcoming or Past Appointments
guide.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Add Upcoming Appointments to the Bottom of Printed and Emailed Receipts
Billing
Add Upcoming Appointments to the Bottom of Printed and Emailed Receipts
2 min read
Balance Plan
Practice Plan
Thrive PlanTo add upcoming appointments to the bottom of a patient’s receipt, you can select the appointment that you’d like to arrive from the schedule, and hit
Arrive
. The appointment will turn green in the schedule.
From there, next to the
Pay
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/e171bc30-bafc-486a-9fff-52aaf781797c)
- ![](https://jane.app/thumbs/9f33ab08-852f-4363-84f5-3897d7f39055)
- ![](https://jane.app/thumbs/524ca0cd-c3f8-45a6-83ca-f6fa223aa626)
- ![](https://jane.app/thumbs/989bb432-0444-4fc0-82fe-85cc666114ad)
