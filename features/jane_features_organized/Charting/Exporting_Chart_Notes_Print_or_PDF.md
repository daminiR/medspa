...
*Source: [https://jane.app/guide/exporting-chart-notes-print-or-pdf](https://jane.app/guide/exporting-chart-notes-print-or-pdf)*

*Category: Charting*

*Scraped: 2025-08-07 01:03:22*
...
Feature OverviewExporting Chart Notes (Print or PDF)
Charting
Exporting Chart Notes (Print or PDF)
7 min read
Balance Plan
...
Occasionally, you may need to export a patient’s chart, SOAP notes, or clinical records — whether for legal requests, referrals to other practitioners, or simply for your records. You have a couple of options, including exporting a patient’s entire chart, selected chart entries, individual entries, specific files, or intake forms.
💡
Jane Tip
: Looking to send a chart entry or treatment by fax? Check out our guide on
Integrated Outbound Fax
.
Exporting multiple chart entries or a patient’s entire Chart
You can choose to export either a patient’s complete chart, specific SOAP notes, or just a portion of their clinical records, depending on what you need.
You can find the export option by finding your patient and heading to their
Chart
.  At the top of the Chart is a
Filter / Export
button:
You can see that at the top of the chart, there are several filters available to you.
You can filter entries by a specific practitioner, discipline, chart status, or date range. So if you’ve been asked for clinical records for a patient from July 15 to October 31 for just one practitioner, you can filter down to the appropriate entries before you export and download the patient’s file.
Once you have the chart entries displayed that you’d like to export, click the button with three dots on the right, then select the
“Print”
or
“PDF”
buttons. If you click Print, you’ll see a preview page where you can choose different template styles by selecting between the Letterhead or Chart Display options. You can then click to print, or you can also create a PDF to download and save the patient’s file.
💡
Jane tip
: If you’d like specific variables displayed on a PDF chart export, such as a patient’s date of birth, you can
customize your chart footer for PDF chart exports
. You can also
add your signature to chart exports
.
Exporting a single chart entry in a patient’s Chart
Sometimes you may need to export a single chart entry for a patient, such as when printing an entry for a patient for an exercise or a
prescription
, or when exporting a
letter
or progress note for a patient.
To export a single chart entry, head to a patient’s
Chart
, click the down arrow button at the top right corner of the entry, click the
Print
option, and the chart entry will open in a new page where you can print or create a PDF.
💡
Jane tip
: You can also export
Treatment Plans
from a patient’s Chart by clicking
Actions
and then
Export/Print
.
Exporting a patient’s file from the Files tab
At times, you may need to download a patient file that hasn’t been included in the patient’s Chart. You can download a patient file by opening the patient’s
Profile
and then clicking on the
Files
tab.
Find the file that you wish to export, hover over the bottom of the preview tile, and then click the
down-arrow button
to download the file. Once the file has been downloaded, you can then manage the file as needed, by saving it as a PDF or printing it.
Exporting a single patient’s Intake Form
To export the completed Intake Form of a specific patient, you can head to the patient’s
Profile
and scroll down on the right-hand side to the
Online Intake Forms
section. If you click the button with the 3 dots next to the Intake Form, you’ll be able to
Print
the form, or save it as a PDF:
Batch Export of all Charts (per staff practitioner)
If you’re looking to export all chart records for a particular staff member, or chart records present in the clinic in their entirety (i.e. as a batch), an Account Owner can request this by emailing support@janeapp.com. Note that these exports are provided per staff member, so if there are multiple staff members that you need to export chart histories for, please provide the Jane Support team with their names.
Batch chart exports are available
one time free of charge
at the termination of your subscription, or as needed for individual practitioners who are leaving your practice but are required to take their chart notes with them.
...
We also have a guide you can look over to give you more information regarding this,
Batch Chart Export for Practitioners
.
💡
Jane tip
:  If you’re moving clinics, you can copy charting data to another Jane account with a
Jane to Jane Data Transfer
.
Batch Export of all Intake Forms
Similarly, at an Account Owner’s request, we can provide a
one-time export
of all Intake Forms present within a Jane account. Please note that this will export
all
intake forms for all patients, and not only a subset of intake forms (i.e. for only patients associated with a particular practitioner or with a particular discipline).
See our
Batch Chart Export for Practitioners
guide page for more info.
Additional resources
If you’re looking for more information about exporting charts and patient files in Jane, these pages may also be helpful:
Integrated Outbound Fax
Printing or Sharing Chart Entries & Treatment Plans
Sharing Patient Charts with a Third Party
Files Area in a Chart
Batch Chart Export for Practitioners
Jane to Jane Chart Transfers (Data Transfers)
We hope you find what you’re looking for in the guides above! If you have questions, or if you want to chat through workflows in Jane, please don’t hesitate to
get in touch
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Exporting Chart Notes (Print or PDF)
Charting
Exporting Chart Notes (Print or PDF)
7 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansExporting a single patient’s Chart or Clinical Record
Occasionally, you may need to export a patient’s chart, SOAP notes, or clinical records — whether for legal requests, referrals to other practitioners, or simply for your records. You have a couple of options, including exporting a patient’s entire chart, selected chart entries, individual entries, specific files, or intake forms.
💡
Jane Tip
: Looking to send a chart entry or treatment by fax? Check out our guide on
...
We hope you find what you’re looking for in the guides above! If you have questions, or if you want to chat through workflows in Jane, please don’t hesitate to
get in touch
, we’re always happy to hear from you. 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![a patient's Chart with the filter and export buttons](https://jane.app/thumbs/65e41248-f235-421b-8a17-42e14748194d)
- ![screenshot of a patient's chart export with template style choices and the PDF and Print buttons](https://jane.app/thumbs/a7c83f6e-182c-410c-ac74-f727d761da2c)
- ![exporting a single chart entry in a patient's Chart with the Print button](https://jane.app/thumbs/449f6208-69a6-4154-884d-6b6535eed390)
- ![a patient's Files tab showing the option to download a file](https://jane.app/thumbs/f0203aea-0390-4bf9-a7b7-ad4cdfa76857)
- ![the print option in the Online Intake Forms section of a patient's Profile](https://jane.app/thumbs/9508801d-2ca6-4941-b692-14e49e324e35)
