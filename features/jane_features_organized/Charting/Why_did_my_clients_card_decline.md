...
*Source: [https://jane.app/guide/why-did-my-client-s-card-decline](https://jane.app/guide/why-did-my-client-s-card-decline)*

*Category: Charting*

*Scraped: 2025-08-07 02:07:19*
...
Feature OverviewWhy did my client's card decline?
Billing
Why did my client's card decline?
2 min read
...
:
HSA/FSA Cards
As always, if you have any questions please don’t hesitate to reach out to our team! 😊 Our email address is support@jane.app and we can be reached by phone at 1-844-310-5263.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Why did my client's card decline?
Billing
Why did my client's card decline?
2 min readWhen you’re taking a payment using Jane Payments, we sent a request to your client’s credit card issuer, who lets us know if it’s “Approved!” or “Declined.” Whenever a credit card is declined, we often jump to conclusions and assume it’s due to insufficient funds (but that’s not usually the case!). Jane tries to give you as much information as possible why a transaction is declined, but oftentimes, we don’t receive a lot of information into the “why” from your client’s credit card provider, as the card provider is the one who approves or declines a transaction.
If your client has ensured that their credit card is valid and should work, it would be best to have them call their credit card issuing bank or provider to ensure they’re not blocking or preventing the payment, and to make sure their billing address is up to date. We wish we could call them on your behalf, but they only like to speak to the person who has a credit card with them.
More information on
Declined Cards
:
HSA/FSA Cards
As always, if you have any questions please don’t hesitate to reach out to our team! 😊 Our email address is support@jane.app and we can be reached by phone at 1-844-310-5263.Subscribe to our monthly newsletter.Jane Software Inc.
