...
*Source: [https://jane.app/guide/deleting-or-reversing-a-refund-recorded-in-error](https://jane.app/guide/deleting-or-reversing-a-refund-recorded-in-error)*

*Category: Charting*

*Scraped: 2025-08-07 02:03:24*
...
Feature OverviewDeleting or Reversing a Refund Recorded in Error
Billing
Deleting or Reversing a Refund Recorded in Error
2 min read
Balance Plan
...
, click on the
Billing
tab with their profile and then on
Payments
.
Next, you’ll want to click on the word
View
to the far right of the refunded payment. Friendly reminder that the payment will have a small orange
Refund
tag on it.
From there, you’ll click on the
Trashcan
icon and you’re all set!
After deleting the refund, the original payment will appear as a credit on the client’s account.
Check out these guide docs for additional steps on how to manage this new-found credit:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Deleting or Reversing a Refund Recorded in Error
Billing
Deleting or Reversing a Refund Recorded in Error
2 min read
Balance Plan
Practice Plan
Thrive PlanAccidentally refunded a payment? Don’t fret! This guide will walk you through how to get that refund deleted so it can hang out as a credit or be deleted.
Note
📍:
Only refunds from payment methods made outside of Jane can be reversed. These would be payment methods like Cash, Interac eTransfer or Venmo. If your clinic is using
Jane Payments
...
Check out these guide docs for additional steps on how to manage this new-found credit:
Deleting a Patient Payment(Taken or Applied in Error
Applying a Patient Credit to a Specific InvoiceSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b261579a-3902-4953-8994-e92a41ac9500)
- ![](https://jane.app/thumbs/68e349ee-0ef8-4fa5-9d04-a5492b15222b)
- ![](https://jane.app/thumbs/47c0ed34-2959-4fd9-b837-1703f69ef4ca)
