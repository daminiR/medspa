...
*Source: [https://jane.app/guide/an-insurance-company-has-sent-me-a-credit-card-to-process-for-reimbursement-what-should-i-do](https://jane.app/guide/an-insurance-company-has-sent-me-a-credit-card-to-process-for-reimbursement-what-should-i-do)*

*Category: Charting*

*Scraped: 2025-08-07 01:46:28*
...
Feature OverviewAn insurance company has sent me a credit card to process for reimbursement, what should I do?
Billing
An insurance company has sent me a credit card to process for reimbursement, what should I do?
5 min read
Practice Plan
...
How can I process insurer credit cards in Jane?
You can process insurer credit cards through Jane if you’re using
Jane Payments for online payments
.
If you aren’t using Jane Payments to seamlessly process credit cards right in your Jane account, then you can head into the
Settings > Jane Payments
area of your account to sign up. Signing up only takes a few minutes, and you’ll be able to process your insurer credit cards right away! To learn more about Jane Payments, click
here
.
Note
:
You can only process insurer credit cards through online Jane Payments. This means you’ll need to enter in the credit card information directly into Jane instead of on your Jane Payments Terminal.
...
area. Select the
Insurance Company
that has sent you a credit card, and click the
New Payment
button.
In the New Payment screen, change the
Payment Method
and select the
Jane Payments
option. If you don’t see a Jane Payments Payment Method, this probably means you’ll need to sign up for a Jane Payments account which can be done in
Settings > Jane Payments
.
Once you’ve selected the Jane Payments Payment Method, you’ll see an area below where you can enter the credit card details. Simply enter the
credit card number
,
expiration date
,
...
, and the
amount
the insurer has loaded on the card. Once you’ve entered that information, click
Next
to process the transaction, as well as record the insurer payment in Jane.
...
As always, if you have any questions on processing insurer credit cards in Jane, then use the Need Help? tab in your Jane account or email us directly at
support@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)An insurance company has sent me a credit card to process for reimbursement, what should I do?
Billing
An insurance company has sent me a credit card to process for reimbursement, what should I do?
5 min read
Practice Plan
Thrive PlanInstead of sending a check or EFT, an insurance company has sent you a credit card to process. If you haven’t received a credit card from an insurer before, or if you don’t know how to manage insurer credit cards in Jane, then this guide should help clear things up.
What is an insurer credit card?
What should I do if I receive a credit card payment from an insurer?
How can I process insurer credit cards in Jane?
Does Jane save insurer credit card information for future use?
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/53a084d1-0d0a-4d2f-858d-8bc200e1542d)
- ![](https://jane.app/thumbs/00dc9a3a-3aeb-4081-bf47-dad4fd66fe81)
- ![](https://jane.app/thumbs/c4ae7a7e-0bf3-497c-abd5-92eed7d593fc)
