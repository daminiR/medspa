...
*Source: [https://jane.app/guide/collecting-payment-for-a-no-show-or-late-cancellation](https://jane.app/guide/collecting-payment-for-a-no-show-or-late-cancellation)*

*Category: Charting*

*Scraped: 2025-08-07 02:09:32*
...
Feature OverviewCollecting Payment for a No Show or Late Cancellation
Billing
Collecting Payment for a No Show or Late Cancellation
4 min read
When an appointment is marked as No Show or Late Cancellation, Jane will generate an invoice automatically. This guide walks through how you can collect payments administratively for those invoices as well as how patients can pay for their balances online.
Note
📝: If you would like for patients to be able to pay for any outstanding balances in the
My Account Patient Portal
, you’re clinic will need to be signed up for
Jane Payments
.
Administrative Payments for No Show Appointments
Since these appointments still hang out on the
Schedule
, you can click on the appointment itself and then on the
Pay
button within the
Appointment Panel
on the right.
From there, you can follow your regular workflow of collecting payments. Unsure of how collecting payments works in Jane? Check out our Jane University
Chapter 3: Payments
guide doc for more detailed steps.
Administrative Payments for Late Cancellations
These can be a bit tricky since the appointment seems to vanish from the schedule 💨. For these appointments, you’ll want to head over to the
Patient’s Profile.
You’ll see the outstanding balance right at the top of the page, along with an overview of the patient’s billing and appointment history.
You can click on the
Private Outstanding Balance
option to proceed to the initial
Receive Payment
screen to begin recording the payment.
Alternatively, you can click on the
Billing
tab and click on the
dropdown arrow
to the right of the cancellation invoice. Next, select
Receive Patient Payment
from the menu options.
If you’ve accidentally clicked on the word
View
you can also hit the blue
Pay
button here:
Paying Balances Online
Regardless of whether the invoice was a No Show or a Late Cancellation, patients will be able to see that balance within their
My Account
area after they click on
Pay Balance
on the left.
On the clinic side of things, you can give them a gentle reminder of the missed appointment and their balance through a
Pay Balance
email.
To view and send this notification, you’ll want to head over to their
Patient Profile
within the
Billing Notices
widget, you can send an Email or an SMS reminder.
Note
📝: SMS notifications are currently only available on Legacy, Practice or Thrive Plans. For more details on each of the different subscriptions we offer, check out our
Pricing Page
.
For more information about online balances and late cancellations in Jane, check out our
Paying Balances Online
guide doc for more details.
Additional Resources:
Here are some other related guides that may come in handy!
Cancellation Policy
Late Cancellations
Billing No Shows to Insurers
No Show and Late Cancellation Fees
Cancel or Remove and Appointment from the Schedule
As always, if you have any additional questions or concerns, please
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Collecting Payment for a No Show or Late Cancellation
Billing
Collecting Payment for a No Show or Late Cancellation
4 min readWhen an appointment is marked as No Show or Late Cancellation, Jane will generate an invoice automatically. This guide walks through how you can collect payments administratively for those invoices as well as how patients can pay for their balances online.
Note
📝: If you would like for patients to be able to pay for any outstanding balances in the
My Account Patient Portal
, you’re clinic will need to be signed up for
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of a no show on the schedule and where to find the Pay button on the administrative side of the Jane account](https://jane.app/thumbs/afc50bba-c988-4101-bdb8-62f10df896d1)
- ![An image of where to view the private outstanding balance at the top of a patient's profile area](https://jane.app/thumbs/a12ee13d-231c-419a-9084-687f07cee406)
- ![An image of the outlined navigational steps](https://jane.app/thumbs/94993388-d835-48f3-a5f6-06006dddac52)
- ![An image of where to find the blue Pay button](https://jane.app/thumbs/5f6c3bae-0f91-4a66-98bd-d347c52d4eba)
- ![An image of the My Account Patient Portal and where patients can pay their balances online](https://jane.app/thumbs/d7596bf2-b4de-40ee-9cea-00d4072dd87b)
- ![An image of the Billing Notices area within a patient's profile](https://jane.app/thumbs/30eae204-fc36-4312-a744-63a8e0acc6d1)
