...
*Source: [https://jane.app/guide/the-chart-entry-is-complete-why-isn-t-the-lock-showing](https://jane.app/guide/the-chart-entry-is-complete-why-isn-t-the-lock-showing)*

*Category: Charting*

*Scraped: 2025-08-07 01:18:57*
...
Feature OverviewThe chart entry is complete, so why isn't the lock showing?
Charting
The chart entry is complete, so why isn't the lock showing?
1 min read
...
You will want to start on the
Patient
tab > select the patient >
Chart
> from the dropdown on the chart
Add Appointment
You will be able to filter to show past appointments and add it to the chart.
Once the appointment has been added to the Chart entry, you will see a little calendar on it and the lock will then appear on the appointment in the Schedule or Day view.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)The chart entry is complete, so why isn't the lock showing?
Charting
The chart entry is complete, so why isn't the lock showing?
1 min readLooking for the little calendar icon on your chart?  Could have sworn you made an entry for that day but there is no lock on the Appointment?  Sounds like the appointment isn’t attached to the chart.  Let’s walk through the steps for adding that.
You will want to start on the
Patient
tab > select the patient >
Chart
...
Add Appointment
You will be able to filter to show past appointments and add it to the chart.
Once the appointment has been added to the Chart entry, you will see a little calendar on it and the lock will then appear on the appointment in the Schedule or Day view.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/6ba2d15e-6276-4d43-b4fa-55430de6534a)
- ![](https://jane.app/thumbs/8f8600c9-d811-4ca6-9081-4dea1b888cc3)
