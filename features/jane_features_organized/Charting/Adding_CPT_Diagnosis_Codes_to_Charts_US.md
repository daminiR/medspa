...
*Source: [https://jane.app/guide/adding-cpt-diagnosis-codes-to-charts-on-the-u-s-insurance-plan](https://jane.app/guide/adding-cpt-diagnosis-codes-to-charts-on-the-u-s-insurance-plan)*

*Category: Charting*

*Scraped: 2025-08-07 01:04:42*
...
Feature OverviewAdding CPT & Diagnosis Codes to Charts (US)
Charting
Adding CPT & Diagnosis Codes to Charts (US)
9 min read
Balance Plan
...
That’s why we’ve built a feature for our US clinics that allows you to add CPT and Diagnosis codes to your Chart Entries and to your appointments at the same time!
Let’s take a look. 👀
...
✍️
Adding codes to signed Chart Entries
💸
...
In any
Note field
of a client’s Chart Entry, you can
type the ‘#’ key
followed by a
Diagnosis or CPT code
. You can type the code itself (ex. M54.5) or words you know are associated with it (ex. low back pain). As you begin to type, Jane will open a
drop-down menu of available codes
. Any of your
starred codes
...
The code is now part of the Chart Entry and will appear in text when you export it.
The code will be added to the
Edit Billing Codes
area at the bottom of the Chart Entry.
🚀 Selecting and sending codes to the appointment
Once you’ve added all your CPT and Diagnosis codes to the chart, you can head down to the bottom of the entry and click the blue
Edit Billing Codes
text.
When this opens up, you can:
#1: Arrange
your CPT and Diagnosis codes in the order you’d like to bill them by
grabbing and dragging
the grey symbol beside each code.
#2: Select
the codes you’d like to send to the appointment to be billed by using the
Select All
checkbox at the top or the
checkboxes
next to each individual code.
#3:
Adjust the
number of units
of each CPT code you’ll be billing as needed.
#4:
Click
Update Billing
to send your selected codes to the appointment!
Jane will add a
green checkmark
✅ next to any codes that are attached to the appointment, and you can double-check them by clicking the
Manage Insurance Info
button. This will open up the
Appointment Panel
, where you can add modifiers, any billing codes that you don’t need to have in your Chart Entry, and the client’s primary or secondary policies.
...
If you’re okay with that, you can ignore it. If you’d like to add it to your chart, you can pop back up to any appropriate Note field and use the
# key
to type the missing code(s) in.
📍
Important
: if you click
Update Billing
in the
Edit Billing Codes
section of the chart, any codes on the appointment that aren’t in your Chart Entry will be removed and replaced with the selected codes from your chart.
Step 2: Beyond the Basics
Adding codes to signed Chart Entries
Even after a Chart Entry has been signed, you can adjust the CPT and Diagnosis codes from the
Edit Billing Codes
area. If you need to
add any additional codes
, though, you’ll need to use the
Amend
button at the bottom of the entry.
Note
📝:
Make sure that the appointment is connected to the chart entry. If you’re unsure how to do this, take a peek at our
Appointment Charting Status
guide for more details.
This will allow you to add a new Note field to the signed entry, and you can use the
#
to add any missing codes in that field. You can then sign your Amendment, and head down to the Edit Billing Codes area if you want to select the new code(s) and Update your Billing for the appointment.
💸 Editing codes on paid visits
If you want to adjust the CPT or Diagnosis codes on an appointment that has been
paid
for, you can do this in the
Edit Billing Settings
section of the Chart Entry by toggling on
Allow Editing.
Keep in mind, you’ll be editing an invoice that has already been paid. For more on that, you can
...
📌 Pin your Billing Codes
If you want to use the same codes for a client that you used at their last visit, but don’t want to duplicate the entire Chart Entry, you can find the Note field with those codes and use the
Pin
to keep those at the top of the chart.
Once you have your billing codes Pinned, you can click the
‘+’ sign
on that card at the top of the chart to create a new Chart Entry that will have those codes ready to go.
When that opens up, you can hover your mouse over the Note field, click on the
3 dots
on the righthand side, and then use the
‘+’ button
to add in your usual Chart Template or additional Chart Items.
...
and over to your
Chart Templates,
you can either Edit an existing template or Create a new one.
...
If you’re someone who has more generic Chart Templates (ex. Initial Assessment and Follow Up), you can create
small Chart Templates with specific code sets
that you bill together most often. Then, while you’re charting, you can add one of those Templates to your Chart Entry based on your work with that client.
If you don’t usually add to your Chart Templates, this guide offers a tip on
Charting with Modules.
That’s all, folks! If you’d like any help at all getting set up or adjusting your workflow to take advantage of this feature, please don’t hesitate to
reach out
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adding CPT & Diagnosis Codes to Charts (US)
Charting
Adding CPT & Diagnosis Codes to Charts (US)
9 min read
Balance Plan
Practice Plan
Thrive PlanJane’s goal is always to be helpful, and when it comes to documentation and insurance billing, that means being thorough, compliant, and efficient.
That’s why we’ve built a feature for our US clinics that allows you to add CPT and Diagnosis codes to your Chart Entries and to your appointments at the same time!
Let’s take a look. 👀
Follow along with Alex in the video below, or scroll down to read step-by-step instructions.
Step 1: The Basics
...
That’s all, folks! If you’d like any help at all getting set up or adjusting your workflow to take advantage of this feature, please don’t hesitate to
reach out
! We love chatting with you. 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/4e0c18f1-ea0b-48ca-9003-232b5b769456)
- ![](https://jane.app/thumbs/bc41058a-10ff-45ac-a129-fa56fb0b1783)
- ![](https://jane.app/thumbs/d356488a-fb61-43de-a8dc-7ce0bd8a1cb4)
- ![](https://jane.app/thumbs/61ca82e3-95d5-4eaa-b817-3d5f5060cae6)
- ![](https://jane.app/thumbs/03ba72b4-a08d-422c-bfce-c59cb68a58a1)
- ![](https://jane.app/thumbs/593eb05d-de4a-4bc8-b810-86966d655e70)
- ![](https://jane.app/thumbs/9de21aa0-23bf-448a-9f00-39230ade2927)
- ![](https://jane.app/thumbs/c5ede888-afe1-42e7-a44a-7263c27742bd)
- ![](https://jane.app/thumbs/abca458c-073e-4f8c-9fe0-dcb5dc080f20)
- ![](https://jane.app/thumbs/c68e92e8-8398-4ce2-8392-f288e4d76e2a)
- ![](https://jane.app/thumbs/2eaaa36a-25d8-433a-a573-b3c797e5af4d)
- ![](https://jane.app/thumbs/c46ee611-9a4c-4760-89ea-a7e377673493)
- ![](https://jane.app/thumbs/93a8a166-4e8e-4d4e-836b-c8d0f19166e0)
