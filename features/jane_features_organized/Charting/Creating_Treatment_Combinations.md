...
*Source: [https://jane.app/guide/creating-treatment-combinations](https://jane.app/guide/creating-treatment-combinations)*

*Category: Charting*

*Scraped: 2025-08-07 02:02:17*
...
Feature OverviewCreating Treatment Combinations
Billing
Creating Treatment Combinations
3 min read
Balance Plan
...
In this guide, we’ll go over how to set up some common examples of treatment combinations — but if you’re just getting started, our guide on
Setting Up Treatments
will be your go-to resource for creating your initial offerings.
Feel free to jump to a specific section below: 👇
Combining Services
Combining Treatment Areas
For each of the scenarios, we’ll get started by heading to
Settings > Treatments, Classes & Group Appointments > New Treatment.
...
💡
Tip: If you’d like to organize your offerings, head to our
Disciplines
Guide. In our example below, we have created a Discipline for “Facial Treatments”.
Start by filling in the required fields and setting your pricing. If your treatment price varies (based on the number of units required, for example), our
Medical Aesthetics Hub
has got you covered with our recommended billing workflows.
💡
One more tip: if you’re pairing different modalities together, you may need to update or add to your clinic’s
Resources
. If you want a second set of eyes on this, feel free to
...
Fill out the required fields and set your pricing. Again, if your pricing varies, head to our
Medical Aesthetics Hub
to walk through our recommended billing workflows.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating Treatment Combinations
Billing
Creating Treatment Combinations
3 min read
Balance Plan
Practice Plan
Thrive PlanWe’ve noticed that our Aesthetic Clinics like to get creative when it comes to making unique combinations of treatments. This comes up when a clinic is looking to:
Combine modalities or resources
Perform multiple treatments within a single appointment
Combine areas that are being treated
In this guide, we’ll go over how to set up some common examples of treatment combinations — but if you’re just getting started, our guide on
...
Medical Aesthetics Hub
to walk through our recommended billing workflows.
And there you have it! We’ve successfully set up treatment combinations.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/a1ee9f82-3163-417b-bc06-d5ee07430e89)
- ![](https://jane.app/thumbs/52523baf-5022-435f-9f5c-9693bb5dd1f4)
- ![](https://jane.app/thumbs/45458180-6402-48bb-9cdf-875e19b99135)
