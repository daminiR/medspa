...
*Source: [https://jane.app/guide/sign-and-lock-workflow](https://jane.app/guide/sign-and-lock-workflow)*

*Category: Charting*

*Scraped: 2025-08-07 01:12:07*
...
Feature OverviewDay View: Sign and Lock Workflow
Charting
Day View: Sign and Lock Workflow
3 min read
Balance Plan
Practice Plan
Thrive Plan
The Day View helps you stay on top of documenting your appointments. You can keep tabs on your schedule and easily see which appointments have session notes or treatment notes attached. The lock and unlock icons only show up in this view, so you can quickly see your charting progress. Administrative staff won’t see these chart indicators as this view is just for practitioners to track their own appointments and charting status.
Let’s dive in 🤿
...
Again, a reminder that you need to be charting from the “Day” view for Jane to assign a chart entry to that visit and the lock icon is only visible on the Day view.
To learn more about how you can search for unlocked “draft” charts or appointments without chart entries see this help document on
reviewing chart status
.
If you click the appointment in your Day view a second time, the right hand Appointment panel will also pop up which will allow you to manage your billing and complete other appointment-related actions.
Hot Tip 🔥
: Streamline your charting even further with
AI Scribe
! Draft your notes with AI-powered assistance before signing and locking, saving time while keeping your documentation thorough and compliant.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Day View: Sign and Lock Workflow
Charting
Day View: Sign and Lock Workflow
3 min read
Balance Plan
Practice Plan
Thrive PlanThe Day View helps you stay on top of documenting your appointments. You can keep tabs on your schedule and easily see which appointments have session notes or treatment notes attached. The lock and unlock icons only show up in this view, so you can quickly see your charting progress. Administrative staff won’t see these chart indicators as this view is just for practitioners to track their own appointments and charting status.
Let’s dive in 🤿
For the lock icon to show up the treatment has to be connected to the chart entry.  Which means it needs to be selected on the schedule (so the “check” needs to be displayed on the appropriate appointment)
This can be from the main schedule or from the Day view, but the lock icon will only show up on appointments in the Day view.
The best place for you to chart from is your “Day” view that shows up in the very top left of your screen. You’ll get a sort of one day “daysheet” view that gives you single click access to your patient charts.
...
: Streamline your charting even further with
AI Scribe
! Draft your notes with AI-powered assistance before signing and locking, saving time while keeping your documentation thorough and compliant.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/11/09/1ax7cnxewe_blob)
- ![](https://jane.app/system/dragonfly/production/2016/11/09/3e2f1fwo4y_blob)
- ![](https://jane.app/system/dragonfly/production/2016/11/09/4qar022h46_blob)
...
- ![screenshot of Day view](https://jane.app/thumbs/1dfd5354-84fc-453c-972b-cc4db376e646)
