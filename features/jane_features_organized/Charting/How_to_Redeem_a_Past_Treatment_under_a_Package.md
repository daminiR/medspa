...
*Source: [https://jane.app/guide/how-to-redeem-a-past-treatment-under-a-package](https://jane.app/guide/how-to-redeem-a-past-treatment-under-a-package)*

*Category: Charting*

*Scraped: 2025-08-07 02:02:49*
...
Feature OverviewHow to Redeem a Past Treatment under a Package
Billing
How to Redeem a Past Treatment under a Package
3 min read
Thrive Plan
...
Before walking through these steps, you’ll want to ensure that the package is paid in full and the treatment you’re trying to redeem the package for is an eligible treatment under the package’s settings. Check out our guide docs on
Selling, Redeeming and Refunding a Package
and
Setting up a Package
for a refresher on the first steps of this process.
Let’s dive in 🤿
If there are payments attached to the appointment, you’ll want to make sure that they’re unapplied first. Our guide doc on
Unapplying a Payment
has more details on the process.
With payments unapplied, you’ll want to head over to the
Schedule
, select the appointment and then scroll down to the
Billing Info
section of the
Appointment Panel
. From there, you can select the package and you’re all set!
Another option is to do this through the
Patient’s Profile
and under the
Billing
tab. You’ll want to click on the word
View
to the right of the appointment invoice.
Next, scroll down to the
Packages & Memberships
section and you’ll be able to select the package to redeem.
If you have any additional questions about Packages, check out these other guides that are jam-packed with information:
Setting up a Package
Packages FAQ
Package and Membership Reports
Working with Package and Membership Receipts
Understanding Package Compensation
As always, we’re here for you if you have any additional questions about packages 💙
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Redeem a Past Treatment under a Package
Billing
How to Redeem a Past Treatment under a Package
3 min read
Thrive PlanSometimes a patient may decide to purchase a package in the middle of a series of appointments. Wondering how you can apply that package to their past appointments? Don’t worry, we’ve got you covered!
Before walking through these steps, you’ll want to ensure that the package is paid in full and the treatment you’re trying to redeem the package for is an eligible treatment under the package’s settings. Check out our guide docs on
Selling, Redeeming and Refunding a Package
and
Setting up a Package
...
Working with Package and Membership Receipts
Understanding Package Compensation
As always, we’re here for you if you have any additional questions about packages 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![click on the appointment and a panel will open up on the right side of the screen](https://jane.app/thumbs/4880a5dc-4661-4c55-98d9-169f25bafa50)
- ![in the profile, you'll be brought to the billing area. The invoices are listed in reverse chronological order and the view button is on the far right of the screen](https://jane.app/thumbs/f1cd7b9e-a99e-4276-b1a3-57990bb55391)
- ![scroll down on the purchase screen to the Packages and Memberships section. Click in the circle to redeem the package](https://jane.app/thumbs/e7fdd3a0-037c-495c-a365-312f5e89c06a)
