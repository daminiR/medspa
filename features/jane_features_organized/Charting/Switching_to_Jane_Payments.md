...
*Source: [https://jane.app/guide/switching-payment-processors](https://jane.app/guide/switching-payment-processors)*

*Category: Charting*

*Scraped: 2025-08-07 02:14:46*
...
Feature OverviewSwitching to Jane Payments
Jane Payments
Switching to Jane Payments
3 min read
Balance Plan
Practice Plan
Thrive Plan
So you are ready to make the switch to our integrated payment solution, Jane Payments! 💳
This quick and easy process will only take 5 minutes before you are ready to start taking payments! 💰
To get started making the switch to Jane Payments, you’ll want to take the following steps:
1️⃣
Step 1: Sign up for Jane Payments
First, you’ll need to set up Jane Payments. To do this, full-access users can start by heading to
Settings > Jane Payments
. If you’re ready to go, click the blue
“I’m in, let’s do this”
button and follow the on-screen prompts and questions.
2️⃣
Step 2: Order your Jane Payments Terminal
Note:  It’s entirely your choice whether you’d like to utilize the terminal or prefer to use online payments exclusively.
Stay in the
Settings > Jane Payments
area of your Jane account and click the
+ Add Item
button and select
Order Terminal
from the dropdown menu.
Once ordered, your terminal should arrive within 2-5 business days.
3️⃣
Step 3: Taking payments online and via the terminal
Keep in mind that any credit card information saved on your current processor will not be able to be transferred to Jane Payments. However, Jane Payments features make it easy to regather that information:
Online Booking Policies
Collect Credit Cards on Intake Forms
Paying Balances Online
4️⃣ Step 4: To reconcile your payments, the following guides will come in handy
(optional)
Jane Payments Transactions, Payouts, and Monthly Processing Reports
Accounts Receivable Report
5️⃣ Step 5: Be sure to cancel your other payment processor to avoid any monthly fees!
🎉 Bonus: Features we’ve built that are unique to Jane Payments
Packages & Memberships
Online Gift Cards
We hope this makes switching to Jane Payments a smooth experience. If you have any questions, don’t hesitate to get in touch at
payments@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Switching to Jane Payments
Jane Payments
Switching to Jane Payments
3 min read
Balance Plan
Practice Plan
Thrive PlanSo you are ready to make the switch to our integrated payment solution, Jane Payments! 💳
This quick and easy process will only take 5 minutes before you are ready to start taking payments! 💰
To get started making the switch to Jane Payments, you’ll want to take the following steps:
1️⃣
Step 1: Sign up for Jane Payments
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b5c9437f-c291-49a8-8b0b-7b227c3cc1ac)
- ![](https://jane.app/thumbs/3233dac1-93d5-4dd7-8fce-97237342a2fa)
