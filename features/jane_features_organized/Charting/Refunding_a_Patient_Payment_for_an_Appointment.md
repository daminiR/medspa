...
*Source: [https://jane.app/guide/refunding-a-patient-payment](https://jane.app/guide/refunding-a-patient-payment)*

*Category: Charting*

*Scraped: 2025-08-07 01:51:56*
...
Feature OverviewRefunding a Patient Payment for an Appointment
Billing
Refunding a Patient Payment for an Appointment
4 min read
Balance Plan
Practice Plan
Thrive Plan
This guide walks through how to issue a refund or reimbursement for a patient payment applied to an appointment or service invoice for payments processed through
Jane Payments
!
Note📝
:
If you’re looking to correct a payment that you collected
outside of Jane
, check out this document on
Deleting a Payment
. If you are looking to return a product or inventory item see
Refunding a Product
.
To refund a patient for a specific treatment, you’ll want to hop into the
Patient Profile
and head into their
Billing
tab. Now you can go to their
Payments
, find the payment line you want to reimburse, and click
View.
...
, the
Remove
button. This will create a Credit on their account.
Once the payment has been unapplied, a button will appear in the top-left of the screen, allowing you to
Refund
the credit. If you decide not to issue a refund, this credit can then be used for a future purchase.
You can Refund back to the original payment method, or choose a different payment method to record the refund.
📍
Note: There are no additional transaction fees for processing a refund through Jane Payments; however, the original transaction fee will not be refunded.
🇨🇦
Refunding an Interac Payment
If a client paid using an Interac debit card, their refund can only be processed through your Jane Payments Terminal. Unlike credit card refunds, Interac refunds require the client to be physically present with the same card they used for the original payment.
...
Once a refund has been issued, it cannot be reversed. In that case, a new payment would need to be initiated. The funds will be returned right away but may take
5-10 business days
to reflect on the patient’s bank statement.
Note📝
:
If you need to refund only part of a payment, see this guide on
Partially Refunding a Product
Additional Notes
...
, click on
Billing
and by default, Jane will land on
Purchases
. Next, click on
View
to the right of the invoice.
From there, you’ll toggle off
This purchase is taxable
, and Jane will automatically create a credit for the taxed amount.
Now you can refund the tax by heading over to
Payments
, and clicking on
View
...
Lastly, click on the
Refund
button to the left and select the original payment method.
Need to issue a receipt for a refund? No problem!
Here are the steps to follow
.
We hope this has been helpful to you but as always you can
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Refunding a Patient Payment for an Appointment
Billing
Refunding a Patient Payment for an Appointment
4 min read
Balance Plan
Practice Plan
Thrive PlanThis guide walks through how to issue a refund or reimbursement for a patient payment applied to an appointment or service invoice for payments processed through
Jane Payments
!
Note📝
:
...
We hope this has been helpful to you but as always you can
contact our support team
for any additional questions or concerns 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![](https://jane.app/thumbs/d56b5999-e0cf-4a9d-830a-3a2402de1068)
- ![](https://jane.app/thumbs/f6adf051-965a-44c5-83f8-adeb0b6df9de)
- ![](https://jane.app/thumbs/982cda49-1584-4627-8eb5-4d746ddaff96)
- ![an image of where where to find the navigational steps](https://jane.app/thumbs/9629b8b7-6132-41d2-a7e0-a9cf75554fdd)
- ![An image of where to view and click on the toggle to remove the tax](https://jane.app/thumbs/a948afbc-d959-4ed0-842b-8e4995573d5a)
- ![An image of the navigational steps](https://jane.app/thumbs/267ca88a-1446-4921-bd88-e572a7558fdc)
- ![an image of here to view and click on the refund button to issue a refund for the sales tax](https://jane.app/thumbs/a730d27a-3640-47d8-8969-cf6cac1d1a23)
