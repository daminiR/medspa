...
*Source: [https://jane.app/guide/jane-payments-terminal](https://jane.app/guide/jane-payments-terminal)*

*Category: Charting*

*Scraped: 2025-08-07 02:13:52*
...
Feature OverviewJane Payments Terminal
Jane Payments
Jane Payments Terminal
3 min read
Balance Plan
Practice Plan
Thrive Plan
If you find yourselves processing lots of debit payments and need a terminal to do so, we’ve got you covered!
📍 With the
Jane Payments Terminal
, you can link to each of your practitioner’s bank accounts to send them their payments directly. 💸 Yep, you heard that right, no need for multiple terminals.
📍 You’ll have the option to save a credit card on file when a client taps, swipes, or inserts their card into the Jane Payments Terminal. This is an easy way to save payment information, which can help prevent no-shows.
📍 All reporting for payments processed through Jane Online Payments and the Jane Payments Terminal will be in Jane, in real-time, all on one payout schedule. This means less time reconciling payments, and less chance of error from manual entry, too.
The Jane Payments Terminal is available for Jane Payments users in 🇨🇦 Canada and 🇺🇸 the US.
Pricing:
Canada: $279.00 + tax/shipping
US: $239.00 + tax/shipping
Shipments
Wondering how long it takes to get the terminal once it’s been shipped? In Canada, shipping takes between
2-5 business days
. All terminals in Canada are shipped from Ontario, so the further away a clinic is from Ontario, the longer the shipment will take.
In the US, shipping is completed by
UPS
, and takes a couple of business days. Terminals ship from multiple places in the US, and delivery is generally a bit speedier than deliveries in Canada.
Terminal Receipt
If you’re looking for a receipt for your terminal purchase, the listed
Account Owner
can contact our Jane Payments team at
payments@jane.app
, and our team will issue a receipt via the email listed in the Account Owner’s profile.
Step 2: Ordering, unboxing & linking your Jane Payments Terminal
Saving credit cards from the Jane Payments Terminal
Tips on the Jane Payments Terminal
How to switch a Jane Payments Terminal between locations
Jane Payments Terminal Troubleshooting
Navigating the Jane Payments Terminal
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane Payments Terminal
Jane Payments
Jane Payments Terminal
3 min read
Balance Plan
Practice Plan
Thrive PlanIf you find yourselves processing lots of debit payments and need a terminal to do so, we’ve got you covered!
📍 With the
Jane Payments Terminal
, you can link to each of your practitioner’s bank accounts to send them their payments directly. 💸 Yep, you heard that right, no need for multiple terminals.
📍 You’ll have the option to save a credit card on file when a client taps, swipes, or inserts their card into the Jane Payments Terminal. This is an easy way to save payment information, which can help prevent no-shows.
...
How to switch a Jane Payments Terminal between locations
Jane Payments Terminal Troubleshooting
Navigating the Jane Payments TerminalSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5cc03891-509b-4f35-8a27-aea15c831ef9)
