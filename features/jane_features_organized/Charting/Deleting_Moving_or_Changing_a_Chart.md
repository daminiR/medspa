...
*Source: [https://jane.app/guide/deleting-moving-or-changing-a-chart](https://jane.app/guide/deleting-moving-or-changing-a-chart)*

*Category: Charting*

*Scraped: 2025-08-07 01:02:06*
...
Feature OverviewDeleting, Moving or Changing a Chart
Charting
Deleting, Moving or Changing a Chart
8 min read
Balance Plan
...
Changing the Author
Duplicating a Chart Entry
Making an Amendment
Archiving a Chart draft or Deleting a Signed Chart
Changing the Patient
So long as you are the
chart author,
you will have the ability to change the patient within a chart entry whether the chart is locked/signed or still in draft form. We know that things are moving quickly in clinics and that sometimes charts can be created under the wrong patient. Luckily, there’s a simple way to move the entry to the correct patient.
This can be done by clicking the
cog icon
at the bottom of the chart and then selecting the
Change Patient
button.
...
In such cases, Jane allows any Full Access user or the current author of the chart entry to transfer draft charts to another staff member. They can select the
cog icon
at the bottom of the chart and then select the
Change Author.
You can learn more about our
Supervisor Sign Off
workflow in our guide document
here
.
Duplicating a Chart Entry
To help you save some time when charting for your patients, you can use the
Duplicate
feature. It allows you to copy an entire chart entry, including all the content within the chart. It’s like a copy-and-paste feature, while still giving you the ability to edit the content.
To start, head over to the
Day
tab and click on a patient appointment to open up their
Chart.
Next, click on the
dropdown arrow
to the right of a chart entry and select
Duplicate
within the menu options.
You can also access this if you’re within the
Patient
tab if you head over to their
Patient Profile
and click on
Charts
.
If the patient has a treatment plan in place, duplicating a chart will automatically add it as part of that plan. However, if you need the chart to be assigned to the
Unassigned Charts
section, click on the
dropdown arrow
to the right of the entry and select
Remove from plan
.
Making an Amendment
If you need to correct, change or edit your chart entry that was already signed and locked, you will need to make an amendment.
As the chart author, you will find the
Amend
button in the bottom right-hand corner of the chart.
...
When archiving draft charts or deleting signed charts, it’s important to note who the
owner
of the chart is, and the
status of the chart.
Chart authors will be able to archive chart drafts and delete their own signed entries; and,
The
account owner
will have the ability to also delete staff-authored charts and patient-authored entries such as intake forms and surveys.
...
can archive their
draft
charts. In the below example, you’ll see that the entry is a
Draft
...
Note📝
:
Draft chart entries cannot be deleted. They can only be archived. If you need to delete the entry, you can
sign
the entry first and then delete it.
This is not true when
deleting a signed chart,
which permanently deletes the chart from Jane. Let’s take a closer look at deleting signed charts below.
2. Deleting a Signed Chart
While uncommon, there are times when a signed chart entry may need to be deleted.
As legal requirements vary among disciplines and regions, we encourage users to review any obligations to retaining patient records prior to deleting an entry.
As mentioned before, charts can be
moved
and
amended
as needed.
...
When deleting a chart entry, select the
cog icon
at the bottom of the entry, and click
Delete Chart Entry
in the dropdown menu.
Delete chart entry
option will only be seen on signed chart notes. Draft chart notes will have an
Archive chart entry
option.
...
As an Account Owner, you’ll be able to use your
Activity Log
in Jane to review charts that have been deleted. The Activity Log includes the Practitioner’s name as well as the date and time the chart was deleted.
Additional Notes & FAQ
⭐️Does Jane have an “undo” function if I accidentally delete a chart part?
For text deletions in a
Note
field, you can use
CMD+Z
(Mac) or
CTRL+Z
(Windows) to undo recent changes while you’re charting. Unfortunately, if you’ve removed an entire chart part or section, this action is permanent and cannot be undone.
If you have any questions about this or are running into any trouble please
let us know
!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Deleting, Moving or Changing a Chart
Charting
Deleting, Moving or Changing a Chart
8 min read
Balance Plan
Practice Plan
Thrive PlanMaking Changes to a Chart Entry
There are a few scenarios that pop up where a chart needs some attention. Jane has a few ways to work with your chart entries, while also remaining compliant with general charting regulations. These regulations typically require original entries to remain legible and all changes to a signed chart to be documented and dated.
Feel free to scroll through this guide to learn more, or jump to each section below:
Changing the Patient
Changing the Author
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.apphttps://jane.app/system/dragonfly/production/2016/10/21/98j02sn51k_blob)
- ![](https://jane.apphttps://jane.app/system/dragonfly/production/2016/10/21/5rofr2nl3q_blob)
- ![](https://jane.app/thumbs/2c2c17a8-fe72-4e73-95a1-a269c432edde)
- ![An image of the navigational steps](https://jane.app/thumbs/50cc7481-eda2-485e-85b2-59e403b9a9b0)
- ![An image of what the dropdown option looks like for a chart entry within a treatment plan](https://jane.app/thumbs/4aff926e-4909-4b4d-bbb6-91c2968052a4)
- ![](https://jane.app/thumbs/f836f421-893e-4dbd-acd2-e20b0e9ec688)
- ![](https://jane.app/thumbs/cffcac21-4e38-49b1-ba3d-1730ec7e0222)
- ![](https://jane.app/thumbs/1f136d61-3f6b-4009-9f07-1671711560bb)
- ![](https://jane.app/thumbs/a6314e2e-acf5-4a85-803d-31b51cbf49c3)
- ![](https://jane.app/thumbs/c8afd0bc-233f-4b20-b220-360ca83a57c2)
- ![](https://jane.app/thumbs/29bd7580-414b-4d4a-bf64-43856418ed6c)
- ![](https://jane.app/thumbs/c3bbb683-8bb7-4c1a-bed9-ab2a394ca8ac)
- ![](https://jane.app/thumbs/b141e8ae-f73d-418f-a23a-d07ec0800795)
