...
*Source: [https://jane.app/guide/jane-payments-monthly-processing-report](https://jane.app/guide/jane-payments-monthly-processing-report)*

*Category: Charting*

*Scraped: 2025-08-07 02:17:21*
...
Feature OverviewJane Payments Monthly Processing Report
Jane Payments
Jane Payments Monthly Processing Report
2 min read
Balance Plan
...
Thrive Plan
Legacy Plans
What is the Jane Payments Monthly Processing Report?
This report is designed to give you a detailed breakdown of the number of transactions and the total value of transactions processed each month throughout the
previous year
.
📍
Note:
This report is currently only available for our Jane Payments users in North America.
To view this report, a staff member with
Full Access
access can head over to the
Reports
tab and then click on
Jane Payments Monthly Processing
within the left sidebar menu.
What is included in the Jane Payments Monthly Processing Report?
This report shows the total gross volume for each month before deducting refunds. It also details the transaction fees incurred for each month and the number of transactions processed during the same period. The totals for these fields will be located at the bottom of the report.
Additionally, this report reflects when payments were processed in Jane, rather than when they were actually paid out to you. For example, a payment of $100 processed on December 31st would be paid out in the following year.
Where can I find the breakdown of individual transactions that make up the totals in this report? Feel free to take a peek at our guide,
Jane Payments Transaction Report
to learn more about this!
Digging into reports and not sure what something means?
Our Jane Payments team can help clarify. Just email us at
payments@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Jane Payments Monthly Processing Report
Jane Payments
Jane Payments Monthly Processing Report
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansWhat is the Jane Payments Monthly Processing Report?
This report is designed to give you a detailed breakdown of the number of transactions and the total value of transactions processed each month throughout the
previous year
.
📍
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/421cafd8-4ab2-493f-bcfa-13f0e6371584)
