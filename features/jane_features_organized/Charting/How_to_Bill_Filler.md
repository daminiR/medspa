...
*Source: [https://jane.app/guide/how-to-bill-filler](https://jane.app/guide/how-to-bill-filler)*

*Category: Charting*

*Scraped: 2025-08-07 01:54:35*
...
Feature OverviewHow to Bill Filler
Billing
How to Bill Filler
5 min read
Balance Plan
...
Option 1: By Syringe
We can set up our syringes as Products and then add them to a client’s treatment when arriving the appointment. By doing this, we can have the
Treatment
itself cost $0.00, but then you’ll be able to add on the appropriate number of syringes to charge for each individual client. Here are the steps:
The first step is to
Create a product
. If you decide to bill by syringe, we often see clinics set up their product offerings like this:
...
, and
Income Category
fields (you’ll likely want to select
treatment income
as the category so that the
staff member’s compensation
is calculated appropriately). You can fill out any of the optional fields and then click
Create Product.
...
Price to $0.00.
Uncheck the
Display Price on Online Booking
pages, and click
Update Treatment:
Option 2: By Brand
...
The first step is to
Create a product
. We often see clinics set up their product offerings like this:
...
steps from Option 1
to edit or create a treatment with a $0.00 cost.
...
Typically this method is used by practitioners tracking their inventory outside of Jane because they won’t be attaching products to appointments so Jane won’t track how much of a product has been used for each appointment. We typically see the amount of product tracked within the
chart notes
for the applicable treatment.
The first for this method is to create your
Treatments
.
...
In my example below, we’ve created a treatment for a 7-Point Lift at the cost of $3500, and Chin Filler at the cost of $1200.
...
That way, during the client’s visit, you can
Sell a Product
that will share how much product was used within the Patient’s Billing Info section. This will then update your inventory in Jane without impacting the price of the treatment.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Bill Filler
Billing
How to Bill Filler
5 min read
Balance Plan
Practice Plan
Thrive PlanWe often see our Aesthetic Clinics bill their Injectables in a few different ways. This could be by syringe, by the treatment area, or by brand.
Option 1: By Syringe
We can set up our syringes as Products and then add them to a client’s treatment when arriving the appointment. By doing this, we can have the
Treatment
itself cost $0.00, but then you’ll be able to add on the appropriate number of syringes to charge for each individual client. Here are the steps:
...
That way, during the client’s visit, you can
Sell a Product
that will share how much product was used within the Patient’s Billing Info section. This will then update your inventory in Jane without impacting the price of the treatment.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5a444bd2-f9fe-4e1e-8f75-1ca23432f464)
- ![](https://jane.app/thumbs/7bb16638-a42b-4eb4-87b7-553b7432c495)
- ![](https://jane.app/thumbs/93d2217b-237c-4158-975d-90ee432bbe21)
- ![](https://jane.app/thumbs/250d547e-8b14-4ecb-a911-bf555352a2d8)
- ![](https://jane.app/thumbs/4971f983-0bb8-4652-8e85-ffcc7d3cfab4)
- ![](https://jane.app/thumbs/2dbe183b-03a3-4bfa-b13f-78fa327dfa64)
- ![](https://jane.app/thumbs/de1468a6-9b29-44e7-bbc9-dea9a3375606)
- ![](https://jane.app/thumbs/f4d84f72-dcba-47ad-8b7c-318d2f2f3462)
