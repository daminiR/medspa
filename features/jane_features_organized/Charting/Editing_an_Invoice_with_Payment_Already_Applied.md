...
*Source: [https://jane.app/guide/editing-an-invoice-with-payment-already-applied](https://jane.app/guide/editing-an-invoice-with-payment-already-applied)*

*Category: Charting*

*Scraped: 2025-08-07 01:36:14*
...
Feature OverviewEditing an Invoice with Payment Already Applied
Billing
Editing an Invoice with Payment Already Applied
2 min read
Balance Plan
Practice Plan
Thrive Plan
If a payment has already been received and applied, here’s what you can do to change the amount charged. Alternatively, head here to
Change the Payment Method
Unapply The Payment
First note the invoice number and then
Unapply the Payment
Change The Invoice
...
For more details on investigating and solving this issue,  you can check out our
...
Adjusting Insurer Payment Dates
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Editing an Invoice with Payment Already Applied
Billing
Editing an Invoice with Payment Already Applied
2 min read
Balance Plan
Practice Plan
Thrive PlanIf a payment has already been received and applied, here’s what you can do to change the amount charged. Alternatively, head here to
Change the Payment Method
Unapply The Payment
First note the invoice number and then
Unapply the Payment
...
You can always adjust an invoice’s dates so that your reporting is accurate. See:
Adjusting Invoice Dates
Adjusting Insurer Payment DatesSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2014/06/05/2dbdqjdc6i_undefined)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/fo1q5d3d2_blob)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/6iv615mh1r_blob)
