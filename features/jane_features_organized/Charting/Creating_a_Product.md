...
*Source: [https://jane.app/guide/creating-a-product](https://jane.app/guide/creating-a-product)*

*Category: Charting*

*Scraped: 2025-08-07 01:34:18*
...
Feature OverviewCreating a Product
Billing
Creating a Product
7 min read
Balance Plan
...
Note
📝:
If your clinic needs to charge taxes on product sales, check out our guide on
Setting Up Sales Taxes in Jane
that has more details on that process before you jump into creating a new product.
Creating a Product
To get started, a staff member with
Administrative / All Billing
access will want to head over to the
Settings
tab and then select
Products
within the left sidebar menu:
On the Products screen, click
New Product
in the top-right:
Now you can fill in the information about your new product! Only the product’s
Name
,
Price
, and
...
If it’s a physical product or inventory, you can also enter your
Quantity
or supplies on hand per location to keep track of how much you sell:
When you’re ready, just hit
Create Product
at the bottom to save your product.
Other Product Fields
Wondering what those other fields are meant for? Let’s take a look:
Product Code
While the
Product Code
field isn’t mandatory, you can use a barcode scanner to scan your product’s barcode into this field! Then, when you
Sell This Product
, you can scan the barcode into Jane to quickly check out your customer:
Description
The Description Field also allows you to add extra detailed notes to show up on the receipt for that product:
Reorder Threshold
The reorder threshold will trigger the product to appear on your
Inventory Report
order list when the stock is one less than the threshold. This allows you to list a product without a quantity for items that are a special order.
💡
Jane Tip:
The Reorder Threshold applies to each location individually. For example, if your yoga mat Reorder Threshold is 5, and you have 35 yoga mats at the Village but only 4 at the District, your Inventory Report will show that you need to reorder yoga mats for the District only.
Viewing the Log of Changes for a Product
...
If you’d like to see a bit more details for a purchase, click on the blue
Created Purchase
text. Jane will redirect you straight to the invoice for a little extra sleuthing 🔍
How to archive a Product:
From time to time, you may need need to delete a Product from the Product List so it’s no longer part of your inventory. To do so, you can archive a Product.
To archive a Product, head to
Settings
in the blue banner at the top of your Jane page, click on
Products
in the left sidebar menu, find the Product in the list, and click
Edit
.
Scroll to the bottom of the Product page and click the
Archive
button.
You can view archived Products, as well as unarchive them, by heading to
Settings
, then to
Products
...
Archived products will be displayed with a grey
Archived
badge. You can click
Edit
to view the Product details, and you can also click the blue
Save & Unarchive
button if needed.
💡
Jane tip
: the Products List can be accessed by staff members with billing access, including the Administrative / All Billing, Full Access, and Account Owner
staff access levels
.
Additional Notes & FAQ
How can I view a list of products that have tax added to them?
A staff member with
Full Access
...
tab and click on
Products
within the left sidebar menu. Jane will display a list of all the products, including a column with which tax has been added.
If you’d like to learn more about pulling a product list in Jane, check out our
The Inventory Report, Product Price Lists and Calculating Retail Value
guide for more details.
Next up, click here to learn how to
Sell a Product
!
If you have questions, or if you want to chat through workflows in Jane, please don’t hesitate to
get in touch
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating a Product
Billing
Creating a Product
7 min read
Balance Plan
Practice Plan
Thrive PlanReady to add that product list to your Jane account? You’re in the perfect place!
Creating a Product
Viewing the Log of Changes for a Product
Additional Notes & FAQ
Note
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b9f12fe7-0ff2-47f0-bd74-298e429546f9)
- ![](https://jane.app/thumbs/3cf0e7a8-3c1f-4e61-9310-44edef76f0f4)
- ![](https://jane.app/thumbs/af951652-720d-4813-bf77-a8ffd8a9eab3)
- ![](https://jane.app/thumbs/c075780e-e923-42da-8ad3-74677aebd0b7)
- ![](https://jane.app/thumbs/3f95d46c-9669-4dbc-ac48-0de0809e51de)
- ![](https://jane.app/thumbs/ca7c19a3-aa27-4366-8a0d-f3ac54490eb1)
- ![](https://jane.app/thumbs/162dc974-3606-4786-bb7c-89e124c7d013)
- ![](https://jane.app/thumbs/0e229019-d540-487e-af90-73d6cdc563a8)
- ![](https://jane.app/thumbs/1e79e64e-efcc-4683-9851-b80a7c1da26d)
- ![](https://jane.app/thumbs/a9a87d7b-2174-4eb1-b544-75a5553d4e57)
- ![](https://jane.app/thumbs/a0725884-39da-43a4-bdd8-924b91c9719d)
- ![Product List page with Edit button to change Product](https://jane.app/thumbs/807b4fb4-8c66-4835-a50b-1532cae77ba5)
- ![Product page with Archive button](https://jane.app/thumbs/8aa342da-2ad5-46ff-83f7-5b0ddb8f9841)
- ![Product List page with Show Archived button on with Archived badge next to archived Product](https://jane.app/thumbs/a4e45215-0c96-4f2f-b019-517be7a28af9)
- ![An image of the navigational steps and where to view the tax](https://jane.app/thumbs/e446f3c8-40bb-4c5e-bdde-2f522f0ab4a5)
