...
*Source: [https://jane.app/guide/chart-template-library](https://jane.app/guide/chart-template-library)*

*Category: Charting*

*Scraped: 2025-08-07 00:57:46*
...
Feature OverviewChart Template Library
Charting
Chart Template Library
6 min read
Balance Plan
Practice Plan
Thrive Plan
Jane’s Chart Template Library is a collection of ready-to-use templates shared by many amazing practitioners in the Jane community, and they span across a wide range of disciplines. Whether you’re just getting started or looking for inspiration to fine-tune your charting, the library is a great place to explore what’s worked well for others.
Jane Tip 💙 If you’re using
AI Scribe
, chart templates help guide the type of draft notes AI generates for you. Many templates in the library are designed specifically with AI Scribe in mind, and you can jump right to the
Searching for AI Scribe templates
section of this guide to learn more.
Browsing the library
To explore the Chart Template Library, head to the
Staff
tab and select your profile from the left menu. From there, click the
Templates
tab, then choose the
Template Library
button in the top right corner.
Once you’re in the library, you can:
Use the search bar to look up templates by keyword.
or
Select a discipline category to browse templates specific to that area of practice.
Each template includes the name, the contributor, when it was added, and how many Jane users have saved it to their own template list.
If you see something that looks like it might fit your needs, just click on the template to open a full preview.
Searching for AI Scribe templates
If you’re using
AI Scribe
, you can filter the Chart Template Library to find templates that are built to work beautifully with it.
To get started, head into the
Template Library
and choose the discipline you’re looking for. From there, click the
Any Features
dropdown near the top right and select
AI Scribe
. Jane will show you all the templates that have been tagged as Scribe-ready.
These templates are a great place to start if you’re not quite sure how to prompt AI Scribe or what kind of structure works best. Each one was created by a real practitioner and is designed to help generate clear, relevant draft notes. You’ll see an AI Scribe label on any templates built with that feature in mind. Once you’ve saved a template to your account, you can always make small tweaks to the prompts or wording to better suit your own charting style.
Looking for additional prompt inspiration?
If you’re wondering how to word your prompts to get the best results from AI Scribe, check out our
AI Scribe Sample Prompts
guide. It’s full of ideas and examples to help you create prompts that work well across different charting styles and disciplines.
Adding a template to your account
When you find a template you’d like to use, click
Add
. The copied version will appear in your chart template list, where you can edit or customize it as needed.
Templates added from the library are only visible to your clinic, so feel free to edit them to suit your needs. Add, delete, adjust - make it your own! You can learn more about building and customizing templates in our
Creating a Chart Template
guide.
Sharing your own templates
Did you know you can share a chart template with practitioners who work outside of your clinic? Just click the
Share to Template Library
button next to any of your chart templates.
When sharing your template, you can assign it a discipline, choose whether or not to display your name as the author, and add any notes about how the template is intended to be used.
Additional notes
Can I customize a chart template I’ve added to my account?
You got it! After you’ve added a template to your account, just click
Edit
. From there, hover over any section until you see the
three dots (…)
. Click them to access more editing options—add, edit, delete, or rearrange—so you can tailor the template to fit your style.
Can I remove a template from the library after I’ve shared it?
You sure can! If you’re the original author of a shared template, you can remove it by heading to the
Template Library
, searching for your template, and clicking the
Remove from Library
button at the top of the preview.
Not seeing the “Remove from Library” option?
If it’s an older template, we may need to remove it for you. Just reach out to us at
support@jane.app
and we’ll be happy to help, with permission from the listed Account Owner 💙
Whether you’re looking to save time, stay consistent, or explore new approaches to charting, the Chart Template Library is a great place to start. Feel free to explore, customize, and even contribute your own templates to help others in the Jane community. And if you’re using
AI Scribe
, don’t forget to check out the Scribe-ready templates to get the most out of your notes!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Chart Template Library
Charting
Chart Template Library
6 min read
Balance Plan
Practice Plan
Thrive PlanJane’s Chart Template Library is a collection of ready-to-use templates shared by many amazing practitioners in the Jane community, and they span across a wide range of disciplines. Whether you’re just getting started or looking for inspiration to fine-tune your charting, the library is a great place to explore what’s worked well for others.
Jane Tip 💙 If you’re using
AI Scribe
, chart templates help guide the type of draft notes AI generates for you. Many templates in the library are designed specifically with AI Scribe in mind, and you can jump right to the
Searching for AI Scribe templates
...
Whether you’re looking to save time, stay consistent, or explore new approaches to charting, the Chart Template Library is a great place to start. Feel free to explore, customize, and even contribute your own templates to help others in the Jane community. And if you’re using
AI Scribe
, don’t forget to check out the Scribe-ready templates to get the most out of your notes!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![accessing the template library](https://jane.app/thumbs/2ce0ad1a-3f9b-4e17-bbac-0ae423a4846a)
- ![template library view](https://jane.app/thumbs/51dc7838-2629-4c98-bde5-b48ec1a64aec)
- ![previewing a template](https://jane.app/thumbs/8054914c-b594-4014-b3a3-72387fdf4c5f)
- ![filtering for ai scribe](https://jane.app/thumbs/51a51cea-46cc-432a-a064-e8a18390d6fa)
- ![adding a template to your own](https://jane.app/thumbs/3ee55c9b-78dc-49cd-917c-0f2753e1fbfa)
- ![editing a template](https://jane.app/thumbs/4a38bc29-ea6f-4661-bcbe-aea1cd7878c6)
- ![An image walking though how to share a chart template within the chart template library](https://jane.app/thumbs/196f33bc-29fa-46f6-943b-8ee89c8dadda)
- ![customizing a template](https://jane.app/thumbs/de8b3c04-faa1-4b32-9f17-7de1aee6bc46)
- ![removing a template](https://jane.app/thumbs/e288cd7c-1414-41d7-a1a4-37eb501b0b9f)
