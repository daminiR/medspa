...
*Source: [https://jane.app/guide/charting-for-a-past-date](https://jane.app/guide/charting-for-a-past-date)*

*Category: Charting*

*Scraped: 2025-08-07 00:58:16*
...
Feature OverviewCharting for a Past Date
Charting
Charting for a Past Date
3 min read
Balance Plan
...
From an Appointment
If you chart from the
Day
tab, Jane will automatically link the chart entry to that date of service. Choose a previous visit that you would like to chart for and click on it, and you’ll see a check box on the appointment.
You can add a chart entry from here by clicking
New Chart Entry
and Jane will date the entry to that date.
Alternatively, you can also use the
Appointments Report
filtered by the
Chart Status
to get a quicker overview of which appointments are missing charts:
Next, you can click on the blue text with the patient’s name to be redirected to their profile:
Manual Override
If you are adding entries from the Patient tab you can alter the date manually.
If the chart is still a draft, meaning you have not signed it yet, just click the
date
in the top-left corner of the chart, and you will get a date picker to select a new date. Once you’re done, save your work by hitting the
yellow checkmark
:
If the chart has already been signed, click the
Amend
button at the bottom of the chart:
In “Amend” mode, you will also be able to click the date at the top-left of the chart and use the date picker to choose the date you want. And remember, when you change the date of a signed chart, the new date of the chart will NOT change the date and time that the chart was signed.
Feel free to check out our
Making a Chart Amendment
guide for more info on amending signed charts.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Charting for a Past Date
Charting
Charting for a Past Date
3 min read
Balance Plan
Practice Plan
Thrive PlanIt’s important to note that while you can adjust or change the date of the chart entry to reflect the date of service, you cannot backdate the date and time of the “signed at” stamp.  To comply with charting regulations, Jane will accurately record and display the date and time that the chart entry was signed.
You can, however, change the date of the chart entry to reflect the actual date of the visit in two ways.
From an Appointment
If you chart from the
Day
...
Making a Chart Amendment
guide for more info on amending signed charts.
Hope that helps and happy charting ;)Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2018/03/09/93yy4f2vfy_date_of_chart_entry_for_back_date.png)
- ![](https://jane.app/thumbs/602a791d-bfe0-4b16-a040-5b6a3ba1acc1)
- ![](https://jane.app/thumbs/88fd52f3-08ac-4393-91da-ea94052097b4)
- ![](https://jane.app/thumbs/cf8ce2b6-f705-49f4-ae77-30c83800f5cf)
- ![](https://jane.app/thumbs/b4c7e05b-6769-44e8-93d2-9e5ac02bc8b6)
- ![screenshot of editing date of chart entry](https://jane.app/thumbs/577e5f92-f5bd-47ef-8a3b-5849f608ff7b)
- ![screenshot of Amend button](https://jane.app/thumbs/316b58ff-e8fb-47eb-bcee-cc34f076610b)
- ![](https://jane.app/system/dragonfly/production/2018/03/09/71bhcq19mc_date_signed_does_not_change.png)
