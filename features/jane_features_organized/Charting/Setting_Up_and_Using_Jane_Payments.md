...
*Source: [https://jane.app/guide/setting-up-and-using-jane-payments](https://jane.app/guide/setting-up-and-using-jane-payments)*

*Category: Charting*

*Scraped: 2025-08-07 02:13:13*
...
Feature OverviewSetting Up and Using Jane Payments
Jane Payments
Setting Up and Using Jane Payments
2 min read
Balance Plan
...
Thrive Plan
Set Up
Step 1: Setting up Jane Payments & ordering a Terminal
Step 2: Unboxing and linking your Jane Payments Terminal(optional)
Step 3: Taking payments online and on the terminal (via Jane Payments)
...
Save and remove cards on a Client’s profile
Add a Credit Card from the Client My Account Portal
Jane’s Terminal Payments
...
Investigating Your Jane Payments Payouts🕵️‍♀️
Reporting
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Setting Up and Using Jane Payments
Jane Payments
Setting Up and Using Jane Payments
2 min read
Balance Plan
