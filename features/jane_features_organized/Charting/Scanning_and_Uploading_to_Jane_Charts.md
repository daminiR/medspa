...
*Source: [https://jane.app/guide/scanning-and-uploading-to-jane-charts](https://jane.app/guide/scanning-and-uploading-to-jane-charts)*

*Category: Charting*

*Scraped: 2025-08-07 01:10:13*
...
Feature OverviewScanning and Uploading to Jane Charts
Charting
Scanning and Uploading to Jane Charts
3 min read
Balance Plan
Practice Plan
Thrive Plan
You might be looking to load in a scanned Dr. referral, or an in clinic intake form, or the paper chart that you’re leaving behind.  Loading documents into Jane
through the Files area of a patients’ profile
is something that you will do regularly so here’s some tips.
Size of File
Jane does have a file size maximum for both the
Charts
area and the
Files
area, which is
50MB
.  Most scanners are set by default to a very high resolution - more than you need for this type of scan.  High resolutions create larger files which take time to upload. “Screen Resolution” is enough.
Format of File
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Scanning and Uploading to Jane Charts
Charting
Scanning and Uploading to Jane Charts
3 min read
Balance Plan
Practice Plan
Thrive PlanYou might be looking to load in a scanned Dr. referral, or an in clinic intake form, or the paper chart that you’re leaving behind.  Loading documents into Jane
through the Files area of a patients’ profile
is something that you will do regularly so here’s some tips.
Size of File
Jane does have a file size maximum for both the
...
Here’s a chart with many entries (not all uploads)
I type in “Report” here in the search bar, and magic!
Just the Report uploads show up.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2015/12/09/4lqevfzcj_blob)
- ![](https://jane.app/system/dragonfly/production/2015/12/09/8wc5geg13n_blob)
- ![](https://jane.app/system/dragonfly/production/2016/12/05/3qobm0yq3s_blob)
- ![](https://jane.app/system/dragonfly/production/2016/12/05/5b60wtoddp_blob)
- ![](https://jane.app/system/dragonfly/production/2016/12/05/4ebvy5ovhr_blob)
