...
*Source: [https://jane.app/guide/reordering-diagnosis-codes](https://jane.app/guide/reordering-diagnosis-codes)*

*Category: Charting*

*Scraped: 2025-08-07 02:07:59*
...
Feature OverviewReordering Diagnosis Codes
Billing
Reordering Diagnosis Codes
2 min read
Well hello there,
...
If you haven’t added a diagnosis code before here is a great place to start:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Reordering Diagnosis Codes
Billing
Reordering Diagnosis Codes
2 min readWell hello there,
Have you been looking for our little ditty about setting a Primary Diagnosis codes, Ordering Diagnosis codes, or were you just browsing our lovely guide? Well either way I hope you enjoy the read.
If you haven’t added a diagnosis code before here is a great place to start:
Including Billing & Diagnosis Codes In Patient Charts
However if you are looking to know which one is the primary or added more than 12 and wanted to know which codes will be added to the CMS1500 or EDI, you are in the right place.
...
From here you can drag and drop the diagnosis codes into the correct order.
If the insurance company or third party you are submitting too requires a primary diagnosis it is often the first code upon submission. Jane counts from the first CPT code, so the primary diagnosis will need to be in the first option.
Lastly, Jane does allow you to add more than 12 diagnosis codes to this area however only 12 are accepted on the CMS1500 and EDI file. Jane will not include further diagnosis codes when using these features.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/d36f2234-ad6a-48e0-84d1-d518f66d4eaa)
- ![](https://jane.app/thumbs/632c62fa-4ac6-427a-b897-3c6e0cd1bef9)
- ![](https://jane.app/thumbs/eb12406a-4c06-4d26-a745-3cfc9f33c28a)
