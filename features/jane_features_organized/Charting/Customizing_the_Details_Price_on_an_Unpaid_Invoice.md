...
*Source: [https://jane.app/guide/customizing-the-details-price-on-an-unpaid-invoice](https://jane.app/guide/customizing-the-details-price-on-an-unpaid-invoice)*

*Category: Charting*

*Scraped: 2025-08-07 01:50:55*
...
Feature OverviewCustomizing the Details & Price on an Unpaid Invoice
Billing
Customizing the Details & Price on an Unpaid Invoice
3 min read
Balance Plan
Practice Plan
Thrive Plan
This is an oldie but a goodie. Did you know that you can easily
customize the details and price on an unpaid invoice prior to collecting payment?
This allows you to document certain details that will be reflected on the client’s invoice & receipt.
If a payment has already been applied, you can visit this guide
here
to learn how to manually override a paid invoice.
Take a look at the “
Details
” section below:
...
If
Jane Payments
is set up, you’ll have the ability to share a client’s credit card across related profiles. So, if Mom wanted to pay for her child’s session, you can pay with Mom’s Shared Credit Card, and Jane will automatically update Mom as the Payee on the Child’s receipt.
...
Within your schedule, open up your appointment. Make sure that you’ve clicked
Arrive
so that Jane knows to generate the invoice.
Scroll down within the Appointment Panel to your Billing Info section, and click on the
blue link
that represents the client invoice:
...
📍Note:
If an insurance claim is added to an appointment after the Amount of the invoice is changed, the Amount will revert back to the original Amount set for that treatment. If you would like to submit an insurance claim for a custom Amount, we recommend using a
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Customizing the Details & Price on an Unpaid Invoice
Billing
Customizing the Details & Price on an Unpaid Invoice
3 min read
Balance Plan
Practice Plan
Thrive PlanThis is an oldie but a goodie. Did you know that you can easily
customize the details and price on an unpaid invoice prior to collecting payment?
This allows you to document certain details that will be reflected on the client’s invoice & receipt.
If a payment has already been applied, you can visit this guide
here
...
Discount or Price Adjustment
instead.
If you have any questions, we’d love to hear from you! Our email is support@janeapp.com.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/c37ebf78-96c9-4104-a73d-74d48ffb10d1)
- ![](https://jane.app/thumbs/71eae2a6-71de-44fd-b4be-3202d085e4cc)
- ![](https://jane.app/thumbs/e0da71ef-21f0-4b5c-bb2f-ca5d7eb0b00a)
- ![](https://jane.app/thumbs/52c388cf-2bb2-44ce-9f5f-eaadf03cc61c)
