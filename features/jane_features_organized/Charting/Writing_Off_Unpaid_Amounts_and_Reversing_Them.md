...
*Source: [https://jane.app/guide/writing-off-unpaid-amounts-and-reversing-them](https://jane.app/guide/writing-off-unpaid-amounts-and-reversing-them)*

*Category: Charting*

*Scraped: 2025-08-07 01:43:33*
...
Feature OverviewWriting Off Unpaid Amounts (and Reversing Them!)
Billing
Writing Off Unpaid Amounts (and Reversing Them!)
4 min read
Balance Plan
...
You can always keep trying to collect the balance, but after a time it makes sense to write off the owed amount or that bad debt, so you can track and have a record that you attempted to collect it and were unsuccessful. Here’s how to do this:
Go to the
Patient
tab, locate the patient and then proceed to the
Billing
tab.
Click on the blue
Patient Invoice
or
Insurer Invoice
text to open up the invoice details.
...
Now, we also know that sometimes, just when you least expect it, someone will come back to pay that amount that you’ve written off. Jane allows you to reverse that write-off. Locate the invoice just as you did above, and click the same arrow as above, but this time you’ll see the “Reverse Write Off” option.
Writing off Insurer Invoices
To help streamline the process, you can head to the
Billing
tab and select an insurer within the
Insurer Invoices
section.
...
blue text with the insurer invoice number
(will end with -C01, C02 etc).
Now you can click on the
dropdown arrow
and select
Write-Off.
Write Off Report
Write offs can be reviewed by visiting the dedicated
Write Off Report
under the Reports Tab. The data can be filtered by location, the date the write-off took place, as well as the staff member associated with the invoice.
...
No
- If the compensation report is filtered to Invoice(Accrual) then the write-off will appear in a $0 line. If the compensation report is filtered to Cash(Collected) then the invoice won’t appear on the report at all.
If you would like staff to be compensated for write-offs we’d like to recommend using a Price Adjustment. To learn more about price adjustments you can check out our guide on
Discounts and Price Adjustments
.
Can I backdate a write-off?
No
- At the moment, the write-off date will default to the date when the action was completed. We’d love to hear more about how this feature would be helpful to you! You can add a comment to our Feature Requests page
here
. To learn more about this area and how to access it, check out our guide on
Feature Requests
💙
Can I change the amount I need to write off?
Currently, there isn’t a way to enter a custom amount when writing off an invoice. The write-off amount is generated from the invoice total and also depends on whether a payment is applied to the invoice.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Writing Off Unpaid Amounts (and Reversing Them!)
Billing
Writing Off Unpaid Amounts (and Reversing Them!)
4 min read
Balance Plan
Practice Plan
Thrive PlanYou bill an invoice to insurance, only to see that they will not be covering as much as they said they would. Or maybe a patient has an outstanding balance they refuse to pay and never come back to the clinic.
You can always keep trying to collect the balance, but after a time it makes sense to write off the owed amount or that bad debt, so you can track and have a record that you attempted to collect it and were unsuccessful. Here’s how to do this:
Go to the
Patient
tab, locate the patient and then proceed to the
...
💙
Can I change the amount I need to write off?
Currently, there isn’t a way to enter a custom amount when writing off an invoice. The write-off amount is generated from the invoice total and also depends on whether a payment is applied to the invoice.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/2e575e10-a02a-425e-b9e3-682ba97aad2d)
- ![](https://jane.app/thumbs/5b80501d-03d7-4660-b58f-dc83283448a1)
- ![](https://jane.app/thumbs/f74c36dc-dc00-4dde-ba10-29b692a45071)
- ![](https://jane.app/thumbs/1f7d8963-fc19-4aee-935e-f4df2748c9a8)
- ![](https://jane.app/thumbs/7920b16c-9250-4583-8f2b-8f2a373b4f97)
- ![](https://jane.app/thumbs/1b40936f-dcfa-4191-be26-d1277440f102)
- ![](https://jane.app/thumbs/7ee1aba0-6ee5-4535-86ac-1acb4fc48ace)
