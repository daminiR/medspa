...
*Source: [https://jane.app/guide/files-area-in-chart](https://jane.app/guide/files-area-in-chart)*

*Category: Charting*

*Scraped: 2025-08-07 01:02:50*
...
Feature OverviewFiles Area in Chart
Charting
Files Area in Chart
9 min read
Balance Plan
...
One of the best features about the Files Upload area is you can upload
multiple files at once
by selecting them all from your saved files on your device and dragging and dropping them into the upload area.
...
Size of File
Jane does have a file size maximum for both the Charts area and the Files area, which is
50MB
. Most scanners are set by default to a very high resolution - more than you need for this type of scan. High resolutions create larger files that take time to upload.
Format of Files
...
to send it there.
Do you want your
patient to be able to see it
in their My Account? If yes, you can share a file upload with a patient by
click the bar
that says “Not Visible to Patient” to flip it to “Visible to Patient”
Do you want
other staff to be able to see it
? Use the
drop-down menu
to select who is able to view the file.
...
Batch Chart Exports for Practitioners
to learn more about how to manage this process
...
patient portal here
.
Once a file has been uploaded, you can access the edit menu by hovering your mouse over the file image. Three icons will appear: a
pencil icon
to edit the file name or details, a
download icon
to save a copy of the file to your device, and a
chart ico
n to view the file in the chart. Downloaded files will be saved in the same format they were uploaded in, such as JPEG, PDF, or PNG.
You’ll find these same options when viewing your files in list view as well. Edit, download, and view in chart are all available when you preview the file from the list:
Signing a Chart
...
To unlink a patient’s file upload from a chart entry, the staff member who initially uploaded the file can head over to the
Files
section within the patient’s profile.
Next, hover over the uploaded file and click on the
black pencil icon:
From there, they can
toggle off
the Include in Chart option. Make sure to click the blue
Save
button to confirm those changes.
Jane will automatically remove the file upload as a chart entry and you’re all set!
Deleting a File
To delete a patient’s file upload, the staff member who initially uploaded the file or authored the chart entry can head over to the
Files
section within the patient’s profile.
Next, hover over the uploaded file and click on the
black pencil icon
...
red trashcan icon
to delete the file. You’ll get a little pop-up letting you know that once you confirm, this action cannot be undone as a final way to confirm this is an action that you’d like to complete.
...
Read more about
privacy and access levels here
.
Additional Notes
⭐️Can I filter or search for different files?
...
⭐️Can I make folders in the Files section?
No - this area is currently designed to store individual files only. If you need to organize multiple files, you might consider compressing them into a
zip file
before uploading, which can help manage multiple documents as a single file.
For even better document and chart management, review our other guide document on
Pinning and Starring Charts
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Files Area in Chart
Charting
Files Area in Chart
9 min read
Balance Plan
Practice Plan
Thrive PlanOften you’ve uploaded something to a client’s chart, and you’re just looking for a quick way to find and review the upload.
Overview
There’s an area in every patient’s profile called “Files” where you can conveniently review all uploads with a preview of the file. Not only can you conveniently preview all files and jump to specific chart entries, but you can also upload images of patient ID cards, X-rays and even lab requisitions.
Let’s take a look at the different ways that the Files area can help!
Your files will default as thumbnails in a grid (as seen in the above screenshot) or you can toggle to a list view.
...
before uploading, which can help manage multiple documents as a single file.
For even better document and chart management, review our other guide document on
Pinning and Starring ChartsSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/b3fcea68-cf3f-45d8-95a4-eb87cc8aec2a)
- ![](https://jane.app/thumbs/6cdc4130-f481-4dfc-b006-2614db712c0a)
- ![](https://jane.app/thumbs/a4e246fc-573e-4309-add3-78c02e1eb9fd)
- ![](https://jane.app/thumbs/bebdff56-3c64-42cd-b2c2-d5ba01807106)
- ![](https://jane.app/thumbs/b21872fa-6078-498b-9dea-2fd0e05d85f1)
- ![](https://jane.app/thumbs/70695b21-fae3-4ef0-b7ab-03788dcac393)
- ![](https://jane.app/thumbs/fff61903-4c32-4095-a375-45e26bba99a0)
- ![](https://jane.app/thumbs/493ba741-5179-42c5-91b2-2f2d2cb77780)
- ![](https://jane.app/thumbs/7c26c694-f6d7-41b3-9818-8d8a43316179)
- ![](https://jane.app/thumbs/62348f3f-18cc-4e79-bbc5-9f25f2cd853b)
- ![](https://jane.app/thumbs/9001323e-9388-4d18-95e6-3e08c65e4962)
- ![](https://jane.app/thumbs/02efddfe-0e57-4e0e-b2cd-e325fc6a0907)
- ![](https://jane.app/thumbs/406b1d45-a242-4b33-870c-bb622d052b1b)
