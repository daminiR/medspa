...
*Source: [https://jane.app/guide/sharing-patient-charts-with-a-third-party](https://jane.app/guide/sharing-patient-charts-with-a-third-party)*

*Category: Charting*

*Scraped: 2025-08-07 01:18:45*
...
Feature OverviewSharing Patient Charts with a Third Party
Charting
Sharing Patient Charts with a Third Party
3 min read
Balance Plan
...
Thrive Plan
Legacy Plans
When it comes to sharing a patients charts with a Third Party like a lawyer or insurer we don’t recommend emailing chart notes, but we have a couple of alternatives:
You can
create the Third Party a patient profile
, upload the document and then share that document to their patient portal so they can view and download it in a HIPAA compliant environment.
You can fax chart entries and Treatment Plans using our Integrated Outbound Fax feature.
...
Patient tab
, click into our desired patients profile, hop to their
Charts
tab, click
Filter / Export
and finally
...
​
​Pro Tip
: You can also use the filters to only export charts created within a certain date, a certain practitioner, or a certain discipline. You can even use the search box to only export charts with a certain keyword in them!
​
​
...
​
​
You may also want to do this only for a single chart entry, not to worry we’ve also got you covered! Just open the chart entry you’d like by clicking, scroll to the bottom of the entry, click the
cog wheel
and then choose to
Export
.
...
​Once you have your exported file it’s time to upload it and share it with the third party! Lets now head to their newly created profile and head into their
Files
tab, then we can
Add a File
or drag & drop to upload the PDF, and finally choose to share this file with the patient.
​
​
​From here, Jane will ask you to
Confirm & Notify
your client that you have shared a Document with them:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Sharing Patient Charts with a Third Party
Charting
Sharing Patient Charts with a Third Party
3 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansWhen it comes to sharing a patients charts with a Third Party like a lawyer or insurer we don’t recommend emailing chart notes, but we have a couple of alternatives:
You can
create the Third Party a patient profile
, upload the document and then share that document to their patient portal so they can view and download it in a HIPAA compliant environment.
You can fax chart entries and Treatment Plans using our Integrated Outbound Fax feature.
...
Printing or Sharing Chart Entries (Treatment Plans)
Integrated Outbound Fax
I hope you find these helpful. Please feel free to email back if there is anything I can clarify for you.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/a0ea4178-a20b-4f1f-a3d6-705e1204692c)
- ![](https://jane.app/thumbs/6317c795-2309-49d4-9a7e-a704d507e0f1)
- ![](https://jane.app/thumbs/a6d17b00-f541-444d-af2b-8eed43b3924e)
- ![](https://jane.app/thumbs/2d9cbb51-72a0-416e-ade2-cc13c063cf92)
- ![](https://jane.app/thumbs/43e4033d-43db-460f-bf39-8ae99e14a695)
- ![](https://jane.app/thumbs/2a40a97c-5d40-438a-b259-849e29684569)
