...
*Source: [https://jane.app/guide/how-to-edit-the-received-dates-of-payments](https://jane.app/guide/how-to-edit-the-received-dates-of-payments)*

*Category: Charting*

*Scraped: 2025-08-07 01:56:55*
...
Feature OverviewHow to Edit the Received and Applied Dates of Payments
Billing
How to Edit the Received and Applied Dates of Payments
7 min read
Balance Plan
...
Day End Procedures
for reducing the need to backdate in the first place.
Here’s how all the different dates affect different reports:
Invoice date of Purchase
- affects
Sales
reports
Applied date of Payment to Invoice
- affects the
Compensation
report
Date of Payment / Received At
- affects
Transaction
reports
Note
📝: To make our bookkeeping friends happy and keep you folks as accurate on your financial reporting as possible, only those with
Full Access
profiles can backdate payments. For more information on the different access levels, check out our guide doc on the different
Staff Access Levels
.
...
tab within the
Patient’s Profile
. There are two ways you can access the payment - either from the
Purchases
tab or the
Payments
tab.
...
Click the
Edit
button to the right of the trashcan icon.
Update the
Received At
field and click
Save
...
Note📍:
If the payment was received via
Jane Payments
, then the Received At data and the amount collected
cannot be edited
. This is because the patient’s card was actually charged on that date and will match what they see on their bank statement.*
Editing the Applied at Date of a Patient Payment
Within this same area, you’ll want to scroll to the
Applied To
section and click on the
black pencil icon.
Next, update the
Applied Date
field and make sure to hit the blue
Save
button to confirm those changes.
After you click on the Save button, Jane will ask for a final confirmation and you’ll want to hit the orange
Yes, Change the Date
...
Insurer Invoices
section
You can access an insurer payment if you head over to the
Patient’s Profile
and click on the
Billing
tab. By default, Jane will land on the
Purchases
tab if you know the date of service of the claim you need to edit.
You’ll want to click on the
blue insurer invoice
link or on the word
View
to the far right.
Next, scroll to the bottom of the page and click on the
blue payment link
within the
Payment History
section.
Now you’ll click the
Edit
button to the right of the trashcan icon:
Update the
Received At
field and click on the blue
Save
button to confirm those changes.
You can also locate an insurer payment by heading over to the
Billing
tab in the top blue banner and then selecting the insurer within the left sidebar menu.
Next, click on the
Payments
tab, then search by the reference number or payment amount. Once you locate the payment, click on the word
View
to the right of the payment line.
From here, you’ll want to click on the
Edit
button to the right of the trashcan icon.
Update the
Received At
payment date and click
Save
to confirm those changes.
...
Save
button, Jane will ask for a final confirmation and you’ll want to hit the orange Yes, Change the Date button to confirm the change.
Additional Notes on Applied Dates
Backdating the
Received At
will change the date that the payment shows up on the
Transaction Report
. We call this the Payment Date, (when the payment was received).
When a payment is used to pay for something we call this the
Applied Date
(when it was used or applied to an invoice). This is the date that determines when this payment shows up on the
Compensation Report
.
Changing the
Applied To
dates will affect the numbers of your past reporting, so do this with caution. Because of this, editing the Applied Date of a payment can only be done by a
Full Access
user.
...
We know sorting out billing issues can feel overwhelming, so feel free to
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Edit the Received and Applied Dates of Payments
Billing
How to Edit the Received and Applied Dates of Payments
7 min read
Balance Plan
Practice Plan
Thrive PlanOccasionally you may come across the need to modify the date or method of payment recorded on a transaction. You can edit the payment received dates for both insurer and patient payments,  in addition to the date the payment was applied to an invoice.
We highly recommend these
Day End Procedures
for reducing the need to backdate in the first place.
Here’s how all the different dates affect different reports:
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of navigational steps](https://jane.app/thumbs/0a6b8319-f401-45f5-9353-78096bef776c)
- ![screenshot of where to find the payment attached to the invoice](https://jane.app/thumbs/8632b979-c4aa-415a-8f63-98f2c6f6d6a7)
- ![screenshot of where to find the edit button when viewing a payment](https://jane.app/thumbs/9c6ab2c2-c1a5-42ea-a485-8b7cb356687f)
- ![screenshot of what it looks like to update the date including the calendar that pops up](https://jane.app/thumbs/4f48319f-369c-4e57-ad47-10a7115e2227)
- ![screenshot of where to find the black pencil icon and where the field to edit the applied at date appears](https://jane.app/thumbs/cea9aeaa-764e-45dd-ba09-010a53e32906)
- ![screenshot of the orange button where Jane asks for the final confirmation of the change](https://jane.app/thumbs/1528040a-9309-4671-a39e-a088fcdd5341)
- ![screenshot of navigation steps to access the payment through the patient's profile](https://jane.app/thumbs/95c443df-9c03-4e5c-add5-e0cd4f268d61)
- ![screenshot of where to find the payment link when viewing the invoice](https://jane.app/thumbs/5270501e-1192-4643-92ef-1d240f1d7b05)
- ![screenshot of where to find the Edit button when viewing the payment](https://jane.app/thumbs/da66cc3c-68bd-4283-8e20-6f75595fb4f5)
- ![screenshot of what it looks like to update the date including the calendar date picker](https://jane.app/thumbs/648cde78-21f5-4274-9358-f66a79b5fbe5)
- ![screenshot of navigational steps](https://jane.app/thumbs/6e2943e6-5248-41bc-89ce-26d1cb598bea)
- ![screenshot of navigational steps](https://jane.app/thumbs/e055ecb5-4e93-4ae9-9575-898a56948fe0)
- ![screenshot of where to click on the Edit button](https://jane.app/thumbs/86b2fd49-d184-4dd9-8753-48e25da75321)
- ![screenshot of what it looks like to update this field and the calendar date picker](https://jane.app/thumbs/00e2f525-8a76-41db-b1c1-87d378f3ead9)
- ![screenshot of where to find the pencil icon and how to update the applied at date](https://jane.app/thumbs/66fad7ee-0b76-4cb1-a7ea-3b620eaabd60)
- ![screenshot of the orange button and Jane's final confirmation](https://jane.app/thumbs/886d652a-5f3b-4717-b8e4-63a2bbb575e5)
