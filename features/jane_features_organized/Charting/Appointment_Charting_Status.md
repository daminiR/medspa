...
*Source: [https://jane.app/guide/appointment-charting-status](https://jane.app/guide/appointment-charting-status)*

*Category: Charting*

*Scraped: 2025-08-07 00:56:24*
...
Feature OverviewAppointment Charting Status
Charting
Appointment Charting Status
4 min read
Balance Plan
...
As long as you are charting from the Day view or are ensuring that the appointment is selected when you create a chart note, then Jane will link the chart entry with the appointments.  See this help document on the
Sign and Lock Workflow
.
If you’ve forgotten to chart from your day sheet, you can now
assign your chart to an appointment
, or
change the appointment that it’s currently assigned to
. Check out our guide doc
...
You can also run the appointment report, which includes a column that displays chart status. This is a quick way to view a list of all the appointments that have no charts attached to them or have not been completed yet.
...
From the Dashboard
The Charts component of your
Practitioner Dashboard
will show the distribution of the practitioner’s signed, drafted, and never started chart entries for all arrived appointments within the past 90 days.
To access the practitioner dashboard, click the
Day
button in the upper-left corner of Jane, and then make sure the
Dashboard
toggle is on in the upper right corner.
...
📍 Note:
Only the Chart author is able to manage the appointment linked to a Chart entry.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Appointment Charting Status
Charting
Appointment Charting Status
4 min read
Balance Plan
Practice Plan
Thrive PlanSometimes you would like to review your appointments or those in your clinic to see if there are any appointments that haven’t been documented.
As long as you are charting from the Day view or are ensuring that the appointment is selected when you create a chart note, then Jane will link the chart entry with the appointments.  See this help document on the
Sign and Lock Workflow
.
If you’ve forgotten to chart from your day sheet, you can now
...
Once a chart has been associated with an appointment, you’ll notice a new calendar icon displaying on your charts, letting you know that this chart is attached to an appointment.
📍 Note:
Only the Chart author is able to manage the appointment linked to a Chart entry.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/11/09/8mjn22vf85_blob)
...
- ![](https://jane.app/system/dragonfly/production/2016/11/09/4lzc6e265w_blob)
- ![](https://jane.app/thumbs/860c8adf-040c-451d-bcae-e2b9029881cd)
- ![](https://jane.app/thumbs/04abf563-2c97-49b1-a94c-e355130e2ac4)
- ![](https://jane.app/thumbs/c1db9e95-817d-4290-a71f-1684812e4907)
