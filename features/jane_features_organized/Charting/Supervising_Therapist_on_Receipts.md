...
*Source: [https://jane.app/guide/supervising-therapist-on-receipts](https://jane.app/guide/supervising-therapist-on-receipts)*

*Category: Charting*

*Scraped: 2025-08-07 01:41:55*
...
Feature OverviewSupervising Therapist on Receipts
Staff Profiles
Supervising Therapist on Receipts
2 min read
Practice Plan
...
Enter both names and numbers in the
ID Numbers
area within the
Billing tab
...
If it’s only for certain session types,  you can change the
Billing name
on that type of session to reflect the supervisor:
Head over to the
Settings tab
and then to
Treatments, Classes & Group Appointments
in the left sidebar menu. Next, either click on the
blue text with the name of the treatment
or on the
Edit
button to the right of the treatment you’d like to update.
Once you scroll down to the
Details
section, you’ll want to make sure to add the Treatment name, the Supervisor’s name and their credentials in the
Billing Name
field.
3. Edit the invoice directly
If it’s just an occasional visit and you don’t want it on every invoice, you can also always edit any invoice with some extra details by clicking on the blue
Patient Invoice
in the
Billing Info
section of the Appointment Panel:
And then enter the info in the
“Details”
area and
Save:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Supervising Therapist on Receipts
Staff Profiles
Supervising Therapist on Receipts
2 min read
Practice Plan
Thrive PlanSometimes there are staff members that are being supervised by another therapist, and you would like the supervisor’s name and Registration number to show up on the receipt.
There are a few ways to do this in Jane:
1. You can add the supervising therapist’s name and license number to your staff profile
Enter both names and numbers in the
ID Numbers
...
Save:
In each case, you’ll see both numbers show up on the receipts and invoices.
As always, let us know if you have trouble finding the right place to enter the info!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/5d3289e6-4925-41d4-a970-4bbb9aa7ec34)
- ![](https://jane.app/thumbs/9ef9ad01-6c70-4d4a-a3b5-fa180e657030)
- ![](https://jane.app/thumbs/fc90371e-6b1a-4529-a982-fa83cac4afb5)
- ![](https://jane.app/thumbs/5de88b4f-31d0-4639-a8ec-98e058f3c86c)
- ![](https://jane.app/thumbs/04a210fd-8e3d-485b-b522-41d533b0e822)
- ![](https://jane.app/thumbs/c40d54ad-5587-4b01-ab10-5b84ac24ec64)
