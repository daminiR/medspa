...
*Source: [https://jane.app/guide/letters-in-jane](https://jane.app/guide/letters-in-jane)*

*Category: Charting*

*Scraped: 2025-08-07 01:05:49*
...
Feature OverviewLetters in Jane
Charting
Letters in Jane
4 min read
Balance Plan
...
We work with Jane’s flexible templates - what you might be used to as
Chart Templates
- to create these forms. Once created, these forms can then be saved as a PDF and emailed, or printed on letterhead and faxed or mailed.
💡
Jane Tip
: Did you know you can fax chart entries right from Jane? Check out our guide on
...
Once you’ve added your contact database portion, you can then choose the form letter you’d like to insert.
Complete the blanks that are unique to the client you are working with and then sign the entry:
Print or Save as Letterhead
Once signed you can print this single entry as a letter template.
Use the “cog” dropdown and choose print
Use the dropdown at the print preview stage to switch from “chart” style to “letterhead” style.
Final PDF
...
You can bill for letters by creating a product in Jane, similar to how you might bill for phone calls, chart notes, or other non-appointment-based services.
If you’d like to set this up, we have a step-by-step guide you can check out here:
Billing to Insurers Without an Appointment
.
Here are some additional resources:
Integrated Outbound Fax
Adding a Staff Signature to Charts
Creating Chart Templates
Assigning Charts to an Author
. This would be especially relevant if your admin staff are creating the template and filling in the basic info for you and then assigning it to you for the clinical info and your signature.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Letters in Jane
Charting
Letters in Jane
4 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansOften you need to send Progress Reports, Doctor Letters or other Form style Letters to people outside of your practice.
We work with Jane’s flexible templates - what you might be used to as
Chart Templates
- to create these forms. Once created, these forms can then be saved as a PDF and emailed, or printed on letterhead and faxed or mailed.
💡
...
Creating Chart Templates
Assigning Charts to an Author
. This would be especially relevant if your admin staff are creating the template and filling in the basic info for you and then assigning it to you for the clinical info and your signature.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2018/03/26/538dxl9p5b_image.png)
- ![](https://jane.app/thumbs/c9135a84-3a81-40e7-ac4d-13b342d35a2a)
- ![](https://jane.app/system/dragonfly/production/2018/03/26/4zmcwhlu2j_image.png)
- ![](https://jane.app/system/dragonfly/production/2018/03/26/1js3bfilw3_image.png)
- ![](https://jane.app/system/dragonfly/production/2018/03/26/4bmxdipwud_image.png)
- ![](https://jane.app/system/dragonfly/production/2018/03/26/5f8ol1gpcw_image.png)
- ![](https://jane.app/system/dragonfly/production/2018/03/26/9giovy7l1g_image.png)
