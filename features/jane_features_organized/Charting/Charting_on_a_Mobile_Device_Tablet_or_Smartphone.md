...
*Source: [https://jane.app/guide/charting-on-a-mobile-device-tablet-or-smartphone](https://jane.app/guide/charting-on-a-mobile-device-tablet-or-smartphone)*

*Category: Charting*

*Scraped: 2025-08-07 01:26:10*
...
Feature OverviewCharting on a Mobile Device (Tablet or Smartphone)
Charting
Charting on a Mobile Device (Tablet or Smartphone)
5 min read
Balance Plan
...
Open up your tablet or smartphone’s web browser,
enter your clinic’s URL
and let’s get started!
Charting on a Tablet
Charting on a Smartphone
Charting on a Tablet
With the screen being smaller, Jane won’t display all of the same options in the same way as a desktop or laptop. By default, Jane will land on the
Day
view for active practitioners. To begin charting, you can tap on an appointment on the schedule.
Jane will automatically open up the patient’s charts within a new screen, where you can tap on the blue
New Chart Entry
button to get started.
Once you’ve
Signed and & Locked the Chart
entry, you’ll want to hit the
Back
button in the top left corner to be redirected back to the
Day
view.
You’ll now see a
lock icon
to the right of the appointment as an indicator that the appointment has a completed chart attached to it:
If you work at more than one location on a specific day, Jane will display each of the shifts in the
Day
view. While there isn’t a visual indicator for which shift is for which location, you can add a little break right above the shift with the name of the location the shift is created for.
Charting on a Smartphone
While navigating Jane on a smartphone (i.e. iPhone or an Android phone), you’ll notice a few differences from the tablet version. Let’s start by logging into your Jane account through your phone’s web browser.
For practitioners, you’ll be directed to the
Day
view by default. Now you can tap on an appointment to get started.
Jane will automatically open up the patient’s charts within a new screen, where you can tap on the blue
New Chart Entry
button to get started.
Jane will display all the
chart parts
you can use to record your notes for the session or you can scroll down a bit to select a
chart template
.
Once you’ve
Signed and & Locked the Chart
...
You’ll now see a
lock
icon to the right of the appointment as an indicator that the appointment has a completed chart attached to it. For any unfinished charts, you’ll see a
lock icon that’s open
or if there’s no chart present, no icon at all.
Additional Resources:
We have a couple of guides related to using Jane on a tablet or a mobile device that may come in handy:
Using Jane on a Tablet
Using Jane on a Smartphone
Booking a Break on a Mobile Device
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Charting on a Mobile Device (Tablet or Smartphone)
Charting
Charting on a Mobile Device (Tablet or Smartphone)
5 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansWhether you’re using Jane on an iPad, Android tablet or smartphone, this guide walks through navigating charting on a smaller screen.
Open up your tablet or smartphone’s web browser,
enter your clinic’s URL
and let’s get started!
Charting on a Tablet
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An  image of what the navigation looks like on a tablet](https://jane.app/thumbs/5c0755af-e283-43e3-991a-56f132ff99a2)
- ![An image of where to view and tap on the new chart entry button in the charting area of a patient's profile](https://jane.app/thumbs/bcc957bf-7564-459d-a8b6-4164d62dea85)
- ![An image of where to tap on the back button to return to the day view](https://jane.app/thumbs/3fc83810-15bd-42ed-baa0-3043ab7a1807)
- ![An image of where the lock sign will appear in the top right corner of the appointment](https://jane.app/thumbs/22dad175-db57-45d4-a097-93405c37cad1)
- ![An image of what the day view looks like on a tablet with more than one shift in a day](https://jane.app/thumbs/fa0d5d1b-0836-4810-80d3-c37976a04783)
- ![An image of what it looks like for practitioners opening up a patient's chart on a smartphone](https://jane.app/thumbs/b6e27c70-687f-4ac5-9a55-7f5c45510981)
- ![An image of where to view and tap on the new chart entry button to begin charting on a smartphone](https://jane.app/thumbs/db89d2eb-9b8d-4329-9421-9f7fb4df798b)
- ![An image of what the chart part options are and the prompt to scroll down further on the screen to select a chart template](https://jane.app/thumbs/961c0e78-0423-4dfa-859f-8561545e882f)
- ![An image of where to view and tap on the Back button in the top left portion of the screen](https://jane.app/thumbs/59c7617e-7512-483c-bf44-711978fc9584)
- ![An image of what the icons in the top right of the appointments looks like](https://jane.app/thumbs/93222262-8d4d-493a-a58e-9bf9b607750f)
