...
*Source: [https://jane.app/guide/how-to-manage-a-wallet-or-bank-style-package-and-membership](https://jane.app/guide/how-to-manage-a-wallet-or-bank-style-package-and-membership)*

*Category: Charting*

*Scraped: 2025-08-07 02:04:31*
...
Feature OverviewHow to Manage a Wallet or Bank Style Package and Membership
Billing
How to Manage a Wallet or Bank Style Package and Membership
4 min read
...
Let’s explore how to set up an internal wallet or bank using
Jane’s Gift Card
feature. We can adapt this feature to suit your clinic’s packages or memberships, making it easy for patients and staff to redeem and manage credited dollar amounts according to your practice needs.
Creating the Bank Style Package or Membership
Head to the
Patients
tab in the top menu, and click the client’s name on the left-hand side. Click
Billing > Gift Cards > Click + New Gift Card
.
...
Jane Tip 💡: If you notice your Giftcards have a maximum, a Full Access User or the Account Owner can update the
Billing Settings
by heading to
...
With this offer, we might consider using Intake Forms to create a
Membership Terms & Agreement
. More on this through our guide in
Using Intake Forms for Consent.
...
Add a Product
to their invoice. In the case that your treatment bills by-product and the patient receives a discounted price, we often see providers either
Create a Product
to reflect their special bank pricing or use
Adjustments
.
In our example below, I added 25 units of the applicable Botox Units.
From here, once we select the
Pay
button at the top of the
Appointment Panel
, Jane will confirm the amount being paid, along with the product or treatment they are paying for in
Step 1: Receiving Payment
.
Once we head to
Step 2: Receiving Payment
, we’ll have the availability to
Add Payment Method
and
Redeem Gift Card…
.
...
Tracking Usage
In case you’d like to track the usage of the
Bank
, we often see providers use the
Note
section of the Gift Card.
To locate this area, you can head to
Patient Profile > Billing > Gift Cards > View
on the applicable Gift Card and use the Note section to update when and how many units or products were used.
We’d love to hear how you use bank-style memberships or packages in your practice and what would be helpful for you in Jane. We have some
Feature Requests
...
Allow Banking or Wallet Feature
Packages and Memberships to Include Products
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Manage a Wallet or Bank Style Package and Membership
Billing
How to Manage a Wallet or Bank Style Package and Membership
4 min readYou might consider setting up packages or memberships within Jane that act as a wallet or bank-style option for your patients to redeem from.
Let’s explore how to set up an internal wallet or bank using
Jane’s Gift Card
feature. We can adapt this feature to suit your clinic’s packages or memberships, making it easy for patients and staff to redeem and manage credited dollar amounts according to your practice needs.
Creating the Bank Style Package or Membership
...
below that you may be interested in adding your feedback to. When you upvote a feature request, you’ll be notified of its progress.
Allow Banking or Wallet Feature
Packages and Memberships to Include ProductsSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/f0694f59-73ae-4880-8ae3-a27fbe516499)
- ![](https://jane.app/thumbs/a223c05a-520d-46b7-831d-c54de76d0eee)
- ![](https://jane.app/thumbs/5ff62f66-511f-4530-b31c-cdc8da70dd46)
- ![](https://jane.app/thumbs/8142aacb-549a-40a9-b842-f75108a8bd1e)
- ![](https://jane.app/thumbs/78ab47f9-23d3-4978-98b8-f2fcff0621a2)
- ![](https://jane.app/thumbs/2fccbeae-7882-47c7-86ef-ff88954a9e91)
- ![](https://jane.app/thumbs/4c6e75b7-9053-4a78-adf4-1a233828a69a)
