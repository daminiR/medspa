...
*Source: [https://jane.app/guide/customizing-or-removing-the-footer-on-financial-documents](https://jane.app/guide/customizing-or-removing-the-footer-on-financial-documents)*

*Category: Charting*

*Scraped: 2025-08-07 02:10:14*
...
Feature OverviewCustomizing or Removing the Footer on Financial Documents
Billing
Customizing or Removing the Footer on Financial Documents
4 min read
Practice Plan
Thrive Plan
Legacy Plans
While we think footers are a great way to keep your patients in the loop, sometimes you want a cleaner look! This guide walks through how you can remove certain parts, like your billing address, from the footer on an invoice and where Jane pulls this information from.
Note
📝:
The footer is different from the fine print on invoices. If you’d like to update this language, a
Full Access
user can head over to the
Settings
tab, and click on
Billing Settings
within the left sidebar menu. Check out our guide on
Setting up Billing Settings
for more detailed information.
Here’s what an invoice looks like with the footer information included:
Here’s what an invoice looks like when the footer information is removed:
The language in the footer of financial documents comes from a couple of different areas. If you’re looking to remove the phone number and email address from the footer of an invoice, statement or receipt, you’ll want to start by heading over to the
Settings
tab and clicking on
Online Booking
...
and
Display Email Address
will also remove the contact information on your online booking site when shifts or treatment types are set to
Contact to Book
. Additionally, all financial and printed documents will have this information removed.
Make sure to hit the blue
Save
button at the bottom of the section to confirm those changes.
To remove the clinic’s legal name from the footer, click on
Locations
within the
Settings
tab and then
...
In the Legal Name field, you can enter a dash (-) if you would prefer no language here and hit
Update
since this is a required field.
Currently, the only way to remove the
Book your next appointment
text is to
disable
online booking overall. If your clinic is on the
Balance
Plan, no need to worry about this language!
For clinics on the
Practice
,
Thrive
...
Full Access
user can head over to the Settings tab, and click on
Online Booking
within the left sidebar menu. From there, you can select
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Customizing or Removing the Footer on Financial Documents
Billing
Customizing or Removing the Footer on Financial Documents
4 min read
Practice Plan
Thrive Plan
Legacy PlansWhile we think footers are a great way to keep your patients in the loop, sometimes you want a cleaner look! This guide walks through how you can remove certain parts, like your billing address, from the footer on an invoice and where Jane pulls this information from.
Note
📝:
The footer is different from the fine print on invoices. If you’d like to update this language, a
Full Access
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of a receipt with the footer information included](https://jane.app/thumbs/33c2ce66-36ae-4467-9712-c01b0cba3455)
- ![An image  of what the footer information looks like with the information removed](https://jane.app/thumbs/bf600804-bc44-4f87-a208-65c384db6104)
- ![An image of where to view and disable both options for the phone number and email address](https://jane.app/thumbs/20f6d0a1-3223-4a45-a758-8243d7669ba4)
- ![an image of the navigational steps](https://jane.app/thumbs/f8d32a68-2fa6-476c-a023-801d11f345af)
- ![An image of where to view and update the billing information for the location settings](https://jane.app/thumbs/e4f662d1-e0ae-4cd3-817b-e568ee0fabae)
- ![An image of the navigational steps](https://jane.app/thumbs/f4faa0b8-4497-4f82-8028-1bccfa5b1be8)
