...
*Source: [https://jane.app/guide/charting-for-classes-and-group-appointments](https://jane.app/guide/charting-for-classes-and-group-appointments)*

*Category: Charting*

*Scraped: 2025-08-07 01:21:13*
...
Feature OverviewCharting for Classes and Group Appointments
Charting
Charting for Classes and Group Appointments
4 min read
Balance Plan
...
With the
Copy to Client
feature, you can quickly copy a signed chart entry to all participants of a Class or Group Appointment.
Here’s how it works:
Once you have finished charting for one of the clients in a Class or Group Appointment, you’ll click
Sign
...
Why didn’t my group/class note copy over to all the participants?
How can I share feedback?
Can I copy a signed entry at a later date?
You bet! Start by clicking the
gear icon
at the bottom of the signed entry and then click the
Copy to Client
button.
What if I don’t need to copy any charts?
If the Copy to Client workflow doesn’t apply to you, simply click the
Skip
button. Jane won’t add a draft chart for the other attendees, so if you’d like to see if there are any appointments that haven’t been documented, this guide might be helpful
...
Why didn’t my group/class note copy over to all the participants?
Not to worry. This feature only works for chart entries that are
signed
and assigned
to Classes or Group Appointments
. So let’s start by checking two places:
First, you’ll want to make sure the entry is
signed
. To confirm this, a
lock symbol
will appear at the top right of the chart entry.
You’ll also want to ensure the chart entry is
assigned
to a
Class
or
Group Appointment
. If you do not see the calendar icon, that means the chart entry is not assigned to an appointment.
To assign the chart to an appointment, click the
drop-down menu
and then select
Add Appointment
.
...
date range
if needed and then select the appropriate appointment.
💡
Quick tip
: If you’re charting from your
Day View
, Jane will know to always assign your appointment to the chart!
How can I share feedback?
...
We want to keep improving this feature to make charting for groups even more helpful. If you have any feedback for us, we’d love to hear from you! You can
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Charting for Classes and Group Appointments
Charting
Charting for Classes and Group Appointments
4 min read
Balance Plan
Practice Plan
Thrive PlanTo the practitioners charting for Classes or Group Appointments (i.e., family or couples therapy), we have a time-saving treat for you. 🍫
With the
Copy to Client
feature, you can quickly copy a signed chart entry to all participants of a Class or Group Appointment.
Here’s how it works:
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/4ecb084c-d04e-4f20-b2d6-1b517ccdb425)
- ![](https://jane.app/thumbs/9794d8ef-8985-4d14-abb9-ce05e45324b0)
- ![](https://jane.app/thumbs/f8cb857a-1689-4006-8d13-bb77e6b446a3)
- ![](https://jane.app/thumbs/d1bdec32-56e9-4a32-9732-394f549f1e73)
- ![](https://jane.app/thumbs/a1240fc0-c15f-4d9b-b75b-7eef10fce124)
- ![](https://jane.app/thumbs/58585fb9-45b7-4e49-87bc-5e50b279b44d)
- ![](https://jane.app/thumbs/487abac4-e176-406c-b11c-6d515707d394)
