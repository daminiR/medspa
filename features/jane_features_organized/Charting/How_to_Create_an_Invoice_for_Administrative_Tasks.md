...
*Source: [https://jane.app/guide/how-to-create-an-invoice-for-administrative-tasks](https://jane.app/guide/how-to-create-an-invoice-for-administrative-tasks)*

*Category: Charting*

*Scraped: 2025-08-07 01:56:12*
...
Feature OverviewHow to Create an Invoice for Administrative Tasks
Billing
How to Create an Invoice for Administrative Tasks
3 min read
Do you need to charge your patients for an administrative task, such as an admin fee or report of findings? We’ve got you covered! You can take advantage of selling products as a way to invoice patients for additional admin costs outside of their usual booked appointments.
If you’d like, you can track the income generated from these admin tasks in a different
Income Category
. This allows you to filter specific sales in your billing reports in case you’d like to track those sales separately from treatment income.
Click here to learn how to create an Income Category
.
Create a Product
You’ll need to create a product for each admin task you would like to invoice.
Head to
Settings > Products
> then select the
New Product
button
Fill in the information of the product: the
name, price, and income category
are required, the other fields are optional!
Click
Create Product
Invoice the Patient for the Admin Fee
Once the product is created, you are ready to invoice it to your patient! There are two ways you can sell the product to the patient.
Adding products from the Appointment Panel
When you arrive an appointment, you can click on the dropdown beside the “
Pay”
button and click “
Add Items
...
In the
“Add a Product…”
box, search for the admin task you would like to invoice. To update the quantity, type a number in the quantity box and Jane will multiply it by the product price to calculate the total for you.
From here, you can click “
Save
”, or “
Receive Payment
” straight away!
Adding the product from the patient’s profile whether or not they have an appointment
No problemo! Simply head to the patient’s profile, head to the
Billing
tab, and click “
New Purchase
”
Just like adding a product from the appointment panel, search for the admin task you would like to invoice in the
“Add a Product…”
box. To update the quantity, type a number in the quantity box and Jane will multiply it by the product price to calculate the total for you.
Click “
Save
”, or “
Receive Payment
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)How to Create an Invoice for Administrative Tasks
Billing
How to Create an Invoice for Administrative Tasks
3 min readDo you need to charge your patients for an administrative task, such as an admin fee or report of findings? We’ve got you covered! You can take advantage of selling products as a way to invoice patients for additional admin costs outside of their usual booked appointments.
If you’d like, you can track the income generated from these admin tasks in a different
Income Category
. This allows you to filter specific sales in your billing reports in case you’d like to track those sales separately from treatment income.
Click here to learn how to create an Income Category
...
Receive Payment
” straight away!
Voila!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/38867543-8460-4b9d-8456-95328f3b0bf6)
- ![](https://jane.app/thumbs/c5291426-fae6-4b4e-adee-0c60fd895a83)
- ![](https://jane.app/thumbs/f831c3ba-fc8c-46b0-8be1-ff175bbbe4b8)
- ![](https://jane.app/thumbs/e34b3803-7c2c-4f67-a987-81fcaa9555cc)
- ![](https://jane.app/thumbs/f831c3ba-fc8c-46b0-8be1-ff175bbbe4b8)
