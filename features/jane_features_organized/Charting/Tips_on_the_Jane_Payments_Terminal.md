...
*Source: [https://jane.app/guide/tips-on-the-jane-payments-terminal](https://jane.app/guide/tips-on-the-jane-payments-terminal)*

*Category: Charting*

*Scraped: 2025-08-07 02:16:02*
...
Feature OverviewTips on the Jane Payments Terminal
Jane Payments
Tips on the Jane Payments Terminal
2 min read
👋 “It was so good to see you, and I hope you enjoyed your treatment today. Would you… like to leave a tip?”
Well, that’s an awkward way to end a conversation
.
Good thing you can avoid that with the help of your Jane Payments Terminal!
You can have your terminal privately prompt your clients to leave a tip so you don’t have to.
But wait, there’s more! Check out these neat tip-related features we’re so excited to be able to offer through the Jane Payments Terminal:
Choose three pre-set percentage amounts
your clients can quickly choose from (as well as the option to enter a custom amount or to skip the tip entirely)
Turn off tips during a particular client’s checkout
with one click, if it’s not an appropriate time to prompt for a tip
...
This is where you’ll be able to manage your terminal, including the name of it and which Location it lives at,
Enable Save Cards
and
Enable Tips!
...
Receive Payment
screen directly under the total on Step 2, you can uncheck the box that says ‘Allow tipping on this terminal payment?’
Note
📝:
Tips are only customizable on the terminal at the moment.
We hope this helps you make a little extra dough without the uncomfortable interactions!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Tips on the Jane Payments Terminal
Jane Payments
Tips on the Jane Payments Terminal
2 min read👋 “It was so good to see you, and I hope you enjoyed your treatment today. Would you… like to leave a tip?”
Well, that’s an awkward way to end a conversation
.
Good thing you can avoid that with the help of your Jane Payments Terminal!
You can have your terminal privately prompt your clients to leave a tip so you don’t have to.
...
- ![](https://jane.app/thumbs/31ac7343-e6f6-4c8f-a6b7-00b047c49f47)
- ![](https://jane.app/thumbs/d2806988-b0d4-4000-ae06-ee150948b1c8)
- ![](https://jane.app/thumbs/1c0b5493-d995-4381-a51f-f6391edb71d8)
