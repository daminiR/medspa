...
*Source: [https://jane.app/guide/refunding-a-product-inventory-purchase](https://jane.app/guide/refunding-a-product-inventory-purchase)*

*Category: Charting*

*Scraped: 2025-08-07 01:40:33*
...
Feature OverviewRefunding a Product/Inventory Purchase
Billing
Refunding a Product/Inventory Purchase
4 min read
Balance Plan
Practice Plan
Thrive Plan
This article refers to refunding a sold item. This typically would be a product sold from your
Product list
.
...
.
To fix a
payment taken or applied in error
, see
this one
.
...
Select
Refund Purchase
This tells Jane to add the number of units sold back to the product inventory and disconnect the payment from this product.  The payment will now be available as a credit on the patient’s account.  If a staff member was assigned to the product sale, in the staff member’s Compensation Report the refund will be deducted from the staff member’s compensation. However, this does NOT create a refund on your Transaction Report, since
at this point the patient has not been given any money back
.  The patient can either use this credit for future appointments/sales, or you can refund using the second step below.
Pro Tip:
If the product was invoiced erroneously and no payment has been applied yet, select
Delete Purchase
instead to remove it from the patient’s account without creating a refund activity line.
2. Refund the Money
In the Patient’s Billing tab, head to
Payments
Click
View
next to the payment associated with the original purchase
Click the
Refund
button
...
This refund will now be on the corresponding practitioner’s
Compensation report
as well as the
Transaction report
for that day. Un-applying the payment will take the payment off of the Compensation report while processing the refund will create a negative transaction on the Transaction report.
...
Click
View
next to the original product payment
Unapply the payment
by clicking on the broken chain link symbol
Close the payment screen and click
View
again
The product will now show in the Outstanding invoice list. Type in how much money you
want to keep
, as the leftover is what you will refund back to the patient
Click
Apply
At the top of the page, you’ll see that you can refund the difference
2. Write Off the Difference
Their product invoice will now be in a
Partially Paid
state and you can write off the difference.
Head back to the patient’s
Billing > Purchases
tab
...
, you can click
View Log
on a Product to see its sales log. This shows a history of the product’s inventory additions and depletions:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Refunding a Product/Inventory Purchase
Billing
Refunding a Product/Inventory Purchase
4 min read
Balance Plan
Practice Plan
Thrive PlanThis article refers to refunding a sold item. This typically would be a product sold from your
Product list
.
If you’re looking to
refund an appointment
...
, you can click
View Log
on a Product to see its sales log. This shows a history of the product’s inventory additions and depletions:Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/6b3d9418-614f-49a1-b6e5-189d8ef68ba3)
- ![](https://jane.app/thumbs/708ca666-fddb-4a52-9fa5-4f8cddc668e6)
- ![](https://jane.app/thumbs/c39a0b98-af66-4cfe-9756-49627372c984)
- ![](https://jane.app/system/dragonfly/production/2017/01/04/8o9srug8l1_blob)
- ![](https://jane.app/thumbs/71e55a6f-69cf-4ff8-8825-1ca5d9c2d635)
- ![](https://jane.app/thumbs/f884419a-b738-4072-ab9c-e39b69a3f696)
- ![](https://jane.app/thumbs/e191f725-23b8-41bc-a5d0-89412e459e69)
- ![](https://jane.app/thumbs/787e3b04-8367-439d-9460-10e227d9a144)
- ![](https://jane.app/thumbs/11107b01-90c6-47a3-8dd2-680be7c10f13)
- ![](https://jane.app/thumbs/64919321-d60f-48fb-ae0f-f86a032c2767)
