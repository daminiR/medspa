...
*Source: [https://jane.app/guide/adding-billing-diagnosis-codes-to-charts-on-the-base-plan](https://jane.app/guide/adding-billing-diagnosis-codes-to-charts-on-the-base-plan)*

*Category: Charting*

*Scraped: 2025-08-07 01:05:02*
...
Feature OverviewAdding Billing & Diagnosis Codes to Charts on the Base Plan
Charting
Adding Billing & Diagnosis Codes to Charts on the Base Plan
2 min read
...
Legacy Base Plan
only.
When creating a chart template, you can use
Note
,
Drop Down
, and/or
Check Box
items to manually enter codes into your chart entries.
If you were to use a
Drop Down
item, you could include your most popular codes as options within the drop down, and select the relevant code(s) when charting for your patient.
Similarly, if you were to use a
check box
item, you could include each of your most popular codes as check box options, and check off the relevant code(s) when charting for a patient.
Lastly, if you were to use a
Note
, you could simply type in the code(s) relevant to the patient’s visit.
...
Please note that the use of Drop Downs, Notes, and Check Boxes in your charts for the purpose of including codes is merely a
suggestion
! It’s best to contact your
college or licensing body
as to what their specific requirements are for displaying codes in your chart entries.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Adding Billing & Diagnosis Codes to Charts on the Base Plan
Charting
Adding Billing & Diagnosis Codes to Charts on the Base Plan
2 min read💡Heads up — this guide is applicable for the
Legacy Base Plan
only.
When creating a chart template, you can use
Note
...
! It’s best to contact your
college or licensing body
as to what their specific requirements are for displaying codes in your chart entries.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/dcaa23ec-52f6-4bee-a744-46140ddc7c2e)
- ![](https://jane.app/thumbs/b4ac67d3-1068-45c1-b4ee-60745e9fe4e5)
- ![](https://jane.app/thumbs/32a59770-0fa0-4379-b53b-375ae1f2546c)
