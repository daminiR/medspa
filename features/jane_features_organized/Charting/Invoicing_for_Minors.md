...
*Source: [https://jane.app/guide/invoicing-for-minors](https://jane.app/guide/invoicing-for-minors)*

*Category: Charting*

*Scraped: 2025-08-07 02:05:10*
...
Feature OverviewInvoicing for Minors
Billing
Invoicing for Minors
3 min read
Hey there!
...
Once you have arrived the appointment by clicking the
Arrive
button at the top of the appointment panel,  you can edit the details of the receipt by scrolling down to the Billing Info section of the appointment panel and clicking on the blue client invoice text:
You can then add any additional text in the Details area and click
Save
at the bottom when you’re done.
Here is what it would look like on the invoice:
That’s it!
If you’d like, you can check out our guide
Payments for Related Clients
to see how you can use Jane’s relationships feature to accurately reflect the payer of an invoice (and the payment method) when one client is paying for someone else. For this workflow, both clients, in this case parent and child, must have a profile in your account.
We do currently have a feature request for being able to set the Bill To: to the parent. You can click the link
here
to vote on the request and add any feedback.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Invoicing for Minors
Billing
Invoicing for Minors
3 min readHey there!
Are you a practitioner who sees clients who are minors? If so, this guide will show you how to edit invoices in Jane to include the name of the parent or guardian who will be paying for the visit.
...
here
to vote on the request and add any feedback.
This is so helpful for our team as we decide which features to build in Jane and how they should look.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/a83411f8-5297-48c7-aeee-ad617fddfd86)
- ![](https://jane.app/thumbs/c157d8ea-a025-40ed-ab47-12ac1b237d3b)
- ![](https://jane.app/thumbs/22ea2121-be08-405a-89cb-bcb95dcaf051)
