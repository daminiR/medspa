...
*Source: [https://jane.app/guide/hide-client-information-from-financial-emails](https://jane.app/guide/hide-client-information-from-financial-emails)*

*Category: Charting*

*Scraped: 2025-08-07 01:50:16*
...
Feature OverviewHide Client Information from Financial Emails
Billing
Hide Client Information from Financial Emails
3 min read
Balance Plan
...
The
Hide Client Information from Financial Emails
preference allows clinics to choose how they would like their clients to receive emailed copies of their receipts, invoices, and other financial documents.
...
If you are interested in the technical details of sending data over email, refer to our security article on
Email Encryption
.
...
A
full-access user
can enable this feature under the
Settings Tab > Billing Settings
area. This will hide client information from all financial emails. This includes receipts, invoices, statements, and superbills (US only).
...
We created
this guide document for clients
to showcase the client experience if you’re interested!
Relationships
If a client has a
relationship
set up with the permission to “Receive a copy of receipts, statements, and financial emails”, the relationship will also receive a copy of the secure link.
Keep in mind that the relationship will be required to log into Jane
with their own credentials
in order to access the receipt.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Hide Client Information from Financial Emails
Billing
Hide Client Information from Financial Emails
3 min read
Balance Plan
...
Keep in mind that the relationship will be required to log into Jane
with their own credentials
in order to access the receipt.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/44fd2eed-7bae-41d6-9c88-967fccede261)
- ![](https://jane.app/thumbs/33b2e45d-87e3-4825-b038-a15576de395d)
- ![](https://jane.app/thumbs/0052ffc1-ef85-4665-b313-72749e664e7c)
- ![](https://jane.app/thumbs/33d21dcb-4e2e-4b65-99c0-4fe1d8bbdd1d)
- ![](https://jane.app/thumbs/4dfc8026-aa2e-428d-b237-83a70fb0905a)
- ![](https://jane.app/thumbs/b915f04b-76b0-4b89-af17-72bc0444df6c)
