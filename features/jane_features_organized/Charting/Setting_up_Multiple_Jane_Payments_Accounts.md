...
*Source: [https://jane.app/guide/setting-up-multiple-jane-payments-accounts](https://jane.app/guide/setting-up-multiple-jane-payments-accounts)*

*Category: Charting*

*Scraped: 2025-08-07 01:57:35*
...
Feature OverviewSetting up Multiple Jane Payments Accounts
Billing
Setting up Multiple Jane Payments Accounts
3 min read
Balance Plan
...
unique email address for each Jane Payments account
& to be a
Full Access
user of your Jane account
.
First, you’ll want to head to the
Settings > Jane Payments
area of your Jane account, and click on the + Add Item button. You’ll then select New Account.
...
You can also access this area from your
Settings > Jane Payments
area, and click the
Pencil
icon beside each Jane Payment account.
Once you’re here, you’ll have four options:
Name
- this is how Jane will reference your payments account only in Jane. We’d suggest naming this after a particular practitioner or location.
Location
- optionally set this payments account to only be used at a location you’ve set up in Jane.
Staff
- optionally set this payments account to only be used for a particular staff member’s online payments, such as online booking prepayments, and pay balance emails. If you’re a solo practitioner, we’d recommend leaving this as “All Staff.”
Statement Descriptor
- this is what will show up on your client’s credit card statement. Make sure it’s something that they’ll recognize!
...
If you’re setting up Jane Payments and want to chat things through, you can connect with us at
payments@jane.app
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Setting up Multiple Jane Payments Accounts
Billing
Setting up Multiple Jane Payments Accounts
3 min read
Balance Plan
Practice Plan
Thrive PlanWith Jane Payments, you can process credit cards right from within Jane! But what if you want those transactions to deposit into different bank accounts, depending on which practitioner took the payment, or which location it happened at? We have you covered!
All you’ll need is a
unique email address for each Jane Payments account
& to be a
Full Access
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/4f7ac632-1cdd-46bd-939f-c19490c589ef)
- ![](https://jane.app/thumbs/b8fc03cc-059c-41bb-8718-2150c5548204)
- ![](https://jane.app/thumbs/16822052-47fe-4772-b7fb-dc34cd9ae699)
- ![](https://jane.app/thumbs/ed94a420-1920-48cc-aa57-2804791c9315)
