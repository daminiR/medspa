...
*Source: [https://jane.app/guide/bookkeeping-hub](https://jane.app/guide/bookkeeping-hub)*

*Category: Charting*

*Scraped: 2025-08-07 02:10:54*
...
Feature OverviewBookkeeping Hub
Billing
Bookkeeping Hub
5 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Designed specifically for book keepers and accountants, this hub offers a centralized location for all your financial reporting and billing needs.
Financial Reports in Jane
Reconciling Clinic Finances
Additional Resources and FAQs
Financial Reports in Jane
Our
Billing Reports
guide walks through all of the various financial reports in Jane, ranging from tracking cash flow, showing taxes invoiced or collected, reconciling your daily POS cash-out and calculating your clinic’s payroll.
Check out our
Jane Payments Transactions, Payouts, and Monthly Processing Reports
for some tips and tricks on how to reconcile your payouts with your bank statements.
Reconciling Clinic Finances
For a quick overview of each aspect of
Setting Up Your Billing Settings
in Jane.
Explore how a
Reconciliation Date
can help keep track of any changes that have been made to past invoices from different periods through
Invoice Reversals
.
Explore all the different
Strategies for Investigating Reports
and resources that you have at your disposal when taking a deeper dive into your clinic’s numbers.
Need help with sorting out some mystery balances? Check out our
Credits and Owings - Investigating
for all the tips and tricks!
We understand that the end of the year is a busy time for everyone, so we put together
Jane’s Tips for Year End
, which is a handy checklist to ensure a smooth rollover for your clinic into the new year.
Nothing is more satisfying than having all your accounts balance after some careful calculations. Our
Reconciling Your Accounts Receivable (A/R) Between Periods
guide is a deep dive into how you (or your bookkeeper) can keep track of outstanding invoices as of a given date.
For US-based clinics that bill insurance, explore our
Insurance Specific Reporting (US)
guide, as Jane has a few key reports and workflows that help you stay on top of your insurance billing.
Adjusting Invoice Dates
is handy if you need to ensure that the totals listed within the
Sales Report
are recorded accurately within the correct periods.
Learn
How to Edit the Received and Applied Dates of Payments
to help balance totals reflected on the
Transaction Report
.
Take a look at our
Working with the Purchase, Invoice, Received At, and Applied Dates
guide for a detailed breakdown of how all the billing dates interact with financial reports in Jane.
Additional Resources & FAQs
Check out our handy
Accounting Software and Jane
and
Importing Sales to Quickbooks Online (QBO) from Jane
guides for all the details on how bookkeepers can use Jane and accounting software like Quickbooks together.
Want to become an Excel wizard with your exported Jane reports? Get all the tips and tricks in our
Exporting Reports and Customizing them in Excel
guide.
For our US clinics, learn more about mastering tax season with our webinar on
Tax Tips for your Business with Bench Accounting
and our bonus Q&A session on
Common questions businesses ask during tax season
.
The
Reporting FAQs
guide is a compilation of some of the most frequently asked questions we receive about working with reports in Jane.
We’ve put together a
Payroll Guide Hub
to help walk you through it all, from setting up Timesheets to managing commissions.
Connect With Us
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Bookkeeping Hub
Billing
Bookkeeping Hub
5 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansDesigned specifically for book keepers and accountants, this hub offers a centralized location for all your financial reporting and billing needs.
Financial Reports in Jane
Reconciling Clinic Finances
Additional Resources and FAQs
Financial Reports in Jane
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![An image of where to view and enter email for subscriptions sign up](https://jane.app/thumbs/e71fad0c-d25a-4f4e-8334-21fd2bc8493f)
