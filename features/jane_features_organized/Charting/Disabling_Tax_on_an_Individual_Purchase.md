...
*Source: [https://jane.app/guide/disabling-tax-on-an-individual-purchase](https://jane.app/guide/disabling-tax-on-an-individual-purchase)*

*Category: Charting*

*Scraped: 2025-08-07 02:03:59*
...
Feature OverviewDisabling Tax on an Individual Purchase
Billing
Disabling Tax on an Individual Purchase
2 min read
Balance Plan
...
❗️ Please note that the following workflow is only applicable if you intend to disable all taxes on a purchase. It will not work if your purchase includes multiple types of taxes, and you want to disable only one of them (e.g., a purchase with HST and GST where you wish to disable only GST). In such cases, we recommend setting up a separate treatment type for those appointments.
You’ll want to begin by heading to the Purchase panel. This can be done by clicking on an appointment in your Schedule so that the Appointment panel pops up and you can click
View
in the Billing Info section.
Or you can access it directly from the Patient Profile by heading to their
Billing
tab and clicking
View
on the purchase.
In the Purchase panel, simply uncheck the
...
For more info on taxes in Jane and how to set those up, feel free to check out our
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Disabling Tax on an Individual Purchase
Billing
Disabling Tax on an Individual Purchase
2 min read
Balance Plan
Practice Plan
Thrive PlanSometimes there are situations where you may need to disable tax on a specific purchase. For instance, perhaps you have an individual patient who is tax-exempt.
In these cases, Jane’s got your back with a quick workflow you can use to remove tax on a purchase.
❗️ Please note that the following workflow is only applicable if you intend to disable all taxes on a purchase. It will not work if your purchase includes multiple types of taxes, and you want to disable only one of them (e.g., a purchase with HST and GST where you wish to disable only GST). In such cases, we recommend setting up a separate treatment type for those appointments.
You’ll want to begin by heading to the Purchase panel. This can be done by clicking on an appointment in your Schedule so that the Appointment panel pops up and you can click
View
...
For more info on taxes in Jane and how to set those up, feel free to check out our
Setting Up Sales Taxes in Jane
Jane guide.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![Screenshot of the Appointment panel in the Schedule](https://jane.app/thumbs/2ba19bc9-d6e6-4426-a28a-6dc03904823f)
- ![Screenshot of the Billing tab in a Patient Profile](https://jane.app/thumbs/8a69941e-90e3-4a9d-957b-d3a9d1902b62)
- ![Screenshot of the Purchase panel](https://jane.app/thumbs/74ececd1-9905-4934-a1b4-8e220ce51d8d)
