...
*Source: [https://jane.app/guide/things-to-know-when-taking-your-first-payments-in-jane](https://jane.app/guide/things-to-know-when-taking-your-first-payments-in-jane)*

*Category: Charting*

*Scraped: 2025-08-07 01:45:58*
...
Feature OverviewThings to Know When Taking Your First Payments In Jane
Billing
Things to Know When Taking Your First Payments In Jane
2 min read
Balance Plan
Practice Plan
Thrive Plan
So, you’ve gone through the process of
Creating Payment Methods
, and you’ve mastered the art of arriving your patients and you’re ready to take your first payments in Jane 💰. How exciting!
The first step is going to be to press the blue “Pay” button at the top right of the appointment panel.
This is going to bring up the Receive Payment screen.
You can simply hit the next button if you’re ready to take a payment, or follow these instructions if you need to
Partially Pay an Invoice
.
Now, if this is your first time taking a payment for this patient, you might see what looks like a scary warning/error message saying you need to add funds or reduce the amount you’re collecting in order to continue, but this will go away once we actually select the payment method you want to use for this patient!
...
If your patient wants to pay using multiple payment methods, you can learn how to do that
here
. Once you’ve selected your patient’s preferred payment method(s), you can go ahead and hit pay. The button you select here will depend if you want to generate a printed or emailed receipt, or if you don’t want to generate a receipt at all.
Now you’re all set! If you ever need to know how to reverse (we call it un-apply) a payment, you can learn how to do that
here
if that ever comes up for you.
Happy Billing!
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Things to Know When Taking Your First Payments In Jane
Billing
Things to Know When Taking Your First Payments In Jane
2 min read
Balance Plan
Practice Plan
Thrive PlanSo, you’ve gone through the process of
Creating Payment Methods
, and you’ve mastered the art of arriving your patients and you’re ready to take your first payments in Jane 💰. How exciting!
The first step is going to be to press the blue “Pay” button at the top right of the appointment panel.
This is going to bring up the Receive Payment screen.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/49b3bdbb-dd20-4b7a-b815-1aa91caa776c)
- ![](https://jane.app/thumbs/fe2b4d42-2004-40b2-b932-61e3310e2768)
- ![](https://jane.app/thumbs/3539f0aa-88cd-4fd3-8a15-5d77c2e83081)
- ![](https://jane.app/thumbs/0839eda9-9c8e-4827-9636-fc60aa8e1bf5)
