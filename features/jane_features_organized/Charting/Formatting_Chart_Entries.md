...
*Source: [https://jane.app/guide/formatting-chart-entries](https://jane.app/guide/formatting-chart-entries)*

*Category: Charting*

*Scraped: 2025-08-07 01:20:45*
...
Feature OverviewFormatting Chart Entries
Charting
Formatting Chart Entries
3 min read
Balance Plan
...
Use your
cursor to highlight
the text you’d like to format.
A toolbar will appear, giving you the option to
Bold (B)
, Underline (U),
Italicize (I)
,
Link
(🔗), and create Bulleted or Numbered lists. If you get a little carried away, you can also use the crossed-out ‘T’ on the far right to remove it all.
🥳
Formatting is available in any
Note field
that you chart in. You can add formatting to your
Chart Templates
and
Phrases
, as well as directly into your Chart Entries.
...
Which of the above chart entries do you find easier to read and understand? If you said the one on the
left
, we totally agree!
...
🌶
Hot tip:
any links you add will be available for Clients in their My Account area when you
share a Chart Entry with them
.
...
Using
AI Scribe
can make formatting your chart entries faster and easier! Let AI help you create clear, organized notes so you can focus more on patient care.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Formatting Chart Entries
Charting
Formatting Chart Entries
3 min read
Balance Plan
Practice Plan
Thrive PlanDid you know you can add formatting to your Charting in Jane? If you haven’t checked it out yet, we definitely recommend it.
Want to give it a try?
Use your
cursor to highlight
the text you’d like to format.
...
AI Scribe
can make formatting your chart entries faster and easier! Let AI help you create clear, organized notes so you can focus more on patient care.
We hope you’re as excited about this as we are.💃 As always, if you have any questions, you can give us a shout and we’ll be happy to help. Happy formatting!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/c6e3d80a-f5f0-47d3-a7a9-531be2205e8d)
- ![](https://jane.app/thumbs/1cfb05b4-bd7f-410a-9c89-c8bd51c0a0f6)
- ![](https://jane.app/thumbs/190b0a28-abba-4bd3-b336-07fba08f2f21)
