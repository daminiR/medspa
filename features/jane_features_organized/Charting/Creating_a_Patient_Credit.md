...
*Source: [https://jane.app/guide/creating-a-patient-credit](https://jane.app/guide/creating-a-patient-credit)*

*Category: Charting*

*Scraped: 2025-08-07 01:33:47*
...
Feature OverviewCreating a Patient Credit
Billing
Creating a Patient Credit
3 min read
Balance Plan
Practice Plan
Thrive Plan
Ever need to accept a patient payment without booking an appointment or selling a product?
Introducing credits!
To add a credit to a patient’s profile, you can overpay an invoice (through cash, cheque or whatever method of payment chosen to overpay) or create a payment without applying it to an invoice.
Recording an Overpayment
For this method, we’ll be recording a payment for more than what the client or patient would be charged for just the owed amount on the invoice. In the images below, you can see that the amount owing is $100.  Taking a payment of $300 will apply $100 towards the invoice, and leave a $200 credit on the patient’s account. You can do this from any screen where you would normally receive a payment.
...
workflow to use the credit on an outstanding balance on a related client’s profile.
Option 2
: Another alternative would be to load a Gift card using a gift card, since gift cards can be redeemed by any client or patient profile.
For more details on this process, check out our guide:
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Creating a Patient Credit
Billing
Creating a Patient Credit
3 min read
Balance Plan
Practice Plan
Thrive PlanEver need to accept a patient payment without booking an appointment or selling a product?
Introducing credits!
To add a credit to a patient’s profile, you can overpay an invoice (through cash, cheque or whatever method of payment chosen to overpay) or create a payment without applying it to an invoice.
Recording an Overpayment
For this method, we’ll be recording a payment for more than what the client or patient would be charged for just the owed amount on the invoice. In the images below, you can see that the amount owing is $100.  Taking a payment of $300 will apply $100 towards the invoice, and leave a $200 credit on the patient’s account. You can do this from any screen where you would normally receive a payment.
...
How to Transfer a Patient Credit Using a Gift Card
As always, if you have any additional questions, feel free to
reach out to our support teamSubscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/06/23/6xy24y8k23_blob)
- ![](https://jane.app/system/dragonfly/production/2016/06/23/2t9k6nhg9m_blob)
- ![](https://jane.app/system/dragonfly/production/2016/06/23/3oprx1fwxb_blob)
- ![](https://jane.app/system/dragonfly/production/2016/06/23/7prc3caqfw_blob)
- ![](https://jane.app/system/dragonfly/production/2016/06/23/5lpodzxjb4_blob)
