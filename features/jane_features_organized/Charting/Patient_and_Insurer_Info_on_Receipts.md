...
*Source: [https://jane.app/guide/patient-and-insurer-info-on-receipts](https://jane.app/guide/patient-and-insurer-info-on-receipts)*

*Category: Charting*

*Scraped: 2025-08-07 01:38:30*
...
Feature OverviewPatient and Insurer Info on Receipts
Billing
Patient and Insurer Info on Receipts
2 min read
Balance Plan
...
From the Patient’s Billing Tab, you can go to their Purchases and filter down to the visit or visits you’d like displayed.  Note that you’ll want them to be
blue
so if you use filters to get down to a list you’d like, just hit the “select all” button to turn the entire list blue.  Or if you only want a few of the visits, click them individually to create a custom set.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Patient and Insurer Info on Receipts
Billing
Patient and Insurer Info on Receipts
2 min read
Balance Plan
Practice Plan
Thrive PlanHi Jane Peeps,
High time we made this a support doc.
Many of you have asked about getting both the insurer and the patient portion onto a single receipt.  Here’s how you can find that information!
From the Patient’s Billing Tab, you can go to their Purchases and filter down to the visit or visits you’d like displayed.  Note that you’ll want them to be
blue
...
From there you will see some further filters at the top of the Statement - you can choose to show just Patient info, just Insurer info or both.  You can also filter to only invoices, only payments or both invoices and payments. Once you’ve set the filters hit the “filter” button to have them come into effect:
The “email” button will email the statement directly to the patient, or print it out.
I hope that helps!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/system/dragonfly/production/2016/01/29/7p4v0fonrh_blob)
- ![](https://jane.app/system/dragonfly/production/2016/01/29/2ef4bt2m19_blob)
