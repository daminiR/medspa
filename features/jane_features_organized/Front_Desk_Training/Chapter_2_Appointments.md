...
*Source: [https://jane.app/guide/chapter-2-appointments](https://jane.app/guide/chapter-2-appointments)*

*Category: Front-Desk Training*

*Scraped: 2025-08-06 23:59:20*
...
Feature OverviewChapter 2: Appointments
Front-Desk Training
Chapter 2: Appointments
7 min read
Balance Plan
...
💡
Jane Tip:
We recommend heading over to Jane’s Demo Clinic to practice as you learn!
Contact us
to request access.
Chapter 2: Working with appointments
Now that we’re feeling comfortable navigating the schedule and booking appointments, we can learn how to book repeat appointments, and how to reschedule appointments in case one of our patients can no longer make it, or change their mind.
...
When you click
Copy
, Jane duplicates the appointment - so you don’t have to re-enter the details. You’re creating a new appointment, not changing the original.
Rescheduling an appointment:
Sometimes a patient needs to move their appointment to a new time or even a different provider. Here are two easy ways to reschedule:
Option 1: Drag and drop
Great for moving an appointment within the same week — or to a different staff member at the same time.
Click and hold the appointment.
Drag it to the new time or Shift.
Release — and you’re done!
Option 2: Using the Move button
This second method is for when the appointment is being rescheduled to a different week or month. To use the move tool, click on the appointment to open up the
appointment panel
. Next, click on the Move button.
You’ll be redirected back to the schedule page, except a little notice will appear on the top of the page, letting you know there is a specific appointment that is currently being moved.
Navigate to the new date within the schedule and click on the start time of the appointment. Jane will give you the option of just confirming the change or sending out a notification to the client or patient of the updated time of their appointment.
Note
📍: You will only see the option to
Move
appointments that haven’t been marked as “Arrived”.
Cancelling appointments:
Appointment cancellations happen for a variety of reasons. If you have an appointment on the schedule that you need to cancel, this can be done right inside the appointment panel.
...
To manage how cancelled or deleted appointments appear:
Go to Schedule Settings (⚙️).
Toggle on/off
Cancelled
appointments.
More details:
...
Instructions:
First, let’s rebook an appointment using the
Copy
button.
Find an appointment in the Schedule. Inside the Appointment panel, click the
Copy
button below Booking Info.
...
To finish copying, click any available spot in the schedule. A green message will appear to let us know this was successful and we will now see our copied appointment in our selected spot. This will copy over all of the details for this appointment.
Next, choose any unarrived appointment from the Schedule. Underneath Booking Info, click on the
Cancel/Delete button
.
Select one of the Cancellation reasons or Delete this appointment. Remember that Cancelling an appointment notifies the patient, while Deleting does not. (Don’t forget you can quickly view cancelled or deleted appointments in your schedule by clicking on the cog wheel icon in the bottom right and togging those on.)
Bravo!
💡
Jane Tip
: You can set custom fees for late cancellations and no-shows. Add as many options as you need — flat fee, percentage, or full price.
Learn more
Using the Wait List:
Managing a practitioner’s wait list in Jane is easy and painless. Jane’s Wait List is built right into the schedule. It’s simple to access and helps your team stay on top of patient needs. Watch the video to see Jane’s Wait List in action:
💡
Jane Tip:
It’s often handy to add a note to a patient’s wait list request so other staff in the clinic know what’s going on.
If you’d like to learn more, you can head on over to our
Hub guide
on all things Wait List Management.
Double Book appointments:
Need to squeeze someone in? Jane allows staff to double book with the keyboard shortcut, typing “D”.  This allows staff members to double book appointments on the schedule, but will not allow patients to double book online.
This feature is popular with practitioners who rotate between treatment rooms, such as physiotherapists, acupuncturists, and chiropractors.
...
Hit the
D key
on your keyboard. You will notice all existing appointments will shift over to the left, creating space to book adjacent appointments on the right.
...
Fantastic job!
Before we move onto the next chapter, complete
this short quiz
to test your knowledge.
Ready to move on? Let’s see what’s up next, in
Chapter 3
.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Chapter 2: Appointments
Front-Desk Training
Chapter 2: Appointments
7 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/f8392002-d83d-425c-80df-6028bdbff33f?dimensions=700x500)
- ![](https://jane.app/thumbs/ca86fe73-b997-4f6f-989b-29e5cdb33c0e)
- ![](https://jane.app/thumbs/20e1c332-df56-4358-9ca1-411364e1e7f0)
- ![](https://jane.app/thumbs/6b5f37c0-16ca-478f-9a8d-3b13040ec2b1)
- ![](https://jane.app/thumbs/8ea24ff8-e4ac-432f-aab3-04bb1fff12f0)
