...
*Source: [https://jane.app/guide/chapter-5-patient-experience](https://jane.app/guide/chapter-5-patient-experience)*

*Category: Front-Desk Training*

*Scraped: 2025-08-07 00:00:06*
...
Feature OverviewChapter 5: Patient Experience
Front-Desk Training
Chapter 5: Patient Experience
9 min read
Balance Plan
...
If the patient already exists in your Jane account, you can send them a
Welcome Email
. This lets them link their profile and create a username and password.
Just head to the patient’s profile and click the
Welcome
button on the right:
You can also add a note to the email if you like.
Note 📍:
If an existing patient is requesting an update to their username, the clinic will either want to send them another welcome or get in contact with our support team to get this updated.
...
Starting fresh with online booking?
Consider sending a
Mass Welcome Email
to all clients. It’s a great way to let them know you’ve moved to a new system — especially if you’ve imported profiles from another platform.
Learn more about the Mass Welcome Email.
💡
Jane Tip
: Want to message everyone about a pricing update or practitioner change? Use the
Patient List Report
to export emails and send a custom message through a tool like Mailchimp.
Practice drill
Let’s try out sending the
Welcome Email
to an existing patient. This gives them access to set up a username and password for online booking and access to the client portal area.
Instructions:
In the Jane Demo Clinic, head to the
Patients
tab.
...
Use the
Welcome button
to email the Welcome Email to Lucas.
Impressive!
Troubleshooting client login
...
Duplicate profiles:
Sometimes patients end up creating a duplicate profile in the system and, when they log in, they don’t see their appointment history. If this happens, search for the patient, see if there is a duplicate, and, if there is, you can
merge the two profiles
.
My Account Portal
The
My Account
area is where patients can view and manage appointments, cancel or reschedule, and see any documents or notes their practitioner has shared — like exercise instructions or lab results.
They can access this from your Jane booking site or right after they book a visit.
Learn more about the My Account portal.
Using Jane Payments?
Your patients will also see:
An option to
add a credit card
A place to
pay their balance online
If your clinic allows, the ability to
...
all required forms will load in one place.
...
💡
Jane Tip:
Reduce no-shows by enabling appointment reminders! Jane can automatically send email and SMS reminders before each visit.
...
💡
Jane Tip:
Learn how you can add upcoming appointments to the bottom of a patient’s receipt.
Click here to see how!
You are so close! Give
this quiz
a try, then let’s make our way to the final lesson all about Insurance.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Chapter 5: Patient Experience
Front-Desk Training
Chapter 5: Patient Experience
9 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/7ca8fd0f-e793-42cf-abe7-0a7904dd6729)
- ![](https://jane.app/thumbs/d99f9c99-6f5a-4188-8252-a8219d6153ba)
- ![](https://jane.app/thumbs/29557100-8350-42a5-8a05-9daaaace118e)
- ![](https://jane.app/thumbs/cbfa541d-7525-46a1-87e1-57e45d999322)
- ![](https://jane.app/thumbs/387fa683-11c9-4e6a-bc4a-f372dfe803d7)
- ![](https://jane.app/thumbs/3c7c736a-a68a-4833-aaed-f6669c7f344f)
- ![](https://jane.app/thumbs/24aff4aa-4e9f-4600-b8b2-634a467971f4)
- ![](https://jane.app/thumbs/0c63a98e-5464-40b3-b020-1c46a24b7e86)
- ![](https://jane.app/thumbs/bebd0dc8-27db-4270-bcc6-703020b6ac91)
- ![](https://jane.app/thumbs/98876a3f-037e-4739-ba72-cdc4ceb35100)
- ![](https://jane.app/thumbs/aefba3e2-29f4-46d0-863f-49f6e2bef3fe?dimensions=700x500)
