...
*Source: [https://jane.app/guide/chapter-1-schedule](https://jane.app/guide/chapter-1-schedule)*

*Category: Front-Desk Training*

*Scraped: 2025-08-06 23:59:06*
...
Feature OverviewChapter 1: Schedule
Schedule
Chapter 1: Schedule
13 min read
Balance Plan
...
All of the content in this course “Front-Desk Training” is subject to our
Terms of Use.
Course Preparation
💡Head on over to
Jane’s Demo Clinic
to practice as you learn. The username is
owner,
and you can find the weekly password by clicking the Need Help button in the upper right of your Jane account:
If you’re having any trouble, you can also request the password by email (support@jane.app).
...
Watch this video to learn how to show appointments for a specific day and a specific practitioner, how to configure your display settings, as well as how to create a custom view of practitioners on a single page.
...
To show practitioners at a specific location, choose the location from the drop-down at the top (only visible if your clinic has multiple locations).
...
Instructions:
View the Schedule for The Village location.
Select Susan Lo from the practitioner list.
Click Day, Week, and Staff Today to see how the view changes.
Use the Left/Right Arrows near Today to move through dates.
Use Go to Date to pick any date, then return to Today.
Nice work!
Let’s learn about shifts!
Shifts in Jane are important because you’ll need to know where you can book patients in the schedule (and where
not
to).
Practitioner shifts in Jane are represented by this light blue background:
Any background color that is
white
in the schedule is referred to as
“white space”
. White space represents the time that the practitioner is
unavailable
, and therefore patients will
not
have the option to book an appointment online.
Patients booking appointments online can only book appointments within the practitioner’s shift
.
💡
Jane Tip
: Depending on your clinic’s setting, administrative staff may or may not have the option of booking appointments outside of a shift in the administrative schedule. If you’d like to limit your staff from booking outside of shifts, please visit
this handy guide
.
Let’s navigate over to Jane’s primary scheduling tool, called
Manage Shifts.
...
Select
Manage Shifts
. This is Jane’s primary scheduling tool for creating shifts.
If you’d like a complete walkthrough of setting up shifts, we have created a
detailed guide document here
with supporting videos!
Or, you can watch this quick video below to learn all about
Shifts
in Jane before diving into your practice drill:
As promised, here are the guides mentioned in the video:
Schedule Opening & Closing Times
For split shifts, double booking shifts and more, visit
Set-up Shifts
For room booking, visit
Rooms
Practice drill
Next, we will practice booking shifts in Jane.
Instructions:
Go to Manage Shifts for a practitioner.
Set the date range through Dec 31.
Clear existing shifts if needed.
Add a shift: 9 AM to 3 PM.
Try a split shift: 9 AM to 12 PM and 1 PM to 3 PM.
Mark it “Bookable Online” with a note: “Return Patients Only.”
Copy the shift to other days.
Apply the shift to another practitioner.
Click Apply Shift Schedule and Accept.
Way to go!
...
💡Jane tip
: Use the magnifying glass to highlight available times in orange.
Learn more.
If you ever need to
change the length of a scheduled appointment
, you can easily do so by hovering over the appointment and clicking the
double arrow
in the bottom right-hand corner. Once you see the blue dots on the top and bottom, you can adjust it however you need!
Practice drill
Next, we will practice booking appointments for an existing patient.
Instructions
:
Click any open time on the schedule to start booking.
Use the “New Appointment” panel on the right.
Search for Lily Chu.
Choose a treatment.
Adjust time or add notes if needed.
Select “None” for claim (if prompted).
Click Book Appointment.
Awesome work!
Before we move on, it’s worth noting that the previous booking workflow is for appointments between one patient and one practitioner. With Jane, you can also book Group Appointments and Classes, in-person and online. Learn more about booking
Group Appointments here
, or
Classes here
.
...
In our next video, we’ll cover how to create a new administrative appointment note. If you have any notes that you want to stay “sticky” to a patient, just click the Star.
...
Breaks are perfect for blocking off Holidays, personal time, and even great for administrative reminders. Watch the video below to learn how you can use Jane’s break feature:
...
Sometimes you want the morning to book up first before the afternoon is opened up. Here’s how that might look:
Holidays
...
Instructions:
First, hop over to the Schedule.
Click on an appointment to view the Appointment panel on the right and head into the Notes section.
Input an appointment note that indicates what injury the patient is coming in for. This note should make an icon appear on the appointment.
...
💡
Jane Tip:
Jane loves to be efficient! Check out the available schedule keyboard shortcuts.
Staff Favourite:
View the next # of upcoming days by clicking keyboard numbers 1-7
You’re amazing! You’ve completed Chapter 1. To test your knowledge, complete
this quiz
before moving on.
Next up,
Chapter 2
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Chapter 1: Schedule
Schedule
Chapter 1: Schedule
13 min read
Balance Plan
Practice Plan
Thrive PlanJane University: Front-Desk Staff Training
Welcome! We’re so happy you’re here.
At Jane University, we want to take the guesswork out of learning Jane!
We designed our front-desk training to take you on a structured learning tour. Why? Well, we talk a lot here about “Jane’s heart,” and one of our customers recently said that she felt like the Jane team was here to care for her as she cares for her patients. We really loved hearing that because we want to be to you what you are to your patients: a helper, a cheerleader, and a champion of success. This course is here to take you through Jane in a clear and step-by-step manner. Our goal is to help you learn all of Jane’s basic features so you can get started as a Jane administrator with confidence!
We hope you enjoy working with Jane as much as we do.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/add54bc0-b7a4-4773-be64-b9285f00dbde)
- ![](https://jane.app/thumbs/b606518a-08ba-4c45-b53c-4e1e2483267f)
- ![](https://jane.app/thumbs/cb74b639-c415-4b7d-9f3a-e936a25c52db)
- ![](https://jane.app/thumbs/73137f2e-d9f7-44ce-87af-8d333f1f9084)
- ![](https://jane.app/thumbs/89e27d7d-b20c-46c0-875a-877490f92454)
- ![](https://jane.app/thumbs/3355c719-6b4e-42f1-a7c8-475861fd7e35)
- ![](https://jane.app/thumbs/70c11492-4ee7-4aef-a4a5-29be993f2779)
- ![](https://jane.app/thumbs/bf3ba2c8-27be-4c70-88bc-8b1d240871a1)
- ![](https://jane.app/thumbs/eba53eb7-74a7-4677-8a03-f559b84678da)
- ![](https://jane.app/thumbs/74644c19-1ef3-435a-bed5-fb59e1231ed3)
- ![](https://jane.app/thumbs/74c21c6e-ed9d-46ad-b9a4-3c83ce4600cf)
- ![](https://jane.app/thumbs/89fa4997-8c46-4893-907a-4c463255238a)
...
- ![](https://jane.app/thumbs/c75abc8d-f5e6-453a-8c37-a5473ddff797)
