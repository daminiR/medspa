...
*Source: [https://jane.app/guide/chapter-4-charting](https://jane.app/guide/chapter-4-charting)*

*Category: Front-Desk Training*

*Scraped: 2025-08-06 23:59:39*
...
Feature OverviewChapter 4: Charting
Front-Desk Training
Chapter 4: Charting
6 min read
Balance Plan
...
As an administrator, you might need to upload a scanned doctor referral, a paper intake form, or even an old-school chart you’re moving away from.
...
Uploading documents into Jane is something you’ll likely do often. Let’s take a look at how it works by covering the basics of charting in the video below:
...
Choose the
File/Image
option. This creates a draft chart entry.
You’ll now see an area where you can upload a file or image.✋ Just a quick reminder: don’t upload or enter any real patient info in the Demo Clinic — it’s shared and viewable by others.
Give the file a clear name so it’s easy to find later. For example:
Paper Chart – Jan 2015 to Dec 2017
.
Click
Sign
to complete the chart entry.
Keep it up!
Files area in Chart:
...
This can be very useful for creating quick electronic copies of paper intake forms, or any other useful images for documentation. When using the Image/File Upload option in the chart, you can take a picture directly from your device.The photo will upload directly to the client’s chart.
Most devices can do this without saving the photo locally, but it’s advisable to check your device’s camera folder to ensure no local copies are saved.
Uploads for Review - labs, X-rays and other reporting
If you are uploading clinical information that needs to be reviewed by a practitioner, you can assign them directly to that practitioner for clarity and accountability. Learn more here:
Read Guide
...
Instructions:
In the Jane Demo Clinic, head over to the patient profile for
Benjamin French
.
Inside Benjamin’s the Chart tab, find the
Filter/Export button
.
From the drop-down filter options, try filtering the chart notes by Discipline, Staff Member and a desired date range
Use the
PDF
button to export all of the filtered entries.
Nicely done!
...
Last step: check your knowledge with
this quiz
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Chapter 4: Charting
Front-Desk Training
Chapter 4: Charting
6 min read
Balance Plan
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/191849e7-dfd7-4170-8496-82854b0b9e73)
- ![](https://jane.app/thumbs/9d1c4fe9-aba1-4dbd-bead-cd7be817506b)
- ![](https://jane.app/thumbs/fabc6511-05e1-4fdf-864b-26dfbb66d2ad)
