...
*Source: [https://jane.app/guide/deleting-and-cancelling-memberships](https://jane.app/guide/deleting-and-cancelling-memberships)*

*Category: Packages & Memberships*

*Scraped: 2025-08-07 04:49:20*
...
Feature OverviewDeleting and Cancelling Memberships
...
A clinic typically needs to
delete a membership
if the membership
was invoiced erroneously
.  We might have sold the wrong membership type, or have sold it to the wrong patient. Your client may have also changed their mind at the last minute and no longer wants to purchase the membership.
A membership can be deleted if the status of all invoiced billing cycles are
unpaid.
...
cancel a membership
when they want to
terminate the invoicing schedule and benefits before the contract end date
.
...
If the membership has been set to
automatic payments
, the card on file will no longer be charged.
...
, you will be able to specify a
Cancellable After
date. This date will show up on the membership terms document that you may provide your patient after purchase.
Note:
At this time, cancelling a membership is an
administrative-only
function. Patients will not be able to cancel memberships via the patient portal and will be required to contact the clinic to finalize the cancellation. This is a feature we would like to implement as we continue to improve on Memberships.
...
To
delete
a membership, hop over to
Billing > Packages & Memberships
section of a client’s profile. From here, click
View
to bring up the detail page.
The option to
Delete a Membership
will be available at the top of this detail page if the status of all invoiced billing cycles are
unpaid
.
After clicking
Delete Membership
, you will be asked to confirm whether you would like to proceed. Press
Confirm
to finalize the deletion, or
Cancel
...
Cancelling a Membership
Cancelling a membership also begins over in the
Billing > Packages & Memberships
section of a client’s profile. From here, click
View
to bring up the detail page.
The option to
Cancel a Membership
will be available at the top of this detail page if there is
at least one billing cycle that has a payment applied
.
If you click on
Cancel Membership
, you will be asked to confirm that you would like to proceed.
Note:
An alert will appear at the top of this pop-up if you attempt to cancel a membership outside of its cancellation policy. This is just a heads up and will not prevent staff members from finalizing the cancellation if required.
...
Jane will show the option to delete a membership if all of the invoiced billing cycles are unpaid. If deleting is the preferred action (over cancelling), you’ll want to
unapply any payments
that have been applied towards the active billing cycles.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Deleting and Cancelling Memberships
Packages & Memberships
Deleting and Cancelling Memberships
6 min read
Thrive PlanIn this guide, we’ll go over the difference between deleting and cancelling a membership as well as how to perform these actions within Jane.
Deleting vs. Cancelling a Membership
So, what is the difference anyway? We’re glad you asked! Here is a breakdown of when and why you would want to delete or cancel a membership.
Deleting a Membership
A clinic typically needs to
...
Jane will show the option to delete a membership if all of the invoiced billing cycles are unpaid. Apply at least one payment to an existing billing cycle invoice in order to cancel the membership.
I made a mistake and deleted/cancelled a membership by accident, can I undo this?
It is not possible to reverse a membership cancellation or deletion at this time. We recommend selling another instance of the same membership to your client.Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/6bf2ffbb-3141-44fc-ac60-f0155c2c9afb)
- ![](https://jane.app/thumbs/d772fbe7-c384-4a47-a39f-3baf1c5a762f)
- ![](https://jane.app/thumbs/d1b6adae-e673-49fd-9b3b-53403e9b2891)
- ![](https://jane.app/thumbs/54547948-93be-4b88-bc44-d166feac0e42)
- ![](https://jane.app/thumbs/4b359264-ed40-43d8-98d1-3e4c88c6b4fc)
- ![](https://jane.app/thumbs/ab8a93b4-655e-4ba5-93c3-6e366e740995)
