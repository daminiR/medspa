...
*Source: [https://jane.app/guide/packages-on-a-payment-plan](https://jane.app/guide/packages-on-a-payment-plan)*

*Category: Packages & Memberships*

*Scraped: 2025-08-07 04:50:42*
...
Feature OverviewPackages on a Payment Plan
...
As a Full Access user, you can begin by
...
🤓 Quick tip:
You may find it helpful to set the Name of each Package in a way that will allow you to easily track a patient’s progress through the payment plan ie. “Treatment Package 1/4”
...
Once you’re happy with the mini Package you created, hit that
Create Package
button to save your hard work. You can go ahead and repeat this process for the remaining mini Packages.
...
Similarly to option 1, you’ll start as a Full Access user
Setting up a Package
by heading to your
Settings > Packages & Memberships
to create a
...
New Product
.
When you are creating your Product, the fields you will want to fill out are the Name, Price, and Income Category. Once complete, go ahead and
Create Product
.
...
For a great resource on partially paying an invoice, you can reference our
...
Selling a Product
Packages FAQ
As always, we’re here for you if you have any additional questions or would like a helping hand during this setup. Please feel free to check out our
Jane Support & Resources
page if you’d like some extra assistance. 💙
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Packages on a Payment Plan
Packages & Memberships
Packages on a Payment Plan
5 min read
Thrive Plan📣
...
As always, we’re here for you if you have any additional questions or would like a helping hand during this setup. Please feel free to check out our
Jane Support & Resources
page if you’d like some extra assistance. 💙Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![screenshot of package set up for option 1](https://jane.app/thumbs/5837382f-73c0-4daa-b81c-1759d0d43455)
- ![screenshot of package set up for option 2](https://jane.app/thumbs/f93a395b-378f-46d6-afd5-1aecde7e05ac)
- ![screenshot of product setup for option 2](https://jane.app/thumbs/a6c1509b-238e-4c16-b7df-98ddf797ad5f)
