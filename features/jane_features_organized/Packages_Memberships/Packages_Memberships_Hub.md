...
*Source: [https://jane.app/guide/packages-memberships-hub](https://jane.app/guide/packages-memberships-hub)*

*Category: Packages & Memberships*

*Scraped: 2025-08-07 04:52:00*
...
Feature OverviewPackages & Memberships Hub
Packages & Memberships
Packages & Memberships Hub
3 min read
Thrive Plan
Legacy Plans
Exploring ways to offer prepaid care, build plans of treatment, or simplify billing with recurring payments?
Packages and memberships in Jane can help you support your clients, and stay on top of billing with less back and forth. This guide walks you through how to set them up, manage them, and make the most of these tools.
Heads up:
Packages and Memberships are included in our Thrive Plan and also available on Jane’s legacy Base and Insurance Plans. If you’re interested in upgrading to the Thrive Plan, you can find the steps to upgrade on our
Managing Your Jane Subscription
guide. Not sure which plan works best for you? You can check out your options on our
Pricing Page
.
Packages
Getting started with packages
Setting up a Package
: Walk through how to create and customize packages that fit your services and client needs.
Managing and using packages
Selling, Redeeming and Refunding a Package
: What to expect after setup, from selling to applying and refunding.
How to Redeem a Past Treatment under a Package
: Apply a package to eligible past visits.
Special use cases and more
Insurance Friendly Packages
: Designed for clients who pay upfront and submit receipts for reimbursement.
Packages on a Payment Plan
: Learn how to collect package payments in installments.
Packages FAQs
: Browse answers to common package-related questions.
Memberships
Getting started with memberships
Setting up a Membership
: Learn how to offer recurring billing, whether weekly, monthly, or yearly.
Selling and managing memberships
Selling a Membership
: Steps for offering memberships to your clients.
Redeeming or Refunding Memberships
: How to apply visits or issue a refund when needed.
Deleting and Cancelling Memberships
: For memberships that are no longer needed.
Special use cases and more
How to Manage a Wallet or Bank Style Package and Membership
: A flexible workflow for clinics using credit-style memberships or packages.
Memberships FAQ
: Answers to common membership questions.
Reporting, Compensation & Receipts
Package & Membership Reports
: Track package and membership sales or usage for your clinic.
Understanding Package & Membership Compensation
: A look at the options for tracking and paying out packages and memberships.
Working with Package & Membership Receipts
: Clients may need their receipts to include specific details, for insurance reimbursement, or just to keep good records. This guide walks you through how to tailor receipts to meet those needs.
Not sure if packages or memberships are the right fit for your clinic?
Reach out to our support team
. We’re always happy to help you figure out what works best.
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Packages & Memberships Hub
Packages & Memberships
Packages & Memberships Hub
3 min read
Thrive Plan
Legacy PlansExploring ways to offer prepaid care, build plans of treatment, or simplify billing with recurring payments?
Packages and memberships in Jane can help you support your clients, and stay on top of billing with less back and forth. This guide walks you through how to set them up, manage them, and make the most of these tools.
Heads up:
Packages and Memberships are included in our Thrive Plan and also available on Jane’s legacy Base and Insurance Plans. If you’re interested in upgrading to the Thrive Plan, you can find the steps to upgrade on our
Managing Your Jane Subscription
...
Not sure if packages or memberships are the right fit for your clinic?
Reach out to our support team
. We’re always happy to help you figure out what works best.Subscribe to our monthly newsletter.Jane Software Inc.
