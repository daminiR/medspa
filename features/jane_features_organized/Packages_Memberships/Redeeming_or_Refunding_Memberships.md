...
*Source: [https://jane.app/guide/redeeming-or-refunding-memberships](https://jane.app/guide/redeeming-or-refunding-memberships)*

*Category: Packages & Memberships*

*Scraped: 2025-08-07 04:50:31*
...
Feature OverviewRedeeming or Refunding Memberships
Packages & Memberships
Redeeming or Refunding Memberships
8 min read
Thrive Plan
Now that your client has purchased their membership, it is now available to be applied to any of their upcoming appointments:
Redeeming or Applying a Membership to an appointment
...
eligible items
for the membership they have purchased, a new
Membership
section will appear.
💡
Note:
More often than not, a patient with a membership will likely want to apply their membership if an eligible session has been selected. For that reason, Jane will try her best to be helpful and pre-select the membership for you during the booking flow.
If you’ve selected the membership in error, simply click the blue ‘x’ and the selection will become available once again.
📍
Note:
A membership can only be removed from an appointment if it has
not
yet been arrived.
Once a membership is applied and the appointment is marked as
arrived
, the total billed to the patient will match the value that has been set under
Additional Charge
for this treatment or class type under the Membership Settings.
...
Option 1:
Cover the no show by redeeming a membership use for this session; or,
Option 2:
Opt not to redeem a membership use for this session, and choose one of the clinic’s existing
No Show Fees
to invoice for this appointment instead
In the case of:
Option 1
, redeeming a membership usage for a No Show would behave exactly the same way as if the appointment was arrived — the amount that the patient is billed will match whatever the
Additional Charge
amount has been set to in the Membership settings.
With
Option 2
, the membership will not be used and instead, Jane will charge one of the standard clinic no-show fees instead.
...
Reviewing a Patient’s Membership
If you want to review the status of a patient’s membership, head over to the
Patient’s Profile
, and then click on the
Billing
tab. From there, you’ll want to click on the
Packages & Memberships
tab.
Jane will display a general overview of the membership, including the date the membership was purchased, how many uses are remaining, and when it will expire.
If you click on the
View
button, a detailed breakdown of the membership will be available to review, including the specific invoices that the membership has been redeemed towards and how many billing cycles are remaining.
There are also two reports, the
Package & Memberships Sales and Usage Reports
that come in handy if you are interested in this type of information across all memberships that have been sold and redeemed across the entire clinic.
Membership Expiry
If a membership has
expired
...
Refunding a Membership
You might run into a situation where a patient does not redeem all of the available uses of a membership, and you would like to offer a refund of the remaining sessions.
Let’s walk through the two places to initiate a Membership refund:
Option 1
: Head over to the
Patient Profile
and then click on the
Billing
tab within the profile. Within Purchases, click on the
black dropdown arrow
to the right of the word
View
. Within the menu options, make sure to select
Refund Billing Cycle
.
Option 2
: Head over to the Patient Profile and then click on the
Billing
tab within the profile. Next, click on
Packages & Membership
and
View
to the right of the relevant membership. Jane will display the membership page.
From here, you’ll want to click on the
black dropdown arrow
to the right of
View Purchase
. Lastly, you’ll select select
Refund Cycle
...
Due to variations in refund regulations of membership deals across locales and disciplines, the amount that you would like to return to the patient is fairly flexible. Jane will provide a
suggested amount
which is calculated by taking the original membership price and dividing it by the number of uses to get a per-use value. She will then multiply this amount by the number of remaining sessions to offer a suggested refund amount, although you can override this value to any amount between $0 and the total amount originally collected.
Wait— you’re not quite done yet! Once the refund has been initiated, the specified amount will become unapplied and available as credit so that it can be properly refunded to the desired payment method of your choosing. This can be done by viewing the original Payment itself. Check out our guide on
Refunding a Patient Payment
for a quick refresher on how to finalize this second half of the refund.
📍
Note:
A friendly reminder that refunding the membership will automatically
invalidate
the membership, meaning the membership will no longer be valid for use.
If you have any questions about working with memberships, don’t hesitate to send us an email to
support@jane.app
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Redeeming or Refunding Memberships
Packages & Memberships
Redeeming or Refunding Memberships
8 min read
Thrive PlanNow that your client has purchased their membership, it is now available to be applied to any of their upcoming appointments:
Redeeming or Applying a Membership to an appointment
No Shows and Memberships
Reviewing a Patient’s Membership
Membership Expiry
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/82edf7c4-5a6f-4dca-b86e-1895b5a942bf)
- ![](https://jane.app/thumbs/80eef869-4e79-4755-b1fb-310d1885ca2e)
- ![](https://jane.app/thumbs/6fb97d59-77cc-47d5-925d-7d9e6525b72f)
- ![](https://jane.app/thumbs/62b481c9-d945-4299-affa-aaf60b92e260)
- ![](https://jane.app/thumbs/ba50c135-ae36-43c2-8fa0-e556f61f40c8)
- ![](https://jane.app/thumbs/33f99f9d-4240-48cb-b2be-29df6d04a013)
- ![](https://jane.app/thumbs/d5f634d4-ce8c-4ec5-9824-b2b7f84ce1c7)
- ![](https://jane.app/thumbs/70f0603e-5929-481c-bd05-34b008d0d45d)
- ![](https://jane.app/thumbs/d50a37c0-008e-4630-bd05-9366aefcc1c4)
- ![](https://jane.app/thumbs/4b9bfdee-09d1-4319-9b5f-e4e98c991caa)
