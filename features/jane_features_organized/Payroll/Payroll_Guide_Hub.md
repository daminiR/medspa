...
*Source: [https://jane.app/guide/payroll-guide-hub](https://jane.app/guide/payroll-guide-hub)*

*Category: Payroll*

*Scraped: 2025-08-07 03:46:16*
...
Feature OverviewPayroll Guide Hub
Payroll
Payroll Guide Hub
4 min read
Balance Plan
...
Thrive Plan
Legacy Plans
At Jane, we’re here to help make your payroll process a little smoother. We’ve put together some handy guides to walk you through it all — from setting up Timesheets to managing commissions — so you can spend less time crunching numbers and more time running your clinic.
Table of Contents
Hourly Compensation
Timesheets
How to Calculate Hourly Wages for a Practitioner Based on Booked Hours
Commission-Based Compensation
Referral Commission
Commission Rates by Location
Compensating Product Sales by Profit Margin
How to Calculate Flat Fee Compensation Based on the Number of Services Provided
Managing & Reporting Compensation
Income Categories and Compensation at Different Rates
Compensation Report
Understanding Package and Membership Compensation
Hourly & Compensation
Timesheets
Timesheets are here to help you track admninistrator hours accurately, right in Jane. This guide will walk you through how to log hours worked, vacation, and sick leave all in one spot.
Timesheets Guide
How to Calculate Hourly Wages for a Practitioner Based on Booked Hours
If you compensate your practitioners based on their booked appointment hours, you can use the Hours Scheduled/Booked report to track how many hours a practitioner has been booked.
Calculating Hourly Wages Based on Booked Hours Guide
Commission-Based Compensation
Referral Commission
Want to thank your practitioners for bringing in new patients? This guide will show you how to set up referral commissions.
Referral Commission Guide
Commission Rates by Location
For clinics with multiple locations, commission rates can vary. This guide will help you set different rates for each location and ensure the right one is applied.
Commission Rates by Location Guide
Compensating Product Sales by Profit Margin
If you sell products in your clinic, this guide will show you how to link compensation to the profit margin of those products, making sure your team is properly compensated for each sale.
Product Sales Compensation Guide
How to Calculate Flat Fee Compensation Based on the Number of Services Provided
This guide will show you how to calculate compensation using the Product Performance Report. This is helpful if you pay your staff members a flat fee based on the number of services provided.
Calculating Flat Fee Compensation Based on the Number of Services Provided Guide
Managing & Reporting Compensation
Income Categories and Compensation at Different Rates
This guide shows you how to set up income categories for different types of compensation, so you can easily set different pay rates for different services.
Income Categories and Compensation Guide
Compensation Report
Calculate a practitioner’s commission with help from our compensation report.
Compensation Report Guide
Understanding Package and Membership Compensation
Package and membership sales can be an important part of your business. Learn how to compensate practitioners for the sale of these packages and memberships.
Package and Membership Compensation Guide
Designed specifically for book keepers and accountants, we have a
Bookkeeping Hub
for all your financial reporting and billing needs.
If you need a hand or have any questions,
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Payroll Guide Hub
Payroll
Payroll Guide Hub
4 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansAt Jane, we’re here to help make your payroll process a little smoother. We’ve put together some handy guides to walk you through it all — from setting up Timesheets to managing commissions — so you can spend less time crunching numbers and more time running your clinic.
Table of Contents
Hourly Compensation
Timesheets
How to Calculate Hourly Wages for a Practitioner Based on Booked Hours
