...
*Source: [https://jane.app/guide/compensation-report](https://jane.app/guide/compensation-report)*

*Category: Payroll*

*Scraped: 2025-08-07 03:47:11*
...
Feature OverviewCompensation Report
Payroll
Compensation Report
7 min read
Balance Plan
...
To get started, let’s mosey over to
Reports
on the top blue bar and select
Compensation
...
If you are paying them on the collected total, you will want
Cash accounting method
which will only report revenue when the invoices have been paid - including invoices generated outside the date range. This method references the date the payment was
applied
to the invoice.
Otherwise you are searching for our
Accrual accounting method,
where reports are based on what has been
invoiced
, regardless of payments being received.
As a reminder the default Accounting method can be set under the
...
2) Income Categories
These are my favourite! If you haven’t already set these up have a quick read through our
guide document.
...
Note:
A friendly reminder that the tax amount calculated in the “Commission” section is different from the
collected tax
total in the “Income” section. For example, if Cam had one session for the pay period that was for $100 with 5% tax, the
collected tax
amount in the Income section would be $5, for a collected total of $105. However, if Cam only receives 75% commission for this session, the “Commission” section would reflect a collected total of $75 x 5%, for a total of $78.75.
5) Practitioner Transaction Fees
Jane allows you to add and charge a percentage or a flat fee on each transaction processed on behalf of a practitioner. This will be taken off of the staff member’s total compensation under the
Fees
section of the
Compensation Report
.  Practitioner transaction fees are set within each
Payment Method
. If you haven’t set this fee or would like to change it, you can check out our
Creating a New Payment Method
, guide walking you through this option step by step.
6) Final Total
...
Easy! There are two types of providers adjustments and if needed Jane will add them to the practitioners total income as Adjustments Owed to Staff Members before calculating the commissions. This will also show up as its own line item in the report, as
Provided by Company (Owed to Staff Member)
. If you need jog your memory of which type you are using, have a quick read
here
.
Details
Can’t believe the amazing totals in the income section? You can toggle on the
Details
filter and investigate those totals a bit more closely. Scrolling down a bit on the page, you’ll see every invoice that contributes to the totals displayed in the Income, Commissions and Fees summaries.
Staff Commissions:
The Compensation Report can only calculate a set commission on the sum of sales by a staff member. Commissions in Jane come from a
Staff Member’s Profile
, under their
Permissions and Commissions
area. This is calculated based on a split or a percentage of their total sales.
If your clinic uses a different compensation model like tiered, hourly or flat rates, those commissions will need to be calculated outside of Jane. If you’d like to do your own calculations, feel free to export this information using the
Export > Excel
button in the top right-hand corner.
Pro tip: If you click Print, you can then Group by patient name and Hide (or show) $0.00 Staff
Exploring payments in more detail:
At times, you may notice that a payment listed on the Transaction Report isn’t included on the Compensation Report for the same filtered date range.
This can occur due to a couple of reasons. The payment may not have been applied to an invoice yet. It can be helpful to explore the
Transaction Report
to see if it’s a payment that’s currently a credit on a patient/client account.
💡
Jane tip
: To find the patient profile with the credit on file, you can head to the Transaction Report, click the blue link for the transaction, and then click the blue link for the patient on the window that opens.
If you’re viewing the
cash-collected
version of the Compensation Report, the payment may have been applied on a different date from the original transaction date. To learn more about different billing dates, this guide can be helpful:
Working with the Purchase, Invoice, Received At, and Applied Dates
Another reason that payments may be different on the Compensation Report and the Transaction Report can be when payments are applied to purchases not linked to staff. A purchase needs to be linked to a staff member to appear on the Compensation Report. Not to worry though, you can assign the purchase to a staff member:
Assigning Product/Inventory to Staff
We hope the info about the Compensation Report is helpful. If you have questions, or if you want to chat through workflows in Jane, please don’t hesitate to
get in touch
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Compensation Report
Payroll
Compensation Report
7 min read
Balance Plan
Practice Plan
Thrive PlanWhat’s the Compensation Report?
Whooop Whooop, it’s pay day! Whether it’s for the week, the month, or half the year, Jane’s Compensation Report can help you calculate a practitioner’s compensation.
To get started, let’s mosey over to
Reports
on the top blue bar and select
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/aab351b4-a306-47f0-ad12-5bf6af0d58b3)
- ![](https://jane.app/thumbs/a2bb9bea-5f9c-4cca-afda-3d1d57bb832f)
- ![](https://jane.app/thumbs/5e7272f9-d046-48a4-b063-a602a8caff66)
- ![](https://jane.app/thumbs/91e28cd2-0984-4af8-ad38-776e2d219282)
- ![](https://jane.app/thumbs/71d44d45-64ca-43b0-9761-cc049aa3cf61)
- ![unapplied payment on the Transaction Report](https://jane.app/thumbs/933e9d84-7dba-4e82-878e-85792bf08a36)
