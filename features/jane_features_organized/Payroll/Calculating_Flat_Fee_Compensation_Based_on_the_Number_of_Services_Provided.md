...
*Source: [https://jane.app/guide/calculating-flat-fee-compensation-based-on-the-number-of-services-provided](https://jane.app/guide/calculating-flat-fee-compensation-based-on-the-number-of-services-provided)*

*Category: Payroll*

*Scraped: 2025-08-07 03:48:26*
...
Feature OverviewCalculating Flat Fee Compensation Based on the Number of Services Provided
Payroll
Calculating Flat Fee Compensation Based on the Number of Services Provided
2 min read
Balance Plan
...
can also be used to track appointments in addition to packages, memberships, and products. If your practitioners are compensated with a flat fee based on the number of services they provide, you can use this to track and calculate their pay. Let’s walk through how to do it.
To get started, head to
Reports
and select
Product Performance Report
. You can filter by Location, Staff Member, and Date Range to match the pay period you’re working with. You can also filter by Purchase Type to narrow it down to only Appointments, Products, or Packages & Memberships.
Once your filters are in place, check out the
# Sales
column for the staff member you’re calculating pay for.
If you’re compensating based on a specific service, take the number from the relevant row and multiply it by the staff rate you pay your staff for each service.
For example, let’s say Susan is compensated $50 for every 30-minute massage. Since this report shows she completed nine 30-minute massages, we would calculate her payment for this service as 9 X $50 = $450.
If you compensate based on the total number of sales, regardless of their type, just use the total number at the bottom of the report. Multiply that by your flat rate to figure out the total compensation.
And that’s it! You’re all set to calculate flat fee compensation. If you have any questions,
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Calculating Flat Fee Compensation Based on the Number of Services Provided
Payroll
Calculating Flat Fee Compensation Based on the Number of Services Provided
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansDespite its name, the
Product Performance Report
can also be used to track appointments in addition to packages, memberships, and products. If your practitioners are compensated with a flat fee based on the number of services they provide, you can use this to track and calculate their pay. Let’s walk through how to do it.
To get started, head to
Reports
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/78dc9698-ee8d-4632-ad21-d9e9dd153393)
- ![](https://jane.app/thumbs/ba846d61-958d-40fd-81d8-f6cbcc1dd0f4)
