...
*Source: [https://jane.app/guide/calculating-hourly-wages-based-on-booked-hours-3db702fe-e10c-4dea-a65a-ec9b261b16c2](https://jane.app/guide/calculating-hourly-wages-based-on-booked-hours-3db702fe-e10c-4dea-a65a-ec9b261b16c2)*

*Category: Payroll*

*Scraped: 2025-08-07 03:48:03*
...
Feature OverviewCalculating Hourly Wages Based on Booked Hours
Payroll
Calculating Hourly Wages Based on Booked Hours
2 min read
Balance Plan
...
Thrive Plan
Legacy Plans
Are you wondering how to pay your practitioners for their booked hours? One option is to calculate their hourly rate based on the time they’ve been booked for appointments. Jane’s Hours Scheduled/Booked report shows how many hours a practitioner has been booked over a certain period, making it easier to figure out their compensation.
💡
Jane tip:
Booked hours are the total time scheduled for a practitioner’s appointments or classes each day. It includes all appointments marked as booked, arrived, or no-show — but not cancelled ones. For more information, check out our guide on the
Hours Scheduled/Booked Report
.
To find this report, head to
Reports > Hours Scheduled/Booked
.
You can filter the report by Location, Staff Member, and Date Range to narrow down the data.
Once you’ve got the report filtered, take the value from the Booked (hrs) column and multiply it by a practitioner’s hourly rate to calculate their total pay.
If you want to work with the data further, you can export the report to Excel (or another spreadsheet program) by clicking on the three dots at the top-right-hand side of the page.
Heads up — Jane doesn’t store hourly wages, so you’ll need to pull the data from the report and calculate the final total based on each practitioner’s rate.
💡 For more details on exporting reports and working with the data, check out our guide on
...
Security
How to reset your email password and enable Two-Factor Authentication (2FA)Calculating Hourly Wages Based on Booked Hours
Payroll
Calculating Hourly Wages Based on Booked Hours
2 min read
Balance Plan
Practice Plan
Thrive Plan
Legacy PlansAre you wondering how to pay your practitioners for their booked hours? One option is to calculate their hourly rate based on the time they’ve been booked for appointments. Jane’s Hours Scheduled/Booked report shows how many hours a practitioner has been booked over a certain period, making it easier to figure out their compensation.
💡
Jane tip:
Booked hours are the total time scheduled for a practitioner’s appointments or classes each day. It includes all appointments marked as booked, arrived, or no-show — but not cancelled ones. For more information, check out our guide on the
Hours Scheduled/Booked Report
...
Questions?
Let us know
— we’re here to help!Subscribe to our monthly newsletter.Jane Software Inc.
...
- ![More from Jane](https://jane.app/assets/icons/stack_2_layers_dark_grey-7320907fa4e9bc366bdbf1c0f0851e53cd0eae755c37f0e143098652126300a5.svg)
- ![Feature Overview](https://jane.app/assets/icons/arrow_right_aqua-44fd64c285b864d54d7b80a7e51fe92c373aa86ded9e6e4fa710b8ba4995339f.svg)
- ![](https://jane.app/thumbs/09ea7d48-665a-48dc-a4bc-13854febb851)
- ![](https://jane.app/thumbs/4fed7fe5-3716-4d3a-9fee-162bb86b7d42)
- ![](https://jane.app/thumbs/90e30742-2bdf-4b63-b354-f08c3a62baeb)
